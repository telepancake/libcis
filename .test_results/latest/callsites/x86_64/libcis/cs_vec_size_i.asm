; call site: cs_vec_size_i   lib=libcis   arch=x86_64   size=12 bytes
...
00000000000002a7 <cs_vec_size_i>:
cs_vec_size_i():
/home/user/libcis/.claude/worktrees/agent-a7d5311b0eded3df4/bench/callsites.cpp:48
 2a7:	f3 0f 1e fa          	endbr64
 2ab:	48 8b 3f             	mov    (%rdi),%rdi
 2ae:	e9 bb fd ff ff       	jmp    6e <_ZNKSt6vectorIiSaIiEE4sizeEv.isra.0>
