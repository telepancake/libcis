; call site: cs_vec_empty_i   lib=ref   arch=arm64   size=16 bytes
...
0000000000000068 <cs_vec_empty_i>:
_ZN9__gnu_cxxeqIPKiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESB_():
/usr/aarch64-linux-gnu/include/c++/13/bits/stl_iterator.h:1203 (discriminator 2)
  68:	a9400001 	ldp	x1, x0, [x0]
  6c:	eb00003f 	cmp	x1, x0
cs_vec_empty_i():
