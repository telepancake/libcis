...
namespace libcis_ns_input_output_syncstream_syncbuf_syncstream_syncbuf_assign_assign { // libcis
...
} // libcis_ns_input_output_syncstream_syncbuf_syncstream_syncbuf_assign_assign (libcis)
