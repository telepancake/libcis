...
namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_next_iterator_sentinel { // libcis
...
} // libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_next_iterator_sentinel (libcis)
