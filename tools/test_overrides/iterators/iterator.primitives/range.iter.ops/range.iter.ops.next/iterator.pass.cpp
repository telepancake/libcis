...
namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_next_iterator { // libcis
template <class It>
...
} // libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_next_iterator (libcis)
