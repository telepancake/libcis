...
namespace libcis_ns_algorithms_alg_sorting_alg_three_way_lexicographical_compare_three_way { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_three_way_lexicographical_compare_three_way (libcis)
