...
namespace libcis_ns_experimental_utilities_propagate_const_propagate_const_class_swap { // libcis
...
} // libcis_ns_experimental_utilities_propagate_const_propagate_const_class_swap (libcis)
