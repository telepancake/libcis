// transferred+adapted from libc++ by tools/transfer.py (slug=library_description_conventions_customization_point_object_cpo_a089ae42).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_library_description_conventions_customization_point_object_cpo_a089ae42 { // libcis
...
} // libcis_ns_library_description_conventions_customization_point_object_cpo_a089ae42 (libcis)
