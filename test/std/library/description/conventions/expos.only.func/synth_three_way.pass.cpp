// transferred+adapted from libc++ by tools/transfer.py (slug=library_description_conventions_expos_only_func_synth_three_way_6b4d7d39).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_library_description_conventions_expos_only_func_synth_three_way_6b4d7d39 { // libcis
...
} // libcis_ns_library_description_conventions_expos_only_func_synth_three_way_6b4d7d39 (libcis)
