// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_objects_init_0a3de690).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_objects_init_0a3de690 { // libcis
struct Checker {
    char *cerr_mem_dump;
    char *cin_mem_dump;
    char *cout_mem_dump;
...
} // libcis_ns_input_output_iostream_objects_init_0a3de690 (libcis)
