// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_objects_init).
// main -> test_input_output_iostream_objects_init; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_objects_init { // libcis: isolate file-scope helpers
struct Checker {
    char *cerr_mem_dump;
    char *cin_mem_dump;
    char *cout_mem_dump;
...
} using namespace libcis_ns_input_output_iostream_objects_init; // libcis

#endif

void test_input_output_iostream_objects_init() {
