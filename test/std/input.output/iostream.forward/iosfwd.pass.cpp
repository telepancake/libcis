// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_forward_iosfwd).
// main -> test_input_output_iostream_forward_iosfwd; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_forward_iosfwd { // libcis: isolate file-scope helpers
template <class Ptr> void test()
{
    Ptr p = 0;
    ((void)p); // Prevent unused warning
}
} using namespace libcis_ns_input_output_iostream_forward_iosfwd; // libcis


void test_input_output_iostream_forward_iosfwd()
{
