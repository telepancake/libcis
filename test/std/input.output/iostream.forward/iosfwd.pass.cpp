// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_forward_iosfwd_6de9f42b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_forward_iosfwd_6de9f42b { // libcis
...
} // libcis_ns_input_output_iostream_forward_iosfwd_6de9f42b (libcis)
