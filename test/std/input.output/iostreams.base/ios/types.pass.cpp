// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_types_80130990).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_types_80130990 { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_iostreams_base_ios_types_80130990 (libcis)
