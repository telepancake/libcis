// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_basic_ios_members_imbue_ce5cc68a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_basic_ios_members_imbue_ce5cc68a { // libcis
struct testbuf
...
} // libcis_ns_input_output_iostreams_base_ios_basic_ios_members_imbue_ce5cc68a (libcis)
