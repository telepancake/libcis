// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_basic_ios_members_imbue).
// main -> test_input_output_iostreams_base_ios_basic_ios_members_imbue; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_basic_ios_members_imbue { // libcis: isolate file-scope helpers
struct testbuf
...
} using namespace libcis_ns_input_output_iostreams_base_ios_basic_ios_members_imbue; // libcis


void test_input_output_iostreams_base_ios_basic_ios_members_imbue()
{
    {
        std::ios ios(0);
