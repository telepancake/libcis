// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_basic_ios_members_move_921c617f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_basic_ios_members_move_921c617f { // libcis
struct testbuf
...
} // libcis_ns_input_output_iostreams_base_ios_basic_ios_members_move_921c617f (libcis)
