// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_basic_ios_members_move).
// main -> test_input_output_iostreams_base_ios_basic_ios_members_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_basic_ios_members_move { // libcis: isolate file-scope helpers
struct testbuf
...
} using namespace libcis_ns_input_output_iostreams_base_ios_basic_ios_members_move; // libcis


void test_input_output_iostreams_base_ios_basic_ios_members_move()
{
    testios ios1;
    testbuf sb2;
    std::ios ios2(&sb2);
