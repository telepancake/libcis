// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_basic_ios_members_copyfmt).
// main -> test_input_output_iostreams_base_ios_basic_ios_members_copyfmt; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_basic_ios_members_copyfmt { // libcis: isolate file-scope helpers
struct testbuf
...
} using namespace libcis_ns_input_output_iostreams_base_ios_basic_ios_members_copyfmt; // libcis


void test_input_output_iostreams_base_ios_basic_ios_members_copyfmt()
{
    testbuf sb1;
    std::ios ios1(&sb1);
