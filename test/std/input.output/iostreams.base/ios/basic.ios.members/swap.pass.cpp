// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_basic_ios_members_swap).
// main -> test_input_output_iostreams_base_ios_basic_ios_members_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_basic_ios_members_swap { // libcis: isolate file-scope helpers
struct testbuf
...
} using namespace libcis_ns_input_output_iostreams_base_ios_basic_ios_members_swap; // libcis


void test_input_output_iostreams_base_ios_basic_ios_members_swap()
{
    testbuf sb1;
    testios ios1(&sb1);
