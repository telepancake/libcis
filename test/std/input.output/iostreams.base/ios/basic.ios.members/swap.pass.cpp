// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_basic_ios_members_swap_ff7d7e0a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_basic_ios_members_swap_ff7d7e0a { // libcis
struct testbuf
...
} // libcis_ns_input_output_iostreams_base_ios_basic_ios_members_swap_ff7d7e0a (libcis)
