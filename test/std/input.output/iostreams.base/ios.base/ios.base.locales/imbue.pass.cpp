// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_base_ios_base_locales_imbue).
// main -> test_input_output_iostreams_base_ios_base_ios_base_locales_imbue; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_base_ios_base_locales_imbue { // libcis: isolate file-scope helpers
class test
    : public std::ios
{
public:
...
} using namespace libcis_ns_input_output_iostreams_base_ios_base_ios_base_locales_imbue; // libcis


void test_input_output_iostreams_base_ios_base_ios_base_locales_imbue()
{
    test t;
    std::ios_base& b = t;
