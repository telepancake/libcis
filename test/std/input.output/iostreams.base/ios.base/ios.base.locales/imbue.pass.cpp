// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_base_ios_base_locales_imbue_36cd3d54).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_base_ios_base_locales_imbue_36cd3d54 { // libcis
class test
    : public std::ios
{
public:
...
} // libcis_ns_input_output_iostreams_base_ios_base_ios_base_locales_imbue_36cd3d54 (libcis)
