// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_base_ios_base_cons_dtor_5cfb293f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_base_ios_base_cons_dtor_5cfb293f { // libcis
class test
    : public std::ios
{
public:
...
} // libcis_ns_input_output_iostreams_base_ios_base_ios_base_cons_dtor_5cfb293f (libcis)
