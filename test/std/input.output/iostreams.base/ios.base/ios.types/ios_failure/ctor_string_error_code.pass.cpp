// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_base_ios_types_ios_failure_ctor_string_error_code_e3bde7de).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_base_ios_types_ios_failure_ctor_string_error_code_e3bde7de { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_iostreams_base_ios_base_ios_types_ios_failure_ctor_string_error_code_e3bde7de (libcis)
