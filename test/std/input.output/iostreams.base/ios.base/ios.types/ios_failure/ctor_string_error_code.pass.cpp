// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_base_ios_types_ios_failure_ctor_string_error_code).
// main -> test_input_output_iostreams_base_ios_base_ios_types_ios_failure_ctor_string_error_code; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_iostreams_base_ios_base_ios_types_ios_failure_ctor_string_error_code()
{
