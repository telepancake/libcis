// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_base_ios_types_ios_Init_ios_Init_multiple_442fd4cd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_base_ios_types_ios_Init_ios_Init_multiple_442fd4cd { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_iostreams_base_ios_base_ios_types_ios_Init_ios_Init_multiple_442fd4cd (libcis)
