// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_base_ios_types_ios_fmtflags_fmtflags_0dfd360a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_ios_base_ios_types_ios_fmtflags_fmtflags_0dfd360a { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_iostreams_base_ios_base_ios_types_ios_fmtflags_fmtflags_0dfd360a (libcis)
