// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostreams_base_ios_base_ios_types_ios_fmtflags_fmtflags).
// main -> test_input_output_iostreams_base_ios_base_ios_types_ios_fmtflags_fmtflags; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_iostreams_base_ios_base_ios_types_ios_fmtflags_fmtflags()
{
