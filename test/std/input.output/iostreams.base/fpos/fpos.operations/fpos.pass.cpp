// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostreams_base_fpos_fpos_operations_fpos).
// main -> test_input_output_iostreams_base_fpos_fpos_operations_fpos; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_fpos_fpos_operations_fpos { // libcis: isolate file-scope helpers
...
struct Foo { };
} using namespace libcis_ns_input_output_iostreams_base_fpos_fpos_operations_fpos; // libcis


void test_input_output_iostreams_base_fpos_fpos_operations_fpos()
{
