// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostreams_base_fpos_fpos_operations_fpos_82b9accc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostreams_base_fpos_fpos_operations_fpos_82b9accc { // libcis
...
} // libcis_ns_input_output_iostreams_base_fpos_fpos_operations_fpos_82b9accc (libcis)
