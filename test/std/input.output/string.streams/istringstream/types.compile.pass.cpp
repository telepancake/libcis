// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_istringstream_types_96a2d638).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_istringstream_types_96a2d638 { // libcis
...
} // libcis_ns_input_output_string_streams_istringstream_types_96a2d638 (libcis)
