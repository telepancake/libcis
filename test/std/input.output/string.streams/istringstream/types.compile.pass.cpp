// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_istringstream_types).
...
namespace libcis_ns_input_output_string_streams_istringstream_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_string_streams_istringstream_types; // libcis
