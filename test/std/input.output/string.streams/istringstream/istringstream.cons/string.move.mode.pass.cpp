// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_istringstream_istringstream_cons_string_move_mode_956ea773).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_istringstream_istringstream_cons_string_move_mode_956ea773 { // libcis
...
} // libcis_ns_input_output_string_streams_istringstream_istringstream_cons_string_move_mode_956ea773 (libcis)
