// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_istringstream_istringstream_cons_string_fbc7f41a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_istringstream_istringstream_cons_string_fbc7f41a { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_input_output_string_streams_istringstream_istringstream_cons_string_fbc7f41a (libcis)
