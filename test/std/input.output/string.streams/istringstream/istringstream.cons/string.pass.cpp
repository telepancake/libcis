// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_istringstream_istringstream_cons_string).
// main -> test_input_output_string_streams_istringstream_istringstream_cons_string; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_string_streams_istringstream_istringstream_cons_string()
{
    {
