// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_istringstream_istringstream_cons_string_mode_alloc_07fafad8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_istringstream_istringstream_cons_string_mode_alloc_07fafad8 { // libcis
...
} // libcis_ns_input_output_string_streams_istringstream_istringstream_cons_string_mode_alloc_07fafad8 (libcis)
