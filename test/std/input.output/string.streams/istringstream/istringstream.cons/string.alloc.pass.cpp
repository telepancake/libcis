// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_istringstream_istringstream_cons_string_alloc_5f1fdd62).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_istringstream_istringstream_cons_string_alloc_5f1fdd62 { // libcis
...
} // libcis_ns_input_output_string_streams_istringstream_istringstream_cons_string_alloc_5f1fdd62 (libcis)
