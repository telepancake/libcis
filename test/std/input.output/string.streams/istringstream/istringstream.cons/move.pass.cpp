// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_istringstream_istringstream_cons_move_ade37389).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_istringstream_istringstream_cons_move_ade37389 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_input_output_string_streams_istringstream_istringstream_cons_move_ade37389 (libcis)
