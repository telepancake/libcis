// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_istringstream_istringstream_assign_move_02995727).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_istringstream_istringstream_assign_move_02995727 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_input_output_string_streams_istringstream_istringstream_assign_move_02995727 (libcis)
