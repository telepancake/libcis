// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_istringstream_istringstream_members_view_bb564a68).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_istringstream_istringstream_members_view_bb564a68 { // libcis
...
} // libcis_ns_input_output_string_streams_istringstream_istringstream_members_view_bb564a68 (libcis)
