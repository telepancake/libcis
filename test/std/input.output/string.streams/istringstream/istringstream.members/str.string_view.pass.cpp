// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_istringstream_istringstream_members_str_string_view).
// main -> test_input_output_string_streams_istringstream_istringstream_members_str_string_view; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_istringstream_istringstream_members_str_string_view { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_string_streams_istringstream_istringstream_members_str_string_view; // libcis


void test_input_output_string_streams_istringstream_istringstream_members_str_string_view() {
