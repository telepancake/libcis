// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_virtuals_seekpos).
// main -> test_input_output_string_streams_stringbuf_stringbuf_virtuals_seekpos; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_string_streams_stringbuf_stringbuf_virtuals_seekpos()
{
    {
