// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_virtuals_seekpos_32ffb6f8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_virtuals_seekpos_32ffb6f8 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_input_output_string_streams_stringbuf_stringbuf_virtuals_seekpos_32ffb6f8 (libcis)
