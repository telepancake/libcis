// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_virtuals_pbackfail).
// main -> test_input_output_string_streams_stringbuf_stringbuf_virtuals_pbackfail; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_virtuals_pbackfail { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_virtuals_pbackfail; // libcis


void test_input_output_string_streams_stringbuf_stringbuf_virtuals_pbackfail()
{
    // check pbackfail
    {
        testbuf<char> tb("");
