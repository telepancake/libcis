// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_virtuals_pbackfail_66650786).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_virtuals_pbackfail_66650786 { // libcis
...
} // libcis_ns_input_output_string_streams_stringbuf_stringbuf_virtuals_pbackfail_66650786 (libcis)
