// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_virtuals_overflow_e461d4be).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_virtuals_overflow_e461d4be { // libcis
...
} // libcis_ns_input_output_string_streams_stringbuf_stringbuf_virtuals_overflow_e461d4be (libcis)
