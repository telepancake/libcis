// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_virtuals_overflow).
// main -> test_input_output_string_streams_stringbuf_stringbuf_virtuals_overflow; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_virtuals_overflow { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_virtuals_overflow; // libcis


void test_input_output_string_streams_stringbuf_stringbuf_virtuals_overflow()
{
    // check overflow
    {
        testbuf<char> tb("");
