// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_virtuals_seekoff_bf050201).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_virtuals_seekoff_bf050201 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_input_output_string_streams_stringbuf_stringbuf_virtuals_seekoff_bf050201 (libcis)
