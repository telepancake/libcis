// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_members_str).
// main -> test_input_output_string_streams_stringbuf_stringbuf_members_str; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_members_str { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_members_str; // libcis


void test_input_output_string_streams_stringbuf_stringbuf_members_str()
{
