// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_cons_move).
// main -> test_input_output_string_streams_stringbuf_stringbuf_cons_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_cons_move { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_cons_move; // libcis


void test_input_output_string_streams_stringbuf_stringbuf_cons_move() {
  test<char>();
