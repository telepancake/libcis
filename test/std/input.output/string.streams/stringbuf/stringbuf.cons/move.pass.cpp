// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_cons_move_859bcede).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_cons_move_859bcede { // libcis
...
} // libcis_ns_input_output_string_streams_stringbuf_stringbuf_cons_move_859bcede (libcis)
