// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_cons_default).
// main -> test_input_output_string_streams_stringbuf_stringbuf_cons_default; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_cons_default { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_cons_default; // libcis


void test_input_output_string_streams_stringbuf_stringbuf_cons_default()
{
    {
        std::stringbuf buf;
        assert(buf.str() == "");
