// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_cons_default_de095a43).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_cons_default_de095a43 { // libcis
...
} // libcis_ns_input_output_string_streams_stringbuf_stringbuf_cons_default_de095a43 (libcis)
