// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_cons_string_move_mode_08223a6d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_cons_string_move_mode_08223a6d { // libcis
...
} // libcis_ns_input_output_string_streams_stringbuf_stringbuf_cons_string_move_mode_08223a6d (libcis)
