// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_assign_nonmember_swap_noexcept).
// main -> test_input_output_string_streams_stringbuf_stringbuf_assign_nonmember_swap_noexcept; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_assign_nonmember_swap_noexcept { // libcis: isolate file-scope helpers
template <class T>
struct test_alloc {
  using value_type = T;
...
} using namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_assign_nonmember_swap_noexcept; // libcis


void test_input_output_string_streams_stringbuf_stringbuf_assign_nonmember_swap_noexcept() {
  test<char>();
