// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_assign_nonmember_swap_noexcept_2553ea21).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_assign_nonmember_swap_noexcept_2553ea21 { // libcis
template <class T>
struct test_alloc {
  using value_type = T;
...
} // libcis_ns_input_output_string_streams_stringbuf_stringbuf_assign_nonmember_swap_noexcept_2553ea21 (libcis)
