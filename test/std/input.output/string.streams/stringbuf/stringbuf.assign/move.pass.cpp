// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringbuf_stringbuf_assign_move_48750371).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringbuf_stringbuf_assign_move_48750371 { // libcis
...
} // libcis_ns_input_output_string_streams_stringbuf_stringbuf_assign_move_48750371 (libcis)
