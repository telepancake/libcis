// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_ostringstream_ostringstream_members_str_allocator_propagation_75decef9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_ostringstream_ostringstream_members_str_allocator_propagation_75decef9 { // libcis
...
} // libcis_ns_input_output_string_streams_ostringstream_ostringstream_members_str_allocator_propagation_75decef9 (libcis)
