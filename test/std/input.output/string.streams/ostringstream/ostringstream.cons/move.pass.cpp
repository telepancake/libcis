// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_ostringstream_ostringstream_cons_move).
// main -> test_input_output_string_streams_ostringstream_ostringstream_cons_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_string_streams_ostringstream_ostringstream_cons_move()
{
    {
