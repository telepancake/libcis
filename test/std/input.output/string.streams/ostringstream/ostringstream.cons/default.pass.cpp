// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_ostringstream_ostringstream_cons_default).
// main -> test_input_output_string_streams_ostringstream_ostringstream_cons_default; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_ostringstream_ostringstream_cons_default { // libcis: isolate file-scope helpers
template <typename S>
void test() {
  static_assert(test_convertible<S>(), "");
  static_assert(!test_convertible<S, std::ios_base::openmode>(), "");
}
} using namespace libcis_ns_input_output_string_streams_ostringstream_ostringstream_cons_default; // libcis

#endif

void test_input_output_string_streams_ostringstream_ostringstream_cons_default()
{
    {
