// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_ostringstream_ostringstream_cons_string_move_mode_bf76649c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_ostringstream_ostringstream_cons_string_move_mode_bf76649c { // libcis
...
} // libcis_ns_input_output_string_streams_ostringstream_ostringstream_cons_string_move_mode_bf76649c (libcis)
