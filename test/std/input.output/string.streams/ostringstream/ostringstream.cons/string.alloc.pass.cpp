// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_ostringstream_ostringstream_cons_string_alloc_dfbdbeef).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_ostringstream_ostringstream_cons_string_alloc_dfbdbeef { // libcis
...
} // libcis_ns_input_output_string_streams_ostringstream_ostringstream_cons_string_alloc_dfbdbeef (libcis)
