// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_ostringstream_ostringstream_cons_string_mode_alloc_03db0dc8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_ostringstream_ostringstream_cons_string_mode_alloc_03db0dc8 { // libcis
...
} // libcis_ns_input_output_string_streams_ostringstream_ostringstream_cons_string_mode_alloc_03db0dc8 (libcis)
