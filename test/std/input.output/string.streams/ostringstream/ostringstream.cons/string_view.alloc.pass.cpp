// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_ostringstream_ostringstream_cons_string_view_alloc).
// main -> test_input_output_string_streams_ostringstream_ostringstream_cons_string_view_alloc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_ostringstream_ostringstream_cons_string_view_alloc { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_string_streams_ostringstream_ostringstream_cons_string_view_alloc; // libcis


void test_input_output_string_streams_ostringstream_ostringstream_cons_string_view_alloc() {
