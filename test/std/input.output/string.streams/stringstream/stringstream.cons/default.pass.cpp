// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringstream_stringstream_cons_default_50f72e6c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringstream_stringstream_cons_default_50f72e6c { // libcis
#if TEST_STD_VER >= 11
...
} // libcis_ns_input_output_string_streams_stringstream_stringstream_cons_default_50f72e6c (libcis)
