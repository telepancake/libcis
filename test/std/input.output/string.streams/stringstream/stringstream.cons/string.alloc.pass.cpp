// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringstream_stringstream_cons_string_alloc_8d367ee5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringstream_stringstream_cons_string_alloc_8d367ee5 { // libcis
...
} // libcis_ns_input_output_string_streams_stringstream_stringstream_cons_string_alloc_8d367ee5 (libcis)
