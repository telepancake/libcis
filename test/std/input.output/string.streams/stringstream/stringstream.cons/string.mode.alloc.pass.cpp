// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringstream_stringstream_cons_string_mode_alloc_ae2e0ce6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringstream_stringstream_cons_string_mode_alloc_ae2e0ce6 { // libcis
...
} // libcis_ns_input_output_string_streams_stringstream_stringstream_cons_string_mode_alloc_ae2e0ce6 (libcis)
