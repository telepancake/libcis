// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringstream_stringstream_cons_string_f776c101).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringstream_stringstream_cons_string_f776c101 { // libcis
template<typename T>
...
} // libcis_ns_input_output_string_streams_stringstream_stringstream_cons_string_f776c101 (libcis)
