// AST-transferred from libc++ by tools/transfer.py (slug=input_output_string_streams_stringstream_stringstream_cons_string).
// main -> test_input_output_string_streams_stringstream_stringstream_cons_string; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringstream_stringstream_cons_string { // libcis: isolate file-scope helpers
template<typename T>
...
} using namespace libcis_ns_input_output_string_streams_stringstream_stringstream_cons_string; // libcis



void test_input_output_string_streams_stringstream_stringstream_cons_string()
{
    {
