// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringstream_stringstream_cons_move_600fa9ca).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringstream_stringstream_cons_move_600fa9ca { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_input_output_string_streams_stringstream_stringstream_cons_move_600fa9ca (libcis)
