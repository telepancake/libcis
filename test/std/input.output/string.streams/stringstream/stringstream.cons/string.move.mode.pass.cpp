// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringstream_stringstream_cons_string_move_mode_93597094).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringstream_stringstream_cons_string_move_mode_93597094 { // libcis
...
} // libcis_ns_input_output_string_streams_stringstream_stringstream_cons_string_move_mode_93597094 (libcis)
