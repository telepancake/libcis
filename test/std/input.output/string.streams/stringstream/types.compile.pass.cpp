// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringstream_types_96a6563b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringstream_types_96a6563b { // libcis
...
} // libcis_ns_input_output_string_streams_stringstream_types_96a6563b (libcis)
