// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_string_streams_stringstream_stringstream_members_view_8cc6bc91).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_string_streams_stringstream_stringstream_members_view_8cc6bc91 { // libcis
...
} // libcis_ns_input_output_string_streams_stringstream_stringstream_members_view_8cc6bc91 (libcis)
