// AST-transferred from libc++ by tools/transfer.py (slug=input_output_file_streams_c_files_cstdio).
// main -> test_input_output_file_streams_c_files_cstdio; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_file_streams_c_files_cstdio()
{
    std::FILE* fp = 0;
