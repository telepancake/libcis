// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_c_files_cstdio_d800697a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_c_files_cstdio_d800697a { // libcis
int main(int, char**)
{
    std::FILE* fp = 0;
...
} // libcis_ns_input_output_file_streams_c_files_cstdio_d800697a (libcis)
