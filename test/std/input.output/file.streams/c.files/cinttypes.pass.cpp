// AST-transferred from libc++ by tools/transfer.py (slug=input_output_file_streams_c_files_cinttypes).
// main -> test_input_output_file_streams_c_files_cinttypes; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_c_files_cinttypes { // libcis: isolate file-scope helpers
template <class T> void test()
{
    T t = 0;
    ((void)t); // Prevent unused warning
}
} using namespace libcis_ns_input_output_file_streams_c_files_cinttypes; // libcis


void test_input_output_file_streams_c_files_cinttypes()
{
    test<std::int8_t >();
    test<std::int16_t>();
    test<std::int32_t>();
