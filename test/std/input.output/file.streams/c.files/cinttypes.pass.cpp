// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_c_files_cinttypes_f53f6251).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_c_files_cinttypes_f53f6251 { // libcis
...
} // libcis_ns_input_output_file_streams_c_files_cinttypes_f53f6251 (libcis)
