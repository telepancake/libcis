// AST-transferred from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_filebuf_members_open_pointer).
// main -> test_input_output_file_streams_fstreams_filebuf_members_open_pointer; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_file_streams_fstreams_filebuf_members_open_pointer()
{
