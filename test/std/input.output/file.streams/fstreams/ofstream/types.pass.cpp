// AST-transferred from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_ofstream_types).
// main -> test_input_output_file_streams_fstreams_ofstream_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_file_streams_fstreams_ofstream_types()
{
