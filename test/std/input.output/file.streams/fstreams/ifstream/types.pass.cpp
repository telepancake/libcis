// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_ifstream_types_32135346).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_ifstream_types_32135346 { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_file_streams_fstreams_ifstream_types_32135346 (libcis)
