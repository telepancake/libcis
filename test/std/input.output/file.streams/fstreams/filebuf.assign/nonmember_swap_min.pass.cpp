// AST-transferred from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_filebuf_assign_nonmember_swap_min).
// main -> test_input_output_file_streams_fstreams_filebuf_assign_nonmember_swap_min; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_file_streams_fstreams_filebuf_assign_nonmember_swap_min()
{
