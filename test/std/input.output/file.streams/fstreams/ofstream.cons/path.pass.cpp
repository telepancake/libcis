// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_ofstream_cons_path_daf58c11).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_ofstream_cons_path_daf58c11 { // libcis
...
} // libcis_ns_input_output_file_streams_fstreams_ofstream_cons_path_daf58c11 (libcis)
