// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_ofstream_cons_string_513a6edc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_ofstream_cons_string_513a6edc { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_file_streams_fstreams_ofstream_cons_string_513a6edc (libcis)
