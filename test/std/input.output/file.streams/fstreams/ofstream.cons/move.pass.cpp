// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_ofstream_cons_move_332300bb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_ofstream_cons_move_332300bb { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_file_streams_fstreams_ofstream_cons_move_332300bb (libcis)
