// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_filebuf_types_c0fe2c4d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_filebuf_types_c0fe2c4d { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_file_streams_fstreams_filebuf_types_c0fe2c4d (libcis)
