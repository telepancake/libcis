// AST-transferred from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_filebuf_virtuals_seekoff).
// main -> test_input_output_file_streams_fstreams_filebuf_virtuals_seekoff; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_file_streams_fstreams_filebuf_virtuals_seekoff()
{
    {
        char buf[10];
