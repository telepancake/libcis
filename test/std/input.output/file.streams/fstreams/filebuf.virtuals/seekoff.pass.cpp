// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_filebuf_virtuals_seekoff_5d86df3c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_filebuf_virtuals_seekoff_5d86df3c { // libcis
int main(int, char**)
{
    {
        char buf[10];
...
} // libcis_ns_input_output_file_streams_fstreams_filebuf_virtuals_seekoff_5d86df3c (libcis)
