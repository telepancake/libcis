// AST-transferred from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_filebuf_virtuals_xsputn).
// main -> test_input_output_file_streams_fstreams_filebuf_virtuals_xsputn; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_filebuf_virtuals_xsputn { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_file_streams_fstreams_filebuf_virtuals_xsputn; // libcis

#endif

void test_input_output_file_streams_fstreams_filebuf_virtuals_xsputn() {
  sputn_not_open();
#ifndef TEST_HAS_NO_WIDE_CHARACTERS
