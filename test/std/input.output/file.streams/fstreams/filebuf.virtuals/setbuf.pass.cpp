// AST-transferred from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_filebuf_virtuals_setbuf).
// main -> test_input_output_file_streams_fstreams_filebuf_virtuals_setbuf; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_filebuf_virtuals_setbuf { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_file_streams_fstreams_filebuf_virtuals_setbuf; // libcis


void test_input_output_file_streams_fstreams_filebuf_virtuals_setbuf() {
  test<char>();
