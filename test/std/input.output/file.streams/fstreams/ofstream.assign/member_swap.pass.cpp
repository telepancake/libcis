// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_ofstream_assign_member_swap_8a83b880).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_ofstream_assign_member_swap_8a83b880 { // libcis
...
} // libcis_ns_input_output_file_streams_fstreams_ofstream_assign_member_swap_8a83b880 (libcis)
