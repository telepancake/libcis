// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_ofstream_assign_nonmember_swap_cf1478d7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_ofstream_assign_nonmember_swap_cf1478d7 { // libcis
...
} // libcis_ns_input_output_file_streams_fstreams_ofstream_assign_nonmember_swap_cf1478d7 (libcis)
