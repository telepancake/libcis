// AST-transferred from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_ofstream_assign_nonmember_swap).
// main -> test_input_output_file_streams_fstreams_ofstream_assign_nonmember_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_ofstream_assign_nonmember_swap { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_file_streams_fstreams_ofstream_assign_nonmember_swap; // libcis


void test_input_output_file_streams_fstreams_ofstream_assign_nonmember_swap()
{
