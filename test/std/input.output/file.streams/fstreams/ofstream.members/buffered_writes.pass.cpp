// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_ofstream_members_buffered_writes_5dae07be).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_ofstream_members_buffered_writes_5dae07be { // libcis
...
} // libcis_ns_input_output_file_streams_fstreams_ofstream_members_buffered_writes_5dae07be (libcis)
