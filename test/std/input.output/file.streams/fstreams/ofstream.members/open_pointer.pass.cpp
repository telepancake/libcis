// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_ofstream_members_open_pointer_2d70ef5c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_ofstream_members_open_pointer_2d70ef5c { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_file_streams_fstreams_ofstream_members_open_pointer_2d70ef5c (libcis)
