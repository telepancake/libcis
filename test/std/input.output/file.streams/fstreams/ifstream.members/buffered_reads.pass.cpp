// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_ifstream_members_buffered_reads_1fa805af).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_ifstream_members_buffered_reads_1fa805af { // libcis
...
} // libcis_ns_input_output_file_streams_fstreams_ifstream_members_buffered_reads_1fa805af (libcis)
