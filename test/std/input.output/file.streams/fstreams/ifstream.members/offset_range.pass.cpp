// AST-transferred from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_ifstream_members_offset_range).
// main -> test_input_output_file_streams_fstreams_ifstream_members_offset_range; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_ifstream_members_offset_range { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_file_streams_fstreams_ifstream_members_offset_range; // libcis


void test_input_output_file_streams_fstreams_ifstream_members_offset_range() {
