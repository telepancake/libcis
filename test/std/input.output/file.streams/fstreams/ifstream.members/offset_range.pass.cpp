// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_ifstream_members_offset_range_4b17690f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_ifstream_members_offset_range_4b17690f { // libcis
...
} // libcis_ns_input_output_file_streams_fstreams_ifstream_members_offset_range_4b17690f (libcis)
