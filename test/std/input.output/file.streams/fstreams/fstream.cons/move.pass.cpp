// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_fstream_cons_move_c3acf405).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_fstream_cons_move_c3acf405 { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_file_streams_fstreams_fstream_cons_move_c3acf405 (libcis)
