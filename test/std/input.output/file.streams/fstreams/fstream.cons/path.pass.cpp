// AST-transferred from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_fstream_cons_path).
// main -> test_input_output_file_streams_fstreams_fstream_cons_path; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_fstream_cons_path { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_file_streams_fstreams_fstream_cons_path; // libcis


void test_input_output_file_streams_fstreams_fstream_cons_path() {
