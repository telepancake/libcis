// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_fstream_cons_string_d03f66ec).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_fstream_cons_string_d03f66ec { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_file_streams_fstreams_fstream_cons_string_d03f66ec (libcis)
