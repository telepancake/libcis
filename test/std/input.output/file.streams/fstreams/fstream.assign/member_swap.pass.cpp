// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_file_streams_fstreams_fstream_assign_member_swap_e6eb3924).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_file_streams_fstreams_fstream_assign_member_swap_e6eb3924 { // libcis
...
} // libcis_ns_input_output_file_streams_fstreams_fstream_assign_member_swap_e6eb3924 (libcis)
