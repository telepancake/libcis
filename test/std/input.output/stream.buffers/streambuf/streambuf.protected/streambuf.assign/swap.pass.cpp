// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_stream_buffers_streambuf_streambuf_protected_streambuf_assign_swap_4edac9eb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_stream_buffers_streambuf_streambuf_protected_streambuf_assign_swap_4edac9eb { // libcis
...
} // libcis_ns_input_output_stream_buffers_streambuf_streambuf_protected_streambuf_assign_swap_4edac9eb (libcis)
