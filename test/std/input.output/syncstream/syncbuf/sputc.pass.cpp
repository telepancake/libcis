// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_syncstream_syncbuf_sputc_ea06a317).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_syncstream_syncbuf_sputc_ea06a317 { // libcis
...
} // libcis_ns_input_output_syncstream_syncbuf_sputc_ea06a317 (libcis)
