// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_syncstream_syncbuf_syncstream_syncbuf_cons_cons_default_a9ed78b4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_syncstream_syncbuf_syncstream_syncbuf_cons_cons_default_a9ed78b4 { // libcis
...
} // libcis_ns_input_output_syncstream_syncbuf_syncstream_syncbuf_cons_cons_default_a9ed78b4 (libcis)
