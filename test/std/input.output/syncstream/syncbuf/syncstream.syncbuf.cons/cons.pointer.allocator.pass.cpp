// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_syncstream_syncbuf_syncstream_syncbuf_cons_cons_pointer_allocator_2feeecc3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_syncstream_syncbuf_syncstream_syncbuf_cons_cons_pointer_allocator_2feeecc3 { // libcis
...
} // libcis_ns_input_output_syncstream_syncbuf_syncstream_syncbuf_cons_cons_pointer_allocator_2feeecc3 (libcis)
