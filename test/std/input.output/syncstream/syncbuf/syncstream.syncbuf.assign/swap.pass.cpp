// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_syncstream_syncbuf_syncstream_syncbuf_assign_swap_1b0c9a5d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_syncstream_syncbuf_syncstream_syncbuf_assign_swap_1b0c9a5d { // libcis
...
} // libcis_ns_input_output_syncstream_syncbuf_syncstream_syncbuf_assign_swap_1b0c9a5d (libcis)
