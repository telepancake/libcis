// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_syncstream_syncbuf_sputn_23d4d84a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_syncstream_syncbuf_sputn_23d4d84a { // libcis
...
} // libcis_ns_input_output_syncstream_syncbuf_sputn_23d4d84a (libcis)
