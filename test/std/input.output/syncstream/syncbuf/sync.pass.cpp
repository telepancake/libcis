// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_syncstream_syncbuf_sync_5579347b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_syncstream_syncbuf_sync_5579347b { // libcis
...
} // libcis_ns_input_output_syncstream_syncbuf_sync_5579347b (libcis)
