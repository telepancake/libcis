// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_syncstream_osyncstream_assign_95987435).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_syncstream_osyncstream_assign_95987435 { // libcis
...
} // libcis_ns_input_output_syncstream_osyncstream_assign_95987435 (libcis)
