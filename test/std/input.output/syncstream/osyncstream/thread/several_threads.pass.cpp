// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_syncstream_osyncstream_thread_several_threads_52bf3160).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_syncstream_osyncstream_thread_several_threads_52bf3160 { // libcis
...
} // libcis_ns_input_output_syncstream_osyncstream_thread_several_threads_52bf3160 (libcis)
