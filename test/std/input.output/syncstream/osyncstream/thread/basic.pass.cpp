// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_syncstream_osyncstream_thread_basic_06af6d42).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_syncstream_osyncstream_thread_basic_06af6d42 { // libcis
...
} // libcis_ns_input_output_syncstream_osyncstream_thread_basic_06af6d42 (libcis)
