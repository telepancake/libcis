// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_syncstream_osyncstream_syncstream_osyncstream_cons_cons_ostream_allocator_b47381cc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_syncstream_osyncstream_syncstream_osyncstream_cons_cons_ostream_allocator_b47381cc { // libcis
...
} // libcis_ns_input_output_syncstream_osyncstream_syncstream_osyncstream_cons_cons_ostream_allocator_b47381cc (libcis)
