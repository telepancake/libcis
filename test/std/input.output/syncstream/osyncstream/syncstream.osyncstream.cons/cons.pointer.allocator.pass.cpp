// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_syncstream_osyncstream_syncstream_osyncstream_cons_cons_pointer_allocator_5e6c0421).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_syncstream_osyncstream_syncstream_osyncstream_cons_cons_pointer_allocator_5e6c0421 { // libcis
...
} // libcis_ns_input_output_syncstream_osyncstream_syncstream_osyncstream_cons_cons_pointer_allocator_5e6c0421 (libcis)
