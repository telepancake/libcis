// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_syncstream_osyncstream_syncstream_osyncstream_cons_cons_ostream_3ed08989).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_syncstream_osyncstream_syncstream_osyncstream_cons_cons_ostream_3ed08989 { // libcis
...
} // libcis_ns_input_output_syncstream_osyncstream_syncstream_osyncstream_cons_cons_ostream_3ed08989 (libcis)
