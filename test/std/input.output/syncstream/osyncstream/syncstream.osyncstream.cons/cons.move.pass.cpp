// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_syncstream_osyncstream_syncstream_osyncstream_cons_cons_move_b68d3a2a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_syncstream_osyncstream_syncstream_osyncstream_cons_cons_move_b68d3a2a { // libcis
...
} // libcis_ns_input_output_syncstream_osyncstream_syncstream_osyncstream_cons_cons_move_b68d3a2a (libcis)
