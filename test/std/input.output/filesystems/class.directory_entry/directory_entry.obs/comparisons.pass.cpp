// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_directory_entry_directory_entry_obs_comparisons_6c4eae14).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_directory_entry_directory_entry_obs_comparisons_6c4eae14 { // libcis
...
} // libcis_ns_input_output_filesystems_class_directory_entry_directory_entry_obs_comparisons_6c4eae14 (libcis)
