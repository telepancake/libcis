// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_directory_entry_directory_entry_obs_comparisons).
// main -> test_input_output_filesystems_class_directory_entry_directory_entry_obs_comparisons; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_filesystems_class_directory_entry_directory_entry_obs_comparisons() {
  using namespace fs;
