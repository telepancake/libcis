// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_directory_entry_directory_entry_obs_path).
// main -> test_input_output_filesystems_class_directory_entry_directory_entry_obs_path; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_directory_entry_directory_entry_obs_path { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_class_directory_entry_directory_entry_obs_path; // libcis


void test_input_output_filesystems_class_directory_entry_directory_entry_obs_path() {
  test_path_method();
