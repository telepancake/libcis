// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_directory_entry_directory_entry_io_directory_entry_io_a666c60e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_directory_entry_directory_entry_io_directory_entry_io_a666c60e { // libcis
...
} // libcis_ns_input_output_filesystems_class_directory_entry_directory_entry_io_directory_entry_io_a666c60e (libcis)
