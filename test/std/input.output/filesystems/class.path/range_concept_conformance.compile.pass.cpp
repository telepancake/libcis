// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_range_concept_conformance_5da4ffe4).
//===----------------------------------------------------------------------===//
//
...
#include <concepts>
#include <ranges>
namespace libcis_ns_input_output_filesystems_class_path_range_concept_conformance_5da4ffe4 { // libcis
...
} // libcis_ns_input_output_filesystems_class_path_range_concept_conformance_5da4ffe4 (libcis)
