// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_nonmember_path_factory).
// main -> test_input_output_filesystems_class_path_path_nonmember_path_factory; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_filesystems_class_path_path_nonmember_path_factory()
{
  using namespace fs;
