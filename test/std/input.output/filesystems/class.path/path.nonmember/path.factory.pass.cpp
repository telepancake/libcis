// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_nonmember_path_factory_71c7fd3c).
//===----------------------------------------------------------------------===//
//
...
#include "count_new.h"
namespace libcis_ns_input_output_filesystems_class_path_path_nonmember_path_factory_71c7fd3c { // libcis
...
} // libcis_ns_input_output_filesystems_class_path_path_nonmember_path_factory_71c7fd3c (libcis)
