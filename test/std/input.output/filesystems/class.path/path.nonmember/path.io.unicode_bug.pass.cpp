// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_nonmember_path_io_unicode_bug_1ede2d56).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_path_path_nonmember_path_io_unicode_bug_1ede2d56 { // libcis
...
} // libcis_ns_input_output_filesystems_class_path_path_nonmember_path_io_unicode_bug_1ede2d56 (libcis)
