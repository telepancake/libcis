// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_nonmember_path_io).
// main -> test_input_output_filesystems_class_path_path_nonmember_path_io; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_path_path_nonmember_path_io { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_class_path_path_nonmember_path_io; // libcis
...
void test_input_output_filesystems_class_path_path_nonmember_path_io() {
  doIOTest<char>();
#ifndef TEST_HAS_NO_WIDE_CHARACTERS
  doIOTest<wchar_t>();
#endif
