// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_nonmember_swap_914a5235).
//===----------------------------------------------------------------------===//
//
...
#include "count_new.h"
namespace libcis_ns_input_output_filesystems_class_path_path_nonmember_swap_914a5235 { // libcis
...
} // libcis_ns_input_output_filesystems_class_path_path_nonmember_swap_914a5235 (libcis)
