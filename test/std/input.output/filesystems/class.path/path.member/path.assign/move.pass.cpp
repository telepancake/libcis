// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_assign_move_8e3bcb92).
//===----------------------------------------------------------------------===//
//
...
#include "count_new.h"
namespace libcis_ns_input_output_filesystems_class_path_path_member_path_assign_move_8e3bcb92 { // libcis
...
} // libcis_ns_input_output_filesystems_class_path_path_member_path_assign_move_8e3bcb92 (libcis)
