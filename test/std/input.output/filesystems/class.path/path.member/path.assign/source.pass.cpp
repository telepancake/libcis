// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_assign_source).
// main -> test_input_output_filesystems_class_path_path_member_path_assign_source; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_path_path_member_path_assign_source { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_class_path_path_member_path_assign_source; // libcis


void test_input_output_filesystems_class_path_path_member_path_assign_source() {
