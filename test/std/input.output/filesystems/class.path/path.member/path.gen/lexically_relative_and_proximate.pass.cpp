// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_gen_lexically_relative_and_proximate_5e301c0a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_path_path_member_path_gen_lexically_relative_and_proximate_5e301c0a { // libcis
...
} // libcis_ns_input_output_filesystems_class_path_path_member_path_gen_lexically_relative_and_proximate_5e301c0a (libcis)
