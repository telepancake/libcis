// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_gen_lexically_normal).
// main -> test_input_output_filesystems_class_path_path_member_path_gen_lexically_normal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_filesystems_class_path_path_member_path_gen_lexically_normal() {
  // clang-format off
  struct {
    std::string input;
    std::string expect;
