// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_concat_a586b6e4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_path_path_member_path_concat_a586b6e4 { // libcis
...
} // libcis_ns_input_output_filesystems_class_path_path_member_path_concat_a586b6e4 (libcis)
