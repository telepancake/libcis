// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_concat).
// main -> test_input_output_filesystems_class_path_path_member_path_concat; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_path_path_member_path_concat { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_class_path_path_member_path_concat; // libcis


void test_input_output_filesystems_class_path_path_member_path_concat()
{
  using namespace fs;
