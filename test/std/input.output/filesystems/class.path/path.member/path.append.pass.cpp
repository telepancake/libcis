// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_append_d342ae1c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_path_path_member_path_append_d342ae1c { // libcis
...
} // libcis_ns_input_output_filesystems_class_path_path_member_path_append_d342ae1c (libcis)
