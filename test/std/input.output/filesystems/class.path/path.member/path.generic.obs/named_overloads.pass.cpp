// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_generic_obs_named_overloads_bb6cef0b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_path_path_member_path_generic_obs_named_overloads_bb6cef0b { // libcis
...
} // libcis_ns_input_output_filesystems_class_path_path_member_path_generic_obs_named_overloads_bb6cef0b (libcis)
