// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_charconv_7eb8931e).
//===----------------------------------------------------------------------===//
//
...
#endif
namespace libcis_ns_input_output_filesystems_class_path_path_member_path_charconv_7eb8931e { // libcis
...
} // libcis_ns_input_output_filesystems_class_path_path_member_path_charconv_7eb8931e (libcis)
