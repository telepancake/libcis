// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_charconv).
// main -> test_input_output_filesystems_class_path_path_member_path_charconv; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// one-byte code pages.
namespace libcis_ns_input_output_filesystems_class_path_path_member_path_charconv { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_class_path_path_member_path_charconv; // libcis


void test_input_output_filesystems_class_path_path_member_path_charconv()
{
  test_latin_unicode();
  test_wide_unicode();
  test_append();
