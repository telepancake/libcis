// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_compare).
// main -> test_input_output_filesystems_class_path_path_member_path_compare; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_path_path_member_path_compare { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_class_path_path_member_path_compare; // libcis


void test_input_output_filesystems_class_path_path_member_path_compare() {
  test_compare_basic();
