// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_decompose_path_decompose_dd57a781).
//===----------------------------------------------------------------------===//
//
...
#include "count_new.h"
namespace libcis_ns_input_output_filesystems_class_path_path_member_path_decompose_path_decompose_dd57a781 { // libcis
...
} // libcis_ns_input_output_filesystems_class_path_path_member_path_decompose_path_decompose_dd57a781 (libcis)
