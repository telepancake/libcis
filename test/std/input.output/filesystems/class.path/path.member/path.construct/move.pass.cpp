// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_construct_move).
// main -> test_input_output_filesystems_class_path_path_member_path_construct_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_filesystems_class_path_path_member_path_construct_move() {
  using namespace fs;
