// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_member_path_construct_source_caafe1c8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_path_path_member_path_construct_source_caafe1c8 { // libcis
...
} // libcis_ns_input_output_filesystems_class_path_path_member_path_construct_source_caafe1c8 (libcis)
