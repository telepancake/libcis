// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_synop).
// main -> test_input_output_filesystems_class_path_synop; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_filesystems_class_path_synop() {
  using namespace fs;
#ifdef _WIN32
