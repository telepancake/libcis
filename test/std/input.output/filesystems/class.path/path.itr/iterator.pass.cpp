// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_path_path_itr_iterator).
// main -> test_input_output_filesystems_class_path_path_itr_iterator; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_path_path_itr_iterator { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_class_path_path_itr_iterator; // libcis


void test_input_output_filesystems_class_path_path_itr_iterator() {
  using namespace fs;
