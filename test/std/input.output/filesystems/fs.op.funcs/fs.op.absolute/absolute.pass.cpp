// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_op_funcs_fs_op_absolute_absolute_842672ce).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_absolute_absolute_842672ce { // libcis
...
} // libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_absolute_absolute_842672ce (libcis)
