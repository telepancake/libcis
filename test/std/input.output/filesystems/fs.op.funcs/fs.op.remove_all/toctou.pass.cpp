// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_op_funcs_fs_op_remove_all_toctou).
// main -> test_input_output_filesystems_fs_op_funcs_fs_op_remove_all_toctou; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_filesystems_fs_op_funcs_fs_op_remove_all_toctou() {
  scoped_test_env env;
