// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_op_funcs_fs_op_remove_all_toctou_b30faf64).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_remove_all_toctou_b30faf64 { // libcis
...
} // libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_remove_all_toctou_b30faf64 (libcis)
