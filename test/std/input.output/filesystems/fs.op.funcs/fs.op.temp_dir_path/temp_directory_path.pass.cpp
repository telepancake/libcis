// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_op_funcs_fs_op_temp_dir_path_temp_directory_path).
// main -> test_input_output_filesystems_fs_op_funcs_fs_op_temp_dir_path_temp_directory_path; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_temp_dir_path_temp_directory_path { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_temp_dir_path_temp_directory_path; // libcis


void test_input_output_filesystems_fs_op_funcs_fs_op_temp_dir_path_temp_directory_path() {
    signature_test();
    basic_tests();
    return;
}
