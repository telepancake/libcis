// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_op_funcs_fs_op_status_known_status_known_040c4754).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_status_known_status_known_040c4754 { // libcis
...
} // libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_status_known_status_known_040c4754 (libcis)
