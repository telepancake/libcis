// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file_91da75f0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file_91da75f0 { // libcis
...
} // libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file_91da75f0 (libcis)
