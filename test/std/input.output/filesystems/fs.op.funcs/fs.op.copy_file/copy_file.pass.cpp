// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file).
// main -> test_input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file; // libcis


void test_input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file() {
  test_signatures();
