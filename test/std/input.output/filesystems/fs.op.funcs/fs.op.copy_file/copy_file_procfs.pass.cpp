// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file_procfs).
// main -> test_input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file_procfs; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file_procfs() {
    // libcis: re-bind dropped main() parameters as runtime locals
    static char libcis_arg0[] = "libcis_test";
    static char* argv_storage[] = {libcis_arg0, nullptr};
    char** argv = argv_storage; (void)argv;
