// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file_large).
// main -> test_input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file_large; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file_large { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file_large; // libcis


void test_input_output_filesystems_fs_op_funcs_fs_op_copy_file_copy_file_large() {
  large_file();
