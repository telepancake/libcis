// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_op_funcs_fs_op_proximate_proximate).
// main -> test_input_output_filesystems_fs_op_funcs_fs_op_proximate_proximate; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_proximate_proximate { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_fs_op_funcs_fs_op_proximate_proximate; // libcis


void test_input_output_filesystems_fs_op_funcs_fs_op_proximate_proximate() {
  signature_test();
  basic_test();
