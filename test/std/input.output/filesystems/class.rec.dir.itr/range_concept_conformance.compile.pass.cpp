// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_rec_dir_itr_range_concept_conformance_63e98c96).
//===----------------------------------------------------------------------===//
//
...
#include <concepts>
#include <ranges>
namespace libcis_ns_input_output_filesystems_class_rec_dir_itr_range_concept_conformance_63e98c96 { // libcis
...
} // libcis_ns_input_output_filesystems_class_rec_dir_itr_range_concept_conformance_63e98c96 (libcis)
