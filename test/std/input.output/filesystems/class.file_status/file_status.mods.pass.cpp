// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_file_status_file_status_mods_c8eacaca).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_file_status_file_status_mods_c8eacaca { // libcis
...
} // libcis_ns_input_output_filesystems_class_file_status_file_status_mods_c8eacaca (libcis)
