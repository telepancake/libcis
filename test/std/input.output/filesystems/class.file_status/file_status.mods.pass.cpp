// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_file_status_file_status_mods).
// main -> test_input_output_filesystems_class_file_status_file_status_mods; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_filesystems_class_file_status_file_status_mods() {
  using namespace fs;
