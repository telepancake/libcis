// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_file_status_file_status_cons).
// main -> test_input_output_filesystems_class_file_status_file_status_cons; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_filesystems_class_file_status_file_status_cons() {
 using namespace fs;
  // Default ctor
  {
