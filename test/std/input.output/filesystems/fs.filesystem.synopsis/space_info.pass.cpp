// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_filesystem_synopsis_space_info_af5a56af).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_filesystem_synopsis_space_info_af5a56af { // libcis
...
} // libcis_ns_input_output_filesystems_fs_filesystem_synopsis_space_info_af5a56af (libcis)
