// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_filesystem_synopsis_enable_view).
...
namespace libcis_ns_input_output_filesystems_fs_filesystem_synopsis_enable_view { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_fs_filesystem_synopsis_enable_view; // libcis
