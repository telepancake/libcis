// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_enum_enum_perms_2ce0dcfd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_enum_enum_perms_2ce0dcfd { // libcis
...
} // libcis_ns_input_output_filesystems_fs_enum_enum_perms_2ce0dcfd (libcis)
