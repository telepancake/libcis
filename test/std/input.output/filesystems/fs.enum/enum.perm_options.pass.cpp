// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_enum_enum_perm_options_aff6beab).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_enum_enum_perm_options_aff6beab { // libcis
...
} // libcis_ns_input_output_filesystems_fs_enum_enum_perm_options_aff6beab (libcis)
