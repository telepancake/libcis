// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_enum_enum_copy_options_12dc7072).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_enum_enum_copy_options_12dc7072 { // libcis
...
} // libcis_ns_input_output_filesystems_fs_enum_enum_copy_options_12dc7072 (libcis)
