// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_enum_enum_copy_options).
// main -> test_input_output_filesystems_fs_enum_enum_copy_options; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_enum_enum_copy_options { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_fs_enum_enum_copy_options; // libcis


void test_input_output_filesystems_fs_enum_enum_copy_options() {
