// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_fs_enum_enum_directory_options_a298264a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_fs_enum_enum_directory_options_a298264a { // libcis
...
} // libcis_ns_input_output_filesystems_fs_enum_enum_directory_options_a298264a (libcis)
