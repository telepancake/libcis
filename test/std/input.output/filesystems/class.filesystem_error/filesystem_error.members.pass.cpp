// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_filesystem_error_filesystem_error_members).
// main -> test_input_output_filesystems_class_filesystem_error_filesystem_error_members; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_filesystem_error_filesystem_error_members { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_class_filesystem_error_filesystem_error_members; // libcis


void test_input_output_filesystems_class_filesystem_error_filesystem_error_members() {
