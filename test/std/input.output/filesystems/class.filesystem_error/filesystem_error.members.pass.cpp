// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_filesystems_class_filesystem_error_filesystem_error_members_5a2c8224).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_filesystems_class_filesystem_error_filesystem_error_members_5a2c8224 { // libcis
...
} // libcis_ns_input_output_filesystems_class_filesystem_error_filesystem_error_members_5a2c8224 (libcis)
