// AST-transferred from libc++ by tools/transfer.py (slug=input_output_filesystems_class_directory_iterator_iterator_concept_conformance).
...
namespace libcis_ns_input_output_filesystems_class_directory_iterator_iterator_concept_conformance { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_filesystems_class_directory_iterator_iterator_concept_conformance; // libcis
