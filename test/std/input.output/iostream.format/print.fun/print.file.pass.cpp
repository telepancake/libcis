// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_print_fun_print_file).
// main -> test_input_output_iostream_format_print_fun_print_file; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_print_fun_print_file { // libcis: isolate file-scope helpers
scoped_test_env env;
...
} using namespace libcis_ns_input_output_iostream_format_print_fun_print_file; // libcis


void test_input_output_iostream_format_print_fun_print_file() {
