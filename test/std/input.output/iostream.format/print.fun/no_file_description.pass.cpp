// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_print_fun_no_file_description).
// main -> test_input_output_iostream_format_print_fun_no_file_description; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_print_fun_no_file_description { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_iostream_format_print_fun_no_file_description; // libcis


void test_input_output_iostream_format_print_fun_no_file_description() {
  test_print();
  test_println();
