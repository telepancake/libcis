// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_input_streams_istream_types_beb90c30).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_input_streams_istream_types_beb90c30 { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_iostream_format_input_streams_istream_types_beb90c30 (libcis)
