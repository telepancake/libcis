// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_input_streams_istream_types).
// main -> test_input_output_iostream_format_input_streams_istream_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_iostream_format_input_streams_istream_types()
{
