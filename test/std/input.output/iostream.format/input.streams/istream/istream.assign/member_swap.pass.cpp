// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_input_streams_istream_istream_assign_member_swap_56537319).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_input_streams_istream_istream_assign_member_swap_56537319 { // libcis
...
} // libcis_ns_input_output_iostream_format_input_streams_istream_istream_assign_member_swap_56537319 (libcis)
