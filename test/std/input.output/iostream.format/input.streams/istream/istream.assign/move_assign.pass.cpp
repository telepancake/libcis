// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_input_streams_istream_istream_assign_move_assign_b0e4bdf1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_input_streams_istream_istream_assign_move_assign_b0e4bdf1 { // libcis
...
} // libcis_ns_input_output_iostream_format_input_streams_istream_istream_assign_move_assign_b0e4bdf1 (libcis)
