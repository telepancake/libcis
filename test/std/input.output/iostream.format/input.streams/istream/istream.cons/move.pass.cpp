// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_input_streams_istream_istream_cons_move_3be1de48).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_input_streams_istream_istream_cons_move_3be1de48 { // libcis
...
} // libcis_ns_input_output_iostream_format_input_streams_istream_istream_cons_move_3be1de48 (libcis)
