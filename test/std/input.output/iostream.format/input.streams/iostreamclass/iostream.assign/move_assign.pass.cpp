// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_input_streams_iostreamclass_iostream_assign_move_assign_b0c8827a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_input_streams_iostreamclass_iostream_assign_move_assign_b0c8827a { // libcis
...
} // libcis_ns_input_output_iostream_format_input_streams_iostreamclass_iostream_assign_move_assign_b0c8827a (libcis)
