// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_input_streams_iostreamclass_iostream_cons_move_2ed5c048).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_input_streams_iostreamclass_iostream_cons_move_2ed5c048 { // libcis
...
} // libcis_ns_input_output_iostream_format_input_streams_iostreamclass_iostream_cons_move_2ed5c048 (libcis)
