// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_input_streams_iostreamclass_types_f7e597a3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_input_streams_iostreamclass_types_f7e597a3 { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_iostream_format_input_streams_iostreamclass_types_f7e597a3 (libcis)
