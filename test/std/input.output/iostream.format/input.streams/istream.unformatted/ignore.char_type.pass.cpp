// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_input_streams_istream_unformatted_ignore_char_type).
// main -> test_input_output_iostream_format_input_streams_istream_unformatted_ignore_char_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_iostream_format_input_streams_istream_unformatted_ignore_char_type() {
