// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_input_streams_istream_unformatted_sync).
// main -> test_input_output_iostream_format_input_streams_istream_unformatted_sync; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_input_streams_istream_unformatted_sync { // libcis: isolate file-scope helpers
int sync_called = 0;
...
} using namespace libcis_ns_input_output_iostream_format_input_streams_istream_unformatted_sync; // libcis
...
void test_input_output_iostream_format_input_streams_istream_unformatted_sync()
{
    {
