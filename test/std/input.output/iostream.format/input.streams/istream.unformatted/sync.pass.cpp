// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_input_streams_istream_unformatted_sync_19d0a0a3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_input_streams_istream_unformatted_sync_19d0a0a3 { // libcis
int sync_called = 0;
...
} // libcis_ns_input_output_iostream_format_input_streams_istream_unformatted_sync_19d0a0a3 (libcis)
