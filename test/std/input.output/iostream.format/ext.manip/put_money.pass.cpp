// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_ext_manip_put_money_fa013618).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_ext_manip_put_money_fa013618 { // libcis
...
} // libcis_ns_input_output_iostream_format_ext_manip_put_money_fa013618 (libcis)
