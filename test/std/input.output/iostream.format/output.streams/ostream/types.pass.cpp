// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_output_streams_ostream_types_2cf8ddb5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_output_streams_ostream_types_2cf8ddb5 { // libcis
int main(int, char**)
{
...
} // libcis_ns_input_output_iostream_format_output_streams_ostream_types_2cf8ddb5 (libcis)
