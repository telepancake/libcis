// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_output_streams_ostream_types).
// main -> test_input_output_iostream_format_output_streams_ostream_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_input_output_iostream_format_output_streams_ostream_types()
{
