// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_output_streams_ostream_assign_move_assign).
// main -> test_input_output_iostream_format_output_streams_ostream_assign_move_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_output_streams_ostream_assign_move_assign { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_iostream_format_output_streams_ostream_assign_move_assign; // libcis



void test_input_output_iostream_format_output_streams_ostream_assign_move_assign()
{
    {
        testbuf<char> sb1;
        testbuf<char> sb2;
