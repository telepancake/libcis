// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_output_streams_ostream_formatted_ostream_inserters_arithmetic_minus1).
// main -> test_input_output_iostream_format_output_streams_ostream_formatted_ostream_inserters_arithmetic_minus1; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_inserters_arithmetic_minus1 { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_inserters_arithmetic_minus1; // libcis


void test_input_output_iostream_format_output_streams_ostream_formatted_ostream_inserters_arithmetic_minus1()
{
