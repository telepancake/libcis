// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_output_streams_ostream_formatted_ostream_inserters_arithmetic_pointer_volatile).
// main -> test_input_output_iostream_format_output_streams_ostream_formatted_ostream_inserters_arithmetic_pointer_volatile; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_inserters_arithmetic_pointer_volatile { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_inserters_arithmetic_pointer_volatile; // libcis


void test_input_output_iostream_format_output_streams_ostream_formatted_ostream_inserters_arithmetic_pointer_volatile() {
  testbuf<char> sb1;
  std::ostream os1(&sb1);
  int n1 = 0;
  os1 << &n1;
