// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_output_streams_ostream_formatted_ostream_inserters_arithmetic_minmax_showbase_ce04e4c2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_inserters_arithmetic_minmax_showbase_ce04e4c2 { // libcis
template <typename T>
...
} // libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_inserters_arithmetic_minmax_showbase_ce04e4c2 (libcis)
