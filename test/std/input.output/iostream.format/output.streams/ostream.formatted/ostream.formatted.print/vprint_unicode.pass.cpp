// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_vprint_unicode).
// main -> test_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_vprint_unicode; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_vprint_unicode { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_vprint_unicode; // libcis


void test_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_vprint_unicode() {
