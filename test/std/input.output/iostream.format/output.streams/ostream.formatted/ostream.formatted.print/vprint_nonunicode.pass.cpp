// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_vprint_nonunicode).
// main -> test_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_vprint_nonunicode; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_vprint_nonunicode { // libcis: isolate file-scope helpers
...
in
} using namespace libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_vprint_nonunicode; // libcis
t void test_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_vprint_nonunicode() print_tests(test_file, test_exception);
