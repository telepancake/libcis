// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_locale_specific_form).
// main -> test_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_locale_specific_form; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_locale_specific_form { // libcis: isolate file-scope helpers
...
int ma
} using namespace libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_locale_specific_form; // libcis
invoid test_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_locale_specific_form()t_bool();
  test_integer();
