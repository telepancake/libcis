// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_println).
// main -> test_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_println; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_println { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_println; // libcis


void test_input_output_iostream_format_output_streams_ostream_formatted_ostream_formatted_print_println() {
