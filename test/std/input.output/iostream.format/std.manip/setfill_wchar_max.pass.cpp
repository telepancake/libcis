// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_std_manip_setfill_wchar_max).
// main -> test_input_output_iostream_format_std_manip_setfill_wchar_max; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_std_manip_setfill_wchar_max { // libcis: isolate file-scope helpers
template <class CharT>
struct testbuf : public std::basic_streambuf<CharT> {
  testbuf() {}
};
} using namespace libcis_ns_input_output_iostream_format_std_manip_setfill_wchar_max; // libcis


void test_input_output_iostream_format_std_manip_setfill_wchar_max() {
  testbuf<wchar_t> sb;
  std::wostream os(&sb);
