// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_std_manip_setfill_wchar_max_da7d82d3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_std_manip_setfill_wchar_max_da7d82d3 { // libcis
...
} // libcis_ns_input_output_iostream_format_std_manip_setfill_wchar_max_da7d82d3 (libcis)
