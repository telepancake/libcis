// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_std_manip_setbase_622d461d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_std_manip_setbase_622d461d { // libcis
...
} // libcis_ns_input_output_iostream_format_std_manip_setbase_622d461d (libcis)
