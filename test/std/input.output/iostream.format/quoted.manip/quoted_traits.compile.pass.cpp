// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_quoted_manip_quoted_traits_f5f04ba4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_quoted_manip_quoted_traits_f5f04ba4 { // libcis
...
} // libcis_ns_input_output_iostream_format_quoted_manip_quoted_traits_f5f04ba4 (libcis)
