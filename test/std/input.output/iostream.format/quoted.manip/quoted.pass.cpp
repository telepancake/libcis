// transferred+adapted from libc++ by tools/transfer.py (slug=input_output_iostream_format_quoted_manip_quoted_1a4bf726).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_quoted_manip_quoted_1a4bf726 { // libcis
...
} // libcis_ns_input_output_iostream_format_quoted_manip_quoted_1a4bf726 (libcis)
