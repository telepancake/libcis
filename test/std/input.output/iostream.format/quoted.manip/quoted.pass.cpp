// AST-transferred from libc++ by tools/transfer.py (slug=input_output_iostream_format_quoted_manip_quoted).
// main -> test_input_output_iostream_format_quoted_manip_quoted; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_input_output_iostream_format_quoted_manip_quoted { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_input_output_iostream_format_quoted_manip_quoted; // libcis



void test_input_output_iostream_format_quoted_manip_quoted()
{
