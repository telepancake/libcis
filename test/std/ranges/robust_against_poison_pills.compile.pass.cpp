// AST-transferred from libc++ by tools/transfer.py (slug=ranges_robust_against_poison_pills).
...
namespace libcis_ns_ranges_robust_against_poison_pills { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_robust_against_poison_pills; // libcis
