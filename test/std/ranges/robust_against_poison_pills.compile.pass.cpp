// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_robust_against_poison_pills_fe0f5204).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_robust_against_poison_pills_fe0f5204 { // libcis
namespace ns {
...
} // libcis_ns_ranges_robust_against_poison_pills_fe0f5204 (libcis)
