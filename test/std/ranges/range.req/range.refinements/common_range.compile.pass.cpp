// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_refinements_common_range_7dcf3f1f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_refinements_common_range_7dcf3f1f { // libcis
...
static_assert( std::ranges::common_range<Holder<Incomplete>* const(&)[10]>);
static_assert( std::ranges::common_range<Holder<Incomplete>* const(&&)[10]>);
} // libcis_ns_ranges_range_req_range_refinements_common_range_7dcf3f1f (libcis)
