// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_refinements_viewable_range_8c5fa950).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_refinements_viewable_range_8c5fa950 { // libcis
struct T1 { };
...
static_assert( std::ranges::viewable_range<Holder<Incomplete>* const(&)[10]>);
static_assert(!std::ranges::viewable_range<Holder<Incomplete>* const(&&)[10]>);
} // libcis_ns_ranges_range_req_range_refinements_viewable_range_8c5fa950 (libcis)
