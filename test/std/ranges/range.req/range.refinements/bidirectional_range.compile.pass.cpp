// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_refinements_bidirectional_range_9710daea).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_refinements_bidirectional_range_9710daea { // libcis
...
static_assert( std::ranges::bidirectional_range<Holder<Incomplete>* const(&)[10]>);
static_assert( std::ranges::bidirectional_range<Holder<Incomplete>* const(&&)[10]>);
} // libcis_ns_ranges_range_req_range_refinements_bidirectional_range_9710daea (libcis)
