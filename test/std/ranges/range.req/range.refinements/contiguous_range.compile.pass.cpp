// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_refinements_contiguous_range_1644b0bf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_refinements_contiguous_range_1644b0bf { // libcis
...
static_assert( std::ranges::contiguous_range<Holder<Incomplete>* const(&)[10]>);
static_assert( std::ranges::contiguous_range<Holder<Incomplete>* const(&&)[10]>);
} // libcis_ns_ranges_range_req_range_refinements_contiguous_range_1644b0bf (libcis)
