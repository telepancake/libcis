// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_refinements_random_access_range_761c8bf6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_refinements_random_access_range_761c8bf6 { // libcis
...
static_assert( std::ranges::random_access_range<Holder<Incomplete>* const(&)[10]>);
static_assert( std::ranges::random_access_range<Holder<Incomplete>* const(&&)[10]>);
} // libcis_ns_ranges_range_req_range_refinements_random_access_range_761c8bf6 (libcis)
