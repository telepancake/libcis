// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_refinements_forward_range_6058ffa3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_refinements_forward_range_6058ffa3 { // libcis
...
static_assert( std::ranges::forward_range<Holder<Incomplete>* const(&)[10]>);
static_assert( std::ranges::forward_range<Holder<Incomplete>* const(&&)[10]>);
} // libcis_ns_ranges_range_req_range_refinements_forward_range_6058ffa3 (libcis)
