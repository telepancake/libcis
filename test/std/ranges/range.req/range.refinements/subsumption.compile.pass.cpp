// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_refinements_subsumption_1e69727f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_refinements_subsumption_1e69727f { // libcis
struct range {
  int* begin();
  int* end();
};
...
} // libcis_ns_ranges_range_req_range_refinements_subsumption_1e69727f (libcis)
