// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_req_range_refinements_subsumption).
...
namespace libcis_ns_ranges_range_req_range_refinements_subsumption { // libcis: isolate file-scope helpers
struct range {
  int* begin();
  int* end();
};
...
} using namespace libcis_ns_ranges_range_req_range_refinements_subsumption; // libcis
