// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_req_range_refinements_input_range).
...
namespace libcis_ns_ranges_range_req_range_refinements_input_range { // libcis: isolate file-scope helpers
...
static_assert( std::ranges::input_range<Holder<Incomplete>* const(&)[10]>);
static_assert( std::ranges::input_range<Holder<Incomplete>* const(&&)[10]>);
} using namespace libcis_ns_ranges_range_req_range_refinements_input_range; // libcis
