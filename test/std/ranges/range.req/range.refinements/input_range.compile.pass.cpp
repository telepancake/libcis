// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_refinements_input_range_c40ec22a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_refinements_input_range_c40ec22a { // libcis
...
static_assert( std::ranges::input_range<Holder<Incomplete>* const(&)[10]>);
static_assert( std::ranges::input_range<Holder<Incomplete>* const(&&)[10]>);
} // libcis_ns_ranges_range_req_range_refinements_input_range_c40ec22a (libcis)
