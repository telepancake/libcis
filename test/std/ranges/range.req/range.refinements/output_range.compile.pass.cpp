// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_refinements_output_range_1b9e1a44).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_refinements_output_range_1b9e1a44 { // libcis
struct T { };
...
static_assert(!std::ranges::output_range<Holder<Incomplete>* const(&)[10], Holder<Incomplete>*>);
static_assert(!std::ranges::output_range<Holder<Incomplete>* const(&&)[10], Holder<Incomplete>*>);
} // libcis_ns_ranges_range_req_range_refinements_output_range_1b9e1a44 (libcis)
