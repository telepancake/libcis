// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_req_range_refinements_output_range).
...
namespace libcis_ns_ranges_range_req_range_refinements_output_range { // libcis: isolate file-scope helpers
struct T { };
...
static_assert(!std::ranges::output_range<Holder<Incomplete>* const(&)[10], Holder<Incomplete>*>);
static_assert(!std::ranges::output_range<Holder<Incomplete>* const(&&)[10], Holder<Incomplete>*>);
} using namespace libcis_ns_ranges_range_req_range_refinements_output_range; // libcis
