// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_view_view_7502d0a8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_view_view_7502d0a8 { // libcis
...
} // libcis_ns_ranges_range_req_range_view_view_7502d0a8 (libcis)
