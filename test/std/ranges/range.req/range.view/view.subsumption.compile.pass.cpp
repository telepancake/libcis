// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_view_view_subsumption_c86eaa17).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_view_view_subsumption_c86eaa17 { // libcis
...
} // libcis_ns_ranges_range_req_range_view_view_subsumption_c86eaa17 (libcis)
