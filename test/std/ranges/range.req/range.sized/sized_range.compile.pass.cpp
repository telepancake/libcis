// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_sized_sized_range_fbc8269f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_sized_sized_range_fbc8269f { // libcis
...
} // libcis_ns_ranges_range_req_range_sized_sized_range_fbc8269f (libcis)
