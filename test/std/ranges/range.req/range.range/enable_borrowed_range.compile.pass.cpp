// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_range_enable_borrowed_range_219c278e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_range_enable_borrowed_range_219c278e { // libcis
struct S {};
...
} // libcis_ns_ranges_range_req_range_range_enable_borrowed_range_219c278e (libcis)
