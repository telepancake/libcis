// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_req_range_range_enable_borrowed_range).
...
namespace libcis_ns_ranges_range_req_range_range_enable_borrowed_range { // libcis: isolate file-scope helpers
struct S {};
...
} using namespace libcis_ns_ranges_range_req_range_range_enable_borrowed_range; // libcis
