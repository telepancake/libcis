// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_req_range_range_range).
...
namespace libcis_ns_ranges_range_req_range_range_range { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_req_range_range_range; // libcis
