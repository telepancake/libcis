// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_req_range_range_range_size_t_778049e0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_req_range_range_range_size_t_778049e0 { // libcis
template<class T>
...
} // libcis_ns_ranges_range_req_range_range_range_size_t_778049e0 (libcis)
