// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_req_range_range_helper_aliases).
...
namespace libcis_ns_ranges_range_req_range_range_helper_aliases { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_req_range_range_helper_aliases; // libcis
