// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_single_view_end).
// main -> test_ranges_range_factories_range_single_view_end; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_single_view_end { // libcis: isolate file-scope helpers
struct Empty {};
...
} using namespace libcis_ns_ranges_range_factories_range_single_view_end; // libcis


void test_ranges_range_factories_range_single_view_end() {
  test();
  static_assert(test());
