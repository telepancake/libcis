// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_single_view_data_025611de).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_single_view_data_025611de { // libcis
struct Empty {};
...
} // libcis_ns_ranges_range_factories_range_single_view_data_025611de (libcis)
