// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_single_view_begin_0d3300a3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_single_view_begin_0d3300a3 { // libcis
struct Empty {};
...
} // libcis_ns_ranges_range_factories_range_single_view_begin_0d3300a3 (libcis)
