// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_single_view_range_concept_conformance).
...
namespace libcis_ns_ranges_range_factories_range_single_view_range_concept_conformance { // libcis: isolate file-scope helpers
struct Empty {};
...
} using namespace libcis_ns_ranges_range_factories_range_single_view_range_concept_conformance; // libcis
