// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_single_view_size_84d9c297).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_single_view_size_84d9c297 { // libcis
constexpr bool test() {
  {
...
} // libcis_ns_ranges_range_factories_range_single_view_size_84d9c297 (libcis)
