// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_single_view_size).
// main -> test_ranges_range_factories_range_single_view_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_single_view_size { // libcis: isolate file-scope helpers
constexpr bool test() {
  {
...
} using namespace libcis_ns_ranges_range_factories_range_single_view_size; // libcis


void test_ranges_range_factories_range_single_view_size() {
  test();
  static_assert(test());
