// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_single_view_cpo_5db60209).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_single_view_cpo_5db60209 { // libcis
...
} // libcis_ns_ranges_range_factories_range_single_view_cpo_5db60209 (libcis)
