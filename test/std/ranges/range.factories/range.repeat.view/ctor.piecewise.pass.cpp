// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_repeat_view_ctor_piecewise).
// main -> test_ranges_range_factories_range_repeat_view_ctor_piecewise; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_repeat_view_ctor_piecewise { // libcis: isolate file-scope helpers
struct C {};
...
} using namespace libcis_ns_ranges_range_factories_range_repeat_view_ctor_piecewise; // libcis


void test_ranges_range_factories_range_repeat_view_ctor_piecewise() {
  test();
  static_assert(test());
