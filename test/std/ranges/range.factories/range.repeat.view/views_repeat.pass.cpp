// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_repeat_view_views_repeat).
// main -> test_ranges_range_factories_range_repeat_view_views_repeat; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_repeat_view_views_repeat { // libcis: isolate file-scope helpers
struct NonCopyable {
...
} using namespace libcis_ns_ranges_range_factories_range_repeat_view_views_repeat; // libcis


void test_ranges_range_factories_range_repeat_view_views_repeat() {
  test();
  static_assert(test());
