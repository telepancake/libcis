// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_repeat_view_ctor_value_bound).
// main -> test_ranges_range_factories_range_repeat_view_ctor_value_bound; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_repeat_view_ctor_value_bound { // libcis: isolate file-scope helpers
struct Empty {};
...
} using namespace libcis_ns_ranges_range_factories_range_repeat_view_ctor_value_bound; // libcis


void test_ranges_range_factories_range_repeat_view_ctor_value_bound() {
  test();
  static_assert(test());
