// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_repeat_view_iterator_member_typedefs).
// main -> test_ranges_range_factories_range_repeat_view_iterator_member_typedefs; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_repeat_view_iterator_member_typedefs { // libcis: isolate file-scope helpers
constexpr bool test() {
  // unbound
  {
...
} using namespace libcis_ns_ranges_range_factories_range_repeat_view_iterator_member_typedefs; // libcis


void test_ranges_range_factories_range_repeat_view_iterator_member_typedefs() {
  test();
  static_assert(test());
