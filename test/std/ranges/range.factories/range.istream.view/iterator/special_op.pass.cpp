// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_istream_view_iterator_special_op).
// main -> test_ranges_range_factories_range_istream_view_iterator_special_op; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_istream_view_iterator_special_op { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_factories_range_istream_view_iterator_special_op; // libcis


void test_ranges_range_factories_range_istream_view_iterator_special_op() {
  test<char>();
#ifndef TEST_HAS_NO_WIDE_CHARACTERS
  test<wchar_t>();
#endif
