// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_istream_view_iterator_special_op_8b98220c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_istream_view_iterator_special_op_8b98220c { // libcis
...
} // libcis_ns_ranges_range_factories_range_istream_view_iterator_special_op_8b98220c (libcis)
