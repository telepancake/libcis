// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_istream_view_iterator_member_types_20ca8571).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_istream_view_iterator_member_types_20ca8571 { // libcis
template <class T>
...
} // libcis_ns_ranges_range_factories_range_istream_view_iterator_member_types_20ca8571 (libcis)
