// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_istream_view_range_concept).
...
namespace libcis_ns_ranges_range_factories_range_istream_view_range_concept { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_factories_range_istream_view_range_concept; // libcis
