// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_istream_view_cpo_8dcfb50f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_istream_view_cpo_8dcfb50f { // libcis
...
} // libcis_ns_ranges_range_factories_range_istream_view_cpo_8dcfb50f (libcis)
