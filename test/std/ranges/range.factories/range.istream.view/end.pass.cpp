// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_istream_view_end_c61d6594).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_istream_view_end_c61d6594 { // libcis
template <class T>
concept NoexceptEnd =
    requires(T t) {
      { t.end() } noexcept;
...
} // libcis_ns_ranges_range_factories_range_istream_view_end_c61d6594 (libcis)
