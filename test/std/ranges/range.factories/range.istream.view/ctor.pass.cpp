// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_istream_view_ctor_b6cf8197).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_istream_view_ctor_b6cf8197 { // libcis
...
} // libcis_ns_ranges_range_factories_range_istream_view_ctor_b6cf8197 (libcis)
