// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_istream_view_begin_222e552f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_istream_view_begin_222e552f { // libcis
template <class T>
...
} // libcis_ns_ranges_range_factories_range_istream_view_begin_222e552f (libcis)
