// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_size_0f944b53).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_size_0f944b53 { // libcis
constexpr bool test() {
...
} // libcis_ns_ranges_range_factories_range_iota_view_size_0f944b53 (libcis)
