// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_ctor_first_last_c53c8a91).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_ctor_first_last_c53c8a91 { // libcis
#if TEST_STD_VER >= 23
...
} // libcis_ns_ranges_range_factories_range_iota_view_ctor_first_last_c53c8a91 (libcis)
