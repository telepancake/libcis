// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_ctor_first_last).
// main -> test_ranges_range_factories_range_iota_view_ctor_first_last; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_ctor_first_last { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_factories_range_iota_view_ctor_first_last; // libcis


void test_ranges_range_factories_range_iota_view_ctor_first_last() {
  test();
  static_assert(test());
