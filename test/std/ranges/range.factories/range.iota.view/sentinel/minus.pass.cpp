// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_sentinel_minus_040cac52).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_sentinel_minus_040cac52 { // libcis
template<class T>
...
} // libcis_ns_ranges_range_factories_range_iota_view_sentinel_minus_040cac52 (libcis)
