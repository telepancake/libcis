// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_sentinel_minus).
// main -> test_ranges_range_factories_range_iota_view_sentinel_minus; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_sentinel_minus { // libcis: isolate file-scope helpers
template<class T>
...
} using namespace libcis_ns_ranges_range_factories_range_iota_view_sentinel_minus; // libcis


void test_ranges_range_factories_range_iota_view_sentinel_minus() {
  test();
  static_assert(test());
