// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_sentinel_eq_57ebe444).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_sentinel_eq_57ebe444 { // libcis
constexpr bool test() {
  {
...
} // libcis_ns_ranges_range_factories_range_iota_view_sentinel_eq_57ebe444 (libcis)
