// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_sentinel_ctor_value_5da3b5e6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_sentinel_ctor_value_5da3b5e6 { // libcis
constexpr bool test() {
  {
...
} // libcis_ns_ranges_range_factories_range_iota_view_sentinel_ctor_value_5da3b5e6 (libcis)
