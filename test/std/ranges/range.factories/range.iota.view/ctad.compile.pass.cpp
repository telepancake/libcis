// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_ctad_960fced7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_ctad_960fced7 { // libcis
...
} // libcis_ns_ranges_range_factories_range_iota_view_ctad_960fced7 (libcis)
