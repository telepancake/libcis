// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_ctad).
...
namespace libcis_ns_ranges_range_factories_range_iota_view_ctad { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_factories_range_iota_view_ctad; // libcis
