// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_views_iota_e22b3a2e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_views_iota_e22b3a2e { // libcis
...
} // libcis_ns_ranges_range_factories_range_iota_view_views_iota_e22b3a2e (libcis)
