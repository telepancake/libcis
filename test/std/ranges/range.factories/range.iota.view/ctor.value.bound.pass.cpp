// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_ctor_value_bound_ecc6d890).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_ctor_value_bound_ecc6d890 { // libcis
#if TEST_STD_VER >= 23
...
} // libcis_ns_ranges_range_factories_range_iota_view_ctor_value_bound_ecc6d890 (libcis)
