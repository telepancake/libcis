// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_empty_24da8725).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_empty_24da8725 { // libcis
template <typename R>
...
} // libcis_ns_ranges_range_factories_range_iota_view_empty_24da8725 (libcis)
