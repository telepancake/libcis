// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_iterator_minus).
// main -> test_ranges_range_factories_range_iota_view_iterator_minus; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#else
namespace libcis_ns_ranges_range_factories_range_iota_view_iterator_minus { // libcis: isolate file-scope helpers
using IntDiffT = long;
#endif
...
} using namespace libcis_ns_ranges_range_factories_range_iota_view_iterator_minus; // libcis


void test_ranges_range_factories_range_iota_view_iterator_minus() {
  test();
  static_assert(test());
