// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_iterator_minus_eq_1c26a1a5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_iterator_minus_eq_1c26a1a5 { // libcis
constexpr bool test() {
...
} // libcis_ns_ranges_range_factories_range_iota_view_iterator_minus_eq_1c26a1a5 (libcis)
