// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_iterator_compare_7a52dc1a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_iterator_compare_7a52dc1a { // libcis
constexpr bool test() {
  {
...
} // libcis_ns_ranges_range_factories_range_iota_view_iterator_compare_7a52dc1a (libcis)
