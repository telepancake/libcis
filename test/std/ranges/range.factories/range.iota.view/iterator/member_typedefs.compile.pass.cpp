// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_iterator_member_typedefs_78d1f876).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_iterator_member_typedefs_78d1f876 { // libcis
...
} // libcis_ns_ranges_range_factories_range_iota_view_iterator_member_typedefs_78d1f876 (libcis)
