// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_iterator_star_32f3d5df).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_iterator_star_32f3d5df { // libcis
...
} // libcis_ns_ranges_range_factories_range_iota_view_iterator_star_32f3d5df (libcis)
