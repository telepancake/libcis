// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_range_concept_conformance_c686f58d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_range_concept_conformance_c686f58d { // libcis
...
} // libcis_ns_ranges_range_factories_range_iota_view_range_concept_conformance_c686f58d (libcis)
