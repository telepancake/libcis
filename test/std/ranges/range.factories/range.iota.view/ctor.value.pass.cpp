// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_ctor_value_db949d89).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_ctor_value_db949d89 { // libcis
...
} // libcis_ns_ranges_range_factories_range_iota_view_ctor_value_db949d89 (libcis)
