// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_factories_range_iota_view_ctor_value).
// main -> test_ranges_range_factories_range_iota_view_ctor_value; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_factories_range_iota_view_ctor_value { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_factories_range_iota_view_ctor_value; // libcis


void test_ranges_range_factories_range_iota_view_ctor_value() {
  test();
  static_assert(test());
