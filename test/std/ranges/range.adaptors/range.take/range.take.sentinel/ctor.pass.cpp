// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_range_take_sentinel_ctor).
// main -> test_ranges_range_adaptors_range_take_range_take_sentinel_ctor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_range_take_sentinel_ctor { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_ranges_range_adaptors_range_take_range_take_sentinel_ctor; // libcis


void test_ranges_range_adaptors_range_take_range_take_sentinel_ctor() {
  test();
  static_assert(test());
