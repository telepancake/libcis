// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_range_take_sentinel_ctor_c0b12dce).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_range_take_sentinel_ctor_c0b12dce { // libcis
constexpr bool test() {
...
} // libcis_ns_ranges_range_adaptors_range_take_range_take_sentinel_ctor_c0b12dce (libcis)
