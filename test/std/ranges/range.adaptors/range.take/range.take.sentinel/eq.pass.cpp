// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_range_take_sentinel_eq_af3193de).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_range_take_sentinel_eq_af3193de { // libcis
template <bool Const>
...
} // libcis_ns_ranges_range_adaptors_range_take_range_take_sentinel_eq_af3193de (libcis)
