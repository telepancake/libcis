// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_range_concept_conformance).
...
namespace libcis_ns_ranges_range_adaptors_range_take_range_concept_conformance { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_take_range_concept_conformance; // libcis
