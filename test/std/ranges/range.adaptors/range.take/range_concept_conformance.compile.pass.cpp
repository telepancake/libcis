// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_range_concept_conformance_956992fa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_range_concept_conformance_956992fa { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_take_range_concept_conformance_956992fa (libcis)
