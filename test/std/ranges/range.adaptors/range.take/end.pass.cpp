// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_end).
// main -> test_ranges_range_adaptors_range_take_end; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_end { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_ranges_range_adaptors_range_take_end; // libcis


void test_ranges_range_adaptors_range_take_end() {
  test();
  static_assert(test());
