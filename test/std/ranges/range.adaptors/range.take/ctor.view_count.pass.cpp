// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_ctor_view_count_3cfac420).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_ctor_view_count_3cfac420 { // libcis
#if TEST_STD_VER >= 23
...
} // libcis_ns_ranges_range_adaptors_range_take_ctor_view_count_3cfac420 (libcis)
