// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_ctor_view_count).
// main -> test_ranges_range_adaptors_range_take_ctor_view_count; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_ctor_view_count { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_take_ctor_view_count; // libcis


void test_ranges_range_adaptors_range_take_ctor_view_count() {
  test();
  static_assert(test());
