// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_general_981de56a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_general_981de56a { // libcis
int main(int, char**) {
...
} // libcis_ns_ranges_range_adaptors_range_elements_general_981de56a (libcis)
