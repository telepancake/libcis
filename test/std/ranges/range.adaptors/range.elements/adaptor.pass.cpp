// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_adaptor_b73c70de).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_adaptor_b73c70de { // libcis
template <class T>
...
} // libcis_ns_ranges_range_adaptors_range_elements_adaptor_b73c70de (libcis)
