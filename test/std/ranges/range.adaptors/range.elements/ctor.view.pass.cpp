// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_ctor_view_f3209836).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_ctor_view_f3209836 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_elements_ctor_view_f3209836 (libcis)
