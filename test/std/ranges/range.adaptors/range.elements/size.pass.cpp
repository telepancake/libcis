// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_size_92345485).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_size_92345485 { // libcis
template <class T>
...
} // libcis_ns_ranges_range_adaptors_range_elements_size_92345485 (libcis)
