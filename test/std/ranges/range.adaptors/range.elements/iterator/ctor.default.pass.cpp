// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_iterator_ctor_default_d3f74d06).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_iterator_ctor_default_d3f74d06 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_elements_iterator_ctor_default_d3f74d06 (libcis)
