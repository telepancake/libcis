// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_iterator_ctor_other_b4507ca3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_iterator_ctor_other_b4507ca3 { // libcis
template <bool Const>
...
} // libcis_ns_ranges_range_adaptors_range_elements_iterator_ctor_other_b4507ca3 (libcis)
