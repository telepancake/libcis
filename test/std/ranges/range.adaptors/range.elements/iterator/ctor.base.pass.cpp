// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_iterator_ctor_base_78d0ec20).
//===----------------------------------------------------------------------===//
//
...
// Test explicit
namespace libcis_ns_ranges_range_adaptors_range_elements_iterator_ctor_base_78d0ec20 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_elements_iterator_ctor_base_78d0ec20 (libcis)
