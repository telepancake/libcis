// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_iterator_decrement).
// main -> test_ranges_range_adaptors_range_elements_iterator_decrement; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_iterator_decrement { // libcis: isolate file-scope helpers
template <class Iter>
...
} using namespace libcis_ns_ranges_range_adaptors_range_elements_iterator_decrement; // libcis


void test_ranges_range_adaptors_range_elements_iterator_decrement() {
  test();
  static_assert(test());
