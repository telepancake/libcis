// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_iterator_deref_cff160b3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_iterator_deref_cff160b3 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_elements_iterator_deref_cff160b3 (libcis)
