// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_iterator_member_types).
...
namespace libcis_ns_ranges_range_adaptors_range_elements_iterator_member_types { // libcis: isolate file-scope helpers
template <class Iter>
...
} using namespace libcis_ns_ranges_range_adaptors_range_elements_iterator_member_types; // libcis
