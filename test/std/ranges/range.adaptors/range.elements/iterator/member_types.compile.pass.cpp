// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_iterator_member_types_1d09a720).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_iterator_member_types_1d09a720 { // libcis
template <class Iter>
...
} // libcis_ns_ranges_range_adaptors_range_elements_iterator_member_types_1d09a720 (libcis)
