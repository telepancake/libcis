// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_iterator_subscript_2fc9a47c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_iterator_subscript_2fc9a47c { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_elements_iterator_subscript_2fc9a47c (libcis)
