// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_iterator_base).
// main -> test_ranges_range_adaptors_range_elements_iterator_base; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// Test Noexcept
namespace libcis_ns_ranges_range_adaptors_range_elements_iterator_base { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_ranges_range_adaptors_range_elements_iterator_base; // libcis


void test_ranges_range_adaptors_range_elements_iterator_base() {
  test();
  static_assert(test());
  return;
}
