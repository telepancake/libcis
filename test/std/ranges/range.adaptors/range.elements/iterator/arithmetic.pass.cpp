// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_iterator_arithmetic_04ddaa8b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_iterator_arithmetic_04ddaa8b { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_elements_iterator_arithmetic_04ddaa8b (libcis)
