// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_end_393a4c30).
//===----------------------------------------------------------------------===//
//
...
// !range<const V>
namespace libcis_ns_ranges_range_adaptors_range_elements_end_393a4c30 { // libcis
template <class T>
...
} // libcis_ns_ranges_range_adaptors_range_elements_end_393a4c30 (libcis)
