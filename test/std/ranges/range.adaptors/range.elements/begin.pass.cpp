// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_begin_a6be5a34).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_begin_a6be5a34 { // libcis
template <class T>
...
} // libcis_ns_ranges_range_adaptors_range_elements_begin_a6be5a34 (libcis)
