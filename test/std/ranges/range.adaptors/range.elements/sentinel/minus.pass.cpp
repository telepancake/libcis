// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_sentinel_minus).
// main -> test_ranges_range_adaptors_range_elements_sentinel_minus; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_sentinel_minus { // libcis: isolate file-scope helpers
template <bool Const>
struct Iter {
  std::tuple<int>* it_;
...
} using namespace libcis_ns_ranges_range_adaptors_range_elements_sentinel_minus; // libcis


void test_ranges_range_adaptors_range_elements_sentinel_minus() {
  test();
  static_assert(test());
