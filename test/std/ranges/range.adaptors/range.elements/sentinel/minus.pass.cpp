// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_sentinel_minus_79ab6213).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_sentinel_minus_79ab6213 { // libcis
template <bool Const>
struct Iter {
  std::tuple<int>* it_;
...
} // libcis_ns_ranges_range_adaptors_range_elements_sentinel_minus_79ab6213 (libcis)
