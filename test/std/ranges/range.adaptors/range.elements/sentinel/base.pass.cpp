// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_sentinel_base_fe18d4a5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_sentinel_base_fe18d4a5 { // libcis
struct Sent {
  int i;
...
} // libcis_ns_ranges_range_adaptors_range_elements_sentinel_base_fe18d4a5 (libcis)
