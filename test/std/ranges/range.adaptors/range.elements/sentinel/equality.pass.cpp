// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_sentinel_equality_ca3f139b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_sentinel_equality_ca3f139b { // libcis
template <bool Const>
struct Iter {
  std::tuple<int>* it_;
...
} // libcis_ns_ranges_range_adaptors_range_elements_sentinel_equality_ca3f139b (libcis)
