// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_sentinel_ctor_convert_c86a13d5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_sentinel_ctor_convert_c86a13d5 { // libcis
struct Sent {
  int i;
...
} // libcis_ns_ranges_range_adaptors_range_elements_sentinel_ctor_convert_c86a13d5 (libcis)
