// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_range_concept).
...
namespace libcis_ns_ranges_range_adaptors_range_elements_range_concept { // libcis: isolate file-scope helpers
template <class It>
...
} using namespace libcis_ns_ranges_range_adaptors_range_elements_range_concept; // libcis
