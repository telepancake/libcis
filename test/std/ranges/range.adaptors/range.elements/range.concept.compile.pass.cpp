// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_elements_range_concept_1fb52836).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_elements_range_concept_1fb52836 { // libcis
template <class It>
...
} // libcis_ns_ranges_range_adaptors_range_elements_range_concept_1fb52836 (libcis)
