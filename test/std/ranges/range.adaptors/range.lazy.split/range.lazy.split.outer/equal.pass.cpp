// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_range_lazy_split_outer_equal_9a389fce).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_range_lazy_split_outer_equal_9a389fce { // libcis
constexpr bool test() {
...
} // libcis_ns_ranges_range_adaptors_range_lazy_split_range_lazy_split_outer_equal_9a389fce (libcis)
