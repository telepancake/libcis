// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_ctor_view_be1ba6d5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_ctor_view_be1ba6d5 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_lazy_split_ctor_view_be1ba6d5 (libcis)
