// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_ctor_view).
// main -> test_ranges_range_adaptors_range_lazy_split_ctor_view; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_ctor_view { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_lazy_split_ctor_view; // libcis


void test_ranges_range_adaptors_range_lazy_split_ctor_view() {
  test();
  static_assert(test());
