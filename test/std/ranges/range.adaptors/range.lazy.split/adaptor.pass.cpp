// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_adaptor_a4e1c53a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_adaptor_a4e1c53a { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_lazy_split_adaptor_a4e1c53a (libcis)
