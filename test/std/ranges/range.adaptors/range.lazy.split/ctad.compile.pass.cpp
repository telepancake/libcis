// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_ctad_d81e5b5e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_ctad_d81e5b5e { // libcis
struct ForwardRange {
...
} // libcis_ns_ranges_range_adaptors_range_lazy_split_ctad_d81e5b5e (libcis)
