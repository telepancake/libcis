// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_end).
// main -> test_ranges_range_adaptors_range_lazy_split_end; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_end { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_lazy_split_end; // libcis


void test_ranges_range_adaptors_range_lazy_split_end() {
  test();
  static_assert(test());
