// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_ctor_range_e876c166).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_ctor_range_e876c166 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_lazy_split_ctor_range_e876c166 (libcis)
