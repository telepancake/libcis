// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_range_lazy_split_inner_ctor_outer_iterator_a220132f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_range_lazy_split_inner_ctor_outer_iterator_a220132f { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_lazy_split_range_lazy_split_inner_ctor_outer_iterator_a220132f (libcis)
