// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_range_lazy_split_inner_iter_swap_b518f54d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_range_lazy_split_inner_iter_swap_b518f54d { // libcis
namespace adl {
...
} // libcis_ns_ranges_range_adaptors_range_lazy_split_range_lazy_split_inner_iter_swap_b518f54d (libcis)
