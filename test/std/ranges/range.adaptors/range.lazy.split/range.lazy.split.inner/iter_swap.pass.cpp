// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_range_lazy_split_inner_iter_swap).
// main -> test_ranges_range_adaptors_range_lazy_split_range_lazy_split_inner_iter_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_range_lazy_split_inner_iter_swap { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_ranges_range_adaptors_range_lazy_split_range_lazy_split_inner_iter_swap; // libcis


void test_ranges_range_adaptors_range_lazy_split_range_lazy_split_inner_iter_swap() {
  test();
  static_assert(test());
