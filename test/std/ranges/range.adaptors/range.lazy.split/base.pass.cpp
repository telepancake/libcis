// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_base_2553ac81).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_base_2553ac81 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_lazy_split_base_2553ac81 (libcis)
