// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_begin_e7be8b17).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_begin_e7be8b17 { // libcis
template <class View>
...
} // libcis_ns_ranges_range_adaptors_range_lazy_split_begin_e7be8b17 (libcis)
