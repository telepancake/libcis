// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_view_interface_3c51cbad).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_view_interface_3c51cbad { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_lazy_split_view_interface_3c51cbad (libcis)
