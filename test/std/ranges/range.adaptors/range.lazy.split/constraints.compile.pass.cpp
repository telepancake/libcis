// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_constraints).
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_constraints { // libcis: isolate file-scope helpers
struct ForwardRange {
...
} using namespace libcis_ns_ranges_range_adaptors_range_lazy_split_constraints; // libcis
