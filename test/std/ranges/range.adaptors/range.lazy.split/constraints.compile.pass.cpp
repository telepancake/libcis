// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_lazy_split_constraints_d4acc637).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_lazy_split_constraints_d4acc637 { // libcis
struct ForwardRange {
...
} // libcis_ns_ranges_range_adaptors_range_lazy_split_constraints_d4acc637 (libcis)
 // namespace test9
