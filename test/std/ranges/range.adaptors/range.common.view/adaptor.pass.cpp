// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_common_view_adaptor).
// main -> test_ranges_range_adaptors_range_common_view_adaptor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_common_view_adaptor { // libcis: isolate file-scope helpers
constexpr bool test() {
  int buf[] = {1, 2, 3};
...
} using namespace libcis_ns_ranges_range_adaptors_range_common_view_adaptor; // libcis


void test_ranges_range_adaptors_range_common_view_adaptor() {
  test();
  static_assert(test());
