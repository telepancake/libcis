// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_common_view_adaptor_b0c89248).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_common_view_adaptor_b0c89248 { // libcis
constexpr bool test() {
  int buf[] = {1, 2, 3};
...
} // libcis_ns_ranges_range_adaptors_range_common_view_adaptor_b0c89248 (libcis)
