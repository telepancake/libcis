// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_common_view_end_8830cc3c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_common_view_end_8830cc3c { // libcis
constexpr bool test() {
...
} // libcis_ns_ranges_range_adaptors_range_common_view_end_8830cc3c (libcis)
