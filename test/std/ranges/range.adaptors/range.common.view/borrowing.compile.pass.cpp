// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_common_view_borrowing_d5f4cb07).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_common_view_borrowing_d5f4cb07 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_common_view_borrowing_d5f4cb07 (libcis)
