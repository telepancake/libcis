// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_counted_counted).
// main -> test_ranges_range_adaptors_range_counted_counted; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_counted_counted { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_counted_counted; // libcis


void test_ranges_range_adaptors_range_counted_counted() {
  test();
  static_assert(test());
