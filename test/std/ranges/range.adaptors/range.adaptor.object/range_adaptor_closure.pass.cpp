// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_adaptor_object_range_adaptor_closure).
// main -> test_ranges_range_adaptors_range_adaptor_object_range_adaptor_closure; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_adaptor_object_range_adaptor_closure { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_ranges_range_adaptors_range_adaptor_object_range_adaptor_closure; // libcis


void test_ranges_range_adaptors_range_adaptor_object_range_adaptor_closure() {
  test();
  static_assert(test());
