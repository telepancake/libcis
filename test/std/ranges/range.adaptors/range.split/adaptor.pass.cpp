// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_split_adaptor_ebf21085).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_split_adaptor_ebf21085 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_split_adaptor_ebf21085 (libcis)
