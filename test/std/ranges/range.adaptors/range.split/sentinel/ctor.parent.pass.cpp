// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_split_sentinel_ctor_parent_a4e1958c).
//===----------------------------------------------------------------------===//
//
...
// test explicit
namespace libcis_ns_ranges_range_adaptors_range_split_sentinel_ctor_parent_a4e1958c { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_split_sentinel_ctor_parent_a4e1958c (libcis)
