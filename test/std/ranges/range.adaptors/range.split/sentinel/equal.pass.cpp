// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_split_sentinel_equal).
// main -> test_ranges_range_adaptors_range_split_sentinel_equal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_split_sentinel_equal { // libcis: isolate file-scope helpers
template <class Iter>
...
} using namespace libcis_ns_ranges_range_adaptors_range_split_sentinel_equal; // libcis


void test_ranges_range_adaptors_range_split_sentinel_equal() {
  test();
  static_assert(test());
