// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_split_sentinel_equal_1a41053d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_split_sentinel_equal_1a41053d { // libcis
template <class Iter>
...
} // libcis_ns_ranges_range_adaptors_range_split_sentinel_equal_1a41053d (libcis)
