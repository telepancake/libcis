// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_split_ctor_range_940a028b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_split_ctor_range_940a028b { // libcis
struct Counting {
...
} // libcis_ns_ranges_range_adaptors_range_split_ctor_range_940a028b (libcis)
