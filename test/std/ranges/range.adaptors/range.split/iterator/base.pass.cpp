// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_split_iterator_base_4669ce01).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_split_iterator_base_4669ce01 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_split_iterator_base_4669ce01 (libcis)
