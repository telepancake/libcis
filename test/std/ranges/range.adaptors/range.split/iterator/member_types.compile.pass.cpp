// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_split_iterator_member_types_5d469914).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_split_iterator_member_types_5d469914 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_split_iterator_member_types_5d469914 (libcis)
