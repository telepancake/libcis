// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_split_iterator_increment_4d249016).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_split_iterator_increment_4d249016 { // libcis
template <class Iter>
...
} // libcis_ns_ranges_range_adaptors_range_split_iterator_increment_4d249016 (libcis)
