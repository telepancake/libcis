// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_split_general).
// main -> test_ranges_range_adaptors_range_split_general; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_split_general { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_split_general; // libcis


void test_ranges_range_adaptors_range_split_general() {
  example_test();
