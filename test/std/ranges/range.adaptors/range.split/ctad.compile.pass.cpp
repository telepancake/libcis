// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_split_ctad_b741f7e1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_split_ctad_b741f7e1 { // libcis
struct Container {
  int* begin() const;
  int* end() const;
};
...
} // libcis_ns_ranges_range_adaptors_range_split_ctad_b741f7e1 (libcis)
