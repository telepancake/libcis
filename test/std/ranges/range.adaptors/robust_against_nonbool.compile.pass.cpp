// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_robust_against_nonbool).
...
namespace libcis_ns_ranges_range_adaptors_robust_against_nonbool { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_robust_against_nonbool; // libcis
