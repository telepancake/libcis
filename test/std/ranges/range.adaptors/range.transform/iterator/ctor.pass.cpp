// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_transform_iterator_ctor).
// main -> test_ranges_range_adaptors_range_transform_iterator_ctor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_ctor { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_ctor; // libcis


void test_ranges_range_adaptors_range_transform_iterator_ctor() {
  test();
  static_assert(test());
