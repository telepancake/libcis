// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_transform_iterator_base_69ade9e3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_base_69ade9e3 { // libcis
constexpr bool test() {
  {
...
} // libcis_ns_ranges_range_adaptors_range_transform_iterator_base_69ade9e3 (libcis)
