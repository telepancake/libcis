// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_transform_iterator_sentinel).
// main -> test_ranges_range_adaptors_range_transform_iterator_sentinel; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_sentinel { // libcis: isolate file-scope helpers
template<class T>
...
} using namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_sentinel; // libcis


void test_ranges_range_adaptors_range_transform_iterator_sentinel() {
  test();
  static_assert(test());
