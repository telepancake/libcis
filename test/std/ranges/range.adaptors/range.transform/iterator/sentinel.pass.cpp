// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_transform_iterator_sentinel_c62427c5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_sentinel_c62427c5 { // libcis
template<class T>
...
} // libcis_ns_ranges_range_adaptors_range_transform_iterator_sentinel_c62427c5 (libcis)
