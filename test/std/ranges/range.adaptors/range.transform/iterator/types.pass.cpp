// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_transform_iterator_types).
// main -> test_ranges_range_adaptors_range_transform_iterator_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_types; // libcis


void test_ranges_range_adaptors_range_transform_iterator_types() {
  test();
  static_assert(test());
