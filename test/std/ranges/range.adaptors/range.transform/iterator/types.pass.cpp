// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_transform_iterator_types_12674e1a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_types_12674e1a { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_transform_iterator_types_12674e1a (libcis)
