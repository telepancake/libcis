// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_transform_iterator_subscript).
// main -> test_ranges_range_adaptors_range_transform_iterator_subscript; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_subscript { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_subscript; // libcis


void test_ranges_range_adaptors_range_transform_iterator_subscript() {
  test();
  static_assert(test());
