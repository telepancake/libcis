// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_transform_iterator_deref).
// main -> test_ranges_range_adaptors_range_transform_iterator_deref; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_ranges_range_adaptors_range_transform_iterator_deref() {
  {
