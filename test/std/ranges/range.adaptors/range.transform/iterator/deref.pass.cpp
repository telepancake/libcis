// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_transform_iterator_deref_90a070eb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_deref_90a070eb { // libcis
int main(int, char**) {
  {
...
} // libcis_ns_ranges_range_adaptors_range_transform_iterator_deref_90a070eb (libcis)
