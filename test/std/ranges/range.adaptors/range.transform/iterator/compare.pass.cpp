// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_transform_iterator_compare).
// main -> test_ranges_range_adaptors_range_transform_iterator_compare; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_compare { // libcis: isolate file-scope helpers
constexpr bool test() {
  {
...
} using namespace libcis_ns_ranges_range_adaptors_range_transform_iterator_compare; // libcis


void test_ranges_range_adaptors_range_transform_iterator_compare() {
  test();
  static_assert(test());
