// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_transform_base_3efedc36).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_transform_base_3efedc36 { // libcis
constexpr bool test() {
  {
...
} // libcis_ns_ranges_range_adaptors_range_transform_base_3efedc36 (libcis)
