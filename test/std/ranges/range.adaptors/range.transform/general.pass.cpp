// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_transform_general).
// main -> test_ranges_range_adaptors_range_transform_general; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_transform_general { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_transform_general; // libcis


void test_ranges_range_adaptors_range_transform_general() {
  {
