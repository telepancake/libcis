// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_chunk_by_constraints).
...
namespace libcis_ns_ranges_range_adaptors_range_chunk_by_constraints { // libcis: isolate file-scope helpers
template <class View, class Pred>
concept CanFormChunkByView = requires { typename std::ranges::chunk_by_view<View, Pred>; };
} using namespace libcis_ns_ranges_range_adaptors_range_chunk_by_constraints; // libcis
