// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_chunk_by_adaptor).
// main -> test_ranges_range_adaptors_range_chunk_by_adaptor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_chunk_by_adaptor { // libcis: isolate file-scope helpers
struct Pred {
...
} using namespace libcis_ns_ranges_range_adaptors_range_chunk_by_adaptor; // libcis


void test_ranges_range_adaptors_range_chunk_by_adaptor() {
  test();
  static_assert(test());
