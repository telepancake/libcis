// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_chunk_by_range_chunk_by_iter_types).
...
namespace libcis_ns_ranges_range_adaptors_range_chunk_by_range_chunk_by_iter_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_chunk_by_range_chunk_by_iter_types; // libcis
