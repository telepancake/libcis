// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_chunk_by_range_chunk_by_iter_decrement).
// main -> test_ranges_range_adaptors_range_chunk_by_range_chunk_by_iter_decrement; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_chunk_by_range_chunk_by_iter_decrement { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_ranges_range_adaptors_range_chunk_by_range_chunk_by_iter_decrement; // libcis


void test_ranges_range_adaptors_range_chunk_by_range_chunk_by_iter_decrement() {
  tests();
  static_assert(tests());
