// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_chunk_by_range_chunk_by_iter_compare).
// main -> test_ranges_range_adaptors_range_chunk_by_range_chunk_by_iter_compare; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_chunk_by_range_chunk_by_iter_compare { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_chunk_by_range_chunk_by_iter_compare; // libcis


void test_ranges_range_adaptors_range_chunk_by_range_chunk_by_iter_compare() {
  tests();
  static_assert(tests());
  return;
}
