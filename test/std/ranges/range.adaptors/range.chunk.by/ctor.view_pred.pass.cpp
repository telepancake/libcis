// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_chunk_by_ctor_view_pred).
// main -> test_ranges_range_adaptors_range_chunk_by_ctor_view_pred; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_chunk_by_ctor_view_pred { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_chunk_by_ctor_view_pred; // libcis


void test_ranges_range_adaptors_range_chunk_by_ctor_view_pred() {
  test();
  static_assert(test());
