// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_drop_ctor_view_6ed04395).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_drop_ctor_view_6ed04395 { // libcis
#if TEST_STD_VER >= 23
...
} // libcis_ns_ranges_range_adaptors_range_drop_ctor_view_6ed04395 (libcis)
