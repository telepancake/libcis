// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_drop_end_ba699928).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_drop_end_ba699928 { // libcis
constexpr bool test() {
  // range<const V>
...
} // libcis_ns_ranges_range_adaptors_range_drop_end_ba699928 (libcis)
