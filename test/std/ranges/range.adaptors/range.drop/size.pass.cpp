// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_drop_size).
// main -> test_ranges_range_adaptors_range_drop_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_drop_size { // libcis: isolate file-scope helpers
template<class T>
...
} using namespace libcis_ns_ranges_range_adaptors_range_drop_size; // libcis


void test_ranges_range_adaptors_range_drop_size() {
  test();
  static_assert(test());
