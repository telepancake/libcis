// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_drop_general_5a156491).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_drop_general_5a156491 { // libcis
template<class T>
...
} // libcis_ns_ranges_range_adaptors_range_drop_general_5a156491 (libcis)
