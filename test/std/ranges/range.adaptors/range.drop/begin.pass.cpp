// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_drop_begin_761f2f47).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_drop_begin_761f2f47 { // libcis
template<class T>
...
} // libcis_ns_ranges_range_adaptors_range_drop_begin_761f2f47 (libcis)
