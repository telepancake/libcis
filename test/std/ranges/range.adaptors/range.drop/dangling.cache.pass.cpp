// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_drop_dangling_cache).
// main -> test_ranges_range_adaptors_range_drop_dangling_cache; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_drop_dangling_cache { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_drop_dangling_cache; // libcis


void test_ranges_range_adaptors_range_drop_dangling_cache() {
