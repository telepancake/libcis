// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_drop_while_adaptor_90fcc56c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_drop_while_adaptor_90fcc56c { // libcis
struct Pred {
...
} // libcis_ns_ranges_range_adaptors_range_drop_while_adaptor_90fcc56c (libcis)
