// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_drop_while_ctor_default_1f80873f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_drop_while_ctor_default_1f80873f { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_drop_while_ctor_default_1f80873f (libcis)
