// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_drop_while_ctad_dc50e38d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_drop_while_ctad_dc50e38d { // libcis
struct Container {
  int* begin() const;
  int* end() const;
};
...
} // libcis_ns_ranges_range_adaptors_range_drop_while_ctad_dc50e38d (libcis)
