// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_drop_while_borrowed).
...
namespace libcis_ns_ranges_range_adaptors_range_drop_while_borrowed { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_drop_while_borrowed; // libcis
