// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_drop_while_base_a7c80fe1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_drop_while_base_a7c80fe1 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_drop_while_base_a7c80fe1 (libcis)
