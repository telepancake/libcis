// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_drop_while_range_concept).
...
namespace libcis_ns_ranges_range_adaptors_range_drop_while_range_concept { // libcis: isolate file-scope helpers
template <class It>
...
static_assert(!HasDropWhileView<Range<int**>, Pred<int>>);
} using namespace libcis_ns_ranges_range_adaptors_range_drop_while_range_concept; // libcis
