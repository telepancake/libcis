// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_drop_while_begin_c020a400).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_drop_while_begin_c020a400 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_drop_while_begin_c020a400 (libcis)
