// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_while_begin_4065ef71).
//===----------------------------------------------------------------------===//
//
...
// Test Constraints
namespace libcis_ns_ranges_range_adaptors_range_take_while_begin_4065ef71 { // libcis
template <class T>
...
} // libcis_ns_ranges_range_adaptors_range_take_while_begin_4065ef71 (libcis)
