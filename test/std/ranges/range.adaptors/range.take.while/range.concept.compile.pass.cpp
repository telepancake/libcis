// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_while_range_concept_b24b43ab).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_while_range_concept_b24b43ab { // libcis
template <class It>
...
static_assert(!HasTakeWhileView<Range<int**>, Pred<int>>);
} // libcis_ns_ranges_range_adaptors_range_take_while_range_concept_b24b43ab (libcis)
