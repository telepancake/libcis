// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_while_sentinel_equality_e2212956).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_while_sentinel_equality_e2212956 { // libcis
template <bool Const>
struct Iter {
  int* it_;
...
} // libcis_ns_ranges_range_adaptors_range_take_while_sentinel_equality_e2212956 (libcis)
