// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_while_sentinel_ctor_convert).
// main -> test_ranges_range_adaptors_range_take_while_sentinel_ctor_convert; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_while_sentinel_ctor_convert { // libcis: isolate file-scope helpers
struct Sent {
  int i;
...
} using namespace libcis_ns_ranges_range_adaptors_range_take_while_sentinel_ctor_convert; // libcis


void test_ranges_range_adaptors_range_take_while_sentinel_ctor_convert() {
  test();
  static_assert(test());
