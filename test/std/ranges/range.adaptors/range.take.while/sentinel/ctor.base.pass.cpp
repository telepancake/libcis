// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_while_sentinel_ctor_base_ea4e6117).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_while_sentinel_ctor_base_ea4e6117 { // libcis
struct Sent {
  int i;
...
} // libcis_ns_ranges_range_adaptors_range_take_while_sentinel_ctor_base_ea4e6117 (libcis)
