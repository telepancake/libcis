// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_while_base_0d17b56f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_while_base_0d17b56f { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_take_while_base_0d17b56f (libcis)
