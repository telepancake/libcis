// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_while_ctor_default_1de92aa5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_while_ctor_default_1de92aa5 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_take_while_ctor_default_1de92aa5 (libcis)
