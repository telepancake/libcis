// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_while_adaptor_84aa57e0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_take_while_adaptor_84aa57e0 { // libcis
struct Pred {
...
} // libcis_ns_ranges_range_adaptors_range_take_while_adaptor_84aa57e0 (libcis)
