// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_take_while_end_65541d20).
//===----------------------------------------------------------------------===//
//
...
// Test Constraints
namespace libcis_ns_ranges_range_adaptors_range_take_while_end_65541d20 { // libcis
template <class T>
...
} // libcis_ns_ranges_range_adaptors_range_take_while_end_65541d20 (libcis)
