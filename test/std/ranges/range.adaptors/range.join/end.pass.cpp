// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_join_end_a7d747b8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_join_end_a7d747b8 { // libcis
template <class T>
...
} // libcis_ns_ranges_range_adaptors_range_join_end_a7d747b8 (libcis)
