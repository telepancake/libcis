// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_join_range_join_iterator_arrow).
// main -> test_ranges_range_adaptors_range_join_range_join_iterator_arrow; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_join_range_join_iterator_arrow { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_ranges_range_adaptors_range_join_range_join_iterator_arrow; // libcis


void test_ranges_range_adaptors_range_join_range_join_iterator_arrow() {
  test();
  static_assert(test());
