// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_join_range_join_iterator_eq_1d886ced).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_join_range_join_iterator_eq_1d886ced { // libcis
constexpr bool test() {
...
} // libcis_ns_ranges_range_adaptors_range_join_range_join_iterator_eq_1d886ced (libcis)
