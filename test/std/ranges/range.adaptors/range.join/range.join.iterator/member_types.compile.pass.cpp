// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_join_range_join_iterator_member_types_6d3724ea).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_join_range_join_iterator_member_types_6d3724ea { // libcis
template<class T>
...
} // libcis_ns_ranges_range_adaptors_range_join_range_join_iterator_member_types_6d3724ea (libcis)
