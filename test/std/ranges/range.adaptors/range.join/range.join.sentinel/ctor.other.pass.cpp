// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_join_range_join_sentinel_ctor_other).
// main -> test_ranges_range_adaptors_range_join_range_join_sentinel_ctor_other; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_join_range_join_sentinel_ctor_other { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_ranges_range_adaptors_range_join_range_join_sentinel_ctor_other; // libcis


void test_ranges_range_adaptors_range_join_range_join_sentinel_ctor_other() {
  test();
  static_assert(test());
