// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_join_range_join_sentinel_ctor_other_32614585).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_join_range_join_sentinel_ctor_other_32614585 { // libcis
template <class T>
...
} // libcis_ns_ranges_range_adaptors_range_join_range_join_sentinel_ctor_other_32614585 (libcis)
