// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_join_range_join_sentinel_eq).
// main -> test_ranges_range_adaptors_range_join_range_join_sentinel_eq; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_join_range_join_sentinel_eq { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_join_range_join_sentinel_eq; // libcis


void test_ranges_range_adaptors_range_join_range_join_sentinel_eq() {
  test();
  static_assert(test());
