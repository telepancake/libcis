// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_join_range_join_sentinel_ctor_parent_9290d7b8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_join_range_join_sentinel_ctor_parent_9290d7b8 { // libcis
constexpr bool test() {
...
} // libcis_ns_ranges_range_adaptors_range_join_range_join_sentinel_ctor_parent_9290d7b8 (libcis)
