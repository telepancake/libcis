// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_join_ctad).
...
namespace libcis_ns_ranges_range_adaptors_range_join_ctad { // libcis: isolate file-scope helpers
struct Child {
  int *begin() const;
  int *end() const;
};
...
} using namespace libcis_ns_ranges_range_adaptors_range_join_ctad; // libcis
