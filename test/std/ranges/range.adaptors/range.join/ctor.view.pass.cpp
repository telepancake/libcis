// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_join_ctor_view).
// main -> test_ranges_range_adaptors_range_join_ctor_view; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_join_ctor_view { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_ranges_range_adaptors_range_join_ctor_view; // libcis


void test_ranges_range_adaptors_range_join_ctor_view() {
  test();
  static_assert(test());
