// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_join_lwg3698_bcca8258).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_join_lwg3698_bcca8258 { // libcis
int main(int, char**) {
...
} // libcis_ns_ranges_range_adaptors_range_join_lwg3698_bcca8258 (libcis)
