// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_join_lwg3698).
// main -> test_ranges_range_adaptors_range_join_lwg3698; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_ranges_range_adaptors_range_join_lwg3698() {
