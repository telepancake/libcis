// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_zip_range_concept).
...
namespace libcis_ns_ranges_range_adaptors_range_zip_range_concept { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_zip_range_concept; // libcis
