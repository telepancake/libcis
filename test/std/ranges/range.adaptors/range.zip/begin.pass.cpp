// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_zip_begin).
// main -> test_ranges_range_adaptors_range_zip_begin; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_zip_begin { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_ranges_range_adaptors_range_zip_begin; // libcis


void test_ranges_range_adaptors_range_zip_begin() {
  test();
  static_assert(test());
