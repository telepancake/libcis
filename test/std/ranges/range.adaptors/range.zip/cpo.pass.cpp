// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_zip_cpo).
// main -> test_ranges_range_adaptors_range_zip_cpo; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_zip_cpo { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_zip_cpo; // libcis


void test_ranges_range_adaptors_range_zip_cpo() {
  test();
  static_assert(test());
