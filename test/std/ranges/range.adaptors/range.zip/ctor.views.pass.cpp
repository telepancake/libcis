// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_zip_ctor_views).
// main -> test_ranges_range_adaptors_range_zip_ctor_views; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_zip_ctor_views { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_ranges_range_adaptors_range_zip_ctor_views; // libcis


void test_ranges_range_adaptors_range_zip_ctor_views() {
  test();
  static_assert(test());
