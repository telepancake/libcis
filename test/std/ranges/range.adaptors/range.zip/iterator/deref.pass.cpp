// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_zip_iterator_deref).
// main -> test_ranges_range_adaptors_range_zip_iterator_deref; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_zip_iterator_deref { // libcis: isolate file-scope helpers
constexpr bool test() {
  std::array a{1, 2, 3, 4};
...
} using namespace libcis_ns_ranges_range_adaptors_range_zip_iterator_deref; // libcis


void test_ranges_range_adaptors_range_zip_iterator_deref() {
  test();
  static_assert(test());
