// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_zip_iterator_arithmetic).
// main -> test_ranges_range_adaptors_range_zip_iterator_arithmetic; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_zip_iterator_arithmetic { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_zip_iterator_arithmetic; // libcis


void test_ranges_range_adaptors_range_zip_iterator_arithmetic() {
  test();
  static_assert(test());
