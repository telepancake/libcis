// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_zip_sentinel_minus).
// main -> test_ranges_range_adaptors_range_zip_sentinel_minus; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// clang-format off
namespace libcis_ns_ranges_range_adaptors_range_zip_sentinel_minus { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_zip_sentinel_minus; // libcis


void test_ranges_range_adaptors_range_zip_sentinel_minus() {
  test();
  static_assert(test());
