// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_zip_borrowing).
...
namespace libcis_ns_ranges_range_adaptors_range_zip_borrowing { // libcis: isolate file-scope helpers
struct Borrowed : std::ranges::view_base {
  int* begin() const;
  int* end() const;
};
} using namespace libcis_ns_ranges_range_adaptors_range_zip_borrowing; // libcis
