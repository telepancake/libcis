// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_begin_ebc8bb64).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_begin_ebc8bb64 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_filter_begin_ebc8bb64 (libcis)
