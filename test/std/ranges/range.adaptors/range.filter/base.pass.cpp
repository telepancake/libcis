// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_base).
// main -> test_ranges_range_adaptors_range_filter_base; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_base { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_filter_base; // libcis


void test_ranges_range_adaptors_range_filter_base() {
  test();
  static_assert(test());
