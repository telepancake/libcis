// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_base_b5d15dc8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_base_b5d15dc8 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_filter_base_b5d15dc8 (libcis)
