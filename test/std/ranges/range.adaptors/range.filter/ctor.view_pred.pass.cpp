// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_ctor_view_pred_7c0767a7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_ctor_view_pred_7c0767a7 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_filter_ctor_view_pred_7c0767a7 (libcis)
