// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_constraints).
...
namespace libcis_ns_ranges_range_adaptors_range_filter_constraints { // libcis: isolate file-scope helpers
template <class View, class Pred>
concept can_form_filter_view = requires {
  typename std::ranges::filter_view<View, Pred>;
};
} using namespace libcis_ns_ranges_range_adaptors_range_filter_constraints; // libcis
