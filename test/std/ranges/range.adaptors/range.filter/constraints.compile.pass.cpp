// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_constraints_ccb7eedf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_constraints_ccb7eedf { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_filter_constraints_ccb7eedf (libcis)
