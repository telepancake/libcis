// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_ctad_ddcfbd04).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_ctad_ddcfbd04 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_filter_ctad_ddcfbd04 (libcis)
