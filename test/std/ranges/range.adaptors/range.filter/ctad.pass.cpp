// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_ctad).
// main -> test_ranges_range_adaptors_range_filter_ctad; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_ctad { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_filter_ctad; // libcis


void test_ranges_range_adaptors_range_filter_ctad() {
  test();
  static_assert(test());
