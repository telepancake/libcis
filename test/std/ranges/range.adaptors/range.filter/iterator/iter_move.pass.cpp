// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_iter_move).
// main -> test_ranges_range_adaptors_range_filter_iterator_iter_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_iter_move { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_iter_move; // libcis


void test_ranges_range_adaptors_range_filter_iterator_iter_move() {
  tests();
  static_assert(tests());
  return;
}
