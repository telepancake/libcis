// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_iter_swap_574c55e2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_iter_swap_574c55e2 { // libcis
template <class It>
...
} // libcis_ns_ranges_range_adaptors_range_filter_iterator_iter_swap_574c55e2 (libcis)
