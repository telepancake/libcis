// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_iter_swap).
// main -> test_ranges_range_adaptors_range_filter_iterator_iter_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_iter_swap { // libcis: isolate file-scope helpers
template <class It>
...
} using namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_iter_swap; // libcis


void test_ranges_range_adaptors_range_filter_iterator_iter_swap() {
  tests();
  static_assert(tests());
  return;
}
