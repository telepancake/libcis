// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_ctor_parent_iter_ee52e4a2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_ctor_parent_iter_ee52e4a2 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_filter_iterator_ctor_parent_iter_ee52e4a2 (libcis)
