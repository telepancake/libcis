// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_compare_a532dfb8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_compare_a532dfb8 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_filter_iterator_compare_a532dfb8 (libcis)
