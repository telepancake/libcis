// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_deref).
// main -> test_ranges_range_adaptors_range_filter_iterator_deref; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_deref { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_deref; // libcis


void test_ranges_range_adaptors_range_filter_iterator_deref() {
  tests();
  static_assert(tests());
  return;
}
