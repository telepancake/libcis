// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_deref_726edab6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_deref_726edab6 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_filter_iterator_deref_726edab6 (libcis)
