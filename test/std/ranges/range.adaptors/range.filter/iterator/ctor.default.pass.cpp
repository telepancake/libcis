// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_ctor_default_32de9439).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_ctor_default_32de9439 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_filter_iterator_ctor_default_32de9439 (libcis)
