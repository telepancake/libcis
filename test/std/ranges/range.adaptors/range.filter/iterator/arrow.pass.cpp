// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_arrow).
// main -> test_ranges_range_adaptors_range_filter_iterator_arrow; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_arrow { // libcis: isolate file-scope helpers
struct XYPoint {
  int x;
  int y;
};
...
} using namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_arrow; // libcis


void test_ranges_range_adaptors_range_filter_iterator_arrow() {
  tests();
  static_assert(tests());
  return;
}
