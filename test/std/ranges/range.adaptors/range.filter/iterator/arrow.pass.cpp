// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_arrow_26a5062c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_arrow_26a5062c { // libcis
struct XYPoint {
  int x;
  int y;
};
...
} // libcis_ns_ranges_range_adaptors_range_filter_iterator_arrow_26a5062c (libcis)
