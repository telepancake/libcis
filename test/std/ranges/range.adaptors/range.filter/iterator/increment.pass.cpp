// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_increment_33bb7804).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_increment_33bb7804 { // libcis
struct EqualTo {
  int x;
...
} // libcis_ns_ranges_range_adaptors_range_filter_iterator_increment_33bb7804 (libcis)
