// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_increment).
// main -> test_ranges_range_adaptors_range_filter_iterator_increment; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_increment { // libcis: isolate file-scope helpers
struct EqualTo {
  int x;
...
} using namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_increment; // libcis


void test_ranges_range_adaptors_range_filter_iterator_increment() {
  tests();
  static_assert(tests());
  return;
}
