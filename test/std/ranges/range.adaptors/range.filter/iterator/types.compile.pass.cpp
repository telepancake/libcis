// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_types_5027ab87).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_types_5027ab87 { // libcis
template <typename T>
...
} // libcis_ns_ranges_range_adaptors_range_filter_iterator_types_5027ab87 (libcis)
