// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_iterator_types).
...
namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_types { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_ranges_range_adaptors_range_filter_iterator_types; // libcis
