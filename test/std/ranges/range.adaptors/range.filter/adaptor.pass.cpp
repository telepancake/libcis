// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_adaptor).
// main -> test_ranges_range_adaptors_range_filter_adaptor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_adaptor { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_filter_adaptor; // libcis


void test_ranges_range_adaptors_range_filter_adaptor() {
  test();
  static_assert(test());
