// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_ctor_default_463b620c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_ctor_default_463b620c { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_filter_ctor_default_463b620c (libcis)
