// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_filter_sentinel_ctor_parent_b39a8ba7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_filter_sentinel_ctor_parent_b39a8ba7 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_filter_sentinel_ctor_parent_b39a8ba7 (libcis)
