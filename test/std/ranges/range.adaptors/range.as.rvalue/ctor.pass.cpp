// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_as_rvalue_ctor).
// main -> test_ranges_range_adaptors_range_as_rvalue_ctor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_as_rvalue_ctor { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_as_rvalue_ctor; // libcis


void test_ranges_range_adaptors_range_as_rvalue_ctor() {
  static_assert(test());
  test();
