// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_reverse_ctor_view_bc345ff1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_reverse_ctor_view_bc345ff1 { // libcis
constexpr bool test() {
...
} // libcis_ns_ranges_range_adaptors_range_reverse_ctor_view_bc345ff1 (libcis)
