// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_reverse_adaptor).
// main -> test_ranges_range_adaptors_range_reverse_adaptor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_reverse_adaptor { // libcis: isolate file-scope helpers
constexpr bool test() {
  int buf[] = {1, 2, 3};
...
} using namespace libcis_ns_ranges_range_adaptors_range_reverse_adaptor; // libcis


void test_ranges_range_adaptors_range_reverse_adaptor() {
  test();
  static_assert(test());
