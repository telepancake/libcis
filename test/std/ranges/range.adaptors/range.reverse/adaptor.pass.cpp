// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_reverse_adaptor_521043c4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_reverse_adaptor_521043c4 { // libcis
constexpr bool test() {
  int buf[] = {1, 2, 3};
...
} // libcis_ns_ranges_range_adaptors_range_reverse_adaptor_521043c4 (libcis)
