// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_reverse_end_c2aca363).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_reverse_end_c2aca363 { // libcis
constexpr bool test() {
...
} // libcis_ns_ranges_range_adaptors_range_reverse_end_c2aca363 (libcis)
