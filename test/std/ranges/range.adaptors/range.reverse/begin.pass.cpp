// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_reverse_begin).
// main -> test_ranges_range_adaptors_range_reverse_begin; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_reverse_begin { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_reverse_begin; // libcis


void test_ranges_range_adaptors_range_reverse_begin() {
  test();
  static_assert(test());
