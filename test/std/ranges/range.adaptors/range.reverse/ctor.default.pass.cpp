// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_reverse_ctor_default_a799d3a0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_reverse_ctor_default_a799d3a0 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_reverse_ctor_default_a799d3a0 (libcis)
