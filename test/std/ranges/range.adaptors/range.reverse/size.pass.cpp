// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_reverse_size_e1d7fe34).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_reverse_size_e1d7fe34 { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_reverse_size_e1d7fe34 (libcis)
