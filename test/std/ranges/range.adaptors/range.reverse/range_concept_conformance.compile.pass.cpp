// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_reverse_range_concept_conformance_04ed6c0d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_reverse_range_concept_conformance_04ed6c0d { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_reverse_range_concept_conformance_04ed6c0d (libcis)
