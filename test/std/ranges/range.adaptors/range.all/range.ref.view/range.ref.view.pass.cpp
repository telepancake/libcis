// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_all_range_ref_view_range_ref_view).
// main -> test_ranges_range_adaptors_range_all_range_ref_view_range_ref_view; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_all_range_ref_view_range_ref_view { // libcis: isolate file-scope helpers
int globalBuff[8];
...
} using namespace libcis_ns_ranges_range_adaptors_range_all_range_ref_view_range_ref_view; // libcis
...
void test_ranges_range_adaptors_range_all_range_ref_view_range_ref_view() {
  test();
  static_assert(test());
