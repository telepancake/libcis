// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_all_range_owning_view_begin_end).
// main -> test_ranges_range_adaptors_range_all_range_owning_view_begin_end; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_all_range_owning_view_begin_end { // libcis: isolate file-scope helpers
struct Base {
...
} using namespace libcis_ns_ranges_range_adaptors_range_all_range_owning_view_begin_end; // libcis


void test_ranges_range_adaptors_range_all_range_owning_view_begin_end() {
  test();
  static_assert(test());
