// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_all_range_owning_view_begin_end_13a4874e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_all_range_owning_view_begin_end_13a4874e { // libcis
struct Base {
...
} // libcis_ns_ranges_range_adaptors_range_all_range_owning_view_begin_end_13a4874e (libcis)
