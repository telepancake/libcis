// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_all_range_owning_view_constructor_be5e0d6b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_all_range_owning_view_constructor_be5e0d6b { // libcis
...
} // libcis_ns_ranges_range_adaptors_range_all_range_owning_view_constructor_be5e0d6b (libcis)
