// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_all_range_owning_view_constructor).
// main -> test_ranges_range_adaptors_range_all_range_owning_view_constructor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_all_range_owning_view_constructor { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_all_range_owning_view_constructor; // libcis


void test_ranges_range_adaptors_range_all_range_owning_view_constructor() {
  test();
  static_assert(test());
