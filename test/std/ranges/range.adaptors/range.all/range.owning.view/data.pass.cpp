// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_all_range_owning_view_data_de745555).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_all_range_owning_view_data_de745555 { // libcis
template <class T>
...
} // libcis_ns_ranges_range_adaptors_range_all_range_owning_view_data_de745555 (libcis)
