// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_all_range_owning_view_base_8c997291).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_all_range_owning_view_base_8c997291 { // libcis
struct Base {
  int *begin() const;
  int *end() const;
};
...
} // libcis_ns_ranges_range_adaptors_range_all_range_owning_view_base_8c997291 (libcis)
