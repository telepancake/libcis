// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_all_range_owning_view_size_fd83d70f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_all_range_owning_view_size_fd83d70f { // libcis
template <class T>
...
} // libcis_ns_ranges_range_adaptors_range_all_range_owning_view_size_fd83d70f (libcis)
