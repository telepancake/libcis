// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_all_range_owning_view_empty_b92ff087).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_all_range_owning_view_empty_b92ff087 { // libcis
template <class T>
...
} // libcis_ns_ranges_range_adaptors_range_all_range_owning_view_empty_b92ff087 (libcis)
