// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_all_all_t).
...
namespace libcis_ns_ranges_range_adaptors_range_all_all_t { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_adaptors_range_all_all_t; // libcis
