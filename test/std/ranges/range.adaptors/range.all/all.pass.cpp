// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_adaptors_range_all_all).
// main -> test_ranges_range_adaptors_range_all_all; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_adaptors_range_all_all { // libcis: isolate file-scope helpers
int globalBuff[8];
...
} using namespace libcis_ns_ranges_range_adaptors_range_all_all; // libcis
...
void test_ranges_range_adaptors_range_all_all() {
  test();
  static_assert(test());
