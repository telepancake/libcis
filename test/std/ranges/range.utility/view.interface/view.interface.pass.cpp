// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_utility_view_interface_view_interface).
// main -> test_ranges_range_utility_view_interface_view_interface; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_view_interface_view_interface { // libcis: isolate file-scope helpers
template<class T>
...
} using namespace libcis_ns_ranges_range_utility_view_interface_view_interface; // libcis


void test_ranges_range_utility_view_interface_view_interface() {
  testEmpty();
