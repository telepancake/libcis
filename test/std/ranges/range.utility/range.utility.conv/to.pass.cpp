// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_utility_range_utility_conv_to).
// main -> test_ranges_range_utility_range_utility_conv_to; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_utility_conv_to { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_utility_range_utility_conv_to; // libcis


void test_ranges_range_utility_range_utility_conv_to() {
  test();
  static_assert(test());
