// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_utility_range_utility_conv_to_std_containers).
// main -> test_ranges_range_utility_range_utility_conv_to_std_containers; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_utility_conv_to_std_containers { // libcis: isolate file-scope helpers
...
using all_containers = types::concatenate_t<
    ...
    unordered_maps<K, V>>;
} using namespace libcis_ns_ranges_range_utility_range_utility_conv_to_std_containers; // libcis
...
void test_ranges_range_utility_range_utility_conv_to_std_containers() {
  test();
