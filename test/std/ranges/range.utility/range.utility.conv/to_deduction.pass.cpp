// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_utility_range_utility_conv_to_deduction).
// main -> test_ranges_range_utility_range_utility_conv_to_deduction; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_utility_conv_to_deduction { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_utility_range_utility_conv_to_deduction; // libcis


void test_ranges_range_utility_range_utility_conv_to_deduction() {
  test();
  static_assert(test());
