// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_operator_pair_like_a8f264be).
...
namespace libcis_ns_ranges_range_utility_range_subrange_operator_pair_like_a8f264be { // libcis
...
} // libcis_ns_ranges_range_utility_range_subrange_operator_pair_like_a8f264be (libcis)
