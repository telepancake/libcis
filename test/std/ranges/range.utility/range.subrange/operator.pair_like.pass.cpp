// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_operator_pair_like).
// main -> test_ranges_range_utility_range_subrange_operator_pair_like; file-scope helpers isolated in anon namespace.
...
namespace libcis_ns_ranges_range_utility_range_subrange_operator_pair_like { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_utility_range_subrange_operator_pair_like; // libcis


void test_ranges_range_utility_range_subrange_operator_pair_like() {
  test();
  static_assert(test());
