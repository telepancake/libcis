// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_ctor_range).
// main -> test_ranges_range_utility_range_subrange_ctor_range; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_subrange_ctor_range { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_utility_range_subrange_ctor_range; // libcis


void test_ranges_range_utility_range_subrange_ctor_range() {
  test();
  static_assert(test());
