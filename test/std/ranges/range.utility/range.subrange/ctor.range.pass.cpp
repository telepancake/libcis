// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_ctor_range_d2fd4757).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_subrange_ctor_range_d2fd4757 { // libcis
...
} // libcis_ns_ranges_range_utility_range_subrange_ctor_range_d2fd4757 (libcis)
