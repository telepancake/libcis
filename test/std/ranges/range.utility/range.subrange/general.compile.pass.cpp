// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_general_958baa2e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_subrange_general_958baa2e { // libcis
...
// Not an iterator.
static_assert(!ValidSubrange<int>);
} // libcis_ns_ranges_range_utility_range_subrange_general_958baa2e (libcis)
