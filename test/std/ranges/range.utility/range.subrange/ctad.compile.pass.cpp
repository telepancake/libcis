// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_ctad).
...
namespace libcis_ns_ranges_range_utility_range_subrange_ctad { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_utility_range_subrange_ctad; // libcis
