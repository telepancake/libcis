// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_ctor_begin_end).
// main -> test_ranges_range_utility_range_subrange_ctor_begin_end; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// !StoreSize ctor.
namespace libcis_ns_ranges_range_utility_range_subrange_ctor_begin_end { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_utility_range_subrange_ctor_begin_end; // libcis


void test_ranges_range_utility_range_subrange_ctor_begin_end() {
  test();
  static_assert(test());
