// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_ctor_begin_end_size_386ae5ee).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_subrange_ctor_begin_end_size_386ae5ee { // libcis
...
} // libcis_ns_ranges_range_utility_range_subrange_ctor_begin_end_size_386ae5ee (libcis)
