// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_advance).
// main -> test_ranges_range_utility_range_subrange_advance; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_subrange_advance { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_ranges_range_utility_range_subrange_advance; // libcis


void test_ranges_range_utility_range_subrange_advance() {
  test();
  static_assert(test());
