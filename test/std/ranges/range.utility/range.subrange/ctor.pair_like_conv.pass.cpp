// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_ctor_pair_like_conv).
// main -> test_ranges_range_utility_range_subrange_ctor_pair_like_conv; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_subrange_ctor_pair_like_conv { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_utility_range_subrange_ctor_pair_like_conv; // libcis


void test_ranges_range_utility_range_subrange_ctor_pair_like_conv() {
  test();
  static_assert(test());
