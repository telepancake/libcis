// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_structured_bindings).
// main -> test_ranges_range_utility_range_subrange_structured_bindings; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_subrange_structured_bindings { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_utility_range_subrange_structured_bindings; // libcis


void test_ranges_range_utility_range_subrange_structured_bindings()
{
    test();
    static_assert(test());
