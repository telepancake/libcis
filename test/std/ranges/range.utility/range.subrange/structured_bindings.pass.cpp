// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_structured_bindings_3a9253c5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_subrange_structured_bindings_3a9253c5 { // libcis
...
} // libcis_ns_ranges_range_utility_range_subrange_structured_bindings_3a9253c5 (libcis)
