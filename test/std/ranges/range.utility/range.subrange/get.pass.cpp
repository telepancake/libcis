// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_get).
// main -> test_ranges_range_utility_range_subrange_get; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_subrange_get { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_utility_range_subrange_get; // libcis


void test_ranges_range_utility_range_subrange_get() {
  test();
  static_assert(test());
