// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_get_776a9de1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_subrange_get_776a9de1 { // libcis
...
} // libcis_ns_ranges_range_utility_range_subrange_get_776a9de1 (libcis)
