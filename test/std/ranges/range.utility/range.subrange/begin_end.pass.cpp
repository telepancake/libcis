// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_begin_end_f945aaae).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_subrange_begin_end_f945aaae { // libcis
...
} // libcis_ns_ranges_range_utility_range_subrange_begin_end_f945aaae (libcis)
