// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_utility_range_subrange_lwg3470_0490f182).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_subrange_lwg3470_0490f182 { // libcis
constexpr bool test()
{
...
} // libcis_ns_ranges_range_utility_range_subrange_lwg3470_0490f182 (libcis)
