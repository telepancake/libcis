// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_utility_range_dangling_borrowed_subrange_e7d98a14).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_dangling_borrowed_subrange_e7d98a14 { // libcis
...
} // libcis_ns_ranges_range_utility_range_dangling_borrowed_subrange_e7d98a14 (libcis)
