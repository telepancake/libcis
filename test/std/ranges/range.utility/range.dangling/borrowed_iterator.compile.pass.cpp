// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_utility_range_dangling_borrowed_iterator_33a0e380).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_utility_range_dangling_borrowed_iterator_33a0e380 { // libcis
...
} // libcis_ns_ranges_range_utility_range_dangling_borrowed_iterator_33a0e380 (libcis)
