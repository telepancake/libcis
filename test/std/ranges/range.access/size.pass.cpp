// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_access_size).
// main -> test_ranges_range_access_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_access_size { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_access_size; // libcis
...
void test_ranges_range_access_size() {
  testArrayType();
