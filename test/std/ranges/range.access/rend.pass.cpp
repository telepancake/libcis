// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_access_rend).
// main -> test_ranges_range_access_rend; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_access_rend { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_access_rend; // libcis
...
void test_ranges_range_access_rend() {
