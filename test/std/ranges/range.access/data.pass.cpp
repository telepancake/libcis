// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_access_data).
// main -> test_ranges_range_access_data; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_access_data { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_access_data; // libcis
...
void test_ranges_range_access_data() {
