// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_access_end).
// main -> test_ranges_range_access_end; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_access_end { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_access_end; // libcis
...
void test_ranges_range_access_end() {
