// AST-transferred from libc++ by tools/transfer.py (slug=ranges_range_access_empty).
// main -> test_ranges_range_access_empty; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_access_empty { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_ranges_range_access_empty; // libcis
...
void test_ranges_range_access_empty() {
  testEmptyMember();
