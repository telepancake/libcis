// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_range_access_ssize_7673430d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_range_access_ssize_7673430d { // libcis
...
} // libcis_ns_ranges_range_access_ssize_7673430d (libcis)
