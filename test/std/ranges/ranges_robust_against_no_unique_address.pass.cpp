// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_ranges_robust_against_no_unique_address_fe405d39).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_ranges_ranges_robust_against_no_unique_address_fe405d39 { // libcis
struct Pred {
  alignas(128) bool a{};
...
} // libcis_ns_ranges_ranges_robust_against_no_unique_address_fe405d39 (libcis)
