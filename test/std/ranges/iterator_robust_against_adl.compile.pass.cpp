// transferred+adapted from libc++ by tools/transfer.py (slug=ranges_iterator_robust_against_adl_22221495).
//===----------------------------------------------------------------------===//
//
...
#include <istream>
#endif
namespace libcis_ns_ranges_iterator_robust_against_adl_22221495 { // libcis
namespace adl {
...
} // libcis_ns_ranges_iterator_robust_against_adl_22221495 (libcis)
