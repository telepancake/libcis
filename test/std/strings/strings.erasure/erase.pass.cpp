// transferred+adapted from libc++ by tools/transfer.py (slug=strings_strings_erasure_erase_727440bb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_strings_erasure_erase_727440bb { // libcis
...
} // libcis_ns_strings_strings_erasure_erase_727440bb (libcis)
