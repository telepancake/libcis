// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_literals_noexcept).
...
namespace libcis_ns_strings_basic_string_literals_noexcept { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_basic_string_literals_noexcept; // libcis
