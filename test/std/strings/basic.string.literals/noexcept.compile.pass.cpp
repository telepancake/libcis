// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_literals_noexcept_223c182c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_literals_noexcept_223c182c { // libcis
...
} // libcis_ns_strings_basic_string_literals_noexcept_223c182c (libcis)
