// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_literals_literal).
// main -> test_strings_basic_string_literals_literal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_literals_literal { // libcis: isolate file-scope helpers
typedef std::u8string u8string;
} using namespace libcis_ns_strings_basic_string_literals_literal; // libcis

#else
typedef std::string u8string;
#endif

void test_strings_basic_string_literals_literal() {
  {
