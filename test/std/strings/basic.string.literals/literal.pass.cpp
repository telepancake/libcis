// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_literals_literal_59ffa705).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_literals_literal_59ffa705 { // libcis
...
} // libcis_ns_strings_basic_string_literals_literal_59ffa705 (libcis)
