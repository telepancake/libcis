// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_conversions_stold).
// main -> test_strings_string_conversions_stold; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_strings_string_conversions_stold() {
