// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_conversions_stold_7c34df11).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_conversions_stold_7c34df11 { // libcis
int main(int, char**) {
...
} // libcis_ns_strings_string_conversions_stold_7c34df11 (libcis)
