// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_conversions_stoull_8211dcb2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_conversions_stoull_8211dcb2 { // libcis
int main(int, char**) {
...
} // libcis_ns_strings_string_conversions_stoull_8211dcb2 (libcis)
