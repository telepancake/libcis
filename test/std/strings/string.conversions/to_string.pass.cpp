// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_conversions_to_string_bad5196c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_conversions_to_string_bad5196c { // libcis
template <class T>
void test_signed() {
  {
...
} // libcis_ns_strings_string_conversions_to_string_bad5196c (libcis)
