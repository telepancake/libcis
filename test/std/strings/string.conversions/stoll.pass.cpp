// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_conversions_stoll_7f219007).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_conversions_stoll_7f219007 { // libcis
int main(int, char**) {
...
} // libcis_ns_strings_string_conversions_stoll_7f219007 (libcis)
