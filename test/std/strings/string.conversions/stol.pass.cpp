// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_conversions_stol).
// main -> test_strings_string_conversions_stol; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_strings_string_conversions_stol() {
  assert(std::stol("0") == 0);
  assert(std::stol("-0") == 0);
