// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_conversions_stol_56474e5f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_conversions_stol_56474e5f { // libcis
int main(int, char**) {
  assert(std::stol("0") == 0);
  assert(std::stol("-0") == 0);
...
} // libcis_ns_strings_string_conversions_stol_56474e5f (libcis)
