// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_conversions_stof_e8cc2635).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_conversions_stof_e8cc2635 { // libcis
int main(int, char**) {
  assert(std::stof("0") == 0);
  assert(std::stof("-0") == 0);
...
} // libcis_ns_strings_string_conversions_stof_e8cc2635 (libcis)
