// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_conversions_stod_8854034d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_conversions_stod_8854034d { // libcis
int main(int, char**) {
  // char
  {
    assert(std::stod("0") == 0);
...
} // libcis_ns_strings_string_conversions_stod_8854034d (libcis)
