// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_conversions_stoi_5f87fbc3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_conversions_stoi_5f87fbc3 { // libcis
int main(int, char**) {
  assert(std::stoi("0") == 0);
  assert(std::stoi("-0") == 0);
...
} // libcis_ns_strings_string_conversions_stoi_5f87fbc3 (libcis)
