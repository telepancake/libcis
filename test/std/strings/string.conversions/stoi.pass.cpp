// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_conversions_stoi).
// main -> test_strings_string_conversions_stoi; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_strings_string_conversions_stoi() {
  assert(std::stoi("0") == 0);
  assert(std::stoi("-0") == 0);
