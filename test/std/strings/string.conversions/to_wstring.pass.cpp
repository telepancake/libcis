// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_conversions_to_wstring_167077d9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_conversions_to_wstring_167077d9 { // libcis
template <class T>
void test_signed() {
  {
...
} // libcis_ns_strings_string_conversions_to_wstring_167077d9 (libcis)
