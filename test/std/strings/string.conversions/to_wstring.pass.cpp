// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_conversions_to_wstring).
// main -> test_strings_string_conversions_to_wstring; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_conversions_to_wstring { // libcis: isolate file-scope helpers
template <class T>
void test_signed() {
  {
...
} using namespace libcis_ns_strings_string_conversions_to_wstring; // libcis


void test_strings_string_conversions_to_wstring() {
  test_signed<int>();
  test_signed<long>();
