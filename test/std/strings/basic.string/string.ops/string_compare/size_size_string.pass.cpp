// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_compare_size_size_string_b9202a4f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_compare_size_size_string_b9202a4f { // libcis
...
} // libcis_ns_strings_basic_string_string_ops_string_compare_size_size_string_b9202a4f (libcis)
