// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_compare_size_size_string_view_6357dbd7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_compare_size_size_string_view_6357dbd7 { // libcis
...
} // libcis_ns_strings_basic_string_string_ops_string_compare_size_size_string_view_6357dbd7 (libcis)
