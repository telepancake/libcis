// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_compare_size_size_pointer_a9944a36).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_compare_size_size_pointer_a9944a36 { // libcis
...
} // libcis_ns_strings_basic_string_string_ops_string_compare_size_size_pointer_a9944a36 (libcis)
