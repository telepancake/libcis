// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_compare_size_size_pointer_size).
// main -> test_strings_basic_string_string_ops_string_compare_size_size_pointer_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_compare_size_size_pointer_size { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_basic_string_string_ops_string_compare_size_size_pointer_size; // libcis


void test_strings_basic_string_string_ops_string_compare_size_size_pointer_size() {
  test<std::string>();
#if TEST_STD_VER >= 11
