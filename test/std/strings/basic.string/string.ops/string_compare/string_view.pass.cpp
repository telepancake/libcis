// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_compare_string_view_0104ed1a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_compare_string_view_0104ed1a { // libcis
...
} // libcis_ns_strings_basic_string_string_ops_string_compare_string_view_0104ed1a (libcis)
