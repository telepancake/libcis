// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_find_char_size_cfeaa257).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_find_char_size_cfeaa257 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_ops_string_find_char_size_cfeaa257 (libcis)
