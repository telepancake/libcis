// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_find_string_view_size_1b26dd78).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_find_string_view_size_1b26dd78 { // libcis
...
} // libcis_ns_strings_basic_string_string_ops_string_find_string_view_size_1b26dd78 (libcis)
