// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_find_string_size_950ed63c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_find_string_size_950ed63c { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_ops_string_find_string_size_950ed63c (libcis)
