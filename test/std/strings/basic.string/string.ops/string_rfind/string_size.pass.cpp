// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_rfind_string_size_06b24481).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_rfind_string_size_06b24481 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_ops_string_rfind_string_size_06b24481 (libcis)
