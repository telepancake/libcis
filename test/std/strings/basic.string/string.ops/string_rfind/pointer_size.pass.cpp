// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_rfind_pointer_size_5730f25b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_rfind_pointer_size_5730f25b { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_ops_string_rfind_pointer_size_5730f25b (libcis)
