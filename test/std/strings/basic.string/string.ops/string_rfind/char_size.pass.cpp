// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_rfind_char_size_cecc97fe).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_rfind_char_size_cecc97fe { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_ops_string_rfind_char_size_cecc97fe (libcis)
