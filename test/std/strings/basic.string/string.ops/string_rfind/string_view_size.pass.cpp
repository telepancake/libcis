// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_rfind_string_view_size_b9dc5806).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_rfind_string_view_size_b9dc5806 { // libcis
...
} // libcis_ns_strings_basic_string_string_ops_string_rfind_string_view_size_b9dc5806 (libcis)
