// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_find_first_not_of_pointer_size_size).
// main -> test_strings_basic_string_string_ops_string_find_first_not_of_pointer_size_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_find_first_not_of_pointer_size_size { // libcis: isolate file-scope helpers
template <class S>
...
} using namespace libcis_ns_strings_basic_string_string_ops_string_find_first_not_of_pointer_size_size; // libcis


void test_strings_basic_string_string_ops_string_find_first_not_of_pointer_size_size() {
  test();
#if TEST_STD_VER > 17
  static_assert(test());
#endif
