// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_find_first_of_pointer_size_10a3aa26).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_find_first_of_pointer_size_10a3aa26 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_ops_string_find_first_of_pointer_size_10a3aa26 (libcis)
