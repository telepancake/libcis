// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_accessors_get_allocator_b5d97a11).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_accessors_get_allocator_b5d97a11 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_ops_string_accessors_get_allocator_b5d97a11 (libcis)
