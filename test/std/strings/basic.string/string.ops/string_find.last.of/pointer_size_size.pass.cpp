// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_find_last_of_pointer_size_size_6a6b76cb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_find_last_of_pointer_size_size_6a6b76cb { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_ops_string_find_last_of_pointer_size_size_6a6b76cb (libcis)
