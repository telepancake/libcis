// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_find_last_of_pointer_size_0825ce65).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_find_last_of_pointer_size_0825ce65 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_ops_string_find_last_of_pointer_size_0825ce65 (libcis)
