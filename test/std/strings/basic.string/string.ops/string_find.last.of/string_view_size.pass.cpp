// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_find_last_of_string_view_size_8bbdf804).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_find_last_of_string_view_size_8bbdf804 { // libcis
...
} // libcis_ns_strings_basic_string_string_ops_string_find_last_of_string_view_size_8bbdf804 (libcis)
