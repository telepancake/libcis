// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_ops_string_substr_substr).
// main -> test_strings_basic_string_string_ops_string_substr_substr; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ops_string_substr_substr { // libcis: isolate file-scope helpers
template <class S>
...
} using namespace libcis_ns_strings_basic_string_string_ops_string_substr_substr; // libcis


void test_strings_basic_string_string_ops_string_substr_substr() {
  test();
  test_alloc();
#if TEST_STD_VER > 17
  static_assert(test());
