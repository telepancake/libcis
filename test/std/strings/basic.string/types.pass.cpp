// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_types).
// main -> test_strings_basic_string_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_basic_string_types; // libcis


void test_strings_basic_string_types() {
