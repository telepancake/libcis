// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_range_concept_conformance).
...
namespace libcis_ns_strings_basic_string_range_concept_conformance { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_basic_string_range_concept_conformance; // libcis
