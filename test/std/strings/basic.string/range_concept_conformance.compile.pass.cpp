// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_range_concept_conformance_74a38b2b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_range_concept_conformance_74a38b2b { // libcis
...
} // libcis_ns_strings_basic_string_range_concept_conformance_74a38b2b (libcis)
