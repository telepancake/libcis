// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_capacity_reserve_size_fc57e0f6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_capacity_reserve_size_fc57e0f6 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_capacity_reserve_size_fc57e0f6 (libcis)
