// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_capacity_reserve_size_asan_aba62761).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_capacity_reserve_size_asan_aba62761 { // libcis
template <class S>
void test() {
...
} // libcis_ns_strings_basic_string_string_capacity_reserve_size_asan_aba62761 (libcis)
