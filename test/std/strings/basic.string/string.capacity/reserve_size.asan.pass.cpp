// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_capacity_reserve_size_asan).
// main -> test_strings_basic_string_string_capacity_reserve_size_asan; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_capacity_reserve_size_asan { // libcis: isolate file-scope helpers
template <class S>
void test() {
...
} using namespace libcis_ns_strings_basic_string_string_capacity_reserve_size_asan; // libcis


void test_strings_basic_string_string_capacity_reserve_size_asan() {
  test<std::string>();
