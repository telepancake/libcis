// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_capacity_capacity).
// main -> test_strings_basic_string_string_capacity_capacity; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_capacity_capacity { // libcis: isolate file-scope helpers
template <class S>
...
} using namespace libcis_ns_strings_basic_string_string_capacity_capacity; // libcis


void test_strings_basic_string_string_capacity_capacity() {
  test();
#if TEST_STD_VER >= 20
  static_assert(test());
#endif
