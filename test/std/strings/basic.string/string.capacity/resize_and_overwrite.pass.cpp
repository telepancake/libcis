// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_capacity_resize_and_overwrite).
// main -> test_strings_basic_string_string_capacity_resize_and_overwrite; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_capacity_resize_and_overwrite { // libcis: isolate file-scope helpers
template <class S>
...
} using namespace libcis_ns_strings_basic_string_string_capacity_resize_and_overwrite; // libcis


void test_strings_basic_string_string_capacity_resize_and_overwrite() {
