// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_capacity_resize_size_char_9f21fba6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_capacity_resize_size_char_9f21fba6 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_capacity_resize_size_char_9f21fba6 (libcis)
