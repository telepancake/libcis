// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_capacity_deallocate_size_ef80fa5f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_capacity_deallocate_size_ef80fa5f { // libcis
...
} // libcis_ns_strings_basic_string_string_capacity_deallocate_size_ef80fa5f (libcis)
