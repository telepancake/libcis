// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_capacity_deallocate_size).
// main -> test_strings_basic_string_string_capacity_deallocate_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_capacity_deallocate_size { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_basic_string_string_capacity_deallocate_size; // libcis


void test_strings_basic_string_string_capacity_deallocate_size() {
  test<uint32_t>();
  test<uint64_t>();
  test<size_t>();
