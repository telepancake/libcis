// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ends_with_ends_with_string_view_fd1e6575).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ends_with_ends_with_string_view_fd1e6575 { // libcis
...
} // libcis_ns_strings_basic_string_string_ends_with_ends_with_string_view_fd1e6575 (libcis)
