// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_ends_with_ends_with_ptr_a160038f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_ends_with_ends_with_ptr_a160038f { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_ends_with_ends_with_ptr_a160038f (libcis)
