// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_iterators_iterator_concept_conformance_c5af9b9d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_iterators_iterator_concept_conformance_c5af9b9d { // libcis
...
} // libcis_ns_strings_basic_string_string_iterators_iterator_concept_conformance_c5af9b9d (libcis)
