// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_iterators_end_ad492cad).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_iterators_end_ad492cad { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_iterators_end_ad492cad (libcis)
