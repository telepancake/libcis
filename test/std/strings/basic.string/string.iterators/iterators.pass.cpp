// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_iterators_iterators_d42dbac1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_iterators_iterators_d42dbac1 { // libcis
template <class C>
...
} // libcis_ns_strings_basic_string_string_iterators_iterators_d42dbac1 (libcis)
