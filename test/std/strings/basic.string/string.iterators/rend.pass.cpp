// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_iterators_rend_ca5c88a3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_iterators_rend_ca5c88a3 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_iterators_rend_ca5c88a3 (libcis)
