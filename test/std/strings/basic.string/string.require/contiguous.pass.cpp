// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_require_contiguous).
// main -> test_strings_basic_string_string_require_contiguous; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_require_contiguous { // libcis: isolate file-scope helpers
template <class C>
...
} using namespace libcis_ns_strings_basic_string_string_require_contiguous; // libcis


void test_strings_basic_string_string_require_contiguous() {
  test();
#if TEST_STD_VER > 17
  static_assert(test());
#endif
