// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_require_contiguous_2b3ebd51).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_require_contiguous_2b3ebd51 { // libcis
template <class C>
...
} // libcis_ns_strings_basic_string_string_require_contiguous_2b3ebd51 (libcis)
