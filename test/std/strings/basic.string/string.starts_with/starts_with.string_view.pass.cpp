// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_starts_with_starts_with_string_view_5909ac72).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_starts_with_starts_with_string_view_5909ac72 { // libcis
...
} // libcis_ns_strings_basic_string_string_starts_with_starts_with_string_view_5909ac72 (libcis)
