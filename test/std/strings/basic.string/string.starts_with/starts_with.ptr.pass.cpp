// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_starts_with_starts_with_ptr).
// main -> test_strings_basic_string_string_starts_with_starts_with_ptr; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_starts_with_starts_with_ptr { // libcis: isolate file-scope helpers
template <class S>
...
} using namespace libcis_ns_strings_basic_string_string_starts_with_starts_with_ptr; // libcis


void test_strings_basic_string_string_starts_with_starts_with_ptr() {
  test();
  static_assert(test());
