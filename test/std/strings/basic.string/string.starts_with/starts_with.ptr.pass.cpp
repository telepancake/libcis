// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_starts_with_starts_with_ptr_e94f0f5f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_starts_with_starts_with_ptr_e94f0f5f { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_starts_with_starts_with_ptr_e94f0f5f (libcis)
