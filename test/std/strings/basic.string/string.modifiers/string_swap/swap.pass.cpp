// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_swap_swap_80033594).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_swap_swap_80033594 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_swap_swap_80033594 (libcis)
