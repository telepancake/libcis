// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_swap_swap_asan_220fca24).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_swap_swap_asan_220fca24 { // libcis
...
} // libcis_ns_strings_basic_string_string_modifiers_string_swap_swap_asan_220fca24 (libcis)
