// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_swap_swap_asan).
// main -> test_strings_basic_string_string_modifiers_string_swap_swap_asan; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_swap_swap_asan { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_basic_string_string_modifiers_string_swap_swap_asan; // libcis


void test_strings_basic_string_string_modifiers_string_swap_swap_asan() {
  test<char>('x');
