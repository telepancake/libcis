// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_replace_iter_iter_pointer_c8faa9a7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_replace_iter_iter_pointer_c8faa9a7 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_replace_iter_iter_pointer_c8faa9a7 (libcis)
