// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_replace_size_size_string_view_1e0a5614).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_replace_size_size_string_view_1e0a5614 { // libcis
...
} // libcis_ns_strings_basic_string_string_modifiers_string_replace_size_size_string_view_1e0a5614 (libcis)
