// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_replace_size_size_pointer_size_c0a55edd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_replace_size_size_pointer_size_c0a55edd { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_replace_size_size_pointer_size_c0a55edd (libcis)
