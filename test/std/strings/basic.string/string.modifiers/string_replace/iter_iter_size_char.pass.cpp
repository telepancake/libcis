// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_replace_iter_iter_size_char_08b8a53b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_replace_iter_iter_size_char_08b8a53b { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_replace_iter_iter_size_char_08b8a53b (libcis)
