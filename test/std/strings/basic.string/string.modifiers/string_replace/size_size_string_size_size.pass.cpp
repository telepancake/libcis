// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_replace_size_size_string_size_size).
// main -> test_strings_basic_string_string_modifiers_string_replace_size_size_string_size_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_replace_size_size_string_size_size { // libcis: isolate file-scope helpers
template <class S>
...
} using namespace libcis_ns_strings_basic_string_string_modifiers_string_replace_size_size_string_size_size; // libcis


void test_strings_basic_string_string_modifiers_string_replace_size_size_string_size_size() {
  test<std::string>();
#if TEST_STD_VER >= 11
