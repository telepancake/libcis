// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_replace_iter_iter_string_view_a1ae53da).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_replace_iter_iter_string_view_a1ae53da { // libcis
...
} // libcis_ns_strings_basic_string_string_modifiers_string_replace_iter_iter_string_view_a1ae53da (libcis)
