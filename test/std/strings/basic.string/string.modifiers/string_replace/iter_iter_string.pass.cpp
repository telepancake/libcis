// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_replace_iter_iter_string_ee03b3bf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_replace_iter_iter_string_ee03b3bf { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_replace_iter_iter_string_ee03b3bf (libcis)
