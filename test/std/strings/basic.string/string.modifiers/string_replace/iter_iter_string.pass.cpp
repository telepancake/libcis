// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_replace_iter_iter_string).
// main -> test_strings_basic_string_string_modifiers_string_replace_iter_iter_string; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_replace_iter_iter_string { // libcis: isolate file-scope helpers
template <class S>
...
} using namespace libcis_ns_strings_basic_string_string_modifiers_string_replace_iter_iter_string; // libcis


void test_strings_basic_string_string_modifiers_string_replace_iter_iter_string() {
  test<std::string>();
#if TEST_STD_VER >= 11
