// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_erase_iter_1f4baef0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_erase_iter_1f4baef0 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_erase_iter_1f4baef0 (libcis)
