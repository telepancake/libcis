// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_erase_size_size_a3078948).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_erase_size_size_a3078948 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_erase_size_size_a3078948 (libcis)
