// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_erase_pop_back_e27e0bb2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_erase_pop_back_e27e0bb2 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_erase_pop_back_e27e0bb2 (libcis)
