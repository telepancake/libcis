// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_assign_string_3e3ca3f4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_assign_string_3e3ca3f4 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_assign_string_3e3ca3f4 (libcis)
