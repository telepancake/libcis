// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_assign_size_char_475c88dc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_assign_size_char_475c88dc { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_assign_size_char_475c88dc (libcis)
