// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_assign_T_size_size_a8367a46).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_assign_T_size_size_a8367a46 { // libcis
...
} // libcis_ns_strings_basic_string_string_modifiers_string_assign_T_size_size_a8367a46 (libcis)
