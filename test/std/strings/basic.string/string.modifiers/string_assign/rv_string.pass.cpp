// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_assign_rv_string_f2356714).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_assign_rv_string_f2356714 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_assign_rv_string_f2356714 (libcis)
