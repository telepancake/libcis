// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_op_plus_equal_string_752b9d7d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_op_plus_equal_string_752b9d7d { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_op_plus_equal_string_752b9d7d (libcis)
