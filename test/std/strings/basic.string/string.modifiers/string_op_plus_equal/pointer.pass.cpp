// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_op_plus_equal_pointer_e74f1dae).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_op_plus_equal_pointer_e74f1dae { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_op_plus_equal_pointer_e74f1dae (libcis)
