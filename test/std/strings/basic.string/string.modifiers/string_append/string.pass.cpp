// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_append_string_aacd1a12).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_append_string_aacd1a12 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_append_string_aacd1a12 (libcis)
