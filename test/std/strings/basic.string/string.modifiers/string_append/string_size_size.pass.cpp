// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_append_string_size_size_c7dcb940).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_append_string_size_size_c7dcb940 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_append_string_size_size_c7dcb940 (libcis)
