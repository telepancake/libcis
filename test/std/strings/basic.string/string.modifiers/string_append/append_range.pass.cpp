// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_append_append_range).
// main -> test_strings_basic_string_string_modifiers_string_append_append_range; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_append_append_range { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_basic_string_string_modifiers_string_append_append_range; // libcis


void test_strings_basic_string_string_modifiers_string_append_append_range() {
