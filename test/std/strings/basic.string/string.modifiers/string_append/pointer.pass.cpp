// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_append_pointer_6e462308).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_append_pointer_6e462308 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_append_pointer_6e462308 (libcis)
