// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_append_push_back).
// main -> test_strings_basic_string_string_modifiers_string_append_push_back; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_append_push_back { // libcis: isolate file-scope helpers
struct VeryLarge {
  long long a;
  char b;
};
} using namespace libcis_ns_strings_basic_string_string_modifiers_string_append_push_back; // libcis
...
void test_strings_basic_string_string_modifiers_string_append_push_back() {
  test();
#if TEST_STD_VER > 17
  static_assert(test());
#endif
