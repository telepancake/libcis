// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_append_iterator_06ed73be).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_append_iterator_06ed73be { // libcis
...
} // libcis_ns_strings_basic_string_string_modifiers_string_append_iterator_06ed73be (libcis)
