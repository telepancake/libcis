// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_append_string_view_f6de875b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_append_string_view_f6de875b { // libcis
...
} // libcis_ns_strings_basic_string_string_modifiers_string_append_string_view_f6de875b (libcis)
