// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_append_pointer_size_1113826d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_append_pointer_size_1113826d { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_append_pointer_size_1113826d (libcis)
