// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_insert_size_size_char_99affd3b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_insert_size_size_char_99affd3b { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_insert_size_size_char_99affd3b (libcis)
