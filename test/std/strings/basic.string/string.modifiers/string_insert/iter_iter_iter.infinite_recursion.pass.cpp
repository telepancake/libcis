// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_insert_iter_iter_iter_infinite_recursion).
// main -> test_strings_basic_string_string_modifiers_string_insert_iter_iter_iter_infinite_recursion; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_insert_iter_iter_iter_infinite_recursion { // libcis: isolate file-scope helpers
struct char_ascii {
  char char_;
...
} using namespace libcis_ns_strings_basic_string_string_modifiers_string_insert_iter_iter_iter_infinite_recursion; // libcis
...
void test_strings_basic_string_string_modifiers_string_insert_iter_iter_iter_infinite_recursion() {
