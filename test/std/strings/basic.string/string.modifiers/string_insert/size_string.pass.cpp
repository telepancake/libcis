// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_insert_size_string_41e6fbd0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_insert_size_string_41e6fbd0 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_insert_size_string_41e6fbd0 (libcis)
