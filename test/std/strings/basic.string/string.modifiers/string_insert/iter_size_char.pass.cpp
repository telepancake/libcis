// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_insert_iter_size_char_0c3c4828).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_insert_iter_size_char_0c3c4828 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_insert_iter_size_char_0c3c4828 (libcis)
