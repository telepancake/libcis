// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_insert_size_pointer_size_2567bfed).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_insert_size_pointer_size_2567bfed { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_modifiers_string_insert_size_pointer_size_2567bfed (libcis)
