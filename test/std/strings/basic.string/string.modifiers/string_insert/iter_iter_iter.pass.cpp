// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_modifiers_string_insert_iter_iter_iter_358c77d6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_modifiers_string_insert_iter_iter_iter_358c77d6 { // libcis
...
} // libcis_ns_strings_basic_string_string_modifiers_string_insert_iter_iter_iter_358c77d6 (libcis)
