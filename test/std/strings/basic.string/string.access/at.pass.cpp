// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_access_at_06cf5d42).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_access_at_06cf5d42 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_access_at_06cf5d42 (libcis)
