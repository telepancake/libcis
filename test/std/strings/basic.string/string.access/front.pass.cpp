// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_access_front_b796725f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_access_front_b796725f { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_access_front_b796725f (libcis)
