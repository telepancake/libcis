// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_alloc_1fc50da0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_alloc_1fc50da0 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_cons_alloc_1fc50da0 (libcis)
