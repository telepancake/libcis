// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_move_assignment_7573e213).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_move_assignment_7573e213 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_cons_move_assignment_7573e213 (libcis)
