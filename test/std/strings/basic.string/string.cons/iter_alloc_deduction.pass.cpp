// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_iter_alloc_deduction_68712803).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_iter_alloc_deduction_68712803 { // libcis
class NotAnIterator {};
...
} // libcis_ns_strings_basic_string_string_cons_iter_alloc_deduction_68712803 (libcis)
