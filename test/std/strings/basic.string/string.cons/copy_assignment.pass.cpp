// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_copy_assignment_0faf47a1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_copy_assignment_0faf47a1 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_cons_copy_assignment_0faf47a1 (libcis)
