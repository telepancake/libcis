// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_string_view_size_size_deduction_061ada07).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_string_view_size_size_deduction_061ada07 { // libcis
...
} // libcis_ns_strings_basic_string_string_cons_string_view_size_size_deduction_061ada07 (libcis)
