// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_move_alloc_6b564133).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_move_alloc_6b564133 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_cons_move_alloc_6b564133 (libcis)
