// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_pointer_size_alloc_c8a3f1a0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_pointer_size_alloc_c8a3f1a0 { // libcis
...
} // libcis_ns_strings_basic_string_string_cons_pointer_size_alloc_c8a3f1a0 (libcis)
