// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_pointer_alloc_daba783d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_pointer_alloc_daba783d { // libcis
...
} // libcis_ns_strings_basic_string_string_cons_pointer_alloc_daba783d (libcis)
