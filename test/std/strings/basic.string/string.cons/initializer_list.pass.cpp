// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_initializer_list_1fa2d774).
//===----------------------------------------------------------------------===//
//
...
// clang-format off
namespace libcis_ns_strings_basic_string_string_cons_initializer_list_1fa2d774 { // libcis
...
} // libcis_ns_strings_basic_string_string_cons_initializer_list_1fa2d774 (libcis)
