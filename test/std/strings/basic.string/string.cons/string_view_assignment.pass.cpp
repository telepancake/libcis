// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_string_view_assignment).
// main -> test_strings_basic_string_string_cons_string_view_assignment; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_string_view_assignment { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_basic_string_string_cons_string_view_assignment; // libcis


void test_strings_basic_string_string_cons_string_view_assignment() {
  test();
#if TEST_STD_VER > 17
  static_assert(test());
#endif
