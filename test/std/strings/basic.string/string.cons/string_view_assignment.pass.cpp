// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_string_view_assignment_a24debab).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_string_view_assignment_a24debab { // libcis
...
} // libcis_ns_strings_basic_string_string_cons_string_view_assignment_a24debab (libcis)
