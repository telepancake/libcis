// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_dtor).
// main -> test_strings_basic_string_string_cons_dtor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_dtor { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_strings_basic_string_string_cons_dtor; // libcis


void test_strings_basic_string_string_cons_dtor() {
  test();
#if TEST_STD_VER > 17
  static_assert(test());
#endif
