// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_dtor_ac7b4710).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_dtor_ac7b4710 { // libcis
template <class T>
...
} // libcis_ns_strings_basic_string_string_cons_dtor_ac7b4710 (libcis)
