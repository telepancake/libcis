// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_size_char_alloc).
// main -> test_strings_basic_string_string_cons_size_char_alloc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_size_char_alloc { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_basic_string_string_cons_size_char_alloc; // libcis


void test_strings_basic_string_string_cons_size_char_alloc() {
  test();
#if TEST_STD_VER > 17
  static_assert(test());
#endif
