// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_move_assign_noexcept_53485048).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_move_assign_noexcept_53485048 { // libcis
template <class T>
struct some_alloc {
...
} // libcis_ns_strings_basic_string_string_cons_move_assign_noexcept_53485048 (libcis)
