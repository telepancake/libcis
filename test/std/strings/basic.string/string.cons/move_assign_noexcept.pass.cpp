// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_move_assign_noexcept).
// main -> test_strings_basic_string_string_cons_move_assign_noexcept; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_move_assign_noexcept { // libcis: isolate file-scope helpers
template <class T>
struct some_alloc {
...
} using namespace libcis_ns_strings_basic_string_string_cons_move_assign_noexcept; // libcis


void test_strings_basic_string_string_cons_move_assign_noexcept() {
  test();
#if TEST_STD_VER > 17
  static_assert(test());
#endif
