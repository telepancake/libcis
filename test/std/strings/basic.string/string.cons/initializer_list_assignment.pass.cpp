// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_initializer_list_assignment_3cbba7f7).
//===----------------------------------------------------------------------===//
//
...
// clang-format off
namespace libcis_ns_strings_basic_string_string_cons_initializer_list_assignment_3cbba7f7 { // libcis
...
} // libcis_ns_strings_basic_string_string_cons_initializer_list_assignment_3cbba7f7 (libcis)
