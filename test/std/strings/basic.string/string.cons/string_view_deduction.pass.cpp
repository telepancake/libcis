// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_string_view_deduction_99a7d8dd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_string_view_deduction_99a7d8dd { // libcis
...
} // libcis_ns_strings_basic_string_string_cons_string_view_deduction_99a7d8dd (libcis)
