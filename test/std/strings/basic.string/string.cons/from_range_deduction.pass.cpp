// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_from_range_deduction).
// main -> test_strings_basic_string_string_cons_from_range_deduction; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_strings_basic_string_string_cons_from_range_deduction() {
  using Char = char16_t;
