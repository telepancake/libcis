// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_string_view_ece9741c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_string_view_ece9741c { // libcis
...
} // libcis_ns_strings_basic_string_string_cons_string_view_ece9741c (libcis)
