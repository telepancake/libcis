// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_cons_substr_rvalue).
// main -> test_strings_basic_string_string_cons_substr_rvalue; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_cons_substr_rvalue { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_basic_string_string_cons_substr_rvalue; // libcis


void test_strings_basic_string_string_cons_substr_rvalue() {
