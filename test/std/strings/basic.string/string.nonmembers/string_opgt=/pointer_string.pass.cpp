// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_opgt_pointer_string_9b533240).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_opgt_pointer_string_9b533240 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_opgt_pointer_string_9b533240 (libcis)
