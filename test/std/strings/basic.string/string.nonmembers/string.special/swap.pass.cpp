// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_special_swap_b574ecc4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_special_swap_b574ecc4 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_special_swap_b574ecc4 (libcis)
