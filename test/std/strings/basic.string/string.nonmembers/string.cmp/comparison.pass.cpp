// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_cmp_comparison_7f3e2f90).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_cmp_comparison_7f3e2f90 { // libcis
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_cmp_comparison_7f3e2f90 (libcis)
