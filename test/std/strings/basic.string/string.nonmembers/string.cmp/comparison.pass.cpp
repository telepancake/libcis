// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_cmp_comparison).
// main -> test_strings_basic_string_string_nonmembers_string_cmp_comparison; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_cmp_comparison { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_basic_string_string_nonmembers_string_cmp_comparison; // libcis


void test_strings_basic_string_string_nonmembers_string_cmp_comparison() {
  test_all_types();
