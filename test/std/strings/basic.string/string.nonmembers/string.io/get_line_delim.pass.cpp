// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_io_get_line_delim_b13aceec).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_io_get_line_delim_b13aceec { // libcis
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_io_get_line_delim_b13aceec (libcis)
