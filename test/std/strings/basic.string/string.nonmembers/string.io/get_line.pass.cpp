// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_io_get_line).
// main -> test_strings_basic_string_string_nonmembers_string_io_get_line; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_io_get_line { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_basic_string_string_nonmembers_string_io_get_line; // libcis


void test_strings_basic_string_string_nonmembers_string_io_get_line() {
