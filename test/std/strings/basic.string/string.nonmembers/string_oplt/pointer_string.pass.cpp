// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_oplt_pointer_string_ea6a0a01).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_oplt_pointer_string_ea6a0a01 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_oplt_pointer_string_ea6a0a01 (libcis)
