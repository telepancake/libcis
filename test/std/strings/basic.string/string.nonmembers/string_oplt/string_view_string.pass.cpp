// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_oplt_string_view_string_a3a043a7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_oplt_string_view_string_a3a043a7 { // libcis
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_oplt_string_view_string_a3a043a7 (libcis)
