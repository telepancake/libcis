// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_oplt_string_string_view_36fe00c1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_oplt_string_string_view_36fe00c1 { // libcis
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_oplt_string_string_view_36fe00c1 (libcis)
