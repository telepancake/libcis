// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_oplt_string_view_string_d4acd24f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_oplt_string_view_string_d4acd24f { // libcis
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_oplt_string_view_string_d4acd24f (libcis)
