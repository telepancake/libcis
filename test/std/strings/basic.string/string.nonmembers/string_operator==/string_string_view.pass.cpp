// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_operator_string_string_view_886bfd86).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_operator_string_string_view_886bfd86 { // libcis
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_operator_string_string_view_886bfd86 (libcis)
