// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_operator_string_view_string_54dcff3f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_operator_string_view_string_54dcff3f { // libcis
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_operator_string_view_string_54dcff3f (libcis)
