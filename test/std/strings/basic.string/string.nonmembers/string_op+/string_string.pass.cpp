// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_op_string_string_d8470c80).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_op_string_string_d8470c80 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_op_string_string_d8470c80 (libcis)
