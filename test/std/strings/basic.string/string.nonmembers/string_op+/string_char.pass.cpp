// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_op_string_char).
// main -> test_strings_basic_string_string_nonmembers_string_op_string_char; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_op_string_char { // libcis: isolate file-scope helpers
template <class S>
...
} using namespace libcis_ns_strings_basic_string_string_nonmembers_string_op_string_char; // libcis


void test_strings_basic_string_string_nonmembers_string_op_string_char() {
  test();
#if TEST_STD_VER >= 20
  static_assert(test());
#endif
