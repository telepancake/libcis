// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_op_char_string_37ea43c0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_op_char_string_37ea43c0 { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_op_char_string_37ea43c0 (libcis)
