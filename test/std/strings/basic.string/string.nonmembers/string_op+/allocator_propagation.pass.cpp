// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_op_allocator_propagation_526d55e2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_op_allocator_propagation_526d55e2 { // libcis
template <class T>
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_op_allocator_propagation_526d55e2 (libcis)
