// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_op_allocator_propagation).
// main -> test_strings_basic_string_string_nonmembers_string_op_allocator_propagation; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_op_allocator_propagation { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_strings_basic_string_string_nonmembers_string_op_allocator_propagation; // libcis


void test_strings_basic_string_string_nonmembers_string_op_allocator_propagation() {
  test<char>();
