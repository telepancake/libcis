// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_opgt_string_string_view_54dd4450).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_opgt_string_string_view_54dd4450 { // libcis
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_opgt_string_string_view_54dd4450 (libcis)
