// AST-transferred from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_opgt_string_string_view).
// main -> test_strings_basic_string_string_nonmembers_string_opgt_string_string_view; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_opgt_string_string_view { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_basic_string_string_nonmembers_string_opgt_string_string_view; // libcis


void test_strings_basic_string_string_nonmembers_string_opgt_string_string_view() {
  test();
#if TEST_STD_VER > 17
  static_assert(test());
#endif
