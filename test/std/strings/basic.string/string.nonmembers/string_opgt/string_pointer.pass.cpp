// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_opgt_string_pointer_54cd12bc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_opgt_string_pointer_54cd12bc { // libcis
template <class S>
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_opgt_string_pointer_54cd12bc (libcis)
