// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_opgt_string_view_string_357894dd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_opgt_string_view_string_357894dd { // libcis
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_opgt_string_view_string_357894dd (libcis)
