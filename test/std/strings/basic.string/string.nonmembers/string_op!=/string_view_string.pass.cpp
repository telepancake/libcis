// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_op_string_view_string_ffa2d271).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_op_string_view_string_ffa2d271 { // libcis
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_op_string_view_string_ffa2d271 (libcis)
