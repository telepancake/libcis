// transferred+adapted from libc++ by tools/transfer.py (slug=strings_basic_string_string_nonmembers_string_op_string_string_view_5ce16f24).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_basic_string_string_nonmembers_string_op_string_string_view_5ce16f24 { // libcis
...
} // libcis_ns_strings_basic_string_string_nonmembers_string_op_string_string_view_5ce16f24 (libcis)
