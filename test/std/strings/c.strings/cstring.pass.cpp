// transferred+adapted from libc++ by tools/transfer.py (slug=strings_c_strings_cstring_3b5bfe53).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_c_strings_cstring_3b5bfe53 { // libcis
int main(int, char**) {
...
} // libcis_ns_strings_c_strings_cstring_3b5bfe53 (libcis)
