// AST-transferred from libc++ by tools/transfer.py (slug=strings_c_strings_cstring).
// main -> test_strings_c_strings_cstring; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_strings_c_strings_cstring() {
