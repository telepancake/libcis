// AST-transferred from libc++ by tools/transfer.py (slug=strings_c_strings_cwctype).
// main -> test_strings_c_strings_cwctype; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_strings_c_strings_cwctype() {
  std::wint_t w = 0;
