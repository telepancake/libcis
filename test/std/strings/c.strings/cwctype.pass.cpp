// transferred+adapted from libc++ by tools/transfer.py (slug=strings_c_strings_cwctype_6d602daa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_c_strings_cwctype_6d602daa { // libcis
int main(int, char**) {
  std::wint_t w = 0;
...
} // libcis_ns_strings_c_strings_cwctype_6d602daa (libcis)
