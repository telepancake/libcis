// AST-transferred from libc++ by tools/transfer.py (slug=strings_c_strings_cuchar).
...
namespace libcis_ns_strings_c_strings_cuchar { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_c_strings_cuchar; // libcis
