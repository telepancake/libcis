// AST-transferred from libc++ by tools/transfer.py (slug=strings_c_strings_cctype).
// main -> test_strings_c_strings_cctype; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_strings_c_strings_cctype() {
