// transferred+adapted from libc++ by tools/transfer.py (slug=strings_c_strings_cctype_a029bcea).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_c_strings_cctype_a029bcea { // libcis
int main(int, char**) {
...
} // libcis_ns_strings_c_strings_cctype_a029bcea (libcis)
