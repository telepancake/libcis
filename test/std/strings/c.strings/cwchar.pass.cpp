// transferred+adapted from libc++ by tools/transfer.py (slug=strings_c_strings_cwchar_0cf13265).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_c_strings_cwchar_0cf13265 { // libcis
int main(int, char**) {
  std::mbstate_t mb = {};
  std::size_t s     = 0;
  std::tm* tm       = 0;
...
} // libcis_ns_strings_c_strings_cwchar_0cf13265 (libcis)
