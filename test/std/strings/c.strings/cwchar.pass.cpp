// AST-transferred from libc++ by tools/transfer.py (slug=strings_c_strings_cwchar).
// main -> test_strings_c_strings_cwchar; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_strings_c_strings_cwchar() {
  std::mbstate_t mb = {};
  std::size_t s     = 0;
  std::tm* tm       = 0;
  std::wint_t w     = 0;
