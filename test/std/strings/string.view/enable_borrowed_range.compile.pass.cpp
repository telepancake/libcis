// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_enable_borrowed_range_6de061a0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_enable_borrowed_range_6de061a0 { // libcis
void test() {
...
} // libcis_ns_strings_string_view_enable_borrowed_range_6de061a0 (libcis)
