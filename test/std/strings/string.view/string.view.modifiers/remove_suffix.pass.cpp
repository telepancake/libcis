// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_modifiers_remove_suffix_f2802f0f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_modifiers_remove_suffix_f2802f0f { // libcis
...
} // libcis_ns_strings_string_view_string_view_modifiers_remove_suffix_f2802f0f (libcis)
