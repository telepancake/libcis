// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_modifiers_swap_6655da73).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_modifiers_swap_6655da73 { // libcis
...
} // libcis_ns_strings_string_view_string_view_modifiers_swap_6655da73 (libcis)
