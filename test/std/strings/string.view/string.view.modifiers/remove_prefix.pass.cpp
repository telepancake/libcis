// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_modifiers_remove_prefix_0bf08e5d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_modifiers_remove_prefix_0bf08e5d { // libcis
...
} // libcis_ns_strings_string_view_string_view_modifiers_remove_prefix_0bf08e5d (libcis)
