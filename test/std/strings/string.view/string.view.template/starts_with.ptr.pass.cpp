// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_template_starts_with_ptr_09f48830).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_template_starts_with_ptr_09f48830 { // libcis
int main(int, char**) {
  {
...
} // libcis_ns_strings_string_view_string_view_template_starts_with_ptr_09f48830 (libcis)
