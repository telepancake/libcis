// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_template_ends_with_ptr_03e4b342).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_template_ends_with_ptr_03e4b342 { // libcis
int main(int, char**) {
  {
...
} // libcis_ns_strings_string_view_string_view_template_ends_with_ptr_03e4b342 (libcis)
