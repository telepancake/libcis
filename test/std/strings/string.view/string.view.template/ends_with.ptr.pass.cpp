// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_template_ends_with_ptr).
// main -> test_strings_string_view_string_view_template_ends_with_ptr; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_strings_string_view_string_view_template_ends_with_ptr() {
  {
