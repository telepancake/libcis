// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_template_starts_with_string_view).
// main -> test_strings_string_view_string_view_template_starts_with_string_view; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_strings_string_view_string_view_template_starts_with_string_view() {
  {
