// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_template_contains_ptr).
// main -> test_strings_string_view_string_view_template_contains_ptr; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_template_contains_ptr { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_strings_string_view_string_view_template_contains_ptr; // libcis


void test_strings_string_view_string_view_template_contains_ptr() {
  test();
  static_assert(test());
