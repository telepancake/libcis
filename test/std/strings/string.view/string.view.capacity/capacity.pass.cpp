// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_capacity_capacity_241e8dfe).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_capacity_capacity_241e8dfe { // libcis
...
} // libcis_ns_strings_string_view_string_view_capacity_capacity_241e8dfe (libcis)
