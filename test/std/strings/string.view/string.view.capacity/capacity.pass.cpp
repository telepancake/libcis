// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_capacity_capacity).
// main -> test_strings_string_view_string_view_capacity_capacity; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_capacity_capacity { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_string_view_string_view_capacity_capacity; // libcis


void test_strings_string_view_string_view_capacity_capacity() {
