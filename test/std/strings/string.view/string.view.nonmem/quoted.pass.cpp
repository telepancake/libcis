// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_nonmem_quoted).
// main -> test_strings_string_view_string_view_nonmem_quoted; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_nonmem_quoted { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_string_view_string_view_nonmem_quoted; // libcis

#endif // TEST_HAS_NO_WIDE_CHARACTERS

void test_strings_string_view_string_view_nonmem_quoted() {
  round_trip("");
  round_trip_ws("");
  round_trip_d("", 'q');
  round_trip_e("", 'q');
