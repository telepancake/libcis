// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_nonmem_quoted_779e4802).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_nonmem_quoted_779e4802 { // libcis
...
} // libcis_ns_strings_string_view_string_view_nonmem_quoted_779e4802 (libcis)
