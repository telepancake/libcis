// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_deduct_iterator_sentinel_db67ab4b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_deduct_iterator_sentinel_db67ab4b { // libcis
...
} // libcis_ns_strings_string_view_string_view_deduct_iterator_sentinel_db67ab4b (libcis)
