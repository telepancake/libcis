// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_deduct_range).
// main -> test_strings_string_view_string_view_deduct_range; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_deduct_range { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_string_view_string_view_deduct_range; // libcis


void test_strings_string_view_string_view_deduct_range() {
  test();
