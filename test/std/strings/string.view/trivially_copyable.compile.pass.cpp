// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_trivially_copyable).
...
namespace libcis_ns_strings_string_view_trivially_copyable { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_string_view_trivially_copyable; // libcis
