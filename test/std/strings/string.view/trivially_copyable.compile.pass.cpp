// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_trivially_copyable_25041e3e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_trivially_copyable_25041e3e { // libcis
...
} // libcis_ns_strings_string_view_trivially_copyable_25041e3e (libcis)
