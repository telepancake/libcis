// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_ops_compare_sv_080bbaef).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_ops_compare_sv_080bbaef { // libcis
...
} // libcis_ns_strings_string_view_string_view_ops_compare_sv_080bbaef (libcis)
