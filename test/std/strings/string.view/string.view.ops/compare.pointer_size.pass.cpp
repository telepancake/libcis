// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_ops_compare_pointer_size).
// main -> test_strings_string_view_string_view_ops_compare_pointer_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_ops_compare_pointer_size { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_string_view_string_view_ops_compare_pointer_size; // libcis


void test_strings_string_view_string_view_ops_compare_pointer_size() {
  test0();
  test1();
  test2();
