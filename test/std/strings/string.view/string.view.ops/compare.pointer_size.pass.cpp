// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_ops_compare_pointer_size_eaf02276).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_ops_compare_pointer_size_eaf02276 { // libcis
...
} // libcis_ns_strings_string_view_string_view_ops_compare_pointer_size_eaf02276 (libcis)
