// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_ops_compare_size_size_sv_d4e7a12a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_ops_compare_size_size_sv_d4e7a12a { // libcis
...
} // libcis_ns_strings_string_view_string_view_ops_compare_size_size_sv_d4e7a12a (libcis)
