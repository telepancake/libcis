// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_ops_substr_486ae3c1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_ops_substr_486ae3c1 { // libcis
...
} // libcis_ns_strings_string_view_string_view_ops_substr_486ae3c1 (libcis)
