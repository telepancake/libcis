// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_ops_compare_pointer_77798a3b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_ops_compare_pointer_77798a3b { // libcis
...
} // libcis_ns_strings_string_view_string_view_ops_compare_pointer_77798a3b (libcis)
