// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_ops_compare_pointer).
// main -> test_strings_string_view_string_view_ops_compare_pointer; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_ops_compare_pointer { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_string_view_string_view_ops_compare_pointer; // libcis


void test_strings_string_view_string_view_ops_compare_pointer() {
  {
    test("", "", 0);
    test("", "abcde", -5);
    test("", "abcdefghij", -10);
