// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_ops_copy).
// main -> test_strings_string_view_string_view_ops_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_ops_copy { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_string_view_string_view_ops_copy; // libcis


void test_strings_string_view_string_view_ops_copy() {
