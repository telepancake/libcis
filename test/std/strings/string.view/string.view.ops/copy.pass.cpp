// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_ops_copy_932ec48c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_ops_copy_932ec48c { // libcis
...
} // libcis_ns_strings_string_view_string_view_ops_copy_932ec48c (libcis)
