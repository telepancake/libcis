// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_comparison_greater_equal_3317fbfe).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_comparison_greater_equal_3317fbfe { // libcis
template <class T>
...
} // libcis_ns_strings_string_view_string_view_comparison_greater_equal_3317fbfe (libcis)
