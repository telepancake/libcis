// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_comparison_less_a301b44a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_comparison_less_a301b44a { // libcis
template <class T>
...
} // libcis_ns_strings_string_view_string_view_comparison_less_a301b44a (libcis)
