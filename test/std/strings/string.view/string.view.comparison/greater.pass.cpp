// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_comparison_greater_4ead416f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_comparison_greater_4ead416f { // libcis
template <class T>
...
} // libcis_ns_strings_string_view_string_view_comparison_greater_4ead416f (libcis)
