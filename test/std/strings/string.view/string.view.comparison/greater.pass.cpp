// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_comparison_greater).
// main -> test_strings_string_view_string_view_comparison_greater; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_comparison_greater { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_strings_string_view_string_view_comparison_greater; // libcis


void test_strings_string_view_string_view_comparison_greater() {
