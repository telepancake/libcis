// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_comparison_less_equal_d594c5b1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_comparison_less_equal_d594c5b1 { // libcis
template <class T>
...
} // libcis_ns_strings_string_view_string_view_comparison_less_equal_d594c5b1 (libcis)
