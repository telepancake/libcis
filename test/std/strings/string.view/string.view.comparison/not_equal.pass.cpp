// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_comparison_not_equal).
// main -> test_strings_string_view_string_view_comparison_not_equal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_comparison_not_equal { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_strings_string_view_string_view_comparison_not_equal; // libcis


void test_strings_string_view_string_view_comparison_not_equal() {
