// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_comparison_comparison_5e14c54f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_comparison_comparison_5e14c54f { // libcis
...
} // libcis_ns_strings_string_view_string_view_comparison_comparison_5e14c54f (libcis)
