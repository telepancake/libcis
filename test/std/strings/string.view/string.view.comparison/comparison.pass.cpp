// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_comparison_comparison).
// main -> test_strings_string_view_string_view_comparison_comparison; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_comparison_comparison { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_string_view_string_view_comparison_comparison; // libcis


void test_strings_string_view_string_view_comparison_comparison() {
  test_all_types();
