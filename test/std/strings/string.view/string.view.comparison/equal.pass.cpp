// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_comparison_equal_b22b9210).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_comparison_equal_b22b9210 { // libcis
template <class T>
...
} // libcis_ns_strings_string_view_string_view_comparison_equal_b22b9210 (libcis)
