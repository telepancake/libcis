// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_literals_literal).
// main -> test_strings_string_view_string_view_literals_literal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_literals_literal { // libcis: isolate file-scope helpers
typedef std::u8string_view u8string_view;
} using namespace libcis_ns_strings_string_view_string_view_literals_literal; // libcis

#else
typedef std::string_view u8string_view;
#endif

void test_strings_string_view_string_view_literals_literal() {
  {
