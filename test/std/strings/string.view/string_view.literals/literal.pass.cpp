// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_literals_literal_e6279f86).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_literals_literal_e6279f86 { // libcis
...
} // libcis_ns_strings_string_view_string_view_literals_literal_e6279f86 (libcis)
