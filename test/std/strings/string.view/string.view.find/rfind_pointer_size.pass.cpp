// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_find_rfind_pointer_size_db4e57a6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_find_rfind_pointer_size_db4e57a6 { // libcis
template <class S>
...
} // libcis_ns_strings_string_view_string_view_find_rfind_pointer_size_db4e57a6 (libcis)
