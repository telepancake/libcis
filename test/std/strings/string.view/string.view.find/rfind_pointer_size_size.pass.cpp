// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_find_rfind_pointer_size_size_640ef2fb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_find_rfind_pointer_size_size_640ef2fb { // libcis
template <class S>
void test(const S& s,
...
} // libcis_ns_strings_string_view_string_view_find_rfind_pointer_size_size_640ef2fb (libcis)
