// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_find_rfind_char_size_c9508535).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_find_rfind_char_size_c9508535 { // libcis
template <class S>
...
} // libcis_ns_strings_string_view_string_view_find_rfind_char_size_c9508535 (libcis)
