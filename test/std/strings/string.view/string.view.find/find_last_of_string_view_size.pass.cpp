// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_find_find_last_of_string_view_size_d6f98118).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_find_find_last_of_string_view_size_d6f98118 { // libcis
template <class S>
...
} // libcis_ns_strings_string_view_string_view_find_find_last_of_string_view_size_d6f98118 (libcis)
