// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_find_find_pointer_size_size_32977280).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_find_find_pointer_size_size_32977280 { // libcis
template <class S>
void test(const S& s,
...
} // libcis_ns_strings_string_view_string_view_find_find_pointer_size_size_32977280 (libcis)
