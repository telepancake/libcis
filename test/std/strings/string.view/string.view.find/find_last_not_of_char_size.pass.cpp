// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_find_find_last_not_of_char_size_062a9795).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_find_find_last_not_of_char_size_062a9795 { // libcis
template <class S>
...
} // libcis_ns_strings_string_view_string_view_find_find_last_not_of_char_size_062a9795 (libcis)
