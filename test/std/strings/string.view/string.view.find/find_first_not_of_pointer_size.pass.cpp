// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_find_find_first_not_of_pointer_size).
// main -> test_strings_string_view_string_view_find_find_first_not_of_pointer_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_find_find_first_not_of_pointer_size { // libcis: isolate file-scope helpers
template <class S>
...
} using namespace libcis_ns_strings_string_view_string_view_find_find_first_not_of_pointer_size; // libcis


void test_strings_string_view_string_view_find_find_first_not_of_pointer_size() {
  {
