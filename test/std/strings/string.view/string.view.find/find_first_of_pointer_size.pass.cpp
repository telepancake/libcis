// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_find_find_first_of_pointer_size_62e9d8b7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_find_find_first_of_pointer_size_62e9d8b7 { // libcis
template <class S>
...
} // libcis_ns_strings_string_view_string_view_find_find_first_of_pointer_size_62e9d8b7 (libcis)
