// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_find_rfind_string_view_size_0ec47fb4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_find_rfind_string_view_size_0ec47fb4 { // libcis
template <class S>
...
} // libcis_ns_strings_string_view_string_view_find_rfind_string_view_size_0ec47fb4 (libcis)
