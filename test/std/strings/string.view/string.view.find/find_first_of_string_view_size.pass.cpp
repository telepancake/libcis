// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_find_find_first_of_string_view_size_4c4990e0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_find_find_first_of_string_view_size_4c4990e0 { // libcis
template <class S>
...
} // libcis_ns_strings_string_view_string_view_find_find_first_of_string_view_size_4c4990e0 (libcis)
