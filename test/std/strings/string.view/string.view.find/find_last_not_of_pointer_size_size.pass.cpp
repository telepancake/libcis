// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_find_find_last_not_of_pointer_size_size_f0f9710d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_find_find_last_not_of_pointer_size_size_f0f9710d { // libcis
template <class S>
void test(const S& s,
...
} // libcis_ns_strings_string_view_string_view_find_find_last_not_of_pointer_size_size_f0f9710d (libcis)
