// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_find_find_string_view_size_77e01b45).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_find_find_string_view_size_77e01b45 { // libcis
template <class S>
...
} // libcis_ns_strings_string_view_string_view_find_find_string_view_size_77e01b45 (libcis)
