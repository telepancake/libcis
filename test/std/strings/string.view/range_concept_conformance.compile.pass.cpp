// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_range_concept_conformance_aee80502).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_range_concept_conformance_aee80502 { // libcis
...
} // libcis_ns_strings_string_view_range_concept_conformance_aee80502 (libcis)
