// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_range_concept_conformance).
...
namespace libcis_ns_strings_string_view_range_concept_conformance { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_string_view_range_concept_conformance; // libcis
