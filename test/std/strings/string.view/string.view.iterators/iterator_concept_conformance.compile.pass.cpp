// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_iterators_iterator_concept_conformance_5118c519).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_iterators_iterator_concept_conformance_5118c519 { // libcis
...
} // libcis_ns_strings_string_view_string_view_iterators_iterator_concept_conformance_5118c519 (libcis)
