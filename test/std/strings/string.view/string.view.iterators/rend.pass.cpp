// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_iterators_rend).
// main -> test_strings_string_view_string_view_iterators_rend; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_iterators_rend { // libcis: isolate file-scope helpers
template <class S>
void test(S s) {
  const S& cs                            = s;
...
} using namespace libcis_ns_strings_string_view_string_view_iterators_rend; // libcis


void test_strings_string_view_string_view_iterators_rend() {
