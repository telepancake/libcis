// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_iterators_iterators_b4e00164).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_iterators_iterators_b4e00164 { // libcis
...
} // libcis_ns_strings_string_view_string_view_iterators_iterators_b4e00164 (libcis)
