// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_iterators_iterators).
// main -> test_strings_string_view_string_view_iterators_iterators; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_iterators_iterators { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_string_view_string_view_iterators_iterators; // libcis


void test_strings_string_view_string_view_iterators_iterators() {
  test();
#if TEST_STD_VER >= 14
  static_assert(test(), "");
#endif
