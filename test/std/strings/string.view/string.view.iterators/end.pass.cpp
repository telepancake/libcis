// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_iterators_end).
// main -> test_strings_string_view_string_view_iterators_end; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_iterators_end { // libcis: isolate file-scope helpers
template <class S>
void test(S s) {
  const S& cs                    = s;
...
} using namespace libcis_ns_strings_string_view_string_view_iterators_end; // libcis


void test_strings_string_view_string_view_iterators_end() {
