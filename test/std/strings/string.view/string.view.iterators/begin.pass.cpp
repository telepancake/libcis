// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_iterators_begin_b3bf42d1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_iterators_begin_b3bf42d1 { // libcis
template <class S>
void test(S s) {
  const S& cs                    = s;
...
} // libcis_ns_strings_string_view_string_view_iterators_begin_b3bf42d1 (libcis)
