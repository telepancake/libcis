// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_access_front_dcd1dbb6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_access_front_dcd1dbb6 { // libcis
...
} // libcis_ns_strings_string_view_string_view_access_front_dcd1dbb6 (libcis)
