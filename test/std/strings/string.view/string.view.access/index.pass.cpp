// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_access_index_cbe7b02d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_access_index_cbe7b02d { // libcis
...
} // libcis_ns_strings_string_view_string_view_access_index_cbe7b02d (libcis)
