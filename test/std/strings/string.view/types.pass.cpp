// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_types_c9d36c2d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_types_c9d36c2d { // libcis
...
} // libcis_ns_strings_string_view_types_c9d36c2d (libcis)
