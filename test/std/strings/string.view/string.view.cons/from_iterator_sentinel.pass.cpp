// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_cons_from_iterator_sentinel_350bb310).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_cons_from_iterator_sentinel_350bb310 { // libcis
...
} // libcis_ns_strings_string_view_string_view_cons_from_iterator_sentinel_350bb310 (libcis)
