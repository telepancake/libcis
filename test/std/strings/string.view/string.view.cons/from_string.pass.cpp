// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_cons_from_string).
// main -> test_strings_string_view_string_view_cons_from_string; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_cons_from_string { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_string_view_string_view_cons_from_string; // libcis


void test_strings_string_view_string_view_cons_from_string() {
