// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_cons_from_string_6c412692).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_cons_from_string_6c412692 { // libcis
...
} // libcis_ns_strings_string_view_string_view_cons_from_string_6c412692 (libcis)
