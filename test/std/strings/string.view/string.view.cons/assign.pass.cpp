// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_cons_assign_d68e9b9b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_cons_assign_d68e9b9b { // libcis
template <typename T>
#if TEST_STD_VER > 11
constexpr
#endif
...
} // libcis_ns_strings_string_view_string_view_cons_assign_d68e9b9b (libcis)
