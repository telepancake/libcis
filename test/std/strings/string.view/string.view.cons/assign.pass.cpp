// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_cons_assign).
// main -> test_strings_string_view_string_view_cons_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_cons_assign { // libcis: isolate file-scope helpers
template <typename T>
#if TEST_STD_VER > 11
constexpr
#endif
...
} using namespace libcis_ns_strings_string_view_string_view_cons_assign; // libcis


void test_strings_string_view_string_view_cons_assign() {
