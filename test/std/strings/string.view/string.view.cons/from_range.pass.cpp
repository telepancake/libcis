// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_cons_from_range).
// main -> test_strings_string_view_string_view_cons_from_range; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_cons_from_range { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_string_view_string_view_cons_from_range; // libcis


void test_strings_string_view_string_view_cons_from_range() {
  test();
  static_assert(test());
#ifndef TEST_HAS_NO_EXCEPTIONS
  test_throwing();
