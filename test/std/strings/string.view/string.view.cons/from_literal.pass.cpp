// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_cons_from_literal_5e4b52f2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_cons_from_literal_5e4b52f2 { // libcis
...
} // libcis_ns_strings_string_view_string_view_cons_from_literal_5e4b52f2 (libcis)
