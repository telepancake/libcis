// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_cons_from_ptr_len).
// main -> test_strings_string_view_string_view_cons_from_ptr_len; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_cons_from_ptr_len { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_strings_string_view_string_view_cons_from_ptr_len; // libcis


void test_strings_string_view_string_view_cons_from_ptr_len() {
  test("QBCDE", 5);
  test("QBCDE", 2);
  test("", 0);
#if TEST_STD_VER > 11
