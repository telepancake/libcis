// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_cons_from_ptr_len_261f70d0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_cons_from_ptr_len_261f70d0 { // libcis
...
} // libcis_ns_strings_string_view_string_view_cons_from_ptr_len_261f70d0 (libcis)
