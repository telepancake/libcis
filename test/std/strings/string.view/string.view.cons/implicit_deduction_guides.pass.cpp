// AST-transferred from libc++ by tools/transfer.py (slug=strings_string_view_string_view_cons_implicit_deduction_guides).
// main -> test_strings_string_view_string_view_cons_implicit_deduction_guides; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_strings_string_view_string_view_cons_implicit_deduction_guides() {
  {
    // Testing (1)
