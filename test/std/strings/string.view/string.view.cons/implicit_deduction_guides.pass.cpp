// transferred+adapted from libc++ by tools/transfer.py (slug=strings_string_view_string_view_cons_implicit_deduction_guides_31d7cb3c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_strings_string_view_string_view_cons_implicit_deduction_guides_31d7cb3c { // libcis
int main(int, char**) {
  {
    // Testing (1)
...
} // libcis_ns_strings_string_view_string_view_cons_implicit_deduction_guides_31d7cb3c (libcis)
