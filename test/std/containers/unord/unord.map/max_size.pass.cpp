// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_max_size_12f9c2fd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_max_size_12f9c2fd { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_unord_unord_map_max_size_12f9c2fd (libcis)
