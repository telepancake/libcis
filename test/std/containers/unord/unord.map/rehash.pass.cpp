// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_rehash_3581c53d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_rehash_3581c53d { // libcis
template <class C>
...
} // libcis_ns_containers_unord_unord_map_rehash_3581c53d (libcis)
