// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_erase_if_eb88a4bd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_erase_if_eb88a4bd { // libcis
...
} // libcis_ns_containers_unord_unord_map_erase_if_eb88a4bd (libcis)
