// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_key_eq_64d43f0a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_key_eq_64d43f0a { // libcis
int main(int, char**) {
...
} // libcis_ns_containers_unord_unord_map_key_eq_64d43f0a (libcis)
