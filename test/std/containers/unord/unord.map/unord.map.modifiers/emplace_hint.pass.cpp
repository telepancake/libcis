// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_modifiers_emplace_hint).
// main -> test_containers_unord_unord_map_unord_map_modifiers_emplace_hint; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_map_unord_map_modifiers_emplace_hint() {
  {
