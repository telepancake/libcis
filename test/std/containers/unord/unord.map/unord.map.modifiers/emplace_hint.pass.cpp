// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_modifiers_emplace_hint_8eeb719e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_unord_map_modifiers_emplace_hint_8eeb719e { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_map_unord_map_modifiers_emplace_hint_8eeb719e (libcis)
