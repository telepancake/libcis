// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_modifiers_insert_hint_rvalue).
// main -> test_containers_unord_unord_map_unord_map_modifiers_insert_hint_rvalue; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_map_unord_map_modifiers_insert_hint_rvalue() {
  {
