// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_modifiers_extract_iterator_4a3e45da).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_unord_map_modifiers_extract_iterator_4a3e45da { // libcis
...
} // libcis_ns_containers_unord_unord_map_unord_map_modifiers_extract_iterator_4a3e45da (libcis)
