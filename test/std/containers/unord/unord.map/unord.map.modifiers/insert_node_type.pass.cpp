// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_modifiers_insert_node_type).
// main -> test_containers_unord_unord_map_unord_map_modifiers_insert_node_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_unord_map_modifiers_insert_node_type { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_unord_unord_map_unord_map_modifiers_insert_node_type; // libcis


void test_containers_unord_unord_map_unord_map_modifiers_insert_node_type() {
