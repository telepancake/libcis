// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_modifiers_try_emplace).
// main -> test_containers_unord_unord_map_unord_map_modifiers_try_emplace; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_unord_map_modifiers_try_emplace { // libcis: isolate file-scope helpers
class Moveable {
...
} using namespace libcis_ns_containers_unord_unord_map_unord_map_modifiers_try_emplace; // libcis
...
void test_containers_unord_unord_map_unord_map_modifiers_try_emplace() {
