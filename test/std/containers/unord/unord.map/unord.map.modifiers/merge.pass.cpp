// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_modifiers_merge_60280f39).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_unord_map_modifiers_merge_60280f39 { // libcis
template <class Map>
...
} // libcis_ns_containers_unord_unord_map_unord_map_modifiers_merge_60280f39 (libcis)
