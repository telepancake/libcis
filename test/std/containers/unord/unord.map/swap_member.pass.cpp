// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_swap_member_5afd7f2b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_swap_member_5afd7f2b { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_map_swap_member_5afd7f2b (libcis)
