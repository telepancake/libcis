// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_cnstr_size_allocator_9b502afb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_unord_map_cnstr_size_allocator_9b502afb { // libcis
...
} // libcis_ns_containers_unord_unord_map_unord_map_cnstr_size_allocator_9b502afb (libcis)
