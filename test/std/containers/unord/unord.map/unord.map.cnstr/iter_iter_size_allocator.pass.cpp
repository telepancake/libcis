// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_cnstr_iter_iter_size_allocator_e972c8e2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_unord_map_cnstr_iter_iter_size_allocator_e972c8e2 { // libcis
...
} // libcis_ns_containers_unord_unord_map_unord_map_cnstr_iter_iter_size_allocator_e972c8e2 (libcis)
