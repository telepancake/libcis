// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_cnstr_move_assign_noexcept_2c3e40ee).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_unord_map_cnstr_move_assign_noexcept_2c3e40ee { // libcis
template <class T>
struct some_comp
{
...
} // libcis_ns_containers_unord_unord_map_unord_map_cnstr_move_assign_noexcept_2c3e40ee (libcis)
