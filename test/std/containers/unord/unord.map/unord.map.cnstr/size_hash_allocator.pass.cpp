// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_cnstr_size_hash_allocator_db42959c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_unord_map_cnstr_size_hash_allocator_db42959c { // libcis
...
} // libcis_ns_containers_unord_unord_map_unord_map_cnstr_size_hash_allocator_db42959c (libcis)
