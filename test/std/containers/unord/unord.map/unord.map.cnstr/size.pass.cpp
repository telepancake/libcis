// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_cnstr_size_10d8e3e2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_unord_map_cnstr_size_10d8e3e2 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_map_unord_map_cnstr_size_10d8e3e2 (libcis)
