// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_cnstr_deduct_2e522fbd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_unord_map_cnstr_deduct_2e522fbd { // libcis
...
} // libcis_ns_containers_unord_unord_map_unord_map_cnstr_deduct_2e522fbd (libcis)
