// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_cnstr_dtor_noexcept_eaddad24).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_unord_map_cnstr_dtor_noexcept_eaddad24 { // libcis
template <class T>
struct some_comp
{
...
} // libcis_ns_containers_unord_unord_map_unord_map_cnstr_dtor_noexcept_eaddad24 (libcis)
