// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_cnstr_assign_move).
// main -> test_containers_unord_unord_map_unord_map_cnstr_assign_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_map_unord_map_cnstr_assign_move() {
  {
