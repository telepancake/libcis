// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_swap_swap_noexcept_68f18124).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_unord_map_swap_swap_noexcept_68f18124 { // libcis
template <class T>
struct some_comp
{
...
} // libcis_ns_containers_unord_unord_map_unord_map_swap_swap_noexcept_68f18124 (libcis)
