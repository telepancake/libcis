// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_swap_swap_non_member).
// main -> test_containers_unord_unord_map_unord_map_swap_swap_non_member; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_map_unord_map_swap_swap_non_member() {
  {
