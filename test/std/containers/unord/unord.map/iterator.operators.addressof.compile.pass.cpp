// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_map_iterator_operators_addressof).
...
namespace libcis_ns_containers_unord_unord_map_iterator_operators_addressof { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_unord_unord_map_iterator_operators_addressof; // libcis
