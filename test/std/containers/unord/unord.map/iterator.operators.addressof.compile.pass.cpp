// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_iterator_operators_addressof_9398c673).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_iterator_operators_addressof_9398c673 { // libcis
...
} // libcis_ns_containers_unord_unord_map_iterator_operators_addressof_9398c673 (libcis)
