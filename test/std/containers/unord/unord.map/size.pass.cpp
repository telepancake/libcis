// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_size_9de50d7b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_size_9de50d7b { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_map_size_9de50d7b (libcis)
