// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_iterator_concept_conformance_01a8bf7d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_iterator_concept_conformance_01a8bf7d { // libcis
...
} // libcis_ns_containers_unord_unord_map_iterator_concept_conformance_01a8bf7d (libcis)
