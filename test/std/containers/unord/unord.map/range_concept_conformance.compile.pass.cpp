// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_range_concept_conformance_1a12d4d4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_range_concept_conformance_1a12d4d4 { // libcis
...
} // libcis_ns_containers_unord_unord_map_range_concept_conformance_1a12d4d4 (libcis)
