// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_contains_transparent_241bb8f1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_contains_transparent_241bb8f1 { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_unord_unord_map_contains_transparent_241bb8f1 (libcis)
