// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_map_unord_map_elem_index).
// main -> test_containers_unord_unord_map_unord_map_elem_index; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_map_unord_map_elem_index() {
  {
