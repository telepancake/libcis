// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_contains_a3f677a3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_contains_a3f677a3 { // libcis
...
} // libcis_ns_containers_unord_unord_map_contains_a3f677a3 (libcis)
