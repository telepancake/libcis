// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_map_contains).
// main -> test_containers_unord_unord_map_contains; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_contains { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_unord_unord_map_contains; // libcis


void test_containers_unord_unord_map_contains() {
  {
