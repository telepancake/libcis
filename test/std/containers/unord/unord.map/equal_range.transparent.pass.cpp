// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_equal_range_transparent_10657d14).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_equal_range_transparent_10657d14 { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_unord_unord_map_equal_range_transparent_10657d14 (libcis)
