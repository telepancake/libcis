// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_map_equal_range_transparent).
// main -> test_containers_unord_unord_map_equal_range_transparent; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_map_equal_range_transparent() {
