// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_map_eq_different_hash_3dd5fd25).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_map_eq_different_hash_3dd5fd25 { // libcis
template <class T>
...
} // libcis_ns_containers_unord_unord_map_eq_different_hash_3dd5fd25 (libcis)
