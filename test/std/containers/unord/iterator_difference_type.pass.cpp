// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_iterator_difference_type_f85c1fb2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_iterator_difference_type_f85c1fb2 { // libcis
...
} // libcis_ns_containers_unord_iterator_difference_type_f85c1fb2 (libcis)
