// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_extract_key_e4fcc973).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_extract_key_e4fcc973 { // libcis
...
} // libcis_ns_containers_unord_unord_set_extract_key_e4fcc973 (libcis)
