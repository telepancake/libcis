// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_unord_set_cnstr_size_allocator_1efb1c64).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_unord_set_cnstr_size_allocator_1efb1c64 { // libcis
...
} // libcis_ns_containers_unord_unord_set_unord_set_cnstr_size_allocator_1efb1c64 (libcis)
