// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_unord_set_cnstr_deduct_f68c2dff).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_unord_set_cnstr_deduct_f68c2dff { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_unord_unord_set_unord_set_cnstr_deduct_f68c2dff (libcis)
