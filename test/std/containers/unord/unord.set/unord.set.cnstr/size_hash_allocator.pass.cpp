// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_unord_set_cnstr_size_hash_allocator_e2444f01).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_unord_set_cnstr_size_hash_allocator_e2444f01 { // libcis
...
} // libcis_ns_containers_unord_unord_set_unord_set_cnstr_size_hash_allocator_e2444f01 (libcis)
