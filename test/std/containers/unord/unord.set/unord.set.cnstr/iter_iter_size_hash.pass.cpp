// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_set_unord_set_cnstr_iter_iter_size_hash).
// main -> test_containers_unord_unord_set_unord_set_cnstr_iter_iter_size_hash; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_set_unord_set_cnstr_iter_iter_size_hash() {
  {
