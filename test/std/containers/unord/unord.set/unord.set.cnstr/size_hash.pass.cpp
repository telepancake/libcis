// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_unord_set_cnstr_size_hash_3468b9d4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_unord_set_cnstr_size_hash_3468b9d4 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_set_unord_set_cnstr_size_hash_3468b9d4 (libcis)
