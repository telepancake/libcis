// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_set_unord_set_cnstr_assign_copy).
// main -> test_containers_unord_unord_set_unord_set_cnstr_assign_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_unord_set_cnstr_assign_copy { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_containers_unord_unord_set_unord_set_cnstr_assign_copy; // libcis


void test_containers_unord_unord_set_unord_set_cnstr_assign_copy() {
  test();
