// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_unord_set_cnstr_copy_3fb8742e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_unord_set_cnstr_copy_3fb8742e { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_set_unord_set_cnstr_copy_3fb8742e (libcis)
