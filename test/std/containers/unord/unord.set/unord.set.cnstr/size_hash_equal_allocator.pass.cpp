// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_unord_set_cnstr_size_hash_equal_allocator_53f9b249).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_unord_set_cnstr_size_hash_equal_allocator_53f9b249 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_set_unord_set_cnstr_size_hash_equal_allocator_53f9b249 (libcis)
