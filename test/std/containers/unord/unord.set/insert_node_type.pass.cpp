// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_insert_node_type_0c536413).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_insert_node_type_0c536413 { // libcis
...
} // libcis_ns_containers_unord_unord_set_insert_node_type_0c536413 (libcis)
