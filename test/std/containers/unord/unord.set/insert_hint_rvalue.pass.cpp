// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_insert_hint_rvalue_9dcc7a69).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_insert_hint_rvalue_9dcc7a69 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_set_insert_hint_rvalue_9dcc7a69 (libcis)
