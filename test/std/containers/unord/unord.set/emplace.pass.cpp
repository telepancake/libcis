// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_set_emplace).
// main -> test_containers_unord_unord_set_emplace; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_set_emplace() {
  {
