// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_emplace_hint_b1172938).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_emplace_hint_b1172938 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_set_emplace_hint_b1172938 (libcis)
