// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_set_max_size).
// main -> test_containers_unord_unord_set_max_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_set_max_size() {
  {
