// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_rehash_71d088d4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_rehash_71d088d4 { // libcis
template <class C>
...
} // libcis_ns_containers_unord_unord_set_rehash_71d088d4 (libcis)
