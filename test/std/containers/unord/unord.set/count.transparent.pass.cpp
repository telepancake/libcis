// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_count_transparent_0c50a4c1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_count_transparent_0c50a4c1 { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_unord_unord_set_count_transparent_0c50a4c1 (libcis)
