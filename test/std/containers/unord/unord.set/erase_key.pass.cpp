// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_erase_key_19a5babd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_erase_key_19a5babd { // libcis
#if TEST_STD_VER >= 11
...
} // libcis_ns_containers_unord_unord_set_erase_key_19a5babd (libcis)
