// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_erase_if_1ab46e0c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_erase_if_1ab46e0c { // libcis
...
} // libcis_ns_containers_unord_unord_set_erase_if_1ab46e0c (libcis)
