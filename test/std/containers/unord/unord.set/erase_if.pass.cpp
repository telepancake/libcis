// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_set_erase_if).
// main -> test_containers_unord_unord_set_erase_if; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_erase_if { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_unord_unord_set_erase_if; // libcis


void test_containers_unord_unord_set_erase_if() {
