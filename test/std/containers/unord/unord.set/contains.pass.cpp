// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_contains_67cadaba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_contains_67cadaba { // libcis
...
} // libcis_ns_containers_unord_unord_set_contains_67cadaba (libcis)
