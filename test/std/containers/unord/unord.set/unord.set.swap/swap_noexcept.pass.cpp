// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_unord_set_swap_swap_noexcept_c26124eb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_unord_set_swap_swap_noexcept_c26124eb { // libcis
template <class T>
struct some_comp
{
...
} // libcis_ns_containers_unord_unord_set_unord_set_swap_swap_noexcept_c26124eb (libcis)
