// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_unord_set_swap_swap_non_member_94599cdc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_unord_set_swap_swap_non_member_94599cdc { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_set_unord_set_swap_swap_non_member_94599cdc (libcis)
