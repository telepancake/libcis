// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_extract_iterator_2917e8f0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_extract_iterator_2917e8f0 { // libcis
...
} // libcis_ns_containers_unord_unord_set_extract_iterator_2917e8f0 (libcis)
