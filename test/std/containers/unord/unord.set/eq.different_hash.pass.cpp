// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_eq_different_hash_f78135a5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_eq_different_hash_f78135a5 { // libcis
template <class T>
...
} // libcis_ns_containers_unord_unord_set_eq_different_hash_f78135a5 (libcis)
