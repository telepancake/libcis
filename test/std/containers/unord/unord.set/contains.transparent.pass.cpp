// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_contains_transparent_84bac49e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_contains_transparent_84bac49e { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_unord_unord_set_contains_transparent_84bac49e (libcis)
