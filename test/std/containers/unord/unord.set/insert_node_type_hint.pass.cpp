// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_insert_node_type_hint_2139a23c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_insert_node_type_hint_2139a23c { // libcis
...
} // libcis_ns_containers_unord_unord_set_insert_node_type_hint_2139a23c (libcis)
