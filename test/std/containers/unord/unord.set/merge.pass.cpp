// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_merge_50b28e3c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_merge_50b28e3c { // libcis
template <class Set>
...
} // libcis_ns_containers_unord_unord_set_merge_50b28e3c (libcis)
