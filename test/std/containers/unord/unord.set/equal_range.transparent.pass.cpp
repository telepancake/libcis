// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_set_equal_range_transparent_1b15a3a5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_set_equal_range_transparent_1b15a3a5 { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_unord_unord_set_equal_range_transparent_1b15a3a5 (libcis)
