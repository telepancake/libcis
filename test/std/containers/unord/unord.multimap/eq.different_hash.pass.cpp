// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_eq_different_hash_513c76f9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_eq_different_hash_513c76f9 { // libcis
template <class T>
...
} // libcis_ns_containers_unord_unord_multimap_eq_different_hash_513c76f9 (libcis)
