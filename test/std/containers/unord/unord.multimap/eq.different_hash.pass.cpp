// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_eq_different_hash).
// main -> test_containers_unord_unord_multimap_eq_different_hash; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_eq_different_hash { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_containers_unord_unord_multimap_eq_different_hash; // libcis


void test_containers_unord_unord_multimap_eq_different_hash() {
  {
    std::size_t vals[] = {
        // clang-format off
        1,
