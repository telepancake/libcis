// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_cnstr_move).
// main -> test_containers_unord_unord_multimap_unord_multimap_cnstr_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_multimap_unord_multimap_cnstr_move() {
  {
