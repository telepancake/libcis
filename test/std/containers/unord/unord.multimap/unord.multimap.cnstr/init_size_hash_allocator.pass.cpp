// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_cnstr_init_size_hash_allocator_cc08ca09).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_init_size_hash_allocator_cc08ca09 { // libcis
...
} // libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_init_size_hash_allocator_cc08ca09 (libcis)
