// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_cnstr_iter_iter_size_allocator).
// main -> test_containers_unord_unord_multimap_unord_multimap_cnstr_iter_iter_size_allocator; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_iter_iter_size_allocator { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_iter_iter_size_allocator; // libcis


void test_containers_unord_unord_multimap_unord_multimap_cnstr_iter_iter_size_allocator() {
