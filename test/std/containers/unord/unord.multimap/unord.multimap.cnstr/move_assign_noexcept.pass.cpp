// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_cnstr_move_assign_noexcept_abe02c4e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_move_assign_noexcept_abe02c4e { // libcis
template <class T>
struct some_comp
{
...
} // libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_move_assign_noexcept_abe02c4e (libcis)
