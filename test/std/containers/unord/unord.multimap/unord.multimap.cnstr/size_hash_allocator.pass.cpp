// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_cnstr_size_hash_allocator_05ebcbcb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_size_hash_allocator_05ebcbcb { // libcis
...
} // libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_size_hash_allocator_05ebcbcb (libcis)
