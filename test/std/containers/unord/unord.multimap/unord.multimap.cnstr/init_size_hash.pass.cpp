// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_cnstr_init_size_hash_cdd7a60e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_init_size_hash_cdd7a60e { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_init_size_hash_cdd7a60e (libcis)
