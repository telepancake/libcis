// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_cnstr_deduct_const_5787e6cc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_deduct_const_5787e6cc { // libcis
...
} // libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_deduct_const_5787e6cc (libcis)
