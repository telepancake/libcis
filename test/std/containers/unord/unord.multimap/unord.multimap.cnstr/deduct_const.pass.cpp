// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_cnstr_deduct_const).
// main -> test_containers_unord_unord_multimap_unord_multimap_cnstr_deduct_const; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_deduct_const { // libcis: isolate file-scope helpers
using P  = std::pair<int, long>;
using PC = std::pair<const int, long>;
} using namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_deduct_const; // libcis


void test_containers_unord_unord_multimap_unord_multimap_cnstr_deduct_const() {
