// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_cnstr_move_alloc).
// main -> test_containers_unord_unord_multimap_unord_multimap_cnstr_move_alloc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_multimap_unord_multimap_cnstr_move_alloc() {
  {
