// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_cnstr_size_hash_equal_dbf7be4d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_size_hash_equal_dbf7be4d { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_size_hash_equal_dbf7be4d (libcis)
