// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_cnstr_init_size_allocator_821cb6a6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_init_size_allocator_821cb6a6 { // libcis
...
} // libcis_ns_containers_unord_unord_multimap_unord_multimap_cnstr_init_size_allocator_821cb6a6 (libcis)
