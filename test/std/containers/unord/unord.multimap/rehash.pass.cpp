// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_rehash).
// main -> test_containers_unord_unord_multimap_rehash; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_rehash { // libcis: isolate file-scope helpers
template <class C>
...
} using namespace libcis_ns_containers_unord_unord_multimap_rehash; // libcis


void test_containers_unord_unord_multimap_rehash() {
  {
