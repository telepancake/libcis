// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_rehash_0a53758c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_rehash_0a53758c { // libcis
template <class C>
...
} // libcis_ns_containers_unord_unord_multimap_rehash_0a53758c (libcis)
