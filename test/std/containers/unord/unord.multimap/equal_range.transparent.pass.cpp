// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_equal_range_transparent_8e985043).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_equal_range_transparent_8e985043 { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_unord_unord_multimap_equal_range_transparent_8e985043 (libcis)
