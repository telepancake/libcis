// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_erase_if_cb43d386).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_erase_if_cb43d386 { // libcis
...
} // libcis_ns_containers_unord_unord_multimap_erase_if_cb43d386 (libcis)
