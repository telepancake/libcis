// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_reserve).
// main -> test_containers_unord_unord_multimap_reserve; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_reserve { // libcis: isolate file-scope helpers
template <class C>
void test(const C& c) {
  assert(c.size() == 6);
  {
...
} using namespace libcis_ns_containers_unord_unord_multimap_reserve; // libcis


void test_containers_unord_unord_multimap_reserve() {
  {
