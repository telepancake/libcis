// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_reserve_92865f39).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_reserve_92865f39 { // libcis
template <class C>
void test(const C& c)
{
    assert(c.size() == 6);
...
} // libcis_ns_containers_unord_unord_multimap_reserve_92865f39 (libcis)
