// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_swap_member_a04f087f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_swap_member_a04f087f { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_multimap_swap_member_a04f087f (libcis)
