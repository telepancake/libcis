// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_modifiers_erase_key).
// main -> test_containers_unord_unord_multimap_unord_multimap_modifiers_erase_key; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER >= 11
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_erase_key { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_erase_key; // libcis

#endif

void test_containers_unord_unord_multimap_unord_multimap_modifiers_erase_key() {
  {
