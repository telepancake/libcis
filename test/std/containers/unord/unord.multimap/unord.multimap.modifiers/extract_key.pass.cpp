// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_modifiers_extract_key_b479fdbb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_extract_key_b479fdbb { // libcis
...
} // libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_extract_key_b479fdbb (libcis)
