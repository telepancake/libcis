// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_modifiers_extract_key).
// main -> test_containers_unord_unord_multimap_unord_multimap_modifiers_extract_key; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_extract_key { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_extract_key; // libcis


void test_containers_unord_unord_multimap_unord_multimap_modifiers_extract_key() {
  {
