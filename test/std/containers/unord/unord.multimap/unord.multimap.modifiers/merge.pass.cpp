// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_modifiers_merge).
// main -> test_containers_unord_unord_multimap_unord_multimap_modifiers_merge; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_merge { // libcis: isolate file-scope helpers
template <class Map>
bool map_equal(const Map& map, Map other) {
  return map == other;
}
} using namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_merge; // libcis
...
void test_containers_unord_unord_multimap_unord_multimap_modifiers_merge() {
  {
  ...
  struct equal {
    ...
    bool operator()(const Counter<int>& lhs, const Counter<int>& rhs) const { return; }
  };
  struct hasher {
    hasher() = default;
    std::size_t operator()(const Counter<int>& p) const { return; }
  };
  {
