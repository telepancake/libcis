// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_modifiers_merge_6de42d99).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_merge_6de42d99 { // libcis
template <class Map>
...
} // libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_merge_6de42d99 (libcis)
