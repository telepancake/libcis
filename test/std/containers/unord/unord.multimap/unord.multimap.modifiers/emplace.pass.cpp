// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_modifiers_emplace_df114419).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_emplace_df114419 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_emplace_df114419 (libcis)
