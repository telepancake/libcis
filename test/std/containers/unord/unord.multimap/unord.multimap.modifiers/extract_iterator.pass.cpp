// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_unord_multimap_modifiers_extract_iterator_fc25242a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_extract_iterator_fc25242a { // libcis
...
} // libcis_ns_containers_unord_unord_multimap_unord_multimap_modifiers_extract_iterator_fc25242a (libcis)
