// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_max_size_5768a451).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_max_size_5768a451 { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_unord_unord_multimap_max_size_5768a451 (libcis)
