// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_eq_0d9a53a1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_eq_0d9a53a1 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_multimap_eq_0d9a53a1 (libcis)
