// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_equal_range_const).
// main -> test_containers_unord_unord_multimap_equal_range_const; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_multimap_equal_range_const() {
  {
