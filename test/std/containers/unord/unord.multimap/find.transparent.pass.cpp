// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_find_transparent_c4abf5e2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_find_transparent_c4abf5e2 { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_unord_unord_multimap_find_transparent_c4abf5e2 (libcis)
