// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_find_transparent).
// main -> test_containers_unord_unord_multimap_find_transparent; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_multimap_find_transparent() {
