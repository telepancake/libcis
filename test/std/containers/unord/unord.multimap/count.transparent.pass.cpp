// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_count_transparent_a6dd91a3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_count_transparent_a6dd91a3 { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_unord_unord_multimap_count_transparent_a6dd91a3 (libcis)
