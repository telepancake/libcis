// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_iterator_concept_conformance_bf31b311).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_iterator_concept_conformance_bf31b311 { // libcis
...
} // libcis_ns_containers_unord_unord_multimap_iterator_concept_conformance_bf31b311 (libcis)
