// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_key_eq_0cf4ebec).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_key_eq_0cf4ebec { // libcis
int main(int, char**) {
...
} // libcis_ns_containers_unord_unord_multimap_key_eq_0cf4ebec (libcis)
