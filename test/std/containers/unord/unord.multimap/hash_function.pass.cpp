// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multimap_hash_function_bd568adf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multimap_hash_function_bd568adf { // libcis
int main(int, char**) {
...
} // libcis_ns_containers_unord_unord_multimap_hash_function_bd568adf (libcis)
