// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_unord_multiset_cnstr_size_allocator_5519361c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_unord_multiset_cnstr_size_allocator_5519361c { // libcis
...
} // libcis_ns_containers_unord_unord_multiset_unord_multiset_cnstr_size_allocator_5519361c (libcis)
