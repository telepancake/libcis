// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_unord_multiset_cnstr_size_hash_equal_b77812c2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_unord_multiset_cnstr_size_hash_equal_b77812c2 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_multiset_unord_multiset_cnstr_size_hash_equal_b77812c2 (libcis)
