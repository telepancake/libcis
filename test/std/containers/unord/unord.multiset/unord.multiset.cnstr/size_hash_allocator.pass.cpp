// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_unord_multiset_cnstr_size_hash_allocator_a458dc43).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_unord_multiset_cnstr_size_hash_allocator_a458dc43 { // libcis
...
} // libcis_ns_containers_unord_unord_multiset_unord_multiset_cnstr_size_hash_allocator_a458dc43 (libcis)
