// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_unord_multiset_cnstr_move_alloc_a1b49077).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_unord_multiset_cnstr_move_alloc_a1b49077 { // libcis
int main(int, char**)
{
    {
        typedef int P;
...
} // libcis_ns_containers_unord_unord_multiset_unord_multiset_cnstr_move_alloc_a1b49077 (libcis)
