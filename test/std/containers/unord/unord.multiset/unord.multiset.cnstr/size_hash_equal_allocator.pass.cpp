// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_unord_multiset_cnstr_size_hash_equal_allocator).
// main -> test_containers_unord_unord_multiset_unord_multiset_cnstr_size_hash_equal_allocator; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_multiset_unord_multiset_cnstr_size_hash_equal_allocator() {
  {
