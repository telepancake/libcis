// AST-transferred from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_equal_range_non_const).
// main -> test_containers_unord_unord_multiset_equal_range_non_const; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_unord_unord_multiset_equal_range_non_const() {
  {
