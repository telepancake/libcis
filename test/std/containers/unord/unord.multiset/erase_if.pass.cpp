// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_erase_if_3dabfa8a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_erase_if_3dabfa8a { // libcis
...
} // libcis_ns_containers_unord_unord_multiset_erase_if_3dabfa8a (libcis)
