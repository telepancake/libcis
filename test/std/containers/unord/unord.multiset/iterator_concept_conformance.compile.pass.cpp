// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_iterator_concept_conformance_e355f1b8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_iterator_concept_conformance_e355f1b8 { // libcis
...
} // libcis_ns_containers_unord_unord_multiset_iterator_concept_conformance_e355f1b8 (libcis)
