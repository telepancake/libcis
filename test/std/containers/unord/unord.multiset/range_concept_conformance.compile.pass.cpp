// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_range_concept_conformance_d9e9e53d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_range_concept_conformance_d9e9e53d { // libcis
...
} // libcis_ns_containers_unord_unord_multiset_range_concept_conformance_d9e9e53d (libcis)
