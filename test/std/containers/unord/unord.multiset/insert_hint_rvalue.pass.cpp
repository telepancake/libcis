// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_insert_hint_rvalue_5d0f782b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_insert_hint_rvalue_5d0f782b { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_multiset_insert_hint_rvalue_5d0f782b (libcis)
