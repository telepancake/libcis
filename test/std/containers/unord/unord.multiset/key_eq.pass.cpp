// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_key_eq_366db65e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_key_eq_366db65e { // libcis
int main(int, char**) {
...
} // libcis_ns_containers_unord_unord_multiset_key_eq_366db65e (libcis)
