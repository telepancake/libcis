// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_insert_node_type_6cfcb50b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_insert_node_type_6cfcb50b { // libcis
...
} // libcis_ns_containers_unord_unord_multiset_insert_node_type_6cfcb50b (libcis)
