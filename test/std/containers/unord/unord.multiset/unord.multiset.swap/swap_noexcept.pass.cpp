// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_unord_multiset_swap_swap_noexcept_ea31d060).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_unord_multiset_swap_swap_noexcept_ea31d060 { // libcis
template <class T>
struct some_comp
{
...
} // libcis_ns_containers_unord_unord_multiset_unord_multiset_swap_swap_noexcept_ea31d060 (libcis)
