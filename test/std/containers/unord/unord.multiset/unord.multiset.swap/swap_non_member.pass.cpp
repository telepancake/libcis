// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_unord_multiset_swap_swap_non_member_71f463ee).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_unord_multiset_swap_swap_non_member_71f463ee { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_multiset_unord_multiset_swap_swap_non_member_71f463ee (libcis)
