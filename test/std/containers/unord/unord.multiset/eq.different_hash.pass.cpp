// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_eq_different_hash_d6ee1ac2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_eq_different_hash_d6ee1ac2 { // libcis
template <class T>
...
} // libcis_ns_containers_unord_unord_multiset_eq_different_hash_d6ee1ac2 (libcis)
