// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_extract_key_14d314d3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_extract_key_14d314d3 { // libcis
...
} // libcis_ns_containers_unord_unord_multiset_extract_key_14d314d3 (libcis)
