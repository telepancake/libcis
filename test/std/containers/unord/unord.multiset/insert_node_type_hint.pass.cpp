// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_insert_node_type_hint_3bf63b0b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_insert_node_type_hint_3bf63b0b { // libcis
...
} // libcis_ns_containers_unord_unord_multiset_insert_node_type_hint_3bf63b0b (libcis)
