// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_eq_8f4a02da).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_eq_8f4a02da { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_multiset_eq_8f4a02da (libcis)
