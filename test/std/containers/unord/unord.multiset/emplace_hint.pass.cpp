// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_emplace_hint_5b0a54d2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_emplace_hint_5b0a54d2 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_unord_unord_multiset_emplace_hint_5b0a54d2 (libcis)
