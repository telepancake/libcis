// transferred+adapted from libc++ by tools/transfer.py (slug=containers_unord_unord_multiset_merge_cc9503b7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_unord_unord_multiset_merge_cc9503b7 { // libcis
template <class Set>
...
} // libcis_ns_containers_unord_unord_multiset_merge_cc9503b7 (libcis)
