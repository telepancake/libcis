// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_front_back_72670470).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_front_back_72670470 { // libcis
...
} // libcis_ns_containers_sequences_array_front_back_72670470 (libcis)
