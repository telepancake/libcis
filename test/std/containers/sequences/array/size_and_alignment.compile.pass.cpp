// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_array_size_and_alignment).
...
namespace libcis_ns_containers_sequences_array_size_and_alignment { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_array_size_and_alignment; // libcis
