// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_size_and_alignment_ab9928ae).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_size_and_alignment_ab9928ae { // libcis
...
} // libcis_ns_containers_sequences_array_size_and_alignment_ab9928ae (libcis)
