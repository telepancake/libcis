// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_array_creation_to_array_0ae6ca4e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_array_creation_to_array_0ae6ca4e { // libcis
...
} // libcis_ns_containers_sequences_array_array_creation_to_array_0ae6ca4e (libcis)
