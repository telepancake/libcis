// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_array_array_creation_to_array).
// main -> test_containers_sequences_array_array_creation_to_array; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_array_creation_to_array { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_array_array_creation_to_array; // libcis


void test_containers_sequences_array_array_creation_to_array() {
  tests();
  static_assert(tests(), "");
  return;
}
