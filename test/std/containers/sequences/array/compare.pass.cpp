// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_compare_bc9d127c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_compare_bc9d127c { // libcis
...
} // libcis_ns_containers_sequences_array_compare_bc9d127c (libcis)
