// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_contiguous_9ea994dc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_contiguous_9ea994dc { // libcis
...
} // libcis_ns_containers_sequences_array_contiguous_9ea994dc (libcis)
