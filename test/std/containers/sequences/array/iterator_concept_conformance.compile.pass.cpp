// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_iterator_concept_conformance_be61e710).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_iterator_concept_conformance_be61e710 { // libcis
...
} // libcis_ns_containers_sequences_array_iterator_concept_conformance_be61e710 (libcis)
