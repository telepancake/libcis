// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_range_concept_conformance_ac02a467).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_range_concept_conformance_ac02a467 { // libcis
...
} // libcis_ns_containers_sequences_array_range_concept_conformance_ac02a467 (libcis)
