// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_array_special_swap_95f3867a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_array_special_swap_95f3867a { // libcis
struct NonSwappable {
...
} // libcis_ns_containers_sequences_array_array_special_swap_95f3867a (libcis)
