// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_array_array_special_swap).
// main -> test_containers_sequences_array_array_special_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_array_special_swap { // libcis: isolate file-scope helpers
struct NonSwappable {
...
} using namespace libcis_ns_containers_sequences_array_array_special_swap; // libcis


void test_containers_sequences_array_array_special_swap() {
  tests();
#if TEST_STD_VER >= 20
  static_assert(tests(), "");
#endif
