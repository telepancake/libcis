// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_array_types).
// main -> test_containers_sequences_array_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_types { // libcis: isolate file-scope helpers
template <class C>
void test_iterators() {
...
} using namespace libcis_ns_containers_sequences_array_types; // libcis


void test_containers_sequences_array_types() {
  {
    typedef double T;
