// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_types_16f731b0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_types_16f731b0 { // libcis
template <class C>
void test_iterators() {
...
} // libcis_ns_containers_sequences_array_types_16f731b0 (libcis)
