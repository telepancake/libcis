// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_array_cons_deduct_744247bc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_array_cons_deduct_744247bc { // libcis
...
} // libcis_ns_containers_sequences_array_array_cons_deduct_744247bc (libcis)
