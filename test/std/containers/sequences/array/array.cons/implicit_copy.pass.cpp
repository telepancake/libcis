// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_array_cons_implicit_copy_045ea993).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_array_cons_implicit_copy_045ea993 { // libcis
struct NoDefault {
...
} // libcis_ns_containers_sequences_array_array_cons_implicit_copy_045ea993 (libcis)
