// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_array_array_cons_implicit_copy).
// main -> test_containers_sequences_array_array_cons_implicit_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_array_cons_implicit_copy { // libcis: isolate file-scope helpers
struct NoDefault {
...
} using namespace libcis_ns_containers_sequences_array_array_cons_implicit_copy; // libcis


void test_containers_sequences_array_array_cons_implicit_copy() {
  tests();
#if TEST_STD_VER >= 14
  static_assert(tests(), "");
#endif
