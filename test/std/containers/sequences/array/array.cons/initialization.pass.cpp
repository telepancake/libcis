// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_array_array_cons_initialization).
// main -> test_containers_sequences_array_array_cons_initialization; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_array_cons_initialization { // libcis: isolate file-scope helpers
struct NoDefault {
...
} using namespace libcis_ns_containers_sequences_array_array_cons_initialization; // libcis

#endif

void test_containers_sequences_array_array_cons_initialization() {
