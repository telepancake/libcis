// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_array_cons_initialization_e78ed5fa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_array_cons_initialization_e78ed5fa { // libcis
struct NoDefault {
...
} // libcis_ns_containers_sequences_array_array_cons_initialization_e78ed5fa (libcis)
