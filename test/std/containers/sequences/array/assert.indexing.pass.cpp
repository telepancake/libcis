// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_array_assert_indexing).
// main -> test_containers_sequences_array_assert_indexing; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_sequences_array_assert_indexing() {
