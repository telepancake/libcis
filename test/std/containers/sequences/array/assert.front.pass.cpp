// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_array_assert_front).
// main -> test_containers_sequences_array_assert_front; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_sequences_array_assert_front() {
  {
