// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_at_b5a6f66b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_at_b5a6f66b { // libcis
...
} // libcis_ns_containers_sequences_array_at_b5a6f66b (libcis)
