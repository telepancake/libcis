// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_compare_three_way_036112f2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_compare_three_way_036112f2 { // libcis
...
} // libcis_ns_containers_sequences_array_compare_three_way_036112f2 (libcis)
