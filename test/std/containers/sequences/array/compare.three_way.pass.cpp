// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_array_compare_three_way).
// main -> test_containers_sequences_array_compare_three_way; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_compare_three_way { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_array_compare_three_way; // libcis


void test_containers_sequences_array_compare_three_way() {
