// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_array_array_tuple_get_const_rv).
// main -> test_containers_sequences_array_array_tuple_get_const_rv; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_sequences_array_array_tuple_get_const_rv() {
  {
