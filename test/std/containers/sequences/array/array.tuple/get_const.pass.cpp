// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_array_tuple_get_const_a070a294).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_array_tuple_get_const_a070a294 { // libcis
...
} // libcis_ns_containers_sequences_array_array_tuple_get_const_a070a294 (libcis)
