// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_array_array_tuple_get).
// main -> test_containers_sequences_array_array_tuple_get; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_array_tuple_get { // libcis: isolate file-scope helpers
template <typename... T>
...
} using namespace libcis_ns_containers_sequences_array_array_tuple_get; // libcis


void test_containers_sequences_array_array_tuple_get() {
  tests();
#if TEST_STD_VER >= 14
  static_assert(tests(), "");
#endif
