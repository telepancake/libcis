// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_array_tuple_get_e59bd4a1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_array_tuple_get_e59bd4a1 { // libcis
template <typename ...T>
...
} // libcis_ns_containers_sequences_array_array_tuple_get_e59bd4a1 (libcis)
