// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_array_at_const).
// main -> test_containers_sequences_array_at_const; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_at_const { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_array_at_const; // libcis


void test_containers_sequences_array_at_const() {
  tests();
  test_exceptions();
