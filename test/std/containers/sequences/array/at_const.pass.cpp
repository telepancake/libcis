// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_at_const_57c2367c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_at_const_57c2367c { // libcis
...
} // libcis_ns_containers_sequences_array_at_const_57c2367c (libcis)
