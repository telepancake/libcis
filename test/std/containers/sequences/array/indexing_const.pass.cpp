// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_indexing_const_6207873c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_indexing_const_6207873c { // libcis
...
} // libcis_ns_containers_sequences_array_indexing_const_6207873c (libcis)
