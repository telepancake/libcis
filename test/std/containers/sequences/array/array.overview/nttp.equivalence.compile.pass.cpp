// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_array_overview_nttp_equivalence_4241f780).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_array_overview_nttp_equivalence_4241f780 { // libcis
...
} // libcis_ns_containers_sequences_array_array_overview_nttp_equivalence_4241f780 (libcis)
 // namespace test_auto
