// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_iterators_b8299e5d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_iterators_b8299e5d { // libcis
struct NoDefault {
...
} // libcis_ns_containers_sequences_array_iterators_b8299e5d (libcis)
