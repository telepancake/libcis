// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_array_aggregate_e7d5f3c0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_array_aggregate_e7d5f3c0 { // libcis
template <typename T>
...
} // libcis_ns_containers_sequences_array_aggregate_e7d5f3c0 (libcis)
