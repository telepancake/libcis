// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_data_data_const).
// main -> test_containers_sequences_vector_vector_data_data_const; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_data_data_const { // libcis: isolate file-scope helpers
struct Nasty {
...
} using namespace libcis_ns_containers_sequences_vector_vector_data_data_const; // libcis


void test_containers_sequences_vector_vector_data_data_const() {
  tests();
#if TEST_STD_VER > 17
  static_assert(tests());
#endif
