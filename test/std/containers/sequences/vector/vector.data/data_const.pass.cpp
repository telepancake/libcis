// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_data_data_const_8eff68ed).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_data_data_const_8eff68ed { // libcis
struct Nasty {
...
} // libcis_ns_containers_sequences_vector_vector_data_data_const_8eff68ed (libcis)
