// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_reverse_iterators_a86f691c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_reverse_iterators_a86f691c { // libcis
...
} // libcis_ns_containers_sequences_vector_reverse_iterators_a86f691c (libcis)
