// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_trivial_relocation_30e3c095).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_trivial_relocation_30e3c095 { // libcis
struct Tracker {
...
} // libcis_ns_containers_sequences_vector_trivial_relocation_30e3c095 (libcis)
