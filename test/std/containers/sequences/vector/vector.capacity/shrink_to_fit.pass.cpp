// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_capacity_shrink_to_fit_1fb70c0f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_capacity_shrink_to_fit_1fb70c0f { // libcis
...
} // libcis_ns_containers_sequences_vector_vector_capacity_shrink_to_fit_1fb70c0f (libcis)
