// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_modifiers_erase_iter_iter).
// main -> test_containers_sequences_vector_vector_modifiers_erase_iter_iter; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_modifiers_erase_iter_iter { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_vector_modifiers_erase_iter_iter; // libcis


void test_containers_sequences_vector_vector_modifiers_erase_iter_iter() {
  tests();
#if TEST_STD_VER >= 20
  static_assert(tests());
#endif
