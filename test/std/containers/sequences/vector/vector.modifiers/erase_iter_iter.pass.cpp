// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_modifiers_erase_iter_iter_ca5fa6a3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_modifiers_erase_iter_iter_ca5fa6a3 { // libcis
...
} // libcis_ns_containers_sequences_vector_vector_modifiers_erase_iter_iter_ca5fa6a3 (libcis)
