// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_modifiers_insert_iter_lvalue_a0fbe175).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_modifiers_insert_iter_lvalue_a0fbe175 { // libcis
...
} // libcis_ns_containers_sequences_vector_vector_modifiers_insert_iter_lvalue_a0fbe175 (libcis)
