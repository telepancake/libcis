// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_modifiers_destroy_elements).
// main -> test_containers_sequences_vector_vector_modifiers_destroy_elements; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_modifiers_destroy_elements { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_vector_modifiers_destroy_elements; // libcis


void test_containers_sequences_vector_vector_modifiers_destroy_elements() {
  test();
#if TEST_STD_VER >= 20
  static_assert(test());
#endif
