// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_modifiers_insert_iter_iter_iter_e6b9790d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_modifiers_insert_iter_iter_iter_e6b9790d { // libcis
namespace adl {
struct S {};
...
} // libcis_ns_containers_sequences_vector_vector_modifiers_insert_iter_iter_iter_e6b9790d (libcis)
