// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_modifiers_push_back_exception_safety).
// main -> test_containers_sequences_vector_vector_modifiers_push_back_exception_safety; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_modifiers_push_back_exception_safety { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_vector_modifiers_push_back_exception_safety; // libcis
...
void test_containers_sequences_vector_vector_modifiers_push_back_exception_safety() {
