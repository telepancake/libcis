// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_modifiers_insert_iter_initializer_list_54887789).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_modifiers_insert_iter_initializer_list_54887789 { // libcis
...
} // libcis_ns_containers_sequences_vector_vector_modifiers_insert_iter_initializer_list_54887789 (libcis)
