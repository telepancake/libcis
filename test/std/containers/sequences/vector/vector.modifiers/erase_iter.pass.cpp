// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_modifiers_erase_iter_45c63be1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_modifiers_erase_iter_45c63be1 { // libcis
...
} // libcis_ns_containers_sequences_vector_vector_modifiers_erase_iter_45c63be1 (libcis)
