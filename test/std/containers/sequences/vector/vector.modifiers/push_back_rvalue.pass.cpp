// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_modifiers_push_back_rvalue_d3c09f3d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_modifiers_push_back_rvalue_d3c09f3d { // libcis
...
} // libcis_ns_containers_sequences_vector_vector_modifiers_push_back_rvalue_d3c09f3d (libcis)
