// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_modifiers_emplace_c769cab5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_modifiers_emplace_c769cab5 { // libcis
class A
{
    int i_;
    double d_;
...
} // libcis_ns_containers_sequences_vector_vector_modifiers_emplace_c769cab5 (libcis)
