// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_iterators_51e841a6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_iterators_51e841a6 { // libcis
struct A
{
    int first;
    int second;
...
} // libcis_ns_containers_sequences_vector_iterators_51e841a6 (libcis)
