// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_range_concept_conformance_15f0feb5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_range_concept_conformance_15f0feb5 { // libcis
...
} // libcis_ns_containers_sequences_vector_range_concept_conformance_15f0feb5 (libcis)
