// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_special_swap_c4fc670a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_special_swap_c4fc670a { // libcis
template <typename A>
...
} // libcis_ns_containers_sequences_vector_vector_special_swap_c4fc670a (libcis)
