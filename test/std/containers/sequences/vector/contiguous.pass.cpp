// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_contiguous_90a04f4b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_contiguous_90a04f4b { // libcis
template <class C>
...
} // libcis_ns_containers_sequences_vector_contiguous_90a04f4b (libcis)
