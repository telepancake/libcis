// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_cons_move_alloc_adf57dfb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_cons_move_alloc_adf57dfb { // libcis
...
} // libcis_ns_containers_sequences_vector_vector_cons_move_alloc_adf57dfb (libcis)
