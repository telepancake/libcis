// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_cons_move_alloc).
// main -> test_containers_sequences_vector_vector_cons_move_alloc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_cons_move_alloc { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_vector_cons_move_alloc; // libcis


void test_containers_sequences_vector_vector_cons_move_alloc() {
  tests();
#if TEST_STD_VER > 17
  static_assert(tests());
#endif
