// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_cons_construct_default_3d09dad8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_cons_construct_default_3d09dad8 { // libcis
template <class C>
...
} // libcis_ns_containers_sequences_vector_vector_cons_construct_default_3d09dad8 (libcis)
