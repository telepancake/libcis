// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_cons_assign_iter_iter).
// main -> test_containers_sequences_vector_vector_cons_assign_iter_iter; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_cons_assign_iter_iter { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_vector_cons_assign_iter_iter; // libcis


void test_containers_sequences_vector_vector_cons_assign_iter_iter() {
  test();
#if TEST_STD_VER > 17
  static_assert(test());
#endif
