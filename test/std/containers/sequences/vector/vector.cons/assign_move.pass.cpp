// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_cons_assign_move_06bdc4f4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_cons_assign_move_06bdc4f4 { // libcis
...
} // libcis_ns_containers_sequences_vector_vector_cons_assign_move_06bdc4f4 (libcis)
