// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_cons_construct_iter_iter_767e8641).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_cons_construct_iter_iter_767e8641 { // libcis
...
} // libcis_ns_containers_sequences_vector_vector_cons_construct_iter_iter_767e8641 (libcis)
