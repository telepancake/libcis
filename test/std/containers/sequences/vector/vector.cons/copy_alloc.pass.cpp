// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_cons_copy_alloc_ebf9240b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_cons_copy_alloc_ebf9240b { // libcis
template <class C>
...
} // libcis_ns_containers_sequences_vector_vector_cons_copy_alloc_ebf9240b (libcis)
