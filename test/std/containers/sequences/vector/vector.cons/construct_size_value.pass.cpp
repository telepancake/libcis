// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_cons_construct_size_value_b226ab14).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_cons_construct_size_value_b226ab14 { // libcis
template <class C>
...
} // libcis_ns_containers_sequences_vector_vector_cons_construct_size_value_b226ab14 (libcis)
