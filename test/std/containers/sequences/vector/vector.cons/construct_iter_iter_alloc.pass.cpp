// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_cons_construct_iter_iter_alloc).
// main -> test_containers_sequences_vector_vector_cons_construct_iter_iter_alloc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_cons_construct_iter_iter_alloc { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_vector_cons_construct_iter_iter_alloc; // libcis


void test_containers_sequences_vector_vector_cons_construct_iter_iter_alloc() {
  test();
#if TEST_STD_VER > 17
  static_assert(test());
#endif
