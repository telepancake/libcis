// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_cons_construct_size_e6046f1b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_cons_construct_size_e6046f1b { // libcis
template <class C>
...
} // libcis_ns_containers_sequences_vector_vector_cons_construct_size_e6046f1b (libcis)
