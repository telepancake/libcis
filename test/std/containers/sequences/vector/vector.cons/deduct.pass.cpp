// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_cons_deduct_fc834fc9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_cons_deduct_fc834fc9 { // libcis
struct A {};
...
} // libcis_ns_containers_sequences_vector_vector_cons_deduct_fc834fc9 (libcis)
