// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_cons_deduct).
// main -> test_containers_sequences_vector_vector_cons_deduct; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_cons_deduct { // libcis: isolate file-scope helpers
struct A {};
...
} using namespace libcis_ns_containers_sequences_vector_vector_cons_deduct; // libcis


void test_containers_sequences_vector_vector_cons_deduct() {
  tests();
#if TEST_STD_VER > 17
  static_assert(tests());
#endif
