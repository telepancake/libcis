// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_cons_assign_copy).
// main -> test_containers_sequences_vector_vector_cons_assign_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_cons_assign_copy { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_vector_cons_assign_copy; // libcis


void test_containers_sequences_vector_vector_cons_assign_copy() {
  tests();
#if TEST_STD_VER > 17
  static_assert(tests());
#endif
