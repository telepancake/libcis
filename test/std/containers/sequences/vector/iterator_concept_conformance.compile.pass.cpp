// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_iterator_concept_conformance).
...
namespace libcis_ns_containers_sequences_vector_iterator_concept_conformance { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_iterator_concept_conformance; // libcis
