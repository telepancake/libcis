// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_types).
// main -> test_containers_sequences_vector_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_types { // libcis: isolate file-scope helpers
struct A {
  std::vector<A> v;
...
} using namespace libcis_ns_containers_sequences_vector_types; // libcis


void test_containers_sequences_vector_types() {
