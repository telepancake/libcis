// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_types_68f8f08d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_types_68f8f08d { // libcis
...
} // libcis_ns_containers_sequences_vector_types_68f8f08d (libcis)
