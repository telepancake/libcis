// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_compare).
// main -> test_containers_sequences_vector_compare; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_compare { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_compare; // libcis


void test_containers_sequences_vector_compare() {
  test();
#if TEST_STD_VER > 17
  static_assert(test());
#endif
