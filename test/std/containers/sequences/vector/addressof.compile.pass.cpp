// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_addressof).
...
namespace libcis_ns_containers_sequences_vector_addressof { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_addressof; // libcis
