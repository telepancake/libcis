// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_erasure_erase_if_82f63f1d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_erasure_erase_if_82f63f1d { // libcis
...
} // libcis_ns_containers_sequences_vector_vector_erasure_erase_if_82f63f1d (libcis)
