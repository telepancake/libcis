// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_vector_erasure_erase_cec8d31b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_vector_erasure_erase_cec8d31b { // libcis
...
} // libcis_ns_containers_sequences_vector_vector_erasure_erase_cec8d31b (libcis)
