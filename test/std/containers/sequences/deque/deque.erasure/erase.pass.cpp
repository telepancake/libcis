// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_erasure_erase_d3cf72a1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_erasure_erase_d3cf72a1 { // libcis
...
} // libcis_ns_containers_sequences_deque_deque_erasure_erase_d3cf72a1 (libcis)
