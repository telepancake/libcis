// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_erasure_erase_if).
// main -> test_containers_sequences_deque_deque_erasure_erase_if; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_erasure_erase_if { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_deque_deque_erasure_erase_if; // libcis


void test_containers_sequences_deque_deque_erasure_erase_if() {
  test<std::deque<int>>();
