// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_erasure_erase_if_0bf844b2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_erasure_erase_if_0bf844b2 { // libcis
...
} // libcis_ns_containers_sequences_deque_deque_erasure_erase_if_0bf844b2 (libcis)
