// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_capacity_resize_size_e8094560).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_capacity_resize_size_e8094560 { // libcis
template <class C>
C
...
} // libcis_ns_containers_sequences_deque_deque_capacity_resize_size_e8094560 (libcis)
