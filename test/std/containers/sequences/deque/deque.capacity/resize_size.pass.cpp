// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_capacity_resize_size).
// main -> test_containers_sequences_deque_deque_capacity_resize_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_capacity_resize_size { // libcis: isolate file-scope helpers
template <class C>
...
} using namespace libcis_ns_containers_sequences_deque_deque_capacity_resize_size; // libcis


void test_containers_sequences_deque_deque_capacity_resize_size() {
  {
