// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_capacity_access_c2a32126).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_capacity_access_c2a32126 { // libcis
template <class C>
C
...
} // libcis_ns_containers_sequences_deque_deque_capacity_access_c2a32126 (libcis)
