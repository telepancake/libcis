// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_capacity_resize_size_value_55360b27).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_capacity_resize_size_value_55360b27 { // libcis
template <class C>
C
...
} // libcis_ns_containers_sequences_deque_deque_capacity_resize_size_value_55360b27 (libcis)
