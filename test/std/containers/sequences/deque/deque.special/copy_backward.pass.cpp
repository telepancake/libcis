// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_special_copy_backward).
// main -> test_containers_sequences_deque_deque_special_copy_backward; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_special_copy_backward { // libcis: isolate file-scope helpers
template <class C>
...
} using namespace libcis_ns_containers_sequences_deque_deque_special_copy_backward; // libcis


void test_containers_sequences_deque_deque_special_copy_backward() {
  {
