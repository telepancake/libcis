// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_special_copy_backward_3a1ad2cf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_special_copy_backward_3a1ad2cf { // libcis
template <class C>
C
...
} // libcis_ns_containers_sequences_deque_deque_special_copy_backward_3a1ad2cf (libcis)
