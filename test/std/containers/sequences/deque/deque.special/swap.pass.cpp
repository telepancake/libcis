// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_special_swap).
// main -> test_containers_sequences_deque_deque_special_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_special_swap { // libcis: isolate file-scope helpers
template <class C>
...
} using namespace libcis_ns_containers_sequences_deque_deque_special_swap; // libcis


void test_containers_sequences_deque_deque_special_swap() {
  {
