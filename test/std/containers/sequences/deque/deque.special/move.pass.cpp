// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_special_move).
// main -> test_containers_sequences_deque_deque_special_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_special_move { // libcis: isolate file-scope helpers
template <class C>
...
} using namespace libcis_ns_containers_sequences_deque_deque_special_move; // libcis


void test_containers_sequences_deque_deque_special_move() {
  {
