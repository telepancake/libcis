// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_range_concept_conformance_5edca8cf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_range_concept_conformance_5edca8cf { // libcis
...
} // libcis_ns_containers_sequences_deque_range_concept_conformance_5edca8cf (libcis)
