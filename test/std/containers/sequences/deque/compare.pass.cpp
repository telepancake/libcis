// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_deque_compare).
// main -> test_containers_sequences_deque_compare; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_sequences_deque_compare() {
  {
