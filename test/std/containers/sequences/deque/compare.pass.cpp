// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_compare_a6e14a92).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_compare_a6e14a92 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_sequences_deque_compare_a6e14a92 (libcis)
