// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_types_bac2e4d5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_types_bac2e4d5 { // libcis
...
} // libcis_ns_containers_sequences_deque_types_bac2e4d5 (libcis)
