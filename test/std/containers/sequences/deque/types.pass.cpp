// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_deque_types).
// main -> test_containers_sequences_deque_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_deque_types; // libcis


void test_containers_sequences_deque_types() {
