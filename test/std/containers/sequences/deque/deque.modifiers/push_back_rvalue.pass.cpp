// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_modifiers_push_back_rvalue_d4485df5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_modifiers_push_back_rvalue_d4485df5 { // libcis
template <class C>
C
...
} // libcis_ns_containers_sequences_deque_deque_modifiers_push_back_rvalue_d4485df5 (libcis)
