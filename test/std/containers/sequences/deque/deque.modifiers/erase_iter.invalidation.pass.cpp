// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_modifiers_erase_iter_invalidation_928ca828).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_modifiers_erase_iter_invalidation_928ca828 { // libcis
template <typename C>
...
} // libcis_ns_containers_sequences_deque_deque_modifiers_erase_iter_invalidation_928ca828 (libcis)
