// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_modifiers_emplace_622ebfd5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_modifiers_emplace_622ebfd5 { // libcis
template <class C>
C
...
} // libcis_ns_containers_sequences_deque_deque_modifiers_emplace_622ebfd5 (libcis)
