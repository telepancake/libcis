// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_modifiers_insert_rvalue_2299d5e7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_modifiers_insert_rvalue_2299d5e7 { // libcis
template <class C>
C
...
} // libcis_ns_containers_sequences_deque_deque_modifiers_insert_rvalue_2299d5e7 (libcis)
