// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_modifiers_erase_iter_iter_invalidation_e8fbb76b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_modifiers_erase_iter_iter_invalidation_e8fbb76b { // libcis
template <typename C>
...
} // libcis_ns_containers_sequences_deque_deque_modifiers_erase_iter_iter_invalidation_e8fbb76b (libcis)
