// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_modifiers_insert_value_4f9642e9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_modifiers_insert_value_4f9642e9 { // libcis
template <class C>
C
...
} // libcis_ns_containers_sequences_deque_deque_modifiers_insert_value_4f9642e9 (libcis)
