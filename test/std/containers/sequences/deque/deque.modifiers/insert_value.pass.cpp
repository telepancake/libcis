// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_modifiers_insert_value).
// main -> test_containers_sequences_deque_deque_modifiers_insert_value; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_modifiers_insert_value { // libcis: isolate file-scope helpers
template <class C>
...
} using namespace libcis_ns_containers_sequences_deque_deque_modifiers_insert_value; // libcis


void test_containers_sequences_deque_deque_modifiers_insert_value() {
  {
