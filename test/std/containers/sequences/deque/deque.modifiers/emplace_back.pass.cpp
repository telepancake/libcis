// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_modifiers_emplace_back_d477d26c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_modifiers_emplace_back_d477d26c { // libcis
template <class C>
C
...
} // libcis_ns_containers_sequences_deque_deque_modifiers_emplace_back_d477d26c (libcis)
