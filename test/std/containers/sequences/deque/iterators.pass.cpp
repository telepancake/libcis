// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_iterators_e9b2ff15).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_iterators_e9b2ff15 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_sequences_deque_iterators_e9b2ff15 (libcis)
