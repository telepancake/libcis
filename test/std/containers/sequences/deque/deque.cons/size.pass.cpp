// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_cons_size_14c295af).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_cons_size_14c295af { // libcis
...
} // libcis_ns_containers_sequences_deque_deque_cons_size_14c295af (libcis)
