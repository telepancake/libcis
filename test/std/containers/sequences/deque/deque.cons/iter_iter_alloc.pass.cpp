// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_cons_iter_iter_alloc_cd879fa1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_cons_iter_iter_alloc_cd879fa1 { // libcis
...
} // libcis_ns_containers_sequences_deque_deque_cons_iter_iter_alloc_cd879fa1 (libcis)
