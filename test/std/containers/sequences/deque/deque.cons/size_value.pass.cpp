// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_cons_size_value_6b32edfc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_cons_size_value_6b32edfc { // libcis
...
} // libcis_ns_containers_sequences_deque_deque_cons_size_value_6b32edfc (libcis)
