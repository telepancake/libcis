// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_cons_move_alloc_76a8155f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_cons_move_alloc_76a8155f { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_sequences_deque_deque_cons_move_alloc_76a8155f (libcis)
