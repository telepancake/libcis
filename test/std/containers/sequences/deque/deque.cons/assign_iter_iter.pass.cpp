// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_cons_assign_iter_iter_037f1a84).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_cons_assign_iter_iter_037f1a84 { // libcis
template <class C>
C
...
} // libcis_ns_containers_sequences_deque_deque_cons_assign_iter_iter_037f1a84 (libcis)
