// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_cons_copy_f0ac3275).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_cons_copy_f0ac3275 { // libcis
template <class C>
void
test(const C& x)
{
...
} // libcis_ns_containers_sequences_deque_deque_cons_copy_f0ac3275 (libcis)
