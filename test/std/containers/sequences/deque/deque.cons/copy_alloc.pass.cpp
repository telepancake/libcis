// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_cons_copy_alloc_cf7b0665).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_cons_copy_alloc_cf7b0665 { // libcis
template <class C>
void
...
} // libcis_ns_containers_sequences_deque_deque_cons_copy_alloc_cf7b0665 (libcis)
