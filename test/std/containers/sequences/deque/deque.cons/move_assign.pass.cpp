// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_cons_move_assign_e5f26527).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_cons_move_assign_e5f26527 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_sequences_deque_deque_cons_move_assign_e5f26527 (libcis)
