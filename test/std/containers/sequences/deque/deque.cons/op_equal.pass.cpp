// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_cons_op_equal).
// main -> test_containers_sequences_deque_deque_cons_op_equal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_cons_op_equal { // libcis: isolate file-scope helpers
template <class C>
void test(const C& x) {
  C c;
  c = x;
...
} using namespace libcis_ns_containers_sequences_deque_deque_cons_op_equal; // libcis


void test_containers_sequences_deque_deque_cons_op_equal() {
  {
