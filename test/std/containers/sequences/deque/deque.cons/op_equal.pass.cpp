// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_cons_op_equal_10a9a353).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_deque_deque_cons_op_equal_10a9a353 { // libcis
template <class C>
void
test(const C& x)
{
...
} // libcis_ns_containers_sequences_deque_deque_cons_op_equal_10a9a353 (libcis)
