// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_deque_deque_cons_move).
// main -> test_containers_sequences_deque_deque_cons_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_sequences_deque_deque_cons_move() {
  {
