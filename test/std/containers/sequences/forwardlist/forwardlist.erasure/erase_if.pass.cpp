// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_erasure_erase_if_46125670).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_erasure_erase_if_46125670 { // libcis
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_erasure_erase_if_46125670 (libcis)
