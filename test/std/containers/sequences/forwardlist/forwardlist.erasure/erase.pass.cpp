// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_erasure_erase_047d62c8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_erasure_erase_047d62c8 { // libcis
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_erasure_erase_047d62c8 (libcis)
