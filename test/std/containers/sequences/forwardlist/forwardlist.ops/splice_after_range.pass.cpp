// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_ops_splice_after_range_08428e0c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_ops_splice_after_range_08428e0c { // libcis
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_ops_splice_after_range_08428e0c (libcis)
