// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_ops_remove_if_85025593).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_ops_remove_if_85025593 { // libcis
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_ops_remove_if_85025593 (libcis)
