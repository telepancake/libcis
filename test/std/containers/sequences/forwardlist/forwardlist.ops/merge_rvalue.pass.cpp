// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_ops_merge_rvalue_bb00a9cd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_ops_merge_rvalue_bb00a9cd { // libcis
struct value {
  int a;
  int b;
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_ops_merge_rvalue_bb00a9cd (libcis)
