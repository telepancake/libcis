// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_ops_unique_pred_c4c092e2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_ops_unique_pred_c4c092e2 { // libcis
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_ops_unique_pred_c4c092e2 (libcis)
