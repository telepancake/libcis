// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_ops_merge_lvalue_ed334e26).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_ops_merge_lvalue_ed334e26 { // libcis
struct value {
  int a;
  int b;
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_ops_merge_lvalue_ed334e26 (libcis)
