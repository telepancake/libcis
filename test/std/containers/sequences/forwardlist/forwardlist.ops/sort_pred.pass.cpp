// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_ops_sort_pred).
// main -> test_containers_sequences_forwardlist_forwardlist_ops_sort_pred; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_ops_sort_pred { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_forwardlist_forwardlist_ops_sort_pred; // libcis


void test_containers_sequences_forwardlist_forwardlist_ops_sort_pred() {
  for (int i = 0; i < 40; ++i)
