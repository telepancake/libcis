// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_ops_splice_after_flist_3d40ce58).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_ops_splice_after_flist_3d40ce58 { // libcis
typedef int T;
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_ops_splice_after_flist_3d40ce58 (libcis)
