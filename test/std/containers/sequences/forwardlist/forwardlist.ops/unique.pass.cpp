// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_ops_unique_6110678d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_ops_unique_6110678d { // libcis
template <class L>
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_ops_unique_6110678d (libcis)
