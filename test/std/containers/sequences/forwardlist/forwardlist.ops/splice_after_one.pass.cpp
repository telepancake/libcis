// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_ops_splice_after_one_8aeca7eb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_ops_splice_after_one_8aeca7eb { // libcis
typedef int T;
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_ops_splice_after_one_8aeca7eb (libcis)
