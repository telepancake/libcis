// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_ops_remove_76b31d3b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_ops_remove_76b31d3b { // libcis
template <class L>
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_ops_remove_76b31d3b (libcis)
