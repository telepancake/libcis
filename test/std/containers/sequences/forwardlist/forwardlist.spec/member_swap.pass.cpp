// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_spec_member_swap_9117722d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_spec_member_swap_9117722d { // libcis
int main(int, char**)
{
    {
        typedef int T;
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_spec_member_swap_9117722d (libcis)
