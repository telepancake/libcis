// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_spec_swap_noexcept).
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_spec_swap_noexcept { // libcis: isolate file-scope helpers
template <class T>
struct some_alloc {
...
} using namespace libcis_ns_containers_sequences_forwardlist_forwardlist_spec_swap_noexcept; // libcis
