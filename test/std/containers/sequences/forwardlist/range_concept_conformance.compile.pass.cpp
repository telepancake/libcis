// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_range_concept_conformance_2da19ad9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_range_concept_conformance_2da19ad9 { // libcis
...
} // libcis_ns_containers_sequences_forwardlist_range_concept_conformance_2da19ad9 (libcis)
