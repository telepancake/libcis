// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_types_364a9e72).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_types_364a9e72 { // libcis
struct my_base {
...
} // libcis_ns_containers_sequences_forwardlist_types_364a9e72 (libcis)
