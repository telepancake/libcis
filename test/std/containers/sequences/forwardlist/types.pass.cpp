// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_types).
// main -> test_containers_sequences_forwardlist_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_types { // libcis: isolate file-scope helpers
struct my_base {
...
} using namespace libcis_ns_containers_sequences_forwardlist_types; // libcis
 // incomplete type support

void test_containers_sequences_forwardlist_types() {
  {
