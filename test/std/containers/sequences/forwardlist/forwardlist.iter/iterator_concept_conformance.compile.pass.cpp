// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_iter_iterator_concept_conformance_dfe8ed3d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_iter_iterator_concept_conformance_dfe8ed3d { // libcis
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_iter_iterator_concept_conformance_dfe8ed3d (libcis)
