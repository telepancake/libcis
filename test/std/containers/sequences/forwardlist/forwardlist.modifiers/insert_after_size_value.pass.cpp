// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_modifiers_insert_after_size_value_184c1c52).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_modifiers_insert_after_size_value_184c1c52 { // libcis
int main(int, char**)
{
    {
        typedef int T;
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_modifiers_insert_after_size_value_184c1c52 (libcis)
