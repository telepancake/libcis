// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_modifiers_erase_after_one_d9c29ba5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_modifiers_erase_after_one_d9c29ba5 { // libcis
int main(int, char**)
{
    {
        typedef int T;
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_modifiers_erase_after_one_d9c29ba5 (libcis)
