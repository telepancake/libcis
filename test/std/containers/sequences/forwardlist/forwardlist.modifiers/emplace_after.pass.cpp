// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_modifiers_emplace_after_b83be75f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_modifiers_emplace_after_b83be75f { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_modifiers_emplace_after_b83be75f (libcis)
