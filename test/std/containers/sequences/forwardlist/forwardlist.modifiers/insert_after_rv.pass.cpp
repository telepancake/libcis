// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_modifiers_insert_after_rv_3fbe7ba9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_modifiers_insert_after_rv_3fbe7ba9 { // libcis
int main(int, char**)
{
    {
        typedef MoveOnly T;
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_modifiers_insert_after_rv_3fbe7ba9 (libcis)
