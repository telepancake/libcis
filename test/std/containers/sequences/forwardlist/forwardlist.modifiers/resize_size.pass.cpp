// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_modifiers_resize_size_17ff180f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_modifiers_resize_size_17ff180f { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_modifiers_resize_size_17ff180f (libcis)
