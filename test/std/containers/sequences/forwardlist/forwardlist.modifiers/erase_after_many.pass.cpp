// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_modifiers_erase_after_many_7d160969).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_modifiers_erase_after_many_7d160969 { // libcis
int main(int, char**)
{
    {
        typedef int T;
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_modifiers_erase_after_many_7d160969 (libcis)
