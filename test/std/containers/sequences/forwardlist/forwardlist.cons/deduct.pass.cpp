// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_cons_deduct_14f23a58).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_cons_deduct_14f23a58 { // libcis
struct A {};
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_cons_deduct_14f23a58 (libcis)
