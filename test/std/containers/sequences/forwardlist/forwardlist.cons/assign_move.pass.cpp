// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_cons_assign_move_b2ba22e6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_cons_assign_move_b2ba22e6 { // libcis
int main(int, char**)
{
    {
        typedef MoveOnly T;
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_cons_assign_move_b2ba22e6 (libcis)
