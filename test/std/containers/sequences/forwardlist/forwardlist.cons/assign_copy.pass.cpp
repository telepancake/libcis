// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_cons_assign_copy_de582613).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_cons_assign_copy_de582613 { // libcis
int main(int, char**)
{
    {
        typedef int T;
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_cons_assign_copy_de582613 (libcis)
