// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_forwardlist_forwardlist_cons_size_ccfaceae).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_forwardlist_forwardlist_cons_size_ccfaceae { // libcis
...
} // libcis_ns_containers_sequences_forwardlist_forwardlist_cons_size_ccfaceae (libcis)
