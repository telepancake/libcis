// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_iterator_concept_conformance_83ef8ccf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_iterator_concept_conformance_83ef8ccf { // libcis
...
} // libcis_ns_containers_sequences_list_iterator_concept_conformance_83ef8ccf (libcis)
