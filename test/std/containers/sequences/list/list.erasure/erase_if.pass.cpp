// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_erasure_erase_if_dcfb3348).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_erasure_erase_if_dcfb3348 { // libcis
...
} // libcis_ns_containers_sequences_list_list_erasure_erase_if_dcfb3348 (libcis)
