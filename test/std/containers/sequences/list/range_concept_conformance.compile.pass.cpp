// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_range_concept_conformance_6fa7858a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_range_concept_conformance_6fa7858a { // libcis
...
} // libcis_ns_containers_sequences_list_range_concept_conformance_6fa7858a (libcis)
