// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_types_2f0695f0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_types_2f0695f0 { // libcis
struct my_base {
...
} // libcis_ns_containers_sequences_list_types_2f0695f0 (libcis)
