// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_modifiers_insert_iter_iter_iter_774a8865).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_modifiers_insert_iter_iter_iter_774a8865 { // libcis
template <class List>
void test() {
    int a1[] = {1, 2, 3};
    List l1;
...
} // libcis_ns_containers_sequences_list_list_modifiers_insert_iter_iter_iter_774a8865 (libcis)
