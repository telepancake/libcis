// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_modifiers_insert_iter_value_0c62d25c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_modifiers_insert_iter_value_0c62d25c { // libcis
template <class List>
void test()
{
    int a1[] = {1, 2, 3};
...
} // libcis_ns_containers_sequences_list_list_modifiers_insert_iter_value_0c62d25c (libcis)
