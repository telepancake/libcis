// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_modifiers_erase_iter_iter_ab081764).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_modifiers_erase_iter_iter_ab081764 { // libcis
int main(int, char**)
{
    int a1[] = {1, 2, 3};
    {
...
} // libcis_ns_containers_sequences_list_list_modifiers_erase_iter_iter_ab081764 (libcis)
