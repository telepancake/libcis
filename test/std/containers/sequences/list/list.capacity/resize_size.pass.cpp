// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_capacity_resize_size_3bec4e03).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_capacity_resize_size_3bec4e03 { // libcis
int main(int, char**)
{
    {
        std::list<int> l(5, 2);
...
} // libcis_ns_containers_sequences_list_list_capacity_resize_size_3bec4e03 (libcis)
