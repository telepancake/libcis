// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_special_swap_5a4f67fa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_special_swap_5a4f67fa { // libcis
int main(int, char**)
{
    {
        int a1[] = {1, 3, 7, 9, 10};
...
} // libcis_ns_containers_sequences_list_list_special_swap_5a4f67fa (libcis)
