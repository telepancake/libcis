// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_ops_unique_pred_5adcd7b0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_ops_unique_pred_5adcd7b0 { // libcis
bool g(int x, int y)
{
    return x == y;
}
...
} // libcis_ns_containers_sequences_list_list_ops_unique_pred_5adcd7b0 (libcis)
