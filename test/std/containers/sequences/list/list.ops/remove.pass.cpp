// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_ops_remove_50c8d8b4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_ops_remove_50c8d8b4 { // libcis
struct S {
...
} // libcis_ns_containers_sequences_list_list_ops_remove_50c8d8b4 (libcis)
