// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_ops_remove_if_ad3f127c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_ops_remove_if_ad3f127c { // libcis
bool even(int i)
{
    return i % 2 == 0;
}
...
} // libcis_ns_containers_sequences_list_list_ops_remove_if_ad3f127c (libcis)
