// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_ops_merge_comp_ece642e3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_ops_merge_comp_ece642e3 { // libcis
int main(int, char**)
{
    {
    int a1[] = {10, 9, 7, 3, 1};
...
} // libcis_ns_containers_sequences_list_list_ops_merge_comp_ece642e3 (libcis)
