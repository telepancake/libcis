// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_ops_splice_pos_list_6cd1eacb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_ops_splice_pos_list_6cd1eacb { // libcis
int main(int, char**)
{
    int a1[] = {1, 2, 3};
    int a2[] = {4, 5, 6};
...
} // libcis_ns_containers_sequences_list_list_ops_splice_pos_list_6cd1eacb (libcis)
