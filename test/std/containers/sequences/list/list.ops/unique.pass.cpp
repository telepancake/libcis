// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_ops_unique_c1d9d50b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_ops_unique_c1d9d50b { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_sequences_list_list_ops_unique_c1d9d50b (libcis)
