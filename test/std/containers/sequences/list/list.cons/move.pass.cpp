// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_cons_move_029ce90a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_cons_move_029ce90a { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_sequences_list_list_cons_move_029ce90a (libcis)
