// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_cons_input_iterator_6b6b8e12).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_cons_input_iterator_6b6b8e12 { // libcis
void basic_test()
{
    {
        int a[] = {0, 1, 2, 3};
...
} // libcis_ns_containers_sequences_list_list_cons_input_iterator_6b6b8e12 (libcis)
