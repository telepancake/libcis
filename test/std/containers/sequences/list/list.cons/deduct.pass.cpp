// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_cons_deduct_c74131d6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_cons_deduct_c74131d6 { // libcis
struct A {};
...
} // libcis_ns_containers_sequences_list_list_cons_deduct_c74131d6 (libcis)
