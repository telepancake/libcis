// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_cons_assign_copy_72f6a106).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_cons_assign_copy_72f6a106 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_sequences_list_list_cons_assign_copy_72f6a106 (libcis)
