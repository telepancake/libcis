// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_cons_initializer_list_alloc_e52279ce).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_cons_initializer_list_alloc_e52279ce { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_sequences_list_list_cons_initializer_list_alloc_e52279ce (libcis)
