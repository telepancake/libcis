// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_cons_copy_alloc_4429c020).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_cons_copy_alloc_4429c020 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_sequences_list_list_cons_copy_alloc_4429c020 (libcis)
