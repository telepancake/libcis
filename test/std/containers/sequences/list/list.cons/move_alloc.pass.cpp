// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_cons_move_alloc_048fb80f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_cons_move_alloc_048fb80f { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_sequences_list_list_cons_move_alloc_048fb80f (libcis)
