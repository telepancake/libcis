// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_cons_assign_move_667c7f2d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_cons_assign_move_667c7f2d { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_sequences_list_list_cons_assign_move_667c7f2d (libcis)
