// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_list_cons_size_value_alloc_7e35e2c2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_list_cons_size_value_alloc_7e35e2c2 { // libcis
int main(int, char**)
{
    {
        std::list<int> l(3, 2);
...
} // libcis_ns_containers_sequences_list_list_cons_size_value_alloc_7e35e2c2 (libcis)
