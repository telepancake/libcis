// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_list_compare_e21b3ea3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_list_compare_e21b3ea3 { // libcis
int main(int, char**) {
    {
...
} // libcis_ns_containers_sequences_list_compare_e21b3ea3 (libcis)
