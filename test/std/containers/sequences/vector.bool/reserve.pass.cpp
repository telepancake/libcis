// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_reserve_fd251ef4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_reserve_fd251ef4 { // libcis
...
} // libcis_ns_containers_sequences_vector_bool_reserve_fd251ef4 (libcis)
