// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_at).
// main -> test_containers_sequences_vector_bool_at; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_at { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_bool_at; // libcis


void test_containers_sequences_vector_bool_at() {
  tests();
  test_exceptions();
