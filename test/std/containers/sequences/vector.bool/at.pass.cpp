// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_at_a09d5c1c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_at_a09d5c1c { // libcis
...
} // libcis_ns_containers_sequences_vector_bool_at_a09d5c1c (libcis)
