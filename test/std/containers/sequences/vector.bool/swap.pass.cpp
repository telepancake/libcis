// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_swap).
// main -> test_containers_sequences_vector_bool_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_swap { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_bool_swap; // libcis


void test_containers_sequences_vector_bool_swap() {
  tests();
#if TEST_STD_VER > 17
  static_assert(tests());
#endif
