// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_erase_iter_iter_855ab735).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_erase_iter_iter_855ab735 { // libcis
...
} // libcis_ns_containers_sequences_vector_bool_erase_iter_iter_855ab735 (libcis)
