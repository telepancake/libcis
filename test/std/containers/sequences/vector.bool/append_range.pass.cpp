// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_append_range).
// main -> test_containers_sequences_vector_bool_append_range; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_append_range { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_containers_sequences_vector_bool_append_range; // libcis


void test_containers_sequences_vector_bool_append_range() {
  test();
  static_assert(test());
