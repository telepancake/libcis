// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_construct_iter_iter_3fef06eb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_construct_iter_iter_3fef06eb { // libcis
...
} // libcis_ns_containers_sequences_vector_bool_construct_iter_iter_3fef06eb (libcis)
