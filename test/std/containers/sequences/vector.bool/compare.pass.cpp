// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_compare_f9f244bf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_compare_f9f244bf { // libcis
...
} // libcis_ns_containers_sequences_vector_bool_compare_f9f244bf (libcis)
