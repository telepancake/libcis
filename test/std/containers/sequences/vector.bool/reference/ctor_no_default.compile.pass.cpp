// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_reference_ctor_no_default).
...
namespace libcis_ns_containers_sequences_vector_bool_reference_ctor_no_default { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_bool_reference_ctor_no_default; // libcis
