// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_construct_size_value_alloc_b16ce34a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_construct_size_value_alloc_b16ce34a { // libcis
template <class C>
...
} // libcis_ns_containers_sequences_vector_bool_construct_size_value_alloc_b16ce34a (libcis)
