// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_move_alloc_15347745).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_move_alloc_15347745 { // libcis
...
} // libcis_ns_containers_sequences_vector_bool_move_alloc_15347745 (libcis)
