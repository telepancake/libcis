// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_types).
// main -> test_containers_sequences_vector_bool_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_types { // libcis: isolate file-scope helpers
template <class Allocator>
void test() {
...
} using namespace libcis_ns_containers_sequences_vector_bool_types; // libcis


void test_containers_sequences_vector_bool_types() {
