// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_types_1be2097d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_types_1be2097d { // libcis
template <class Allocator>
void
test()
{
...
} // libcis_ns_containers_sequences_vector_bool_types_1be2097d (libcis)
