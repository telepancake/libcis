// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_move).
// main -> test_containers_sequences_vector_bool_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_move { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_bool_move; // libcis


void test_containers_sequences_vector_bool_move() {
  tests();
#if TEST_STD_VER > 17
  static_assert(tests());
#endif
