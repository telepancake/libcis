// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_shrink_to_fit_2d6ad174).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_shrink_to_fit_2d6ad174 { // libcis
...
} // libcis_ns_containers_sequences_vector_bool_shrink_to_fit_2d6ad174 (libcis)
