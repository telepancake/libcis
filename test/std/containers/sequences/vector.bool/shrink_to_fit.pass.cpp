// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_shrink_to_fit).
// main -> test_containers_sequences_vector_bool_shrink_to_fit; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_shrink_to_fit { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_bool_shrink_to_fit; // libcis

#endif // TEST_STD_VER >= 23

void test_containers_sequences_vector_bool_shrink_to_fit() {
  tests();
#if TEST_STD_VER > 17
  static_assert(tests());
#endif
