// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_construct_size_24952b23).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_construct_size_24952b23 { // libcis
template <class C>
...
} // libcis_ns_containers_sequences_vector_bool_construct_size_24952b23 (libcis)
