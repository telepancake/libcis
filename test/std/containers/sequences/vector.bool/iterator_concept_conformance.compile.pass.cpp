// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_iterator_concept_conformance_f66b38cb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_iterator_concept_conformance_f66b38cb { // libcis
...
} // libcis_ns_containers_sequences_vector_bool_iterator_concept_conformance_f66b38cb (libcis)
