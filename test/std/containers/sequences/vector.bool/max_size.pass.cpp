// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_max_size).
// main -> test_containers_sequences_vector_bool_max_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_max_size { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_bool_max_size; // libcis


void test_containers_sequences_vector_bool_max_size() {
  tests();
