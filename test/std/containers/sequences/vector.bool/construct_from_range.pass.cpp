// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_construct_from_range).
// main -> test_containers_sequences_vector_bool_construct_from_range; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_construct_from_range { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_containers_sequences_vector_bool_construct_from_range; // libcis

#endif

void test_containers_sequences_vector_bool_construct_from_range() {
  test();
  static_assert(test());
