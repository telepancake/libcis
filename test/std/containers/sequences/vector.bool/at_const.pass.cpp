// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_at_const_8b3d4eb1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_at_const_8b3d4eb1 { // libcis
...
} // libcis_ns_containers_sequences_vector_bool_at_const_8b3d4eb1 (libcis)
