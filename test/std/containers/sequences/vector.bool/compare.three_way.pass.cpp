// transferred+adapted from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_compare_three_way_facd81c3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_compare_three_way_facd81c3 { // libcis
...
} // libcis_ns_containers_sequences_vector_bool_compare_three_way_facd81c3 (libcis)
