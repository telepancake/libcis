// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_vector_bool_fmt_format).
// main -> test_containers_sequences_vector_bool_vector_bool_fmt_format; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_sequences_vector_bool_vector_bool_fmt_format { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_bool_vector_bool_fmt_format; // libcis


void test_containers_sequences_vector_bool_vector_bool_fmt_format() {
  test();
