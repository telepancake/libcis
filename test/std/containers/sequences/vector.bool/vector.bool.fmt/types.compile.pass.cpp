// AST-transferred from libc++ by tools/transfer.py (slug=containers_sequences_vector_bool_vector_bool_fmt_types).
...
namespace libcis_ns_containers_sequences_vector_bool_vector_bool_fmt_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_sequences_vector_bool_vector_bool_fmt_types; // libcis
