// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_types_8ff3d907).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_types_8ff3d907 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_multimap_types_8ff3d907 (libcis)
