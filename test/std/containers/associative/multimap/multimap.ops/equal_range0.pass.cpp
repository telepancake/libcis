// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_ops_equal_range0).
// main -> test_containers_associative_multimap_multimap_ops_equal_range0; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_multimap_multimap_ops_equal_range0() {
  {
