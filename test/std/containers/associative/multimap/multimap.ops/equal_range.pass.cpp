// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_ops_equal_range_7af9e50d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_ops_equal_range_7af9e50d { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_associative_multimap_multimap_ops_equal_range_7af9e50d (libcis)
