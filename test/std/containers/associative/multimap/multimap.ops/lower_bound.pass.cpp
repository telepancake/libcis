// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_ops_lower_bound_5c74ba26).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_ops_lower_bound_5c74ba26 { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_associative_multimap_multimap_ops_lower_bound_5c74ba26 (libcis)
