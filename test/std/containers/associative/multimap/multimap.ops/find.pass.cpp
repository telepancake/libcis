// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_ops_find).
// main -> test_containers_associative_multimap_multimap_ops_find; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_ops_find { // libcis: isolate file-scope helpers
template <class Iter>
...
} using namespace libcis_ns_containers_associative_multimap_multimap_ops_find; // libcis


void test_containers_associative_multimap_multimap_ops_find() {
