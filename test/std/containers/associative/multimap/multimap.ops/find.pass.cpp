// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_ops_find_8e906fba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_ops_find_8e906fba { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_associative_multimap_multimap_ops_find_8e906fba (libcis)
