// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_range_concept_conformance_6412980f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_range_concept_conformance_6412980f { // libcis
...
} // libcis_ns_containers_associative_multimap_range_concept_conformance_6412980f (libcis)
