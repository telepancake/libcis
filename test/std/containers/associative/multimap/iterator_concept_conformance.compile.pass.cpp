// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_iterator_concept_conformance_34451897).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_iterator_concept_conformance_34451897 { // libcis
...
} // libcis_ns_containers_associative_multimap_iterator_concept_conformance_34451897 (libcis)
