// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_nonmember_op_compare_cd6afa20).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_nonmember_op_compare_cd6afa20 { // libcis
int main(int, char**) {
...
} // libcis_ns_containers_associative_multimap_multimap_nonmember_op_compare_cd6afa20 (libcis)
