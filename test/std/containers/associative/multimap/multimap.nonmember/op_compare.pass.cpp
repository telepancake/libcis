// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_nonmember_op_compare).
// main -> test_containers_associative_multimap_multimap_nonmember_op_compare; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_multimap_multimap_nonmember_op_compare() {
