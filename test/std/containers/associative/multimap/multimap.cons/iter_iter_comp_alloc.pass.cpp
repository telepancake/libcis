// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_cons_iter_iter_comp_alloc_4318c0f4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_cons_iter_iter_comp_alloc_4318c0f4 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_multimap_multimap_cons_iter_iter_comp_alloc_4318c0f4 (libcis)
