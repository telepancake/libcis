// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_cons_deduct_const_8d572157).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_cons_deduct_const_8d572157 { // libcis
...
} // libcis_ns_containers_associative_multimap_multimap_cons_deduct_const_8d572157 (libcis)
