// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_cons_initializer_list_compare_alloc).
// main -> test_containers_associative_multimap_multimap_cons_initializer_list_compare_alloc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_multimap_multimap_cons_initializer_list_compare_alloc() {
  {
