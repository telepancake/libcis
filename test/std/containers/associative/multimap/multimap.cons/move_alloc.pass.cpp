// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_cons_move_alloc_678ba4a9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_cons_move_alloc_678ba4a9 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_multimap_multimap_cons_move_alloc_678ba4a9 (libcis)
