// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_cons_copy).
// main -> test_containers_associative_multimap_multimap_cons_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_cons_copy { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_associative_multimap_multimap_cons_copy; // libcis


void test_containers_associative_multimap_multimap_cons_copy() {
  test();
