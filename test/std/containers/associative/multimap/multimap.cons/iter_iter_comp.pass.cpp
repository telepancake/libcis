// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_cons_iter_iter_comp).
// main -> test_containers_associative_multimap_multimap_cons_iter_iter_comp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_multimap_multimap_cons_iter_iter_comp() {
  {
