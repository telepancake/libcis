// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_erasure_erase_if_8cd9d9d2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_erasure_erase_if_8cd9d9d2 { // libcis
...
} // libcis_ns_containers_associative_multimap_multimap_erasure_erase_if_8cd9d9d2 (libcis)
