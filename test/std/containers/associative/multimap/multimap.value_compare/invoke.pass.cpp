// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_value_compare_invoke_5b107a2d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_value_compare_invoke_5b107a2d { // libcis
...
} // libcis_ns_containers_associative_multimap_multimap_value_compare_invoke_5b107a2d (libcis)
