// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_value_compare_invoke).
// main -> test_containers_associative_multimap_multimap_value_compare_invoke; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_value_compare_invoke { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_associative_multimap_multimap_value_compare_invoke; // libcis


void test_containers_associative_multimap_multimap_value_compare_invoke() {
