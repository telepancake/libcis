// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_max_size_fc5841d1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_max_size_fc5841d1 { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_associative_multimap_max_size_fc5841d1 (libcis)
