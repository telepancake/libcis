// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_special_swap_noexcept_5dadc890).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_special_swap_noexcept_5dadc890 { // libcis
template <class T>
struct some_comp
{
...
} // libcis_ns_containers_associative_multimap_multimap_special_swap_noexcept_5dadc890 (libcis)
