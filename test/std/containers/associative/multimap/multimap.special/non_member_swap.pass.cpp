// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_special_non_member_swap_abd06484).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_special_non_member_swap_abd06484 { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_associative_multimap_multimap_special_non_member_swap_abd06484 (libcis)
