// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_special_non_member_swap).
// main -> test_containers_associative_multimap_multimap_special_non_member_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_multimap_multimap_special_non_member_swap() {
