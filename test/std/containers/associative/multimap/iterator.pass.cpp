// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_iterator_57a364a2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_iterator_57a364a2 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_multimap_iterator_57a364a2 (libcis)
