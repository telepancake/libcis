// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_modifiers_insert_iter_iter_7eb073a0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_modifiers_insert_iter_iter_7eb073a0 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_multimap_multimap_modifiers_insert_iter_iter_7eb073a0 (libcis)
