// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_modifiers_insert_node_type_ea90c605).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_modifiers_insert_node_type_ea90c605 { // libcis
...
} // libcis_ns_containers_associative_multimap_multimap_modifiers_insert_node_type_ea90c605 (libcis)
