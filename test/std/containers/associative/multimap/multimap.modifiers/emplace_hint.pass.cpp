// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_modifiers_emplace_hint_b2e9b7d3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_modifiers_emplace_hint_b2e9b7d3 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_multimap_multimap_modifiers_emplace_hint_b2e9b7d3 (libcis)
