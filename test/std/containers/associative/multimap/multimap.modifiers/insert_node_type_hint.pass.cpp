// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_modifiers_insert_node_type_hint_44ab607c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_modifiers_insert_node_type_hint_44ab607c { // libcis
...
} // libcis_ns_containers_associative_multimap_multimap_modifiers_insert_node_type_hint_44ab607c (libcis)
