// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_modifiers_merge_54787324).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_modifiers_merge_54787324 { // libcis
template <class Map>
...
} // libcis_ns_containers_associative_multimap_multimap_modifiers_merge_54787324 (libcis)
