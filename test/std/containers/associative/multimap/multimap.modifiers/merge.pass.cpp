// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_modifiers_merge).
// main -> test_containers_associative_multimap_multimap_modifiers_merge; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_modifiers_merge { // libcis: isolate file-scope helpers
template <class Map>
bool map_equal(const Map& map, Map other) {
  return map == other;
}
} using namespace libcis_ns_containers_associative_multimap_multimap_modifiers_merge; // libcis
...
void test_containers_associative_multimap_multimap_modifiers_merge() {
  {
