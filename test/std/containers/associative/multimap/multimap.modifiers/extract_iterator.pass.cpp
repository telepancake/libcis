// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_modifiers_extract_iterator_43fdd99a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_modifiers_extract_iterator_43fdd99a { // libcis
...
} // libcis_ns_containers_associative_multimap_multimap_modifiers_extract_iterator_43fdd99a (libcis)
