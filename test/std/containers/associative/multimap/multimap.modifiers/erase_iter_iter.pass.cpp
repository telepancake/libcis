// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_modifiers_erase_iter_iter_49c3ac2d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_modifiers_erase_iter_iter_49c3ac2d { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_multimap_multimap_modifiers_erase_iter_iter_49c3ac2d (libcis)
