// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_modifiers_extract_key_7f048c5a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_modifiers_extract_key_7f048c5a { // libcis
...
} // libcis_ns_containers_associative_multimap_multimap_modifiers_extract_key_7f048c5a (libcis)
