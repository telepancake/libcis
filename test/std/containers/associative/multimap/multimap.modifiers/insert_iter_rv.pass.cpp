// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_modifiers_insert_iter_rv).
// main -> test_containers_associative_multimap_multimap_modifiers_insert_iter_rv; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_modifiers_insert_iter_rv { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_associative_multimap_multimap_modifiers_insert_iter_rv; // libcis


void test_containers_associative_multimap_multimap_modifiers_insert_iter_rv() {
