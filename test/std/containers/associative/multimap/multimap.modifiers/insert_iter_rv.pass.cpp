// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multimap_multimap_modifiers_insert_iter_rv_a8524481).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multimap_multimap_modifiers_insert_iter_rv_a8524481 { // libcis
...
} // libcis_ns_containers_associative_multimap_multimap_modifiers_insert_iter_rv_a8524481 (libcis)
