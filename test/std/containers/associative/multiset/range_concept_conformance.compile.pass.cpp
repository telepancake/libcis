// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_range_concept_conformance_35b0f069).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_range_concept_conformance_35b0f069 { // libcis
...
} // libcis_ns_containers_associative_multiset_range_concept_conformance_35b0f069 (libcis)
