// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_extract_key_9473a6cf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_extract_key_9473a6cf { // libcis
...
} // libcis_ns_containers_associative_multiset_extract_key_9473a6cf (libcis)
