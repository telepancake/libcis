// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_cons_copy_alloc_5feee6a6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_multiset_cons_copy_alloc_5feee6a6 { // libcis
int main(int, char**)
{
    typedef int V;
    V ar[] =
...
} // libcis_ns_containers_associative_multiset_multiset_cons_copy_alloc_5feee6a6 (libcis)
