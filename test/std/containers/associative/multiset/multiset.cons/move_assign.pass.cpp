// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_cons_move_assign).
// main -> test_containers_associative_multiset_multiset_cons_move_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_multiset_multiset_cons_move_assign() {
  {
    typedef MoveOnly V;
