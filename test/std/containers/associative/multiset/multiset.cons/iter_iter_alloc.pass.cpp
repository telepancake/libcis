// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_cons_iter_iter_alloc).
// main -> test_containers_associative_multiset_multiset_cons_iter_iter_alloc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_multiset_multiset_cons_iter_iter_alloc() {
  {
    typedef int V;
