// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_cons_iter_iter_alloc_a49a76c7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_multiset_cons_iter_iter_alloc_a49a76c7 { // libcis
int main(int, char**)
{
    {
    typedef int V;
...
} // libcis_ns_containers_associative_multiset_multiset_cons_iter_iter_alloc_a49a76c7 (libcis)
