// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_cons_deduct_b950201b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_multiset_cons_deduct_b950201b { // libcis
...
} // libcis_ns_containers_associative_multiset_multiset_cons_deduct_b950201b (libcis)
