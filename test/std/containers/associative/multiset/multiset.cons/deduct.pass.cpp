// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_cons_deduct).
// main -> test_containers_associative_multiset_multiset_cons_deduct; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_multiset_cons_deduct { // libcis: isolate file-scope helpers
struct NotAnAllocator {
  friend bool operator<(NotAnAllocator, NotAnAllocator) { return false; }
};
} using namespace libcis_ns_containers_associative_multiset_multiset_cons_deduct; // libcis


void test_containers_associative_multiset_multiset_cons_deduct() {
  {
