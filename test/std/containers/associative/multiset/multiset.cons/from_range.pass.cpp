// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_cons_from_range).
// main -> test_containers_associative_multiset_multiset_cons_from_range; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_multiset_cons_from_range { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_associative_multiset_multiset_cons_from_range; // libcis


void test_containers_associative_multiset_multiset_cons_from_range() {
