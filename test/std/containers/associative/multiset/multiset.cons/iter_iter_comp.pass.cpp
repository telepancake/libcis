// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_cons_iter_iter_comp).
// main -> test_containers_associative_multiset_multiset_cons_iter_iter_comp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_multiset_multiset_cons_iter_iter_comp() {
  typedef int V;
