// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_cons_iter_iter_comp_e7696c95).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_multiset_cons_iter_iter_comp_e7696c95 { // libcis
int main(int, char**)
{
    typedef int V;
    V ar[] =
...
} // libcis_ns_containers_associative_multiset_multiset_cons_iter_iter_comp_e7696c95 (libcis)
