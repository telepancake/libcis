// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_cons_move_alloc_b37f4906).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_multiset_cons_move_alloc_b37f4906 { // libcis
int main(int, char**)
{
    {
        typedef MoveOnly V;
...
} // libcis_ns_containers_associative_multiset_multiset_cons_move_alloc_b37f4906 (libcis)
