// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_insert_iter_iter_98c6f831).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_insert_iter_iter_98c6f831 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_multiset_insert_iter_iter_98c6f831 (libcis)
