// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multiset_insert_iter_iter).
// main -> test_containers_associative_multiset_insert_iter_iter; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_insert_iter_iter { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_associative_multiset_insert_iter_iter; // libcis


void test_containers_associative_multiset_insert_iter_iter() {
  test();
