// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_special_swap_noexcept_760351b4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_multiset_special_swap_noexcept_760351b4 { // libcis
template <class T>
struct some_comp
{
...
} // libcis_ns_containers_associative_multiset_multiset_special_swap_noexcept_760351b4 (libcis)
