// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_special_swap_noexcept).
// main -> test_containers_associative_multiset_multiset_special_swap_noexcept; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_multiset_special_swap_noexcept { // libcis: isolate file-scope helpers
template <class T>
struct some_comp {
...
} using namespace libcis_ns_containers_associative_multiset_multiset_special_swap_noexcept; // libcis


void test_containers_associative_multiset_multiset_special_swap_noexcept() {
  {
