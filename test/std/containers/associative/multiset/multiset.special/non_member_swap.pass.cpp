// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_special_non_member_swap_b6d2403d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_multiset_special_non_member_swap_b6d2403d { // libcis
int main(int, char**)
{
    typedef int V;
    {
...
} // libcis_ns_containers_associative_multiset_multiset_special_non_member_swap_b6d2403d (libcis)
