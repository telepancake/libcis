// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_special_non_member_swap).
// main -> test_containers_associative_multiset_multiset_special_non_member_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_multiset_multiset_special_non_member_swap() {
  typedef int V;
  {
