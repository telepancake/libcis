// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_types_ec4cf9e2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_types_ec4cf9e2 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_multiset_types_ec4cf9e2 (libcis)
