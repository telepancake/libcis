// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_iterator_concept_conformance_a692f501).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_iterator_concept_conformance_a692f501 { // libcis
...
} // libcis_ns_containers_associative_multiset_iterator_concept_conformance_a692f501 (libcis)
