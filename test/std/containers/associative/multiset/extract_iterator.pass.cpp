// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_extract_iterator_026dfe94).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_extract_iterator_026dfe94 { // libcis
...
} // libcis_ns_containers_associative_multiset_extract_iterator_026dfe94 (libcis)
