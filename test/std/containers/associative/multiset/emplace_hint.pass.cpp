// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_emplace_hint_d704c4b4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_emplace_hint_d704c4b4 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_multiset_emplace_hint_d704c4b4 (libcis)
