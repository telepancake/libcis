// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_merge_5ed4bec9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_merge_5ed4bec9 { // libcis
template <class Set>
...
} // libcis_ns_containers_associative_multiset_merge_5ed4bec9 (libcis)
