// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_iterator_20e49367).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_iterator_20e49367 { // libcis
int main(int, char**)
{
    {
        typedef int V;
...
} // libcis_ns_containers_associative_multiset_iterator_20e49367 (libcis)
