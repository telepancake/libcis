// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_erase_key_f18389f8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_erase_key_f18389f8 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_multiset_erase_key_f18389f8 (libcis)
