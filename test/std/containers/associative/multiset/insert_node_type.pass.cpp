// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_insert_node_type_a0bf4a9a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_insert_node_type_a0bf4a9a { // libcis
...
} // libcis_ns_containers_associative_multiset_insert_node_type_a0bf4a9a (libcis)
