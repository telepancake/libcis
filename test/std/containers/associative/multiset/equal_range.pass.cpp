// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multiset_equal_range).
// main -> test_containers_associative_multiset_equal_range; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_multiset_equal_range() {
  {
    typedef int V;
