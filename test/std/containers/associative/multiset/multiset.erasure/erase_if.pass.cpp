// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_multiset_erasure_erase_if_93f4493d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_multiset_erasure_erase_if_93f4493d { // libcis
...
} // libcis_ns_containers_associative_multiset_multiset_erasure_erase_if_93f4493d (libcis)
