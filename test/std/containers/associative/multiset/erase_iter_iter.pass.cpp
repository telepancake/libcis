// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_multiset_erase_iter_iter_d88f211d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_multiset_erase_iter_iter_d88f211d { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_multiset_erase_iter_iter_d88f211d (libcis)
