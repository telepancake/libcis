// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_multiset_erase_iter_iter).
// main -> test_containers_associative_multiset_erase_iter_iter; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_multiset_erase_iter_iter() {
  {
