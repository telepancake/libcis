// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_insert_node_type_17de2747).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_insert_node_type_17de2747 { // libcis
...
} // libcis_ns_containers_associative_set_insert_node_type_17de2747 (libcis)
