// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_upper_bound_2f68b201).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_upper_bound_2f68b201 { // libcis
int main(int, char**)
{
    {
    typedef int V;
...
} // libcis_ns_containers_associative_set_upper_bound_2f68b201 (libcis)
