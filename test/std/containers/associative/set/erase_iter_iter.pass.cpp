// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_erase_iter_iter_7bfc27ae).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_erase_iter_iter_7bfc27ae { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_set_erase_iter_iter_7bfc27ae (libcis)
