// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_set_cons_move_alloc_88822705).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_set_cons_move_alloc_88822705 { // libcis
int main(int, char**)
{
    {
        typedef MoveOnly V;
...
} // libcis_ns_containers_associative_set_set_cons_move_alloc_88822705 (libcis)
