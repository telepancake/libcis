// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_set_set_cons_move_alloc).
// main -> test_containers_associative_set_set_cons_move_alloc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_set_set_cons_move_alloc() {
  {
    typedef MoveOnly V;
