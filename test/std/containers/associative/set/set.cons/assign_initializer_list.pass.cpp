// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_set_cons_assign_initializer_list_5de96125).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_set_cons_assign_initializer_list_5de96125 { // libcis
void basic_test() {
  {
...
} // libcis_ns_containers_associative_set_set_cons_assign_initializer_list_5de96125 (libcis)
