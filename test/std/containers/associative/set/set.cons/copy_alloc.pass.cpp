// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_set_set_cons_copy_alloc).
// main -> test_containers_associative_set_set_cons_copy_alloc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_set_cons_copy_alloc { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_associative_set_set_cons_copy_alloc; // libcis


void test_containers_associative_set_set_cons_copy_alloc() {
  test();
