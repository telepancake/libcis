// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_set_set_cons_copy_assign).
// main -> test_containers_associative_set_set_cons_copy_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_set_cons_copy_assign { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_containers_associative_set_set_cons_copy_assign; // libcis


void test_containers_associative_set_set_cons_copy_assign() {
  test();
