// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_set_cons_move_74ad5efc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_set_cons_move_74ad5efc { // libcis
int main(int, char**)
{
    {
        typedef int V;
...
} // libcis_ns_containers_associative_set_set_cons_move_74ad5efc (libcis)
