// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_emplace_hint_4735489a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_emplace_hint_4735489a { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_set_emplace_hint_4735489a (libcis)
