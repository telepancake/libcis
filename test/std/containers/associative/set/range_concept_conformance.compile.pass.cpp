// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_range_concept_conformance_0e3306cf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_range_concept_conformance_0e3306cf { // libcis
...
} // libcis_ns_containers_associative_set_range_concept_conformance_0e3306cf (libcis)
