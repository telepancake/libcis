// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_extract_key_38423298).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_extract_key_38423298 { // libcis
...
} // libcis_ns_containers_associative_set_extract_key_38423298 (libcis)
