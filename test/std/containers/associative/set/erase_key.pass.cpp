// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_erase_key_ae060b50).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_erase_key_ae060b50 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_set_erase_key_ae060b50 (libcis)
