// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_set_erase_key).
// main -> test_containers_associative_set_erase_key; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_set_erase_key() {
  {
