// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_find_faad9334).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_find_faad9334 { // libcis
int main(int, char**)
{
    {
    typedef int V;
...
} // libcis_ns_containers_associative_set_find_faad9334 (libcis)
