// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_set_find).
// main -> test_containers_associative_set_find; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_set_find() {
  {
    typedef int V;
