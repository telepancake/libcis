// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_contains_e1db4926).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_contains_e1db4926 { // libcis
...
} // libcis_ns_containers_associative_set_contains_e1db4926 (libcis)
