// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_extract_iterator_98473308).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_extract_iterator_98473308 { // libcis
...
} // libcis_ns_containers_associative_set_extract_iterator_98473308 (libcis)
