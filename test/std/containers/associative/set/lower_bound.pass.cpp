// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_set_lower_bound).
// main -> test_containers_associative_set_lower_bound; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_associative_set_lower_bound() {
  {
    typedef int V;
