// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_lower_bound_f3e9f8a6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_lower_bound_f3e9f8a6 { // libcis
int main(int, char**)
{
    {
    typedef int V;
...
} // libcis_ns_containers_associative_set_lower_bound_f3e9f8a6 (libcis)
