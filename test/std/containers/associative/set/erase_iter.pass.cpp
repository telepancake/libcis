// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_erase_iter_cf334e75).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_erase_iter_cf334e75 { // libcis
...
} // libcis_ns_containers_associative_set_erase_iter_cf334e75 (libcis)
