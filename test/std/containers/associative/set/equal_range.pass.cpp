// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_equal_range_9e1d3425).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_equal_range_9e1d3425 { // libcis
int main(int, char**)
{
    {
    typedef int V;
...
} // libcis_ns_containers_associative_set_equal_range_9e1d3425 (libcis)
