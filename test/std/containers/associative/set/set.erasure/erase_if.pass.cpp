// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_set_erasure_erase_if_e4d7cede).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_set_erasure_erase_if_e4d7cede { // libcis
...
} // libcis_ns_containers_associative_set_set_erasure_erase_if_e4d7cede (libcis)
