// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_types_e9156631).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_types_e9156631 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_set_types_e9156631 (libcis)
