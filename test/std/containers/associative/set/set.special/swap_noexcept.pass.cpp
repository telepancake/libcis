// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_set_special_swap_noexcept_bfefd39e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_set_special_swap_noexcept_bfefd39e { // libcis
template <class T>
struct some_comp
{
...
} // libcis_ns_containers_associative_set_set_special_swap_noexcept_bfefd39e (libcis)
