// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_set_special_non_member_swap_f1e9f513).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_set_special_non_member_swap_f1e9f513 { // libcis
int main(int, char**)
{
    typedef int V;
    {
...
} // libcis_ns_containers_associative_set_set_special_non_member_swap_f1e9f513 (libcis)
