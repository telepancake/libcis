// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_merge_fae0e715).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_merge_fae0e715 { // libcis
template <class Set>
...
} // libcis_ns_containers_associative_set_merge_fae0e715 (libcis)
