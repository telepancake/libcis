// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_set_merge).
// main -> test_containers_associative_set_merge; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_merge { // libcis: isolate file-scope helpers
template <class Set>
bool set_equal(const Set& set, Set other) {
  return set == other;
}
} using namespace libcis_ns_containers_associative_set_merge; // libcis
...
void test_containers_associative_set_merge() {
  {
