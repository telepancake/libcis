// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_set_iterator_concept_conformance).
...
namespace libcis_ns_containers_associative_set_iterator_concept_conformance { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_associative_set_iterator_concept_conformance; // libcis
