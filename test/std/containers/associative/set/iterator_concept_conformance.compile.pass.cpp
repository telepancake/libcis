// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_set_iterator_concept_conformance_597d7a50).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_set_iterator_concept_conformance_597d7a50 { // libcis
...
} // libcis_ns_containers_associative_set_iterator_concept_conformance_597d7a50 (libcis)
