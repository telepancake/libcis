// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_lookup_with_converting_comparator).
// main -> test_containers_associative_lookup_with_converting_comparator; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_lookup_with_converting_comparator { // libcis: isolate file-scope helpers
struct S {
  int i_;
...
} using namespace libcis_ns_containers_associative_lookup_with_converting_comparator; // libcis


void test_containers_associative_lookup_with_converting_comparator() {
  {
