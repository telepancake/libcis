// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_range_concept_conformance_8cbd9102).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_range_concept_conformance_8cbd9102 { // libcis
...
} // libcis_ns_containers_associative_map_range_concept_conformance_8cbd9102 (libcis)
