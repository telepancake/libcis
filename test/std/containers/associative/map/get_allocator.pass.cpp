// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_get_allocator_2f35718e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_get_allocator_2f35718e { // libcis
int main(int, char**) {
...
} // libcis_ns_containers_associative_map_get_allocator_2f35718e (libcis)
