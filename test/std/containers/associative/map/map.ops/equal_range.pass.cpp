// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_ops_equal_range_30492427).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_ops_equal_range_30492427 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_map_ops_equal_range_30492427 (libcis)
