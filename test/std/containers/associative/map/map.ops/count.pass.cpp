// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_ops_count_7a8d58f2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_ops_count_7a8d58f2 { // libcis
#if TEST_STD_VER >= 11
template <class T>
...
} // libcis_ns_containers_associative_map_map_ops_count_7a8d58f2 (libcis)
