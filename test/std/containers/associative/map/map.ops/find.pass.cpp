// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_ops_find_b045dd06).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_ops_find_b045dd06 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_map_ops_find_b045dd06 (libcis)
