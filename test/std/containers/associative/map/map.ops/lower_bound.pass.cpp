// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_ops_lower_bound_d108f614).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_ops_lower_bound_d108f614 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_map_ops_lower_bound_d108f614 (libcis)
