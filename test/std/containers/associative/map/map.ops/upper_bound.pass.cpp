// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_ops_upper_bound_ddb9ada5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_ops_upper_bound_ddb9ada5 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_map_ops_upper_bound_ddb9ada5 (libcis)
