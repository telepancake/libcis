// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_ops_contains_33e57959).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_ops_contains_33e57959 { // libcis
...
} // libcis_ns_containers_associative_map_map_ops_contains_33e57959 (libcis)
