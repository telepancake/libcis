// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_iterator_concept_conformance_dd5cacee).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_iterator_concept_conformance_dd5cacee { // libcis
...
} // libcis_ns_containers_associative_map_iterator_concept_conformance_dd5cacee (libcis)
