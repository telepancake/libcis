// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_erasure_erase_if_c35b1712).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_erasure_erase_if_c35b1712 { // libcis
...
} // libcis_ns_containers_associative_map_map_erasure_erase_if_c35b1712 (libcis)
