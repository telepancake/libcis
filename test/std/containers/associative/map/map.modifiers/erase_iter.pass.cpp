// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_modifiers_erase_iter_9cc60b39).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_modifiers_erase_iter_9cc60b39 { // libcis
...
} // libcis_ns_containers_associative_map_map_modifiers_erase_iter_9cc60b39 (libcis)
