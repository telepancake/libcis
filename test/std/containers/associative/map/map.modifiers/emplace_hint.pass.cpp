// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_modifiers_emplace_hint_bfd8076a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_modifiers_emplace_hint_bfd8076a { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_map_modifiers_emplace_hint_bfd8076a (libcis)
