// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_modifiers_insert_or_assign_c46e3c3c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_modifiers_insert_or_assign_c46e3c3c { // libcis
class Moveable
{
...
} // libcis_ns_containers_associative_map_map_modifiers_insert_or_assign_c46e3c3c (libcis)
