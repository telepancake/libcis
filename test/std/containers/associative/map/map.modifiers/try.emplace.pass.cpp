// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_modifiers_try_emplace_cbbfb3f6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_modifiers_try_emplace_cbbfb3f6 { // libcis
class Moveable
{
...
} // libcis_ns_containers_associative_map_map_modifiers_try_emplace_cbbfb3f6 (libcis)
