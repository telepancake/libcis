// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_modifiers_emplace_f2c2398e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_modifiers_emplace_f2c2398e { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_map_modifiers_emplace_f2c2398e (libcis)
