// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_modifiers_merge_3d45d1ad).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_modifiers_merge_3d45d1ad { // libcis
template <class Map>
...
} // libcis_ns_containers_associative_map_map_modifiers_merge_3d45d1ad (libcis)
