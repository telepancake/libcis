// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_modifiers_erase_key_a84bc5f2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_modifiers_erase_key_a84bc5f2 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_map_modifiers_erase_key_a84bc5f2 (libcis)
