// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_modifiers_extract_iterator_98900847).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_modifiers_extract_iterator_98900847 { // libcis
...
} // libcis_ns_containers_associative_map_map_modifiers_extract_iterator_98900847 (libcis)
