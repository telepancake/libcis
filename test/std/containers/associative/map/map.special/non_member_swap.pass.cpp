// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_special_non_member_swap_d5518dd4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_special_non_member_swap_d5518dd4 { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_associative_map_map_special_non_member_swap_d5518dd4 (libcis)
