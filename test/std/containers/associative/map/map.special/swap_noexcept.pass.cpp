// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_special_swap_noexcept_64cc52f7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_special_swap_noexcept_64cc52f7 { // libcis
template <class T>
struct some_comp
{
...
} // libcis_ns_containers_associative_map_map_special_swap_noexcept_64cc52f7 (libcis)
