// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_access_index_rv_key_1f47d62f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_access_index_rv_key_1f47d62f { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_map_access_index_rv_key_1f47d62f (libcis)
