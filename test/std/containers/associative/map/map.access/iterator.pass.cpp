// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_access_iterator_0a14c273).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_access_iterator_0a14c273 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_map_access_iterator_0a14c273 (libcis)
