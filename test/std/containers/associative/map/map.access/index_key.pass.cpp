// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_access_index_key_a5676414).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_access_index_key_a5676414 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_map_access_index_key_a5676414 (libcis)
