// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_compare_722dfea7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_compare_722dfea7 { // libcis
struct Key {
...
} // libcis_ns_containers_associative_map_compare_722dfea7 (libcis)
