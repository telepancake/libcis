// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_types_89e0e832).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_types_89e0e832 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_types_89e0e832 (libcis)
