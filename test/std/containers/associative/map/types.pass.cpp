// AST-transferred from libc++ by tools/transfer.py (slug=containers_associative_map_types).
// main -> test_containers_associative_map_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_associative_map_types; // libcis


void test_containers_associative_map_types() {
  test();
#if TEST_STD_VER >= 26
  static_assert(test());
#endif
