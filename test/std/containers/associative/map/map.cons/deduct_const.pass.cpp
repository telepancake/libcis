// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_cons_deduct_const_da382d9a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_cons_deduct_const_da382d9a { // libcis
...
} // libcis_ns_containers_associative_map_map_cons_deduct_const_da382d9a (libcis)
