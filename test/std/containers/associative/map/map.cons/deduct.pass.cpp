// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_cons_deduct_e31c3f1d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_cons_deduct_e31c3f1d { // libcis
...
} // libcis_ns_containers_associative_map_map_cons_deduct_e31c3f1d (libcis)
