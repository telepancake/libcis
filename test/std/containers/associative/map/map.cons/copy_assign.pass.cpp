// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_cons_copy_assign_9dee8dcd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_cons_copy_assign_9dee8dcd { // libcis
#if TEST_STD_VER >= 11
...
} // libcis_ns_containers_associative_map_map_cons_copy_assign_9dee8dcd (libcis)
