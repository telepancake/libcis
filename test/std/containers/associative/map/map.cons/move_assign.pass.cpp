// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_cons_move_assign_c09d78f8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_cons_move_assign_c09d78f8 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_map_cons_move_assign_c09d78f8 (libcis)
