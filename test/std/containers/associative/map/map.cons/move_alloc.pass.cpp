// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_cons_move_alloc_0a682adc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_cons_move_alloc_0a682adc { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_map_cons_move_alloc_0a682adc (libcis)
