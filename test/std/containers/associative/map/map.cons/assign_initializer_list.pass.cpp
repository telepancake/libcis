// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_cons_assign_initializer_list_00559f8b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_cons_assign_initializer_list_00559f8b { // libcis
void test_basic() {
  {
...
} // libcis_ns_containers_associative_map_map_cons_assign_initializer_list_00559f8b (libcis)
