// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_cons_move_225a243d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_cons_move_225a243d { // libcis
int main(int, char**)
{
...
} // libcis_ns_containers_associative_map_map_cons_move_225a243d (libcis)
