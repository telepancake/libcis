// transferred+adapted from libc++ by tools/transfer.py (slug=containers_associative_map_map_cons_copy_alloc_07fbc3ad).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_associative_map_map_cons_copy_alloc_07fbc3ad { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_containers_associative_map_map_cons_copy_alloc_07fbc3ad (libcis)
