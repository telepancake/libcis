// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_requirements_container_requirements_general_allocator_move).
// main -> test_containers_container_requirements_container_requirements_general_allocator_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_requirements_container_requirements_general_allocator_move { // libcis: isolate file-scope helpers
template <class C>
...
} using namespace libcis_ns_containers_container_requirements_container_requirements_general_allocator_move; // libcis


void test_containers_container_requirements_container_requirements_general_allocator_move() {
