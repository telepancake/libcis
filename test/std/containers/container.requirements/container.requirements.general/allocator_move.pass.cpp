// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_requirements_container_requirements_general_allocator_move_0c329ab4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_requirements_container_requirements_general_allocator_move_0c329ab4 { // libcis
template <class C>
...
} // libcis_ns_containers_container_requirements_container_requirements_general_allocator_move_0c329ab4 (libcis)
