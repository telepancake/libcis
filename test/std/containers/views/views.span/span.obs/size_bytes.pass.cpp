// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_obs_size_bytes).
// main -> test_containers_views_views_span_span_obs_size_bytes; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_obs_size_bytes { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_views_span_span_obs_size_bytes; // libcis


void test_containers_views_views_span_span_obs_size_bytes() {
