// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_obs_size_21ccdb38).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_obs_size_21ccdb38 { // libcis
...
} // libcis_ns_containers_views_views_span_span_obs_size_21ccdb38 (libcis)
