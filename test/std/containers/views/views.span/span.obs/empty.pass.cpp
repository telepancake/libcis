// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_obs_empty_49eec7bd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_obs_empty_49eec7bd { // libcis
struct A{};
...
} // libcis_ns_containers_views_views_span_span_obs_empty_49eec7bd (libcis)
