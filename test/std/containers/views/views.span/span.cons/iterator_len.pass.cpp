// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_iterator_len_1395871f).
//===---------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_iterator_len_1395871f { // libcis
...
} // libcis_ns_containers_views_views_span_span_cons_iterator_len_1395871f (libcis)
