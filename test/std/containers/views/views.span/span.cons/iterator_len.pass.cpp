// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_iterator_len).
// main -> test_containers_views_views_span_span_cons_iterator_len; file-scope helpers isolated in anon namespace.
//===---------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_iterator_len { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_views_span_span_cons_iterator_len; // libcis


void test_containers_views_views_span_span_cons_iterator_len() {
  test();
  static_assert(test());
