// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_deduct_07689580).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_deduct_07689580 { // libcis
...
} // libcis_ns_containers_views_views_span_span_cons_deduct_07689580 (libcis)
