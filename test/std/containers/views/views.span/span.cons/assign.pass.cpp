// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_assign).
// main -> test_containers_views_views_span_span_cons_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_assign { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_containers_views_views_span_span_cons_assign; // libcis


void test_containers_views_views_span_span_cons_assign() {
