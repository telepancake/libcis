// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_assign_f33393b2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_assign_f33393b2 { // libcis
template <typename T>
...
} // libcis_ns_containers_views_views_span_span_cons_assign_f33393b2 (libcis)
