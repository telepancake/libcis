// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_copy_16d36a39).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_copy_16d36a39 { // libcis
template <class T>
constexpr void test() {
...
} // libcis_ns_containers_views_views_span_span_cons_copy_16d36a39 (libcis)
