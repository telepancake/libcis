// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_copy).
// main -> test_containers_views_views_span_span_cons_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_copy { // libcis: isolate file-scope helpers
template <class T>
constexpr void test() {
...
} using namespace libcis_ns_containers_views_views_span_span_cons_copy; // libcis


void test_containers_views_views_span_span_cons_copy() {
  test_all();
