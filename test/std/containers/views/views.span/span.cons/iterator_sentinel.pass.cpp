// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_iterator_sentinel).
// main -> test_containers_views_views_span_span_cons_iterator_sentinel; file-scope helpers isolated in anon namespace.
//===---------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_iterator_sentinel { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_views_span_span_cons_iterator_sentinel; // libcis
...
void test_containers_views_views_span_span_cons_iterator_sentinel() {
  test();
#ifndef TEST_HAS_NO_EXCEPTIONS
  test_exceptions();
#endif
