// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_initializer_list_f4e7fd9b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_initializer_list_f4e7fd9b { // libcis
struct Sink {
...
} // libcis_ns_containers_views_views_span_span_cons_initializer_list_f4e7fd9b (libcis)
