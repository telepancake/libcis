// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_stdarray_ff48628c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_stdarray_ff48628c { // libcis
void checkCV()
{
...
} // libcis_ns_containers_views_views_span_span_cons_stdarray_ff48628c (libcis)
