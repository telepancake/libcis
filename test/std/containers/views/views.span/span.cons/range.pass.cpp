// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_range_51fd632c).
//===---------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_range_51fd632c { // libcis
...
} // libcis_ns_containers_views_views_span_span_cons_range_51fd632c (libcis)
