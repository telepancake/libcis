// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_range).
// main -> test_containers_views_views_span_span_cons_range; file-scope helpers isolated in anon namespace.
//===---------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_range { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_views_span_span_cons_range; // libcis


void test_containers_views_views_span_span_cons_range() {
  test();
  static_assert(test());
