// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_array_eae539e1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_array_eae539e1 { // libcis
void checkCV()
{
                   int   arr[] = {1,2,3};
...
} // libcis_ns_containers_views_views_span_span_cons_array_eae539e1 (libcis)
