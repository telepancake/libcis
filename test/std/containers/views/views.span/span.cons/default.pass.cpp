// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_default).
// main -> test_containers_views_views_span_span_cons_default; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_default { // libcis: isolate file-scope helpers
void checkCV() {
...
struct A {};
} using namespace libcis_ns_containers_views_views_span_span_cons_default; // libcis


void test_containers_views_views_span_span_cons_default() {
