// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_span).
// main -> test_containers_views_views_span_span_cons_span; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_span { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_views_span_span_cons_span; // libcis


void test_containers_views_views_span_span_cons_span() {
  static_assert(test());
  test();
