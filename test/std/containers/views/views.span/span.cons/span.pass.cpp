// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_cons_span_f21ae4d9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_cons_span_f21ae4d9 { // libcis
...
} // libcis_ns_containers_views_views_span_span_cons_span_f21ae4d9 (libcis)
