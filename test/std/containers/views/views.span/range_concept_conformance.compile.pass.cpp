// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_range_concept_conformance_c52f7165).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_range_concept_conformance_c52f7165 { // libcis
...
} // libcis_ns_containers_views_views_span_range_concept_conformance_c52f7165 (libcis)
