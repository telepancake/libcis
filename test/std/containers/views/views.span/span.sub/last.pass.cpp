// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_sub_last).
// main -> test_containers_views_views_span_span_sub_last; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_sub_last { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_views_span_span_sub_last; // libcis


void test_containers_views_views_span_span_sub_last() {
  {
