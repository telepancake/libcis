// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_sub_subspan).
// main -> test_containers_views_views_span_span_sub_subspan; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_sub_subspan { // libcis: isolate file-scope helpers
...
int arr1[]            = {5, 6, 7};
} using namespace libcis_ns_containers_views_views_span_span_sub_subspan; // libcis


void test_containers_views_views_span_span_sub_subspan() {
  {
