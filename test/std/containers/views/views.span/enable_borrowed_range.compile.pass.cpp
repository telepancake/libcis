// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_enable_borrowed_range).
...
namespace libcis_ns_containers_views_views_span_enable_borrowed_range { // libcis: isolate file-scope helpers
void test() {
...
} using namespace libcis_ns_containers_views_views_span_enable_borrowed_range; // libcis
