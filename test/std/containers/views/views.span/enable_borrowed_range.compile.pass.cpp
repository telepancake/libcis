// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_enable_borrowed_range_3628e48d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_enable_borrowed_range_3628e48d { // libcis
void test() {
...
} // libcis_ns_containers_views_views_span_enable_borrowed_range_3628e48d (libcis)
