// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_elem_at).
// main -> test_containers_views_views_span_span_elem_at; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_elem_at { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_views_span_span_elem_at; // libcis


void test_containers_views_views_span_span_elem_at() {
  test();
  static_assert(test());
