// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_elem_op_idx).
// main -> test_containers_views_views_span_span_elem_op_idx; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_elem_op_idx { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_views_span_span_elem_op_idx; // libcis


void test_containers_views_views_span_span_elem_op_idx() {
