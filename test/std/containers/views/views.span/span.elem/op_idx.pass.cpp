// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_elem_op_idx_6d472f09).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_elem_op_idx_6d472f09 { // libcis
...
} // libcis_ns_containers_views_views_span_span_elem_op_idx_6d472f09 (libcis)
