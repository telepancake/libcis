// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_elem_front_424fd179).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_elem_front_424fd179 { // libcis
...
} // libcis_ns_containers_views_views_span_span_elem_front_424fd179 (libcis)
