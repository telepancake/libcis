// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_elem_data_d9e6ac31).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_elem_data_d9e6ac31 { // libcis
...
} // libcis_ns_containers_views_views_span_span_elem_data_d9e6ac31 (libcis)
