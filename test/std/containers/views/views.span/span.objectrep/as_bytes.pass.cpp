// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_objectrep_as_bytes_de65ba93).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_objectrep_as_bytes_de65ba93 { // libcis
...
} // libcis_ns_containers_views_views_span_span_objectrep_as_bytes_de65ba93 (libcis)
