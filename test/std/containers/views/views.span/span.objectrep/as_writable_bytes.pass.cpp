// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_objectrep_as_writable_bytes_1913efb1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_objectrep_as_writable_bytes_1913efb1 { // libcis
...
} // libcis_ns_containers_views_views_span_span_objectrep_as_writable_bytes_1913efb1 (libcis)
