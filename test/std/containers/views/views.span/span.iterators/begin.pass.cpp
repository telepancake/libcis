// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_iterators_begin).
// main -> test_containers_views_views_span_span_iterators_begin; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_iterators_begin { // libcis: isolate file-scope helpers
template <class Span>
...
} using namespace libcis_ns_containers_views_views_span_span_iterators_begin; // libcis


void test_containers_views_views_span_span_iterators_begin() {
