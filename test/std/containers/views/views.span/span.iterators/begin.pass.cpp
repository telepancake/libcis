// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_iterators_begin_81eb5fcb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_iterators_begin_81eb5fcb { // libcis
template <class Span>
...
} // libcis_ns_containers_views_views_span_span_iterators_begin_81eb5fcb (libcis)
