// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_iterators_iterator).
// main -> test_containers_views_views_span_span_iterators_iterator; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_iterators_iterator { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_containers_views_views_span_span_iterators_iterator; // libcis


void test_containers_views_views_span_span_iterators_iterator() {
  test();
  static_assert(test(), "");
