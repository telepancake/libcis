// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_iterators_iterator_8954a5a8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_iterators_iterator_8954a5a8 { // libcis
template <class T>
...
} // libcis_ns_containers_views_views_span_span_iterators_iterator_8954a5a8 (libcis)
