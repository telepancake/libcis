// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_span_iterators_rend).
// main -> test_containers_views_views_span_span_iterators_rend; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_iterators_rend { // libcis: isolate file-scope helpers
template <class Span>
...
} using namespace libcis_ns_containers_views_views_span_span_iterators_rend; // libcis


void test_containers_views_views_span_span_iterators_rend() {
