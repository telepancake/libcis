// transferred+adapted from libc++ by tools/transfer.py (slug=containers_views_views_span_span_iterators_rend_c6fff376).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_span_iterators_rend_c6fff376 { // libcis
template <class Span>
...
} // libcis_ns_containers_views_views_span_span_iterators_rend_c6fff376 (libcis)
