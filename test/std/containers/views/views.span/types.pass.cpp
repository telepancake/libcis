// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_views_span_types).
// main -> test_containers_views_views_span_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_views_span_types { // libcis: isolate file-scope helpers
...
struct A {};
} using namespace libcis_ns_containers_views_views_span_types; // libcis


void test_containers_views_views_span_types() {
  test<int>();
  test<long>();
  test<double>();
  test<std::string>();
