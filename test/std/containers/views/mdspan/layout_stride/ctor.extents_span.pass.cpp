// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_layout_stride_ctor_extents_span).
// main -> test_containers_views_mdspan_layout_stride_ctor_extents_span; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_layout_stride_ctor_extents_span { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_layout_stride_ctor_extents_span; // libcis


void test_containers_views_mdspan_layout_stride_ctor_extents_span() {
  test();
  static_assert(test());
  return;
}
