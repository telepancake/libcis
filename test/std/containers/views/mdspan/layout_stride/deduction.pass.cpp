// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_layout_stride_deduction).
// main -> test_containers_views_mdspan_layout_stride_deduction; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_layout_stride_deduction { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_containers_views_mdspan_layout_stride_deduction; // libcis


void test_containers_views_mdspan_layout_stride_deduction() {
  test();
  static_assert(test());
  return;
}
