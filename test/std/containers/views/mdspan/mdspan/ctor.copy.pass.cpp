// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_mdspan_ctor_copy).
// main -> test_containers_views_mdspan_mdspan_ctor_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_mdspan_ctor_copy { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_mdspan_ctor_copy; // libcis

void test_containers_views_mdspan_mdspan_ctor_copy() {
  test();
  static_assert(test());
  return;
}
