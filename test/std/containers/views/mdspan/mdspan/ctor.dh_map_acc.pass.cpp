// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_mdspan_ctor_dh_map_acc).
// main -> test_containers_views_mdspan_mdspan_ctor_dh_map_acc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_mdspan_ctor_dh_map_acc { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_mdspan_ctor_dh_map_acc; // libcis

void test_containers_views_mdspan_mdspan_ctor_dh_map_acc() {
  test();
  static_assert(test());
  return;
}
