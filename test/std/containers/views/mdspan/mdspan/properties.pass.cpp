// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_mdspan_properties).
// main -> test_containers_views_mdspan_mdspan_properties; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_mdspan_properties { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_mdspan_properties; // libcis

void test_containers_views_mdspan_mdspan_properties() {
  test();
  static_assert(test());
  return;
}
