// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_mdspan_ctor_dh_array).
// main -> test_containers_views_mdspan_mdspan_ctor_dh_array; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_mdspan_ctor_dh_array { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_mdspan_ctor_dh_array; // libcis


void test_containers_views_mdspan_mdspan_ctor_dh_array() {
  test();
  static_assert(test());
  return;
}
