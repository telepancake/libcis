// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_mdspan_assign).
// main -> test_containers_views_mdspan_mdspan_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_mdspan_assign { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_mdspan_assign; // libcis

void test_containers_views_mdspan_mdspan_assign() {
  test();
  static_assert(test());
  return;
}
