// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_mdspan_deduction).
// main -> test_containers_views_mdspan_mdspan_deduction; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_mdspan_deduction { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_mdspan_deduction; // libcis

void test_containers_views_mdspan_mdspan_deduction() {
  test();
  static_assert(test());
  return;
}
