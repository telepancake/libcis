// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_mdspan_types).
// main -> test_containers_views_mdspan_mdspan_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_mdspan_types { // libcis: isolate file-scope helpers
template <class MDS>
...
} using namespace libcis_ns_containers_views_mdspan_mdspan_types; // libcis


void test_containers_views_mdspan_mdspan_types() {
  mixin_accessor<int>();
