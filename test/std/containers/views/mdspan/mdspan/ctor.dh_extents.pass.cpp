// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_mdspan_ctor_dh_extents).
// main -> test_containers_views_mdspan_mdspan_ctor_dh_extents; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_mdspan_ctor_dh_extents { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_mdspan_ctor_dh_extents; // libcis

void test_containers_views_mdspan_mdspan_ctor_dh_extents() {
  test();
  static_assert(test());
  return;
}
