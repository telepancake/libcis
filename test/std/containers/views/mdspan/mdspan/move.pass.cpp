// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_mdspan_move).
// main -> test_containers_views_mdspan_mdspan_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_mdspan_move { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_mdspan_move; // libcis

void test_containers_views_mdspan_mdspan_move() {
  test();
  static_assert(test());
  return;
}
