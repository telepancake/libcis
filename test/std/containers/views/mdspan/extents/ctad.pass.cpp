// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_extents_ctad).
// main -> test_containers_views_mdspan_extents_ctad; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_extents_ctad { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_extents_ctad; // libcis


void test_containers_views_mdspan_extents_ctad() {
  test();
  static_assert(test());
