// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_extents_obs_static).
// main -> test_containers_views_mdspan_extents_obs_static; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_extents_obs_static { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_extents_obs_static; // libcis


void test_containers_views_mdspan_extents_obs_static() {
  test<int>();
  test<unsigned>();
  test<signed char>();
  test<long long>();
