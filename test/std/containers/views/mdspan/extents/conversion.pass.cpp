// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_extents_conversion).
// main -> test_containers_views_mdspan_extents_conversion; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_extents_conversion { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_extents_conversion; // libcis


void test_containers_views_mdspan_extents_conversion() {
  test();
  static_assert(test());
