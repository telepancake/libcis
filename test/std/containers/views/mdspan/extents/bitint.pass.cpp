// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_extents_bitint).
// main -> test_containers_views_mdspan_extents_bitint; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_views_mdspan_extents_bitint() {
#if TEST_HAS_EXTENSION(bit_int)
  test();
  static_assert(test());
#endif
