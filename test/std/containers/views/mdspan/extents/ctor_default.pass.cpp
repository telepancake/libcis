// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_extents_ctor_default).
// main -> test_containers_views_mdspan_extents_ctor_default; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_extents_ctor_default { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_extents_ctor_default; // libcis


void test_containers_views_mdspan_extents_ctor_default() {
