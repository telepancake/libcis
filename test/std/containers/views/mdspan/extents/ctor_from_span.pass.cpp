// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_extents_ctor_from_span).
// main -> test_containers_views_mdspan_extents_ctor_from_span; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_extents_ctor_from_span { // libcis: isolate file-scope helpers
struct SpanCtorTest {
...
} using namespace libcis_ns_containers_views_mdspan_extents_ctor_from_span; // libcis


void test_containers_views_mdspan_extents_ctor_from_span() {
