// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_extents_types).
// main -> test_containers_views_mdspan_extents_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_extents_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_extents_types; // libcis


void test_containers_views_mdspan_extents_types() {
  test<int>();
  test<unsigned>();
  test<signed char>();
  test<long long>();
