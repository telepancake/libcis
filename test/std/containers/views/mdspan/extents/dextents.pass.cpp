// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_extents_dextents).
// main -> test_containers_views_mdspan_extents_dextents; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_extents_dextents { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_extents_dextents; // libcis


void test_containers_views_mdspan_extents_dextents() {
