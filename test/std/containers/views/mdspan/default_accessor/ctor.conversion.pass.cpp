// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_default_accessor_ctor_conversion).
// main -> test_containers_views_mdspan_default_accessor_ctor_conversion; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_default_accessor_ctor_conversion { // libcis: isolate file-scope helpers
struct Base {};
...
} using namespace libcis_ns_containers_views_mdspan_default_accessor_ctor_conversion; // libcis


void test_containers_views_mdspan_default_accessor_ctor_conversion() {
  test();
  static_assert(test());
  return;
}
