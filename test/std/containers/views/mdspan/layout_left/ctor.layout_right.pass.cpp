// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_layout_left_ctor_layout_right).
// main -> test_containers_views_mdspan_layout_left_ctor_layout_right; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_layout_left_ctor_layout_right { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_layout_left_ctor_layout_right; // libcis


void test_containers_views_mdspan_layout_left_ctor_layout_right() {
  test();
  static_assert(test());
  return;
}
