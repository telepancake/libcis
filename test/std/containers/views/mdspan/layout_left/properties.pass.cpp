// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_layout_left_properties).
// main -> test_containers_views_mdspan_layout_left_properties; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_layout_left_properties { // libcis: isolate file-scope helpers
template <class E>
...
} using namespace libcis_ns_containers_views_mdspan_layout_left_properties; // libcis


void test_containers_views_mdspan_layout_left_properties() {
  test();
  static_assert(test());
  return;
}
