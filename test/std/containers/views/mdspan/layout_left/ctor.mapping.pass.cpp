// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_layout_left_ctor_mapping).
// main -> test_containers_views_mdspan_layout_left_ctor_mapping; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_layout_left_ctor_mapping { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_layout_left_ctor_mapping; // libcis


void test_containers_views_mdspan_layout_left_ctor_mapping() {
  test();
  static_assert(test());
  return;
}
