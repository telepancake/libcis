// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_layout_left_ctor_default).
// main -> test_containers_views_mdspan_layout_left_ctor_default; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_layout_left_ctor_default { // libcis: isolate file-scope helpers
template <class E>
...
} using namespace libcis_ns_containers_views_mdspan_layout_left_ctor_default; // libcis


void test_containers_views_mdspan_layout_left_ctor_default() {
  test();
  static_assert(test());
  return;
}
