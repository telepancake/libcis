// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_layout_right_ctor_extents).
// main -> test_containers_views_mdspan_layout_right_ctor_extents; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_layout_right_ctor_extents { // libcis: isolate file-scope helpers
template <class E>
...
} using namespace libcis_ns_containers_views_mdspan_layout_right_ctor_extents; // libcis


void test_containers_views_mdspan_layout_right_ctor_extents() {
  test();
  static_assert(test());
  return;
}
