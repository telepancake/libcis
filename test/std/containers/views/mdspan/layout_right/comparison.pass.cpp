// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_layout_right_comparison).
// main -> test_containers_views_mdspan_layout_right_comparison; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_layout_right_comparison { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_layout_right_comparison; // libcis


void test_containers_views_mdspan_layout_right_comparison() {
  test();
  static_assert(test());
  return;
}
