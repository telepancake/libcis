// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_layout_right_required_span_size).
// main -> test_containers_views_mdspan_layout_right_required_span_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_layout_right_required_span_size { // libcis: isolate file-scope helpers
template <class E>
...
} using namespace libcis_ns_containers_views_mdspan_layout_right_required_span_size; // libcis


void test_containers_views_mdspan_layout_right_required_span_size() {
  test();
  static_assert(test());
  return;
}
