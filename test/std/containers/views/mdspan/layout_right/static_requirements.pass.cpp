// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_layout_right_static_requirements).
// main -> test_containers_views_mdspan_layout_right_static_requirements; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_layout_right_static_requirements { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_layout_right_static_requirements; // libcis


void test_containers_views_mdspan_layout_right_static_requirements() {
