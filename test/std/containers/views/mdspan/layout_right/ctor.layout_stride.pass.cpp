// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_layout_right_ctor_layout_stride).
// main -> test_containers_views_mdspan_layout_right_ctor_layout_stride; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_layout_right_ctor_layout_stride { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_layout_right_ctor_layout_stride; // libcis


void test_containers_views_mdspan_layout_right_ctor_layout_stride() {
  test();
  static_assert(test());
  return;
}
