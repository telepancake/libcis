// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_layout_right_index_operator).
// main -> test_containers_views_mdspan_layout_right_index_operator; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_layout_right_index_operator { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_layout_right_index_operator; // libcis


void test_containers_views_mdspan_layout_right_index_operator() {
  test();
  static_assert(test());
