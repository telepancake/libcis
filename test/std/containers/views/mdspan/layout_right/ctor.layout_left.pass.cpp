// AST-transferred from libc++ by tools/transfer.py (slug=containers_views_mdspan_layout_right_ctor_layout_left).
// main -> test_containers_views_mdspan_layout_right_ctor_layout_left; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_views_mdspan_layout_right_ctor_layout_left { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_views_mdspan_layout_right_ctor_layout_left; // libcis


void test_containers_views_mdspan_layout_right_ctor_layout_left() {
  test();
  static_assert(test());
  return;
}
