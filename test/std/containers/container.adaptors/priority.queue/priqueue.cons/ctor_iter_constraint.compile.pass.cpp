// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_priority_queue_priqueue_cons_ctor_iter_constraint_ed0a7267).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_priority_queue_priqueue_cons_ctor_iter_constraint_ed0a7267 { // libcis
...
static_assert( std::is_constructible<std::priority_queue<int>, int*, int*, std::less<int>, std::vector<int>&, std::allocator<int>>::value, "");
static_assert(!std::is_constructible<std::priority_queue<int>, int , int , std::less<int>, std::vector<int>&, std::allocator<int>>::value, "");
} // libcis_ns_containers_container_adaptors_priority_queue_priqueue_cons_ctor_iter_constraint_ed0a7267 (libcis)
