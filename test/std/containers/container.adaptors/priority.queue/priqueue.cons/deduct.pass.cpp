// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_priority_queue_priqueue_cons_deduct_a837aab1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_priority_queue_priqueue_cons_deduct_a837aab1 { // libcis
struct A {};
...
} // libcis_ns_containers_container_adaptors_priority_queue_priqueue_cons_deduct_a837aab1 (libcis)
