// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_priority_queue_priqueue_cons_alloc_ctor_copy_alloc_dcffdb8b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_priority_queue_priqueue_cons_alloc_ctor_copy_alloc_dcffdb8b { // libcis
template <class C>
C
make(int n)
{
...
} // libcis_ns_containers_container_adaptors_priority_queue_priqueue_cons_alloc_ctor_copy_alloc_dcffdb8b (libcis)
