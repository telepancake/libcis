// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_priority_queue_priqueue_cons_alloc_ctor_iter_iter_comp_cont_alloc_f11ed186).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_priority_queue_priqueue_cons_alloc_ctor_iter_iter_comp_cont_alloc_f11ed186 { // libcis
...
} // libcis_ns_containers_container_adaptors_priority_queue_priqueue_cons_alloc_ctor_iter_iter_comp_cont_alloc_f11ed186 (libcis)
