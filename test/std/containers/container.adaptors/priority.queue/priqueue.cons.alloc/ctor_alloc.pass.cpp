// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_priority_queue_priqueue_cons_alloc_ctor_alloc_1a6d986a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_priority_queue_priqueue_cons_alloc_ctor_alloc_1a6d986a { // libcis
template <class T>
struct test
...
} // libcis_ns_containers_container_adaptors_priority_queue_priqueue_cons_alloc_ctor_alloc_1a6d986a (libcis)
