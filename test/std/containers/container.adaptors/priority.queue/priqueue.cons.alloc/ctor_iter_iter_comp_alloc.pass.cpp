// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_priority_queue_priqueue_cons_alloc_ctor_iter_iter_comp_alloc_044a7fcd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_priority_queue_priqueue_cons_alloc_ctor_iter_iter_comp_alloc_044a7fcd { // libcis
...
} // libcis_ns_containers_container_adaptors_priority_queue_priqueue_cons_alloc_ctor_iter_iter_comp_alloc_044a7fcd (libcis)
