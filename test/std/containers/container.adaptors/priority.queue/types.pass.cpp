// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_priority_queue_types_ae216fbc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_priority_queue_types_ae216fbc { // libcis
struct test
...
} // libcis_ns_containers_container_adaptors_priority_queue_types_ae216fbc (libcis)
