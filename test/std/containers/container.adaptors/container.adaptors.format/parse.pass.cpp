// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_container_adaptors_format_parse).
// main -> test_containers_container_adaptors_container_adaptors_format_parse; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_container_adaptors_format_parse { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_container_adaptors_container_adaptors_format_parse; // libcis


void test_containers_container_adaptors_container_adaptors_format_parse() {
  test();
  static_assert(test());
