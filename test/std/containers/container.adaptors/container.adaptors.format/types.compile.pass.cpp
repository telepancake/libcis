// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_container_adaptors_format_types).
...
namespace libcis_ns_containers_container_adaptors_container_adaptors_format_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_container_adaptors_container_adaptors_format_types; // libcis
