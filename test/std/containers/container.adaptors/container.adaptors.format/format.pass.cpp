// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_container_adaptors_format_format).
// main -> test_containers_container_adaptors_container_adaptors_format_format; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_container_adaptors_format_format { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_container_adaptors_container_adaptors_format_format; // libcis


void test_containers_container_adaptors_container_adaptors_format_format() {
  test();
