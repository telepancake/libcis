// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_queue_queue_defn_types).
// main -> test_containers_container_adaptors_queue_queue_defn_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_queue_queue_defn_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_container_adaptors_queue_queue_defn_types; // libcis


void test_containers_container_adaptors_queue_queue_defn_types() {
