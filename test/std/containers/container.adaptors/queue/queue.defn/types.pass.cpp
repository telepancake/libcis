// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_queue_queue_defn_types_41992aea).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_queue_queue_defn_types_41992aea { // libcis
struct test
...
} // libcis_ns_containers_container_adaptors_queue_queue_defn_types_41992aea (libcis)
