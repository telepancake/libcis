// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_queue_queue_defn_emplace).
// main -> test_containers_container_adaptors_queue_queue_defn_emplace; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_queue_queue_defn_emplace { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_container_adaptors_queue_queue_defn_emplace; // libcis


void test_containers_container_adaptors_queue_queue_defn_emplace() {
