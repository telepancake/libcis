// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_queue_queue_defn_emplace_b030bf5b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_queue_queue_defn_emplace_b030bf5b { // libcis
...
} // libcis_ns_containers_container_adaptors_queue_queue_defn_emplace_b030bf5b (libcis)
