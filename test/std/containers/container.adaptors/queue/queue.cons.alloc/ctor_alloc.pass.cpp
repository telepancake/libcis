// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_queue_queue_cons_alloc_ctor_alloc_a8fd6f79).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_queue_queue_cons_alloc_ctor_alloc_a8fd6f79 { // libcis
struct test
...
} // libcis_ns_containers_container_adaptors_queue_queue_cons_alloc_ctor_alloc_a8fd6f79 (libcis)
