// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_queue_queue_cons_alloc_ctor_queue_alloc_df6929f4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_queue_queue_cons_alloc_ctor_queue_alloc_df6929f4 { // libcis
template <class C>
C
make(int n)
{
...
} // libcis_ns_containers_container_adaptors_queue_queue_cons_alloc_ctor_queue_alloc_df6929f4 (libcis)
