// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_queue_queue_cons_alloc_ctor_rcontainer_alloc_597e8ce2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_queue_queue_cons_alloc_ctor_rcontainer_alloc_597e8ce2 { // libcis
template <class C>
C
make(int n)
{
...
} // libcis_ns_containers_container_adaptors_queue_queue_cons_alloc_ctor_rcontainer_alloc_597e8ce2 (libcis)
