// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_queue_queue_cons_alloc_ctor_rqueue_alloc_fd8ee3cb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_queue_queue_cons_alloc_ctor_rqueue_alloc_fd8ee3cb { // libcis
template <class C>
C
make(int n)
{
...
} // libcis_ns_containers_container_adaptors_queue_queue_cons_alloc_ctor_rqueue_alloc_fd8ee3cb (libcis)
