// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_queue_queue_cons_deduct_44285d40).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_queue_queue_cons_deduct_44285d40 { // libcis
struct A {};
...
} // libcis_ns_containers_container_adaptors_queue_queue_cons_deduct_44285d40 (libcis)
