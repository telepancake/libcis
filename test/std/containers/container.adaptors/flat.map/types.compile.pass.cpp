// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_flat_map_types).
...
namespace libcis_ns_containers_container_adaptors_flat_map_types { // libcis: isolate file-scope helpers
void test() {
  {
...
} using namespace libcis_ns_containers_container_adaptors_flat_map_types; // libcis
