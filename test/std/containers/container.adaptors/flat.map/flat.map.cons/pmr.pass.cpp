// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_flat_map_flat_map_cons_pmr).
// main -> test_containers_container_adaptors_flat_map_flat_map_cons_pmr; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_containers_container_adaptors_flat_map_flat_map_cons_pmr() {
  {
