// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_flat_map_flat_map_cons_deduct_pmr).
// main -> test_containers_container_adaptors_flat_map_flat_map_cons_deduct_pmr; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_flat_map_flat_map_cons_deduct_pmr { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_container_adaptors_flat_map_flat_map_cons_deduct_pmr; // libcis


void test_containers_container_adaptors_flat_map_flat_map_cons_deduct_pmr() {
  test_containers();
