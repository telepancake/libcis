// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_flat_map_flat_map_cons_move_assign_noexcept).
...
namespace libcis_ns_containers_container_adaptors_flat_map_flat_map_cons_move_assign_noexcept { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_container_adaptors_flat_map_flat_map_cons_move_assign_noexcept; // libcis
