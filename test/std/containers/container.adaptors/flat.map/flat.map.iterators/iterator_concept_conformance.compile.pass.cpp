// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_flat_map_flat_map_iterators_iterator_concept_conformance).
...
namespace libcis_ns_containers_container_adaptors_flat_map_flat_map_iterators_iterator_concept_conformance { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_container_adaptors_flat_map_flat_map_iterators_iterator_concept_conformance; // libcis
