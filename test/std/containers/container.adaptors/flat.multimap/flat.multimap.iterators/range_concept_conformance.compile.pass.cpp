// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_flat_multimap_flat_multimap_iterators_range_concept_conformance).
...
namespace libcis_ns_containers_container_adaptors_flat_multimap_flat_multimap_iterators_range_concept_conformance { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_container_adaptors_flat_multimap_flat_multimap_iterators_range_concept_conformance; // libcis
