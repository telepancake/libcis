// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_flat_multimap_flat_multimap_cons_move_noexcept).
// main -> test_containers_container_adaptors_flat_multimap_flat_multimap_cons_move_noexcept; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_flat_multimap_flat_multimap_cons_move_noexcept { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_containers_container_adaptors_flat_multimap_flat_multimap_cons_move_noexcept; // libcis


void test_containers_container_adaptors_flat_multimap_flat_multimap_cons_move_noexcept() {
  {
