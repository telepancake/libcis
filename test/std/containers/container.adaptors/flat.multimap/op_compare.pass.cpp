// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_flat_multimap_op_compare).
// main -> test_containers_container_adaptors_flat_multimap_op_compare; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_flat_multimap_op_compare { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_container_adaptors_flat_multimap_op_compare; // libcis


void test_containers_container_adaptors_flat_multimap_op_compare() {
  ...
  }
  {
    // Comparisons use value_type's native operators, not the comparator
    struct StrongComp {
      bool operator()(double a, double b) const { return; }
    };
