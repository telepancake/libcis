// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_stack_stack_cons_deduct_0478a0ec).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_stack_stack_cons_deduct_0478a0ec { // libcis
struct A {};
...
} // libcis_ns_containers_container_adaptors_stack_stack_cons_deduct_0478a0ec (libcis)
