// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_stack_stack_cons_deduct).
// main -> test_containers_container_adaptors_stack_stack_cons_deduct; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_stack_stack_cons_deduct { // libcis: isolate file-scope helpers
struct A {};
} using namespace libcis_ns_containers_container_adaptors_stack_stack_cons_deduct; // libcis


void test_containers_container_adaptors_stack_stack_cons_deduct() {
