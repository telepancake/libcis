// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_stack_stack_cons_ctor_iterators).
// main -> test_containers_container_adaptors_stack_stack_cons_ctor_iterators; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_stack_stack_cons_ctor_iterators { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_container_adaptors_stack_stack_cons_ctor_iterators; // libcis


void test_containers_container_adaptors_stack_stack_cons_ctor_iterators() {
  const int a[] = {4, 3, 2, 1};
