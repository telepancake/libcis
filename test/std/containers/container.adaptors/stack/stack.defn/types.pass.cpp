// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_stack_stack_defn_types_55a06ac6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_stack_stack_defn_types_55a06ac6 { // libcis
struct test
...
} // libcis_ns_containers_container_adaptors_stack_stack_defn_types_55a06ac6 (libcis)
