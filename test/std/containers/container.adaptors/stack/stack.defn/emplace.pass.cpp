// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_stack_stack_defn_emplace_d917c896).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_stack_stack_defn_emplace_d917c896 { // libcis
...
} // libcis_ns_containers_container_adaptors_stack_stack_defn_emplace_d917c896 (libcis)
