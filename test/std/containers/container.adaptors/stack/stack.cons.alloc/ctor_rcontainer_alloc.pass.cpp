// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_stack_stack_cons_alloc_ctor_rcontainer_alloc_463ed245).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_stack_stack_cons_alloc_ctor_rcontainer_alloc_463ed245 { // libcis
template <class C>
C
make(int n)
{
...
} // libcis_ns_containers_container_adaptors_stack_stack_cons_alloc_ctor_rcontainer_alloc_463ed245 (libcis)
