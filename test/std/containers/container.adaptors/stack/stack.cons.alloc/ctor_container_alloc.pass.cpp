// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_stack_stack_cons_alloc_ctor_container_alloc_5ad9674c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_stack_stack_cons_alloc_ctor_container_alloc_5ad9674c { // libcis
template <class C>
C
make(int n)
{
...
} // libcis_ns_containers_container_adaptors_stack_stack_cons_alloc_ctor_container_alloc_5ad9674c (libcis)
