// AST-transferred from libc++ by tools/transfer.py (slug=containers_container_adaptors_stack_stack_cons_alloc_ctor_rqueue_alloc).
// main -> test_containers_container_adaptors_stack_stack_cons_alloc_ctor_rqueue_alloc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_stack_stack_cons_alloc_ctor_rqueue_alloc { // libcis: isolate file-scope helpers
template <class C>
C make(int n) {
  C c;
  for (int i = 0; i < n; ++i)
...
} using namespace libcis_ns_containers_container_adaptors_stack_stack_cons_alloc_ctor_rqueue_alloc; // libcis


void test_containers_container_adaptors_stack_stack_cons_alloc_ctor_rqueue_alloc() {
