// transferred+adapted from libc++ by tools/transfer.py (slug=containers_container_adaptors_stack_compare_three_way_077cd110).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_container_adaptors_stack_compare_three_way_077cd110 { // libcis
int main(int, char**) {
...
} // libcis_ns_containers_container_adaptors_stack_compare_three_way_077cd110 (libcis)
