// transferred+adapted from libc++ by tools/transfer.py (slug=containers_iterator_rel_ops_185524ce).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_containers_iterator_rel_ops_185524ce { // libcis
...
} // libcis_ns_containers_iterator_rel_ops_185524ce (libcis)
