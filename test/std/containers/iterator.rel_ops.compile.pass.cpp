// AST-transferred from libc++ by tools/transfer.py (slug=containers_iterator_rel_ops).
...
namespace libcis_ns_containers_iterator_rel_ops { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_containers_iterator_rel_ops; // libcis
