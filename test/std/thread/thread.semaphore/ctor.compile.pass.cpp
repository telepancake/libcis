// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_semaphore_ctor).
...
namespace libcis_ns_thread_thread_semaphore_ctor { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_thread_semaphore_ctor; // libcis
