// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_semaphore_ctor_8c1a6603).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_semaphore_ctor_8c1a6603 { // libcis
...
} // libcis_ns_thread_thread_semaphore_ctor_8c1a6603 (libcis)
