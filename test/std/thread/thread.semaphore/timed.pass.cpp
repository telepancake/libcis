// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_semaphore_timed).
// main -> test_thread_thread_semaphore_timed; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_thread_thread_semaphore_timed()
{
