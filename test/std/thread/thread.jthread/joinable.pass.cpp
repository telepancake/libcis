// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_jthread_joinable_de034e54).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_jthread_joinable_de034e54 { // libcis
...
} // libcis_ns_thread_thread_jthread_joinable_de034e54 (libcis)
