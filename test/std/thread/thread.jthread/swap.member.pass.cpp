// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_jthread_swap_member).
// main -> test_thread_thread_jthread_swap_member; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_jthread_swap_member { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_thread_thread_jthread_swap_member; // libcis


void test_thread_thread_jthread_swap_member() {
