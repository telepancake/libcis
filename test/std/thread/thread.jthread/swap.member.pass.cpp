// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_jthread_swap_member_3fa94d02).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_jthread_swap_member_3fa94d02 { // libcis
template <class T>
...
} // libcis_ns_thread_thread_jthread_swap_member_3fa94d02 (libcis)
