// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_jthread_swap_free_2f8b12ea).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_jthread_swap_free_2f8b12ea { // libcis
template <class T>
...
} // libcis_ns_thread_thread_jthread_swap_free_2f8b12ea (libcis)
