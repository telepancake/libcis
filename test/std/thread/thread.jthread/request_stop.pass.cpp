// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_jthread_request_stop_28c27946).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_jthread_request_stop_28c27946 { // libcis
...
} // libcis_ns_thread_thread_jthread_request_stop_28c27946 (libcis)
