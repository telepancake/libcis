// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_jthread_join_40aa2f30).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_jthread_join_40aa2f30 { // libcis
int main(int, char**) {
...
} // libcis_ns_thread_thread_jthread_join_40aa2f30 (libcis)
