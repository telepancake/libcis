// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_jthread_join).
// main -> test_thread_thread_jthread_join; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_thread_thread_jthread_join() {
