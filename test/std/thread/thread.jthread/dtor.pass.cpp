// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_jthread_dtor_0a92bbcc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_jthread_dtor_0a92bbcc { // libcis
int main(int, char**) {
  // !joinable()
  {
    std::jthread jt;
...
} // libcis_ns_thread_thread_jthread_dtor_0a92bbcc (libcis)
