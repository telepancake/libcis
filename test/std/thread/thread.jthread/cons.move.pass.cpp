// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_jthread_cons_move).
// main -> test_thread_thread_jthread_cons_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_jthread_cons_move { // libcis: isolate file-scope helpers
static_assert(std::is_nothrow_move_constructible_v<std::jthread>);
} using namespace libcis_ns_thread_thread_jthread_cons_move; // libcis


void test_thread_thread_jthread_cons_move() {
  {
