// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_jthread_cons_move_84f3c67d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_jthread_cons_move_84f3c67d { // libcis
...
} // libcis_ns_thread_thread_jthread_cons_move_84f3c67d (libcis)
