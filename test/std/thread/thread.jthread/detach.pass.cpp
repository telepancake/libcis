// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_jthread_detach_0145dc7a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_jthread_detach_0145dc7a { // libcis
int main(int, char**) {
...
} // libcis_ns_thread_thread_jthread_detach_0145dc7a (libcis)
