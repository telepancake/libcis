// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_jthread_cons_func_token).
// main -> test_thread_thread_jthread_cons_func_token; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_jthread_cons_func_token { // libcis: isolate file-scope helpers
template <class... Args>
struct Func {
...
} using namespace libcis_ns_thread_thread_jthread_cons_func_token; // libcis


void test_thread_thread_jthread_cons_func_token() {
