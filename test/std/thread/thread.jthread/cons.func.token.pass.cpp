// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_jthread_cons_func_token_d1b872d1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_jthread_cons_func_token_d1b872d1 { // libcis
template <class... Args>
struct Func {
...
} // libcis_ns_thread_thread_jthread_cons_func_token_d1b872d1 (libcis)
