// AST-transferred from libc++ by tools/transfer.py (slug=thread_futures_futures_task_futures_task_members_ctor2).
...
namespace libcis_ns_thread_futures_futures_task_futures_task_members_ctor2 { // libcis: isolate file-scope helpers
struct A {};
...
static_assert(!std::is_constructible_v<PA, std::allocator_arg_t, std::allocator<A>, volatile PI&&>);
} using namespace libcis_ns_thread_futures_futures_task_futures_task_members_ctor2; // libcis
