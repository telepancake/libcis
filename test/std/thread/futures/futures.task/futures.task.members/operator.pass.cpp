// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_task_futures_task_members_operator_df99a35c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_task_futures_task_members_operator_df99a35c { // libcis
class A
{
    long data_;
...
} // libcis_ns_thread_futures_futures_task_futures_task_members_operator_df99a35c (libcis)
