// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_task_futures_task_members_make_ready_at_thread_exit_91714c29).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_task_futures_task_members_make_ready_at_thread_exit_91714c29 { // libcis
class A
{
    long data_;
...
} // libcis_ns_thread_futures_futures_task_futures_task_members_make_ready_at_thread_exit_91714c29 (libcis)
