// AST-transferred from libc++ by tools/transfer.py (slug=thread_futures_futures_task_futures_task_members_ctad).
...
namespace libcis_ns_thread_futures_futures_task_futures_task_members_ctad { // libcis: isolate file-scope helpers
int func(char*);
...
} using namespace libcis_ns_thread_futures_futures_task_futures_task_members_ctad; // libcis
