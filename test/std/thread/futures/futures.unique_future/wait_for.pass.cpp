// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_unique_future_wait_for_e640bc32).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_unique_future_wait_for_e640bc32 { // libcis
...
} // libcis_ns_thread_futures_futures_unique_future_wait_for_e640bc32 (libcis)
