// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_unique_future_wait_until_d2ebde44).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_unique_future_wait_until_d2ebde44 { // libcis
...
} // libcis_ns_thread_futures_futures_unique_future_wait_until_d2ebde44 (libcis)
