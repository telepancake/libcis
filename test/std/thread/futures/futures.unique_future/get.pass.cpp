// AST-transferred from libc++ by tools/transfer.py (slug=thread_futures_futures_unique_future_get).
// main -> test_thread_futures_futures_unique_future_get; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_unique_future_get { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_futures_futures_unique_future_get; // libcis


void test_thread_futures_futures_unique_future_get()
{
    {
        typedef int T;
        {
