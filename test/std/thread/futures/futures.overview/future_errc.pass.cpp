// AST-transferred from libc++ by tools/transfer.py (slug=thread_futures_futures_overview_future_errc).
// main -> test_thread_futures_futures_overview_future_errc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_thread_futures_futures_overview_future_errc()
{
