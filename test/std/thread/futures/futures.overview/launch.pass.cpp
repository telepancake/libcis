// AST-transferred from libc++ by tools/transfer.py (slug=thread_futures_futures_overview_launch).
// main -> test_thread_futures_futures_overview_launch; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_thread_futures_futures_overview_launch()
{
#if TEST_STD_VER >= 11
