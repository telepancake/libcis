// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_overview_launch_b92435f5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_overview_launch_b92435f5 { // libcis
int main(int, char**)
{
#if TEST_STD_VER < 11
...
} // libcis_ns_thread_futures_futures_overview_launch_b92435f5 (libcis)
