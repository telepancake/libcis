// AST-transferred from libc++ by tools/transfer.py (slug=thread_futures_futures_promise_move_assign).
// main -> test_thread_futures_futures_promise_move_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_thread_futures_futures_promise_move_assign()
{
