// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_promise_move_assign_7171e601).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_promise_move_assign_7171e601 { // libcis
int main(int, char**)
{
...
} // libcis_ns_thread_futures_futures_promise_move_assign_7171e601 (libcis)
