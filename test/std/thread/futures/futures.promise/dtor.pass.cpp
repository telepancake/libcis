// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_promise_dtor_34b6abb5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_promise_dtor_34b6abb5 { // libcis
int main(int, char**)
{
    {
        typedef int T;
...
} // libcis_ns_thread_futures_futures_promise_dtor_34b6abb5 (libcis)
