// AST-transferred from libc++ by tools/transfer.py (slug=thread_futures_futures_promise_dtor).
// main -> test_thread_futures_futures_promise_dtor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_thread_futures_futures_promise_dtor()
{
    {
        typedef int T;
        std::future<T> f;
