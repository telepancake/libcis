// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_promise_alloc_ctor_df491418).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_promise_alloc_ctor_df491418 { // libcis
int main(int, char**)
{
...
} // libcis_ns_thread_futures_futures_promise_alloc_ctor_df491418 (libcis)
