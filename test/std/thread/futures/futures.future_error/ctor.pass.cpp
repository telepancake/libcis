// AST-transferred from libc++ by tools/transfer.py (slug=thread_futures_futures_future_error_ctor).
// main -> test_thread_futures_futures_future_error_ctor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_thread_futures_futures_future_error_ctor() {
  {
