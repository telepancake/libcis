// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_future_error_code_e6b354ec).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_future_error_code_e6b354ec { // libcis
int main(int, char**) {
...
} // libcis_ns_thread_futures_futures_future_error_code_e6b354ec (libcis)
