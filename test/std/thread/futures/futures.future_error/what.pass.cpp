// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_future_error_what_24f5caec).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_future_error_what_24f5caec { // libcis
int main(int, char**) {
...
} // libcis_ns_thread_futures_futures_future_error_what_24f5caec (libcis)
