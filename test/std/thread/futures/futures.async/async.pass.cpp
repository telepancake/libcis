// AST-transferred from libc++ by tools/transfer.py (slug=thread_futures_futures_async_async).
// main -> test_thread_futures_futures_async_async; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_async_async { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_futures_futures_async_async; // libcis


void test_thread_futures_futures_async_async()
{
