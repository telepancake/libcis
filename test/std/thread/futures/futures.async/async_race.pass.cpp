// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_async_async_race_8fe5b650).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_async_async_race_8fe5b650 { // libcis
int f_async() {
...
} // libcis_ns_thread_futures_futures_async_async_race_8fe5b650 (libcis)
