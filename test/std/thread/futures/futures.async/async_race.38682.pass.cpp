// AST-transferred from libc++ by tools/transfer.py (slug=thread_futures_futures_async_async_race_38682).
// main -> test_thread_futures_futures_async_async_race_38682; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_async_async_race_38682 { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_futures_futures_async_async_race_38682; // libcis


void test_thread_futures_futures_async_async_race_38682() {
  // future<T>
  {
