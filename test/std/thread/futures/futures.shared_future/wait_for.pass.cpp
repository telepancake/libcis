// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_shared_future_wait_for_f9840ba3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_shared_future_wait_for_f9840ba3 { // libcis
...
} // libcis_ns_thread_futures_futures_shared_future_wait_for_f9840ba3 (libcis)
