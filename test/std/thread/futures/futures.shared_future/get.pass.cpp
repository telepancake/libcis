// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_shared_future_get_8171f734).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_shared_future_get_8171f734 { // libcis
...
} // libcis_ns_thread_futures_futures_shared_future_get_8171f734 (libcis)
