// transferred+adapted from libc++ by tools/transfer.py (slug=thread_futures_futures_shared_future_wait_until_b1fdee2d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_shared_future_wait_until_b1fdee2d { // libcis
...
} // libcis_ns_thread_futures_futures_shared_future_wait_until_b1fdee2d (libcis)
