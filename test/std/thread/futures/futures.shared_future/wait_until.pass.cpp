// AST-transferred from libc++ by tools/transfer.py (slug=thread_futures_futures_shared_future_wait_until).
// main -> test_thread_futures_futures_shared_future_wait_until; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_futures_futures_shared_future_wait_until { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_futures_futures_shared_future_wait_until; // libcis


void test_thread_futures_futures_shared_future_wait_until()
{
