// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvarany_wait_until_token_pred_720aeb41).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_until_token_pred_720aeb41 { // libcis
...
} // libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_until_token_pred_720aeb41 (libcis)
