// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvarany_wait_until_pred_422a5aac).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_until_pred_422a5aac { // libcis
struct TestClock {
...
} // libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_until_pred_422a5aac (libcis)
