// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvarany_wait_for_token_pred_838875cd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_for_token_pred_838875cd { // libcis
...
} // libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_for_token_pred_838875cd (libcis)
