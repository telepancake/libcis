// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvarany_wait_for_pred).
// main -> test_thread_thread_condition_thread_condition_condvarany_wait_for_pred; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_for_pred { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_for_pred; // libcis


void test_thread_thread_condition_thread_condition_condvarany_wait_for_pred() {
