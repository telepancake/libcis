// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvarany_wait_for_pred_6daff7fa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_for_pred_6daff7fa { // libcis
...
} // libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_for_pred_6daff7fa (libcis)
