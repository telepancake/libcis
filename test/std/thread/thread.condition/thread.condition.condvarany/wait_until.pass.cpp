// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvarany_wait_until_fd707639).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_until_fd707639 { // libcis
struct TestClock {
...
} // libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_until_fd707639 (libcis)
