// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvarany_notify_all_198a69fa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvarany_notify_all_198a69fa { // libcis
...
} // libcis_ns_thread_thread_condition_thread_condition_condvarany_notify_all_198a69fa (libcis)
