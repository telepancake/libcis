// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvarany_wait_for_9789d4d5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_for_9789d4d5 { // libcis
...
} // libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_for_9789d4d5 (libcis)
