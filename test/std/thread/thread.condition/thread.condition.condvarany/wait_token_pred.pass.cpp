// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvarany_wait_token_pred_6ee8d934).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_token_pred_6ee8d934 { // libcis
...
} // libcis_ns_thread_thread_condition_thread_condition_condvarany_wait_token_pred_6ee8d934 (libcis)
