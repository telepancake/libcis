// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_condition_notify_all_at_thread_exit_lwg3343).
// main -> test_thread_thread_condition_notify_all_at_thread_exit_lwg3343; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_notify_all_at_thread_exit_lwg3343 { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_thread_condition_notify_all_at_thread_exit_lwg3343; // libcis


void test_thread_thread_condition_notify_all_at_thread_exit_lwg3343()
{
