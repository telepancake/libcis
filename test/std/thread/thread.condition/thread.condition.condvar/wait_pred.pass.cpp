// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvar_wait_pred_ceec7fac).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvar_wait_pred_ceec7fac { // libcis
int main(int, char**) {
...
} // libcis_ns_thread_thread_condition_thread_condition_condvar_wait_pred_ceec7fac (libcis)
