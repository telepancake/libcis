// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvar_wait_pred).
// main -> test_thread_thread_condition_thread_condition_condvar_wait_pred; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_thread_thread_condition_thread_condition_condvar_wait_pred() {
