// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvar_wait_until_pred_78d5fd5c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvar_wait_until_pred_78d5fd5c { // libcis
struct TestClock {
...
} // libcis_ns_thread_thread_condition_thread_condition_condvar_wait_until_pred_78d5fd5c (libcis)
