// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvar_wait_until_f3aa0ddf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvar_wait_until_f3aa0ddf { // libcis
struct TestClock {
...
} // libcis_ns_thread_thread_condition_thread_condition_condvar_wait_until_f3aa0ddf (libcis)
