// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvar_wait_for).
// main -> test_thread_thread_condition_thread_condition_condvar_wait_for; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvar_wait_for { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_thread_condition_thread_condition_condvar_wait_for; // libcis


void test_thread_thread_condition_thread_condition_condvar_wait_for() {
