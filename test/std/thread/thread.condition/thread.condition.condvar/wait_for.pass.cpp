// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_condition_thread_condition_condvar_wait_for_620cd753).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_condition_thread_condition_condvar_wait_for_620cd753 { // libcis
...
} // libcis_ns_thread_thread_condition_thread_condition_condvar_wait_for_620cd753 (libcis)
