// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_mutex_thread_lock_algorithm_lock_77804b21).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_mutex_thread_lock_algorithm_lock_77804b21 { // libcis
class L0
{
    bool locked_;
...
} // libcis_ns_thread_thread_mutex_thread_lock_algorithm_lock_77804b21 (libcis)
