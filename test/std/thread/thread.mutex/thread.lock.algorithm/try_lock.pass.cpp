// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_mutex_thread_lock_algorithm_try_lock_9fb578ca).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_mutex_thread_lock_algorithm_try_lock_9fb578ca { // libcis
class L0
{
    bool locked_;
...
} // libcis_ns_thread_thread_mutex_thread_lock_algorithm_try_lock_9fb578ca (libcis)
