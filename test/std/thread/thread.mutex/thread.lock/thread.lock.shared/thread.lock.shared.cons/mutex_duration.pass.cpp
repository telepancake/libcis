// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_cons_mutex_duration).
// main -> test_thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_cons_mutex_duration; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_cons_mutex_duration { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_cons_mutex_duration; // libcis


void test_thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_cons_mutex_duration()
{
  {
    m.lock();
