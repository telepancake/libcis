// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_cons_mutex_73159681).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_cons_mutex_73159681 { // libcis
struct Monitor {
...
} // libcis_ns_thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_cons_mutex_73159681 (libcis)
