// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_locking_try_lock).
// main -> test_thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_locking_try_lock; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_locking_try_lock { // libcis: isolate file-scope helpers
struct Monitor {
...
} using namespace libcis_ns_thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_locking_try_lock; // libcis


void test_thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_locking_try_lock() {
#if TEST_STD_VER >= 17
