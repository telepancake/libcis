// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_locking_try_lock_cc0637b2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_locking_try_lock_cc0637b2 { // libcis
struct Monitor {
...
} // libcis_ns_thread_thread_mutex_thread_lock_thread_lock_shared_thread_lock_shared_locking_try_lock_cc0637b2 (libcis)
