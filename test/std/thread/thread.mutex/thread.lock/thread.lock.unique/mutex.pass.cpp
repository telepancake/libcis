// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_mutex_thread_lock_thread_lock_unique_mutex).
// main -> test_thread_thread_mutex_thread_lock_thread_lock_unique_mutex; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_mutex_thread_lock_thread_lock_unique_mutex { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_thread_mutex_thread_lock_thread_lock_unique_mutex; // libcis


void test_thread_thread_mutex_thread_lock_thread_lock_unique_mutex() {
  {
    mux.lock();
