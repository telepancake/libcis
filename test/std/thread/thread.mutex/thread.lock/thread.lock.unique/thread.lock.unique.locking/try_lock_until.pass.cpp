// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_mutex_thread_lock_thread_lock_unique_thread_lock_unique_locking_try_lock_until).
// main -> test_thread_thread_mutex_thread_lock_thread_lock_unique_thread_lock_unique_locking_try_lock_until; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_thread_thread_mutex_thread_lock_thread_lock_unique_thread_lock_unique_locking_try_lock_until() {
