// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_mutex_thread_lock_thread_lock_scoped_adopt_lock_d3769dad).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_mutex_thread_lock_thread_lock_scoped_adopt_lock_d3769dad { // libcis
struct TestMutex {
    bool locked = false;
    TestMutex() = default;
...
} // libcis_ns_thread_thread_mutex_thread_lock_thread_lock_scoped_adopt_lock_d3769dad (libcis)
