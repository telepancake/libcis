// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_mutex_thread_lock_thread_lock_scoped_mutex_3456e04e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_mutex_thread_lock_thread_lock_scoped_mutex_3456e04e { // libcis
struct TestMutex {
    bool locked = false;
    TestMutex() = default;
...
} // libcis_ns_thread_thread_mutex_thread_lock_thread_lock_scoped_mutex_3456e04e (libcis)
