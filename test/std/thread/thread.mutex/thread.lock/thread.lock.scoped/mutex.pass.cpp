// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_mutex_thread_lock_thread_lock_scoped_mutex).
// main -> test_thread_thread_mutex_thread_lock_thread_lock_scoped_mutex; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_mutex_thread_lock_thread_lock_scoped_mutex { // libcis: isolate file-scope helpers
struct TestMutex {
    bool locked = false;
    TestMutex() = default;
...
} using namespace libcis_ns_thread_thread_mutex_thread_lock_thread_lock_scoped_mutex; // libcis
...
void test_thread_thread_mutex_thread_lock_thread_lock_scoped_mutex()
{
    {
