// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_mutex_thread_lock_thread_lock_scoped_types_a0522b61).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_mutex_thread_lock_thread_lock_scoped_types_a0522b61 { // libcis
struct NAT {};
...
} // libcis_ns_thread_thread_mutex_thread_lock_thread_lock_scoped_types_a0522b61 (libcis)
