// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stoptoken_stop_requested).
// main -> test_thread_thread_stoptoken_stoptoken_stop_requested; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stoptoken_stop_requested { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_thread_thread_stoptoken_stoptoken_stop_requested; // libcis


void test_thread_thread_stoptoken_stoptoken_stop_requested() {
  // no state
  {
