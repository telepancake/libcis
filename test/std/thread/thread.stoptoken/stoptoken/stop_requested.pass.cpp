// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stoptoken_stop_requested_aa2f59d3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stoptoken_stop_requested_aa2f59d3 { // libcis
template <class T>
...
} // libcis_ns_thread_thread_stoptoken_stoptoken_stop_requested_aa2f59d3 (libcis)
