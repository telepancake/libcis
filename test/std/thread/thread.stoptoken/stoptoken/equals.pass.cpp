// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stoptoken_equals).
// main -> test_thread_thread_stoptoken_stoptoken_equals; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// LWG 3254 is related.
namespace libcis_ns_thread_thread_stoptoken_stoptoken_equals { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_thread_thread_stoptoken_stoptoken_equals; // libcis


void test_thread_thread_stoptoken_stoptoken_equals() {
  // both no state
  {
