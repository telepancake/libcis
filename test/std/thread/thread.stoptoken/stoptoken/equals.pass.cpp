// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stoptoken_equals_502d0a3e).
//===----------------------------------------------------------------------===//
//
...
// LWG 3254 is related.
namespace libcis_ns_thread_thread_stoptoken_stoptoken_equals_502d0a3e { // libcis
template <class T>
...
} // libcis_ns_thread_thread_stoptoken_stoptoken_equals_502d0a3e (libcis)
