// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stoptoken_stop_possible_f10f02c0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stoptoken_stop_possible_f10f02c0 { // libcis
template <class T>
...
} // libcis_ns_thread_thread_stoptoken_stoptoken_stop_possible_f10f02c0 (libcis)
