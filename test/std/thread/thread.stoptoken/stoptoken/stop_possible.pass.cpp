// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stoptoken_stop_possible).
// main -> test_thread_thread_stoptoken_stoptoken_stop_possible; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stoptoken_stop_possible { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_thread_thread_stoptoken_stoptoken_stop_possible; // libcis


void test_thread_thread_stoptoken_stoptoken_stop_possible() {
  // no state
  {
