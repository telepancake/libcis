// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopcallback_copy_move_91dcbc3b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopcallback_copy_move_91dcbc3b { // libcis
struct Callback {
  void operator()() const;
};
...
} // libcis_ns_thread_thread_stoptoken_stopcallback_copy_move_91dcbc3b (libcis)
