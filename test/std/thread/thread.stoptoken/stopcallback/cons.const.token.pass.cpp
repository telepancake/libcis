// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopcallback_cons_const_token_a4b1f816).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopcallback_cons_const_token_a4b1f816 { // libcis
struct Cb {
  void operator()() const;
};
...
} // libcis_ns_thread_thread_stoptoken_stopcallback_cons_const_token_a4b1f816 (libcis)
