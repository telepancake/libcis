// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopcallback_cons_const_token).
// main -> test_thread_thread_stoptoken_stopcallback_cons_const_token; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopcallback_cons_const_token { // libcis: isolate file-scope helpers
struct Cb {
  void operator()() const;
};
...
} using namespace libcis_ns_thread_thread_stoptoken_stopcallback_cons_const_token; // libcis


void test_thread_thread_stoptoken_stopcallback_cons_const_token() {
  // was requested
  {
    std::stop_source ss;
