// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopcallback_cons_rvalue_token_dcdf2e72).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopcallback_cons_rvalue_token_dcdf2e72 { // libcis
struct Cb {
  void operator()() const;
};
...
} // libcis_ns_thread_thread_stoptoken_stopcallback_cons_rvalue_token_dcdf2e72 (libcis)
