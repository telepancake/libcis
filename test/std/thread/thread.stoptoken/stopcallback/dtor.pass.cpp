// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopcallback_dtor).
// main -> test_thread_thread_stoptoken_stopcallback_dtor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopcallback_dtor { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_thread_stoptoken_stopcallback_dtor; // libcis


void DeleteHolder::operator()() const { holder_.callback_.reset(); }

void test_thread_thread_stoptoken_stopcallback_dtor() {
