// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_nostopstate_cons_default_74bdff78).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_nostopstate_cons_default_74bdff78 { // libcis
...
} // libcis_ns_thread_thread_stoptoken_nostopstate_cons_default_74bdff78 (libcis)
