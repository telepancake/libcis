// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopsource_request_stop).
// main -> test_thread_thread_stoptoken_stopsource_request_stop; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopsource_request_stop { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_thread_thread_stoptoken_stopsource_request_stop; // libcis


void test_thread_thread_stoptoken_stopsource_request_stop() {
