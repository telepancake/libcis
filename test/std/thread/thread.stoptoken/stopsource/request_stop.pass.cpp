// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopsource_request_stop_54af55a9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopsource_request_stop_54af55a9 { // libcis
template <class T>
...
} // libcis_ns_thread_thread_stoptoken_stopsource_request_stop_54af55a9 (libcis)
