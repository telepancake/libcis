// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopsource_assign_copy_b1768f38).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopsource_assign_copy_b1768f38 { // libcis
...
} // libcis_ns_thread_thread_stoptoken_stopsource_assign_copy_b1768f38 (libcis)
