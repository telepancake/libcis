// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopsource_cons_copy).
// main -> test_thread_thread_stoptoken_stopsource_cons_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopsource_cons_copy { // libcis: isolate file-scope helpers
static_assert(std::is_nothrow_copy_constructible_v<std::stop_source>);
} using namespace libcis_ns_thread_thread_stoptoken_stopsource_cons_copy; // libcis


void test_thread_thread_stoptoken_stopsource_cons_copy() {
  {
