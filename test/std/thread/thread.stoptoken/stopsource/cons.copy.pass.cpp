// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopsource_cons_copy_17a668a6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopsource_cons_copy_17a668a6 { // libcis
...
} // libcis_ns_thread_thread_stoptoken_stopsource_cons_copy_17a668a6 (libcis)
