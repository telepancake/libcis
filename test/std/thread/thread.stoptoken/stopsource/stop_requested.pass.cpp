// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopsource_stop_requested_1c1d6198).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopsource_stop_requested_1c1d6198 { // libcis
template <class T>
...
} // libcis_ns_thread_thread_stoptoken_stopsource_stop_requested_1c1d6198 (libcis)
