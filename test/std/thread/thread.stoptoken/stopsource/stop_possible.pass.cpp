// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopsource_stop_possible_63757fd4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopsource_stop_possible_63757fd4 { // libcis
template <class T>
...
} // libcis_ns_thread_thread_stoptoken_stopsource_stop_possible_63757fd4 (libcis)
