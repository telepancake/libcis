// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopsource_move_copy_f24eb4e9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopsource_move_copy_f24eb4e9 { // libcis
...
} // libcis_ns_thread_thread_stoptoken_stopsource_move_copy_f24eb4e9 (libcis)
