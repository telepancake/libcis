// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopsource_equals_1ff1aba4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopsource_equals_1ff1aba4 { // libcis
template <class T>
...
} // libcis_ns_thread_thread_stoptoken_stopsource_equals_1ff1aba4 (libcis)
