// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_stoptoken_stopsource_equals).
// main -> test_thread_thread_stoptoken_stopsource_equals; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_stoptoken_stopsource_equals { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_thread_thread_stoptoken_stopsource_equals; // libcis


void test_thread_thread_stoptoken_stopsource_equals() {
  // both no state
  {
