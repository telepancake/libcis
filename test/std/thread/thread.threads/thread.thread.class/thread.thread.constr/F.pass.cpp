// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_threads_thread_thread_class_thread_thread_constr_F).
// main -> test_thread_thread_threads_thread_thread_class_thread_thread_constr_F; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_threads_thread_thread_class_thread_thread_constr_F { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_thread_threads_thread_thread_class_thread_thread_constr_F; // libcis
...
void test_thread_thread_threads_thread_thread_class_thread_thread_constr_F()
{
