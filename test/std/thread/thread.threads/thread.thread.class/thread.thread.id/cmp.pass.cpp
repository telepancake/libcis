// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_threads_thread_thread_class_thread_thread_id_cmp).
// main -> test_thread_thread_threads_thread_thread_class_thread_thread_id_cmp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_thread_thread_threads_thread_thread_class_thread_thread_id_cmp() {
