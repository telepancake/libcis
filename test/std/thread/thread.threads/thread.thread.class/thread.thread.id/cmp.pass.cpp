// transferred+adapted from libc++ by tools/transfer.py (slug=thread_thread_threads_thread_thread_class_thread_thread_id_cmp_ec2623f9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_threads_thread_thread_class_thread_thread_id_cmp_ec2623f9 { // libcis
int main(int, char**) {
...
} // libcis_ns_thread_thread_threads_thread_thread_class_thread_thread_id_cmp_ec2623f9 (libcis)
