// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_threads_thread_thread_class_thread_thread_id_stream).
// main -> test_thread_thread_threads_thread_thread_class_thread_thread_id_stream; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_threads_thread_thread_class_thread_thread_id_stream { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_thread_threads_thread_thread_class_thread_thread_id_stream; // libcis


void test_thread_thread_threads_thread_thread_class_thread_thread_id_stream() {
  test<char>();
