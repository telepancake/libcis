// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_threads_thread_thread_class_thread_thread_id_types).
...
namespace libcis_ns_thread_thread_threads_thread_thread_class_thread_thread_id_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_thread_thread_threads_thread_thread_class_thread_thread_id_types; // libcis
