// AST-transferred from libc++ by tools/transfer.py (slug=thread_thread_threads_thread_thread_this_sleep_for_signals).
// main -> test_thread_thread_threads_thread_thread_this_sleep_for_signals; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_thread_thread_threads_thread_thread_this_sleep_for_signals { // libcis: isolate file-scope helpers
void sig_action(int) {}
} using namespace libcis_ns_thread_thread_threads_thread_thread_this_sleep_for_signals; // libcis


void test_thread_thread_threads_thread_thread_this_sleep_for_signals()
{
  int ec;
