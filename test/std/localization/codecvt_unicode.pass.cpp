// transferred+adapted from libc++ by tools/transfer.py (slug=localization_codecvt_unicode_50b42006).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_codecvt_unicode_50b42006 { // libcis
...
} // libcis_ns_localization_codecvt_unicode_50b42006 (libcis)
