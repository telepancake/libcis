// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_types_locale_category_category_5d8a0b90).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_locale_types_locale_category_category_5d8a0b90 { // libcis
template <class T>
void test(const T &) {}
...
} // libcis_ns_localization_locales_locale_locale_types_locale_category_category_5d8a0b90 (libcis)
