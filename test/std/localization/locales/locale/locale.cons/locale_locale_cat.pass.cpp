// AST-transferred from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_cons_locale_locale_cat).
// main -> test_localization_locales_locale_locale_cons_locale_locale_cat; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_locale_cons_locale_locale_cat { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_localization_locales_locale_locale_cons_locale_locale_cat; // libcis


void test_localization_locales_locale_locale_cons_locale_locale_cat()
{
    {
