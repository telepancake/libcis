// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_cons_name_construction_0860736a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_locale_cons_name_construction_0860736a { // libcis
int main(int, char**) {
...
} // libcis_ns_localization_locales_locale_locale_cons_name_construction_0860736a (libcis)
