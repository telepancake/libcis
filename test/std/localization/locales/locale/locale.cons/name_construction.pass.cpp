// AST-transferred from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_cons_name_construction).
// main -> test_localization_locales_locale_locale_cons_name_construction; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_localization_locales_locale_locale_cons_name_construction() {
