// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_cons_default_750750ea).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_locale_cons_default_750750ea { // libcis
...
} // libcis_ns_localization_locales_locale_locale_cons_default_750750ea (libcis)
