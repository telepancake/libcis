// AST-transferred from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_cons_default).
// main -> test_localization_locales_locale_locale_cons_default; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_locale_cons_default { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_localization_locales_locale_locale_cons_default; // libcis


void test_localization_locales_locale_locale_cons_default()
{
    int ok;
    {
        std::locale loc;
