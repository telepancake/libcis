// AST-transferred from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_cons_locale_facetptr).
// main -> test_localization_locales_locale_locale_cons_locale_facetptr; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_locale_cons_locale_facetptr { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_localization_locales_locale_locale_cons_locale_facetptr; // libcis


std::locale::id my_facet::id;

void test_localization_locales_locale_locale_cons_locale_facetptr()
{
    {
