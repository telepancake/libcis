// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_cons_char_pointer_38d0ad8c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_locale_cons_char_pointer_38d0ad8c { // libcis
...
} // libcis_ns_localization_locales_locale_locale_cons_char_pointer_38d0ad8c (libcis)
