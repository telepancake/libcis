// AST-transferred from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_cons_char_pointer).
// main -> test_localization_locales_locale_locale_cons_char_pointer; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_locale_cons_char_pointer { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_localization_locales_locale_locale_cons_char_pointer; // libcis


void test_localization_locales_locale_locale_cons_char_pointer()
{
    {
