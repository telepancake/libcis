// AST-transferred from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_members_combine).
// main -> test_localization_locales_locale_locale_members_combine; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_locale_members_combine { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_localization_locales_locale_locale_members_combine; // libcis


std::locale::id my_facet::id;

void test_localization_locales_locale_locale_members_combine()
{
{
