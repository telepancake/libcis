// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_operators_eq_2ff26a5b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_locale_operators_eq_2ff26a5b { // libcis
int main(int, char**)
{
    std::locale cloc;
...
} // libcis_ns_localization_locales_locale_locale_operators_eq_2ff26a5b (libcis)
