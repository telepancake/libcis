// AST-transferred from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_operators_eq).
// main -> test_localization_locales_locale_locale_operators_eq; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_localization_locales_locale_locale_operators_eq()
{
    std::locale cloc;
