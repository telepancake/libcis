// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_statics_classic_069cd04e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_locale_statics_classic_069cd04e { // libcis
...
} // libcis_ns_localization_locales_locale_locale_statics_classic_069cd04e (libcis)
