// AST-transferred from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_statics_classic).
// main -> test_localization_locales_locale_locale_statics_classic; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_locale_statics_classic { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_localization_locales_locale_locale_statics_classic; // libcis


void test_localization_locales_locale_locale_statics_classic()
{
