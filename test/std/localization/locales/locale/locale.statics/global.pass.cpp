// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locales_locale_locale_statics_global_8731f273).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_locale_statics_global_8731f273 { // libcis
...
} // libcis_ns_localization_locales_locale_locale_statics_global_8731f273 (libcis)
