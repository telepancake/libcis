// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locales_locale_convenience_conversions_conversions_string_types_4913516f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_convenience_conversions_conversions_string_types_4913516f { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_localization_locales_locale_convenience_conversions_conversions_string_types_4913516f (libcis)
