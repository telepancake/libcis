// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locales_locale_convenience_conversions_conversions_string_ctor_codecvt_0e95a5ce).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_convenience_conversions_conversions_string_ctor_codecvt_0e95a5ce { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_localization_locales_locale_convenience_conversions_conversions_string_ctor_codecvt_0e95a5ce (libcis)
