// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locales_locale_convenience_conversions_conversions_string_ctor_err_string_874cde97).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_convenience_conversions_conversions_string_ctor_err_string_874cde97 { // libcis
int main(int, char**)
{
...
} // libcis_ns_localization_locales_locale_convenience_conversions_conversions_string_ctor_err_string_874cde97 (libcis)
