// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locales_locale_convenience_conversions_conversions_buffer_seekoff_e8fa7b5a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_convenience_conversions_conversions_buffer_seekoff_e8fa7b5a { // libcis
class test_codecvt
...
} // libcis_ns_localization_locales_locale_convenience_conversions_conversions_buffer_seekoff_e8fa7b5a (libcis)
