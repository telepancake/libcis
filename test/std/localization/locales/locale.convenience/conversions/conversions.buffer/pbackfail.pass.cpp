// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locales_locale_convenience_conversions_conversions_buffer_pbackfail_1f5d76ba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_convenience_conversions_conversions_buffer_pbackfail_1f5d76ba { // libcis
struct test_buf
...
} // libcis_ns_localization_locales_locale_convenience_conversions_conversions_buffer_pbackfail_1f5d76ba (libcis)
