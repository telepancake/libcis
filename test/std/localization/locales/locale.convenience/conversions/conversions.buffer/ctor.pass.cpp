// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locales_locale_convenience_conversions_conversions_buffer_ctor_b9887727).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locales_locale_convenience_conversions_conversions_buffer_ctor_b9887727 { // libcis
int main(int, char**)
{
...
} // libcis_ns_localization_locales_locale_convenience_conversions_conversions_buffer_ctor_b9887727 (libcis)
