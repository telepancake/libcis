// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_stdcvt_codecvt_utf16_in_a0df20d5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_stdcvt_codecvt_utf16_in_a0df20d5 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_localization_locale_stdcvt_codecvt_utf16_in_a0df20d5 (libcis)
