// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_stdcvt_codecvt_utf8_unshift_a85af8df).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_stdcvt_codecvt_utf8_unshift_a85af8df { // libcis
int main(int, char**)
{
...
} // libcis_ns_localization_locale_stdcvt_codecvt_utf8_unshift_a85af8df (libcis)
