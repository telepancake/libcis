// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_messages_locale_messages_types_6e27e78c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_messages_locale_messages_types_6e27e78c { // libcis
int main(int, char**)
{
...
} // libcis_ns_localization_locale_categories_category_messages_locale_messages_types_6e27e78c (libcis)
