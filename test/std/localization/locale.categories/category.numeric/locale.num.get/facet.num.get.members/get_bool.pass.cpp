// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_get_bool).
// main -> test_localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_get_bool; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_get_bool { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_get_bool; // libcis


void test_localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_get_bool()
{
    const my_facet f(1);
    std::ios ios(0);
    {
