// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_get_float).
// main -> test_localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_get_float; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_get_float { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_get_float; // libcis



void test_localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_get_float()
{
    const my_facet f(1);
    std::ios ios(0);
    float v = -1;
