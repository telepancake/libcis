// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_get_long_e425dcf9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_get_long_e425dcf9 { // libcis
...
} // libcis_ns_localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_get_long_e425dcf9 (libcis)
