// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_test_neg_one_0687c29a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_test_neg_one_0687c29a { // libcis
...
} // libcis_ns_localization_locale_categories_category_numeric_locale_num_get_facet_num_get_members_test_neg_one_0687c29a (libcis)
