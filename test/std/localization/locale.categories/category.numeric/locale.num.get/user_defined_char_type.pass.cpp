// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_numeric_locale_num_get_user_defined_char_type).
// main -> test_localization_locale_categories_category_numeric_locale_num_get_user_defined_char_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_numeric_locale_num_get_user_defined_char_type { // libcis: isolate file-scope helpers
struct Char {
  Char() = default;
...
} using namespace libcis_ns_localization_locale_categories_category_numeric_locale_num_get_user_defined_char_type; // libcis
...
void test_localization_locale_categories_category_numeric_locale_num_get_user_defined_char_type() {
