// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_numeric_locale_nm_put_facet_num_put_members_put_long_double_hex_fa5d8c0f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_numeric_locale_nm_put_facet_num_put_members_put_long_double_hex_fa5d8c0f { // libcis
...
} // libcis_ns_localization_locale_categories_category_numeric_locale_nm_put_facet_num_put_members_put_long_double_hex_fa5d8c0f (libcis)
