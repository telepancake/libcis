// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_numeric_locale_nm_put_facet_num_put_members_put_long_long_f5bdd846).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_numeric_locale_nm_put_facet_num_put_members_put_long_long_f5bdd846 { // libcis
...
} // libcis_ns_localization_locale_categories_category_numeric_locale_nm_put_facet_num_put_members_put_long_long_f5bdd846 (libcis)
