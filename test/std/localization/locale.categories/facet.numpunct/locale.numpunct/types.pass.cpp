// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_facet_numpunct_locale_numpunct_types).
// main -> test_localization_locale_categories_facet_numpunct_locale_numpunct_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_localization_locale_categories_facet_numpunct_locale_numpunct_types()
{
