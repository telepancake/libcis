// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_facet_numpunct_locale_numpunct_types_92627aa1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_facet_numpunct_locale_numpunct_types_92627aa1 { // libcis
int main(int, char**)
{
...
} // libcis_ns_localization_locale_categories_facet_numpunct_locale_numpunct_types_92627aa1 (libcis)
