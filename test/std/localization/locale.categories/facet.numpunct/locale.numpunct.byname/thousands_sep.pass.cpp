// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_facet_numpunct_locale_numpunct_byname_thousands_sep_21f91b8b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_facet_numpunct_locale_numpunct_byname_thousands_sep_21f91b8b { // libcis
int main(int, char**)
{
    {
        std::locale l("C");
...
} // libcis_ns_localization_locale_categories_facet_numpunct_locale_numpunct_byname_thousands_sep_21f91b8b (libcis)
