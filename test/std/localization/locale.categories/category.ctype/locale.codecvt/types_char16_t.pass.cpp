// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_ctype_locale_codecvt_types_char16_t_30b6855d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_ctype_locale_codecvt_types_char16_t_30b6855d { // libcis
int main(int, char**)
{
...
} // libcis_ns_localization_locale_categories_category_ctype_locale_codecvt_types_char16_t_30b6855d (libcis)
