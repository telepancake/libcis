// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_ctype_locale_codecvt_types_wchar_t).
// main -> test_localization_locale_categories_category_ctype_locale_codecvt_types_wchar_t; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_localization_locale_categories_category_ctype_locale_codecvt_types_wchar_t()
{
