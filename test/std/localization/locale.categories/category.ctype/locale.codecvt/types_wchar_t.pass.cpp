// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_ctype_locale_codecvt_types_wchar_t_5d351088).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_ctype_locale_codecvt_types_wchar_t_5d351088 { // libcis
int main(int, char**)
{
...
} // libcis_ns_localization_locale_categories_category_ctype_locale_codecvt_types_wchar_t_5d351088 (libcis)
