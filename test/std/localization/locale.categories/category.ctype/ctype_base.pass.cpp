// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_ctype_ctype_base).
// main -> test_localization_locale_categories_category_ctype_ctype_base; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_ctype_ctype_base { // libcis: isolate file-scope helpers
template <class T>
void test(const T &) {}
} using namespace libcis_ns_localization_locale_categories_category_ctype_ctype_base; // libcis


void test_localization_locale_categories_category_ctype_ctype_base()
{
