// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_ctype_ctype_base_cbe8ae71).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_ctype_ctype_base_cbe8ae71 { // libcis
template <class T>
void test(const T &) {}
...
} // libcis_ns_localization_locale_categories_category_ctype_ctype_base_cbe8ae71 (libcis)
