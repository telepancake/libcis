// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_ctype_locale_ctype_byname_mask_18fd561a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_ctype_locale_ctype_byname_mask_18fd561a { // libcis
int main(int, char**)
{
    std::locale l("C");
    {
...
} // libcis_ns_localization_locale_categories_category_ctype_locale_ctype_byname_mask_18fd561a (libcis)
