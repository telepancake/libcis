// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_ctype_locale_ctype_byname_scan_is_3afdb9e6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_ctype_locale_ctype_byname_scan_is_3afdb9e6 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_localization_locale_categories_category_ctype_locale_ctype_byname_scan_is_3afdb9e6 (libcis)
