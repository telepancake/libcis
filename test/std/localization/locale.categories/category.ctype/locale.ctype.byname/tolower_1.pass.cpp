// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_ctype_locale_ctype_byname_tolower_1).
// main -> test_localization_locale_categories_category_ctype_locale_ctype_byname_tolower_1; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_localization_locale_categories_category_ctype_locale_ctype_byname_tolower_1()
{
    {
        std::locale l;
        {
