// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_ctype_locale_ctype_byname_toupper_1_1e9ac53c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_ctype_locale_ctype_byname_toupper_1_1e9ac53c { // libcis
int main(int, char**)
{
    {
        std::locale l;
...
} // libcis_ns_localization_locale_categories_category_ctype_locale_ctype_byname_toupper_1_1e9ac53c (libcis)
