// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_ctype_locale_ctype_locale_ctype_members_scan_is).
// main -> test_localization_locale_categories_category_ctype_locale_ctype_locale_ctype_members_scan_is; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_localization_locale_categories_category_ctype_locale_ctype_locale_ctype_members_scan_is()
{
