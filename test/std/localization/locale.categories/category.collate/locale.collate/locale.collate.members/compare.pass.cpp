// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_collate_locale_collate_locale_collate_members_compare_f25585d5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_collate_locale_collate_locale_collate_members_compare_f25585d5 { // libcis
int main(int, char**)
{
...
} // libcis_ns_localization_locale_categories_category_collate_locale_collate_locale_collate_members_compare_f25585d5 (libcis)
