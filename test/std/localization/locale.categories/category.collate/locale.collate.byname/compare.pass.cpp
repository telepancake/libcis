// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_collate_locale_collate_byname_compare).
// main -> test_localization_locale_categories_category_collate_locale_collate_byname_compare; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_localization_locale_categories_category_collate_locale_collate_byname_compare()
{
    {
