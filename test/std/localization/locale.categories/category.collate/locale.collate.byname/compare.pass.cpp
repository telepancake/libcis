// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_collate_locale_collate_byname_compare_a9108e0a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_collate_locale_collate_byname_compare_a9108e0a { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_localization_locale_categories_category_collate_locale_collate_byname_compare_a9108e0a (libcis)
