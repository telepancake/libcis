// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_monetary_locale_money_get_locale_money_get_members_get_long_double_en_US_90674eef).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_monetary_locale_money_get_locale_money_get_members_get_long_double_en_US_90674eef { // libcis
...
} // libcis_ns_localization_locale_categories_category_monetary_locale_money_get_locale_money_get_members_get_long_double_en_US_90674eef (libcis)
