// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_monetary_locale_money_get_types).
// main -> test_localization_locale_categories_category_monetary_locale_money_get_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_localization_locale_categories_category_monetary_locale_money_get_types()
{
