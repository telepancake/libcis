// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_monetary_locale_moneypunct_locale_moneypunct_members_frac_digits_3d32b353).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_locale_moneypunct_members_frac_digits_3d32b353 { // libcis
...
} // libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_locale_moneypunct_members_frac_digits_3d32b353 (libcis)
