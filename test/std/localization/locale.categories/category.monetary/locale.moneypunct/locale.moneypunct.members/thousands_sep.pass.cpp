// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_monetary_locale_moneypunct_locale_moneypunct_members_thousands_sep_ed5bab92).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_locale_moneypunct_members_thousands_sep_ed5bab92 { // libcis
...
} // libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_locale_moneypunct_members_thousands_sep_ed5bab92 (libcis)
