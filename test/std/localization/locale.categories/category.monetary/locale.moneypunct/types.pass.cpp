// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_monetary_locale_moneypunct_types_84f51afd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_types_84f51afd { // libcis
template <class T>
void test(const T &) {}
...
} // libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_types_84f51afd (libcis)
