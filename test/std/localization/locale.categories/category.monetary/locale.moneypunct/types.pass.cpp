// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_monetary_locale_moneypunct_types).
// main -> test_localization_locale_categories_category_monetary_locale_moneypunct_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_types { // libcis: isolate file-scope helpers
template <class T>
void test(const T &) {}
} using namespace libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_types; // libcis


void test_localization_locale_categories_category_monetary_locale_moneypunct_types()
{
