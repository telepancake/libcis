// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_monetary_locale_moneypunct_byname_grouping_cce487d0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_byname_grouping_cce487d0 { // libcis
class Fnf
...
} // libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_byname_grouping_cce487d0 (libcis)
