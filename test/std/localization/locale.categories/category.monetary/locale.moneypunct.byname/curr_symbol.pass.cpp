// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_monetary_locale_moneypunct_byname_curr_symbol).
// main -> test_localization_locale_categories_category_monetary_locale_moneypunct_byname_curr_symbol; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_byname_curr_symbol { // libcis: isolate file-scope helpers
class Fnf
...
} using namespace libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_byname_curr_symbol; // libcis

#endif // TEST_HAS_NO_WIDE_CHARACTERS

void test_localization_locale_categories_category_monetary_locale_moneypunct_byname_curr_symbol()
{
    {
        Fnf f("C", 1);
