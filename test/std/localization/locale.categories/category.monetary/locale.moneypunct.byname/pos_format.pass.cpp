// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_monetary_locale_moneypunct_byname_pos_format).
// main -> test_localization_locale_categories_category_monetary_locale_moneypunct_byname_pos_format; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_byname_pos_format { // libcis: isolate file-scope helpers
class Fnf
...
} using namespace libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_byname_pos_format; // libcis


void test_localization_locale_categories_category_monetary_locale_moneypunct_byname_pos_format()
{
    {
        Fnf f("C", 1);
