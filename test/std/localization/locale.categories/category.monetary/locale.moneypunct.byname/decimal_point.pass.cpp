// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_monetary_locale_moneypunct_byname_decimal_point).
// main -> test_localization_locale_categories_category_monetary_locale_moneypunct_byname_decimal_point; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_byname_decimal_point { // libcis: isolate file-scope helpers
class Fnf
...
} using namespace libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_byname_decimal_point; // libcis

#endif // TEST_HAS_NO_WIDE_CHARACTERS

void test_localization_locale_categories_category_monetary_locale_moneypunct_byname_decimal_point()
{
    {
        Fnf f("C", 1);
