// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_monetary_locale_moneypunct_byname_decimal_point_e0a0f21e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_byname_decimal_point_e0a0f21e { // libcis
class Fnf
...
} // libcis_ns_localization_locale_categories_category_monetary_locale_moneypunct_byname_decimal_point_e0a0f21e (libcis)
