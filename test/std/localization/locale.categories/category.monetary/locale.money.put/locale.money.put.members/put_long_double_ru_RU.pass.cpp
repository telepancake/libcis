// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_monetary_locale_money_put_locale_money_put_members_put_long_double_ru_RU_cff837cf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_monetary_locale_money_put_locale_money_put_members_put_long_double_ru_RU_cff837cf { // libcis
...
} // libcis_ns_localization_locale_categories_category_monetary_locale_money_put_locale_money_put_members_put_long_double_ru_RU_cff837cf (libcis)
