// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_time_locale_time_get_byname_get_weekday_wide_26d0fb2c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_time_locale_time_get_byname_get_weekday_wide_26d0fb2c { // libcis
...
} // libcis_ns_localization_locale_categories_category_time_locale_time_get_byname_get_weekday_wide_26d0fb2c (libcis)
