// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_time_locale_time_get_byname_get_monthname_wide_af283b6f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_time_locale_time_get_byname_get_monthname_wide_af283b6f { // libcis
...
} // libcis_ns_localization_locale_categories_category_time_locale_time_get_byname_get_monthname_wide_af283b6f (libcis)
