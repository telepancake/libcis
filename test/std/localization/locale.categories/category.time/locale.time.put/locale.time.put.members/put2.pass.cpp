// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_time_locale_time_put_locale_time_put_members_put2).
// main -> test_localization_locale_categories_category_time_locale_time_put_locale_time_put_members_put2; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_time_locale_time_put_locale_time_put_members_put2 { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_localization_locale_categories_category_time_locale_time_put_locale_time_put_members_put2; // libcis


void test_localization_locale_categories_category_time_locale_time_put_locale_time_put_members_put2()
{
    const my_facet f(1);
    char str[200];
    std::tm t = {};
