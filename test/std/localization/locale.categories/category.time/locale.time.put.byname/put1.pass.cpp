// AST-transferred from libc++ by tools/transfer.py (slug=localization_locale_categories_category_time_locale_time_put_byname_put1).
// main -> test_localization_locale_categories_category_time_locale_time_put_byname_put1; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_time_locale_time_put_byname_put1 { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_localization_locale_categories_category_time_locale_time_put_byname_put1; // libcis


void test_localization_locale_categories_category_time_locale_time_put_byname_put1()
{
    char str[200];
    std::tm t;
    t.tm_sec = 6;
