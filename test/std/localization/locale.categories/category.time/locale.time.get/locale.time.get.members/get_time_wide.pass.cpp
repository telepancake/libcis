// transferred+adapted from libc++ by tools/transfer.py (slug=localization_locale_categories_category_time_locale_time_get_locale_time_get_members_get_time_wide_1534a2d0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_localization_locale_categories_category_time_locale_time_get_locale_time_get_members_get_time_wide_1534a2d0 { // libcis
...
} // libcis_ns_localization_locale_categories_category_time_locale_time_get_locale_time_get_members_get_time_wide_1534a2d0 (libcis)
