// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_c_math_signbit_39e049de).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_c_math_signbit_39e049de { // libcis
struct TestFloat {
  template <class T>
...
} // libcis_ns_numerics_c_math_signbit_39e049de (libcis)
