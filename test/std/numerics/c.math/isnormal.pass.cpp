// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_c_math_isnormal_9bf0fa64).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_c_math_isnormal_9bf0fa64 { // libcis
struct TestFloat {
  template <class T>
...
} // libcis_ns_numerics_c_math_isnormal_9bf0fa64 (libcis)
