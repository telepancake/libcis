// AST-transferred from libc++ by tools/transfer.py (slug=numerics_c_math_isfinite).
// main -> test_numerics_c_math_isfinite; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
