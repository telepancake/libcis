// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_c_math_isfinite_647ccf17).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_c_math_isfinite_647ccf17 { // libcis
struct TestFloat {
  template <class T>
...
} // libcis_ns_numerics_c_math_isfinite_647ccf17 (libcis)
