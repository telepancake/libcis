// AST-transferred from libc++ by tools/transfer.py (slug=numerics_c_math_cmath).
// main -> test_numerics_c_math_cmath; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
