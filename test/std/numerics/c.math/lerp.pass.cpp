// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_c_math_lerp_60619ddb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_c_math_lerp_60619ddb { // libcis
template <typename T>
...
} // libcis_ns_numerics_c_math_lerp_60619ddb (libcis)
