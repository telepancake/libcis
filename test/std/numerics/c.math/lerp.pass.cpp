// AST-transferred from libc++ by tools/transfer.py (slug=numerics_c_math_lerp).
// main -> test_numerics_c_math_lerp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_c_math_lerp()
{
