// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_c_math_isnan_b4ad6be0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_c_math_isnan_b4ad6be0 { // libcis
struct TestFloat {
  template <class T>
...
} // libcis_ns_numerics_c_math_isnan_b4ad6be0 (libcis)
