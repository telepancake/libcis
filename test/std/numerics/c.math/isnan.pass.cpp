// AST-transferred from libc++ by tools/transfer.py (slug=numerics_c_math_isnan).
// main -> test_numerics_c_math_isnan; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_c_math_isnan { // libcis: isolate file-scope helpers
struct TestFloat {
  template <class T>
...
} using namespace libcis_ns_numerics_c_math_isnan; // libcis


void test_numerics_c_math_isnan() {
