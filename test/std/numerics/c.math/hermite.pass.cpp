// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_c_math_hermite_5bff5cba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_c_math_hermite_5bff5cba { // libcis
template <class Real>
...
} // libcis_ns_numerics_c_math_hermite_5bff5cba (libcis)
