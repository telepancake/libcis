// AST-transferred from libc++ by tools/transfer.py (slug=numerics_c_math_hermite).
// main -> test_numerics_c_math_hermite; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
