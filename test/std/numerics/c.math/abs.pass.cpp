// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_c_math_abs_6fb702c2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_c_math_abs_6fb702c2 { // libcis
template<class T>
...
} // libcis_ns_numerics_c_math_abs_6fb702c2 (libcis)
