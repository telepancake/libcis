// AST-transferred from libc++ by tools/transfer.py (slug=numerics_c_math_abs).
// main -> test_numerics_c_math_abs; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
