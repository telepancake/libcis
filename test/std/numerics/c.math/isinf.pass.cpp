// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_c_math_isinf_3afa3da3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_c_math_isinf_3afa3da3 { // libcis
struct TestFloat {
  template <class T>
...
} // libcis_ns_numerics_c_math_isinf_3afa3da3 (libcis)
