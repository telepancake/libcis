// AST-transferred from libc++ by tools/transfer.py (slug=numerics_c_math_isinf).
// main -> test_numerics_c_math_isinf; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_c_math_isinf { // libcis: isolate file-scope helpers
struct TestFloat {
  template <class T>
...
} using namespace libcis_ns_numerics_c_math_isinf; // libcis


void test_numerics_c_math_isinf() {
