// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numbers_value).
// main -> test_numerics_numbers_value; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
