// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numbers_value_734e7384).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numbers_value_734e7384 { // libcis
...
} // libcis_ns_numerics_numbers_value_734e7384 (libcis)
