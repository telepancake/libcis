// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numbers_defined_ccd68c93).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numbers_defined_ccd68c93 { // libcis
...
} // libcis_ns_numerics_numbers_defined_ccd68c93 (libcis)
