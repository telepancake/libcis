// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numbers_defined).
// main -> test_numerics_numbers_defined; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
