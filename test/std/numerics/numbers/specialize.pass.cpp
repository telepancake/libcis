// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numbers_specialize_cc1f5b0c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numbers_specialize_cc1f5b0c { // libcis
...
} // libcis_ns_numerics_numbers_specialize_cc1f5b0c (libcis)
