// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numbers_specialize).
// main -> test_numerics_numbers_specialize; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
