// AST-transferred from libc++ by tools/transfer.py (slug=numerics_cfenv_cfenv_syn_cfenv).
// main -> test_numerics_cfenv_cfenv_syn_cfenv; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_cfenv_cfenv_syn_cfenv()
{
    std::fenv_t fenv;
    std::fexcept_t fex;
