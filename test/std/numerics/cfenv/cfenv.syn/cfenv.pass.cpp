// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_cfenv_cfenv_syn_cfenv_328f4a2a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_cfenv_cfenv_syn_cfenv_328f4a2a { // libcis
int main(int, char**)
{
    std::fenv_t fenv;
    std::fexcept_t fex;
...
} // libcis_ns_numerics_cfenv_cfenv_syn_cfenv_328f4a2a (libcis)
