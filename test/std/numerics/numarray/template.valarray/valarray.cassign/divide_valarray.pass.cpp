// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_cassign_divide_valarray_5bcd1d42).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_valarray_valarray_cassign_divide_valarray_5bcd1d42 { // libcis
template <class A>
...
} // libcis_ns_numerics_numarray_template_valarray_valarray_cassign_divide_valarray_5bcd1d42 (libcis)
