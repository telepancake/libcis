// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_cassign_modulo_valarray).
// main -> test_numerics_numarray_template_valarray_valarray_cassign_modulo_valarray; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_valarray_valarray_cassign_modulo_valarray { // libcis: isolate file-scope helpers
template <class A>
...
} using namespace libcis_ns_numerics_numarray_template_valarray_valarray_cassign_modulo_valarray; // libcis


void test_numerics_numarray_template_valarray_valarray_cassign_modulo_valarray() {
  int input[]      = {1, 2, 3, 4, 5};
  const unsigned N = sizeof(input) / sizeof(input[0]);
