// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_cassign_modulo_valarray_637ef66b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_valarray_valarray_cassign_modulo_valarray_637ef66b { // libcis
template <class A>
...
} // libcis_ns_numerics_numarray_template_valarray_valarray_cassign_modulo_valarray_637ef66b (libcis)
