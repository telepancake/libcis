// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_cassign_minus_valarray_e60eae1f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_valarray_valarray_cassign_minus_valarray_e60eae1f { // libcis
template <class A>
...
} // libcis_ns_numerics_numarray_template_valarray_valarray_cassign_minus_valarray_e60eae1f (libcis)
