// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_cassign_shift_left_valarray).
// main -> test_numerics_numarray_template_valarray_valarray_cassign_shift_left_valarray; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_valarray_valarray_cassign_shift_left_valarray { // libcis: isolate file-scope helpers
template <class A>
...
} using namespace libcis_ns_numerics_numarray_template_valarray_valarray_cassign_shift_left_valarray; // libcis


void test_numerics_numarray_template_valarray_valarray_cassign_shift_left_valarray() {
