// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_cassign_plus_valarray_87a085f1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_valarray_valarray_cassign_plus_valarray_87a085f1 { // libcis
template <class A>
...
} // libcis_ns_numerics_numarray_template_valarray_valarray_cassign_plus_valarray_87a085f1 (libcis)
