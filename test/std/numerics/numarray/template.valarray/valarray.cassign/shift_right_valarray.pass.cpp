// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_cassign_shift_right_valarray_b75e65b4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_valarray_valarray_cassign_shift_right_valarray_b75e65b4 { // libcis
template <class A>
...
} // libcis_ns_numerics_numarray_template_valarray_valarray_cassign_shift_right_valarray_b75e65b4 (libcis)
