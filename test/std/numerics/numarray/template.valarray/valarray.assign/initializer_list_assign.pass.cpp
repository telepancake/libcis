// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_assign_initializer_list_assign).
// main -> test_numerics_numarray_template_valarray_valarray_assign_initializer_list_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
