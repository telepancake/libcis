// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_cons_deduct_3722bfda).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_valarray_valarray_cons_deduct_3722bfda { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_numerics_numarray_template_valarray_valarray_cons_deduct_3722bfda (libcis)
