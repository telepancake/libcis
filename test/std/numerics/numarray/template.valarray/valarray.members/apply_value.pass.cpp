// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_members_apply_value).
// main -> test_numerics_numarray_template_valarray_valarray_members_apply_value; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
