// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_members_shift_edb148e9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_valarray_valarray_members_shift_edb148e9 { // libcis
int main(int, char**)
{
    {
        typedef int T;
...
} // libcis_ns_numerics_numarray_template_valarray_valarray_members_shift_edb148e9 (libcis)
