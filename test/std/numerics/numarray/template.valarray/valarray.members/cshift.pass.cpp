// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_members_cshift).
// main -> test_numerics_numarray_template_valarray_valarray_members_cshift; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_numarray_template_valarray_valarray_members_cshift()
{
    {
        typedef int T;
