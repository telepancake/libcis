// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_members_cshift_9fdcd17f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_valarray_valarray_members_cshift_9fdcd17f { // libcis
int main(int, char**)
{
    {
        typedef int T;
...
} // libcis_ns_numerics_numarray_template_valarray_valarray_members_cshift_9fdcd17f (libcis)
