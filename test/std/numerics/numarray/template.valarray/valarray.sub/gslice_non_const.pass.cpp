// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_sub_gslice_non_const_ab8cb245).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_valarray_valarray_sub_gslice_non_const_ab8cb245 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_numerics_numarray_template_valarray_valarray_sub_gslice_non_const_ab8cb245 (libcis)
