// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_sub_indirect_array_non_const).
// main -> test_numerics_numarray_template_valarray_valarray_sub_indirect_array_non_const; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_numarray_template_valarray_valarray_sub_indirect_array_non_const()
{
    {
