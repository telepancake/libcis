// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_valarray_valarray_sub_indirect_array_non_const_0886e9e7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_valarray_valarray_sub_indirect_array_non_const_0886e9e7 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_numerics_numarray_template_valarray_valarray_sub_indirect_array_non_const_0886e9e7 (libcis)
