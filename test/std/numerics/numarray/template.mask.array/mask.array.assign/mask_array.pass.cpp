// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_template_mask_array_mask_array_assign_mask_array).
// main -> test_numerics_numarray_template_mask_array_mask_array_assign_mask_array; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_numarray_template_mask_array_mask_array_assign_mask_array()
{
    {
