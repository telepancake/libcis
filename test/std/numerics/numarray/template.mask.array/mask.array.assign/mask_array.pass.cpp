// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_mask_array_mask_array_assign_mask_array_254a0c8c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_mask_array_mask_array_assign_mask_array_254a0c8c { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_numerics_numarray_template_mask_array_mask_array_assign_mask_array_254a0c8c (libcis)
