// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_valarray_nonmembers_valarray_special_swap).
// main -> test_numerics_numarray_valarray_nonmembers_valarray_special_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_numarray_valarray_nonmembers_valarray_special_swap()
{
    {
        typedef int T;
        T a1[] = {1, 2, 3, 4, 5};
