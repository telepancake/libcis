// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_valarray_range_begin_end_d53bc9d1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_valarray_range_begin_end_d53bc9d1 { // libcis
int main(int, char**)
{
  {
    int a[] = {1, 2, 3, 4, 5};
...
} // libcis_ns_numerics_numarray_valarray_range_begin_end_d53bc9d1 (libcis)
