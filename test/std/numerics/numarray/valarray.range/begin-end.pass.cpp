// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_valarray_range_begin_end).
// main -> test_numerics_numarray_valarray_range_begin_end; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_numarray_valarray_range_begin_end()
{
  {
    int a[] = {1, 2, 3, 4, 5};
