// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_indirect_array_indirect_array_comp_assign_shift_left_9df491ff).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_indirect_array_indirect_array_comp_assign_shift_left_9df491ff { // libcis
int main(int, char**)
{
...
} // libcis_ns_numerics_numarray_template_indirect_array_indirect_array_comp_assign_shift_left_9df491ff (libcis)
