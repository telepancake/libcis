// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_template_indirect_array_indirect_array_comp_assign_shift_left).
// main -> test_numerics_numarray_template_indirect_array_indirect_array_comp_assign_shift_left; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_numarray_template_indirect_array_indirect_array_comp_assign_shift_left()
{
