// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_indirect_array_indirect_array_assign_indirect_array_ed1ac250).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_indirect_array_indirect_array_assign_indirect_array_ed1ac250 { // libcis
int main(int, char**)
{
...
} // libcis_ns_numerics_numarray_template_indirect_array_indirect_array_assign_indirect_array_ed1ac250 (libcis)
