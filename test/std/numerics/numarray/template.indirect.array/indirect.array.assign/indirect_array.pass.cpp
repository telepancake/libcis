// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_template_indirect_array_indirect_array_assign_indirect_array).
// main -> test_numerics_numarray_template_indirect_array_indirect_array_assign_indirect_array; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_numarray_template_indirect_array_indirect_array_assign_indirect_array()
{
