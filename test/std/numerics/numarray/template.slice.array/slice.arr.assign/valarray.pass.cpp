// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_template_slice_array_slice_arr_assign_valarray).
// main -> test_numerics_numarray_template_slice_array_slice_arr_assign_valarray; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_numarray_template_slice_array_slice_arr_assign_valarray()
{
