// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_slice_array_slice_arr_assign_valarray_c167741d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_slice_array_slice_arr_assign_valarray_c167741d { // libcis
int main(int, char**)
{
...
} // libcis_ns_numerics_numarray_template_slice_array_slice_arr_assign_valarray_c167741d (libcis)
