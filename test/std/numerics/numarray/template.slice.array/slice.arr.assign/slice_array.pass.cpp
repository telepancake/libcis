// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_slice_array_slice_arr_assign_slice_array_96ed4fe3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_slice_array_slice_arr_assign_slice_array_96ed4fe3 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_numerics_numarray_template_slice_array_slice_arr_assign_slice_array_96ed4fe3 (libcis)
