// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_template_gslice_array_gslice_array_assign_gslice_array).
// main -> test_numerics_numarray_template_gslice_array_gslice_array_assign_gslice_array; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_numarray_template_gslice_array_gslice_array_assign_gslice_array()
{
