// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_gslice_array_gslice_array_assign_gslice_array_5d37cd61).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_gslice_array_gslice_array_assign_gslice_array_5d37cd61 { // libcis
int main(int, char**)
{
...
} // libcis_ns_numerics_numarray_template_gslice_array_gslice_array_assign_gslice_array_5d37cd61 (libcis)
