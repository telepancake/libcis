// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_template_gslice_array_gslice_array_assign_valarray).
// main -> test_numerics_numarray_template_gslice_array_gslice_array_assign_valarray; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_numarray_template_gslice_array_gslice_array_assign_valarray()
{
