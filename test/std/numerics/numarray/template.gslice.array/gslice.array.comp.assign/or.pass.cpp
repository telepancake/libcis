// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numarray_template_gslice_array_gslice_array_comp_assign_or).
// main -> test_numerics_numarray_template_gslice_array_gslice_array_comp_assign_or; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_numarray_template_gslice_array_gslice_array_comp_assign_or()
{
