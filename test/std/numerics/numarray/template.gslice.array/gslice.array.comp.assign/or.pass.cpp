// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_gslice_array_gslice_array_comp_assign_or_5b5f12e2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_gslice_array_gslice_array_comp_assign_or_5b5f12e2 { // libcis
int main(int, char**)
{
...
} // libcis_ns_numerics_numarray_template_gslice_array_gslice_array_comp_assign_or_5b5f12e2 (libcis)
