// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numarray_template_gslice_array_gslice_array_comp_assign_shift_left_45a3e9bb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numarray_template_gslice_array_gslice_array_comp_assign_shift_left_45a3e9bb { // libcis
int main(int, char**)
{
...
} // libcis_ns_numerics_numarray_template_gslice_array_gslice_array_comp_assign_shift_left_45a3e9bb (libcis)
