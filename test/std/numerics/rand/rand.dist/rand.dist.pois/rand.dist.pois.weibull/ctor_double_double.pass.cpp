// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_pois_rand_dist_pois_weibull_ctor_double_double_cb56d870).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_pois_rand_dist_pois_weibull_ctor_double_double_cb56d870 { // libcis
template <class T>
void test_implicit() {
#if TEST_STD_VER >= 11
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_pois_rand_dist_pois_weibull_ctor_double_double_cb56d870 (libcis)
