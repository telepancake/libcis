// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_pois_rand_dist_pois_extreme_ctor_double_double_1f1b59f5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_pois_rand_dist_pois_extreme_ctor_double_double_1f1b59f5 { // libcis
template <class T>
void test_implicit() {
#if TEST_STD_VER >= 11
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_pois_rand_dist_pois_extreme_ctor_double_double_1f1b59f5 (libcis)
