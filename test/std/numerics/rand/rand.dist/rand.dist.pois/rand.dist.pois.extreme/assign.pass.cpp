...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_pois_rand_dist_pois_extreme_assign { // libcis: isolate file-scope helpers
void
test1()
{
...
} using namespace libcis_ns_numerics_rand_rand_dist_rand_dist_pois_rand_dist_pois_extreme_assign; // libcis
