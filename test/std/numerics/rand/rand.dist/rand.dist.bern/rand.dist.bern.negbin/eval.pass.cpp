// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_negbin_eval_b355068a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_negbin_eval_b355068a { // libcis
template <class T>
T sqr(T x) {
    return x * x;
}
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_negbin_eval_b355068a (libcis)
