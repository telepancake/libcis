// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_negbin_ctor_int_double_b8ac16e9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_negbin_ctor_int_double_b8ac16e9 { // libcis
template <class T>
void test_implicit() {
#if TEST_STD_VER >= 11
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_negbin_ctor_int_double_b8ac16e9 (libcis)
