// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_bin_eval_08697ac4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_bin_eval_08697ac4 { // libcis
template <class T>
T sqr(T x) {
    return x * x;
}
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_bin_eval_08697ac4 (libcis)
