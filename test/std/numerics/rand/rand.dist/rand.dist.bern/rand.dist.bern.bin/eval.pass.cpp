// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_bin_eval).
// main -> test_numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_bin_eval; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_bin_eval { // libcis: isolate file-scope helpers
template <class T>
T sqr(T x) {
    return x * x;
}
...
} using namespace libcis_ns_numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_bin_eval; // libcis


void test_numerics_rand_rand_dist_rand_dist_bern_rand_dist_bern_bin_eval() {
    tests<short>();
    tests<int>();
    tests<long>();
    tests<long long>();
