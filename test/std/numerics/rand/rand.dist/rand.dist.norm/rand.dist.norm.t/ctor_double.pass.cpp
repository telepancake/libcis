...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_t_ctor_double { // libcis: isolate file-scope helpers
template <class T>
void test_implicit() {
#if TEST_STD_VER >= 11
...
} using namespace libcis_ns_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_t_ctor_double; // libcis
