...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_t_assign { // libcis: isolate file-scope helpers
void
test1()
{
...
} using namespace libcis_ns_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_t_assign; // libcis
