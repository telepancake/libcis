// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_lognormal_eval).
// main -> test_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_lognormal_eval; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_lognormal_eval { // libcis: isolate file-scope helpers
template <class T>
inline
T
sqr(T x)
...
} using namespace libcis_ns_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_lognormal_eval; // libcis


void test_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_lognormal_eval()
{
    test1();
    test2();
    test3();
