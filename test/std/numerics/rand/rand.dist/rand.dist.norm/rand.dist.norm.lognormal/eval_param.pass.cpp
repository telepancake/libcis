// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_lognormal_eval_param_659ee766).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_lognormal_eval_param_659ee766 { // libcis
template <class T>
inline
T
sqr(T x)
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_lognormal_eval_param_659ee766 (libcis)
