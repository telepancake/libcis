// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_cauchy_ctor_double_double_1393509e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_cauchy_ctor_double_double_1393509e { // libcis
template <class T>
void test_implicit() {
#if TEST_STD_VER >= 11
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_cauchy_ctor_double_double_1393509e (libcis)
