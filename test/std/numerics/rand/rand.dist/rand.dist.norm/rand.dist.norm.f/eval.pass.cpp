// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_f_eval_9edf0b20).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_f_eval_9edf0b20 { // libcis
double fac(double x)
{
    double r = 1;
    for (; x > 1; --x)
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_norm_rand_dist_norm_f_eval_9edf0b20 (libcis)
