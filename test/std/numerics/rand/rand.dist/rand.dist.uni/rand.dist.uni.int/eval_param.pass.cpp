...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_int_eval_param { // libcis: isolate file-scope helpers
template <class T>
inline
T
sqr(T x)
...
} using namespace libcis_ns_numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_int_eval_param; // libcis
