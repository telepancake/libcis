// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_int_ctor_int_int).
// main -> test_numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_int_ctor_int_int; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
