// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_int_ctor_int_int_5c506863).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_int_ctor_int_int_5c506863 { // libcis
template <class T>
void test_implicit() {
#if TEST_STD_VER >= 11
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_int_ctor_int_int_5c506863 (libcis)
