// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_int_eval_e0100a94).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_int_eval_e0100a94 { // libcis
template <class T>
T sqr(T x) {
    return x * x;
}
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_int_eval_e0100a94 (libcis)
