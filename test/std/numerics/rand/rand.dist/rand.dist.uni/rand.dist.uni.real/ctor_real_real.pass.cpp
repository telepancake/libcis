// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_real_ctor_real_real_ee826f94).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_real_ctor_real_real_ee826f94 { // libcis
template <class T>
void test_implicit() {
#if TEST_STD_VER >= 11
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_real_ctor_real_real_ee826f94 (libcis)
