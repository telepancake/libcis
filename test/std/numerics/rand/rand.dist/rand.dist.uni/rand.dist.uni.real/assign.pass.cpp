...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_real_assign { // libcis: isolate file-scope helpers
void
test1()
{
...
} using namespace libcis_ns_numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_real_assign; // libcis
