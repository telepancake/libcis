// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_real_eval_4ff41f32).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_real_eval_4ff41f32 { // libcis
template <class T>
inline
T
sqr(T x)
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_uni_rand_dist_uni_real_eval_4ff41f32 (libcis)
