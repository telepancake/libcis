// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_samp_rand_dist_samp_pconst_eval_param_1977c73e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_samp_rand_dist_samp_pconst_eval_param_1977c73e { // libcis
template <class T>
inline
T
sqr(T x)
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_samp_rand_dist_samp_pconst_eval_param_1977c73e (libcis)
