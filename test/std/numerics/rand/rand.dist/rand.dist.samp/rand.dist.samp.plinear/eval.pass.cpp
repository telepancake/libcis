// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_samp_rand_dist_samp_plinear_eval_d6f2ee41).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_samp_rand_dist_samp_plinear_eval_d6f2ee41 { // libcis
template <class T>
inline
T
sqr(T x)
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_samp_rand_dist_samp_plinear_eval_d6f2ee41 (libcis)
