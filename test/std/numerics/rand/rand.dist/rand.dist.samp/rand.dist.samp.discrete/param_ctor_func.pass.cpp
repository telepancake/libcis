// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_samp_rand_dist_samp_discrete_param_ctor_func).
// main -> test_numerics_rand_rand_dist_rand_dist_samp_rand_dist_samp_discrete_param_ctor_func; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
