// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_dist_rand_dist_samp_rand_dist_samp_discrete_eval_d6d8e982).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_dist_rand_dist_samp_rand_dist_samp_discrete_eval_d6d8e982 { // libcis
template <class T>
void tests() {
...
} // libcis_ns_numerics_rand_rand_dist_rand_dist_samp_rand_dist_samp_discrete_eval_d6d8e982 (libcis)
