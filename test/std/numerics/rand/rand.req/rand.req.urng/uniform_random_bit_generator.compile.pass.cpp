// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_req_rand_req_urng_uniform_random_bit_generator_cc2235c4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_req_rand_req_urng_uniform_random_bit_generator_cc2235c4 { // libcis
...
} // libcis_ns_numerics_rand_rand_req_rand_req_urng_uniform_random_bit_generator_cc2235c4 (libcis)
