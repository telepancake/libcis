// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_lcong_values_3a3067c0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_values_3a3067c0 { // libcis
template <class T>
void where(const T &) {}
...
} // libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_values_3a3067c0 (libcis)
