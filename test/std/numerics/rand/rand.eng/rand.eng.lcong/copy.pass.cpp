// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_lcong_copy).
// main -> test_numerics_rand_rand_eng_rand_eng_lcong_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_copy { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_copy; // libcis


void test_numerics_rand_rand_eng_rand_eng_lcong_copy()
{
    test<unsigned short>();
