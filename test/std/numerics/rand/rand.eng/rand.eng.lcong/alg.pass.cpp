// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_lcong_alg_5937f38c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_alg_5937f38c { // libcis
int main(int, char**)
{
...
} // libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_alg_5937f38c (libcis)
