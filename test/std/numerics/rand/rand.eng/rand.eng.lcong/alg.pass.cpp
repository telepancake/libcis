// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_lcong_alg).
// main -> test_numerics_rand_rand_eng_rand_eng_lcong_alg; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_rand_rand_eng_rand_eng_lcong_alg()
{
