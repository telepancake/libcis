// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_lcong_default).
// main -> test_numerics_rand_rand_eng_rand_eng_lcong_default; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_default { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_default; // libcis


void test_numerics_rand_rand_eng_rand_eng_lcong_default()
{
    test<unsigned short>();
