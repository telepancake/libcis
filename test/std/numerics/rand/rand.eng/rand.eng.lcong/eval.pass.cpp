// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_lcong_eval_fdcda68d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_eval_fdcda68d { // libcis
template <class T>
void
randu()
{
...
} // libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_eval_fdcda68d (libcis)
