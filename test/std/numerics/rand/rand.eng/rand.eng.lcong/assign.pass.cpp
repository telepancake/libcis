// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_lcong_assign_e302c2f6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_assign_e302c2f6 { // libcis
...
} // libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_assign_e302c2f6 (libcis)
