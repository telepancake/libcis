// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_lcong_discard_ae41020b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_discard_ae41020b { // libcis
template <class T>
void
rand0()
{
...
} // libcis_ns_numerics_rand_rand_eng_rand_eng_lcong_discard_ae41020b (libcis)
