// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_mers_result_type).
// main -> test_numerics_rand_rand_eng_rand_eng_mers_result_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
