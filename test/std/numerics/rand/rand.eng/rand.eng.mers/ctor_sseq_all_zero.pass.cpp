// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_mers_ctor_sseq_all_zero).
// main -> test_numerics_rand_rand_eng_rand_eng_mers_ctor_sseq_all_zero; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
