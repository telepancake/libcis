// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_mers_ctor_sseq_all_zero_5b158965).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_eng_rand_eng_mers_ctor_sseq_all_zero_5b158965 { // libcis
...
} // libcis_ns_numerics_rand_rand_eng_rand_eng_mers_ctor_sseq_all_zero_5b158965 (libcis)
