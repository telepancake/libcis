// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_mers_values_922baa2d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_eng_rand_eng_mers_values_922baa2d { // libcis
template <class T>
void where(const T &) {}
...
} // libcis_ns_numerics_rand_rand_eng_rand_eng_mers_values_922baa2d (libcis)
