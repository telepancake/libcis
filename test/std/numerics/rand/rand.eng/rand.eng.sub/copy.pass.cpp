...
namespace libcis_ns_numerics_rand_rand_eng_rand_eng_sub_copy { // libcis: isolate file-scope helpers
void
test1()
{
...
} using namespace libcis_ns_numerics_rand_rand_eng_rand_eng_sub_copy; // libcis
