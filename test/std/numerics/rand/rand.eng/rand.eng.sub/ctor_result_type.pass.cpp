// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_sub_ctor_result_type_7ce99901).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_eng_rand_eng_sub_ctor_result_type_7ce99901 { // libcis
template <class T>
std::string
to_string(T const &e)
{
...
} // libcis_ns_numerics_rand_rand_eng_rand_eng_sub_ctor_result_type_7ce99901 (libcis)
