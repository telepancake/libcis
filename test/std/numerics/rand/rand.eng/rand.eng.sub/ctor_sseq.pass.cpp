// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_sub_ctor_sseq_e0ccabd4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_eng_rand_eng_sub_ctor_sseq_e0ccabd4 { // libcis
void
test1()
{
...
} // libcis_ns_numerics_rand_rand_eng_rand_eng_sub_ctor_sseq_e0ccabd4 (libcis)
