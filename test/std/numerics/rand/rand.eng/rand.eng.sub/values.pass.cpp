// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_eng_rand_eng_sub_values_70a507bb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_eng_rand_eng_sub_values_70a507bb { // libcis
template <class T>
void where(const T &) {}
...
} // libcis_ns_numerics_rand_rand_eng_rand_eng_sub_values_70a507bb (libcis)
