// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_util_rand_util_seedseq_iterator).
// main -> test_numerics_rand_rand_util_rand_util_seedseq_iterator; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
