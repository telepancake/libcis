// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_util_rand_util_seedseq_iterator_adbac686).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_util_rand_util_seedseq_iterator_adbac686 { // libcis
void test()
{
  {
...
} // libcis_ns_numerics_rand_rand_util_rand_util_seedseq_iterator_adbac686 (libcis)
