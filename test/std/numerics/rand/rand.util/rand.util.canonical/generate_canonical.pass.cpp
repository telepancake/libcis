// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_util_rand_util_canonical_generate_canonical).
// main -> test_numerics_rand_rand_util_rand_util_canonical_generate_canonical; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_rand_rand_util_rand_util_canonical_generate_canonical()
{
    {
