// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_util_rand_util_canonical_generate_canonical_2fbfcdc0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_util_rand_util_canonical_generate_canonical_2fbfcdc0 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_numerics_rand_rand_util_rand_util_canonical_generate_canonical_2fbfcdc0 (libcis)
