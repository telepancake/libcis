// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_device_eval_ab1bc508).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_device_eval_ab1bc508 { // libcis
int main(int, char**)
{
    {
        std::random_device r;
...
} // libcis_ns_numerics_rand_rand_device_eval_ab1bc508 (libcis)
