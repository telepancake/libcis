// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_device_eval).
// main -> test_numerics_rand_rand_device_eval; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_rand_rand_device_eval()
{
    {
        std::random_device r;
