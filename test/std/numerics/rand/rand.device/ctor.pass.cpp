// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_device_ctor_354e5832).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_device_ctor_354e5832 { // libcis
...
} // libcis_ns_numerics_rand_rand_device_ctor_354e5832 (libcis)
