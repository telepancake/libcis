// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_device_ctor).
// main -> test_numerics_rand_rand_device_ctor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
