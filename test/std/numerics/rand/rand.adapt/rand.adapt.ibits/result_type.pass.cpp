...
namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_ibits_result_type { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_ibits_result_type; // libcis
