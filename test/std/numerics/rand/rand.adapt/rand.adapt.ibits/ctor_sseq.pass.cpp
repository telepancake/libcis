// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_adapt_rand_adapt_ibits_ctor_sseq_dba4ded9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_ibits_ctor_sseq_dba4ded9 { // libcis
void
test1()
{
...
} // libcis_ns_numerics_rand_rand_adapt_rand_adapt_ibits_ctor_sseq_dba4ded9 (libcis)
