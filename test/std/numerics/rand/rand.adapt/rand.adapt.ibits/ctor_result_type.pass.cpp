// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_adapt_rand_adapt_ibits_ctor_result_type).
// main -> test_numerics_rand_rand_adapt_rand_adapt_ibits_ctor_result_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_ibits_ctor_result_type { // libcis: isolate file-scope helpers
void
test1()
{
...
} using namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_ibits_ctor_result_type; // libcis


void test_numerics_rand_rand_adapt_rand_adapt_ibits_ctor_result_type()
{
    test1();
    test2();
