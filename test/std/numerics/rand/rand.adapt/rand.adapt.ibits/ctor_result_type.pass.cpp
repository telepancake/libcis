// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_adapt_rand_adapt_ibits_ctor_result_type_62790d3d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_ibits_ctor_result_type_62790d3d { // libcis
void
test1()
{
...
} // libcis_ns_numerics_rand_rand_adapt_rand_adapt_ibits_ctor_result_type_62790d3d (libcis)
