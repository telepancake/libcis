// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_adapt_rand_adapt_ibits_values_2b8e49a8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_ibits_values_2b8e49a8 { // libcis
void
test1()
{
...
} // libcis_ns_numerics_rand_rand_adapt_rand_adapt_ibits_values_2b8e49a8 (libcis)
