// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_adapt_rand_adapt_ibits_eval_bd1ba1e1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_ibits_eval_bd1ba1e1 { // libcis
...
} // libcis_ns_numerics_rand_rand_adapt_rand_adapt_ibits_eval_bd1ba1e1 (libcis)
