// AST-transferred from libc++ by tools/transfer.py (slug=numerics_rand_rand_adapt_rand_adapt_disc_ctor_sseq).
// main -> test_numerics_rand_rand_adapt_rand_adapt_disc_ctor_sseq; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_disc_ctor_sseq { // libcis: isolate file-scope helpers
void
test1()
{
...
} using namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_disc_ctor_sseq; // libcis


void test_numerics_rand_rand_adapt_rand_adapt_disc_ctor_sseq()
{
    test1();
    test2();
