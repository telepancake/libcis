...
namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_disc_eval { // libcis: isolate file-scope helpers
void
test1()
{
    std::ranlux24 e;
...
} using namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_disc_eval; // libcis
