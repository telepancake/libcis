...
namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_disc_seed_sseq { // libcis: isolate file-scope helpers
void
test1()
{
    unsigned a[] = {3, 5, 7};
...
} using namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_disc_seed_sseq; // libcis
