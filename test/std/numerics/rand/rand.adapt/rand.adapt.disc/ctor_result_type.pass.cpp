// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_adapt_rand_adapt_disc_ctor_result_type_b7e32033).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_disc_ctor_result_type_b7e32033 { // libcis
void
test1()
{
...
} // libcis_ns_numerics_rand_rand_adapt_rand_adapt_disc_ctor_result_type_b7e32033 (libcis)
