// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_rand_rand_adapt_rand_adapt_shuf_eval_5ede6021).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_shuf_eval_5ede6021 { // libcis
...
} // libcis_ns_numerics_rand_rand_adapt_rand_adapt_shuf_eval_5ede6021 (libcis)
