...
namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_shuf_seed_result_type { // libcis: isolate file-scope helpers
void
test1()
{
    for (int s = 0; s < 20; ++s)
...
} using namespace libcis_ns_numerics_rand_rand_adapt_rand_adapt_shuf_seed_result_type; // libcis
