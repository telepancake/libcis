// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bitops_count_countl_zero_b9d2cfd4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bitops_count_countl_zero_b9d2cfd4 { // libcis
struct A {};
...
} // libcis_ns_numerics_bit_bitops_count_countl_zero_b9d2cfd4 (libcis)
