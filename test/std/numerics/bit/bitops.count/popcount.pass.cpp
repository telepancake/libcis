// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bitops_count_popcount_56d00aeb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bitops_count_popcount_56d00aeb { // libcis
struct A {};
...
} // libcis_ns_numerics_bit_bitops_count_popcount_56d00aeb (libcis)
