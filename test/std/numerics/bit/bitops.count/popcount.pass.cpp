// AST-transferred from libc++ by tools/transfer.py (slug=numerics_bit_bitops_count_popcount).
// main -> test_numerics_bit_bitops_count_popcount; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bitops_count_popcount { // libcis: isolate file-scope helpers
struct A {};
...
} using namespace libcis_ns_numerics_bit_bitops_count_popcount; // libcis


void test_numerics_bit_bitops_count_popcount()
{
    {
