// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bitops_count_countr_one_16944be8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bitops_count_countr_one_16944be8 { // libcis
struct A {};
...
} // libcis_ns_numerics_bit_bitops_count_countr_one_16944be8 (libcis)
