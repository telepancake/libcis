// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bitops_count_countr_zero_2fe345e9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bitops_count_countr_zero_2fe345e9 { // libcis
struct A {};
...
} // libcis_ns_numerics_bit_bitops_count_countr_zero_2fe345e9 (libcis)
