// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bitops_count_countl_one_09183254).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bitops_count_countl_one_09183254 { // libcis
struct A {};
...
} // libcis_ns_numerics_bit_bitops_count_countl_one_09183254 (libcis)
