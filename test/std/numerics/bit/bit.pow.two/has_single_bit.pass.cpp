// AST-transferred from libc++ by tools/transfer.py (slug=numerics_bit_bit_pow_two_has_single_bit).
// main -> test_numerics_bit_bit_pow_two_has_single_bit; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
