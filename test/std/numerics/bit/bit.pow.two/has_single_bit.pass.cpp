// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bit_pow_two_has_single_bit_c517f04c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bit_pow_two_has_single_bit_c517f04c { // libcis
struct A {};
...
} // libcis_ns_numerics_bit_bit_pow_two_has_single_bit_c517f04c (libcis)
