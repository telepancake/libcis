// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bit_pow_two_bit_ceil_7add0cb4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bit_pow_two_bit_ceil_7add0cb4 { // libcis
struct A {};
...
} // libcis_ns_numerics_bit_bit_pow_two_bit_ceil_7add0cb4 (libcis)
