// AST-transferred from libc++ by tools/transfer.py (slug=numerics_bit_bit_pow_two_bit_ceil).
// main -> test_numerics_bit_bit_pow_two_bit_ceil; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bit_pow_two_bit_ceil { // libcis: isolate file-scope helpers
struct A {};
...
} using namespace libcis_ns_numerics_bit_bit_pow_two_bit_ceil; // libcis


void test_numerics_bit_bit_pow_two_bit_ceil()
{
    {
