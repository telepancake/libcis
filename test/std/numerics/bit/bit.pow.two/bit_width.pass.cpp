// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bit_pow_two_bit_width_cf49a4bb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bit_pow_two_bit_width_cf49a4bb { // libcis
struct A {};
...
} // libcis_ns_numerics_bit_bit_pow_two_bit_width_cf49a4bb (libcis)
