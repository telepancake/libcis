// AST-transferred from libc++ by tools/transfer.py (slug=numerics_bit_bit_pow_two_bit_floor).
// main -> test_numerics_bit_bit_pow_two_bit_floor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
