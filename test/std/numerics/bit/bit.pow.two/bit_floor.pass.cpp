// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bit_pow_two_bit_floor_2afac37b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bit_pow_two_bit_floor_2afac37b { // libcis
struct A {};
...
} // libcis_ns_numerics_bit_bit_pow_two_bit_floor_2afac37b (libcis)
