// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bitops_rot_rotl_6995572c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bitops_rot_rotl_6995572c { // libcis
struct A {};
...
} // libcis_ns_numerics_bit_bitops_rot_rotl_6995572c (libcis)
