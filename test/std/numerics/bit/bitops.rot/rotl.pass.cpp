// AST-transferred from libc++ by tools/transfer.py (slug=numerics_bit_bitops_rot_rotl).
// main -> test_numerics_bit_bitops_rot_rotl; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
