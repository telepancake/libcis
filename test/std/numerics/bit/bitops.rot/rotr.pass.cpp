// AST-transferred from libc++ by tools/transfer.py (slug=numerics_bit_bitops_rot_rotr).
// main -> test_numerics_bit_bitops_rot_rotr; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bitops_rot_rotr { // libcis: isolate file-scope helpers
struct A {};
...
} using namespace libcis_ns_numerics_bit_bitops_rot_rotr; // libcis


void test_numerics_bit_bitops_rot_rotr()
{
    {
