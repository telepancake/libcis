// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bitops_rot_rotr_de26adf5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bitops_rot_rotr_de26adf5 { // libcis
struct A {};
...
} // libcis_ns_numerics_bit_bitops_rot_rotr_de26adf5 (libcis)
