// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bit_cast_bit_cast_9faade91).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bit_cast_bit_cast_9faade91 { // libcis
...
} // libcis_ns_numerics_bit_bit_cast_bit_cast_9faade91 (libcis)
