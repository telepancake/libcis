// AST-transferred from libc++ by tools/transfer.py (slug=numerics_bit_bit_cast_bit_cast).
// main -> test_numerics_bit_bit_cast_bit_cast; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
