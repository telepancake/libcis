// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bit_cast_bit_cast_837c783e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bit_cast_bit_cast_837c783e { // libcis
template<class To, class From>
...
} // libcis_ns_numerics_bit_bit_cast_bit_cast_837c783e (libcis)
