// AST-transferred from libc++ by tools/transfer.py (slug=numerics_bit_byteswap).
// main -> test_numerics_bit_byteswap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
