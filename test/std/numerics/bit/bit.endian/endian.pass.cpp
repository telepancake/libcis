// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_bit_bit_endian_endian_d6441919).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_bit_bit_endian_endian_d6441919 { // libcis
int main(int, char**) {
...
} // libcis_ns_numerics_bit_bit_endian_endian_d6441919 (libcis)
