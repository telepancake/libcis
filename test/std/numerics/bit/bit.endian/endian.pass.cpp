// AST-transferred from libc++ by tools/transfer.py (slug=numerics_bit_bit_endian_endian).
// main -> test_numerics_bit_bit_endian_endian; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_bit_bit_endian_endian() {
