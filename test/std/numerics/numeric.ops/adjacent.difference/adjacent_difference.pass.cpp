// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_adjacent_difference_adjacent_difference_4899aed0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_adjacent_difference_adjacent_difference_4899aed0 { // libcis
...
} // libcis_ns_numerics_numeric_ops_adjacent_difference_adjacent_difference_4899aed0 (libcis)
