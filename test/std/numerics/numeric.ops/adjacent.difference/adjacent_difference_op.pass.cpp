// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numeric_ops_adjacent_difference_adjacent_difference_op).
// main -> test_numerics_numeric_ops_adjacent_difference_adjacent_difference_op; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
