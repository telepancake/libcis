// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_exclusive_scan_exclusive_scan_24a37103).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_exclusive_scan_exclusive_scan_24a37103 { // libcis
...
} // libcis_ns_numerics_numeric_ops_exclusive_scan_exclusive_scan_24a37103 (libcis)
