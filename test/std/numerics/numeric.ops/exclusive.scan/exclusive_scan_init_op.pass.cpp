// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numeric_ops_exclusive_scan_exclusive_scan_init_op).
// main -> test_numerics_numeric_ops_exclusive_scan_exclusive_scan_init_op; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
