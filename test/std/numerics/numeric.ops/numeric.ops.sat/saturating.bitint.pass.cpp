// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numeric_ops_numeric_ops_sat_saturating_bitint).
// main -> test_numerics_numeric_ops_numeric_ops_sat_saturating_bitint; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_numeric_ops_numeric_ops_sat_saturating_bitint() {
#if TEST_HAS_EXTENSION(bit_int)
  test();
  static_assert(test());
#endif
