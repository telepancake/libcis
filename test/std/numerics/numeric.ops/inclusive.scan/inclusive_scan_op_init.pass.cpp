// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_inclusive_scan_inclusive_scan_op_init_6ae69241).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_inclusive_scan_inclusive_scan_op_init_6ae69241 { // libcis
...
} // libcis_ns_numerics_numeric_ops_inclusive_scan_inclusive_scan_op_init_6ae69241 (libcis)
