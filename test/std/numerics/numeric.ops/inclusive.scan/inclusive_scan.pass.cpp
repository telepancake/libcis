// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_inclusive_scan_inclusive_scan_1af6f0b8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_inclusive_scan_inclusive_scan_1af6f0b8 { // libcis
...
} // libcis_ns_numerics_numeric_ops_inclusive_scan_inclusive_scan_1af6f0b8 (libcis)
