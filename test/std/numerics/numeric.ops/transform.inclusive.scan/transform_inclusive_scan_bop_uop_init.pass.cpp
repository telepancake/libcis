// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numeric_ops_transform_inclusive_scan_transform_inclusive_scan_bop_uop_init).
// main -> test_numerics_numeric_ops_transform_inclusive_scan_transform_inclusive_scan_bop_uop_init; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
