// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_transform_inclusive_scan_transform_inclusive_scan_bop_uop_77c8e189).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_transform_inclusive_scan_transform_inclusive_scan_bop_uop_77c8e189 { // libcis
struct add_one {
    template <typename T>
...
} // libcis_ns_numerics_numeric_ops_transform_inclusive_scan_transform_inclusive_scan_bop_uop_77c8e189 (libcis)
