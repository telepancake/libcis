// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numeric_ops_transform_inclusive_scan_transform_inclusive_scan_bop_uop).
// main -> test_numerics_numeric_ops_transform_inclusive_scan_transform_inclusive_scan_bop_uop; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_transform_inclusive_scan_transform_inclusive_scan_bop_uop { // libcis: isolate file-scope helpers
struct add_one {
    template <typename T>
...
} using namespace libcis_ns_numerics_numeric_ops_transform_inclusive_scan_transform_inclusive_scan_bop_uop; // libcis


void test_numerics_numeric_ops_transform_inclusive_scan_transform_inclusive_scan_bop_uop()
{
    test();
#if TEST_STD_VER > 17
    static_assert(test());
