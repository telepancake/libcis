// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_partial_sum_partial_sum_op_93329162).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_partial_sum_partial_sum_op_93329162 { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_numerics_numeric_ops_partial_sum_partial_sum_op_93329162 (libcis)
