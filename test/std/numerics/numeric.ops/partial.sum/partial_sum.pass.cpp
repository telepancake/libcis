// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numeric_ops_partial_sum_partial_sum).
// main -> test_numerics_numeric_ops_partial_sum_partial_sum; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_partial_sum_partial_sum { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_numerics_numeric_ops_partial_sum_partial_sum; // libcis


void test_numerics_numeric_ops_partial_sum_partial_sum()
{
    test();
#if TEST_STD_VER > 17
    static_assert(test());
