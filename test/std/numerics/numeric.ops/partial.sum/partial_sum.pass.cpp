// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_partial_sum_partial_sum_e7237ee3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_partial_sum_partial_sum_e7237ee3 { // libcis
...
} // libcis_ns_numerics_numeric_ops_partial_sum_partial_sum_e7237ee3 (libcis)
