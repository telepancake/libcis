// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_transform_exclusive_scan_transform_exclusive_scan_init_bop_uop_181c1bc2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_transform_exclusive_scan_transform_exclusive_scan_init_bop_uop_181c1bc2 { // libcis
struct add_one {
    template <typename T>
...
} // libcis_ns_numerics_numeric_ops_transform_exclusive_scan_transform_exclusive_scan_init_bop_uop_181c1bc2 (libcis)
