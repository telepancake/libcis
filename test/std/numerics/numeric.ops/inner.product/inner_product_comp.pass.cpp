// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_inner_product_inner_product_comp_1774acff).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_inner_product_inner_product_comp_1774acff { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_numerics_numeric_ops_inner_product_inner_product_comp_1774acff (libcis)
