// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numeric_ops_inner_product_inner_product).
// main -> test_numerics_numeric_ops_inner_product_inner_product; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
