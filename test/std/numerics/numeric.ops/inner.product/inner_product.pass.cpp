// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_inner_product_inner_product_0ee6518d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_inner_product_inner_product_0ee6518d { // libcis
...
} // libcis_ns_numerics_numeric_ops_inner_product_inner_product_0ee6518d (libcis)
