// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numeric_ops_numeric_ops_gcd_gcd).
// main -> test_numerics_numeric_ops_numeric_ops_gcd_gcd; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
