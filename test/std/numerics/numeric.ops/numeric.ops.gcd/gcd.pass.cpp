// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_numeric_ops_gcd_gcd_2ac713c5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_numeric_ops_gcd_gcd_2ac713c5 { // libcis
constexpr struct {
  int x;
  int y;
  int expect;
...
} // libcis_ns_numerics_numeric_ops_numeric_ops_gcd_gcd_2ac713c5 (libcis)
