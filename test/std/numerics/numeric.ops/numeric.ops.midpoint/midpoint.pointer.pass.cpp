// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_numeric_ops_midpoint_midpoint_pointer_f301c280).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_numeric_ops_midpoint_midpoint_pointer_f301c280 { // libcis
template <typename T>
...
} // libcis_ns_numerics_numeric_ops_numeric_ops_midpoint_midpoint_pointer_f301c280 (libcis)
