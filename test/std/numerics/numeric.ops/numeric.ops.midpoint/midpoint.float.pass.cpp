// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_numeric_ops_midpoint_midpoint_float_09470924).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_numeric_ops_midpoint_midpoint_float_09470924 { // libcis
template <typename T>
...
} // libcis_ns_numerics_numeric_ops_numeric_ops_midpoint_midpoint_float_09470924 (libcis)
