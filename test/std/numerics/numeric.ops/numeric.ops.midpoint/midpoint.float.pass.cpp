// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numeric_ops_numeric_ops_midpoint_midpoint_float).
// main -> test_numerics_numeric_ops_numeric_ops_midpoint_midpoint_float; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
