// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_numeric_ops_midpoint_midpoint_integer_a1cf0dcf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_numeric_ops_midpoint_midpoint_integer_a1cf0dcf { // libcis
template <typename T>
void signed_test()
{
    constexpr T zero{0};
...
} // libcis_ns_numerics_numeric_ops_numeric_ops_midpoint_midpoint_integer_a1cf0dcf (libcis)
