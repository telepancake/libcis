// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_transform_reduce_transform_reduce_iter_iter_init_bop_uop_cea326af).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_transform_reduce_transform_reduce_iter_iter_init_bop_uop_cea326af { // libcis
struct identity
{
    template <class T>
...
} // libcis_ns_numerics_numeric_ops_transform_reduce_transform_reduce_iter_iter_init_bop_uop_cea326af (libcis)
