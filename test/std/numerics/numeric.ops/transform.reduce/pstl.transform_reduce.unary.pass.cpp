// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_transform_reduce_pstl_transform_reduce_unary_d3a584db).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_transform_reduce_pstl_transform_reduce_unary_d3a584db { // libcis
...
} // libcis_ns_numerics_numeric_ops_transform_reduce_pstl_transform_reduce_unary_d3a584db (libcis)
