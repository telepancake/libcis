// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_transform_reduce_pstl_transform_reduce_binary_b0160404).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_transform_reduce_pstl_transform_reduce_binary_b0160404 { // libcis
template <class T>
...
} // libcis_ns_numerics_numeric_ops_transform_reduce_pstl_transform_reduce_binary_b0160404 (libcis)
