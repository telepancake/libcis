// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numeric_ops_transform_reduce_transform_reduce_iter_iter_iter_init_op_op).
// main -> test_numerics_numeric_ops_transform_reduce_transform_reduce_iter_iter_iter_init_op_op; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
