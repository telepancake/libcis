// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_transform_reduce_transform_reduce_iter_iter_iter_init_op_op_df119de0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_transform_reduce_transform_reduce_iter_iter_iter_init_op_op_df119de0 { // libcis
...
} // libcis_ns_numerics_numeric_ops_transform_reduce_transform_reduce_iter_iter_iter_init_op_op_df119de0 (libcis)
