// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_accumulate_accumulate_op_c240ffc3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_accumulate_accumulate_op_c240ffc3 { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_numerics_numeric_ops_accumulate_accumulate_op_c240ffc3 (libcis)
