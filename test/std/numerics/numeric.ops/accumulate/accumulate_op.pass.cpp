// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numeric_ops_accumulate_accumulate_op).
// main -> test_numerics_numeric_ops_accumulate_accumulate_op; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER > 17
namespace libcis_ns_numerics_numeric_ops_accumulate_accumulate_op { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_numerics_numeric_ops_accumulate_accumulate_op; // libcis


void test_numerics_numeric_ops_accumulate_accumulate_op()
{
    test();
#if TEST_STD_VER > 17
    static_assert(test());
