// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_accumulate_accumulate_12b6d2d4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_accumulate_accumulate_12b6d2d4 { // libcis
...
} // libcis_ns_numerics_numeric_ops_accumulate_accumulate_12b6d2d4 (libcis)
