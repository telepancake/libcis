// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numeric_ops_numeric_ops_lcm_lcm).
// main -> test_numerics_numeric_ops_numeric_ops_lcm_lcm; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
