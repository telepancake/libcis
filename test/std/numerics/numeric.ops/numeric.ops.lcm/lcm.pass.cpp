// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_numeric_ops_lcm_lcm_1b4fe213).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_numeric_ops_lcm_lcm_1b4fe213 { // libcis
constexpr struct {
  int x;
  int y;
  int expect;
...
} // libcis_ns_numerics_numeric_ops_numeric_ops_lcm_lcm_1b4fe213 (libcis)
