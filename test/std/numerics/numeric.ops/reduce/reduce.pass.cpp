// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_reduce_reduce_a1b4ea53).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_reduce_reduce_a1b4ea53 { // libcis
...
} // libcis_ns_numerics_numeric_ops_reduce_reduce_a1b4ea53 (libcis)
