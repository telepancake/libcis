// AST-transferred from libc++ by tools/transfer.py (slug=numerics_numeric_ops_reduce_reduce).
// main -> test_numerics_numeric_ops_reduce_reduce; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_reduce_reduce { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_numerics_numeric_ops_reduce_reduce; // libcis


void test_numerics_numeric_ops_reduce_reduce()
{
    test();
#if TEST_STD_VER > 17
    static_assert(test());
