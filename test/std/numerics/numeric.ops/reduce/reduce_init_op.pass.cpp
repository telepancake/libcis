// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_reduce_reduce_init_op_74f8fd9c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_reduce_reduce_init_op_74f8fd9c { // libcis
...
} // libcis_ns_numerics_numeric_ops_reduce_reduce_init_op_74f8fd9c (libcis)
