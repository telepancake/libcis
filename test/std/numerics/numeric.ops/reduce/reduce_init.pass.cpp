// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_reduce_reduce_init_213cbf77).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_reduce_reduce_init_213cbf77 { // libcis
...
} // libcis_ns_numerics_numeric_ops_reduce_reduce_init_213cbf77 (libcis)
