// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_numeric_ops_reduce_pstl_reduce_d36408af).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_numeric_ops_reduce_pstl_reduce_d36408af { // libcis
...
} // libcis_ns_numerics_numeric_ops_reduce_pstl_reduce_d36408af (libcis)
