// AST-transferred from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_transcendentals_atanh).
// main -> test_numerics_complex_number_complex_transcendentals_atanh; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_transcendentals_atanh { // libcis: isolate file-scope helpers
template <class T>
void
...
} using namespace libcis_ns_numerics_complex_number_complex_transcendentals_atanh; // libcis


void test_numerics_complex_number_complex_transcendentals_atanh()
{
    test<float>();
    test<double>();
    test<long double>();
