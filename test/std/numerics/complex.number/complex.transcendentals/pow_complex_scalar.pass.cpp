...
namespace libcis_ns_numerics_complex_number_complex_transcendentals_pow_complex_scalar { // libcis: isolate file-scope helpers
template <class T>
void
...
} using namespace libcis_ns_numerics_complex_number_complex_transcendentals_pow_complex_scalar; // libcis
