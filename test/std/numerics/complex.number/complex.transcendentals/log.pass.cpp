// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_transcendentals_log_886926a4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_transcendentals_log_886926a4 { // libcis
template <class T>
void
...
} // libcis_ns_numerics_complex_number_complex_transcendentals_log_886926a4 (libcis)
