// AST-transferred from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_transcendentals_log).
// main -> test_numerics_complex_number_complex_transcendentals_log; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
