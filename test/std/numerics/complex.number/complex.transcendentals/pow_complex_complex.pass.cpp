// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_transcendentals_pow_complex_complex_22e9ee9e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_transcendentals_pow_complex_complex_22e9ee9e { // libcis
template <class T>
void
...
} // libcis_ns_numerics_complex_number_complex_transcendentals_pow_complex_complex_22e9ee9e (libcis)
