// AST-transferred from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_transcendentals_pow_complex_complex).
// main -> test_numerics_complex_number_complex_transcendentals_pow_complex_complex; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
