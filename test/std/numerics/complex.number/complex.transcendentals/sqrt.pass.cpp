// AST-transferred from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_transcendentals_sqrt).
// main -> test_numerics_complex_number_complex_transcendentals_sqrt; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_transcendentals_sqrt { // libcis: isolate file-scope helpers
template <class T>
void
...
} using namespace libcis_ns_numerics_complex_number_complex_transcendentals_sqrt; // libcis


void test_numerics_complex_number_complex_transcendentals_sqrt()
{
    test<float>();
    test<double>();
    test<long double>();
