// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_transcendentals_asin_e8909adc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_transcendentals_asin_e8909adc { // libcis
template <class T>
void
...
} // libcis_ns_numerics_complex_number_complex_transcendentals_asin_e8909adc (libcis)
