// AST-transferred from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_transcendentals_asin).
// main -> test_numerics_complex_number_complex_transcendentals_asin; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_transcendentals_asin { // libcis: isolate file-scope helpers
template <class T>
void
...
} using namespace libcis_ns_numerics_complex_number_complex_transcendentals_asin; // libcis


void test_numerics_complex_number_complex_transcendentals_asin()
{
    test<float>();
    test<double>();
    test<long double>();
