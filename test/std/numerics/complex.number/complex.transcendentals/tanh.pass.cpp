// AST-transferred from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_transcendentals_tanh).
// main -> test_numerics_complex_number_complex_transcendentals_tanh; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_transcendentals_tanh { // libcis: isolate file-scope helpers
template <class T>
void
...
} using namespace libcis_ns_numerics_complex_number_complex_transcendentals_tanh; // libcis


void test_numerics_complex_number_complex_transcendentals_tanh()
{
    test<float>();
    test<double>();
    test<long double>();
