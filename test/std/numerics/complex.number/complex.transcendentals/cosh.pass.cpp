// AST-transferred from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_transcendentals_cosh).
// main -> test_numerics_complex_number_complex_transcendentals_cosh; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_transcendentals_cosh { // libcis: isolate file-scope helpers
template <class T>
void
...
} using namespace libcis_ns_numerics_complex_number_complex_transcendentals_cosh; // libcis


void test_numerics_complex_number_complex_transcendentals_cosh()
{
    test<float>();
    test<double>();
    test<long double>();
