// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_cmplx_over_real_bcf92ba5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_cmplx_over_real_bcf92ba5 { // libcis
...
} // libcis_ns_numerics_complex_number_cmplx_over_real_bcf92ba5 (libcis)
