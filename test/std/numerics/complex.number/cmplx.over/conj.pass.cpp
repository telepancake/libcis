// AST-transferred from libc++ by tools/transfer.py (slug=numerics_complex_number_cmplx_over_conj).
// main -> test_numerics_complex_number_cmplx_over_conj; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_cmplx_over_conj { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_numerics_complex_number_cmplx_over_conj; // libcis


void test_numerics_complex_number_cmplx_over_conj()
{
    test<float>();
    test<double>();
    test<long double>();
