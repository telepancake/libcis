// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_cmplx_over_conj_c3b15ead).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_cmplx_over_conj_c3b15ead { // libcis
template <class T>
...
} // libcis_ns_numerics_complex_number_cmplx_over_conj_c3b15ead (libcis)
