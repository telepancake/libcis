// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_cmplx_over_norm_16b951e4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_cmplx_over_norm_16b951e4 { // libcis
template <class T>
...
} // libcis_ns_numerics_complex_number_cmplx_over_norm_16b951e4 (libcis)
