// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_cmplx_over_pow_e573058d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_cmplx_over_pow_e573058d { // libcis
template <class T>
double
...
} // libcis_ns_numerics_complex_number_cmplx_over_pow_e573058d (libcis)
