// AST-transferred from libc++ by tools/transfer.py (slug=numerics_complex_number_cmplx_over_pow).
// main -> test_numerics_complex_number_cmplx_over_pow; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
