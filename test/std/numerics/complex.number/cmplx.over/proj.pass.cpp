// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_cmplx_over_proj_c98e81a2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_cmplx_over_proj_c98e81a2 { // libcis
template <class T>
void
...
} // libcis_ns_numerics_complex_number_cmplx_over_proj_c98e81a2 (libcis)
