// AST-transferred from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_member_ops_divide_equal_complex).
// main -> test_numerics_complex_number_complex_member_ops_divide_equal_complex; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
