// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_literals_literals_63a8433e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_literals_literals_63a8433e { // libcis
int main(int, char**)
{
...
} // libcis_ns_numerics_complex_number_complex_literals_literals_63a8433e (libcis)
