// AST-transferred from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_literals_literals).
// main -> test_numerics_complex_number_complex_literals_literals; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_complex_number_complex_literals_literals()
{
