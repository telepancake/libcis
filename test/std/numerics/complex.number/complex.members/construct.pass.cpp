// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_members_construct_ba5e6b9c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_members_construct_ba5e6b9c { // libcis
template <class T>
void
test()
{
...
} // libcis_ns_numerics_complex_number_complex_members_construct_ba5e6b9c (libcis)
