// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_members_real_imag_c75e5776).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_members_real_imag_c75e5776 { // libcis
template <class T>
...
} // libcis_ns_numerics_complex_number_complex_members_real_imag_c75e5776 (libcis)
