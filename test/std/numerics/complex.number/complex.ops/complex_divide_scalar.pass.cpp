...
namespace libcis_ns_numerics_complex_number_complex_ops_complex_divide_scalar { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_numerics_complex_number_complex_ops_complex_divide_scalar; // libcis
