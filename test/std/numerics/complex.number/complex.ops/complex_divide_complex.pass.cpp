// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_ops_complex_divide_complex_df6a14ae).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_ops_complex_divide_complex_df6a14ae { // libcis
template <class T>
...
} // libcis_ns_numerics_complex_number_complex_ops_complex_divide_complex_df6a14ae (libcis)
