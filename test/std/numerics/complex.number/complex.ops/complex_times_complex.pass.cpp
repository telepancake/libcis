// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_ops_complex_times_complex_136d315f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_ops_complex_times_complex_136d315f { // libcis
template <class T>
...
} // libcis_ns_numerics_complex_number_complex_ops_complex_times_complex_136d315f (libcis)
