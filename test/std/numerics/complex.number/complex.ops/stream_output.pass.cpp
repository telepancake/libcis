// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_ops_stream_output_df0be33f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_ops_stream_output_df0be33f { // libcis
int main(int, char**) {
    // Basic test
    {
...
} // libcis_ns_numerics_complex_number_complex_ops_stream_output_df0be33f (libcis)
