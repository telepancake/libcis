// AST-transferred from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_ops_stream_output).
// main -> test_numerics_complex_number_complex_ops_stream_output; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_numerics_complex_number_complex_ops_stream_output() {
    // Basic test
    {
