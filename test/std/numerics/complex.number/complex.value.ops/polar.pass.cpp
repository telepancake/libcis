// AST-transferred from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_value_ops_polar).
// main -> test_numerics_complex_number_complex_value_ops_polar; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_value_ops_polar { // libcis: isolate file-scope helpers
template <class T>
void
...
} using namespace libcis_ns_numerics_complex_number_complex_value_ops_polar; // libcis


void test_numerics_complex_number_complex_value_ops_polar()
{
    test<float>();
    test<double>();
    test<long double>();
