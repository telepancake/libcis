// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_value_ops_polar_2edeb54a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_value_ops_polar_2edeb54a { // libcis
template <class T>
void
...
} // libcis_ns_numerics_complex_number_complex_value_ops_polar_2edeb54a (libcis)
