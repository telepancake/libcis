// transferred+adapted from libc++ by tools/transfer.py (slug=numerics_complex_number_complex_value_ops_proj_723dcf67).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_numerics_complex_number_complex_value_ops_proj_723dcf67 { // libcis
template <class T>
void
...
} // libcis_ns_numerics_complex_number_complex_value_ops_proj_723dcf67 (libcis)
