...
namespace libcis_ns_numerics_complex_number_complex_value_ops_proj { // libcis: isolate file-scope helpers
template <class T>
void
...
} using namespace libcis_ns_numerics_complex_number_complex_value_ops_proj; // libcis
