// AST-transferred from libc++ by tools/transfer.py (slug=diagnostics_errno_cerrno).
// main -> test_diagnostics_errno_cerrno; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_diagnostics_errno_cerrno()
{
