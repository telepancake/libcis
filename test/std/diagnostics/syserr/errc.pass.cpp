// AST-transferred from libc++ by tools/transfer.py (slug=diagnostics_syserr_errc).
// main -> test_diagnostics_syserr_errc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_diagnostics_syserr_errc()
{
