// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_syserr_syserr_syserr_syserr_syserr_members_ctor_error_code_string_2658350f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_syserr_syserr_syserr_syserr_syserr_members_ctor_error_code_string_2658350f { // libcis
int main(int, char**) {
  {
...
} // libcis_ns_diagnostics_syserr_syserr_syserr_syserr_syserr_members_ctor_error_code_string_2658350f (libcis)
