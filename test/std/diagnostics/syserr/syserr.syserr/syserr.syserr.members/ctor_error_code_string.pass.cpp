// AST-transferred from libc++ by tools/transfer.py (slug=diagnostics_syserr_syserr_syserr_syserr_syserr_members_ctor_error_code_string).
// main -> test_diagnostics_syserr_syserr_syserr_syserr_syserr_members_ctor_error_code_string; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_diagnostics_syserr_syserr_syserr_syserr_syserr_members_ctor_error_code_string() {
  {
