// AST-transferred from libc++ by tools/transfer.py (slug=diagnostics_syserr_syserr_errcat_syserr_errcat_objects_system_category).
// main -> test_diagnostics_syserr_syserr_errcat_syserr_errcat_objects_system_category; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_syserr_syserr_errcat_syserr_errcat_objects_system_category { // libcis: isolate file-scope helpers
struct StaticInit {
...
} using namespace libcis_ns_diagnostics_syserr_syserr_errcat_syserr_errcat_objects_system_category; // libcis


void test_diagnostics_syserr_syserr_errcat_syserr_errcat_objects_system_category() {
  {
