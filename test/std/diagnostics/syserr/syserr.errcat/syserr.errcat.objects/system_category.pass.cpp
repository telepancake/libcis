// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_syserr_syserr_errcat_syserr_errcat_objects_system_category_b096d849).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_syserr_syserr_errcat_syserr_errcat_objects_system_category_b096d849 { // libcis
struct StaticInit {
...
} // libcis_ns_diagnostics_syserr_syserr_errcat_syserr_errcat_objects_system_category_b096d849 (libcis)
