// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_syserr_syserr_errcat_syserr_errcat_objects_generic_category_7e20262d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_syserr_syserr_errcat_syserr_errcat_objects_generic_category_7e20262d { // libcis
struct StaticInit {
...
} // libcis_ns_diagnostics_syserr_syserr_errcat_syserr_errcat_objects_generic_category_7e20262d (libcis)
