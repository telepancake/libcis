// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_syserr_syserr_errcat_syserr_errcat_nonvirtuals_cmp_ee7a6219).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_syserr_syserr_errcat_syserr_errcat_nonvirtuals_cmp_ee7a6219 { // libcis
int main(int, char**) {
...
} // libcis_ns_diagnostics_syserr_syserr_errcat_syserr_errcat_nonvirtuals_cmp_ee7a6219 (libcis)
