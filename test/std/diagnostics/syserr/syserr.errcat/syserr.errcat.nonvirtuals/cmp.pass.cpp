// AST-transferred from libc++ by tools/transfer.py (slug=diagnostics_syserr_syserr_errcat_syserr_errcat_nonvirtuals_cmp).
// main -> test_diagnostics_syserr_syserr_errcat_syserr_errcat_nonvirtuals_cmp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_diagnostics_syserr_syserr_errcat_syserr_errcat_nonvirtuals_cmp() {
