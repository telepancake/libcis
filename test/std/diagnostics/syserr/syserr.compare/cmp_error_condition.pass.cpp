// AST-transferred from libc++ by tools/transfer.py (slug=diagnostics_syserr_syserr_compare_cmp_error_condition).
// main -> test_diagnostics_syserr_syserr_compare_cmp_error_condition; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_diagnostics_syserr_syserr_compare_cmp_error_condition() {
