// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_syserr_syserr_compare_cmp_error_condition_ded89da4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_syserr_syserr_compare_cmp_error_condition_ded89da4 { // libcis
int main(int, char**) {
...
} // libcis_ns_diagnostics_syserr_syserr_compare_cmp_error_condition_ded89da4 (libcis)
