// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_syserr_syserr_compare_cmp_error_code_8dc64572).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_syserr_syserr_compare_cmp_error_code_8dc64572 { // libcis
int main(int, char**) {
...
} // libcis_ns_diagnostics_syserr_syserr_compare_cmp_error_code_8dc64572 (libcis)
