// AST-transferred from libc++ by tools/transfer.py (slug=diagnostics_syserr_syserr_compare_cmp_error_code).
// main -> test_diagnostics_syserr_syserr_compare_cmp_error_code; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_diagnostics_syserr_syserr_compare_cmp_error_code() {
