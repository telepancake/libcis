// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_syserr_syserr_compare_eq_error_code_error_code_d3f9f5ee).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_syserr_syserr_compare_eq_error_code_error_code_d3f9f5ee { // libcis
int main(int, char**) {
...
} // libcis_ns_diagnostics_syserr_syserr_compare_eq_error_code_error_code_d3f9f5ee (libcis)
