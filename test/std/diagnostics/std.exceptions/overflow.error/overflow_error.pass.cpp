// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_std_exceptions_overflow_error_overflow_error_3aef1f5a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_std_exceptions_overflow_error_overflow_error_3aef1f5a { // libcis
int main(int, char**)
{
...
} // libcis_ns_diagnostics_std_exceptions_overflow_error_overflow_error_3aef1f5a (libcis)
