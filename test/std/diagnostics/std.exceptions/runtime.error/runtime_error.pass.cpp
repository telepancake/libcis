// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_std_exceptions_runtime_error_runtime_error_d2d78304).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_std_exceptions_runtime_error_runtime_error_d2d78304 { // libcis
int main(int, char**)
{
...
} // libcis_ns_diagnostics_std_exceptions_runtime_error_runtime_error_d2d78304 (libcis)
