// AST-transferred from libc++ by tools/transfer.py (slug=diagnostics_std_exceptions_runtime_error_runtime_error).
// main -> test_diagnostics_std_exceptions_runtime_error_runtime_error; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_diagnostics_std_exceptions_runtime_error_runtime_error()
{
