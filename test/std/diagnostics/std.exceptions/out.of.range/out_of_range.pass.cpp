// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_std_exceptions_out_of_range_out_of_range_898c8b60).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_std_exceptions_out_of_range_out_of_range_898c8b60 { // libcis
int main(int, char**)
{
...
} // libcis_ns_diagnostics_std_exceptions_out_of_range_out_of_range_898c8b60 (libcis)
