// AST-transferred from libc++ by tools/transfer.py (slug=diagnostics_std_exceptions_domain_error_domain_error).
// main -> test_diagnostics_std_exceptions_domain_error_domain_error; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_diagnostics_std_exceptions_domain_error_domain_error()
{
