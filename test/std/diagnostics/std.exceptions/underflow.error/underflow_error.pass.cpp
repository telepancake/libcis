// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_std_exceptions_underflow_error_underflow_error_aafa141c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_std_exceptions_underflow_error_underflow_error_aafa141c { // libcis
int main(int, char**)
{
...
} // libcis_ns_diagnostics_std_exceptions_underflow_error_underflow_error_aafa141c (libcis)
