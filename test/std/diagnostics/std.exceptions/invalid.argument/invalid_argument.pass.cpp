// AST-transferred from libc++ by tools/transfer.py (slug=diagnostics_std_exceptions_invalid_argument_invalid_argument).
// main -> test_diagnostics_std_exceptions_invalid_argument_invalid_argument; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_diagnostics_std_exceptions_invalid_argument_invalid_argument()
{
