// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_std_exceptions_invalid_argument_invalid_argument_42ff9776).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_std_exceptions_invalid_argument_invalid_argument_42ff9776 { // libcis
int main(int, char**)
{
...
} // libcis_ns_diagnostics_std_exceptions_invalid_argument_invalid_argument_42ff9776 (libcis)
