// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_std_exceptions_length_error_length_error_bb39501f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_std_exceptions_length_error_length_error_bb39501f { // libcis
int main(int, char**)
{
...
} // libcis_ns_diagnostics_std_exceptions_length_error_length_error_bb39501f (libcis)
