// transferred+adapted from libc++ by tools/transfer.py (slug=diagnostics_std_exceptions_range_error_range_error_b9e2bf26).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_diagnostics_std_exceptions_range_error_range_error_b9e2bf26 { // libcis
int main(int, char**)
{
...
} // libcis_ns_diagnostics_std_exceptions_range_error_range_error_b9e2bf26 (libcis)
