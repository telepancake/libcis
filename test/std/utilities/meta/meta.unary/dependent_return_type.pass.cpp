// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_dependent_return_type).
// main -> test_utilities_meta_meta_unary_dependent_return_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_dependent_return_type { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_utilities_meta_meta_unary_dependent_return_type; // libcis
...
void test_utilities_meta_meta_unary_dependent_return_type() { return; }
