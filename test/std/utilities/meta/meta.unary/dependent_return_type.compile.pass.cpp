// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_dependent_return_type_d4d79c64).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_dependent_return_type_d4d79c64 { // libcis
template <class T>
...
} // libcis_ns_utilities_meta_meta_unary_dependent_return_type_d4d79c64 (libcis)
