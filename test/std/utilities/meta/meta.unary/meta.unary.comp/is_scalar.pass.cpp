// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_comp_is_scalar).
// main -> test_utilities_meta_meta_unary_meta_unary_comp_is_scalar; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_scalar { // libcis: isolate file-scope helpers
template <class T>
void test_is_scalar()
{
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_scalar; // libcis



void test_utilities_meta_meta_unary_meta_unary_comp_is_scalar()
{
