// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_comp_is_scalar_0d1e0c91).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_scalar_0d1e0c91 { // libcis
template <class T>
void test_is_scalar()
{
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_scalar_0d1e0c91 (libcis)
