// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_comp_is_compound).
// main -> test_utilities_meta_meta_unary_meta_unary_comp_is_compound; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_compound { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_compound; // libcis



void test_utilities_meta_meta_unary_meta_unary_comp_is_compound()
{
