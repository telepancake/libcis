// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_comp_is_bounded_array_f5b11472).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_bounded_array_f5b11472 { // libcis
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_bounded_array_f5b11472 (libcis)
