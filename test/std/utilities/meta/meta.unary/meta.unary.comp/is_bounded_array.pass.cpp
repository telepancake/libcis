// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_comp_is_bounded_array).
// main -> test_utilities_meta_meta_unary_meta_unary_comp_is_bounded_array; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_bounded_array { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_bounded_array; // libcis


void test_utilities_meta_meta_unary_meta_unary_comp_is_bounded_array()
{
    // Non-array types
