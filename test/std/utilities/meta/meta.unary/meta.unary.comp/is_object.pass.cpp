// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_comp_is_object_8ad2112d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_object_8ad2112d { // libcis
template <class T>
void test_is_object()
{
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_object_8ad2112d (libcis)
