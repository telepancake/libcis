// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_comp_is_object).
// main -> test_utilities_meta_meta_unary_meta_unary_comp_is_object; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_object { // libcis: isolate file-scope helpers
template <class T>
void test_is_object()
{
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_comp_is_object; // libcis



void test_utilities_meta_meta_unary_meta_unary_comp_is_object()
{
