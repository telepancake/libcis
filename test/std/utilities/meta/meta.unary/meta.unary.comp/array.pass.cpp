// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_comp_array_de09e3c2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_comp_array_de09e3c2 { // libcis
template <class T>
void test_array_imp()
{
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_comp_array_de09e3c2 (libcis)
