// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_final_b102fd79).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_final_b102fd79 { // libcis
struct P final { };
union U1 { };
union U2 final { };
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_final_b102fd79 (libcis)
