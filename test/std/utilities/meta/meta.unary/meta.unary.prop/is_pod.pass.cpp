// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_pod_f43e8d2a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_pod_f43e8d2a { // libcis
template <class T>
void test_is_pod()
{
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_pod_f43e8d2a (libcis)
