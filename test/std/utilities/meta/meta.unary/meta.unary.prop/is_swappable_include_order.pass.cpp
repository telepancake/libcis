// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_swappable_include_order_43dbfc65).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_swappable_include_order_43dbfc65 { // libcis
int main(int, char**) {
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_swappable_include_order_43dbfc65 (libcis)
