// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_swappable_include_order).
// main -> test_utilities_meta_meta_unary_meta_unary_prop_is_swappable_include_order; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_meta_meta_unary_meta_unary_prop_is_swappable_include_order() {
