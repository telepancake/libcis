// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_trivially_assignable_f3eda78f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_trivially_assignable_f3eda78f { // libcis
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_trivially_assignable_f3eda78f (libcis)
