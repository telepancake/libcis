// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_polymorphic).
// main -> test_utilities_meta_meta_unary_meta_unary_prop_is_polymorphic; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_polymorphic { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_polymorphic; // libcis
...
void test_utilities_meta_meta_unary_meta_unary_prop_is_polymorphic()
{
