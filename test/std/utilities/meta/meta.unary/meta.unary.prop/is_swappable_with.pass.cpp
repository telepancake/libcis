// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_swappable_with_85a620b4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_swappable_with_85a620b4 { // libcis
namespace MyNS {
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_swappable_with_85a620b4 (libcis)
