// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_nothrow_default_constructible_2093b9a1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_nothrow_default_constructible_2093b9a1 { // libcis
template <class T>
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_nothrow_default_constructible_2093b9a1 (libcis)
