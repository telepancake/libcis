// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_nothrow_swappable_with).
// main -> test_utilities_meta_meta_unary_meta_unary_prop_is_nothrow_swappable_with; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_meta_meta_unary_meta_unary_prop_is_nothrow_swappable_with()
{
