// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_destructible).
// main -> test_utilities_meta_meta_unary_meta_unary_prop_is_destructible; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_destructible { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_destructible; // libcis

#endif


void test_utilities_meta_meta_unary_meta_unary_prop_is_destructible()
{
