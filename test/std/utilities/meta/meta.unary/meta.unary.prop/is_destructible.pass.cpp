// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_destructible_a58cf594).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_destructible_a58cf594 { // libcis
template <class T>
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_destructible_a58cf594 (libcis)
