// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_implicit_lifetime).
// main -> test_utilities_meta_meta_unary_meta_unary_prop_is_implicit_lifetime; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_implicit_lifetime { // libcis: isolate file-scope helpers
enum Enum { EV };
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_implicit_lifetime; // libcis


void test_utilities_meta_meta_unary_meta_unary_prop_is_implicit_lifetime() {
  test();
  static_assert(test());
