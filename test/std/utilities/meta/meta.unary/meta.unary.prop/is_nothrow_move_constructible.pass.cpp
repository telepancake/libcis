// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_nothrow_move_constructible_43506970).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_nothrow_move_constructible_43506970 { // libcis
template <class T>
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_nothrow_move_constructible_43506970 (libcis)
