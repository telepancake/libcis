// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_signed_d9ee0e59).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_signed_d9ee0e59 { // libcis
template <class T>
void test_is_signed()
{
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_signed_d9ee0e59 (libcis)
