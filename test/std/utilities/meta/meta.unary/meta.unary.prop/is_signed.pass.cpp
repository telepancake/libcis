// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_signed).
// main -> test_utilities_meta_meta_unary_meta_unary_prop_is_signed; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_signed { // libcis: isolate file-scope helpers
template <class T>
void test_is_signed()
{
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_signed; // libcis


void test_utilities_meta_meta_unary_meta_unary_prop_is_signed()
{
