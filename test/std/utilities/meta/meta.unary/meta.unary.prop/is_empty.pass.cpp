// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_empty_e3e8bbb2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_empty_e3e8bbb2 { // libcis
template <class T>
void test_is_empty()
{
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_empty_e3e8bbb2 (libcis)
