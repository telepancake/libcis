// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_empty).
// main -> test_utilities_meta_meta_unary_meta_unary_prop_is_empty; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_empty { // libcis: isolate file-scope helpers
template <class T>
void test_is_empty()
{
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_empty; // libcis


void test_utilities_meta_meta_unary_meta_unary_prop_is_empty()
{
