// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_has_unique_object_representations).
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_has_unique_object_representations { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_has_unique_object_representations; // libcis
