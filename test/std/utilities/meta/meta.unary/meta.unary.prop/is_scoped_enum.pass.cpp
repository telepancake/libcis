// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_scoped_enum).
// main -> test_utilities_meta_meta_unary_meta_unary_prop_is_scoped_enum; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_scoped_enum { // libcis: isolate file-scope helpers
template <class T>
void test_positive() {
...
void func1();
int func2(int);
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_scoped_enum; // libcis


void test_utilities_meta_meta_unary_meta_unary_prop_is_scoped_enum() {
