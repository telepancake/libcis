// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_assignable_c6017003).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_assignable_c6017003 { // libcis
struct A
{
};
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_assignable_c6017003 (libcis)
