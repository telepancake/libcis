// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_const_65f55cea).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_const_65f55cea { // libcis
template <class T>
void test_is_const()
{
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_const_65f55cea (libcis)
