// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_nothrow_swappable).
// main -> test_utilities_meta_meta_unary_meta_unary_prop_is_nothrow_swappable; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_meta_meta_unary_meta_unary_prop_is_nothrow_swappable()
{
