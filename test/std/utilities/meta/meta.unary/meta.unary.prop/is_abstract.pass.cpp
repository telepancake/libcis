// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_abstract).
// main -> test_utilities_meta_meta_unary_meta_unary_prop_is_abstract; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_abstract { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_abstract; // libcis


void test_utilities_meta_meta_unary_meta_unary_prop_is_abstract()
{
