// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_aggregate_555bcb59).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_aggregate_555bcb59 { // libcis
template <class T>
void test_true()
{
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_aggregate_555bcb59 (libcis)
