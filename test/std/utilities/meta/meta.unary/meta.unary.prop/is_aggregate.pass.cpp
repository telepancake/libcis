// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_aggregate).
// main -> test_utilities_meta_meta_unary_meta_unary_prop_is_aggregate; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_aggregate { // libcis: isolate file-scope helpers
template <class T>
void test_true()
{
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_aggregate; // libcis



void test_utilities_meta_meta_unary_meta_unary_prop_is_aggregate()
{
  {
    test_false<void>();
    test_false<int>();
