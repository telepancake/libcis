// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_constructible).
// main -> test_utilities_meta_meta_unary_meta_unary_prop_is_constructible; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_constructible { // libcis: isolate file-scope helpers
struct A
{
    explicit A(int);
    A(int, double);
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_constructible; // libcis


void test_utilities_meta_meta_unary_meta_unary_prop_is_constructible()
{
    typedef Base B;
    typedef Derived D;
