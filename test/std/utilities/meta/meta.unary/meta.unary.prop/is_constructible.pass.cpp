// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_prop_is_constructible_62667942).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_constructible_62667942 { // libcis
struct A
{
    explicit A(int);
    A(int, double);
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_prop_is_constructible_62667942 (libcis)
