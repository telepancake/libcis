// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_cat_is_array_981ee040).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_array_981ee040 { // libcis
template <class T>
void test_is_array()
{
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_array_981ee040 (libcis)
