// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_cat_is_array).
// main -> test_utilities_meta_meta_unary_meta_unary_cat_is_array; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_array { // libcis: isolate file-scope helpers
template <class T>
void test_is_array()
{
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_array; // libcis


void test_utilities_meta_meta_unary_meta_unary_cat_is_array()
{
