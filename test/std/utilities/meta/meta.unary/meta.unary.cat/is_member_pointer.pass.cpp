// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_cat_is_member_pointer).
// main -> test_utilities_meta_meta_unary_meta_unary_cat_is_member_pointer; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_member_pointer { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_member_pointer; // libcis



void test_utilities_meta_meta_unary_meta_unary_cat_is_member_pointer()
{
