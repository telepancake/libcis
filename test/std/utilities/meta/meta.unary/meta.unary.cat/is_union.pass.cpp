// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_cat_is_union_eb94e1d7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_union_eb94e1d7 { // libcis
template <class T>
void test_is_union()
{
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_union_eb94e1d7 (libcis)
