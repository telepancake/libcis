// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_cat_is_union).
// main -> test_utilities_meta_meta_unary_meta_unary_cat_is_union; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_union { // libcis: isolate file-scope helpers
template <class T>
void test_is_union()
{
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_union; // libcis


void test_utilities_meta_meta_unary_meta_unary_cat_is_union()
{
    test_is_union<Union>();
