// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_cat_is_void_e00d3cf6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_void_e00d3cf6 { // libcis
template <class T>
void test_is_void()
{
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_void_e00d3cf6 (libcis)
