// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_cat_is_void).
// main -> test_utilities_meta_meta_unary_meta_unary_cat_is_void; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_void { // libcis: isolate file-scope helpers
template <class T>
void test_is_void()
{
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_void; // libcis


void test_utilities_meta_meta_unary_meta_unary_cat_is_void()
{
    test_is_void<void>();
