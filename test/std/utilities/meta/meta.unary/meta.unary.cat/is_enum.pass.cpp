// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_cat_is_enum_107f020b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_enum_107f020b { // libcis
template <class T>
void test_is_enum()
{
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_enum_107f020b (libcis)
