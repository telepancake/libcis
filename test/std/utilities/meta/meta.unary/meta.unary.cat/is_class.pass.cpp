// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_cat_is_class).
// main -> test_utilities_meta_meta_unary_meta_unary_cat_is_class; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_class { // libcis: isolate file-scope helpers
template <class T>
void test_is_class()
{
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_class; // libcis


void test_utilities_meta_meta_unary_meta_unary_cat_is_class()
{
    test_is_class<Empty>();
