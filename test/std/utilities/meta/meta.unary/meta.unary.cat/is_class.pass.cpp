// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_cat_is_class_70298d35).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_class_70298d35 { // libcis
template <class T>
void test_is_class()
{
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_cat_is_class_70298d35 (libcis)
