// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_cat_function_3e163a73).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_function_3e163a73 { // libcis
class Class {};
...
} // libcis_ns_utilities_meta_meta_unary_meta_unary_cat_function_3e163a73 (libcis)
