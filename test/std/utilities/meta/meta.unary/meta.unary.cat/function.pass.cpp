// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_meta_unary_cat_function).
// main -> test_utilities_meta_meta_unary_meta_unary_cat_function; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_function { // libcis: isolate file-scope helpers
class Class {};
...
} using namespace libcis_ns_utilities_meta_meta_unary_meta_unary_cat_function; // libcis


void test_utilities_meta_meta_unary_meta_unary_cat_function()
{
    TEST_REGULAR( void () );
