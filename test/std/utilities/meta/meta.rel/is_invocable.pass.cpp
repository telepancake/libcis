// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_rel_is_invocable_58fc1bc9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_rel_is_invocable_58fc1bc9 { // libcis
struct Tag {};
...
} // libcis_ns_utilities_meta_meta_rel_is_invocable_58fc1bc9 (libcis)
