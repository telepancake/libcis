// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_rel_is_invocable).
// main -> test_utilities_meta_meta_rel_is_invocable; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_rel_is_invocable { // libcis: isolate file-scope helpers
struct Tag {};
...
} using namespace libcis_ns_utilities_meta_meta_rel_is_invocable; // libcis


void test_utilities_meta_meta_rel_is_invocable() {
