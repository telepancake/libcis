// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_rel_is_base_of_union).
// main -> test_utilities_meta_meta_rel_is_base_of_union; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_rel_is_base_of_union { // libcis: isolate file-scope helpers
...
struct I0;
struct I1 {};
} using namespace libcis_ns_utilities_meta_meta_rel_is_base_of_union; // libcis


void test_utilities_meta_meta_rel_is_base_of_union()
{
