// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_rel_is_base_of_union_9f50b5bc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_rel_is_base_of_union_9f50b5bc { // libcis
...
} // libcis_ns_utilities_meta_meta_rel_is_base_of_union_9f50b5bc (libcis)
