// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_rel_is_virtual_base_of).
// main -> test_utilities_meta_meta_rel_is_virtual_base_of; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_rel_is_virtual_base_of { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_meta_meta_rel_is_virtual_base_of; // libcis


void test_utilities_meta_meta_rel_is_virtual_base_of() {
