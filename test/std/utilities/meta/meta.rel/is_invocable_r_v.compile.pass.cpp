// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_rel_is_invocable_r_v_b9a6721e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_rel_is_invocable_r_v_b9a6721e { // libcis
...
static_assert(!std::is_invocable_r<int*, decltype(Return<int>)>::value);
} // libcis_ns_utilities_meta_meta_rel_is_invocable_r_v_b9a6721e (libcis)
