// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_rel_is_invocable_r_v).
...
namespace libcis_ns_utilities_meta_meta_rel_is_invocable_r_v { // libcis: isolate file-scope helpers
...
static_assert(!std::is_invocable_r<int*, decltype(Return<int>)>::value);
} using namespace libcis_ns_utilities_meta_meta_rel_is_invocable_r_v; // libcis
