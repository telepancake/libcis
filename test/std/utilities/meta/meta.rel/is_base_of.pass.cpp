// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_rel_is_base_of).
// main -> test_utilities_meta_meta_rel_is_base_of; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_rel_is_base_of { // libcis: isolate file-scope helpers
...
struct I0;
} using namespace libcis_ns_utilities_meta_meta_rel_is_base_of; // libcis
 // incomplete

void test_utilities_meta_meta_rel_is_base_of()
{
    test_is_base_of<B, D>();
