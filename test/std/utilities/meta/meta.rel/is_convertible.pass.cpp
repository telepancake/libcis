// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_rel_is_convertible).
// main -> test_utilities_meta_meta_rel_is_convertible; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_rel_is_convertible { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_meta_meta_rel_is_convertible; // libcis


void test_utilities_meta_meta_rel_is_convertible()
{
    // void
