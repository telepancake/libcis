// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_rel_is_convertible_e82045e2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_rel_is_convertible_e82045e2 { // libcis
...
} // libcis_ns_utilities_meta_meta_rel_is_convertible_e82045e2 (libcis)
