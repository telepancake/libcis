// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_rel_is_nothrow_convertible_bf87f913).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_rel_is_nothrow_convertible_bf87f913 { // libcis
struct A {};
struct B {
public:
...
} // libcis_ns_utilities_meta_meta_rel_is_nothrow_convertible_bf87f913 (libcis)
