// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_rel_is_nothrow_convertible).
// main -> test_utilities_meta_meta_rel_is_nothrow_convertible; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_rel_is_nothrow_convertible { // libcis: isolate file-scope helpers
struct A {};
struct B {
public:
...
} using namespace libcis_ns_utilities_meta_meta_rel_is_nothrow_convertible; // libcis


void test_utilities_meta_meta_rel_is_nothrow_convertible() {
