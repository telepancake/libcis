// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_rel_is_nothrow_invocable_b665c044).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_rel_is_nothrow_invocable_b665c044 { // libcis
struct Tag {};
...
} // libcis_ns_utilities_meta_meta_rel_is_nothrow_invocable_b665c044 (libcis)
