// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_const_eval_is_constant_evaluated).
// main -> test_utilities_meta_meta_const_eval_is_constant_evaluated; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_const_eval_is_constant_evaluated { // libcis: isolate file-scope helpers
template <bool> struct InTemplate {};
} using namespace libcis_ns_utilities_meta_meta_const_eval_is_constant_evaluated; // libcis


void test_utilities_meta_meta_const_eval_is_constant_evaluated()
{
  // Test the signature
  {
