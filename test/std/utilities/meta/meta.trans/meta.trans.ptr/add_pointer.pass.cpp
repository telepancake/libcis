// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_ptr_add_pointer).
// main -> test_utilities_meta_meta_trans_meta_trans_ptr_add_pointer; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_ptr_add_pointer { // libcis: isolate file-scope helpers
...
struct Foo {};
} using namespace libcis_ns_utilities_meta_meta_trans_meta_trans_ptr_add_pointer; // libcis


void test_utilities_meta_meta_trans_meta_trans_ptr_add_pointer()
{
