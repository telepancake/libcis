// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_sign_make_unsigned).
// main -> test_utilities_meta_meta_trans_meta_trans_sign_make_unsigned; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_sign_make_unsigned { // libcis: isolate file-scope helpers
enum Enum {zero, one_};
...
} using namespace libcis_ns_utilities_meta_meta_trans_meta_trans_sign_make_unsigned; // libcis


void test_utilities_meta_meta_trans_meta_trans_sign_make_unsigned()
{
