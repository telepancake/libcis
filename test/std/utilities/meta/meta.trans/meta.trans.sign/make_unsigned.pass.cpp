// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_sign_make_unsigned_8710c476).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_sign_make_unsigned_8710c476 { // libcis
enum Enum {zero, one_};
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_sign_make_unsigned_8710c476 (libcis)
