// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_sign_make_signed_e3ce2b3f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_sign_make_signed_e3ce2b3f { // libcis
enum Enum {zero, one_};
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_sign_make_signed_e3ce2b3f (libcis)
