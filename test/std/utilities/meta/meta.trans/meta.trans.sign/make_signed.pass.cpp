// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_sign_make_signed).
// main -> test_utilities_meta_meta_trans_meta_trans_sign_make_signed; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_sign_make_signed { // libcis: isolate file-scope helpers
enum Enum {zero, one_};
...
} using namespace libcis_ns_utilities_meta_meta_trans_meta_trans_sign_make_signed; // libcis


void test_utilities_meta_meta_trans_meta_trans_sign_make_signed()
{
