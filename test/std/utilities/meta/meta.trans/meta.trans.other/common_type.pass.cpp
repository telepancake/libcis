// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_other_common_type).
// main -> test_utilities_meta_meta_trans_meta_trans_other_common_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_common_type { // libcis: isolate file-scope helpers
struct E {};
...
} using namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_common_type; // libcis
...
void test_utilities_meta_meta_trans_meta_trans_other_common_type()
{
    static_assert((std::is_same<std::common_type<int>::type, int>::value), "");
