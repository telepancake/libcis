// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_other_result_of11_5f9d6edb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_result_of11_5f9d6edb { // libcis
struct wat
{
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_other_result_of11_5f9d6edb (libcis)
