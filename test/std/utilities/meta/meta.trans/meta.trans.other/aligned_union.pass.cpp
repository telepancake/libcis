// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_other_aligned_union_c8179e18).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_aligned_union_c8179e18 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_other_aligned_union_c8179e18 (libcis)
