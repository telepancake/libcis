// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_other_aligned_union).
// main -> test_utilities_meta_meta_trans_meta_trans_other_aligned_union; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_meta_meta_trans_meta_trans_other_aligned_union()
{
    {
