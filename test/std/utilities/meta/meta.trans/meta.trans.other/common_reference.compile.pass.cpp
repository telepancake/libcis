// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_other_common_reference).
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_common_reference { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_common_reference; // libcis
