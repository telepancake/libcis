// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_other_remove_cvref).
// main -> test_utilities_meta_meta_trans_meta_trans_other_remove_cvref; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_remove_cvref { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_remove_cvref; // libcis


void test_utilities_meta_meta_trans_meta_trans_other_remove_cvref()
{
