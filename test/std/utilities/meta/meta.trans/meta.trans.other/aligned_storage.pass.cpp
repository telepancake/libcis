// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_other_aligned_storage_0bb18efc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_aligned_storage_0bb18efc { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_other_aligned_storage_0bb18efc (libcis)
