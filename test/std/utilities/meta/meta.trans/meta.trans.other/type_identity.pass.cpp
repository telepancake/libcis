// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_other_type_identity_908c6ede).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_type_identity_908c6ede { // libcis
template <class T>
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_other_type_identity_908c6ede (libcis)
