// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_other_underlying_type).
// main -> test_utilities_meta_meta_trans_meta_trans_other_underlying_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER > 17
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_underlying_type { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_underlying_type; // libcis

#endif

void test_utilities_meta_meta_trans_meta_trans_other_underlying_type()
{
//  Basic tests
    check<E, int>();
#ifdef TEST_UNSIGNED_UNDERLYING_TYPE
