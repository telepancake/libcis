// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_other_decay_3216f56d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_decay_3216f56d { // libcis
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_other_decay_3216f56d (libcis)
