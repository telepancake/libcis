// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_other_result_of_182ffb77).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_other_result_of_182ffb77 { // libcis
struct S
{
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_other_result_of_182ffb77 (libcis)
