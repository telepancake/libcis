// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_arr_remove_all_extents_ec492ef8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_arr_remove_all_extents_ec492ef8 { // libcis
enum Enum {zero, one_};
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_arr_remove_all_extents_ec492ef8 (libcis)
