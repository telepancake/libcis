// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_arr_remove_extent).
// main -> test_utilities_meta_meta_trans_meta_trans_arr_remove_extent; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_arr_remove_extent { // libcis: isolate file-scope helpers
enum Enum {zero, one_};
...
} using namespace libcis_ns_utilities_meta_meta_trans_meta_trans_arr_remove_extent; // libcis



void test_utilities_meta_meta_trans_meta_trans_arr_remove_extent()
{
