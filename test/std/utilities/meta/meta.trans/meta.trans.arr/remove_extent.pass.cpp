// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_arr_remove_extent_87c927ab).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_arr_remove_extent_87c927ab { // libcis
enum Enum {zero, one_};
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_arr_remove_extent_87c927ab (libcis)
