// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_cv_remove_volatile_62da8cc0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_cv_remove_volatile_62da8cc0 { // libcis
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_cv_remove_volatile_62da8cc0 (libcis)
