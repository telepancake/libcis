// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_cv_remove_const_84a016b2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_cv_remove_const_84a016b2 { // libcis
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_cv_remove_const_84a016b2 (libcis)
