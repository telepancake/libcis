// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_cv_add_volatile_72c2a97f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_cv_add_volatile_72c2a97f { // libcis
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_cv_add_volatile_72c2a97f (libcis)
