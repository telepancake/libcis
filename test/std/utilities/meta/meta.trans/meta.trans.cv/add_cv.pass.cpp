// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_cv_add_cv_a2cbae30).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_cv_add_cv_a2cbae30 { // libcis
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_cv_add_cv_a2cbae30 (libcis)
