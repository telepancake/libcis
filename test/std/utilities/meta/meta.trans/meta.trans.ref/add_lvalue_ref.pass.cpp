// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_ref_add_lvalue_ref_31d35a56).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_ref_add_lvalue_ref_31d35a56 { // libcis
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_ref_add_lvalue_ref_31d35a56 (libcis)
