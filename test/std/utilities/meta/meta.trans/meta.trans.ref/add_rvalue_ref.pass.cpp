// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_ref_add_rvalue_ref_843eddc1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_ref_add_rvalue_ref_843eddc1 { // libcis
...
} // libcis_ns_utilities_meta_meta_trans_meta_trans_ref_add_rvalue_ref_843eddc1 (libcis)
