// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_trans_meta_trans_ref_add_rvalue_ref).
// main -> test_utilities_meta_meta_trans_meta_trans_ref_add_rvalue_ref; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_trans_meta_trans_ref_add_rvalue_ref { // libcis: isolate file-scope helpers
...
struct Foo {};
} using namespace libcis_ns_utilities_meta_meta_trans_meta_trans_ref_add_rvalue_ref; // libcis


void test_utilities_meta_meta_trans_meta_trans_ref_add_rvalue_ref()
{
