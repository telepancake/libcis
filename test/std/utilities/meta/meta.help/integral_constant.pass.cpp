// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_help_integral_constant_2b670a61).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_help_integral_constant_2b670a61 { // libcis
int main(int, char**)
{
...
} // libcis_ns_utilities_meta_meta_help_integral_constant_2b670a61 (libcis)
