// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_help_integral_constant).
// main -> test_utilities_meta_meta_help_integral_constant; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_meta_meta_help_integral_constant()
{
