// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_derived_from_integral_constant).
...
namespace libcis_ns_utilities_meta_derived_from_integral_constant { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_meta_derived_from_integral_constant; // libcis
