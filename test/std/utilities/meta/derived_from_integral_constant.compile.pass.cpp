// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_derived_from_integral_constant_41c22880).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_derived_from_integral_constant_41c22880 { // libcis
...
} // libcis_ns_utilities_meta_derived_from_integral_constant_41c22880 (libcis)
#if TEST_STD_VER >= 23
