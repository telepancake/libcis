// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_logical_conjunction).
...
namespace libcis_ns_utilities_meta_meta_logical_conjunction { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_meta_meta_logical_conjunction; // libcis
