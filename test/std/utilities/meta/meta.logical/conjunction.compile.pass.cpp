// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_logical_conjunction_4ff28194).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_logical_conjunction_4ff28194 { // libcis
...
} // libcis_ns_utilities_meta_meta_logical_conjunction_4ff28194 (libcis)
