// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_logical_disjunction).
...
namespace libcis_ns_utilities_meta_meta_logical_disjunction { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_meta_meta_logical_disjunction; // libcis
