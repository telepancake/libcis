// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_logical_disjunction_02d4e39f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_logical_disjunction_02d4e39f { // libcis
...
} // libcis_ns_utilities_meta_meta_logical_disjunction_02d4e39f (libcis)
