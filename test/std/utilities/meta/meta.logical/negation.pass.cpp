// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_logical_negation_85d0df78).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_logical_negation_85d0df78 { // libcis
...
} // libcis_ns_utilities_meta_meta_logical_negation_85d0df78 (libcis)
