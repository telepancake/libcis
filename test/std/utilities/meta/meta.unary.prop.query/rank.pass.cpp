// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_prop_query_rank_fb7f0caa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_prop_query_rank_fb7f0caa { // libcis
...
} // libcis_ns_utilities_meta_meta_unary_prop_query_rank_fb7f0caa (libcis)
