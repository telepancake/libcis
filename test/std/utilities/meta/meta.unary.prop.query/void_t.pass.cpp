// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_prop_query_void_t).
// main -> test_utilities_meta_meta_unary_prop_query_void_t; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_prop_query_void_t { // libcis: isolate file-scope helpers
template <class T>
void test1()
{
...
} using namespace libcis_ns_utilities_meta_meta_unary_prop_query_void_t; // libcis


void test_utilities_meta_meta_unary_prop_query_void_t()
{
