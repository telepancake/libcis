// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_prop_query_void_t_13907a98).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_prop_query_void_t_13907a98 { // libcis
template <class T>
void test1()
{
...
} // libcis_ns_utilities_meta_meta_unary_prop_query_void_t_13907a98 (libcis)
