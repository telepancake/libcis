// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_prop_query_alignment_of_ebbb85c8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_prop_query_alignment_of_ebbb85c8 { // libcis
...
} // libcis_ns_utilities_meta_meta_unary_prop_query_alignment_of_ebbb85c8 (libcis)
