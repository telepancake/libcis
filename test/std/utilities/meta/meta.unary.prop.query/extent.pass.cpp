// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_prop_query_extent_64ff1ce3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_prop_query_extent_64ff1ce3 { // libcis
...
} // libcis_ns_utilities_meta_meta_unary_prop_query_extent_64ff1ce3 (libcis)
