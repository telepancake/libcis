// AST-transferred from libc++ by tools/transfer.py (slug=utilities_meta_meta_unary_prop_query_extent).
// main -> test_utilities_meta_meta_unary_prop_query_extent; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_meta_meta_unary_prop_query_extent { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_meta_meta_unary_prop_query_extent; // libcis


void test_utilities_meta_meta_unary_prop_query_extent()
{
    test_extent<void, 0>();
    test_extent<int&, 0>();
    test_extent<Class, 0>();
