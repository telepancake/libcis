// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pair_astuple_pairs_by_type).
// main -> test_utilities_utility_pairs_pair_astuple_pairs_by_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pair_astuple_pairs_by_type { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_pairs_pair_astuple_pairs_by_type; // libcis


void test_utilities_utility_pairs_pair_astuple_pairs_by_type() {
  test();
#if TEST_STD_VER >= 14
  static_assert(test(), "");
#endif
