// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pair_astuple_pairs_by_type_8a487941).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pair_astuple_pairs_by_type_8a487941 { // libcis
int main(int, char**)
{
...
} // libcis_ns_utilities_utility_pairs_pair_astuple_pairs_by_type_8a487941 (libcis)
