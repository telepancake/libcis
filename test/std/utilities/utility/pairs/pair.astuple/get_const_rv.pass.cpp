// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pair_astuple_get_const_rv_76bd943c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pair_astuple_get_const_rv_76bd943c { // libcis
int main(int, char**)
{
    {
#if TEST_STD_VER >= 11
...
} // libcis_ns_utilities_utility_pairs_pair_astuple_get_const_rv_76bd943c (libcis)
