// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pair_astuple_get_const_rv).
// main -> test_utilities_utility_pairs_pair_astuple_get_const_rv; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_utility_pairs_pair_astuple_get_const_rv()
{
    {
#if TEST_STD_VER >= 11
