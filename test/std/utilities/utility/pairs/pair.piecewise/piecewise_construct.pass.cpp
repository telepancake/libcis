// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pair_piecewise_piecewise_construct_5458fb24).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pair_piecewise_piecewise_construct_5458fb24 { // libcis
class A
{
    int i_;
    char c_;
...
} // libcis_ns_utilities_utility_pairs_pair_piecewise_piecewise_construct_5458fb24 (libcis)
