// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_move).
// main -> test_utilities_utility_pairs_pairs_pair_ctor_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_move { // libcis: isolate file-scope helpers
struct Dummy {
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_move; // libcis


void test_utilities_utility_pairs_pairs_pair_ctor_move()
{
    {
