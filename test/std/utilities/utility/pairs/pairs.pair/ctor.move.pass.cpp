// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_move_3868ee3b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_move_3868ee3b { // libcis
struct Dummy {
...
} // libcis_ns_utilities_utility_pairs_pairs_pair_ctor_move_3868ee3b (libcis)
