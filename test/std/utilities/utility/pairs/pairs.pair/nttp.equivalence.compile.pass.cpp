// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_nttp_equivalence).
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_nttp_equivalence { // libcis: isolate file-scope helpers
int i = 0;
int j = 1;
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_nttp_equivalence; // libcis
