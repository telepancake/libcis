// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_nttp_equivalence_b140584c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_nttp_equivalence_b140584c { // libcis
int i = 0;
int j = 1;
...
} // libcis_ns_utilities_utility_pairs_pairs_pair_nttp_equivalence_b140584c (libcis)
 // namespace test_auto
