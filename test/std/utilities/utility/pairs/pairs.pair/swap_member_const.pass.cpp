// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_swap_member_const).
// main -> test_utilities_utility_pairs_pairs_pair_swap_member_const; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_swap_member_const { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_swap_member_const; // libcis


void test_utilities_utility_pairs_pairs_pair_swap_member_const() {
  test();
