// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_pair_like).
// main -> test_utilities_utility_pairs_pairs_pair_ctor_pair_like; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_pair_like { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_pair_like; // libcis


void test_utilities_utility_pairs_pairs_pair_ctor_pair_like() {
  test();
  static_assert(test());
