// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_default_c665102a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_default_c665102a { // libcis
int main(int, char**) {
  {
...
} // libcis_ns_utilities_utility_pairs_pairs_pair_ctor_default_c665102a (libcis)
