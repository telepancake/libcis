// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_brace_init).
// main -> test_utilities_utility_pairs_pairs_pair_ctor_brace_init; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_brace_init { // libcis: isolate file-scope helpers
struct ExplicitT {
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_brace_init; // libcis


void test_utilities_utility_pairs_pairs_pair_ctor_brace_init() {
    test();
#if TEST_STD_VER > 11
    static_assert(test(), "");
#endif
