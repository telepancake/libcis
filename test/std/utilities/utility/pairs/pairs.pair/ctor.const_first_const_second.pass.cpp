// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_const_first_const_second_fcefd788).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_const_first_const_second_fcefd788 { // libcis
...
} // libcis_ns_utilities_utility_pairs_pairs_pair_ctor_const_first_const_second_fcefd788 (libcis)
