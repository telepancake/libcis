// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_const_first_const_second).
// main -> test_utilities_utility_pairs_pairs_pair_ctor_const_first_const_second; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_const_first_const_second { // libcis: isolate file-scope helpers
struct ExplicitT {
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_const_first_const_second; // libcis


void test_utilities_utility_pairs_pairs_pair_ctor_const_first_const_second()
{
    {
