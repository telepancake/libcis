// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_assign_const_pair_U_V_4825db67).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_const_pair_U_V_4825db67 { // libcis
...
} // libcis_ns_utilities_utility_pairs_pairs_pair_assign_const_pair_U_V_4825db67 (libcis)
