// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_brace_init_P1951_54381144).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_brace_init_P1951_54381144 { // libcis
struct A {
    int *p_;
    A(int *p) : p_(p) { *p_ += 1; }
...
} // libcis_ns_utilities_utility_pairs_pairs_pair_ctor_brace_init_P1951_54381144 (libcis)
