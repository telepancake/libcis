// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_implicit_deduction_guides).
// main -> test_utilities_utility_pairs_pairs_pair_implicit_deduction_guides; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_utility_pairs_pairs_pair_implicit_deduction_guides()
{
