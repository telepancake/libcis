// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_assign_const_copy_convert).
// main -> test_utilities_utility_pairs_pairs_pair_assign_const_copy_convert; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// clang-format off
namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_const_copy_convert { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_const_copy_convert; // libcis


void test_utilities_utility_pairs_pairs_pair_assign_const_copy_convert() {
  test();
