// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_special_member_generation_test_aa6299dd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_special_member_generation_test_aa6299dd { // libcis
...
} // libcis_ns_utilities_utility_pairs_pairs_pair_special_member_generation_test_aa6299dd (libcis)
