// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_special_member_generation_test).
// main -> test_utilities_utility_pairs_pairs_pair_special_member_generation_test; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_special_member_generation_test { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_special_member_generation_test; // libcis
...
void test_utilities_utility_pairs_pairs_pair_special_member_generation_test() {
