// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_pair_U_V_move_426bd681).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_move_426bd681 { // libcis
...
} // libcis_ns_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_move_426bd681 (libcis)
