// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_U_V_226be3c5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_U_V_226be3c5 { // libcis
...
} // libcis_ns_utilities_utility_pairs_pairs_pair_ctor_U_V_226be3c5 (libcis)
