// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_assign_pair_like_rv).
// main -> test_utilities_utility_pairs_pairs_pair_assign_pair_like_rv; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_pair_like_rv { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_pair_like_rv; // libcis


void test_utilities_utility_pairs_pairs_pair_assign_pair_like_rv() {
  test();
  static_assert(test());
