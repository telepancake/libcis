// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_default_sfinae_LWG2367).
// main -> test_utilities_utility_pairs_pairs_pair_ctor_default_sfinae_LWG2367; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_default_sfinae_LWG2367 { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_default_sfinae_LWG2367; // libcis



void test_utilities_utility_pairs_pairs_pair_ctor_default_sfinae_LWG2367()
{
    {
