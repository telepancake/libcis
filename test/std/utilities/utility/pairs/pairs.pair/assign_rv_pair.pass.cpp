// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_assign_rv_pair_88f4bf67).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_rv_pair_88f4bf67 { // libcis
struct CountAssign {
  int copied = 0;
  int moved = 0;
...
} // libcis_ns_utilities_utility_pairs_pairs_pair_assign_rv_pair_88f4bf67 (libcis)
