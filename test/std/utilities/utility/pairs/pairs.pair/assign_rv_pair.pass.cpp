// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_assign_rv_pair).
// main -> test_utilities_utility_pairs_pairs_pair_assign_rv_pair; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_rv_pair { // libcis: isolate file-scope helpers
struct CountAssign {
  int copied = 0;
  int moved = 0;
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_rv_pair; // libcis


void test_utilities_utility_pairs_pairs_pair_assign_rv_pair() {
  test();
#if TEST_STD_VER >= 20
  static_assert(test());
#endif
