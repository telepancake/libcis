// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_assign_rv_pair_U_V_6eac6299).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_rv_pair_U_V_6eac6299 { // libcis
...
} // libcis_ns_utilities_utility_pairs_pairs_pair_assign_rv_pair_U_V_6eac6299 (libcis)
