// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_assign_rv_pair_U_V).
// main -> test_utilities_utility_pairs_pairs_pair_assign_rv_pair_U_V; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_rv_pair_U_V { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_rv_pair_U_V; // libcis


void test_utilities_utility_pairs_pairs_pair_assign_rv_pair_U_V() {
  test();
#if TEST_STD_VER >= 20
  static_assert(test());
#endif
