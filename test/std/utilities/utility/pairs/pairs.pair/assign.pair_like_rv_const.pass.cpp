// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_assign_pair_like_rv_const).
// main -> test_utilities_utility_pairs_pairs_pair_assign_pair_like_rv_const; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_pair_like_rv_const { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_pair_like_rv_const; // libcis


void test_utilities_utility_pairs_pairs_pair_assign_pair_like_rv_const() {
  test();
  static_assert(test());
