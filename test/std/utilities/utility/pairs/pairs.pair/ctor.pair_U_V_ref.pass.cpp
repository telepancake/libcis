// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_pair_U_V_ref).
// main -> test_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_ref; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_ref { // libcis: isolate file-scope helpers
struct X {};
struct Y {};
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_ref; // libcis


void test_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_ref() {
  test();
  static_assert(test());
  return;
}
