// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_pair_U_V_const_move).
// main -> test_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_const_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_const_move { // libcis: isolate file-scope helpers
struct X {};
struct Y {};
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_const_move; // libcis


void test_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_const_move() {
  test();
  static_assert(test());
  return;
}
