// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_assign_pair_09fbcded).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_assign_pair_09fbcded { // libcis
struct CountAssign {
  int copied = 0;
  int moved = 0;
...
struct Incomplete {};
Incomplete inc_obj;
} // libcis_ns_utilities_utility_pairs_pairs_pair_assign_pair_09fbcded (libcis)
