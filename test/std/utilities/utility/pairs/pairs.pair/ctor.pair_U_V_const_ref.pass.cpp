// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_pair_U_V_const_ref).
// main -> test_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_const_ref; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_const_ref { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_const_ref; // libcis


void test_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_const_ref() {
  test();
#if TEST_STD_VER >= 20
  static_assert(test());
#endif
