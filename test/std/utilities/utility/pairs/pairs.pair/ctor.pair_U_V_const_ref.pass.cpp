// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_pair_ctor_pair_U_V_const_ref_0e40b0d0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_const_ref_0e40b0d0 { // libcis
...
} // libcis_ns_utilities_utility_pairs_pairs_pair_ctor_pair_U_V_const_ref_0e40b0d0 (libcis)
