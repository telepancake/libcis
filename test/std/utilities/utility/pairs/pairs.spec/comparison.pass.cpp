// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_spec_comparison_801efd5d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_spec_comparison_801efd5d { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_utilities_utility_pairs_pairs_spec_comparison_801efd5d (libcis)
