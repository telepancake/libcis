// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_spec_three_way_comparison).
// main -> test_utilities_utility_pairs_pairs_spec_three_way_comparison; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_spec_three_way_comparison { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_spec_three_way_comparison; // libcis


void test_utilities_utility_pairs_pairs_spec_three_way_comparison() {
  test();
  static_assert(test());
