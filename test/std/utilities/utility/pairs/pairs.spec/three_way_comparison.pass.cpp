// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_spec_three_way_comparison_cb287397).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_spec_three_way_comparison_cb287397 { // libcis
template <class T>
...
} // libcis_ns_utilities_utility_pairs_pairs_spec_three_way_comparison_cb287397 (libcis)
