// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_spec_make_pair_989207c3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_spec_make_pair_989207c3 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_utilities_utility_pairs_pairs_spec_make_pair_989207c3 (libcis)
