// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_spec_make_pair).
// main -> test_utilities_utility_pairs_pairs_spec_make_pair; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_utility_pairs_pairs_spec_make_pair()
{
    {
