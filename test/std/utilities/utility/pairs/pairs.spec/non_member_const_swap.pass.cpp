// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_pairs_pairs_spec_non_member_const_swap).
// main -> test_utilities_utility_pairs_pairs_spec_non_member_const_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_pairs_pairs_spec_non_member_const_swap { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_pairs_pairs_spec_non_member_const_swap; // libcis


void test_utilities_utility_pairs_pairs_spec_non_member_const_swap() {
  test();
