// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_utility_inplace_inplace_7a777697).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_utility_inplace_inplace_7a777697 { // libcis
...
} // libcis_ns_utilities_utility_utility_inplace_inplace_7a777697 (libcis)
