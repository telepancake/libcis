// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_as_const_as_const).
// main -> test_utilities_utility_as_const_as_const; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_as_const_as_const { // libcis: isolate file-scope helpers
struct S {int i;};
...
} using namespace libcis_ns_utilities_utility_as_const_as_const; // libcis


void test_utilities_utility_as_const_as_const()
{
    int i = 3;
    double d = 4.0;
    S s{2};
