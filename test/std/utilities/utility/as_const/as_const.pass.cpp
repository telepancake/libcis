// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_as_const_as_const_9ba7b00f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_as_const_as_const_9ba7b00f { // libcis
struct S {int i;};
...
} // libcis_ns_utilities_utility_as_const_as_const_9ba7b00f (libcis)
