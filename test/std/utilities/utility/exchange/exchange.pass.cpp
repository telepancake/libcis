// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_exchange_exchange).
// main -> test_utilities_utility_exchange_exchange; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER > 17
namespace libcis_ns_utilities_utility_exchange_exchange { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_exchange_exchange; // libcis


void test_utilities_utility_exchange_exchange()
{
    {
    int v = 12;
