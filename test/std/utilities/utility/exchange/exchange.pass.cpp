// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_exchange_exchange_5db8637e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_exchange_exchange_5db8637e { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_utilities_utility_exchange_exchange_5db8637e (libcis)
