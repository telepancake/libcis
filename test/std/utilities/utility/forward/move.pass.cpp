// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_forward_move).
// main -> test_utilities_utility_forward_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_forward_move { // libcis: isolate file-scope helpers
class move_only
{
...
} using namespace libcis_ns_utilities_utility_forward_move; // libcis

#endif
void test_utilities_utility_forward_move()
{
