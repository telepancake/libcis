// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_forward_move_e365fe60).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_forward_move_e365fe60 { // libcis
class move_only
{
...
} // libcis_ns_utilities_utility_forward_move_e365fe60 (libcis)
