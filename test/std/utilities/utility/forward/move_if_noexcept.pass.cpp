// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_forward_move_if_noexcept_79886f85).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_forward_move_if_noexcept_79886f85 { // libcis
class A
{
    A(const A&);
    A& operator=(const A&);
...
} // libcis_ns_utilities_utility_forward_move_if_noexcept_79886f85 (libcis)
