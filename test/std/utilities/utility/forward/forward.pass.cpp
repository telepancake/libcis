// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_forward_forward_9e886b0a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_forward_forward_9e886b0a { // libcis
struct A
{
};
...
} // libcis_ns_utilities_utility_forward_forward_9e886b0a (libcis)
