// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_forward_forward).
// main -> test_utilities_utility_forward_forward; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_forward_forward { // libcis: isolate file-scope helpers
struct A
{
};
...
} using namespace libcis_ns_utilities_utility_forward_forward; // libcis

#endif

void test_utilities_utility_forward_forward()
{
    A a;
    const A ca = A();
