// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_utility_intcmp_intcmp_cmp_not_equal_cmp_not_equal_bb4b2822).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_not_equal_cmp_not_equal_bb4b2822 { // libcis
template <typename T>
struct Tuple {
  T min;
  T max;
...
} // libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_not_equal_cmp_not_equal_bb4b2822 (libcis)
