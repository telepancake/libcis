// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_utility_intcmp_intcmp_in_range_in_range).
// main -> test_utilities_utility_utility_intcmp_intcmp_in_range_in_range; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_utility_intcmp_intcmp_in_range_in_range { // libcis: isolate file-scope helpers
template <typename T>
struct Tuple {
  T min;
  T max;
...
} using namespace libcis_ns_utilities_utility_utility_intcmp_intcmp_in_range_in_range; // libcis


void test_utilities_utility_utility_intcmp_intcmp_in_range_in_range() {
