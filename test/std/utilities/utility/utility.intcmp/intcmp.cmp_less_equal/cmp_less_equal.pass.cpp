// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_utility_intcmp_intcmp_cmp_less_equal_cmp_less_equal_e12aa12f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_less_equal_cmp_less_equal_e12aa12f { // libcis
template <typename T>
struct Tuple {
  T min;
  T max;
...
} // libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_less_equal_cmp_less_equal_e12aa12f (libcis)
