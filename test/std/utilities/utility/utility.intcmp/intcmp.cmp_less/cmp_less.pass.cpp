// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_utility_intcmp_intcmp_cmp_less_cmp_less_ea21cedf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_less_cmp_less_ea21cedf { // libcis
template <typename T>
struct Tuple {
  T min;
  T max;
...
} // libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_less_cmp_less_ea21cedf (libcis)
