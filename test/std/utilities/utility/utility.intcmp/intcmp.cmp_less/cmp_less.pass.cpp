// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_utility_intcmp_intcmp_cmp_less_cmp_less).
// main -> test_utilities_utility_utility_intcmp_intcmp_cmp_less_cmp_less; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_less_cmp_less { // libcis: isolate file-scope helpers
template <typename T>
struct Tuple {
  T min;
  T max;
...
} using namespace libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_less_cmp_less; // libcis


void test_utilities_utility_utility_intcmp_intcmp_cmp_less_cmp_less() {
