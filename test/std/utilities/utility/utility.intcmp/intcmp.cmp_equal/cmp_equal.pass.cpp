// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_utility_intcmp_intcmp_cmp_equal_cmp_equal_8915488b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_equal_cmp_equal_8915488b { // libcis
template <typename T>
struct Tuple {
  T min;
  T max;
...
} // libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_equal_cmp_equal_8915488b (libcis)
