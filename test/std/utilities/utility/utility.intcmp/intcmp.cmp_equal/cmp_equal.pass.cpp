// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_utility_intcmp_intcmp_cmp_equal_cmp_equal).
// main -> test_utilities_utility_utility_intcmp_intcmp_cmp_equal_cmp_equal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_equal_cmp_equal { // libcis: isolate file-scope helpers
template <typename T>
struct Tuple {
  T min;
  T max;
...
} using namespace libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_equal_cmp_equal; // libcis


void test_utilities_utility_utility_intcmp_intcmp_cmp_equal_cmp_equal() {
