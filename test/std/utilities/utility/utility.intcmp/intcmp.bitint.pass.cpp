// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_utility_intcmp_intcmp_bitint).
// main -> test_utilities_utility_utility_intcmp_intcmp_bitint; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_utility_utility_intcmp_intcmp_bitint() {
#if TEST_HAS_EXTENSION(bit_int)
  test();
  static_assert(test());
#endif
