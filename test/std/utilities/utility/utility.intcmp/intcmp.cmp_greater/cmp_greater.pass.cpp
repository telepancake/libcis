// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_utility_intcmp_intcmp_cmp_greater_cmp_greater_bad651c1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_greater_cmp_greater_bad651c1 { // libcis
template <typename T>
struct Tuple {
  T min;
  T max;
...
} // libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_greater_cmp_greater_bad651c1 (libcis)
