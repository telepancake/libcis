// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_utility_intcmp_intcmp_cmp_greater_cmp_greater).
// main -> test_utilities_utility_utility_intcmp_intcmp_cmp_greater_cmp_greater; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_greater_cmp_greater { // libcis: isolate file-scope helpers
template <typename T>
struct Tuple {
  T min;
  T max;
...
} using namespace libcis_ns_utilities_utility_utility_intcmp_intcmp_cmp_greater_cmp_greater; // libcis


void test_utilities_utility_utility_intcmp_intcmp_cmp_greater_cmp_greater() {
