// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_utility_swap_swap).
// main -> test_utilities_utility_utility_swap_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER >= 11
namespace libcis_ns_utilities_utility_utility_swap_swap { // libcis: isolate file-scope helpers
struct CopyOnly {
    CopyOnly() {}
...
} using namespace libcis_ns_utilities_utility_utility_swap_swap; // libcis

#endif // TEST_STD_VER > 17

void test_utilities_utility_utility_swap_swap()
{
