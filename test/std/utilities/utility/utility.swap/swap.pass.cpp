// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_utility_swap_swap_5df203c1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_utility_swap_swap_5df203c1 { // libcis
#if TEST_STD_VER >= 11
struct CopyOnly {
    CopyOnly() {}
...
} // libcis_ns_utilities_utility_utility_swap_swap_5df203c1 (libcis)
