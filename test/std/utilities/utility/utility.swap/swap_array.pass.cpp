// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_utility_swap_swap_array).
// main -> test_utilities_utility_utility_swap_swap_array; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER >= 11
namespace libcis_ns_utilities_utility_utility_swap_swap_array { // libcis: isolate file-scope helpers
struct CopyOnly {
...
} using namespace libcis_ns_utilities_utility_utility_swap_swap_array; // libcis


void test_utilities_utility_utility_swap_swap_array() {
  test();
#if TEST_STD_VER >= 20
  static_assert(test());
#endif
