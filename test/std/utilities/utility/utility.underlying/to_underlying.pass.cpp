// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_utility_underlying_to_underlying).
// main -> test_utilities_utility_utility_underlying_to_underlying; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_utility_underlying_to_underlying { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_utility_underlying_to_underlying; // libcis


void test_utilities_utility_utility_underlying_to_underlying() {
  test();
  static_assert(test());
