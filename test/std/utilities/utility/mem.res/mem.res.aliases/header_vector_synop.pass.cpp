// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_aliases_header_vector_synop).
// main -> test_utilities_utility_mem_res_mem_res_aliases_header_vector_synop; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_utility_mem_res_mem_res_aliases_header_vector_synop() {
