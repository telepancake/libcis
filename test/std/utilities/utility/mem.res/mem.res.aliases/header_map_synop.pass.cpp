// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_aliases_header_map_synop_6ff18238).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_map_synop_6ff18238 { // libcis
int main(int, char**) {
  using K  = int;
  using V  = char;
...
} // libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_map_synop_6ff18238 (libcis)
