// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_aliases_header_regex_synop).
// main -> test_utilities_utility_mem_res_mem_res_aliases_header_regex_synop; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_regex_synop { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_regex_synop; // libcis


void test_utilities_utility_mem_res_mem_res_aliases_header_regex_synop() {
  {
