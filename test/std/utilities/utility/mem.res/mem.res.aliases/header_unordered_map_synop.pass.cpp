// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_aliases_header_unordered_map_synop_2c006afa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_unordered_map_synop_2c006afa { // libcis
template <class T>
...
} // libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_unordered_map_synop_2c006afa (libcis)
