// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_aliases_header_set_synop_def65980).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_set_synop_def65980 { // libcis
int main(int, char**) {
  using V  = char;
  using DC = std::less<V>;
...
} // libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_set_synop_def65980 (libcis)
