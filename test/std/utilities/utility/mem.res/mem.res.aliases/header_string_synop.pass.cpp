// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_aliases_header_string_synop_26ea3996).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_string_synop_26ea3996 { // libcis
...
} // libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_string_synop_26ea3996 (libcis)
