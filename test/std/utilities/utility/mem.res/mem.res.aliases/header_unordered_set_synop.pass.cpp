// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_aliases_header_unordered_set_synop_17e67dcb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_unordered_set_synop_17e67dcb { // libcis
template <class T>
...
} // libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_unordered_set_synop_17e67dcb (libcis)
