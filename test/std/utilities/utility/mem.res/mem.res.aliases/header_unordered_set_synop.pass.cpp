// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_aliases_header_unordered_set_synop).
// main -> test_utilities_utility_mem_res_mem_res_aliases_header_unordered_set_synop; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_unordered_set_synop { // libcis: isolate file-scope helpers
template <class T>
struct MyHash : std::hash<T> {};

template <class T>
struct MyPred : std::equal_to<T> {};
} using namespace libcis_ns_utilities_utility_mem_res_mem_res_aliases_header_unordered_set_synop; // libcis


void test_utilities_utility_mem_res_mem_res_aliases_header_unordered_set_synop() {
  using V  = char;
  using DH = std::hash<V>;
  using MH = MyHash<V>;
