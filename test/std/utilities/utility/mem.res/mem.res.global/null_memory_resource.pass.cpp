// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_global_null_memory_resource_52c0e24a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_global_null_memory_resource_52c0e24a { // libcis
...
} // libcis_ns_utilities_utility_mem_res_mem_res_global_null_memory_resource_52c0e24a (libcis)
