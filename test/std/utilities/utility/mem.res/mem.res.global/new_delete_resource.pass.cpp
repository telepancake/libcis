// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_global_new_delete_resource_e9f93bd8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_global_new_delete_resource_e9f93bd8 { // libcis
...
} // libcis_ns_utilities_utility_mem_res_mem_res_global_new_delete_resource_e9f93bd8 (libcis)
