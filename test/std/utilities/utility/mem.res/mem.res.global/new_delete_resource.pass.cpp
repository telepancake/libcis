// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_global_new_delete_resource).
// main -> test_utilities_utility_mem_res_mem_res_global_new_delete_resource; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_global_new_delete_resource { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_mem_res_mem_res_global_new_delete_resource; // libcis


void test_utilities_utility_mem_res_mem_res_global_new_delete_resource() {
