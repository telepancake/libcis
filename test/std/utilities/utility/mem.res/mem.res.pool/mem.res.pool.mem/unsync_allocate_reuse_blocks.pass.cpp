// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_reuse_blocks_8740476a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_reuse_blocks_8740476a { // libcis
...
} // libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_reuse_blocks_8740476a (libcis)
