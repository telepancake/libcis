// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_overaligned_request).
// main -> test_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_overaligned_request; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_overaligned_request { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_overaligned_request; // libcis


void test_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_overaligned_request() {
