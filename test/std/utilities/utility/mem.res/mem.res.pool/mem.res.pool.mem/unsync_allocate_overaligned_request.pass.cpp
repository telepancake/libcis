// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_overaligned_request_7113dbcb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_overaligned_request_7113dbcb { // libcis
...
} // libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_overaligned_request_7113dbcb (libcis)
