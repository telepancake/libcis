// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_overaligned_request_c9f15e3d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_overaligned_request_c9f15e3d { // libcis
...
} // libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_overaligned_request_c9f15e3d (libcis)
