// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_reuse_blocks_c2013bb2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_reuse_blocks_c2013bb2 { // libcis
...
} // libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_reuse_blocks_c2013bb2 (libcis)
