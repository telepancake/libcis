// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_reuse_blocks).
// main -> test_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_reuse_blocks; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_reuse_blocks { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_reuse_blocks; // libcis


void test_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_reuse_blocks() {
