// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate).
// main -> test_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate() {
