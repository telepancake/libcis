// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_1a98d0e8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_1a98d0e8 { // libcis
int main(int, char**) {
...
} // libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_sync_allocate_1a98d0e8 (libcis)
