// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_02fc098b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_02fc098b { // libcis
int main(int, char**) {
...
} // libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_mem_unsync_allocate_02fc098b (libcis)
