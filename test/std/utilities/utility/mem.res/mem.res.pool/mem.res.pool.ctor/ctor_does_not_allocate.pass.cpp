// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_pool_mem_res_pool_ctor_ctor_does_not_allocate_99c0efd8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_ctor_ctor_does_not_allocate_99c0efd8 { // libcis
...
} // libcis_ns_utilities_utility_mem_res_mem_res_pool_mem_res_pool_ctor_ctor_does_not_allocate_99c0efd8 (libcis)
