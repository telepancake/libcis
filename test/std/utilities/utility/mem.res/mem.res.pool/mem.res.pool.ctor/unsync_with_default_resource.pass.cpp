// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_res_pool_mem_res_pool_ctor_unsync_with_default_resource).
// main -> test_utilities_utility_mem_res_mem_res_pool_mem_res_pool_ctor_unsync_with_default_resource; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_utility_mem_res_mem_res_pool_mem_res_pool_ctor_unsync_with_default_resource() {
