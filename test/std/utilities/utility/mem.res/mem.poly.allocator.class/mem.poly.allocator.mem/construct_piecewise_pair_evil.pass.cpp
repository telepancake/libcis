// AST-transferred from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_poly_allocator_class_mem_poly_allocator_mem_construct_piecewise_pair_evil).
// main -> test_utilities_utility_mem_res_mem_poly_allocator_class_mem_poly_allocator_mem_construct_piecewise_pair_evil; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_poly_allocator_class_mem_poly_allocator_mem_construct_piecewise_pair_evil { // libcis: isolate file-scope helpers
template <class T>
struct EvilAlloc {
...
} using namespace libcis_ns_utilities_utility_mem_res_mem_poly_allocator_class_mem_poly_allocator_mem_construct_piecewise_pair_evil; // libcis


void test_utilities_utility_mem_res_mem_poly_allocator_class_mem_poly_allocator_mem_construct_piecewise_pair_evil() {
