// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_utility_mem_res_mem_poly_allocator_class_mem_poly_allocator_mem_construct_piecewise_pair_evil_79dbe447).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_utility_mem_res_mem_poly_allocator_class_mem_poly_allocator_mem_construct_piecewise_pair_evil_79dbe447 { // libcis
template <class T>
struct EvilAlloc {
...
} // libcis_ns_utilities_utility_mem_res_mem_poly_allocator_class_mem_poly_allocator_mem_construct_piecewise_pair_evil_79dbe447 (libcis)
