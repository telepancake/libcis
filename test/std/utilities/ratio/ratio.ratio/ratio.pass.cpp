// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_ratio_ratio_ratio_ratio_babf7d40).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_ratio_ratio_ratio_ratio_babf7d40 { // libcis
...
} // libcis_ns_utilities_ratio_ratio_ratio_ratio_babf7d40 (libcis)
