// AST-transferred from libc++ by tools/transfer.py (slug=utilities_ratio_typedefs).
// main -> test_utilities_ratio_typedefs; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_ratio_typedefs()
{
