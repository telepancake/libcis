// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_ratio_ratio_comparison_ratio_less_9ed7af6c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_ratio_ratio_comparison_ratio_less_9ed7af6c { // libcis
...
} // libcis_ns_utilities_ratio_ratio_comparison_ratio_less_9ed7af6c (libcis)
