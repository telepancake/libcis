// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_ratio_ratio_comparison_ratio_equal_dc4780e0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_ratio_ratio_comparison_ratio_equal_dc4780e0 { // libcis
...
} // libcis_ns_utilities_ratio_ratio_comparison_ratio_equal_dc4780e0 (libcis)
