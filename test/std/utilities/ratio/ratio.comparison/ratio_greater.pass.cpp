// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_ratio_ratio_comparison_ratio_greater_057629cd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_ratio_ratio_comparison_ratio_greater_057629cd { // libcis
...
} // libcis_ns_utilities_ratio_ratio_comparison_ratio_greater_057629cd (libcis)
