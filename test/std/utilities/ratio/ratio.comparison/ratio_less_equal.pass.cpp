// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_ratio_ratio_comparison_ratio_less_equal_a24cbec8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_ratio_ratio_comparison_ratio_less_equal_a24cbec8 { // libcis
...
} // libcis_ns_utilities_ratio_ratio_comparison_ratio_less_equal_a24cbec8 (libcis)
