// AST-transferred from libc++ by tools/transfer.py (slug=utilities_ratio_ratio_arithmetic_ratio_divide).
// main -> test_utilities_ratio_ratio_arithmetic_ratio_divide; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_ratio_ratio_arithmetic_ratio_divide()
{
    {
