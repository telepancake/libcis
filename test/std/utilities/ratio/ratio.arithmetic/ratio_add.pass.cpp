// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_ratio_ratio_arithmetic_ratio_add_9aa744b3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_ratio_ratio_arithmetic_ratio_add_9aa744b3 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_utilities_ratio_ratio_arithmetic_ratio_add_9aa744b3 (libcis)
