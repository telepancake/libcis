// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_apply_apply_extended_types).
// main -> test_utilities_tuple_tuple_tuple_tuple_apply_apply_extended_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_apply_apply_extended_types { // libcis: isolate file-scope helpers
int count = 0;
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_apply_apply_extended_types; // libcis


void test_utilities_tuple_tuple_tuple_tuple_apply_apply_extended_types()
{
    {
        test_ext_int_0<
