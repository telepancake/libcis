// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_apply_apply_extended_types_04faca70).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_apply_apply_extended_types_04faca70 { // libcis
int count = 0;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_apply_apply_extended_types_04faca70 (libcis)
