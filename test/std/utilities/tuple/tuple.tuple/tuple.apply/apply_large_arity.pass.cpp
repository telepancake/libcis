// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_apply_apply_large_arity_cc0e5a74).
//===----------------------------------------------------------------------===//
//
...
////////////////////////////////////////////////////////////////////////////////
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_apply_apply_large_arity_cc0e5a74 { // libcis
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_apply_apply_large_arity_cc0e5a74 (libcis)
