// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_apply_apply).
// main -> test_utilities_tuple_tuple_tuple_tuple_apply_apply; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_apply_apply { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_apply_apply; // libcis
...
void test_utilities_tuple_tuple_tuple_tuple_apply_apply() {
