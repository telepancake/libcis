// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_helper_tuple_include_utility_201a7eef).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_helper_tuple_include_utility_201a7eef { // libcis
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_helper_tuple_include_utility_201a7eef (libcis)
