// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_helper_tuple_include_utility).
// main -> test_utilities_tuple_tuple_tuple_tuple_helper_tuple_include_utility; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_helper_tuple_include_utility { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_helper_tuple_include_utility; // libcis


void test_utilities_tuple_tuple_tuple_tuple_helper_tuple_include_utility()
{
