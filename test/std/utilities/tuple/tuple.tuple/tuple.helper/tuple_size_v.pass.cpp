// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_helper_tuple_size_v).
// main -> test_utilities_tuple_tuple_tuple_tuple_helper_tuple_size_v; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_helper_tuple_size_v { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_helper_tuple_size_v; // libcis


void test_utilities_tuple_tuple_tuple_tuple_helper_tuple_size_v()
{
    test<std::tuple<>, 0>();
