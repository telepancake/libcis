// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_helper_tuple_size_v_a1578bbd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_helper_tuple_size_v_a1578bbd { // libcis
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_helper_tuple_size_v_a1578bbd (libcis)
