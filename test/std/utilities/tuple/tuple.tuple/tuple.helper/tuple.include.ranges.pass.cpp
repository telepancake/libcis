// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_helper_tuple_include_ranges_f99a36d9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_helper_tuple_include_ranges_f99a36d9 { // libcis
using Iterator = int*;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_helper_tuple_include_ranges_f99a36d9 (libcis)
