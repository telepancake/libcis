// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_helper_tuple_include_ranges).
// main -> test_utilities_tuple_tuple_tuple_tuple_helper_tuple_include_ranges; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_helper_tuple_include_ranges { // libcis: isolate file-scope helpers
using Iterator = int*;
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_helper_tuple_include_ranges; // libcis


void test_utilities_tuple_tuple_tuple_tuple_helper_tuple_include_ranges() {
