// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_creation_tuple_cat_7db0e939).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_creation_tuple_cat_7db0e939 { // libcis
namespace NS {
struct Namespaced {
  int i;
};
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_creation_tuple_cat_7db0e939 (libcis)
