// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_creation_tuple_cat).
// main -> test_utilities_tuple_tuple_tuple_tuple_creation_tuple_cat; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_creation_tuple_cat { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_creation_tuple_cat; // libcis


void test_utilities_tuple_tuple_tuple_tuple_creation_tuple_cat()
{
    {
