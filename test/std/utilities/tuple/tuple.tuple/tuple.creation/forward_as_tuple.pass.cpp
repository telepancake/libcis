// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_creation_forward_as_tuple).
// main -> test_utilities_tuple_tuple_tuple_tuple_creation_forward_as_tuple; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_creation_forward_as_tuple { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_creation_forward_as_tuple; // libcis

#endif

void test_utilities_tuple_tuple_tuple_tuple_creation_forward_as_tuple()
{
    {
