// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_creation_forward_as_tuple_8e89685d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_creation_forward_as_tuple_8e89685d { // libcis
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_creation_forward_as_tuple_8e89685d (libcis)
