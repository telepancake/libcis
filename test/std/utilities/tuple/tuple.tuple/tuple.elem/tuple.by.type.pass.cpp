// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_elem_tuple_by_type).
// main -> test_utilities_tuple_tuple_tuple_tuple_elem_tuple_by_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_tuple_tuple_tuple_tuple_elem_tuple_by_type()
{
