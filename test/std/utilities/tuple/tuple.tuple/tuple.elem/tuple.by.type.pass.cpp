// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_elem_tuple_by_type_0009e684).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_elem_tuple_by_type_0009e684 { // libcis
int main(int, char**)
{
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_elem_tuple_by_type_0009e684 (libcis)
