// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_elem_get_non_const).
// main -> test_utilities_tuple_tuple_tuple_tuple_elem_get_non_const; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_elem_get_non_const { // libcis: isolate file-scope helpers
struct Empty {};
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_elem_get_non_const; // libcis

#endif

void test_utilities_tuple_tuple_tuple_tuple_elem_get_non_const()
{
    {
