// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_elem_get_non_const_db843cfc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_elem_get_non_const_db843cfc { // libcis
#if TEST_STD_VER > 11
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_elem_get_non_const_db843cfc (libcis)
