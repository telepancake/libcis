// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_elem_get_const_rv_f5dfc9bf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_elem_get_const_rv_f5dfc9bf { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_elem_get_const_rv_f5dfc9bf (libcis)
