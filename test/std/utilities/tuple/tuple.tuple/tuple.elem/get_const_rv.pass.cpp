// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_elem_get_const_rv).
// main -> test_utilities_tuple_tuple_tuple_tuple_elem_get_const_rv; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_tuple_tuple_tuple_tuple_elem_get_const_rv()
{
    {
