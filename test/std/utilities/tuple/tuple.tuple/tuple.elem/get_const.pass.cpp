// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_elem_get_const_d953b29b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_elem_get_const_d953b29b { // libcis
struct Empty {};
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_elem_get_const_d953b29b (libcis)
