// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_special_non_member_swap).
// main -> test_utilities_tuple_tuple_tuple_tuple_special_non_member_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_tuple_tuple_tuple_tuple_special_non_member_swap()
{
    {
        typedef std::tuple<> T;
        T t0;
