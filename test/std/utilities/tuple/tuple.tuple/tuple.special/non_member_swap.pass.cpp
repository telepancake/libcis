// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_special_non_member_swap_f64d3453).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_special_non_member_swap_f64d3453 { // libcis
int main(int, char**)
{
    {
        typedef std::tuple<> T;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_special_non_member_swap_f64d3453 (libcis)
