// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_special_non_member_swap_const).
// main -> test_utilities_tuple_tuple_tuple_tuple_special_non_member_swap_const; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_special_non_member_swap_const { // libcis: isolate file-scope helpers
struct S {
  int* calls;
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_special_non_member_swap_const; // libcis


void test_utilities_tuple_tuple_tuple_tuple_special_non_member_swap_const() {
  test();
  static_assert(test());
