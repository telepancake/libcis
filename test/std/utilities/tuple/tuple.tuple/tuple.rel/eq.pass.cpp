// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_rel_eq_4bd697b0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_rel_eq_4bd697b0 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_rel_eq_4bd697b0 (libcis)
