// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_rel_size_incompatible_three_way).
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_rel_size_incompatible_three_way { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_rel_size_incompatible_three_way; // libcis
