// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_assign_move_pair_f9db95a3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_move_pair_f9db95a3 { // libcis
struct B
{
    int id_;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_move_pair_f9db95a3 (libcis)
