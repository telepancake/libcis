// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_assign_move_pair).
// main -> test_utilities_tuple_tuple_tuple_tuple_assign_move_pair; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_move_pair { // libcis: isolate file-scope helpers
struct B
{
    int id_;
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_move_pair; // libcis


void test_utilities_tuple_tuple_tuple_tuple_assign_move_pair()
{
    {
