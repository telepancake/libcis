// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_assign_convert_copy_66b2e895).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_convert_copy_66b2e895 { // libcis
struct B {
    int id_;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_convert_copy_66b2e895 (libcis)
