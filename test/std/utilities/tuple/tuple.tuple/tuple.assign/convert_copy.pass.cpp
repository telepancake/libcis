// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_assign_convert_copy).
// main -> test_utilities_tuple_tuple_tuple_tuple_assign_convert_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_convert_copy { // libcis: isolate file-scope helpers
struct B {
    int id_;
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_convert_copy; // libcis


void test_utilities_tuple_tuple_tuple_tuple_assign_convert_copy()
{
    test();
#if TEST_STD_VER >= 20
    static_assert(test());
