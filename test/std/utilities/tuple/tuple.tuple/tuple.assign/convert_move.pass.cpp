// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_assign_convert_move_1bba0c3f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_convert_move_1bba0c3f { // libcis
struct B {
    int id_;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_convert_move_1bba0c3f (libcis)
