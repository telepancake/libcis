// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_assign_laziness).
// main -> test_utilities_tuple_tuple_tuple_tuple_assign_laziness; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_laziness { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_laziness; // libcis


void test_utilities_tuple_tuple_tuple_tuple_assign_laziness() {
  test_arity_checks();
