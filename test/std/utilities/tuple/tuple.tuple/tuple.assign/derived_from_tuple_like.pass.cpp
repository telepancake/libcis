// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_assign_derived_from_tuple_like).
// main -> test_utilities_tuple_tuple_tuple_tuple_assign_derived_from_tuple_like; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_derived_from_tuple_like { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_derived_from_tuple_like; // libcis


void test_utilities_tuple_tuple_tuple_tuple_assign_derived_from_tuple_like() {
