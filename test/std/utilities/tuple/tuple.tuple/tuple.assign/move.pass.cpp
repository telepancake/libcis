// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_assign_move).
// main -> test_utilities_tuple_tuple_tuple_tuple_assign_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_move { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_move; // libcis
...
void test_utilities_tuple_tuple_tuple_tuple_assign_move()
{
    test();
#if TEST_STD_VER >= 20
    static_assert(test());
