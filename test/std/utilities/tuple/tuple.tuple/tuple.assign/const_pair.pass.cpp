// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_assign_const_pair).
// main -> test_utilities_tuple_tuple_tuple_tuple_assign_const_pair; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_const_pair { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_const_pair; // libcis


void test_utilities_tuple_tuple_tuple_tuple_assign_const_pair()
{
    test();
#if TEST_STD_VER >= 20
    static_assert(test());
