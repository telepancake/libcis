// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_assign_const_pair_fa888a81).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_const_pair_fa888a81 { // libcis
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_assign_const_pair_fa888a81 (libcis)
