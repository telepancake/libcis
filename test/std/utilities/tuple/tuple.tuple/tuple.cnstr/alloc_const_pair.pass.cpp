// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_const_pair).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_const_pair; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_const_pair()
{
    {
