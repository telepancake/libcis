// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_test_lazy_sfinae).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_test_lazy_sfinae; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_test_lazy_sfinae { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_test_lazy_sfinae; // libcis


void test_utilities_tuple_tuple_tuple_tuple_cnstr_test_lazy_sfinae() {
