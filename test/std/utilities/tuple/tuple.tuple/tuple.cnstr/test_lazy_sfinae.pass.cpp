// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_test_lazy_sfinae_997c7e7a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_test_lazy_sfinae_997c7e7a { // libcis
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_test_lazy_sfinae_997c7e7a (libcis)
