// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_PR23256_constrain_UTypes_ctor).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_PR23256_constrain_UTypes_ctor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_PR23256_constrain_UTypes_ctor { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_PR23256_constrain_UTypes_ctor; // libcis


void test_utilities_tuple_tuple_tuple_tuple_cnstr_PR23256_constrain_UTypes_ctor() {
