// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_convert_move_d438f4ef).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_convert_move_d438f4ef { // libcis
struct Explicit {
  int value;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_convert_move_d438f4ef (libcis)
