// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_default).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_default; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_default { // libcis: isolate file-scope helpers
struct NoDefault {
    NoDefault() = delete;
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_default; // libcis


void test_utilities_tuple_tuple_tuple_tuple_cnstr_default()
{
    {
        std::tuple<> t;
        (void)t;
