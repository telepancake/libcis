// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_default_64c0c781).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_default_64c0c781 { // libcis
struct NoDefault {
    NoDefault() = delete;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_default_64c0c781 (libcis)
