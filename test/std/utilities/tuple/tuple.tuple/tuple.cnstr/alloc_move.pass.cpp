// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_move).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_move()
{
    {
        typedef std::tuple<> T;
        T t0;
