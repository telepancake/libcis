// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_move_2b8bf854).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_move_2b8bf854 { // libcis
int main(int, char**)
{
    {
        typedef std::tuple<> T;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_move_2b8bf854 (libcis)
