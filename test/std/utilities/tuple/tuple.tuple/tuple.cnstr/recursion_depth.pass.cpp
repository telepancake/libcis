// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_recursion_depth_ba8cb3a1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_recursion_depth_ba8cb3a1 { // libcis
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_recursion_depth_ba8cb3a1 (libcis)
