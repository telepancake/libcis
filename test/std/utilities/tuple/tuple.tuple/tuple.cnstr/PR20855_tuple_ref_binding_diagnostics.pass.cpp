// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_PR20855_tuple_ref_binding_diagnostics).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_PR20855_tuple_ref_binding_diagnostics; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_PR20855_tuple_ref_binding_diagnostics { // libcis: isolate file-scope helpers
template <class Tp>
struct ConvertsTo {
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_PR20855_tuple_ref_binding_diagnostics; // libcis



void test_utilities_tuple_tuple_tuple_tuple_cnstr_PR20855_tuple_ref_binding_diagnostics() {
  compile_tests();
  allocator_tests();
