// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_copy).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_copy()
{
    {
        typedef std::tuple<> T;
        T t0;
