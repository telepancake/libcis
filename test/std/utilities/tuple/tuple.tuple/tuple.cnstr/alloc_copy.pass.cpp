// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_copy_c74f6859).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_copy_c74f6859 { // libcis
int main(int, char**)
{
    {
        typedef std::tuple<> T;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_copy_c74f6859 (libcis)
