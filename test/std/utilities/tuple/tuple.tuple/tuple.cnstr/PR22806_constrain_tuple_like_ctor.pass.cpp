// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_PR22806_constrain_tuple_like_ctor).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_PR22806_constrain_tuple_like_ctor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_PR22806_constrain_tuple_like_ctor { // libcis: isolate file-scope helpers
template <class Tp>
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_PR22806_constrain_tuple_like_ctor; // libcis


void test_utilities_tuple_tuple_tuple_tuple_cnstr_PR22806_constrain_tuple_like_ctor()
{
