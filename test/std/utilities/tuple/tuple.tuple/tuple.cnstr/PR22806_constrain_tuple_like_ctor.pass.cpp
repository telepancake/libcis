// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_PR22806_constrain_tuple_like_ctor_b54a3ebf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_PR22806_constrain_tuple_like_ctor_b54a3ebf { // libcis
template <class Tp>
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_PR22806_constrain_tuple_like_ctor_b54a3ebf (libcis)
