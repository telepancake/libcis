// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_dtor).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_dtor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_dtor { // libcis: isolate file-scope helpers
struct TrackDtor {
   int* count_;
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_dtor; // libcis


void test_utilities_tuple_tuple_tuple_tuple_cnstr_dtor()
{
  test();
#if TEST_STD_VER > 17
  static_assert(test());
