// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_dtor_ca112f95).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_dtor_ca112f95 { // libcis
struct TrackDtor {
   int* count_;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_dtor_ca112f95 (libcis)
