// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_copy_db9fd657).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_copy_db9fd657 { // libcis
struct Explicit {
  int value;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_copy_db9fd657 (libcis)
