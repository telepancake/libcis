// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_copy).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_copy { // libcis: isolate file-scope helpers
struct Explicit {
  int value;
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_copy; // libcis

#endif

void test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_copy()
{
    {
