// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_UTypes).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_UTypes; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_UTypes { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_UTypes; // libcis


void test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_UTypes()
{
    {
