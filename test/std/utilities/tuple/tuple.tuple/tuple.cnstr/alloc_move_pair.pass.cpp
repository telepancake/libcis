// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_move_pair_6937952f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_move_pair_6937952f { // libcis
struct B
{
    int id_;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_move_pair_6937952f (libcis)
