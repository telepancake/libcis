// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_move_874ad050).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_move_874ad050 { // libcis
struct B
{
    int id_;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_move_874ad050 (libcis)
