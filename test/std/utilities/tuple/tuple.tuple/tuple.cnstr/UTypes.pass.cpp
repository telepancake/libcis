// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_UTypes).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_UTypes; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_UTypes { // libcis: isolate file-scope helpers
struct Empty {};
struct A
{
    int id_;
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_UTypes; // libcis


void test_utilities_tuple_tuple_tuple_tuple_cnstr_UTypes()
{
    {
