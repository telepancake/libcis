// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_UTypes_68ee36a0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_UTypes_68ee36a0 { // libcis
#if TEST_STD_VER > 11
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_UTypes_68ee36a0 (libcis)
