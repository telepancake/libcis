// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_const_Types_be653edd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_const_Types_be653edd { // libcis
struct ImplicitCopy {
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_const_Types_be653edd (libcis)
