// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_non_const_pair).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_non_const_pair; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// test constraints
// sizeof...(Types) == 2
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_non_const_pair { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_non_const_pair; // libcis


void test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_non_const_pair() {
  test();
  static_assert(test());
