// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_const_move).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_const_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_const_move { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_const_move; // libcis


void test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_const_move() {
  test();
  static_assert(test());
  return;
}
