// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_move_be898505).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_move_be898505 { // libcis
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_move_be898505 (libcis)
