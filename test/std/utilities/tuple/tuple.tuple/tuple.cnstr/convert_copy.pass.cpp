// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_convert_copy_85fa1a41).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_convert_copy_85fa1a41 { // libcis
struct Explicit {
  int value;
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_convert_copy_85fa1a41 (libcis)
