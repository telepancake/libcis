// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_cnstr_with_any).
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_cnstr_with_any { // libcis: isolate file-scope helpers
template <class ...Pred>
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_cnstr_with_any; // libcis
