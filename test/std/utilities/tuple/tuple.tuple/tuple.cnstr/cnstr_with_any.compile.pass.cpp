// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_cnstr_with_any_b8db4d04).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_cnstr_with_any_b8db4d04 { // libcis
template <class ...Pred>
...
} // libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_cnstr_with_any_b8db4d04 (libcis)
