// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_const_Types).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_const_Types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_const_Types { // libcis: isolate file-scope helpers
template <class ...>
struct never {
    enum { value = 0 };
};
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_const_Types; // libcis
...
void test_utilities_tuple_tuple_tuple_tuple_cnstr_const_Types()
{
    {
