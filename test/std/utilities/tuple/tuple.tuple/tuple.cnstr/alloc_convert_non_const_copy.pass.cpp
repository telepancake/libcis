// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_non_const_copy).
// main -> test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_non_const_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_non_const_copy { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_non_const_copy; // libcis


void test_utilities_tuple_tuple_tuple_tuple_cnstr_alloc_convert_non_const_copy() {
  test();
  static_assert(test());
  return;
}
