// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_tuple_tuple_swap_member_swap_const).
// main -> test_utilities_tuple_tuple_tuple_tuple_swap_member_swap_const; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_swap_member_swap_const { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_tuple_tuple_swap_member_swap_const; // libcis


void test_utilities_tuple_tuple_tuple_tuple_swap_member_swap_const() {
#ifndef TEST_HAS_NO_EXCEPTIONS
  test_noexcept();
#endif
  test();
