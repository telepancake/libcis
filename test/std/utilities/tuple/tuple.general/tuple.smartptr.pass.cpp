// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_general_tuple_smartptr_87740374).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_general_tuple_smartptr_87740374 { // libcis
int main(int, char**) {
    {
...
} // libcis_ns_utilities_tuple_tuple_general_tuple_smartptr_87740374 (libcis)
