// AST-transferred from libc++ by tools/transfer.py (slug=utilities_tuple_tuple_general_ignore).
// main -> test_utilities_tuple_tuple_general_ignore; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_tuple_tuple_general_ignore { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_tuple_tuple_general_ignore; // libcis


void test_utilities_tuple_tuple_general_ignore() {
  test();
#if TEST_STD_VER >= 14
  static_assert(test(), "");
#endif
