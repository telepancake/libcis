// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_expol_policies_48c81872).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expol_policies_48c81872 { // libcis
template <class T>
...
} // libcis_ns_utilities_expol_policies_48c81872 (libcis)
