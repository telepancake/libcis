// AST-transferred from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_types_inner_allocator_type).
// main -> test_utilities_allocator_adaptor_allocator_adaptor_types_inner_allocator_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_allocator_adaptor_allocator_adaptor_types_inner_allocator_type() {
