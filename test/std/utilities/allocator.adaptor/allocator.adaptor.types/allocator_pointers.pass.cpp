// AST-transferred from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_types_allocator_pointers).
// main -> test_utilities_allocator_adaptor_allocator_adaptor_types_allocator_pointers; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_types_allocator_pointers { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_types_allocator_pointers; // libcis


void test_utilities_allocator_adaptor_allocator_adaptor_types_allocator_pointers() {
