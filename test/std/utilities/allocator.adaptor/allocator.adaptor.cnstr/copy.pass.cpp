// AST-transferred from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_cnstr_copy).
// main -> test_utilities_allocator_adaptor_allocator_adaptor_cnstr_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_allocator_adaptor_allocator_adaptor_cnstr_copy() {
  {
