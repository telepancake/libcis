// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_cnstr_deduct_4e90ac10).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_cnstr_deduct_4e90ac10 { // libcis
int main(int, char**) {
...
} // libcis_ns_utilities_allocator_adaptor_allocator_adaptor_cnstr_deduct_4e90ac10 (libcis)
