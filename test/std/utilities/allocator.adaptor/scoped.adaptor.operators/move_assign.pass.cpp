// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_scoped_adaptor_operators_move_assign_9c8d0a20).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_scoped_adaptor_operators_move_assign_9c8d0a20 { // libcis
int main(int, char**) {
  {
...
} // libcis_ns_utilities_allocator_adaptor_scoped_adaptor_operators_move_assign_9c8d0a20 (libcis)
