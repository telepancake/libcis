// AST-transferred from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_scoped_adaptor_operators_copy_assign).
// main -> test_utilities_allocator_adaptor_scoped_adaptor_operators_copy_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_allocator_adaptor_scoped_adaptor_operators_copy_assign() {
  {
