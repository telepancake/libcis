// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_scoped_adaptor_operators_copy_assign_4d986c63).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_scoped_adaptor_operators_copy_assign_4d986c63 { // libcis
int main(int, char**) {
  {
...
} // libcis_ns_utilities_allocator_adaptor_scoped_adaptor_operators_copy_assign_4d986c63 (libcis)
