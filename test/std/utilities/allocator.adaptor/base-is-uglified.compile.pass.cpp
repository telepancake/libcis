// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_base_is_uglified_63687a95).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_base_is_uglified_63687a95 { // libcis
...
} // libcis_ns_utilities_allocator_adaptor_base_is_uglified_63687a95 (libcis)
