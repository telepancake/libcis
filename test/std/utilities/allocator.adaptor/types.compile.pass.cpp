// AST-transferred from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_types).
...
namespace libcis_ns_utilities_allocator_adaptor_types { // libcis: isolate file-scope helpers
...
static_assert(std::is_same<std::scoped_allocator_adaptor<A2<int>, A1<int>>::const_void_pointer, const void*>::value,
              "");
} using namespace libcis_ns_utilities_allocator_adaptor_types; // libcis
