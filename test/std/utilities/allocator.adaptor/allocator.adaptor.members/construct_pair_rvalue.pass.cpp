// AST-transferred from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_rvalue).
// main -> test_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_rvalue; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_rvalue { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_rvalue; // libcis

void test_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_rvalue() {
  test_no_inner_alloc();
