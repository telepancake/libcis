// AST-transferred from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_members_select_on_container_copy_construction).
// main -> test_utilities_allocator_adaptor_allocator_adaptor_members_select_on_container_copy_construction; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_allocator_adaptor_allocator_adaptor_members_select_on_container_copy_construction() {
  {
