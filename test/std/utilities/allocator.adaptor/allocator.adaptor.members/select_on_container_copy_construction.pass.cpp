// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_members_select_on_container_copy_construction_3f4c8d86).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_select_on_container_copy_construction_3f4c8d86 { // libcis
int main(int, char**) {
  {
...
} // libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_select_on_container_copy_construction_3f4c8d86 (libcis)
