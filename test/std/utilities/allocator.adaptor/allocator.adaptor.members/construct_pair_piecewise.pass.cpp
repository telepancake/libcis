// AST-transferred from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_piecewise).
// main -> test_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_piecewise; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_piecewise { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_piecewise; // libcis

void test_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_piecewise() {
  test_no_inner_alloc();
