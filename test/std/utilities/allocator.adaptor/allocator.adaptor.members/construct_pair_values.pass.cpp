// AST-transferred from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_values).
// main -> test_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_values; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_values { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_values; // libcis

void test_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_values() {
  test_no_inner_alloc();
