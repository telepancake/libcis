// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_const_lvalue_pair_dfe6734a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_const_lvalue_pair_dfe6734a { // libcis
...
} // libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_const_lvalue_pair_dfe6734a (libcis)
