// AST-transferred from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_members_construct).
// main -> test_utilities_allocator_adaptor_allocator_adaptor_members_construct; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct { // libcis: isolate file-scope helpers
struct B {
...
} using namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct; // libcis
...
void test_utilities_allocator_adaptor_allocator_adaptor_members_construct() {
  {
