// AST-transferred from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_members_construct_type).
// main -> test_utilities_allocator_adaptor_allocator_adaptor_members_construct_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct_type { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct_type; // libcis


void test_utilities_allocator_adaptor_allocator_adaptor_members_construct_type() {
  test_bullet_one();
  test_bullet_two();
  test_bullet_three();
