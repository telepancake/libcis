// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_5badf3b1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_5badf3b1 { // libcis
...
} // libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_construct_pair_5badf3b1 (libcis)
