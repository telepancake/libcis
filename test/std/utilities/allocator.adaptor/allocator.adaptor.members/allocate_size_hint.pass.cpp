// AST-transferred from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_members_allocate_size_hint).
// main -> test_utilities_allocator_adaptor_allocator_adaptor_members_allocate_size_hint; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_allocator_adaptor_allocator_adaptor_members_allocate_size_hint() {
  {
