// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_allocator_adaptor_allocator_adaptor_members_allocate_size_hint_ee095948).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_allocate_size_hint_ee095948 { // libcis
int main(int, char**) {
  {
...
} // libcis_ns_utilities_allocator_adaptor_allocator_adaptor_members_allocate_size_hint_ee095948 (libcis)
