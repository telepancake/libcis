// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_comp_with_t_greater_93e06092).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_comp_with_t_greater_93e06092 { // libcis
using std::optional;
...
} // libcis_ns_utilities_optional_optional_comp_with_t_greater_93e06092 (libcis)
