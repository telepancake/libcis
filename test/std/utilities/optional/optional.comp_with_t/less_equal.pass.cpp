// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_comp_with_t_less_equal_27201845).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_comp_with_t_less_equal_27201845 { // libcis
using std::optional;
...
} // libcis_ns_utilities_optional_optional_comp_with_t_less_equal_27201845 (libcis)
