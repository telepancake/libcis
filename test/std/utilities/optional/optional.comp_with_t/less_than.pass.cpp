// AST-transferred from libc++ by tools/transfer.py (slug=utilities_optional_optional_comp_with_t_less_than).
// main -> test_utilities_optional_optional_comp_with_t_less_than; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// Test SFINAE.
namespace libcis_ns_utilities_optional_optional_comp_with_t_less_than { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_optional_optional_comp_with_t_less_than; // libcis
...
void test_utilities_optional_optional_comp_with_t_less_than() {
  {
    typedef X T;
