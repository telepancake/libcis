// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_comp_with_t_less_than_4ad73267).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_comp_with_t_less_than_4ad73267 { // libcis
using std::optional;
...
} // libcis_ns_utilities_optional_optional_comp_with_t_less_than_4ad73267 (libcis)
