// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_comp_with_t_compare_three_way_23f84936).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_comp_with_t_compare_three_way_23f84936 { // libcis
struct SomeInt {
  int value_;
...
} // libcis_ns_utilities_optional_optional_comp_with_t_compare_three_way_23f84936 (libcis)
