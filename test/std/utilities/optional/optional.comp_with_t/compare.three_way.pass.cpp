// AST-transferred from libc++ by tools/transfer.py (slug=utilities_optional_optional_comp_with_t_compare_three_way).
// main -> test_utilities_optional_optional_comp_with_t_compare_three_way; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_comp_with_t_compare_three_way { // libcis: isolate file-scope helpers
struct SomeInt {
  int value_;
...
} using namespace libcis_ns_utilities_optional_optional_comp_with_t_compare_three_way; // libcis


void test_utilities_optional_optional_comp_with_t_compare_three_way() {
  assert(test());
  static_assert(test());
  return;
}
