// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_specalg_make_optional_a2dd06d4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_specalg_make_optional_a2dd06d4 { // libcis
int main(int, char**)
{
    {
        int arr[10];
...
} // libcis_ns_utilities_optional_optional_specalg_make_optional_a2dd06d4 (libcis)
