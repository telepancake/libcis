// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_specalg_make_optional_explicit_initializer_list_ea4ab309).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_specalg_make_optional_explicit_initializer_list_ea4ab309 { // libcis
struct TestT {
  int x;
  int size;
  int *ptr;
...
} // libcis_ns_utilities_optional_optional_specalg_make_optional_explicit_initializer_list_ea4ab309 (libcis)
