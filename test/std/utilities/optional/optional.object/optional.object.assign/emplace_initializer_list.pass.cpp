// AST-transferred from libc++ by tools/transfer.py (slug=utilities_optional_optional_object_optional_object_assign_emplace_initializer_list).
// main -> test_utilities_optional_optional_object_optional_object_assign_emplace_initializer_list; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_object_optional_object_assign_emplace_initializer_list { // libcis: isolate file-scope helpers
class X
{
    int i_;
    int j_ = 0;
...
} using namespace libcis_ns_utilities_optional_optional_object_optional_object_assign_emplace_initializer_list; // libcis
...
void test_utilities_optional_optional_object_optional_object_assign_emplace_initializer_list()
{
    {
        check_X();
#if TEST_STD_VER > 17
