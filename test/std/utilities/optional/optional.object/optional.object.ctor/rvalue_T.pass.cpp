// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_object_optional_object_ctor_rvalue_T_82fd7d2b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_object_optional_object_ctor_rvalue_T_82fd7d2b { // libcis
using std::optional;
...
} // libcis_ns_utilities_optional_optional_object_optional_object_ctor_rvalue_T_82fd7d2b (libcis)
