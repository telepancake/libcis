// AST-transferred from libc++ by tools/transfer.py (slug=utilities_optional_optional_object_optional_object_ctor_const_T).
// main -> test_utilities_optional_optional_object_optional_object_ctor_const_T; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_optional_optional_object_optional_object_ctor_const_T() {
  {
    typedef int T;
    constexpr T t(5);
