// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_object_optional_object_ctor_in_place_t_0d6bc2ab).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_object_optional_object_ctor_in_place_t_0d6bc2ab { // libcis
using std::optional;
...
} // libcis_ns_utilities_optional_optional_object_optional_object_ctor_in_place_t_0d6bc2ab (libcis)
