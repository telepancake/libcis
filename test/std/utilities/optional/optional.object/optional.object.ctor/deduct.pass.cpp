// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_object_optional_object_ctor_deduct_9bb2dfcf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_object_optional_object_ctor_deduct_9bb2dfcf { // libcis
struct A {};
...
} // libcis_ns_utilities_optional_optional_object_optional_object_ctor_deduct_9bb2dfcf (libcis)
