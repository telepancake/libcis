// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_object_optional_object_ctor_default_613d73b5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_object_optional_object_ctor_default_613d73b5 { // libcis
using std::optional;
...
} // libcis_ns_utilities_optional_optional_object_optional_object_ctor_default_613d73b5 (libcis)
