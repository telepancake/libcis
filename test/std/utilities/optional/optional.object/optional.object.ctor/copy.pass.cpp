// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_object_optional_object_ctor_copy_109265f1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_object_optional_object_ctor_copy_109265f1 { // libcis
using std::optional;
...
} // libcis_ns_utilities_optional_optional_object_optional_object_ctor_copy_109265f1 (libcis)
