// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_object_special_members_3d0f6b89).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_object_special_members_3d0f6b89 { // libcis
template <class T>
...
} // libcis_ns_utilities_optional_optional_object_special_members_3d0f6b89 (libcis)
