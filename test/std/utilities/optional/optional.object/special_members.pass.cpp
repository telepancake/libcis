// AST-transferred from libc++ by tools/transfer.py (slug=utilities_optional_optional_object_special_members).
// main -> test_utilities_optional_optional_object_special_members; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_object_special_members { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_utilities_optional_optional_object_special_members; // libcis


void test_utilities_optional_optional_object_special_members() {
    sink(
