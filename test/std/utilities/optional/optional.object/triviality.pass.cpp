// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_object_triviality_bb059da4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_object_triviality_bb059da4 { // libcis
...
} // libcis_ns_utilities_optional_optional_object_triviality_bb059da4 (libcis)
