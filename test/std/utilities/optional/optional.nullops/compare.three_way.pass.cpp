// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_nullops_compare_three_way_544d72e7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_nullops_compare_three_way_544d72e7 { // libcis
constexpr bool test() {
  {
    std::optional<int> op;
...
} // libcis_ns_utilities_optional_optional_nullops_compare_three_way_544d72e7 (libcis)
