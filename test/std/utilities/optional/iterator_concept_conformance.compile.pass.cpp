// AST-transferred from libc++ by tools/transfer.py (slug=utilities_optional_iterator_concept_conformance).
...
namespace libcis_ns_utilities_optional_iterator_concept_conformance { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_optional_iterator_concept_conformance; // libcis
