// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_iterator_concept_conformance_60c37342).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_iterator_concept_conformance_60c37342 { // libcis
...
} // libcis_ns_utilities_optional_iterator_concept_conformance_60c37342 (libcis)
