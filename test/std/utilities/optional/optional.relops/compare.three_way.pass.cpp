// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_relops_compare_three_way_2988b3fe).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_relops_compare_three_way_2988b3fe { // libcis
constexpr bool test() {
  {
...
} // libcis_ns_utilities_optional_optional_relops_compare_three_way_2988b3fe (libcis)
