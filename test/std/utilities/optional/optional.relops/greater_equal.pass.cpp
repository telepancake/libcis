// AST-transferred from libc++ by tools/transfer.py (slug=utilities_optional_optional_relops_greater_equal).
// main -> test_utilities_optional_optional_relops_greater_equal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// Test SFINAE.
namespace libcis_ns_utilities_optional_optional_relops_greater_equal { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_optional_optional_relops_greater_equal; // libcis
...
void test_utilities_optional_optional_relops_greater_equal() {
  {
