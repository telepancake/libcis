// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_relops_less_than_37662a7f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_relops_less_than_37662a7f { // libcis
using std::optional;
...
} // libcis_ns_utilities_optional_optional_relops_less_than_37662a7f (libcis)
