// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_relops_greater_than_ccaa9690).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_relops_greater_than_ccaa9690 { // libcis
using std::optional;
...
} // libcis_ns_utilities_optional_optional_relops_greater_than_ccaa9690 (libcis)
