// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_optional_optional_nullopt_nullopt_t_084cc5dd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_optional_optional_nullopt_nullopt_t_084cc5dd { // libcis
using std::nullopt_t;
using std::nullopt;
...
} // libcis_ns_utilities_optional_optional_nullopt_nullopt_t_084cc5dd (libcis)
