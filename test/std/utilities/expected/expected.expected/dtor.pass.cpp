// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_expected_dtor).
// main -> test_utilities_expected_expected_expected_dtor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// then this destructor is a trivial destructor.
namespace libcis_ns_utilities_expected_expected_expected_dtor { // libcis: isolate file-scope helpers
struct NonTrivial {
  ~NonTrivial() {}
};
...
} using namespace libcis_ns_utilities_expected_expected_expected_dtor; // libcis


void test_utilities_expected_expected_expected_dtor() {
