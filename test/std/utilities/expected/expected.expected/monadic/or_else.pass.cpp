// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_expected_monadic_or_else).
// main -> test_utilities_expected_expected_expected_monadic_or_else; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_expected_monadic_or_else { // libcis: isolate file-scope helpers
struct LVal {
...
} using namespace libcis_ns_utilities_expected_expected_expected_monadic_or_else; // libcis


void test_utilities_expected_expected_expected_monadic_or_else() {
  test();
  static_assert(test());
