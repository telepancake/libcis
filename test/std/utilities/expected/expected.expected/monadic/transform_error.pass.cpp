// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_expected_monadic_transform_error).
// main -> test_utilities_expected_expected_expected_monadic_transform_error; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_expected_monadic_transform_error { // libcis: isolate file-scope helpers
struct LVal {
...
} using namespace libcis_ns_utilities_expected_expected_expected_monadic_transform_error; // libcis


void test_utilities_expected_expected_expected_monadic_transform_error() {
  test();
  static_assert(test());
