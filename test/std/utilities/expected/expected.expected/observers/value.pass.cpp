// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_expected_observers_value).
// main -> test_utilities_expected_expected_expected_observers_value; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_expected_observers_value { // libcis: isolate file-scope helpers
constexpr bool test() {
  // non-const &
  {
...
} using namespace libcis_ns_utilities_expected_expected_expected_observers_value; // libcis


void test_utilities_expected_expected_expected_observers_value() {
  test();
  static_assert(test());
  testException();
  testAsConst();
