// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_expected_assign_assign_copy).
// main -> test_utilities_expected_expected_expected_assign_assign_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_expected_assign_assign_copy { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_expected_expected_expected_assign_assign_copy; // libcis


void test_utilities_expected_expected_expected_assign_assign_copy() {
  test();
  static_assert(test());
  testException();
  return;
