// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_expected_assign_assign_unexpected_move).
// main -> test_utilities_expected_expected_expected_assign_assign_unexpected_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_expected_assign_assign_unexpected_move { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_expected_expected_expected_assign_assign_unexpected_move; // libcis


void test_utilities_expected_expected_expected_assign_assign_unexpected_move() {
  test();
  static_assert(test());
  testException();
  return;
