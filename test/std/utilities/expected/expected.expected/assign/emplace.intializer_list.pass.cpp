// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_expected_assign_emplace_intializer_list).
// main -> test_utilities_expected_expected_expected_assign_emplace_intializer_list; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_expected_assign_emplace_intializer_list { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_expected_expected_expected_assign_emplace_intializer_list; // libcis


void test_utilities_expected_expected_expected_assign_emplace_intializer_list() {
  test();
  static_assert(test());
  return;
}
