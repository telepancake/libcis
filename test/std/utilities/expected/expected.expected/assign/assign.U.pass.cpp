// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_expected_assign_assign_U).
// main -> test_utilities_expected_expected_expected_assign_assign_U; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_expected_assign_assign_U { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_expected_expected_expected_assign_assign_U; // libcis


void test_utilities_expected_expected_expected_assign_assign_U() {
  test();
  static_assert(test());
  testException();
  return;
