// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_expected_assign_emplace).
// main -> test_utilities_expected_expected_expected_assign_emplace; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_expected_assign_emplace { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_expected_expected_expected_assign_emplace; // libcis


void test_utilities_expected_expected_expected_assign_emplace() {
  test();
  static_assert(test());
  return;
}
