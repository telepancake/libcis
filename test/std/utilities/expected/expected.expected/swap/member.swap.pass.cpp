// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_expected_swap_member_swap).
// main -> test_utilities_expected_expected_expected_swap_member_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// Test Constraints:
namespace libcis_ns_utilities_expected_expected_expected_swap_member_swap { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_expected_expected_expected_swap_member_swap; // libcis


void test_utilities_expected_expected_expected_swap_member_swap() {
  test();
  static_assert(test());
  testException();
  return;
