// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_expected_ctor_ctor_move).
// main -> test_utilities_expected_expected_expected_ctor_ctor_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_expected_ctor_ctor_move { // libcis: isolate file-scope helpers
struct NonMovable {
...
} using namespace libcis_ns_utilities_expected_expected_expected_ctor_ctor_move; // libcis


void test_utilities_expected_expected_expected_ctor_ctor_move() {
  test();
  static_assert(test());
  testException();
  return;
