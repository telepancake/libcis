// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_expected_ctor_ctor_default).
// main -> test_utilities_expected_expected_expected_ctor_ctor_default; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_expected_ctor_ctor_default { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_expected_expected_expected_ctor_ctor_default; // libcis


void test_utilities_expected_expected_expected_ctor_ctor_default() {
  test();
  static_assert(test());
  testException();
  return;
