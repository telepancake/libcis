// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_bad_void_specialization).
// main -> test_utilities_expected_expected_bad_void_specialization; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_bad_void_specialization { // libcis: isolate file-scope helpers
struct Inherit : std::bad_expected_access<void> {};
} using namespace libcis_ns_utilities_expected_expected_bad_void_specialization; // libcis


void test_utilities_expected_expected_bad_void_specialization() {
  // base class
