// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_unexpected_swap_swap_free).
// main -> test_utilities_expected_expected_unexpected_swap_swap_free; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// test noexcept
namespace libcis_ns_utilities_expected_expected_unexpected_swap_swap_free { // libcis: isolate file-scope helpers
struct NoexceptSwap {
...
} using namespace libcis_ns_utilities_expected_expected_unexpected_swap_swap_free; // libcis


void test_utilities_expected_expected_unexpected_swap_swap_free() {
  test();
  static_assert(test());
  return;
}
