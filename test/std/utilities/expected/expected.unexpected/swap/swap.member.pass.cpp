// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_unexpected_swap_swap_member).
// main -> test_utilities_expected_expected_unexpected_swap_swap_member; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// test noexcept
namespace libcis_ns_utilities_expected_expected_unexpected_swap_swap_member { // libcis: isolate file-scope helpers
struct NoexceptSwap {
...
} using namespace libcis_ns_utilities_expected_expected_unexpected_swap_swap_member; // libcis


void test_utilities_expected_expected_unexpected_swap_swap_member() {
  test();
  static_assert(test());
  return;
}
