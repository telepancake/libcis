// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_unexpected_ctor_ctor_inplace_init_list).
// main -> test_utilities_expected_expected_unexpected_ctor_ctor_inplace_init_list; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_unexpected_ctor_ctor_inplace_init_list { // libcis: isolate file-scope helpers
struct Arg {
  int i;
...
} using namespace libcis_ns_utilities_expected_expected_unexpected_ctor_ctor_inplace_init_list; // libcis


void test_utilities_expected_expected_unexpected_ctor_ctor_inplace_init_list() {
  test();
  static_assert(test());
  testException();
  return;
