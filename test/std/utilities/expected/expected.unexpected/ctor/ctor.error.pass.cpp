// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_unexpected_ctor_ctor_error).
// main -> test_utilities_expected_expected_unexpected_ctor_ctor_error; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// Test Constraints:
namespace libcis_ns_utilities_expected_expected_unexpected_ctor_ctor_error { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_expected_expected_unexpected_ctor_ctor_error; // libcis


void test_utilities_expected_expected_unexpected_ctor_ctor_error() {
  test();
  static_assert(test());
  testException();
  return;
