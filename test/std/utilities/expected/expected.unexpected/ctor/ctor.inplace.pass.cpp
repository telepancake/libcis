// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_unexpected_ctor_ctor_inplace).
// main -> test_utilities_expected_expected_unexpected_ctor_ctor_inplace; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// Test Constraints:
namespace libcis_ns_utilities_expected_expected_unexpected_ctor_ctor_inplace { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_expected_expected_unexpected_ctor_ctor_inplace; // libcis


void test_utilities_expected_expected_unexpected_ctor_ctor_inplace() {
  test();
  static_assert(test());
  testException();
  return;
