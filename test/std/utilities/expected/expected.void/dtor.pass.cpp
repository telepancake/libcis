// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_void_dtor).
// main -> test_utilities_expected_expected_void_dtor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_void_dtor { // libcis: isolate file-scope helpers
struct NonTrivial {
  ~NonTrivial() {}
};
...
} using namespace libcis_ns_utilities_expected_expected_void_dtor; // libcis


void test_utilities_expected_expected_void_dtor() {
  test();
  static_assert(test());
  return;
}
