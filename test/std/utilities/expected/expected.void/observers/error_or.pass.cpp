// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_void_observers_error_or).
// main -> test_utilities_expected_expected_void_observers_error_or; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_void_observers_error_or { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_expected_expected_void_observers_error_or; // libcis


void test_utilities_expected_expected_void_observers_error_or() {
  test();
  static_assert(test());
