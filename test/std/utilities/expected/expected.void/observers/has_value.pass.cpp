// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_void_observers_has_value).
// main -> test_utilities_expected_expected_void_observers_has_value; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// Test noexcept
namespace libcis_ns_utilities_expected_expected_void_observers_has_value { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_utilities_expected_expected_void_observers_has_value; // libcis


void test_utilities_expected_expected_void_observers_has_value() {
  test();
  static_assert(test());
  return;
}
