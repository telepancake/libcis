// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_void_ctor_ctor_unexpect).
// main -> test_utilities_expected_expected_void_ctor_ctor_unexpect; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// Test Constraints:
namespace libcis_ns_utilities_expected_expected_void_ctor_ctor_unexpect { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_expected_expected_void_ctor_ctor_unexpect; // libcis


void test_utilities_expected_expected_void_ctor_ctor_unexpect() {
  test();
  static_assert(test());
  testException();
  return;
