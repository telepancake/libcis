// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_void_ctor_ctor_unexpected_copy).
// main -> test_utilities_expected_expected_void_ctor_ctor_unexpected_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// Test Constraints
namespace libcis_ns_utilities_expected_expected_void_ctor_ctor_unexpected_copy { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_expected_expected_void_ctor_ctor_unexpected_copy; // libcis


void test_utilities_expected_expected_void_ctor_ctor_unexpected_copy() {
  test();
  static_assert(test());
  testException();
  return;
