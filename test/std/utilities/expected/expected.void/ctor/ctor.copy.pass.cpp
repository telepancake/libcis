// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_void_ctor_ctor_copy).
// main -> test_utilities_expected_expected_void_ctor_ctor_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_void_ctor_ctor_copy { // libcis: isolate file-scope helpers
struct NonCopyable {
...
} using namespace libcis_ns_utilities_expected_expected_void_ctor_ctor_copy; // libcis


void test_utilities_expected_expected_void_ctor_ctor_copy() {
  test();
  static_assert(test());
  testException();
  return;
