// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_void_monadic_transform).
// main -> test_utilities_expected_expected_void_monadic_transform; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_void_monadic_transform { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_expected_expected_void_monadic_transform; // libcis


void test_utilities_expected_expected_void_monadic_transform() {
  test();
  static_assert(test());
