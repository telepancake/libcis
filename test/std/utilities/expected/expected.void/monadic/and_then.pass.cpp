// AST-transferred from libc++ by tools/transfer.py (slug=utilities_expected_expected_void_monadic_and_then).
// main -> test_utilities_expected_expected_void_monadic_and_then; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_expected_expected_void_monadic_and_then { // libcis: isolate file-scope helpers
struct NonCopyable {
...
} using namespace libcis_ns_utilities_expected_expected_void_monadic_and_then; // libcis


void test_utilities_expected_expected_void_monadic_and_then() {
  test();
  static_assert(test());
