// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_ptr_align_assume_aligned).
// main -> test_utilities_memory_ptr_align_assume_aligned; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_ptr_align_assume_aligned { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_utilities_memory_ptr_align_assume_aligned; // libcis


void test_utilities_memory_ptr_align_assume_aligned() {
  tests();
  static_assert(tests());
