// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_ptr_align_assume_aligned_0cda69cb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_ptr_align_assume_aligned_0cda69cb { // libcis
template <typename T>
...
} // libcis_ns_utilities_memory_ptr_align_assume_aligned_0cda69cb (libcis)
