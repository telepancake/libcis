// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_storage_iterator_raw_storage_iterator_0fcde1c1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_storage_iterator_raw_storage_iterator_0fcde1c1 { // libcis
int A_constructed = 0;
...
} // libcis_ns_utilities_memory_storage_iterator_raw_storage_iterator_0fcde1c1 (libcis)
