// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_storage_iterator_raw_storage_iterator_base_2b12a949).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_storage_iterator_raw_storage_iterator_base_2b12a949 { // libcis
int A_constructed = 0;
...
} // libcis_ns_utilities_memory_storage_iterator_raw_storage_iterator_base_2b12a949 (libcis)
