// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_pointer_traits_ptr_types).
...
namespace libcis_ns_utilities_memory_pointer_traits_ptr_types { // libcis: isolate file-scope helpers
void f() {
  {
    using Ptr = int*;
...
} using namespace libcis_ns_utilities_memory_pointer_traits_ptr_types; // libcis
