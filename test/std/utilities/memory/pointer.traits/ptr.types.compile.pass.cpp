// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_pointer_traits_ptr_types_3ee13f98).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_pointer_traits_ptr_types_3ee13f98 { // libcis
void f() {
  {
    using Ptr = int*;
...
} // libcis_ns_utilities_memory_pointer_traits_ptr_types_3ee13f98 (libcis)
