// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_pointer_traits_pointer_traits_functions_pointer_to_ae8e65b3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_pointer_traits_pointer_traits_functions_pointer_to_ae8e65b3 { // libcis
template <class T>
struct A {
private:
  struct nat {};
...
} // libcis_ns_utilities_memory_pointer_traits_pointer_traits_functions_pointer_to_ae8e65b3 (libcis)
