// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_pointer_traits_ptr_pointer_to_e3363e26).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_pointer_traits_ptr_pointer_to_e3363e26 { // libcis
...
} // libcis_ns_utilities_memory_pointer_traits_ptr_pointer_to_e3363e26 (libcis)
