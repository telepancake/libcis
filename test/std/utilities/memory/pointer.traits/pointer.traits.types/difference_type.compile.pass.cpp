// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_pointer_traits_pointer_traits_types_difference_type).
...
namespace libcis_ns_utilities_memory_pointer_traits_pointer_traits_types_difference_type { // libcis: isolate file-scope helpers
struct A
{
...
} using namespace libcis_ns_utilities_memory_pointer_traits_pointer_traits_types_difference_type; // libcis
