// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_pointer_traits_pointer_traits_types_difference_type_b3a2b6bd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_pointer_traits_pointer_traits_types_difference_type_b3a2b6bd { // libcis
struct A
{
...
} // libcis_ns_utilities_memory_pointer_traits_pointer_traits_types_difference_type_b3a2b6bd (libcis)
