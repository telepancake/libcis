// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_pointer_traits_pointer_traits_types_element_type_05ef7de1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_pointer_traits_pointer_traits_types_element_type_05ef7de1 { // libcis
struct A
{
...
} // libcis_ns_utilities_memory_pointer_traits_pointer_traits_types_element_type_05ef7de1 (libcis)
