// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_pointer_traits_pointer_traits_types_rebind_3f774e2e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_pointer_traits_pointer_traits_types_rebind_3f774e2e { // libcis
template <class T>
struct A
{
};
...
} // libcis_ns_utilities_memory_pointer_traits_pointer_traits_types_rebind_3f774e2e (libcis)
