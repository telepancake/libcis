// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_pointer_traits_pointer_traits_types_rebind).
...
namespace libcis_ns_utilities_memory_pointer_traits_pointer_traits_types_rebind { // libcis: isolate file-scope helpers
template <class T>
struct A
{
};
...
} using namespace libcis_ns_utilities_memory_pointer_traits_pointer_traits_types_rebind; // libcis
