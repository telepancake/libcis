// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_uninitialized_fill_n_ranges_uninitialized_fill_n_da7ead5a).
//===----------------------------------------------------------------------===//
//
...
// libc++-specific.
namespace libcis_ns_utilities_memory_specialized_algorithms_uninitialized_fill_n_ranges_uninitialized_fill_n_da7ead5a { // libcis
...
} // libcis_ns_utilities_memory_specialized_algorithms_uninitialized_fill_n_ranges_uninitialized_fill_n_da7ead5a (libcis)
