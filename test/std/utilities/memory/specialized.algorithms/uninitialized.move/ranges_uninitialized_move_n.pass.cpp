// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_uninitialized_move_ranges_uninitialized_move_n_f4cd56d8).
//===----------------------------------------------------------------------===//
//
...
// libc++-specific.
namespace libcis_ns_utilities_memory_specialized_algorithms_uninitialized_move_ranges_uninitialized_move_n_f4cd56d8 { // libcis
...
} // libcis_ns_utilities_memory_specialized_algorithms_uninitialized_move_ranges_uninitialized_move_n_f4cd56d8 (libcis)
