// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_uninitialized_construct_default_ranges_uninitialized_default_construct_n).
// main -> test_utilities_memory_specialized_algorithms_uninitialized_construct_default_ranges_uninitialized_default_construct_n; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// libc++-specific.
namespace libcis_ns_utilities_memory_specialized_algorithms_uninitialized_construct_default_ranges_uninitialized_default_construct_n { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_memory_specialized_algorithms_uninitialized_construct_default_ranges_uninitialized_default_construct_n; // libcis


void test_utilities_memory_specialized_algorithms_uninitialized_construct_default_ranges_uninitialized_default_construct_n() {
