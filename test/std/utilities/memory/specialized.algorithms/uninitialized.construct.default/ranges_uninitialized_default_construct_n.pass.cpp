// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_uninitialized_construct_default_ranges_uninitialized_default_construct_n_dbd2fedb).
//===----------------------------------------------------------------------===//
//
...
// libc++-specific.
namespace libcis_ns_utilities_memory_specialized_algorithms_uninitialized_construct_default_ranges_uninitialized_default_construct_n_dbd2fedb { // libcis
...
} // libcis_ns_utilities_memory_specialized_algorithms_uninitialized_construct_default_ranges_uninitialized_default_construct_n_dbd2fedb (libcis)
