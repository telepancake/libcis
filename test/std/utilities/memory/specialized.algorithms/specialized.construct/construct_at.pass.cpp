// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_specialized_construct_construct_at_4bcc2ff8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_construct_construct_at_4bcc2ff8 { // libcis
struct Foo {
    constexpr Foo() { }
...
} // libcis_ns_utilities_memory_specialized_algorithms_specialized_construct_construct_at_4bcc2ff8 (libcis)
