// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_specialized_construct_construct_at).
// main -> test_utilities_memory_specialized_algorithms_specialized_construct_construct_at; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_construct_construct_at { // libcis: isolate file-scope helpers
struct Foo {
  constexpr Foo() {}
...
} using namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_construct_construct_at; // libcis


void test_utilities_memory_specialized_algorithms_specialized_construct_construct_at() {
  test();
  static_assert(test());
  return;
}
