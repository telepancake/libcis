// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_specialized_construct_ranges_construct_at).
// main -> test_utilities_memory_specialized_algorithms_specialized_construct_ranges_construct_at; file-scope helpers isolated in anon namespace.
namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_construct_ranges_construct_at { // libcis: isolate file-scope helpers
//===----------------------------------------------------------------------===//
//
...
} using namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_construct_ranges_construct_at; // libcis

// TODO(varconst): check that array types work once D114649 implementing LWG3639 lands.

void test_utilities_memory_specialized_algorithms_specialized_construct_ranges_construct_at() {
  test();
  static_assert(test());
