// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_specialized_destroy_destroy_n_ef36bfe0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_destroy_destroy_n_ef36bfe0 { // libcis
struct Counted {
    int* counter_;
...
} // libcis_ns_utilities_memory_specialized_algorithms_specialized_destroy_destroy_n_ef36bfe0 (libcis)
