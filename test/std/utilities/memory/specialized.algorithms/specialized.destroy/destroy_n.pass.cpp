// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_specialized_destroy_destroy_n).
// main -> test_utilities_memory_specialized_algorithms_specialized_destroy_destroy_n; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_destroy_destroy_n { // libcis: isolate file-scope helpers
struct Counted {
    int* counter_;
...
} using namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_destroy_destroy_n; // libcis


void test_utilities_memory_specialized_algorithms_specialized_destroy_destroy_n() {
    tests();
#if TEST_STD_VER > 17
    test_arrays();
    static_assert(tests());
