// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_specialized_destroy_destroy_at_6d35258d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_destroy_destroy_at_6d35258d { // libcis
struct Counted {
    int* counter_;
...
} // libcis_ns_utilities_memory_specialized_algorithms_specialized_destroy_destroy_at_6d35258d (libcis)
