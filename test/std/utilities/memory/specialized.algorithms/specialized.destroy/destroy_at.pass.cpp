// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_specialized_destroy_destroy_at).
// main -> test_utilities_memory_specialized_algorithms_specialized_destroy_destroy_at; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_destroy_destroy_at { // libcis: isolate file-scope helpers
struct Counted {
    int* counter_;
...
} using namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_destroy_destroy_at; // libcis


void test_utilities_memory_specialized_algorithms_specialized_destroy_destroy_at() {
    test();
#if TEST_STD_VER > 17
    test_arrays();
    static_assert(test());
