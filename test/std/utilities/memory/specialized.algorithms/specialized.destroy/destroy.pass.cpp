// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_specialized_destroy_destroy).
// main -> test_utilities_memory_specialized_algorithms_specialized_destroy_destroy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_destroy_destroy { // libcis: isolate file-scope helpers
struct Counted {
    int* counter_;
...
} using namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_destroy_destroy; // libcis


void test_utilities_memory_specialized_algorithms_specialized_destroy_destroy() {
    tests();
#if TEST_STD_VER > 17
    test_arrays();
    static_assert(tests());
