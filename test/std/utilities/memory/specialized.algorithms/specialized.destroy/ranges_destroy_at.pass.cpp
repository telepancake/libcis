// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_specialized_destroy_ranges_destroy_at).
// main -> test_utilities_memory_specialized_algorithms_specialized_destroy_ranges_destroy_at; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// libc++-specific.
namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_destroy_ranges_destroy_at { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_memory_specialized_algorithms_specialized_destroy_ranges_destroy_at; // libcis


void test_utilities_memory_specialized_algorithms_specialized_destroy_ranges_destroy_at() {
  test();
  test_arrays();
