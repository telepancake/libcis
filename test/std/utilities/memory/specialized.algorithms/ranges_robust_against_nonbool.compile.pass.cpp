// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_ranges_robust_against_nonbool_ada7510e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_specialized_algorithms_ranges_robust_against_nonbool_ada7510e { // libcis
...
} // libcis_ns_utilities_memory_specialized_algorithms_ranges_robust_against_nonbool_ada7510e (libcis)
