// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_ranges_robust_against_nonbool).
...
namespace libcis_ns_utilities_memory_specialized_algorithms_ranges_robust_against_nonbool { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_memory_specialized_algorithms_ranges_robust_against_nonbool; // libcis
