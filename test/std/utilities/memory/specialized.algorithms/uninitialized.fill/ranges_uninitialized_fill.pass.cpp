// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_uninitialized_fill_ranges_uninitialized_fill_b4cc89fb).
//===----------------------------------------------------------------------===//
//
...
// libc++-specific.
namespace libcis_ns_utilities_memory_specialized_algorithms_uninitialized_fill_ranges_uninitialized_fill_b4cc89fb { // libcis
...
} // libcis_ns_utilities_memory_specialized_algorithms_uninitialized_fill_ranges_uninitialized_fill_b4cc89fb (libcis)
