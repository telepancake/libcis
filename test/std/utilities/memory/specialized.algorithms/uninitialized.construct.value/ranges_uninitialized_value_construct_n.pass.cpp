// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_uninitialized_construct_value_ranges_uninitialized_value_construct_n_4a84fe38).
//===----------------------------------------------------------------------===//
//
...
// libc++-specific.
namespace libcis_ns_utilities_memory_specialized_algorithms_uninitialized_construct_value_ranges_uninitialized_value_construct_n_4a84fe38 { // libcis
...
} // libcis_ns_utilities_memory_specialized_algorithms_uninitialized_construct_value_ranges_uninitialized_value_construct_n_4a84fe38 (libcis)
