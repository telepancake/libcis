// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_uninitialized_construct_value_ranges_uninitialized_value_construct_c7a0781c).
//===----------------------------------------------------------------------===//
//
...
// libc++-specific.
namespace libcis_ns_utilities_memory_specialized_algorithms_uninitialized_construct_value_ranges_uninitialized_value_construct_c7a0781c { // libcis
...
} // libcis_ns_utilities_memory_specialized_algorithms_uninitialized_construct_value_ranges_uninitialized_value_construct_c7a0781c (libcis)
