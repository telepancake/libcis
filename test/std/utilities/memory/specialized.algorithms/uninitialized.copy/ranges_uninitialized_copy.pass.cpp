// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_specialized_algorithms_uninitialized_copy_ranges_uninitialized_copy_d45a998c).
//===----------------------------------------------------------------------===//
//
...
// libc++-specific.
namespace libcis_ns_utilities_memory_specialized_algorithms_uninitialized_copy_ranges_uninitialized_copy_d45a998c { // libcis
...
} // libcis_ns_utilities_memory_specialized_algorithms_uninitialized_copy_ranges_uninitialized_copy_d45a998c (libcis)
