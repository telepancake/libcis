// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_types_const_pointer_c2095c1b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_types_const_pointer_c2095c1b { // libcis
template <class T>
struct Ptr {};
...
} // libcis_ns_utilities_memory_allocator_traits_allocator_traits_types_const_pointer_c2095c1b (libcis)
