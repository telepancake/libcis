// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_types_is_always_equal).
// main -> test_utilities_memory_allocator_traits_allocator_traits_types_is_always_equal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_types_is_always_equal { // libcis: isolate file-scope helpers
template <class T>
struct A
{
...
} using namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_types_is_always_equal; // libcis


void test_utilities_memory_allocator_traits_allocator_traits_types_is_always_equal()
{
