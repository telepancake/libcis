// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_types_rebind_alloc).
// main -> test_utilities_memory_allocator_traits_allocator_traits_types_rebind_alloc; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_types_rebind_alloc { // libcis: isolate file-scope helpers
template <class T>
struct ReboundA {};
...
} using namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_types_rebind_alloc; // libcis


void test_utilities_memory_allocator_traits_allocator_traits_types_rebind_alloc()
{
#if TEST_STD_VER >= 11
