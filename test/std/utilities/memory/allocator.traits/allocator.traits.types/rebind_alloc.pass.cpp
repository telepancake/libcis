// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_types_rebind_alloc_fed0d902).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_types_rebind_alloc_fed0d902 { // libcis
template <class T>
struct ReboundA {};
...
} // libcis_ns_utilities_memory_allocator_traits_allocator_traits_types_rebind_alloc_fed0d902 (libcis)
