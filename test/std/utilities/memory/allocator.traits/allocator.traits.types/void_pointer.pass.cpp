// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_types_void_pointer_af695bd7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_types_void_pointer_af695bd7 { // libcis
template <class T>
struct Ptr {};
...
} // libcis_ns_utilities_memory_allocator_traits_allocator_traits_types_void_pointer_af695bd7 (libcis)
