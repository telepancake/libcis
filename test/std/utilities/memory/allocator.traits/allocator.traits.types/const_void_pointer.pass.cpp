// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_types_const_void_pointer_891091b5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_types_const_void_pointer_891091b5 { // libcis
template <class T>
struct Ptr {};
...
} // libcis_ns_utilities_memory_allocator_traits_allocator_traits_types_const_void_pointer_891091b5 (libcis)
