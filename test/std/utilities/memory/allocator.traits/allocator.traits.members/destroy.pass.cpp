// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_members_destroy_1c2ba563).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_destroy_1c2ba563 { // libcis
template <class T>
struct NoDestroy
{
...
} // libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_destroy_1c2ba563 (libcis)
