// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_members_destroy).
// main -> test_utilities_memory_allocator_traits_allocator_traits_members_destroy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_destroy { // libcis: isolate file-scope helpers
template <class T>
struct NoDestroy
{
...
} using namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_destroy; // libcis


void test_utilities_memory_allocator_traits_allocator_traits_members_destroy()
{
    test();
#if TEST_STD_VER > 17
    static_assert(test());
