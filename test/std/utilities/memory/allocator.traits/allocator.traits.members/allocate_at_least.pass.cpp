// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_members_allocate_at_least).
// main -> test_utilities_memory_allocator_traits_allocator_traits_members_allocate_at_least; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_allocate_at_least { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_allocate_at_least; // libcis


void test_utilities_memory_allocator_traits_allocator_traits_members_allocate_at_least() {
  test();
  static_assert(test());
