// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_members_max_size_7022167a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_max_size_7022167a { // libcis
template <class T>
struct A
{
...
} // libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_max_size_7022167a (libcis)
