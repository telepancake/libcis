// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_members_allocate_hint_0f7d83be).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_allocate_hint_0f7d83be { // libcis
template <class T>
struct A
{
...
} // libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_allocate_hint_0f7d83be (libcis)
