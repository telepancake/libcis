// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_members_select_on_container_copy_construction_86a8d292).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_select_on_container_copy_construction_86a8d292 { // libcis
template <class T>
struct A
{
...
} // libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_select_on_container_copy_construction_86a8d292 (libcis)
