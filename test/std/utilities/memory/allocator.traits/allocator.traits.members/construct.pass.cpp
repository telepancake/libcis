// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_members_construct_d705b6aa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_construct_d705b6aa { // libcis
template <class T>
struct A
{
...
} // libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_construct_d705b6aa (libcis)
