// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_allocator_traits_members_construct).
// main -> test_utilities_memory_allocator_traits_allocator_traits_members_construct; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_construct { // libcis: isolate file-scope helpers
template <class T>
struct A
{
...
} using namespace libcis_ns_utilities_memory_allocator_traits_allocator_traits_members_construct; // libcis


void test_utilities_memory_allocator_traits_allocator_traits_members_construct()
{
    test();
