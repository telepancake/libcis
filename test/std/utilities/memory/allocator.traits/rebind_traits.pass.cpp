// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_rebind_traits_e06575f3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_rebind_traits_e06575f3 { // libcis
template <class T>
struct ReboundA {};
...
} // libcis_ns_utilities_memory_allocator_traits_rebind_traits_e06575f3 (libcis)
