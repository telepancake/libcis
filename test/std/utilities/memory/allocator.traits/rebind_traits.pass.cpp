// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_allocator_traits_rebind_traits).
// main -> test_utilities_memory_allocator_traits_rebind_traits; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_traits_rebind_traits { // libcis: isolate file-scope helpers
template <class T>
struct ReboundA {};
...
} using namespace libcis_ns_utilities_memory_allocator_traits_rebind_traits; // libcis


void test_utilities_memory_allocator_traits_rebind_traits()
{
#if TEST_STD_VER >= 11
