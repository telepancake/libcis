// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_pointer_conversion_to_address_without_pointer_traits_38e5444f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_pointer_conversion_to_address_without_pointer_traits_38e5444f { // libcis
struct IntPtr {
...
} // libcis_ns_utilities_memory_pointer_conversion_to_address_without_pointer_traits_38e5444f (libcis)
