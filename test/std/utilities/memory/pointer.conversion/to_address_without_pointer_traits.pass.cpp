// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_pointer_conversion_to_address_without_pointer_traits).
// main -> test_utilities_memory_pointer_conversion_to_address_without_pointer_traits; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_pointer_conversion_to_address_without_pointer_traits { // libcis: isolate file-scope helpers
struct IntPtr {
...
} using namespace libcis_ns_utilities_memory_pointer_conversion_to_address_without_pointer_traits; // libcis


void test_utilities_memory_pointer_conversion_to_address_without_pointer_traits() {
  static_assert(test());
  return;
}
