// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_pointer_conversion_to_address_std_iterators_75e41bb6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_pointer_conversion_to_address_std_iterators_75e41bb6 { // libcis
template<class C>
...
} // libcis_ns_utilities_memory_pointer_conversion_to_address_std_iterators_75e41bb6 (libcis)
