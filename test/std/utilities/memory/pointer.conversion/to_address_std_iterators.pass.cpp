// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_pointer_conversion_to_address_std_iterators).
// main -> test_utilities_memory_pointer_conversion_to_address_std_iterators; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_pointer_conversion_to_address_std_iterators { // libcis: isolate file-scope helpers
template<class C>
...
} using namespace libcis_ns_utilities_memory_pointer_conversion_to_address_std_iterators; // libcis


void test_utilities_memory_pointer_conversion_to_address_std_iterators() {
