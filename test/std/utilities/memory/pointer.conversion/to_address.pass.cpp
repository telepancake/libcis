// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_pointer_conversion_to_address).
// main -> test_utilities_memory_pointer_conversion_to_address; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_pointer_conversion_to_address { // libcis: isolate file-scope helpers
struct Irrelevant;
...
} using namespace libcis_ns_utilities_memory_pointer_conversion_to_address; // libcis
...
void test_utilities_memory_pointer_conversion_to_address() {
    test();
    static_assert(test());
    return;
}
