// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_allocator_uses_allocator_uses_trait_uses_allocator).
// main -> test_utilities_memory_allocator_uses_allocator_uses_trait_uses_allocator; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_allocator_uses_allocator_uses_trait_uses_allocator { // libcis: isolate file-scope helpers
struct A
{
};
...
} using namespace libcis_ns_utilities_memory_allocator_uses_allocator_uses_trait_uses_allocator; // libcis


void test_utilities_memory_allocator_uses_allocator_uses_trait_uses_allocator()
{
