// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_default_allocator_allocator_types).
// main -> test_utilities_memory_default_allocator_allocator_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_default_allocator_allocator_types { // libcis: isolate file-scope helpers
struct U;
...
} using namespace libcis_ns_utilities_memory_default_allocator_allocator_types; // libcis


void test_utilities_memory_default_allocator_allocator_types() {
    test<char>();
    return;
}
