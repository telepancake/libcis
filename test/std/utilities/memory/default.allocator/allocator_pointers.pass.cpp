// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_default_allocator_allocator_pointers_a51f5cef).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_default_allocator_allocator_pointers_a51f5cef { // libcis
...
} // libcis_ns_utilities_memory_default_allocator_allocator_pointers_a51f5cef (libcis)
