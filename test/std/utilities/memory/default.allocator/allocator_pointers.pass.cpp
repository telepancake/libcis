// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_default_allocator_allocator_pointers).
// main -> test_utilities_memory_default_allocator_allocator_pointers; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_default_allocator_allocator_pointers { // libcis: isolate file-scope helpers
...
struct Foo { int x; };
} using namespace libcis_ns_utilities_memory_default_allocator_allocator_pointers; // libcis


void test_utilities_memory_default_allocator_allocator_pointers()
{
