// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_default_allocator_allocator_members_allocate).
// main -> test_utilities_memory_default_allocator_allocator_members_allocate; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#else
namespace libcis_ns_utilities_memory_default_allocator_allocator_members_allocate { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_memory_default_allocator_allocator_members_allocate; // libcis
...
void test_utilities_memory_default_allocator_allocator_members_allocate() {
    test_aligned<1>();
    test_aligned<2>();
    test_aligned<4>();
    test_aligned<8>();
