// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_util_smartptr_util_smartptr_shared_util_smartptr_shared_cast_reinterpret_pointer_cast_949eaddd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_shared_util_smartptr_shared_cast_reinterpret_pointer_cast_949eaddd { // libcis
struct A {
  int x;
};
...
} // libcis_ns_utilities_memory_util_smartptr_util_smartptr_shared_util_smartptr_shared_cast_reinterpret_pointer_cast_949eaddd (libcis)
