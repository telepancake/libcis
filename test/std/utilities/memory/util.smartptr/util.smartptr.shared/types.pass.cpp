// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_util_smartptr_util_smartptr_shared_types).
// main -> test_utilities_memory_util_smartptr_util_smartptr_shared_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER > 14
namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_shared_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_shared_types; // libcis


void test_utilities_memory_util_smartptr_util_smartptr_shared_types() {
  test<A>();
  test<B>();
  test<int>();
  test<char*>();
