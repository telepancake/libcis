// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_util_smartptr_util_smartptr_shared_types_f35a61c4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_shared_types_f35a61c4 { // libcis
#if TEST_STD_VER > 14
...
} // libcis_ns_utilities_memory_util_smartptr_util_smartptr_shared_types_f35a61c4 (libcis)
