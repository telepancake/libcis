// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_util_smartptr_util_smartptr_shared_race_condition).
// main -> test_utilities_memory_util_smartptr_util_smartptr_shared_race_condition; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_shared_race_condition { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_shared_race_condition; // libcis


void test_utilities_memory_util_smartptr_util_smartptr_shared_race_condition() {
  {
