// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_util_smartptr_util_smartptr_shared_iterator_concept_conformance).
...
namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_shared_iterator_concept_conformance { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_shared_iterator_concept_conformance; // libcis
