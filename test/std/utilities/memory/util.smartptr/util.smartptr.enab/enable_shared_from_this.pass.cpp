// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_util_smartptr_util_smartptr_enab_enable_shared_from_this).
// main -> test_utilities_memory_util_smartptr_util_smartptr_enab_enable_shared_from_this; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_enab_enable_shared_from_this { // libcis: isolate file-scope helpers
struct T
...
} using namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_enab_enable_shared_from_this; // libcis



void test_utilities_memory_util_smartptr_util_smartptr_enab_enable_shared_from_this()
{
