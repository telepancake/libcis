// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_util_smartptr_util_smartptr_enab_enable_shared_from_this_08a299fe).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_enab_enable_shared_from_this_08a299fe { // libcis
struct T
...
} // libcis_ns_utilities_memory_util_smartptr_util_smartptr_enab_enable_shared_from_this_08a299fe (libcis)
