// AST-transferred from libc++ by tools/transfer.py (slug=utilities_memory_util_smartptr_util_smartptr_weak_util_smartptr_ownerless_owner_less).
// main -> test_utilities_memory_util_smartptr_util_smartptr_weak_util_smartptr_ownerless_owner_less; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_weak_util_smartptr_ownerless_owner_less { // libcis: isolate file-scope helpers
struct X {};
} using namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_weak_util_smartptr_ownerless_owner_less; // libcis


void test_utilities_memory_util_smartptr_util_smartptr_weak_util_smartptr_ownerless_owner_less()
{
