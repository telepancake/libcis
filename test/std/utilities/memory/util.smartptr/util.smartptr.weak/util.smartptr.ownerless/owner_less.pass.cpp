// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_memory_util_smartptr_util_smartptr_weak_util_smartptr_ownerless_owner_less_137a0514).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_memory_util_smartptr_util_smartptr_weak_util_smartptr_ownerless_owner_less_137a0514 { // libcis
struct X {};
...
} // libcis_ns_utilities_memory_util_smartptr_util_smartptr_weak_util_smartptr_ownerless_owner_less_137a0514 (libcis)
