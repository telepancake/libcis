// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_formattable_concept_formattable_float).
...
namespace libcis_ns_utilities_format_format_formattable_concept_formattable_float { // libcis: isolate file-scope helpers
template <class T, class CharT>
...
} using namespace libcis_ns_utilities_format_format_formattable_concept_formattable_float; // libcis
