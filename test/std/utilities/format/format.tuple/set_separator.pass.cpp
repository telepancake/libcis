// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_tuple_set_separator).
// main -> test_utilities_format_format_tuple_set_separator; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_tuple_set_separator { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_tuple_set_separator; // libcis


void test_utilities_format_format_tuple_set_separator() {
  test();
  static_assert(test());
