// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_tuple_parse).
// main -> test_utilities_format_format_tuple_parse; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_tuple_parse { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_tuple_parse; // libcis


void test_utilities_format_format_tuple_parse() {
  test();
  static_assert(test());
