// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_error_format_error_4959b09f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_error_format_error_4959b09f { // libcis
int main(int, char**) {
...
} // libcis_ns_utilities_format_format_error_format_error_4959b09f (libcis)
