// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_error_format_error).
// main -> test_utilities_format_format_error_format_error; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_format_format_error_format_error() {
