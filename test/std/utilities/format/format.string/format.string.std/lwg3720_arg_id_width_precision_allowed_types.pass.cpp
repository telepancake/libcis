// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_string_format_string_std_lwg3720_arg_id_width_precision_allowed_types_b8c77cd9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_string_format_string_std_lwg3720_arg_id_width_precision_allowed_types_b8c77cd9 { // libcis
...
} // libcis_ns_utilities_format_format_string_format_string_std_lwg3720_arg_id_width_precision_allowed_types_b8c77cd9 (libcis)
