// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_string_format_string_std_lwg3720_arg_id_width_precision_allowed_types).
// main -> test_utilities_format_format_string_format_string_std_lwg3720_arg_id_width_precision_allowed_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_string_format_string_std_lwg3720_arg_id_width_precision_allowed_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_string_format_string_std_lwg3720_arg_id_width_precision_allowed_types; // libcis


void test_utilities_format_format_string_format_string_std_lwg3720_arg_id_width_precision_allowed_types() {
  test<char>();
