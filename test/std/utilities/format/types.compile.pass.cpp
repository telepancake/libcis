// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_types_e4b150fb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_types_e4b150fb { // libcis
...
} // libcis_ns_utilities_format_types_e4b150fb (libcis)
