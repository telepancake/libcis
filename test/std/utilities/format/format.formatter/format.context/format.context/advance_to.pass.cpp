// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_context_format_context_advance_to_773cb3d4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_formatter_format_context_format_context_advance_to_773cb3d4 { // libcis
...
} // libcis_ns_utilities_format_format_formatter_format_context_format_context_advance_to_773cb3d4 (libcis)
