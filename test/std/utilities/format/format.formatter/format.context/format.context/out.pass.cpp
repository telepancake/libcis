// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_context_format_context_out).
// main -> test_utilities_format_format_formatter_format_context_format_context_out; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_formatter_format_context_format_context_out { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_formatter_format_context_format_context_out; // libcis


void test_utilities_format_format_formatter_format_context_format_context_out() {
  test();
