// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_parse_ctx_ctor_b74b7d09).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_formatter_format_parse_ctx_ctor_b74b7d09 { // libcis
...
} // libcis_ns_utilities_format_format_formatter_format_parse_ctx_ctor_b74b7d09 (libcis)
