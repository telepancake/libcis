// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_parse_ctx_ctor).
// main -> test_utilities_format_format_formatter_format_parse_ctx_ctor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_formatter_format_parse_ctx_ctor { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_formatter_format_parse_ctx_ctor; // libcis


void test_utilities_format_format_formatter_format_parse_ctx_ctor() {
  test();
  static_assert(test());
