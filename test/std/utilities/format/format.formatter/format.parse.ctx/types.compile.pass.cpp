// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_parse_ctx_types_c70a325e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_formatter_format_parse_ctx_types_c70a325e { // libcis
template <class CharT>
constexpr void test() {
  static_assert(
...
} // libcis_ns_utilities_format_format_formatter_format_parse_ctx_types_c70a325e (libcis)
