// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_parse_ctx_types).
...
namespace libcis_ns_utilities_format_format_formatter_format_parse_ctx_types { // libcis: isolate file-scope helpers
template <class CharT>
constexpr void test() {
  static_assert(
...
} using namespace libcis_ns_utilities_format_format_formatter_format_parse_ctx_types; // libcis
