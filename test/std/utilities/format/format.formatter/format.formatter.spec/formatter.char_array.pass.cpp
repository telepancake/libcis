// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_formatter_spec_formatter_char_array_00509335).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_char_array_00509335 { // libcis
...
} // libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_char_array_00509335 (libcis)
