// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_formatter_spec_formatter_char_fsigned_char).
// main -> test_utilities_format_format_formatter_format_formatter_spec_formatter_char_fsigned_char; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
tenamespace libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_char_fsigned_char { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_char_fsigned_char; // libcis
invoid test_utilities_format_format_formatter_format_formatter_spec_formatter_char_fsigned_char()
  test<char>();
#ifndef TEST_HAS_NO_WIDE_CHARACTERS
  test<wchar_t>();
#endif
