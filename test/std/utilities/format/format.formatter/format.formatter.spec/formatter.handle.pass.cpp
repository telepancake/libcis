// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_formatter_spec_formatter_handle).
// main -> test_utilities_format_format_formatter_format_formatter_spec_formatter_handle; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_handle { // libcis: isolate file-scope helpers
enum class color { black, red, gold };
const char* color_names[] = {"black", "red", "gold"};
} using namespace libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_handle; // libcis
...
void test_utilities_format_format_formatter_format_formatter_spec_formatter_handle() {
