// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_formatter_spec_formatter_pointer).
// main -> test_utilities_format_format_formatter_format_formatter_spec_formatter_pointer; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_pointer { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_pointer; // libcis


void test_utilities_format_format_formatter_format_formatter_spec_formatter_pointer() {
