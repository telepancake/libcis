// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_formatter_spec_formatter_signed_integral_bce9eeae).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_signed_integral_bce9eeae { // libcis
...
} // libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_signed_integral_bce9eeae (libcis)
