// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_formatter_spec_formatter_c_string_9ba3b8d7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_c_string_9ba3b8d7 { // libcis
...
} // libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_c_string_9ba3b8d7 (libcis)
