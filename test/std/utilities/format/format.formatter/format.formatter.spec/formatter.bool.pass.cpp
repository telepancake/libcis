// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_formatter_spec_formatter_bool).
// main -> test_utilities_format_format_formatter_format_formatter_spec_formatter_bool; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_bool { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_bool; // libcis


void test_utilities_format_format_formatter_format_formatter_spec_formatter_bool() {
  test_boolean<char>();
