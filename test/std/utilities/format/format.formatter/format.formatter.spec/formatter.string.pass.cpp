// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_formatter_spec_formatter_string_c2f23cb8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_string_c2f23cb8 { // libcis
...
} // libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_string_c2f23cb8 (libcis)
