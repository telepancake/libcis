// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_formatter_spec_formatter_floating_point_6ef9dcab).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_floating_point_6ef9dcab { // libcis
...
} // libcis_ns_utilities_format_format_formatter_format_formatter_spec_formatter_floating_point_6ef9dcab (libcis)
