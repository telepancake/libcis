// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_formatter_format_formatter_locking_enable_nonlocking_formatter_optimization).
...
namespace libcis_ns_utilities_format_format_formatter_format_formatter_locking_enable_nonlocking_formatter_optimization { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_formatter_format_formatter_locking_enable_nonlocking_formatter_optimization; // libcis
