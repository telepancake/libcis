// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_functions_vformat_to).
// main -> test_utilities_format_format_functions_vformat_to; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_vformat_to { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_functions_vformat_to; // libcis


void test_utilities_format_format_functions_vformat_to() {
