// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_functions_locale_specific_form).
// main -> test_utilities_format_format_functions_locale_specific_form; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_locale_specific_form { // libcis: isolate file-scope helpers
...
int main
} using namespace libcis_ns_utilities_format_format_functions_locale_specific_form; // libcis
(ivoid test_utilities_format_format_functions_locale_specific_form()char>();
#ifndef TEST_HAS_NO_WIDE_CHARACTERS
  test<wchar_t>();
#endif
