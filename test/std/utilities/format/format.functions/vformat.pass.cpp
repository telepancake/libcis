// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_functions_vformat_c4e7a4da).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_vformat_c4e7a4da { // libcis
...
} // libcis_ns_utilities_format_format_functions_vformat_c4e7a4da (libcis)
