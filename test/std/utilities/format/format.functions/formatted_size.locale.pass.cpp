// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_functions_formatted_size_locale_894b6d8f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_formatted_size_locale_894b6d8f { // libcis
auto test =
...
} // libcis_ns_utilities_format_format_functions_formatted_size_locale_894b6d8f (libcis)
