// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_functions_vformat_locale_e24b7a4b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_vformat_locale_e24b7a4b { // libcis
...
} // libcis_ns_utilities_format_format_functions_vformat_locale_e24b7a4b (libcis)
