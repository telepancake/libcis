// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_functions_format_to_a98a7a05).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_format_to_a98a7a05 { // libcis
auto test =
...
} // libcis_ns_utilities_format_format_functions_format_to_a98a7a05 (libcis)
