// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_functions_format_to_n_locale).
// main -> test_utilities_format_format_functions_format_to_n_locale; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_format_to_n_locale { // libcis: isolate file-scope helpers
auto test =
...
} using namespace libcis_ns_utilities_format_format_functions_format_to_n_locale; // libcis


void test_utilities_format_format_functions_format_to_n_locale() {
