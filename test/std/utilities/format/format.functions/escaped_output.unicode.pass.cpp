// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_functions_escaped_output_unicode).
// main -> test_utilities_format_format_functions_escaped_output_unicode; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_escaped_output_unicode { // libcis: isolate file-scope helpers
...
#  endif // TEST_SHORT_WCHAR
#endif   // TEST_HAS_NO_WIDE_CHARA
} using namespace libcis_ns_utilities_format_format_functions_escaped_output_unicode; // libcis
CTERS

  return 0;
}
void test_utilities_format_format_functions_escaped_output_unicode()