// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_functions_format_to_n).
// main -> test_utilities_format_format_functions_format_to_n; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_format_to_n { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_functions_format_to_n; // libcis


void test_utilities_format_format_functions_format_to_n() {
