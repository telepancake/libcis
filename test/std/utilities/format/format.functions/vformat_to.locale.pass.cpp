// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_functions_vformat_to_locale_b33d2d1f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_vformat_to_locale_b33d2d1f { // libcis
...
} // libcis_ns_utilities_format_format_functions_vformat_to_locale_b33d2d1f (libcis)
