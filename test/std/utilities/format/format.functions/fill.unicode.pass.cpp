// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_functions_fill_unicode).
// main -> test_utilities_format_format_functions_fill_unicode; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_fill_unicode { // libcis: isolate file-scope helpers
...
int main(int, char**) {
  test<cha
} using namespace libcis_ns_utilities_format_format_functions_fill_unicode; // libcis
r>void test_utilities_format_format_functions_fill_unicode()_NO_WIDE_CHARACTERS
  test<wchar_t>();
#endif
