// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_functions_unicode).
// main -> test_utilities_format_format_functions_unicode; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_unicode { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_functions_unicode; // libcis


void test_utilities_format_format_functions_unicode() {
  test<char>();
