// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_functions_unicode_04da71c0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_unicode_04da71c0 { // libcis
...
} // libcis_ns_utilities_format_format_functions_unicode_04da71c0 (libcis)
