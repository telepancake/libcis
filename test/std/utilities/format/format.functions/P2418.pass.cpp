// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_functions_P2418_0dfc5a3d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_P2418_0dfc5a3d { // libcis
template <class CharT>
static void test() {
  MoveOnly m{10};
  CharT buffer[10];
...
} // libcis_ns_utilities_format_format_functions_P2418_0dfc5a3d (libcis)
