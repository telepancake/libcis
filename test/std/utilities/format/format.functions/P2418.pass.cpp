// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_functions_P2418).
// main -> test_utilities_format_format_functions_P2418; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_P2418 { // libcis: isolate file-scope helpers
template <class CharT>
static void test() {
  MoveOnly m{10};
  CharT buffer[10];
...
} using namespace libcis_ns_utilities_format_format_functions_P2418; // libcis


void test_utilities_format_format_functions_P2418() {
  test<char>();
