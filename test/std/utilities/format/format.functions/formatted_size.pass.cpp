// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_functions_formatted_size).
// main -> test_utilities_format_format_functions_formatted_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_functions_formatted_size { // libcis: isolate file-scope helpers
auto test =
...
} using namespace libcis_ns_utilities_format_format_functions_formatted_size; // libcis


void test_utilities_format_format_functions_formatted_size() {
