// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_range_format_range_fmtstr_parse).
// main -> test_utilities_format_format_range_format_range_fmtstr_parse; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_range_format_range_fmtstr_parse { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_range_format_range_fmtstr_parse; // libcis


void test_utilities_format_format_range_format_range_fmtstr_parse() {
  test();
  static_assert(test());
