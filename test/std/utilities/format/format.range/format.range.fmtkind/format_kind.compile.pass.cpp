// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_range_format_range_fmtkind_format_kind).
...
namespace libcis_ns_utilities_format_format_range_format_range_fmtkind_format_kind { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_range_format_range_fmtkind_format_kind; // libcis
