// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_range_format_range_fmtmap_format).
// main -> test_utilities_format_format_range_format_range_fmtmap_format; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_range_format_range_fmtmap_format { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_range_format_range_fmtmap_format; // libcis


void test_utilities_format_format_range_format_range_fmtmap_format() {
  test();
