// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_range_format_range_formatter_set_brackets).
// main -> test_utilities_format_format_range_format_range_formatter_set_brackets; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_range_format_range_formatter_set_brackets { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_range_format_range_formatter_set_brackets; // libcis


void test_utilities_format_format_range_format_range_formatter_set_brackets() {
  test();
  static_assert(test());
