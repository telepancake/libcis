// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_arguments_format_args_ctor_b1c7919f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_arguments_format_args_ctor_b1c7919f { // libcis
...
} // libcis_ns_utilities_format_format_arguments_format_args_ctor_b1c7919f (libcis)
