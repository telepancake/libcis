// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_arguments_format_args_get).
// main -> test_utilities_format_format_arguments_format_args_get; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_arguments_format_args_get { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_arguments_format_args_get; // libcis


void test_utilities_format_format_arguments_format_args_get() {
  test();
