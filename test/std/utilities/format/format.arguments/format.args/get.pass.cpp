// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_arguments_format_args_get_ce3d11f4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_arguments_format_args_get_ce3d11f4 { // libcis
...
} // libcis_ns_utilities_format_format_arguments_format_args_get_ce3d11f4 (libcis)
