// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_format_format_arguments_format_args_ctad_b75d5128).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_arguments_format_args_ctad_b75d5128 { // libcis
void test() {
  int i = 1;
...
} // libcis_ns_utilities_format_format_arguments_format_args_ctad_b75d5128 (libcis)
