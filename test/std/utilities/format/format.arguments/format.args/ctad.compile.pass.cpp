// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_arguments_format_args_ctad).
...
namespace libcis_ns_utilities_format_format_arguments_format_args_ctad { // libcis: isolate file-scope helpers
void test() {
  int i = 1;
...
} using namespace libcis_ns_utilities_format_format_arguments_format_args_ctad; // libcis
