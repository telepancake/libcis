// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_arguments_format_arg_visit).
// main -> test_utilities_format_format_arguments_format_arg_visit; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_format_format_arguments_format_arg_visit { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_arguments_format_arg_visit; // libcis


void test_utilities_format_format_arguments_format_arg_visit() {
  test<char>();
