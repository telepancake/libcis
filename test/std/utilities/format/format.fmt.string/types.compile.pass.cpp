// AST-transferred from libc++ by tools/transfer.py (slug=utilities_format_format_fmt_string_types).
...
namespace libcis_ns_utilities_format_format_fmt_string_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_format_format_fmt_string_types; // libcis
