// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_intseq_intseq_general_integer_seq_93ea6999).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_intseq_intseq_general_integer_seq_93ea6999 { // libcis
...
} // libcis_ns_utilities_intseq_intseq_general_integer_seq_93ea6999 (libcis)
