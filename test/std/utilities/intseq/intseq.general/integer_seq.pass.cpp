// AST-transferred from libc++ by tools/transfer.py (slug=utilities_intseq_intseq_general_integer_seq).
// main -> test_utilities_intseq_intseq_general_integer_seq; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_intseq_intseq_general_integer_seq { // libcis: isolate file-scope helpers
template <typename AtContainer, typename T, T... I>
auto extract ( const AtContainer &t, const std::integer_sequence<T, I...> )
-> decltype ( std::make_tuple ( std::get<I>(t)... ))
{     return  std::make_tuple ( std::get<I>(t)... ); }
} using namespace libcis_ns_utilities_intseq_intseq_general_integer_seq; // libcis


void test_utilities_intseq_intseq_general_integer_seq()
{
