// AST-transferred from libc++ by tools/transfer.py (slug=utilities_intseq_intseq_intseq_integer_seq).
// main -> test_utilities_intseq_intseq_intseq_integer_seq; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_intseq_intseq_intseq_integer_seq()
{
