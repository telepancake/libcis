// AST-transferred from libc++ by tools/transfer.py (slug=utilities_any_any_nonmembers_any_cast_any_cast_reference).
// main -> test_utilities_any_any_nonmembers_any_cast_any_cast_reference; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_nonmembers_any_cast_any_cast_reference { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_any_any_nonmembers_any_cast_any_cast_reference; // libcis


void test_utilities_any_any_nonmembers_any_cast_any_cast_reference() {
