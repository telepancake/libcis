// AST-transferred from libc++ by tools/transfer.py (slug=utilities_any_any_nonmembers_make_any).
// main -> test_utilities_any_any_nonmembers_make_any; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_nonmembers_make_any { // libcis: isolate file-scope helpers
template <class Type>
...
} using namespace libcis_ns_utilities_any_any_nonmembers_make_any; // libcis
...
void test_utilities_any_any_nonmembers_make_any() {
