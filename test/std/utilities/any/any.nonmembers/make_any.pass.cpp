// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_any_any_nonmembers_make_any_6e05fd9b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_nonmembers_make_any_6e05fd9b { // libcis
template <class Type>
...
} // libcis_ns_utilities_any_any_nonmembers_make_any_6e05fd9b (libcis)
