// AST-transferred from libc++ by tools/transfer.py (slug=utilities_any_any_class_allocator).
// main -> test_utilities_any_any_class_allocator; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_class_allocator { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_any_any_class_allocator; // libcis


void test_utilities_any_any_class_allocator() {
  // Test large types
  {
