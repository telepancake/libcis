// AST-transferred from libc++ by tools/transfer.py (slug=utilities_any_any_class_any_modifiers_emplace).
// main -> test_utilities_any_any_class_any_modifiers_emplace; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_class_any_modifiers_emplace { // libcis: isolate file-scope helpers
struct Tracked {
    static int count;
    Tracked() { ++count; }
...
} using namespace libcis_ns_utilities_any_any_class_any_modifiers_emplace; // libcis
...
void test_utilities_any_any_class_any_modifiers_emplace() {
