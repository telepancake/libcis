// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_any_any_class_any_cons_in_place_type_e030d3ea).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_class_any_cons_in_place_type_e030d3ea { // libcis
template <class Type>
...
} // libcis_ns_utilities_any_any_class_any_cons_in_place_type_e030d3ea (libcis)
