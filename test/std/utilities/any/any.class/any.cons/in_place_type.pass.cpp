// AST-transferred from libc++ by tools/transfer.py (slug=utilities_any_any_class_any_cons_in_place_type).
// main -> test_utilities_any_any_class_any_cons_in_place_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_class_any_cons_in_place_type { // libcis: isolate file-scope helpers
template <class Type>
...
} using namespace libcis_ns_utilities_any_any_class_any_cons_in_place_type; // libcis


void test_utilities_any_any_class_any_cons_in_place_type() {
