// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_any_any_class_any_cons_move_3d656ad4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_class_any_cons_move_3d656ad4 { // libcis
...
} // libcis_ns_utilities_any_any_class_any_cons_move_3d656ad4 (libcis)
