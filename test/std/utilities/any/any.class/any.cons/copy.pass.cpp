// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_any_any_class_any_cons_copy_a84b9253).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_class_any_cons_copy_a84b9253 { // libcis
template <class Type>
...
} // libcis_ns_utilities_any_any_class_any_cons_copy_a84b9253 (libcis)
