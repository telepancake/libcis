// AST-transferred from libc++ by tools/transfer.py (slug=utilities_any_any_class_any_cons_copy).
// main -> test_utilities_any_any_class_any_cons_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_class_any_cons_copy { // libcis: isolate file-scope helpers
template <class Type>
...
} using namespace libcis_ns_utilities_any_any_class_any_cons_copy; // libcis


void test_utilities_any_any_class_any_cons_copy() {
    test_copy<small>();
    test_copy<large>();
    test_copy_empty();
