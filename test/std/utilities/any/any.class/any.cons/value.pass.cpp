// AST-transferred from libc++ by tools/transfer.py (slug=utilities_any_any_class_any_cons_value).
// main -> test_utilities_any_any_class_any_cons_value; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_class_any_cons_value { // libcis: isolate file-scope helpers
template <class Type>
...
} using namespace libcis_ns_utilities_any_any_class_any_cons_value; // libcis


void test_utilities_any_any_class_any_cons_value() {
