// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_any_any_class_any_cons_value_5e4730d5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_class_any_cons_value_5e4730d5 { // libcis
template <class Type>
...
} // libcis_ns_utilities_any_any_class_any_cons_value_5e4730d5 (libcis)
