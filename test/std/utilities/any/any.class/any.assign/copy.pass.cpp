// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_any_any_class_any_assign_copy_541d7ebc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_class_any_assign_copy_541d7ebc { // libcis
...
} // libcis_ns_utilities_any_any_class_any_assign_copy_541d7ebc (libcis)
