// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_any_any_class_any_assign_value_3d7989d6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_class_any_assign_value_3d7989d6 { // libcis
...
} // libcis_ns_utilities_any_any_class_any_assign_value_3d7989d6 (libcis)
