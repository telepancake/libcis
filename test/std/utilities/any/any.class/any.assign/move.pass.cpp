// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_any_any_class_any_assign_move_0e3aa263).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_any_any_class_any_assign_move_0e3aa263 { // libcis
...
} // libcis_ns_utilities_any_any_class_any_assign_move_0e3aa263 (libcis)
