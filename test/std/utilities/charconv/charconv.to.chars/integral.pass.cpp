// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_charconv_charconv_to_chars_integral_cb5666b7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_charconv_charconv_to_chars_integral_cb5666b7 { // libcis
...
} // libcis_ns_utilities_charconv_charconv_to_chars_integral_cb5666b7 (libcis)
