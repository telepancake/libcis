// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_charconv_charconv_syn_chars_format_520a7bd7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_charconv_charconv_syn_chars_format_520a7bd7 { // libcis
constexpr bool test() {
...
} // libcis_ns_utilities_charconv_charconv_syn_chars_format_520a7bd7 (libcis)
