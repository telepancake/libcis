// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_charconv_charconv_syn_from_chars_result_5708f682).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_charconv_charconv_syn_from_chars_result_5708f682 { // libcis
constexpr bool test() {
...
} // libcis_ns_utilities_charconv_charconv_syn_from_chars_result_5708f682 (libcis)
