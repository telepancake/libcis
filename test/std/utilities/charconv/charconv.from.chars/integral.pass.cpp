// AST-transferred from libc++ by tools/transfer.py (slug=utilities_charconv_charconv_from_chars_integral).
// main -> test_utilities_charconv_charconv_from_chars_integral; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_charconv_charconv_from_chars_integral { // libcis: isolate file-scope helpers
template <typename T>
struct test_basics
{
...
} using namespace libcis_ns_utilities_charconv_charconv_from_chars_integral; // libcis


void test_utilities_charconv_charconv_from_chars_integral() {
    test();
#if TEST_STD_VER > 20
    static_assert(test());
#endif
