// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_charconv_charconv_from_chars_integral_57113cf4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_charconv_charconv_from_chars_integral_57113cf4 { // libcis
template <typename T>
struct test_basics
{
...
} // libcis_ns_utilities_charconv_charconv_from_chars_integral_57113cf4 (libcis)
