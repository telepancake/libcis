// AST-transferred from libc++ by tools/transfer.py (slug=utilities_charconv_charconv_from_chars_floating_point).
// main -> test_utilities_charconv_charconv_from_chars_floating_point; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_charconv_charconv_from_chars_floating_point { // libcis: isolate file-scope helpers
template <class F>
...
} using namespace libcis_ns_utilities_charconv_charconv_from_chars_floating_point; // libcis


void test_utilities_charconv_charconv_from_chars_floating_point() {
