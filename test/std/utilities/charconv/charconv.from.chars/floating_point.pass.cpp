// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_charconv_charconv_from_chars_floating_point_222731f0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_charconv_charconv_from_chars_floating_point_222731f0 { // libcis
template <class F>
...
} // libcis_ns_utilities_charconv_charconv_from_chars_floating_point_222731f0 (libcis)
