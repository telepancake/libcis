// AST-transferred from libc++ by tools/transfer.py (slug=utilities_charconv_charconv_msvc_test).
...
namespace libcis_ns_utilities_charconv_charconv_msvc_test { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_charconv_charconv_msvc_test; // libcis
