// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_operators_op_not_81f364de).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_operators_op_not_81f364de { // libcis
...
} // libcis_ns_utilities_template_bitset_bitset_operators_op_not_81f364de (libcis)
