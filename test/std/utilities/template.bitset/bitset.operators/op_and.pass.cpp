// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_operators_op_and_8f30bd38).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_operators_op_and_8f30bd38 { // libcis
...
} // libcis_ns_utilities_template_bitset_bitset_operators_op_and_8f30bd38 (libcis)
