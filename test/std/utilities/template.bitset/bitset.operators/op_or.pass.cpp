// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_operators_op_or_2ba2eefc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_operators_op_or_2ba2eefc { // libcis
...
} // libcis_ns_utilities_template_bitset_bitset_operators_op_or_2ba2eefc (libcis)
