// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_index_const_dcef503b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_members_index_const_dcef503b { // libcis
...
} // libcis_ns_utilities_template_bitset_bitset_members_index_const_dcef503b (libcis)
