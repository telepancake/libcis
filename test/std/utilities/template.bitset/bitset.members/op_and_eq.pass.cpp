// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_op_and_eq_2a1832df).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_members_op_and_eq_2a1832df { // libcis
...
} // libcis_ns_utilities_template_bitset_bitset_members_op_and_eq_2a1832df (libcis)
