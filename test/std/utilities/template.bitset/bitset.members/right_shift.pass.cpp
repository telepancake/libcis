// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_right_shift_cee41cf8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_members_right_shift_cee41cf8 { // libcis
...
} // libcis_ns_utilities_template_bitset_bitset_members_right_shift_cee41cf8 (libcis)
