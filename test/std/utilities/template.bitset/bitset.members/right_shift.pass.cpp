// AST-transferred from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_right_shift).
// main -> test_utilities_template_bitset_bitset_members_right_shift; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_members_right_shift { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_template_bitset_bitset_members_right_shift; // libcis


void test_utilities_template_bitset_bitset_members_right_shift() {
  test_right_shift<0>();
  test_right_shift<1>();
  test_right_shift<31>();
  test_right_shift<32>();
