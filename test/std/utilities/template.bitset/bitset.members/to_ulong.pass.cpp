// AST-transferred from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_to_ulong).
// main -> test_utilities_template_bitset_bitset_members_to_ulong; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_members_to_ulong { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_template_bitset_bitset_members_to_ulong; // libcis


void test_utilities_template_bitset_bitset_members_to_ulong() {
  test();
#if TEST_STD_VER > 20
  static_assert(test());
#endif
