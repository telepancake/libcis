// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_left_shift_2e341e8d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_members_left_shift_2e341e8d { // libcis
...
} // libcis_ns_utilities_template_bitset_bitset_members_left_shift_2e341e8d (libcis)
