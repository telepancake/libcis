// AST-transferred from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_left_shift_eq).
// main -> test_utilities_template_bitset_bitset_members_left_shift_eq; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_members_left_shift_eq { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_template_bitset_bitset_members_left_shift_eq; // libcis


void test_utilities_template_bitset_bitset_members_left_shift_eq() {
  test_left_shift<0>();
  test_left_shift<1>();
  test_left_shift<31>();
  test_left_shift<32>();
