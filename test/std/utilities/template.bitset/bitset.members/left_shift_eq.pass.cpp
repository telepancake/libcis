// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_left_shift_eq_a0759e06).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_members_left_shift_eq_a0759e06 { // libcis
...
} // libcis_ns_utilities_template_bitset_bitset_members_left_shift_eq_a0759e06 (libcis)
