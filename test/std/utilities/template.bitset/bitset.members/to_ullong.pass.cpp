// AST-transferred from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_to_ullong).
// main -> test_utilities_template_bitset_bitset_members_to_ullong; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_members_to_ullong { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_template_bitset_bitset_members_to_ullong; // libcis


void test_utilities_template_bitset_bitset_members_to_ullong() {
  test();
#if TEST_STD_VER > 20
  static_assert(test());
#endif
