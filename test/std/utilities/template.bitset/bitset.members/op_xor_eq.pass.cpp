// AST-transferred from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_op_xor_eq).
// main -> test_utilities_template_bitset_bitset_members_op_xor_eq; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_members_op_xor_eq { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_template_bitset_bitset_members_op_xor_eq; // libcis


void test_utilities_template_bitset_bitset_members_op_xor_eq() {
  test_op_xor_eq<0>();
  test_op_xor_eq<1>();
  test_op_xor_eq<31>();
  test_op_xor_eq<32>();
