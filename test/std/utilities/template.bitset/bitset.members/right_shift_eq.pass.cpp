// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_right_shift_eq_b1dbc8fd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_members_right_shift_eq_b1dbc8fd { // libcis
...
} // libcis_ns_utilities_template_bitset_bitset_members_right_shift_eq_b1dbc8fd (libcis)
