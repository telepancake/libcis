// AST-transferred from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_to_string).
// main -> test_utilities_template_bitset_bitset_members_to_string; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_members_to_string { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_template_bitset_bitset_members_to_string; // libcis

#endif

void test_utilities_template_bitset_bitset_members_to_string() {
  test_to_string<0>();
  test_to_string<1>();
  test_to_string<31>();
  test_to_string<32>();
