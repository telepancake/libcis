// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_nonstdmem_uglified_11574073).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_members_nonstdmem_uglified_11574073 { // libcis
struct my_base {
...
} // libcis_ns_utilities_template_bitset_bitset_members_nonstdmem_uglified_11574073 (libcis)
