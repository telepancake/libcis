// AST-transferred from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_members_nonstdmem_uglified).
...
namespace libcis_ns_utilities_template_bitset_bitset_members_nonstdmem_uglified { // libcis: isolate file-scope helpers
struct my_base {
...
} using namespace libcis_ns_utilities_template_bitset_bitset_members_nonstdmem_uglified; // libcis
