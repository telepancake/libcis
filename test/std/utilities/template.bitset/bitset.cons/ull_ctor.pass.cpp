// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_cons_ull_ctor_2108339a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_cons_ull_ctor_2108339a { // libcis
...
} // libcis_ns_utilities_template_bitset_bitset_cons_ull_ctor_2108339a (libcis)
