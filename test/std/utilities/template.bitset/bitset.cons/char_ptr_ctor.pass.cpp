// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_cons_char_ptr_ctor_4becd7e4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_cons_char_ptr_ctor_4becd7e4 { // libcis
...
} // libcis_ns_utilities_template_bitset_bitset_cons_char_ptr_ctor_4becd7e4 (libcis)
