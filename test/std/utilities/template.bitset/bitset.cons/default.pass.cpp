// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_cons_default_babc2e00).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_cons_default_babc2e00 { // libcis
...
} // libcis_ns_utilities_template_bitset_bitset_cons_default_babc2e00 (libcis)
