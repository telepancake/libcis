// AST-transferred from libc++ by tools/transfer.py (slug=utilities_template_bitset_bitset_cons_string_ctor).
// main -> test_utilities_template_bitset_bitset_cons_string_ctor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_template_bitset_bitset_cons_string_ctor { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_template_bitset_bitset_cons_string_ctor; // libcis


void test_utilities_template_bitset_bitset_cons_string_ctor() {
  test();
#if TEST_STD_VER > 20
  static_assert(test());
#endif
