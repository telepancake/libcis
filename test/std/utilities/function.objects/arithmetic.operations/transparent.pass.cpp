// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_arithmetic_operations_transparent_37e5bf21).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_arithmetic_operations_transparent_37e5bf21 { // libcis
template <class T>
...
} // libcis_ns_utilities_function_objects_arithmetic_operations_transparent_37e5bf21 (libcis)
