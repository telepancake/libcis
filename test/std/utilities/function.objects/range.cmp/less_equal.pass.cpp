// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_range_cmp_less_equal_7fd6b68b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_range_cmp_less_equal_7fd6b68b { // libcis
...
} // libcis_ns_utilities_function_objects_range_cmp_less_equal_7fd6b68b (libcis)
