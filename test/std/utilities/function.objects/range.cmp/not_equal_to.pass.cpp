// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_range_cmp_not_equal_to_9b21ee74).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_range_cmp_not_equal_to_9b21ee74 { // libcis
...
} // libcis_ns_utilities_function_objects_range_cmp_not_equal_to_9b21ee74 (libcis)
