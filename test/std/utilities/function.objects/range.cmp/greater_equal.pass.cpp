// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_range_cmp_greater_equal_7aa54b66).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_range_cmp_greater_equal_7aa54b66 { // libcis
...
} // libcis_ns_utilities_function_objects_range_cmp_greater_equal_7aa54b66 (libcis)
