// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_range_cmp_greater_199286d5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_range_cmp_greater_199286d5 { // libcis
...
} // libcis_ns_utilities_function_objects_range_cmp_greater_199286d5 (libcis)
