// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_not_fn_not_fn_nttp).
// main -> test_utilities_function_objects_func_not_fn_not_fn_nttp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_not_fn_not_fn_nttp { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_function_objects_func_not_fn_not_fn_nttp; // libcis


void test_utilities_function_objects_func_not_fn_not_fn_nttp() {
  test();
  static_assert(test());
