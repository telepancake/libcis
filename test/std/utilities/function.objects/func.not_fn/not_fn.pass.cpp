// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_not_fn_not_fn).
// main -> test_utilities_function_objects_func_not_fn_not_fn; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_not_fn_not_fn { // libcis: isolate file-scope helpers
struct EvilBool {
...
} using namespace libcis_ns_utilities_function_objects_func_not_fn_not_fn; // libcis
...
void test_utilities_function_objects_func_not_fn_not_fn()
{
    constructor_tests();
    return_type_tests();
