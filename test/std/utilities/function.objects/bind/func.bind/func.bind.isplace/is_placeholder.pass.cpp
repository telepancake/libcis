// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_isplace_is_placeholder).
// main -> test_utilities_function_objects_bind_func_bind_func_bind_isplace_is_placeholder; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_isplace_is_placeholder { // libcis: isolate file-scope helpers
...
struct C {};
} using namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_isplace_is_placeholder; // libcis


void test_utilities_function_objects_bind_func_bind_func_bind_isplace_is_placeholder()
{
