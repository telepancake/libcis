// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_isplace_is_placeholder_9881869a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_isplace_is_placeholder_9881869a { // libcis
...
} // libcis_ns_utilities_function_objects_bind_func_bind_func_bind_isplace_is_placeholder_9881869a (libcis)
