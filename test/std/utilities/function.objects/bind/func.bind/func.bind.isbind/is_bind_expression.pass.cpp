// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_isbind_is_bind_expression).
// main -> test_utilities_function_objects_bind_func_bind_func_bind_isbind_is_bind_expression; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_isbind_is_bind_expression { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_isbind_is_bind_expression; // libcis


void test_utilities_function_objects_bind_func_bind_func_bind_isbind_is_bind_expression()
{
