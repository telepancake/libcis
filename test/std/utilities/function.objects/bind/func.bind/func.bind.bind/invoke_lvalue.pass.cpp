// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_bind_invoke_lvalue_4c2bd73b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_lvalue_4c2bd73b { // libcis
int count = 0;
...
} // libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_lvalue_4c2bd73b (libcis)
