// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_bind_invoke_lvalue).
// main -> test_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_lvalue; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_lvalue { // libcis: isolate file-scope helpers
int count = 0;
...
} using namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_lvalue; // libcis


void test_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_lvalue() {
    test_void_1();
    test_int_1();
    test_void_2();
