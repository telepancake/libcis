// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_bind_copy).
// main -> test_utilities_function_objects_bind_func_bind_func_bind_bind_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_copy { // libcis: isolate file-scope helpers
float _pow(float a, float b)
{
    return std::pow(a, b);
}
} using namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_copy; // libcis


void test_utilities_function_objects_bind_func_bind_func_bind_bind_copy()
{
