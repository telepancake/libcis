// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_bind_invoke_rvalue).
// main -> test_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_rvalue; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_rvalue { // libcis: isolate file-scope helpers
int count = 0;
...
} using namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_rvalue; // libcis


void test_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_rvalue() {
    test_void_1();
    test_int_1();
    test_void_2();
    test_nested();
