// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_bind_invoke_rvalue_ae35af70).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_rvalue_ae35af70 { // libcis
int count = 0;
...
} // libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_rvalue_ae35af70 (libcis)
