// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_bind_invoke_int_0_fa265c4f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_int_0_fa265c4f { // libcis
...
} // libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_int_0_fa265c4f (libcis)
