// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_bind_bind_return_type).
// main -> test_utilities_function_objects_bind_func_bind_func_bind_bind_bind_return_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_bind_return_type { // libcis: isolate file-scope helpers
int dummy = 42;
...
} using namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_bind_return_type; // libcis


void test_utilities_function_objects_bind_func_bind_func_bind_bind_bind_return_type()
{
