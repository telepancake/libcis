// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_bind_bind_return_type_803a7f2a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_bind_return_type_803a7f2a { // libcis
int dummy = 42;
...
} // libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_bind_return_type_803a7f2a (libcis)
