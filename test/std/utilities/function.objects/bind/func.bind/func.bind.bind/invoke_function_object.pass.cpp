// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_bind_invoke_function_object_a5e7d61c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_function_object_a5e7d61c { // libcis
...
} // libcis_ns_utilities_function_objects_bind_func_bind_func_bind_bind_invoke_function_object_a5e7d61c (libcis)
