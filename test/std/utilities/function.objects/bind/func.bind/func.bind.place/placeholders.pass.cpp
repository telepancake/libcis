// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_place_placeholders).
// main -> test_utilities_function_objects_bind_func_bind_func_bind_place_placeholders; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_place_placeholders { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_place_placeholders; // libcis


void test_utilities_function_objects_bind_func_bind_func_bind_place_placeholders() {
  test_all();
#if TEST_STD_VER >= 17
