// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_bind_func_bind_func_bind_place_placeholders_63594061).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bind_func_bind_func_bind_place_placeholders_63594061 { // libcis
template <class T>
...
} // libcis_ns_utilities_function_objects_bind_func_bind_func_bind_place_placeholders_63594061 (libcis)
