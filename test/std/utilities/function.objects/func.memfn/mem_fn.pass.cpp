// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_memfn_mem_fn_dc47ef55).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_memfn_mem_fn_dc47ef55 { // libcis
struct A {
  double data_;
...
} // libcis_ns_utilities_function_objects_func_memfn_mem_fn_dc47ef55 (libcis)
