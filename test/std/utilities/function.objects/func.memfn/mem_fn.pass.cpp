// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_memfn_mem_fn).
// main -> test_utilities_function_objects_func_memfn_mem_fn; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_memfn_mem_fn { // libcis: isolate file-scope helpers
struct A {
  double data_;
...
} using namespace libcis_ns_utilities_function_objects_func_memfn_mem_fn; // libcis

#endif

void test_utilities_function_objects_func_memfn_mem_fn() {
