// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_memfn_robust_against_adl_97432635).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_memfn_robust_against_adl_97432635 { // libcis
struct Incomplete;
...
} // libcis_ns_utilities_function_objects_func_memfn_robust_against_adl_97432635 (libcis)
