// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_bitwise_operations_bit_or).
// main -> test_utilities_function_objects_bitwise_operations_bit_or; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_function_objects_bitwise_operations_bit_or()
{
