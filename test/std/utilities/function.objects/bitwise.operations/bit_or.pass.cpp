// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_bitwise_operations_bit_or_f5a5063f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bitwise_operations_bit_or_f5a5063f { // libcis
int main(int, char**)
{
...
} // libcis_ns_utilities_function_objects_bitwise_operations_bit_or_f5a5063f (libcis)
