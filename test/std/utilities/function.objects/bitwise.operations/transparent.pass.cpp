// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_bitwise_operations_transparent_7a66a391).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bitwise_operations_transparent_7a66a391 { // libcis
template <class T>
...
} // libcis_ns_utilities_function_objects_bitwise_operations_transparent_7a66a391 (libcis)
