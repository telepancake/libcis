// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_bitwise_operations_bit_xor).
// main -> test_utilities_function_objects_bitwise_operations_bit_xor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_function_objects_bitwise_operations_bit_xor()
{
    {
