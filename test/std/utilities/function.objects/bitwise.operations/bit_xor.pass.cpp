// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_bitwise_operations_bit_xor_4185975a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bitwise_operations_bit_xor_4185975a { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_utilities_function_objects_bitwise_operations_bit_xor_4185975a (libcis)
