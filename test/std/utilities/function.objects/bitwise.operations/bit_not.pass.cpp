// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_bitwise_operations_bit_not_e761a699).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_bitwise_operations_bit_not_e761a699 { // libcis
int main(int, char**)
{
...
} // libcis_ns_utilities_function_objects_bitwise_operations_bit_not_e761a699 (libcis)
