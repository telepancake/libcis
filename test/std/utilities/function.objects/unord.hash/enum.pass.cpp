// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_unord_hash_enum_6833caee).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_unord_hash_enum_6833caee { // libcis
...
} // libcis_ns_utilities_function_objects_unord_hash_enum_6833caee (libcis)
