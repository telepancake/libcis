// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_unord_hash_integral).
// main -> test_utilities_function_objects_unord_hash_integral; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_unord_hash_integral { // libcis: isolate file-scope helpers
template <class T>
void
test()
{
...
} using namespace libcis_ns_utilities_function_objects_unord_hash_integral; // libcis


void test_utilities_function_objects_unord_hash_integral()
{
    test<bool>();
    test<char>();
    test<signed char>();
