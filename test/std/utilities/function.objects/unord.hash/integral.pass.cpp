// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_unord_hash_integral_3c143e0b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_unord_hash_integral_3c143e0b { // libcis
template <class T>
void
test()
{
...
} // libcis_ns_utilities_function_objects_unord_hash_integral_3c143e0b (libcis)
