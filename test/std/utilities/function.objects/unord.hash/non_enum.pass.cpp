// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_unord_hash_non_enum_7d96bace).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_unord_hash_non_enum_7d96bace { // libcis
struct X {};
...
} // libcis_ns_utilities_function_objects_unord_hash_non_enum_7d96bace (libcis)
