// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_unord_hash_non_enum).
// main -> test_utilities_function_objects_unord_hash_non_enum; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_unord_hash_non_enum { // libcis: isolate file-scope helpers
struct X {};
} using namespace libcis_ns_utilities_function_objects_unord_hash_non_enum; // libcis


void test_utilities_function_objects_unord_hash_non_enum()
{
    using H = std::hash<X>;
