// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_bind_front_bind_front).
// main -> test_utilities_function_objects_func_bind_front_bind_front; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_bind_front_bind_front { // libcis: isolate file-scope helpers
struct CopyMoveInfo {
...
} using namespace libcis_ns_utilities_function_objects_func_bind_front_bind_front; // libcis


void test_utilities_function_objects_func_bind_front_bind_front() {
  test();
  static_assert(test());
