// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_bind_front_bind_front_ae6b0df4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_bind_front_bind_front_ae6b0df4 { // libcis
struct CopyMoveInfo {
...
} // libcis_ns_utilities_function_objects_func_bind_front_bind_front_ae6b0df4 (libcis)
