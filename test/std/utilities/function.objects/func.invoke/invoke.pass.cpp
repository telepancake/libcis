// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_invoke_invoke_6275bf96).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_invoke_invoke_6275bf96 { // libcis
struct NonCopyable {
    NonCopyable() {}
private:
...
} // libcis_ns_utilities_function_objects_func_invoke_invoke_6275bf96 (libcis)
