// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_invoke_invoke_r).
// main -> test_utilities_function_objects_func_invoke_invoke_r; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_invoke_invoke_r { // libcis: isolate file-scope helpers
template <class R, class F, class ...Args>
...
} using namespace libcis_ns_utilities_function_objects_func_invoke_invoke_r; // libcis


void test_utilities_function_objects_func_invoke_invoke_r() {
    test();
    static_assert(test());
    return;
}
