// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_invoke_invoke_constexpr_1342fa17).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_invoke_invoke_constexpr_1342fa17 { // libcis
struct NonCopyable {
...
} // libcis_ns_utilities_function_objects_func_invoke_invoke_constexpr_1342fa17 (libcis)
