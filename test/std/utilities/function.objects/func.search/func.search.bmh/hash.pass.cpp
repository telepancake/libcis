// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_search_func_search_bmh_hash_3cb5ee48).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_search_func_search_bmh_hash_3cb5ee48 { // libcis
...
} // libcis_ns_utilities_function_objects_func_search_func_search_bmh_hash_3cb5ee48 (libcis)
