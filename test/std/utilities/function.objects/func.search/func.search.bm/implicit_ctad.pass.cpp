// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_search_func_search_bm_implicit_ctad_257325a2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_search_func_search_bm_implicit_ctad_257325a2 { // libcis
int main(int, char**) {
  {
...
} // libcis_ns_utilities_function_objects_func_search_func_search_bm_implicit_ctad_257325a2 (libcis)
