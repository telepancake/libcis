// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_search_func_search_bm_hash_ef837132).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_search_func_search_bm_hash_ef837132 { // libcis
...
} // libcis_ns_utilities_function_objects_func_search_func_search_bm_hash_ef837132 (libcis)
