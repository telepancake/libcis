// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_search_func_search_bm_default).
// main -> test_utilities_function_objects_func_search_func_search_bm_default; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_search_func_search_bm_default { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_function_objects_func_search_func_search_bm_default; // libcis


void test_utilities_function_objects_func_search_func_search_bm_default() {
