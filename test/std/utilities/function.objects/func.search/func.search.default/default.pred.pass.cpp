// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_search_func_search_default_default_pred_6f739740).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_search_func_search_default_default_pred_6f739740 { // libcis
struct count_equal
{
    int *count;
...
} // libcis_ns_utilities_function_objects_func_search_func_search_default_default_pred_6f739740 (libcis)
