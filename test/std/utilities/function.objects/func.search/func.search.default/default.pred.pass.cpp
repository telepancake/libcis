// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_search_func_search_default_default_pred).
// main -> test_utilities_function_objects_func_search_func_search_default_default_pred; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_search_func_search_default_default_pred { // libcis: isolate file-scope helpers
struct count_equal
{
    int *count;
...
} using namespace libcis_ns_utilities_function_objects_func_search_func_search_default_default_pred; // libcis


void test_utilities_function_objects_func_search_func_search_default_default_pred() {
