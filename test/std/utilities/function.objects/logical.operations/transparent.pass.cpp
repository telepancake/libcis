// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_logical_operations_transparent_3f774d20).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_logical_operations_transparent_3f774d20 { // libcis
template <class T>
...
} // libcis_ns_utilities_function_objects_logical_operations_transparent_3f774d20 (libcis)
