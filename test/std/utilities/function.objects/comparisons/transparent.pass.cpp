// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_comparisons_transparent_2f1fa03b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_comparisons_transparent_2f1fa03b { // libcis
template <class T>
...
} // libcis_ns_utilities_function_objects_comparisons_transparent_2f1fa03b (libcis)
