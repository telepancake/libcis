// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_comparisons_transparent).
// main -> test_utilities_function_objects_comparisons_transparent; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_comparisons_transparent { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_utilities_function_objects_comparisons_transparent; // libcis



void test_utilities_function_objects_comparisons_transparent()
{
