// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_comparisons_less_equal).
// main -> test_utilities_function_objects_comparisons_less_equal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_function_objects_comparisons_less_equal()
{
