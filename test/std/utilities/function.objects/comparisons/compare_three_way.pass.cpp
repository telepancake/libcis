// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_comparisons_compare_three_way).
// main -> test_utilities_function_objects_comparisons_compare_three_way; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_comparisons_compare_three_way { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_function_objects_comparisons_compare_three_way; // libcis


void test_utilities_function_objects_comparisons_compare_three_way()
{
    test();
    static_assert(test());
