// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_comparisons_compare_three_way_0e24aa51).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_comparisons_compare_three_way_0e24aa51 { // libcis
...
} // libcis_ns_utilities_function_objects_comparisons_compare_three_way_0e24aa51 (libcis)
