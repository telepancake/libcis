// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_bind_partial_bind_back).
// main -> test_utilities_function_objects_func_bind_partial_bind_back; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_bind_partial_bind_back { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_function_objects_func_bind_partial_bind_back; // libcis


void test_utilities_function_objects_func_bind_partial_bind_back() {
  test();
  static_assert(test());
