// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_operations_implicit_ctad).
// main -> test_utilities_function_objects_operations_implicit_ctad; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_function_objects_operations_implicit_ctad() {
    {
        std::plus f;
