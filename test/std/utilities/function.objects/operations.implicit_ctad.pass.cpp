// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_operations_implicit_ctad_797a91d9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_operations_implicit_ctad_797a91d9 { // libcis
int main(int, char**) {
    {
        std::plus f;
...
} // libcis_ns_utilities_function_objects_operations_implicit_ctad_797a91d9 (libcis)
