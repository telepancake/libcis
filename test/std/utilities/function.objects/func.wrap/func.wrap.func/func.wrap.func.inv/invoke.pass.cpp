// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_inv_invoke).
// main -> test_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_inv_invoke; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_inv_invoke { // libcis: isolate file-scope helpers
int count = 0;
...
} using namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_inv_invoke; // libcis


void test_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_inv_invoke()
{
    test_void_0();
    test_int_0();
    test_void_1();
