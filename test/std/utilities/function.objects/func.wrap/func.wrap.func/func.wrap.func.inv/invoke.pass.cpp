// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_inv_invoke_293680b4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_inv_invoke_293680b4 { // libcis
int count = 0;
...
} // libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_inv_invoke_293680b4 (libcis)
