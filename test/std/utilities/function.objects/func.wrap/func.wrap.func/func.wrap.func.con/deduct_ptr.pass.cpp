// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_deduct_ptr).
// main -> test_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_deduct_ptr; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_deduct_ptr { // libcis: isolate file-scope helpers
struct R { };
struct A1 { };
struct A2 { };
struct A3 { };
...
R f4(A1 = {}) { return {}; }
} using namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_deduct_ptr; // libcis


void test_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_deduct_ptr() {
  {
    // implicit
    std::function a = f0;
