// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_deduct_ptr_fd7c4b73).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_deduct_ptr_fd7c4b73 { // libcis
struct R { };
struct A1 { };
struct A2 { };
struct A3 { };
...
} // libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_deduct_ptr_fd7c4b73 (libcis)
