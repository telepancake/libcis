// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_copy_move).
// main -> test_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_copy_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_copy_move { // libcis: isolate file-scope helpers
class A
{
    int data_[10];
public:
...
} using namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_copy_move; // libcis
...
void test_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_copy_move()
{
