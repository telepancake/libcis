// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_F_nullptr).
// main -> test_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_F_nullptr; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
///////////////////////////////////////////////////////////////////////////////
namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_F_nullptr { // libcis: isolate file-scope helpers
int foo() { return 42; }
...
} using namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_F_nullptr; // libcis


void test_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_F_nullptr() {
    test_func();
    test_mf();
    test_md();
