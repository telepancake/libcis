// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_deduct_F).
// main -> test_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_deduct_F; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_deduct_F { // libcis: isolate file-scope helpers
struct R { };
struct A1 { };
struct A2 { };
struct A3 { };
...
} using namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_deduct_F; // libcis


void test_utilities_function_objects_func_wrap_func_wrap_func_func_wrap_func_con_deduct_F() {
