// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_wrap_func_wrap_func_noncopyable_return_type_5442e105).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_noncopyable_return_type_5442e105 { // libcis
struct NonCopyable {
    NonCopyable() = default;
...
} // libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_noncopyable_return_type_5442e105 (libcis)
