// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_wrap_func_wrap_func_noncopyable_return_type).
// main -> test_utilities_function_objects_func_wrap_func_wrap_func_noncopyable_return_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_noncopyable_return_type { // libcis: isolate file-scope helpers
struct NonCopyable {
    NonCopyable() = default;
...
} using namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_noncopyable_return_type; // libcis


void test_utilities_function_objects_func_wrap_func_wrap_func_noncopyable_return_type()
{
    test();
    const_test();
    void_test();
