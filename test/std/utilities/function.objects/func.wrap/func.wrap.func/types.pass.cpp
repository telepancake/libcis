// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_wrap_func_wrap_func_types).
// main -> test_utilities_function_objects_func_wrap_func_wrap_func_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_types { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_types; // libcis


void test_utilities_function_objects_func_wrap_func_wrap_func_types()
{
