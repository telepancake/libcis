// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_wrap_func_wrap_func_types_bf52a587).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_types_bf52a587 { // libcis
template <typename T>
...
} // libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_types_bf52a587 (libcis)
