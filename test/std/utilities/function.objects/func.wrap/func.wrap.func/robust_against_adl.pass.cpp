// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_wrap_func_wrap_func_robust_against_adl).
// main -> test_utilities_function_objects_func_wrap_func_wrap_func_robust_against_adl; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_robust_against_adl { // libcis: isolate file-scope helpers
struct Incomplete;
...
} using namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_robust_against_adl; // libcis


void test_utilities_function_objects_func_wrap_func_wrap_func_robust_against_adl() {
    Ptr x = nullptr;
