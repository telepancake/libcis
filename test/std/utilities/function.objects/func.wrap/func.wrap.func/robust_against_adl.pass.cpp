// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_wrap_func_wrap_func_robust_against_adl_f945fd0a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_robust_against_adl_f945fd0a { // libcis
struct Incomplete;
...
} // libcis_ns_utilities_function_objects_func_wrap_func_wrap_func_robust_against_adl_f945fd0a (libcis)
