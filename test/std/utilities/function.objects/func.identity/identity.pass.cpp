// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_func_identity_identity_69bf822c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_identity_identity_69bf822c { // libcis
...
} // libcis_ns_utilities_function_objects_func_identity_identity_69bf822c (libcis)
