// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_func_identity_identity).
// main -> test_utilities_function_objects_func_identity_identity; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_func_identity_identity { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_function_objects_func_identity_identity; // libcis


void test_utilities_function_objects_func_identity_identity() {
  test();
  static_assert(test());
