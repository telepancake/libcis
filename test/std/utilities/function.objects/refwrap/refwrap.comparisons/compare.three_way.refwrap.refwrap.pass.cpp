// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_refwrap_refwrap_comparisons_compare_three_way_refwrap_refwrap).
// main -> test_utilities_function_objects_refwrap_refwrap_comparisons_compare_three_way_refwrap_refwrap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_refwrap_refwrap_comparisons_compare_three_way_refwrap_refwrap { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_function_objects_refwrap_refwrap_comparisons_compare_three_way_refwrap_refwrap; // libcis


void test_utilities_function_objects_refwrap_refwrap_comparisons_compare_three_way_refwrap_refwrap() {
  test();
  static_assert(test());
