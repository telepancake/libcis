// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_refwrap_refwrap_const_deduct).
// main -> test_utilities_function_objects_refwrap_refwrap_const_deduct; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_function_objects_refwrap_refwrap_const_deduct() {
    int i = 0;
