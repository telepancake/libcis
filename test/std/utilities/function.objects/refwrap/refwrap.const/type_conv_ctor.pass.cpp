// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_refwrap_refwrap_const_type_conv_ctor).
// main -> test_utilities_function_objects_refwrap_refwrap_const_type_conv_ctor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_refwrap_refwrap_const_type_conv_ctor { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_function_objects_refwrap_refwrap_const_type_conv_ctor; // libcis


void test_utilities_function_objects_refwrap_refwrap_const_type_conv_ctor() {
  {
