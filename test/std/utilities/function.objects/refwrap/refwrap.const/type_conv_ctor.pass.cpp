// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_refwrap_refwrap_const_type_conv_ctor_a13a6618).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_refwrap_refwrap_const_type_conv_ctor_a13a6618 { // libcis
...
} // libcis_ns_utilities_function_objects_refwrap_refwrap_const_type_conv_ctor_a13a6618 (libcis)
