// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_refwrap_unwrap_ref_decay_fdc485a0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_refwrap_unwrap_ref_decay_fdc485a0 { // libcis
...
} // libcis_ns_utilities_function_objects_refwrap_unwrap_ref_decay_fdc485a0 (libcis)
