// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_refwrap_refwrap_invoke_robust_against_adl_153d9681).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_refwrap_refwrap_invoke_robust_against_adl_153d9681 { // libcis
struct Incomplete;
...
} // libcis_ns_utilities_function_objects_refwrap_refwrap_invoke_robust_against_adl_153d9681 (libcis)
