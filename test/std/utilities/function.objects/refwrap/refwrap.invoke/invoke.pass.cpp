// AST-transferred from libc++ by tools/transfer.py (slug=utilities_function_objects_refwrap_refwrap_invoke_invoke).
// main -> test_utilities_function_objects_refwrap_refwrap_invoke_invoke; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_refwrap_refwrap_invoke_invoke { // libcis: isolate file-scope helpers
int count = 0;
...
} using namespace libcis_ns_utilities_function_objects_refwrap_refwrap_invoke_invoke; // libcis


#endif // TEST_STD_VER >= 11

void test_utilities_function_objects_refwrap_refwrap_invoke_invoke()
{
    test_void_1();
    test_int_1();
    test_void_2();
