// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_refwrap_refwrap_invoke_invoke_4d998251).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_refwrap_refwrap_invoke_invoke_4d998251 { // libcis
int count = 0;
...
} // libcis_ns_utilities_function_objects_refwrap_refwrap_invoke_invoke_4d998251 (libcis)
