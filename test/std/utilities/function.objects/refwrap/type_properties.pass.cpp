// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_function_objects_refwrap_type_properties_b442420d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_function_objects_refwrap_type_properties_b442420d { // libcis
#if TEST_STD_VER >= 11
class MoveOnly
{
...
} // libcis_ns_utilities_function_objects_refwrap_type_properties_b442420d (libcis)
