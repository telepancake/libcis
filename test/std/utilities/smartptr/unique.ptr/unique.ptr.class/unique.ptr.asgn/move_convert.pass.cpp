// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_convert_83558d57).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_convert_83558d57 { // libcis
template <int ID = 0>
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_convert_83558d57 (libcis)
