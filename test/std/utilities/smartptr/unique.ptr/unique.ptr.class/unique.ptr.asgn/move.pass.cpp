// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_39431a3b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_39431a3b { // libcis
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_39431a3b (libcis)
