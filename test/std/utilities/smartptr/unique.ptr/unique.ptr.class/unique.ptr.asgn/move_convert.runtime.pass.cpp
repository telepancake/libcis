// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_convert_runtime).
// main -> test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_convert_runtime; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_convert_runtime { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_convert_runtime; // libcis


void test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_convert_runtime() {
  test_sfinae();
  // FIXME: add tests
