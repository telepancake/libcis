// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_convert_runtime_476da20c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_convert_runtime_476da20c { // libcis
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_asgn_move_convert_runtime_476da20c (libcis)
