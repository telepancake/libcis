// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_op_subscript_runtime_7c7b46db).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_op_subscript_runtime_7c7b46db { // libcis
static int next = 0;
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_op_subscript_runtime_7c7b46db (libcis)
