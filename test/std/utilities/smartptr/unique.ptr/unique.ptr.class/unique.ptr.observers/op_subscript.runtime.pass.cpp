// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_op_subscript_runtime).
// main -> test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_op_subscript_runtime; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_op_subscript_runtime { // libcis: isolate file-scope helpers
static int next = 0;
...
} using namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_op_subscript_runtime; // libcis


void test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_op_subscript_runtime() {
  test();
#if TEST_STD_VER >= 23
  static_assert(test());
#endif
