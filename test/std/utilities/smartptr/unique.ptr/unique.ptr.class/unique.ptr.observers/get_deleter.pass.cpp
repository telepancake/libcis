// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_get_deleter_bfbd27c9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_get_deleter_bfbd27c9 { // libcis
struct Deleter {
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_get_deleter_bfbd27c9 (libcis)
