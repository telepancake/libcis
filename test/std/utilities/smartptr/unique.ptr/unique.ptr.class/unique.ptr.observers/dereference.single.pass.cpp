// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_dereference_single_2a6c48a9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_dereference_single_2a6c48a9 { // libcis
#if TEST_STD_VER >= 11
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_dereference_single_2a6c48a9 (libcis)
