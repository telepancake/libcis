// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_assert_subscript).
// main -> test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_assert_subscript; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_assert_subscript { // libcis: isolate file-scope helpers
struct MyDeleter {
  MyDeleter() = default;
...
} using namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_assert_subscript; // libcis


void test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_assert_subscript() {
