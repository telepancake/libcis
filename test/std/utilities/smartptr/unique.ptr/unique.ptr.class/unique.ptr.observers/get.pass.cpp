// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_get_ae5e910e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_get_ae5e910e { // libcis
template <class T>
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_observers_get_ae5e910e (libcis)
