// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert_e752841b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert_e752841b { // libcis
template <int ID = 0>
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert_e752841b (libcis)
