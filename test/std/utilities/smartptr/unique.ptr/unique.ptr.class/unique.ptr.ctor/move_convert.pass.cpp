// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert).
// main -> test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert { // libcis: isolate file-scope helpers
template <int ID = 0>
...
} using namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert; // libcis


void test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert() {
  test();
#if TEST_STD_VER >= 23
  static_assert(test());
#endif
