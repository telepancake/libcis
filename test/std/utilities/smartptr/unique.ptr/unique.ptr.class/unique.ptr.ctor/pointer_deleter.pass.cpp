// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_pointer_deleter_ca8683c5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_pointer_deleter_ca8683c5 { // libcis
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_pointer_deleter_ca8683c5 (libcis)
