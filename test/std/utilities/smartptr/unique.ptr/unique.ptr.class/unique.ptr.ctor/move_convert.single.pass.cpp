// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert_single).
// main -> test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert_single; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert_single { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert_single; // libcis


void test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert_single() {
  test();
#if TEST_STD_VER >= 23
  static_assert(test());
#endif
