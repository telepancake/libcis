// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert_single_b30759de).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert_single_b30759de { // libcis
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_convert_single_b30759de (libcis)
