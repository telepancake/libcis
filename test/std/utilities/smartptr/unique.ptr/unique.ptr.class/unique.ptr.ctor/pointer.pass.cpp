// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_pointer).
// main -> test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_pointer; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_pointer { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_pointer; // libcis
...
void test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_pointer() {
  test();
#if TEST_STD_VER >= 23
  static_assert(test());
#endif
