// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_nullptr).
// main -> test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_nullptr; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER >= 11
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_nullptr { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_nullptr; // libcis
...
void test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_nullptr() {
  test();
#if TEST_STD_VER >= 23
  static_assert(test());
#endif
