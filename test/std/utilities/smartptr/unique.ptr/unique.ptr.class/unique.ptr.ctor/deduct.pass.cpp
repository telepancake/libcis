// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_deduct_dc894589).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_deduct_dc894589 { // libcis
struct Deleter {
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_deduct_dc894589 (libcis)
