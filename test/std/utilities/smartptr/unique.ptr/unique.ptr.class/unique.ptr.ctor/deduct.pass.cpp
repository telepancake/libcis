// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_deduct).
// main -> test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_deduct; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_deduct { // libcis: isolate file-scope helpers
struct Deleter {
  void operator()(int* p) const { delete p; }
};
} using namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_deduct; // libcis


void test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_deduct() {
