// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_09ca05eb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_09ca05eb { // libcis
template <class VT>
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move_09ca05eb (libcis)
