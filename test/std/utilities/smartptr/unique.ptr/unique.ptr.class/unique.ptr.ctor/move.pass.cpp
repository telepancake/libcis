// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move).
// main -> test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move { // libcis: isolate file-scope helpers
template <class VT>
...
} using namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move; // libcis


void test_utilities_smartptr_unique_ptr_unique_ptr_class_unique_ptr_ctor_move() {
