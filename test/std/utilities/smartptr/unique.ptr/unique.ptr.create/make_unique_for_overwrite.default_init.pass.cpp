// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_create_make_unique_for_overwrite_default_init).
// main -> test_utilities_smartptr_unique_ptr_unique_ptr_create_make_unique_for_overwrite_default_init; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_create_make_unique_for_overwrite_default_init { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_create_make_unique_for_overwrite_default_init; // libcis


void test_utilities_smartptr_unique_ptr_unique_ptr_create_make_unique_for_overwrite_default_init() {
  test();
