// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_create_make_unique_for_overwrite).
// main -> test_utilities_smartptr_unique_ptr_unique_ptr_create_make_unique_for_overwrite; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_create_make_unique_for_overwrite { // libcis: isolate file-scope helpers
template <class T, class... Args>
...
} using namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_create_make_unique_for_overwrite; // libcis


void test_utilities_smartptr_unique_ptr_unique_ptr_create_make_unique_for_overwrite() {
  test();
  testCustomNew();
#if TEST_STD_VER >= 23
  static_assert(test());
