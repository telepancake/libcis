// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_create_make_unique_for_overwrite_492f71a4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_create_make_unique_for_overwrite_492f71a4 { // libcis
template <class T, class... Args>
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_create_make_unique_for_overwrite_492f71a4 (libcis)
