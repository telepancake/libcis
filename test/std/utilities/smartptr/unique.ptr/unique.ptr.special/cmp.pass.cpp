// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_special_cmp).
// main -> test_utilities_smartptr_unique_ptr_unique_ptr_special_cmp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_special_cmp { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_special_cmp; // libcis


void test_utilities_smartptr_unique_ptr_unique_ptr_special_cmp() {
  test();
#if TEST_STD_VER >= 23
  static_assert(test());
#endif
