// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_special_cmp_3b662fd1).
//===----------------------------------------------------------------------===//
//
...
TEST_CONSTEXPR_CXX23 namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_special_cmp_3b662fd1 { // libcis
bool test() {
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_special_cmp_3b662fd1 (libcis)
