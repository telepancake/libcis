// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_special_cmp_nullptr_acff8bbc).
//===----------------------------------------------------------------------===//
//
...
TEST_CONSTEXPR_CXX23 namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_special_cmp_nullptr_acff8bbc { // libcis
bool test() {
...
} // libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_special_cmp_nullptr_acff8bbc (libcis)
