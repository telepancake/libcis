// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_unique_ptr_unique_ptr_special_swap).
// main -> test_utilities_smartptr_unique_ptr_unique_ptr_special_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_special_swap { // libcis: isolate file-scope helpers
struct A
{
    int state_;
    static int count;
...
} using namespace libcis_ns_utilities_smartptr_unique_ptr_unique_ptr_special_swap; // libcis
...
void test_utilities_smartptr_unique_ptr_unique_ptr_special_swap() {
  test();
#if TEST_STD_VER >= 23
  static_assert(test());
#endif
