// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_adapt_out_ptr_out_ptr_t_ctor).
// main -> test_utilities_smartptr_adapt_out_ptr_out_ptr_t_ctor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_smartptr_adapt_out_ptr_out_ptr_t_ctor() {
  {
