// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_adapt_out_ptr_out_ptr_general).
// main -> test_utilities_smartptr_adapt_out_ptr_out_ptr_general; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_adapt_out_ptr_out_ptr_general { // libcis: isolate file-scope helpers
void test_get_int_p() {
...
} using namespace libcis_ns_utilities_smartptr_adapt_out_ptr_out_ptr_general; // libcis


void test_utilities_smartptr_adapt_out_ptr_out_ptr_general() {
  test_get_int_p();
