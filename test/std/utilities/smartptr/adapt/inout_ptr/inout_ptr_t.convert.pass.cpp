// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_adapt_inout_ptr_inout_ptr_t_convert).
// main -> test_utilities_smartptr_adapt_inout_ptr_inout_ptr_t_convert; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_smartptr_adapt_inout_ptr_inout_ptr_t_convert() {
  // operator Pointer*()
  {
