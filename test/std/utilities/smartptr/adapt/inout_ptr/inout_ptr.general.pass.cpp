// AST-transferred from libc++ by tools/transfer.py (slug=utilities_smartptr_adapt_inout_ptr_inout_ptr_general).
// main -> test_utilities_smartptr_adapt_inout_ptr_inout_ptr_general; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_smartptr_adapt_inout_ptr_inout_ptr_general { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_smartptr_adapt_inout_ptr_inout_ptr_general; // libcis


void test_utilities_smartptr_adapt_inout_ptr_inout_ptr_general() {
  test_replace_int_p();
