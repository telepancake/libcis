// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_mod_emplace_index_init_list_args_978f80be).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_mod_emplace_index_init_list_args_978f80be { // libcis
struct InitList {
  std::size_t size;
...
} // libcis_ns_utilities_variant_variant_variant_variant_mod_emplace_index_init_list_args_978f80be (libcis)
