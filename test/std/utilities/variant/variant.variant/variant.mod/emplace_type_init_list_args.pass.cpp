// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_mod_emplace_type_init_list_args_42a06ee5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_mod_emplace_type_init_list_args_42a06ee5 { // libcis
struct InitList {
  std::size_t size;
...
} // libcis_ns_utilities_variant_variant_variant_variant_mod_emplace_type_init_list_args_42a06ee5 (libcis)
