// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_implicit_ctad_ea5ebc34).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_implicit_ctad_ea5ebc34 { // libcis
int main(int, char**) {
...
} // libcis_ns_utilities_variant_variant_variant_implicit_ctad_ea5ebc34 (libcis)
