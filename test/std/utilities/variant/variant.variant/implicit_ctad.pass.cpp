// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_implicit_ctad).
// main -> test_utilities_variant_variant_variant_implicit_ctad; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_variant_variant_variant_implicit_ctad() {
