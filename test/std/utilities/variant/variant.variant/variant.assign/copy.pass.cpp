// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_assign_copy_a1c71ed6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_assign_copy_a1c71ed6 { // libcis
struct NoCopy {
...
} // libcis_ns_utilities_variant_variant_variant_variant_assign_copy_a1c71ed6 (libcis)
