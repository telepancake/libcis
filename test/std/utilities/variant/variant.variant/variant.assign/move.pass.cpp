// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_assign_move_ff1108a0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_assign_move_ff1108a0 { // libcis
struct NoCopy {
...
} // libcis_ns_utilities_variant_variant_variant_variant_assign_move_ff1108a0 (libcis)
