// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_assign_move).
// main -> test_utilities_variant_variant_variant_variant_assign_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_assign_move { // libcis: isolate file-scope helpers
struct NoCopy {
...
} using namespace libcis_ns_utilities_variant_variant_variant_variant_assign_move; // libcis


void test_utilities_variant_variant_variant_variant_assign_move() {
  non_constexpr_test();
