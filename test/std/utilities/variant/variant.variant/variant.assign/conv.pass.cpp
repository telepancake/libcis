// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_assign_conv).
// main -> test_utilities_variant_variant_variant_variant_assign_conv; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_variant_variant_variant_variant_assign_conv()
{
