// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_assign_conv_3cc88822).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_assign_conv_3cc88822 { // libcis
int main(int, char**)
{
...
} // libcis_ns_utilities_variant_variant_variant_variant_assign_conv_3cc88822 (libcis)
