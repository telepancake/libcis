// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_assign_T_1afb4e2b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_assign_T_1afb4e2b { // libcis
...
} // libcis_ns_utilities_variant_variant_variant_variant_assign_T_1afb4e2b (libcis)
