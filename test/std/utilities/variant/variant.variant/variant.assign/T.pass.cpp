// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_assign_T).
// main -> test_utilities_variant_variant_variant_variant_assign_T; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_assign_T { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_variant_variant_variant_variant_assign_T; // libcis


void test_utilities_variant_variant_variant_variant_assign_T() {
  test();
  non_constexpr_test();
