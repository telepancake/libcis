// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_swap_swap).
// main -> test_utilities_variant_variant_variant_variant_swap_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_swap_swap { // libcis: isolate file-scope helpers
struct NotSwappable {};
...
} using namespace libcis_ns_utilities_variant_variant_variant_variant_swap_swap; // libcis
...
void test_utilities_variant_variant_variant_variant_swap_swap() {
  non_constexpr_test();
  test();
