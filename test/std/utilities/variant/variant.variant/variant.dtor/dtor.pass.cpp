// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_dtor_dtor_2f17c2e0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_dtor_dtor_2f17c2e0 { // libcis
struct NonTDtor {
  int* count;
...
} // libcis_ns_utilities_variant_variant_variant_variant_dtor_dtor_2f17c2e0 (libcis)
