// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_dtor_dtor).
// main -> test_utilities_variant_variant_variant_variant_dtor_dtor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_dtor_dtor { // libcis: isolate file-scope helpers
struct NonTDtor {
  int* count;
...
} using namespace libcis_ns_utilities_variant_variant_variant_variant_dtor_dtor; // libcis


void test_utilities_variant_variant_variant_variant_dtor_dtor() {
  test();
