// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_ctor_default_a9107c42).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_default_a9107c42 { // libcis
...
} // libcis_ns_utilities_variant_variant_variant_variant_ctor_default_a9107c42 (libcis)
