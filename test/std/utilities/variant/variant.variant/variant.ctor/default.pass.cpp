// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_ctor_default).
// main -> test_utilities_variant_variant_variant_variant_ctor_default; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_default { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_default; // libcis


void test_utilities_variant_variant_variant_variant_ctor_default() {
  test();
