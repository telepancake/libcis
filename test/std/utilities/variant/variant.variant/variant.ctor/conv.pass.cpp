// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_ctor_conv).
// main -> test_utilities_variant_variant_variant_variant_ctor_conv; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_utilities_variant_variant_variant_variant_ctor_conv()
{
