// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_ctor_move).
// main -> test_utilities_variant_variant_variant_variant_ctor_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_move { // libcis: isolate file-scope helpers
struct ThrowsMove {
...
} using namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_move; // libcis


void test_utilities_variant_variant_variant_variant_ctor_move() {
  non_constexpr_test();
