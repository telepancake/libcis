// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_ctor_in_place_type_init_list_args).
// main -> test_utilities_variant_variant_variant_variant_ctor_in_place_type_init_list_args; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_in_place_type_init_list_args { // libcis: isolate file-scope helpers
struct InitList {
  std::size_t size;
...
} using namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_in_place_type_init_list_args; // libcis


void test_utilities_variant_variant_variant_variant_ctor_in_place_type_init_list_args() {
  test_ctor_basic();
  test_ctor_sfinae();
