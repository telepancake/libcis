// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_ctor_in_place_type_init_list_args_26120263).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_in_place_type_init_list_args_26120263 { // libcis
struct InitList {
  std::size_t size;
...
} // libcis_ns_utilities_variant_variant_variant_variant_ctor_in_place_type_init_list_args_26120263 (libcis)
