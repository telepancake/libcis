// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_ctor_T_23468703).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_T_23468703 { // libcis
struct Dummy {
  Dummy() = default;
};
...
} // libcis_ns_utilities_variant_variant_variant_variant_ctor_T_23468703 (libcis)
