// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_ctor_T).
// main -> test_utilities_variant_variant_variant_variant_ctor_T; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_T { // libcis: isolate file-scope helpers
struct Dummy {
  Dummy() = default;
};
...
} using namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_T; // libcis


void test_utilities_variant_variant_variant_variant_ctor_T() {
  test_T_ctor_basic();
