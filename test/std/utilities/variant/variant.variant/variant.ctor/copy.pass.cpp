// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_ctor_copy_10769407).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_copy_10769407 { // libcis
struct NonT {
...
} // libcis_ns_utilities_variant_variant_variant_variant_ctor_copy_10769407 (libcis)
