// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_ctor_copy).
// main -> test_utilities_variant_variant_variant_variant_ctor_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_copy { // libcis: isolate file-scope helpers
struct NonT {
...
} using namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_copy; // libcis


void test_utilities_variant_variant_variant_variant_ctor_copy() {
  non_constexpr_test();
