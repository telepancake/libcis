// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_variant_variant_ctor_in_place_index_args_b6733aab).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_variant_variant_ctor_in_place_index_args_b6733aab { // libcis
...
} // libcis_ns_utilities_variant_variant_variant_variant_ctor_in_place_index_args_b6733aab (libcis)
