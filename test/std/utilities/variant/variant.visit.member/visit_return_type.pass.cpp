// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_visit_member_visit_return_type).
// main -> test_utilities_variant_variant_visit_member_visit_return_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_visit_member_visit_return_type { // libcis: isolate file-scope helpers
template <class... Ts>
...
} using namespace libcis_ns_utilities_variant_variant_visit_member_visit_return_type; // libcis


void test_utilities_variant_variant_visit_member_visit_return_type() {
