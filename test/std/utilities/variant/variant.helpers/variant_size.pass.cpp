// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_helpers_variant_size_c25af3a6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_helpers_variant_size_c25af3a6 { // libcis
...
} // libcis_ns_utilities_variant_variant_helpers_variant_size_c25af3a6 (libcis)
