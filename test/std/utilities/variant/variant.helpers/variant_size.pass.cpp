// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_helpers_variant_size).
// main -> test_utilities_variant_variant_helpers_variant_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_helpers_variant_size { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_variant_variant_helpers_variant_size; // libcis


void test_utilities_variant_variant_helpers_variant_size() {
  test<std::variant<>, 0>();
