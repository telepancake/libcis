// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_helpers_variant_alternative_acc01caf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_helpers_variant_alternative_acc01caf { // libcis
...
} // libcis_ns_utilities_variant_variant_helpers_variant_alternative_acc01caf (libcis)
