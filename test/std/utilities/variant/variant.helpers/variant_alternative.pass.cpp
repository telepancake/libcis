// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_helpers_variant_alternative).
// main -> test_utilities_variant_variant_helpers_variant_alternative; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_helpers_variant_alternative { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_variant_variant_helpers_variant_alternative; // libcis


void test_utilities_variant_variant_helpers_variant_alternative() {
  {
