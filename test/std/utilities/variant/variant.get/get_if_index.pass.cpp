// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_get_get_if_index_eb3cd5be).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_get_get_if_index_eb3cd5be { // libcis
...
} // libcis_ns_utilities_variant_variant_get_get_if_index_eb3cd5be (libcis)
