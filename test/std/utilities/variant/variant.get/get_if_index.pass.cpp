// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_get_get_if_index).
// main -> test_utilities_variant_variant_get_get_if_index; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_get_get_if_index { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_variant_variant_get_get_if_index; // libcis


void test_utilities_variant_variant_get_get_if_index() {
  test_const_get_if();
  test_get_if();
