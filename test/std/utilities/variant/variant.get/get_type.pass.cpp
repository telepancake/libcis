// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_get_get_type_f721be23).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_get_get_type_f721be23 { // libcis
...
} // libcis_ns_utilities_variant_variant_get_get_type_f721be23 (libcis)
