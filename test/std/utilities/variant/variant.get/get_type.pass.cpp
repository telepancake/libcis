// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_get_get_type).
// main -> test_utilities_variant_variant_get_get_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_get_get_type { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_variant_variant_get_get_type; // libcis


void test_utilities_variant_variant_get_get_type() {
