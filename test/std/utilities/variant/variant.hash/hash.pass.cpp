// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_hash_hash).
// main -> test_utilities_variant_variant_hash_hash; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_hash_hash { // libcis: isolate file-scope helpers
...
struct A {};
struct B {};
} using namespace libcis_ns_utilities_variant_variant_hash_hash; // libcis
...
void test_utilities_variant_variant_hash_hash() {
  test_hash_variant();
