// AST-transferred from libc++ by tools/transfer.py (slug=utilities_variant_variant_visit_visit).
// main -> test_utilities_variant_variant_visit_visit; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_visit_visit { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_utilities_variant_variant_visit_visit; // libcis
...
void test_utilities_variant_variant_visit_visit() {
