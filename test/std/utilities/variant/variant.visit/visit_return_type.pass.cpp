// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_visit_visit_return_type_94b4c686).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_visit_visit_return_type_94b4c686 { // libcis
...
} // libcis_ns_utilities_variant_variant_visit_visit_return_type_94b4c686 (libcis)
