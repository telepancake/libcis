// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_relops_three_way_396f1d2d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_relops_three_way_396f1d2d { // libcis
...
} // libcis_ns_utilities_variant_variant_relops_three_way_396f1d2d (libcis)
