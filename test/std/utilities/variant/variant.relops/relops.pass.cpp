// transferred+adapted from libc++ by tools/transfer.py (slug=utilities_variant_variant_relops_relops_5e9dbb90).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_utilities_variant_variant_relops_relops_5e9dbb90 { // libcis
struct MyBool {
  bool value;
...
} // libcis_ns_utilities_variant_variant_relops_relops_5e9dbb90 (libcis)
