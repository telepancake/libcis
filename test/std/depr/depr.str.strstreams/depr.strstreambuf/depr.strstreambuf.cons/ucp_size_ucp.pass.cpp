// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_cons_ucp_size_ucp_099cc37b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_cons_ucp_size_ucp_099cc37b { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_cons_ucp_size_ucp_099cc37b (libcis)
