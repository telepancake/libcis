// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_cons_scp_size_scp_1562d0a9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_cons_scp_size_scp_1562d0a9 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_cons_scp_size_scp_1562d0a9 (libcis)
