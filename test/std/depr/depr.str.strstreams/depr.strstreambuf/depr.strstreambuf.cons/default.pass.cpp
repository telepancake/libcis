// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_cons_default_6c6380d3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_cons_default_6c6380d3 { // libcis
int main(int, char**)
{
    {
        std::strstreambuf s;
...
} // libcis_ns_depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_cons_default_6c6380d3 (libcis)
