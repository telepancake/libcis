// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_cons_cp_size_cp_c159612f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_cons_cp_size_cp_c159612f { // libcis
int main(int, char**)
{
    {
        char buf[] = "abcd";
...
} // libcis_ns_depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_cons_cp_size_cp_c159612f (libcis)
