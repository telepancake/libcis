// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_virtuals_pbackfail_bfcf3efb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_virtuals_pbackfail_bfcf3efb { // libcis
struct test
...
} // libcis_ns_depr_depr_str_strstreams_depr_strstreambuf_depr_strstreambuf_virtuals_pbackfail_bfcf3efb (libcis)
