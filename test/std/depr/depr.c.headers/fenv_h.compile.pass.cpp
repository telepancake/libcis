// AST-transferred from libc++ by tools/transfer.py (slug=depr_depr_c_headers_fenv_h).
...
namespace libcis_ns_depr_depr_c_headers_fenv_h { // libcis: isolate file-scope helpers
fenv_t fenv = {};
...
} using namespace libcis_ns_depr_depr_c_headers_fenv_h; // libcis
