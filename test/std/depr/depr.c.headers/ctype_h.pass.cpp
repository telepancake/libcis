// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_c_headers_ctype_h_815a60a2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_ctype_h_815a60a2 { // libcis
...
} // libcis_ns_depr_depr_c_headers_ctype_h_815a60a2 (libcis)
