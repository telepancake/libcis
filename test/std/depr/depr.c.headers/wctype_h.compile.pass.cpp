// AST-transferred from libc++ by tools/transfer.py (slug=depr_depr_c_headers_wctype_h).
...
namespace libcis_ns_depr_depr_c_headers_wctype_h { // libcis: isolate file-scope helpers
wint_t w = 0;
wctrans_t wctr = 0;
wctype_t wct = 0;
...
} using namespace libcis_ns_depr_depr_c_headers_wctype_h; // libcis
