// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_c_headers_wctype_h_205a5769).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_wctype_h_205a5769 { // libcis
wint_t w = 0;
wctrans_t wctr = 0;
wctype_t wct = 0;
...
} // libcis_ns_depr_depr_c_headers_wctype_h_205a5769 (libcis)
