// AST-transferred from libc++ by tools/transfer.py (slug=depr_depr_c_headers_inttypes_h).
...
namespace libcis_ns_depr_depr_c_headers_inttypes_h { // libcis: isolate file-scope helpers
void f() {
    { int8_t x = 0; (void)x; }
    { int16_t x = 0; (void)x; }
    { int32_t x = 0; (void)x; }
...
} using namespace libcis_ns_depr_depr_c_headers_inttypes_h; // libcis
