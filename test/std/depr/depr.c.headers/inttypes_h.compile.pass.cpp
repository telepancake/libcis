// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_c_headers_inttypes_h_1c41f25c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_inttypes_h_1c41f25c { // libcis
void f() {
    { int8_t x = 0; (void)x; }
    { int16_t x = 0; (void)x; }
    { int32_t x = 0; (void)x; }
...
} // libcis_ns_depr_depr_c_headers_inttypes_h_1c41f25c (libcis)
