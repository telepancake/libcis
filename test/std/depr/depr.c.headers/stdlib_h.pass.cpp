// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_c_headers_stdlib_h_ec69205b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_stdlib_h_ec69205b { // libcis
...
} // libcis_ns_depr_depr_c_headers_stdlib_h_ec69205b (libcis)
