// AST-transferred from libc++ by tools/transfer.py (slug=depr_depr_c_headers_stdlib_h).
// main -> test_depr_depr_c_headers_stdlib_h; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_stdlib_h { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_depr_depr_c_headers_stdlib_h; // libcis


void test_depr_depr_c_headers_stdlib_h() {
    size_t s = 0; ((void)s);
    div_t d; ((void)d);
    ldiv_t ld; ((void)ld);
