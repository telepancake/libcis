// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_c_headers_setjmp_h_22804cd9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_setjmp_h_22804cd9 { // libcis
jmp_buf jb;
ASSERT_SAME_TYPE(void, decltype(longjmp(jb, 0)));

void f() { setjmp(jb); }
} // libcis_ns_depr_depr_c_headers_setjmp_h_22804cd9 (libcis)
