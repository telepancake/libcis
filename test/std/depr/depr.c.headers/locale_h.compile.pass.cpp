// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_c_headers_locale_h_196a06ba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_locale_h_196a06ba { // libcis
lconv lc;
ASSERT_SAME_TYPE(char*,  decltype(setlocale(0, "")));
ASSERT_SAME_TYPE(lconv*, decltype(localeconv()));
} // libcis_ns_depr_depr_c_headers_locale_h_196a06ba (libcis)
