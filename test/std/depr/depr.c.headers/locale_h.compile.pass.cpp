// AST-transferred from libc++ by tools/transfer.py (slug=depr_depr_c_headers_locale_h).
...
namespace libcis_ns_depr_depr_c_headers_locale_h { // libcis: isolate file-scope helpers
lconv lc;
ASSERT_SAME_TYPE(char*,  decltype(setlocale(0, "")));
ASSERT_SAME_TYPE(lconv*, decltype(localeconv()));
} using namespace libcis_ns_depr_depr_c_headers_locale_h; // libcis
