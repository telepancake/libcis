// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_c_headers_string_h_d4579c23).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_string_h_d4579c23 { // libcis
int main(int, char**) {
...
} // libcis_ns_depr_depr_c_headers_string_h_d4579c23 (libcis)
