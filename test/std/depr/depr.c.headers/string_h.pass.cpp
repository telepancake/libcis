// AST-transferred from libc++ by tools/transfer.py (slug=depr_depr_c_headers_string_h).
// main -> test_depr_depr_c_headers_string_h; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_depr_depr_c_headers_string_h() {
