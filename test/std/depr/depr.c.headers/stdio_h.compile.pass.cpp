// AST-transferred from libc++ by tools/transfer.py (slug=depr_depr_c_headers_stdio_h).
...
namespace libcis_ns_depr_depr_c_headers_stdio_h { // libcis: isolate file-scope helpers
FILE* fp = 0;
fpos_t fpos = fpos_t();
size_t s = 0;
char* cp = 0;
...
} using namespace libcis_ns_depr_depr_c_headers_stdio_h; // libcis
