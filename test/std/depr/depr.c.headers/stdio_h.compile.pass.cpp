// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_c_headers_stdio_h_6c2484bd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_stdio_h_6c2484bd { // libcis
FILE* fp = 0;
fpos_t fpos = fpos_t();
size_t s = 0;
char* cp = 0;
...
} // libcis_ns_depr_depr_c_headers_stdio_h_6c2484bd (libcis)
