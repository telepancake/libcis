// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_c_headers_time_h_53c5a096).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_time_h_53c5a096 { // libcis
clock_t c = 0;
size_t s = 0;
time_t t = 0;
tm tmv = {};
...
} // libcis_ns_depr_depr_c_headers_time_h_53c5a096 (libcis)
