// AST-transferred from libc++ by tools/transfer.py (slug=depr_depr_c_headers_time_h).
...
namespace libcis_ns_depr_depr_c_headers_time_h { // libcis: isolate file-scope helpers
clock_t c = 0;
size_t s = 0;
time_t t = 0;
tm tmv = {};
...
} using namespace libcis_ns_depr_depr_c_headers_time_h; // libcis
