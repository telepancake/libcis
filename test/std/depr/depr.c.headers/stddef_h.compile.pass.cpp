// AST-transferred from libc++ by tools/transfer.py (slug=depr_depr_c_headers_stddef_h).
...
namespace libcis_ns_depr_depr_c_headers_stddef_h { // libcis: isolate file-scope helpers
void use() {
...
} using namespace libcis_ns_depr_depr_c_headers_stddef_h; // libcis
