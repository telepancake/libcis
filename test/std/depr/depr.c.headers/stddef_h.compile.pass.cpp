// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_c_headers_stddef_h_94231743).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_stddef_h_94231743 { // libcis
void use() {
...
} // libcis_ns_depr_depr_c_headers_stddef_h_94231743 (libcis)
