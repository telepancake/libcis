// AST-transferred from libc++ by tools/transfer.py (slug=depr_depr_c_headers_uchar_h).
...
namespace libcis_ns_depr_depr_c_headers_uchar_h { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_depr_depr_c_headers_uchar_h; // libcis
