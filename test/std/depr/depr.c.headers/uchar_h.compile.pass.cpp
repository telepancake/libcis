// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_c_headers_uchar_h_2367b0d5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_uchar_h_2367b0d5 { // libcis
...
} // libcis_ns_depr_depr_c_headers_uchar_h_2367b0d5 (libcis)
