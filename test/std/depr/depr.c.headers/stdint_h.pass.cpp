// AST-transferred from libc++ by tools/transfer.py (slug=depr_depr_c_headers_stdint_h).
// main -> test_depr_depr_c_headers_stdint_h; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_stdint_h { // libcis: isolate file-scope helpers
void use() {
...
} using namespace libcis_ns_depr_depr_c_headers_stdint_h; // libcis
...
void test_depr_depr_c_headers_stdint_h() {
    // typedef int8_t
