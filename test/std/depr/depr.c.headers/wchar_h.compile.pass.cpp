// AST-transferred from libc++ by tools/transfer.py (slug=depr_depr_c_headers_wchar_h).
...
namespace libcis_ns_depr_depr_c_headers_wchar_h { // libcis: isolate file-scope helpers
mbstate_t mb = {};
size_t s = 0;
tm *tm = 0;
wint_t w = 0;
...
} using namespace libcis_ns_depr_depr_c_headers_wchar_h; // libcis
