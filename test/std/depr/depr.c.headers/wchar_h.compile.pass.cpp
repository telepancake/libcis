// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_c_headers_wchar_h_a613c9f2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_wchar_h_a613c9f2 { // libcis
mbstate_t mb = {};
size_t s = 0;
tm *tm = 0;
wint_t w = 0;
...
} // libcis_ns_depr_depr_c_headers_wchar_h_a613c9f2 (libcis)
