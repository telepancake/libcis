// AST-transferred from libc++ by tools/transfer.py (slug=depr_depr_c_headers_math_h).
// main -> test_depr_depr_c_headers_math_h; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_math_h { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_depr_depr_c_headers_math_h; // libcis


void test_depr_depr_c_headers_math_h() {
