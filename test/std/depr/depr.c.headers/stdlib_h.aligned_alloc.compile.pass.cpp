// transferred+adapted from libc++ by tools/transfer.py (slug=depr_depr_c_headers_stdlib_h_aligned_alloc_1ed05df1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_depr_depr_c_headers_stdlib_h_aligned_alloc_1ed05df1 { // libcis
static_assert(std::is_same<decltype(aligned_alloc(1, 0)), void*>::value, "");
} // libcis_ns_depr_depr_c_headers_stdlib_h_aligned_alloc_1ed05df1 (libcis)
