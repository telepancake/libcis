// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_ranges_robust_against_omitting_invoke_4b15b79b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_ranges_robust_against_omitting_invoke_4b15b79b { // libcis
struct Foo {
  int val;
...
} // libcis_ns_algorithms_ranges_robust_against_omitting_invoke_4b15b79b (libcis)
