// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_robust_against_nonbool).
...
namespace libcis_ns_algorithms_robust_against_nonbool { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_robust_against_nonbool; // libcis
