// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_ranges_robust_against_differing_projections).
// main -> test_algorithms_ranges_robust_against_differing_projections; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// (in1, in2, ...)
namespace libcis_ns_algorithms_ranges_robust_against_differing_projections { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_ranges_robust_against_differing_projections; // libcis


void test_algorithms_ranges_robust_against_differing_projections() {
  test_all();
