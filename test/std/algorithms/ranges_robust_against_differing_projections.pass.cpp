// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_ranges_robust_against_differing_projections_6694159f).
//===----------------------------------------------------------------------===//
//
...
// (in1, in2, ...)
namespace libcis_ns_algorithms_ranges_robust_against_differing_projections_6694159f { // libcis
...
} // libcis_ns_algorithms_ranges_robust_against_differing_projections_6694159f (libcis)
