// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_robust_re_difference_type_151b5faa).
//===----------------------------------------------------------------------===//
//
...
//
namespace libcis_ns_algorithms_robust_re_difference_type_151b5faa { // libcis
...
} // libcis_ns_algorithms_robust_re_difference_type_151b5faa (libcis)
