// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_ranges_robust_against_nonbool_ef611580).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_ranges_robust_against_nonbool_ef611580 { // libcis
...
} // libcis_ns_algorithms_ranges_robust_against_nonbool_ef611580 (libcis)
