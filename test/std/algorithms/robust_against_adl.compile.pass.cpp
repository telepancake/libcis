// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_robust_against_adl).
...
namespace libcis_ns_algorithms_robust_against_adl { // libcis: isolate file-scope helpers
struct Incomplete;
...
} using namespace libcis_ns_algorithms_robust_against_adl; // libcis
