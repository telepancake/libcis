// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_robust_against_adl_bc57a227).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_robust_against_adl_bc57a227 { // libcis
struct Incomplete;
...
} // libcis_ns_algorithms_robust_against_adl_bc57a227 (libcis)
