// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_ranges_robust_against_proxy_iterators_1ae46e30).
//===----------------------------------------------------------------------===//
//
...
// (in, ...)
namespace libcis_ns_algorithms_ranges_robust_against_proxy_iterators_1ae46e30 { // libcis
...
} // libcis_ns_algorithms_ranges_robust_against_proxy_iterators_1ae46e30 (libcis)
