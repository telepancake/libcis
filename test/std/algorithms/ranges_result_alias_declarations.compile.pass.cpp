// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_ranges_result_alias_declarations_9351f71b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_ranges_result_alias_declarations_9351f71b { // libcis
...
} // libcis_ns_algorithms_ranges_result_alias_declarations_9351f71b (libcis)
