// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_ranges_robust_against_dangling_22bde23c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_ranges_robust_against_dangling_22bde23c { // libcis
...
} // libcis_ns_algorithms_ranges_robust_against_dangling_22bde23c (libcis)
