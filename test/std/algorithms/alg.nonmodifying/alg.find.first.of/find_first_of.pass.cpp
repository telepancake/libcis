// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_first_of_find_first_of).
// main -> test_algorithms_alg_nonmodifying_alg_find_first_of_find_first_of; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER > 17
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_first_of_find_first_of { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_first_of_find_first_of; // libcis

#endif

void test_algorithms_alg_nonmodifying_alg_find_first_of_find_first_of()
{
