// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_first_of_ranges_find_first_of).
// main -> test_algorithms_alg_nonmodifying_alg_find_first_of_ranges_find_first_of; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_first_of_ranges_find_first_of { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_first_of_ranges_find_first_of; // libcis


void test_algorithms_alg_nonmodifying_alg_find_first_of_ranges_find_first_of() {
  test();
  static_assert(test());
