// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_is_permutation_is_permutation_pred).
// main -> test_algorithms_alg_nonmodifying_alg_is_permutation_is_permutation_pred; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_is_permutation_is_permutation_pred { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_is_permutation_is_permutation_pred; // libcis



void test_algorithms_alg_nonmodifying_alg_is_permutation_is_permutation_pred()
{
    {
        const int ia[] = {0};
        const int ib[] = {0};
