// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_is_permutation_ranges_is_permutation_b48adc30).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_is_permutation_ranges_is_permutation_b48adc30 { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_is_permutation_ranges_is_permutation_b48adc30 (libcis)
