// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_is_permutation_ranges_is_permutation).
// main -> test_algorithms_alg_nonmodifying_alg_is_permutation_ranges_is_permutation; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_is_permutation_ranges_is_permutation { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_is_permutation_ranges_is_permutation; // libcis


void test_algorithms_alg_nonmodifying_alg_is_permutation_ranges_is_permutation() {
  test();
  static_assert(test());
