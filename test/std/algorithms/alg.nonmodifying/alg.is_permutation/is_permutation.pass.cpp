// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_is_permutation_is_permutation).
// main -> test_algorithms_alg_nonmodifying_alg_is_permutation_is_permutation; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER > 17
namespace libcis_ns_algorithms_alg_nonmodifying_alg_is_permutation_is_permutation { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_is_permutation_is_permutation; // libcis

#endif

void test_algorithms_alg_nonmodifying_alg_is_permutation_is_permutation()
{
    {
        const int ia[] = {0};
        const int ib[] = {0};
