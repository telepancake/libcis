// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_foreach_for_each_n_d138c3f4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_foreach_for_each_n_d138c3f4 { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_foreach_for_each_n_d138c3f4 (libcis)
