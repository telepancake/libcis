// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_foreach_for_each_n).
// main -> test_algorithms_alg_nonmodifying_alg_foreach_for_each_n; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_foreach_for_each_n { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_foreach_for_each_n; // libcis


void test_algorithms_alg_nonmodifying_alg_foreach_for_each_n() {
  assert(test());
#if TEST_STD_VER > 17
  static_assert(test());
#endif
