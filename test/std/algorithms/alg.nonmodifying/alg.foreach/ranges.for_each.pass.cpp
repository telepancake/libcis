// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_foreach_ranges_for_each_60c7fc9b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_foreach_ranges_for_each_60c7fc9b { // libcis
struct Callable {
  void operator()(int);
};
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_foreach_ranges_for_each_60c7fc9b (libcis)
