// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_foreach_ranges_for_each).
// main -> test_algorithms_alg_nonmodifying_alg_foreach_ranges_for_each; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_foreach_ranges_for_each { // libcis: isolate file-scope helpers
struct Callable {
  void operator()(int);
};
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_foreach_ranges_for_each; // libcis


void test_algorithms_alg_nonmodifying_alg_foreach_ranges_for_each() {
  test();
  static_assert(test());
