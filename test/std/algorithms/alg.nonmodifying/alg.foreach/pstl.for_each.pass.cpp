// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_foreach_pstl_for_each_3915396f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_foreach_pstl_for_each_3915396f { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_foreach_pstl_for_each_3915396f (libcis)
