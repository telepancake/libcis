// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_foreach_ranges_for_each_n).
// main -> test_algorithms_alg_nonmodifying_alg_foreach_ranges_for_each_n; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_foreach_ranges_for_each_n { // libcis: isolate file-scope helpers
struct Callable {
  void operator()(int);
};
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_foreach_ranges_for_each_n; // libcis


void test_algorithms_alg_nonmodifying_alg_foreach_ranges_for_each_n() {
  test();
  static_assert(test());
