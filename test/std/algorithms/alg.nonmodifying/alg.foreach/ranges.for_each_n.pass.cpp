// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_foreach_ranges_for_each_n_13eb806f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_foreach_ranges_for_each_n_13eb806f { // libcis
struct Callable {
  void operator()(int);
};
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_foreach_ranges_for_each_n_13eb806f (libcis)
