// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_foreach_pstl_for_each_n_ffb857e4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_foreach_pstl_for_each_n_ffb857e4 { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_foreach_pstl_for_each_n_ffb857e4 (libcis)
