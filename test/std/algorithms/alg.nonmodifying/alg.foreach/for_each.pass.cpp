// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_foreach_for_each_a342c1ac).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_foreach_for_each_a342c1ac { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_foreach_for_each_a342c1ac (libcis)
