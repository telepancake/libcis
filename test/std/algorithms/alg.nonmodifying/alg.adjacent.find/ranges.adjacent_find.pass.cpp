// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_adjacent_find_ranges_adjacent_find).
// main -> test_algorithms_alg_nonmodifying_alg_adjacent_find_ranges_adjacent_find; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_adjacent_find_ranges_adjacent_find { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_adjacent_find_ranges_adjacent_find; // libcis


void test_algorithms_alg_nonmodifying_alg_adjacent_find_ranges_adjacent_find() {
  test();
  static_assert(test());
