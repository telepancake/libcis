// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_adjacent_find_ranges_adjacent_find_8bbe3eb5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_adjacent_find_ranges_adjacent_find_8bbe3eb5 { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_adjacent_find_ranges_adjacent_find_8bbe3eb5 (libcis)
