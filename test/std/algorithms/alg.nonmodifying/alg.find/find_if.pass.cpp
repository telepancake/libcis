// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_find_if_de6e039a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_find_if_de6e039a { // libcis
struct EqualTo {
  int v;
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_find_find_if_de6e039a (libcis)
