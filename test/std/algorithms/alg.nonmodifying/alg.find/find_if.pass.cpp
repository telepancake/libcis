// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_find_if).
// main -> test_algorithms_alg_nonmodifying_alg_find_find_if; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_find_if { // libcis: isolate file-scope helpers
struct EqualTo {
  int v;
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_find_if; // libcis


void test_algorithms_alg_nonmodifying_alg_find_find_if() {
  test();
#if TEST_STD_VER >= 20
  static_assert(test());
#endif
