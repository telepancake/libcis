// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_find_if_not_13d012fa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_find_if_not_13d012fa { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_find_find_if_not_13d012fa (libcis)
