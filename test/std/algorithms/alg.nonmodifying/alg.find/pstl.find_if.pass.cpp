// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_pstl_find_if_aeeeaea8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_pstl_find_if_aeeeaea8 { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_find_pstl_find_if_aeeeaea8 (libcis)
