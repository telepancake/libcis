// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_ranges_find_a203667f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_ranges_find_a203667f { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_find_ranges_find_a203667f (libcis)
