// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_find_d96283a5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_find_d96283a5 { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_find_find_d96283a5 (libcis)
