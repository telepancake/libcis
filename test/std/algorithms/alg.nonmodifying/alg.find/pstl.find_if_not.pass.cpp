// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_pstl_find_if_not_fe61921d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_pstl_find_if_not_fe61921d { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_find_pstl_find_if_not_fe61921d (libcis)
