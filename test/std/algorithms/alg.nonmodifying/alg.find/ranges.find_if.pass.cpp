// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_ranges_find_if_639aa547).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_ranges_find_if_639aa547 { // libcis
struct Predicate {
  bool operator()(int);
};
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_find_ranges_find_if_639aa547 (libcis)
