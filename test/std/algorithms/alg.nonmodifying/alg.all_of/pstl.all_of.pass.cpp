// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_all_of_pstl_all_of_0fdba063).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_all_of_pstl_all_of_0fdba063 { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_all_of_pstl_all_of_0fdba063 (libcis)
