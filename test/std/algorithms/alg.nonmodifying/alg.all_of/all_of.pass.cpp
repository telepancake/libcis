// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_all_of_all_of_b7fe103d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_all_of_all_of_b7fe103d { // libcis
struct test1
{
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_all_of_all_of_b7fe103d (libcis)
