// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_all_of_ranges_all_of_8f08db8c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_all_of_ranges_all_of_8f08db8c { // libcis
struct UnaryFunctor {
  bool operator()(auto&&);
};
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_all_of_ranges_all_of_8f08db8c (libcis)
