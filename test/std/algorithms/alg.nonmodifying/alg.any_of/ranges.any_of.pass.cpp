// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_any_of_ranges_any_of_cc117aba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_any_of_ranges_any_of_cc117aba { // libcis
struct UnaryFunctor {
  bool operator()(auto&&);
};
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_any_of_ranges_any_of_cc117aba (libcis)
