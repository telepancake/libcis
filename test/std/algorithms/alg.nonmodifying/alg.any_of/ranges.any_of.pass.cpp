// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_any_of_ranges_any_of).
// main -> test_algorithms_alg_nonmodifying_alg_any_of_ranges_any_of; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_any_of_ranges_any_of { // libcis: isolate file-scope helpers
struct UnaryFunctor {
  bool operator()(auto&&);
};
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_any_of_ranges_any_of; // libcis


void test_algorithms_alg_nonmodifying_alg_any_of_ranges_any_of() {
  test();
  static_assert(test());
