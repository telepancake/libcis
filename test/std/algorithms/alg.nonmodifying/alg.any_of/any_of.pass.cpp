// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_any_of_any_of_f80f2f1b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_any_of_any_of_f80f2f1b { // libcis
struct test1
{
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_any_of_any_of_f80f2f1b (libcis)
