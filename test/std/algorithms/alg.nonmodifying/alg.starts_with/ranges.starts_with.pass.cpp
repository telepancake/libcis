// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_starts_with_ranges_starts_with).
// main -> test_algorithms_alg_nonmodifying_alg_starts_with_ranges_starts_with; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_starts_with_ranges_starts_with { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_starts_with_ranges_starts_with; // libcis


void test_algorithms_alg_nonmodifying_alg_starts_with_ranges_starts_with() {
  test();
  static_assert(test());
