// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_equal_ranges_equal).
// main -> test_algorithms_alg_nonmodifying_alg_equal_ranges_equal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_equal_ranges_equal { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_equal_ranges_equal; // libcis


void test_algorithms_alg_nonmodifying_alg_equal_ranges_equal() {
  test();
  static_assert(test());
