// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_equal_pstl_equal_18a47b5c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_equal_pstl_equal_18a47b5c { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_equal_pstl_equal_18a47b5c (libcis)
