// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_equal_equal_e895cb7c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_equal_equal_e895cb7c { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_equal_equal_e895cb7c (libcis)
