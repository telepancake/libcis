// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_equal_equal_segmented).
// main -> test_algorithms_alg_nonmodifying_alg_equal_equal_segmented; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_equal_equal_segmented { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_equal_equal_segmented; // libcis


void test_algorithms_alg_nonmodifying_alg_equal_equal_segmented() {
