// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_contains_ranges_contains).
// main -> test_algorithms_alg_nonmodifying_alg_contains_ranges_contains; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_contains_ranges_contains { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_contains_ranges_contains; // libcis


void test_algorithms_alg_nonmodifying_alg_contains_ranges_contains() {
  test();
  static_assert(test());
