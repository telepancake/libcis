// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_contains_ranges_contains_subrange).
// main -> test_algorithms_alg_nonmodifying_alg_contains_ranges_contains_subrange; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_contains_ranges_contains_subrange { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_contains_ranges_contains_subrange; // libcis


void test_algorithms_alg_nonmodifying_alg_contains_ranges_contains_subrange() {
  test();
  static_assert(test());
