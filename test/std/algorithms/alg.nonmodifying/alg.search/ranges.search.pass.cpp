// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_search_ranges_search).
// main -> test_algorithms_alg_nonmodifying_alg_search_ranges_search; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_search_ranges_search { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_search_ranges_search; // libcis


void test_algorithms_alg_nonmodifying_alg_search_ranges_search() {
  test();
  static_assert(test());
