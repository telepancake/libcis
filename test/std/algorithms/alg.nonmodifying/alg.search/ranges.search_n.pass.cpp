// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_search_ranges_search_n_738c4bdd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_search_ranges_search_n_738c4bdd { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_search_ranges_search_n_738c4bdd (libcis)
