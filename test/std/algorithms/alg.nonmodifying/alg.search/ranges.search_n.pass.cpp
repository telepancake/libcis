// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_search_ranges_search_n).
// main -> test_algorithms_alg_nonmodifying_alg_search_ranges_search_n; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_search_ranges_search_n { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_search_ranges_search_n; // libcis


void test_algorithms_alg_nonmodifying_alg_search_ranges_search_n() {
  test();
  static_assert(test());
