// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_search_search_n_pred).
// main -> test_algorithms_alg_nonmodifying_alg_search_search_n_pred; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER > 17
namespace libcis_ns_algorithms_alg_nonmodifying_alg_search_search_n_pred { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_search_search_n_pred; // libcis
...
void test_algorithms_alg_nonmodifying_alg_search_search_n_pred()
{
