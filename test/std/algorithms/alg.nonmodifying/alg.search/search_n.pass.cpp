// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_search_search_n_42eb0d01).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_search_search_n_42eb0d01 { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_search_search_n_42eb0d01 (libcis)
