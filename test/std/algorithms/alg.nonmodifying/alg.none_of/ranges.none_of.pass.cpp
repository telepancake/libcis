// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_none_of_ranges_none_of_a67737d0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_none_of_ranges_none_of_a67737d0 { // libcis
struct UnaryFunctor {
  bool operator()(auto&&);
};
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_none_of_ranges_none_of_a67737d0 (libcis)
