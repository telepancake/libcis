// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_none_of_none_of_ef77f683).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_none_of_none_of_ef77f683 { // libcis
struct test1
{
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_none_of_none_of_ef77f683 (libcis)
