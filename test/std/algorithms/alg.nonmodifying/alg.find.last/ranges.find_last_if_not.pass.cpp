// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_last_ranges_find_last_if_not).
// main -> test_algorithms_alg_nonmodifying_alg_find_last_ranges_find_last_if_not; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_last_ranges_find_last_if_not { // libcis: isolate file-scope helpers
struct Predicate {
  bool operator()(int);
};
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_last_ranges_find_last_if_not; // libcis


void test_algorithms_alg_nonmodifying_alg_find_last_ranges_find_last_if_not() {
  test();
  static_assert(test());
