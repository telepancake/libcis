// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_last_ranges_find_last).
// main -> test_algorithms_alg_nonmodifying_alg_find_last_ranges_find_last; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_last_ranges_find_last { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_last_ranges_find_last; // libcis


void test_algorithms_alg_nonmodifying_alg_find_last_ranges_find_last() {
  test();
  static_assert(test());
  return;
}
