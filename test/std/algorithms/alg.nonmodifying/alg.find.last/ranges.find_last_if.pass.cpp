// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_last_ranges_find_last_if).
// main -> test_algorithms_alg_nonmodifying_alg_find_last_ranges_find_last_if; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_last_ranges_find_last_if { // libcis: isolate file-scope helpers
struct Predicate {
  bool operator()(int);
};
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_last_ranges_find_last_if; // libcis


void test_algorithms_alg_nonmodifying_alg_find_last_ranges_find_last_if() {
  test();
  static_assert(test());
