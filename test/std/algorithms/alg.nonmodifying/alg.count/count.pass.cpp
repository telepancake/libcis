// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_count_count_757aa390).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_count_count_757aa390 { // libcis
struct Test {
  template <class Iter>
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_count_count_757aa390 (libcis)
