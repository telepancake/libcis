// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_count_pstl_count_46a1dc93).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_count_pstl_count_46a1dc93 { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_count_pstl_count_46a1dc93 (libcis)
