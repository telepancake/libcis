// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_count_count_if_8bcca80c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_count_count_if_8bcca80c { // libcis
struct eq {
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_count_count_if_8bcca80c (libcis)
