// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_count_count_if).
// main -> test_algorithms_alg_nonmodifying_alg_count_count_if; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_count_count_if { // libcis: isolate file-scope helpers
struct eq {
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_count_count_if; // libcis

#endif

void test_algorithms_alg_nonmodifying_alg_count_count_if()
{
    int ia[] = {0, 1, 2, 2, 0, 1, 2, 3};
