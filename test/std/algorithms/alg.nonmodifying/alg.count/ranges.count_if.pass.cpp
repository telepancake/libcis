// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_count_ranges_count_if).
// main -> test_algorithms_alg_nonmodifying_alg_count_ranges_count_if; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_count_ranges_count_if { // libcis: isolate file-scope helpers
struct Predicate {
  bool operator()(int);
};
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_count_ranges_count_if; // libcis


void test_algorithms_alg_nonmodifying_alg_count_ranges_count_if() {
  test();
  static_assert(test());
