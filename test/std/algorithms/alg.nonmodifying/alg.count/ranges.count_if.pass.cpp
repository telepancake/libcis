// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_count_ranges_count_if_59a06666).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_count_ranges_count_if_59a06666 { // libcis
struct Predicate {
  bool operator()(int);
};
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_count_ranges_count_if_59a06666 (libcis)
