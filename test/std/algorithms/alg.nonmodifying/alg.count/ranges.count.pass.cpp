// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_count_ranges_count_f1bfb3a1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_count_ranges_count_f1bfb3a1 { // libcis
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_count_ranges_count_f1bfb3a1 (libcis)
