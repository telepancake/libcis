// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_end_ranges_find_end).
// main -> test_algorithms_alg_nonmodifying_alg_find_end_ranges_find_end; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_end_ranges_find_end { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_end_ranges_find_end; // libcis


void test_algorithms_alg_nonmodifying_alg_find_end_ranges_find_end() {
  test();
  static_assert(test());
