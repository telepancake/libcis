// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_end_find_end).
// main -> test_algorithms_alg_nonmodifying_alg_find_end_find_end; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER > 17
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_end_find_end { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_end_find_end; // libcis


void test_algorithms_alg_nonmodifying_alg_find_end_find_end()
{
