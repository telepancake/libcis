// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_end_find_end_bdaec5d8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_end_find_end_bdaec5d8 { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_algorithms_alg_nonmodifying_alg_find_end_find_end_bdaec5d8 (libcis)
