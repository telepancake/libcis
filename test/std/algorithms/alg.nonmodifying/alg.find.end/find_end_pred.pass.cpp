// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_find_end_find_end_pred).
// main -> test_algorithms_alg_nonmodifying_alg_find_end_find_end_pred; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_end_find_end_pred { // libcis: isolate file-scope helpers
struct count_equal
{
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_find_end_find_end_pred; // libcis
...
void test_algorithms_alg_nonmodifying_alg_find_end_find_end_pred()
{
