// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_fold_requirements).
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_fold_requirements { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_fold_requirements; // libcis
