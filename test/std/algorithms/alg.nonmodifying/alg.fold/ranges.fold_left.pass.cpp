// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_fold_ranges_fold_left).
// main -> test_algorithms_alg_nonmodifying_alg_fold_ranges_fold_left; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_fold_ranges_fold_left { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_fold_ranges_fold_left; // libcis


void test_algorithms_alg_nonmodifying_alg_fold_ranges_fold_left() {
  test_case();
