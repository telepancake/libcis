// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_mismatch_mismatch).
// main -> test_algorithms_alg_nonmodifying_mismatch_mismatch; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_mismatch_mismatch { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_mismatch_mismatch; // libcis


void test_algorithms_alg_nonmodifying_mismatch_mismatch() {
  test();
#if TEST_STD_VER >= 20
  static_assert(test());
#endif
