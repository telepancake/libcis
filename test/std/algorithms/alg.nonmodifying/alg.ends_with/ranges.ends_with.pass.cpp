// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_nonmodifying_alg_ends_with_ranges_ends_with).
// main -> test_algorithms_alg_nonmodifying_alg_ends_with_ranges_ends_with; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_nonmodifying_alg_ends_with_ranges_ends_with { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_nonmodifying_alg_ends_with_ranges_ends_with; // libcis


void test_algorithms_alg_nonmodifying_alg_ends_with_ranges_ends_with() {
  test();
  static_assert(test());
