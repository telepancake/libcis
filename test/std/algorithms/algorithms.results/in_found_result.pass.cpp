// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_algorithms_results_in_found_result_6e03b972).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_algorithms_results_in_found_result_6e03b972 { // libcis
struct A {
  explicit A(int);
};
...
} // libcis_ns_algorithms_algorithms_results_in_found_result_6e03b972 (libcis)
