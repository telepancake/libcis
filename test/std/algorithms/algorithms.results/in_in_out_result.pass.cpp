// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_algorithms_results_in_in_out_result_dc832e9f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_algorithms_results_in_in_out_result_dc832e9f { // libcis
struct A {
  explicit A(int);
};
...
} // libcis_ns_algorithms_algorithms_results_in_in_out_result_dc832e9f (libcis)
