// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_algorithms_results_in_fun_result).
// main -> test_algorithms_algorithms_results_in_fun_result; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_algorithms_results_in_fun_result { // libcis: isolate file-scope helpers
struct A {
  explicit A(int);
};
...
} using namespace libcis_ns_algorithms_algorithms_results_in_fun_result; // libcis


void test_algorithms_algorithms_results_in_fun_result() {
  test();
  static_assert(test());
