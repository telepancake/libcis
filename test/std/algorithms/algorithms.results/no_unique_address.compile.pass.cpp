// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_algorithms_results_no_unique_address_5f065270).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_algorithms_results_no_unique_address_5f065270 { // libcis
struct Empty {};
struct Empty2 {};
...
} // libcis_ns_algorithms_algorithms_results_no_unique_address_5f065270 (libcis)
