// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_algorithms_results_min_max_result_434382af).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_algorithms_results_min_max_result_434382af { // libcis
struct A {
  explicit A(int);
};
...
} // libcis_ns_algorithms_algorithms_results_min_max_result_434382af (libcis)
