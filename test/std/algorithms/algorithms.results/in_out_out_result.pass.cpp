// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_algorithms_results_in_out_out_result_056c0402).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_algorithms_results_in_out_out_result_056c0402 { // libcis
struct A {
  explicit A(int);
};
...
} // libcis_ns_algorithms_algorithms_results_in_out_out_result_056c0402 (libcis)
