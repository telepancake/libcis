// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_algorithms_results_in_in_result_0d4171f5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_algorithms_results_in_in_result_0d4171f5 { // libcis
struct A {
  explicit A(int);
};
...
} // libcis_ns_algorithms_algorithms_results_in_in_result_0d4171f5 (libcis)
