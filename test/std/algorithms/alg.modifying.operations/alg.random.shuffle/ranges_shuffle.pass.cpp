// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_random_shuffle_ranges_shuffle_676333af).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_random_shuffle_ranges_shuffle_676333af { // libcis
class RandGen {
public:
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_random_shuffle_ranges_shuffle_676333af (libcis)
