// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_random_shuffle_ranges_shuffle).
// main -> test_algorithms_alg_modifying_operations_alg_random_shuffle_ranges_shuffle; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_random_shuffle_ranges_shuffle { // libcis: isolate file-scope helpers
class RandGen {
public:
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_random_shuffle_ranges_shuffle; // libcis


void test_algorithms_alg_modifying_operations_alg_random_shuffle_ranges_shuffle() {
  test();
