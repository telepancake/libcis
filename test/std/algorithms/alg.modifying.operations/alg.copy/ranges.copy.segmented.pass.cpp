// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_copy_ranges_copy_segmented_e4568f0d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_copy_ranges_copy_segmented_e4568f0d { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_copy_ranges_copy_segmented_e4568f0d (libcis)
