// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_copy_copy_backward_1cbd8bc3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_copy_copy_backward_1cbd8bc3 { // libcis
class PaddedBase {
public:
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_copy_copy_backward_1cbd8bc3 (libcis)
