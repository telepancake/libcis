// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_copy_ranges_copy_a32e2aad).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_copy_ranges_copy_a32e2aad { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_copy_ranges_copy_a32e2aad (libcis)
