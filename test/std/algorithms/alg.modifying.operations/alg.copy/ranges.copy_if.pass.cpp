// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_copy_ranges_copy_if_ee6295d8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_copy_ranges_copy_if_ee6295d8 { // libcis
struct Functor {
  bool operator()(int);
};
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_copy_ranges_copy_if_ee6295d8 (libcis)
