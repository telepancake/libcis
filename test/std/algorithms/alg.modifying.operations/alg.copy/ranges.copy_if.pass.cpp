// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_copy_ranges_copy_if).
// main -> test_algorithms_alg_modifying_operations_alg_copy_ranges_copy_if; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_copy_ranges_copy_if { // libcis: isolate file-scope helpers
struct Functor {
  bool operator()(int);
};
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_copy_ranges_copy_if; // libcis


void test_algorithms_alg_modifying_operations_alg_copy_ranges_copy_if() {
  test();
  static_assert(test());
