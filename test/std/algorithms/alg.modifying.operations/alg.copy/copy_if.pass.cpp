// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_copy_copy_if_8b9ef1d6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_copy_copy_if_8b9ef1d6 { // libcis
struct Pred
{
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_copy_copy_if_8b9ef1d6 (libcis)
