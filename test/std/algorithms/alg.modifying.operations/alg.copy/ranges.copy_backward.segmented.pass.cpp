// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_copy_ranges_copy_backward_segmented_1b62208d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_copy_ranges_copy_backward_segmented_1b62208d { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_copy_ranges_copy_backward_segmented_1b62208d (libcis)
