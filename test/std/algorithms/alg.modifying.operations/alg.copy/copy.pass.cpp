// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_copy_copy_322d3c53).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_copy_copy_322d3c53 { // libcis
class PaddedBase {
public:
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_copy_copy_322d3c53 (libcis)
