// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_copy_ranges_copy_n).
// main -> test_algorithms_alg_modifying_operations_alg_copy_ranges_copy_n; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_copy_ranges_copy_n { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_copy_ranges_copy_n; // libcis


void test_algorithms_alg_modifying_operations_alg_copy_ranges_copy_n() {
  test();
  static_assert(test());
