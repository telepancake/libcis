// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_transform_ranges_transform_unary).
// main -> test_algorithms_alg_modifying_operations_alg_transform_ranges_transform_unary; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_transform_ranges_transform_unary { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_transform_ranges_transform_unary; // libcis


void test_algorithms_alg_modifying_operations_alg_transform_ranges_transform_unary() {
