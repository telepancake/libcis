// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_transform_ranges_transform_unary_73f3bf35).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_transform_ranges_transform_unary_73f3bf35 { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_transform_ranges_transform_unary_73f3bf35 (libcis)
