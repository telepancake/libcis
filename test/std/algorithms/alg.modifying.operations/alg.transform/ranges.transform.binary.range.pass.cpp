// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_transform_ranges_transform_binary_range_0023db23).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_transform_ranges_transform_binary_range_0023db23 { // libcis
struct BinaryFunc {
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_transform_ranges_transform_binary_range_0023db23 (libcis)
