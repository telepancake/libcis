// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_transform_ranges_transform_binary_iterator_cbb07eb9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_transform_ranges_transform_binary_iterator_cbb07eb9 { // libcis
struct BinaryFunc {
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_transform_ranges_transform_binary_iterator_cbb07eb9 (libcis)
