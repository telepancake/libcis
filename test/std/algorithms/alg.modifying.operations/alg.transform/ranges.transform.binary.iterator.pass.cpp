// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_transform_ranges_transform_binary_iterator).
// main -> test_algorithms_alg_modifying_operations_alg_transform_ranges_transform_binary_iterator; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_transform_ranges_transform_binary_iterator { // libcis: isolate file-scope helpers
struct BinaryFunc {
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_transform_ranges_transform_binary_iterator; // libcis


void test_algorithms_alg_modifying_operations_alg_transform_ranges_transform_binary_iterator() {
  test();
  static_assert(test());
