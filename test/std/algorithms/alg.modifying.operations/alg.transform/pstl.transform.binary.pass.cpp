// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_transform_pstl_transform_binary_7a926301).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_transform_pstl_transform_binary_7a926301 { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_transform_pstl_transform_binary_7a926301 (libcis)
