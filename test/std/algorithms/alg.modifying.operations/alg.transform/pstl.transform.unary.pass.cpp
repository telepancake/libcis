// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_transform_pstl_transform_unary_a0aec79f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_transform_pstl_transform_unary_a0aec79f { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_transform_pstl_transform_unary_a0aec79f (libcis)
