// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_transform_unary_transform_cdeee3e6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_transform_unary_transform_cdeee3e6 { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_transform_unary_transform_cdeee3e6 (libcis)
