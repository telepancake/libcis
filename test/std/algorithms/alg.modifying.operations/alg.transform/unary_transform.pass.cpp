// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_transform_unary_transform).
// main -> test_algorithms_alg_modifying_operations_alg_transform_unary_transform; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_transform_unary_transform { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_transform_unary_transform; // libcis


void test_algorithms_alg_modifying_operations_alg_transform_unary_transform()
{
