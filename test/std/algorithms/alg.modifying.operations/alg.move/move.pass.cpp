// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_move_move_b11b0bab).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_move_move_b11b0bab { // libcis
class PaddedBase {
public:
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_move_move_b11b0bab (libcis)
