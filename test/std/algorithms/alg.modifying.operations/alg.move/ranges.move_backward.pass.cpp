// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_move_ranges_move_backward).
// main -> test_algorithms_alg_modifying_operations_alg_move_ranges_move_backward; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_move_ranges_move_backward { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_move_ranges_move_backward; // libcis


void test_algorithms_alg_modifying_operations_alg_move_ranges_move_backward() {
  test();
  static_assert(test());
