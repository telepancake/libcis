// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_move_ranges_move_eb9b960c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_move_ranges_move_eb9b960c { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_move_ranges_move_eb9b960c (libcis)
