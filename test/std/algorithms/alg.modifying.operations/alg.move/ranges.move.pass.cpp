// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_move_ranges_move).
// main -> test_algorithms_alg_modifying_operations_alg_move_ranges_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_move_ranges_move { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_move_ranges_move; // libcis


void test_algorithms_alg_modifying_operations_alg_move_ranges_move() {
  test();
  static_assert(test());
