// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_move_move_backward_eb7d42c2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_move_move_backward_eb7d42c2 { // libcis
class PaddedBase {
public:
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_move_move_backward_eb7d42c2 (libcis)
