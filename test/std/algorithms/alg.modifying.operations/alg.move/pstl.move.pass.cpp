// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_move_pstl_move_cecefbc1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_move_pstl_move_cecefbc1 { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_move_pstl_move_cecefbc1 (libcis)
