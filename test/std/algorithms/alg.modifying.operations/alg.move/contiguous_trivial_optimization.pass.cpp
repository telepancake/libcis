// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_move_contiguous_trivial_optimization_33450886).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_move_contiguous_trivial_optimization_33450886 { // libcis
struct TMBNTC {
    int *p;
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_move_contiguous_trivial_optimization_33450886 (libcis)
