// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_move_contiguous_trivial_optimization).
// main -> test_algorithms_alg_modifying_operations_alg_move_contiguous_trivial_optimization; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_move_contiguous_trivial_optimization { // libcis: isolate file-scope helpers
struct TMBNTC {
    int *p;
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_move_contiguous_trivial_optimization; // libcis


void test_algorithms_alg_modifying_operations_alg_move_contiguous_trivial_optimization()
{
    test_trivial_moveassign_but_no_trivial_copyassign();
    test_trivial_copyassign_but_no_trivial_moveassign();
