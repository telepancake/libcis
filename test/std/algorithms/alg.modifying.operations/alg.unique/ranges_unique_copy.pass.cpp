// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_unique_ranges_unique_copy_95dc926a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_unique_ranges_unique_copy_95dc926a { // libcis
template <
    class InIter  = int*,
    class Sent    = int*,
    class OutIter = int*,
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_unique_ranges_unique_copy_95dc926a (libcis)
