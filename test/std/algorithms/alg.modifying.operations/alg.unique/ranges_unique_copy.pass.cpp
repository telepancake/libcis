// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_unique_ranges_unique_copy).
// main -> test_algorithms_alg_modifying_operations_alg_unique_ranges_unique_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_unique_ranges_unique_copy { // libcis: isolate file-scope helpers
template <
    class InIter  = int*,
    class Sent    = int*,
    class OutIter = int*,
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_unique_ranges_unique_copy; // libcis


void test_algorithms_alg_modifying_operations_alg_unique_ranges_unique_copy() {
  test();
  static_assert(test());
