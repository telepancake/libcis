// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_unique_unique).
// main -> test_algorithms_alg_modifying_operations_alg_unique_unique; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER > 17
namespace libcis_ns_algorithms_alg_modifying_operations_alg_unique_unique { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_unique_unique; // libcis

#endif // TEST_STD_VER >= 11

void test_algorithms_alg_modifying_operations_alg_unique_unique()
{
