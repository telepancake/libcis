// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_unique_ranges_unique).
// main -> test_algorithms_alg_modifying_operations_alg_unique_ranges_unique; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_unique_ranges_unique { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_unique_ranges_unique; // libcis


void test_algorithms_alg_modifying_operations_alg_unique_ranges_unique() {
  test();
  static_assert(test());
