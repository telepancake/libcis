// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_unique_ranges_unique_0036fbc0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_unique_ranges_unique_0036fbc0 { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_unique_ranges_unique_0036fbc0 (libcis)
