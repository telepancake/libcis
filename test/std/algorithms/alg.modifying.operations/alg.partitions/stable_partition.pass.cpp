// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_partitions_stable_partition_26064f89).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_partitions_stable_partition_26064f89 { // libcis
struct is_odd
{
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_partitions_stable_partition_26064f89 (libcis)
