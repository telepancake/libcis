// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_partitions_is_partitioned_62b49097).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_partitions_is_partitioned_62b49097 { // libcis
struct is_odd {
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_partitions_is_partitioned_62b49097 (libcis)
