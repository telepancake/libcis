// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_partitions_ranges_partition_point).
// main -> test_algorithms_alg_modifying_operations_alg_partitions_ranges_partition_point; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_partitions_ranges_partition_point { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_partitions_ranges_partition_point; // libcis


void test_algorithms_alg_modifying_operations_alg_partitions_ranges_partition_point() {
  test();
  static_assert(test());
