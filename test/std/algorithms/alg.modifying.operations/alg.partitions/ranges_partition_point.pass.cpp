// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_partitions_ranges_partition_point_c3977fd8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_partitions_ranges_partition_point_c3977fd8 { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_partitions_ranges_partition_point_c3977fd8 (libcis)
