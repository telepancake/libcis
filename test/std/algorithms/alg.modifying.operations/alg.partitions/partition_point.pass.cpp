// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_partitions_partition_point_8d5bfa4d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_partitions_partition_point_8d5bfa4d { // libcis
struct is_odd
{
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_partitions_partition_point_8d5bfa4d (libcis)
