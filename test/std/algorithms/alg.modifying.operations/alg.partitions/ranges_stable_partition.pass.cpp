// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_partitions_ranges_stable_partition_ff5030d6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_partitions_ranges_stable_partition_ff5030d6 { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_partitions_ranges_stable_partition_ff5030d6 (libcis)
