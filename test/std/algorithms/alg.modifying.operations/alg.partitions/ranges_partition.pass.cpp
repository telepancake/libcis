// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_partitions_ranges_partition_90431594).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_partitions_ranges_partition_90431594 { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_partitions_ranges_partition_90431594 (libcis)
