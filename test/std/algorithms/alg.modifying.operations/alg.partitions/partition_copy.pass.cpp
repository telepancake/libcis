// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_partitions_partition_copy).
// main -> test_algorithms_alg_modifying_operations_alg_partitions_partition_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_partitions_partition_copy { // libcis: isolate file-scope helpers
struct is_odd
{
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_partitions_partition_copy; // libcis

#endif

void test_algorithms_alg_modifying_operations_alg_partitions_partition_copy()
{
    {
