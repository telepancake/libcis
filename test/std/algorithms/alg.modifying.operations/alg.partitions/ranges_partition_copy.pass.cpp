// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_partitions_ranges_partition_copy_c79614df).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_partitions_ranges_partition_copy_c79614df { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_partitions_ranges_partition_copy_c79614df (libcis)
