// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_partitions_partition_3bd90a45).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_partitions_partition_3bd90a45 { // libcis
struct is_odd
{
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_partitions_partition_3bd90a45 (libcis)
