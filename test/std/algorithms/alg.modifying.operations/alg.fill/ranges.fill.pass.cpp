// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_fill_ranges_fill).
// main -> test_algorithms_alg_modifying_operations_alg_fill_ranges_fill; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_fill_ranges_fill { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_fill_ranges_fill; // libcis


void test_algorithms_alg_modifying_operations_alg_fill_ranges_fill() {
  test();
  static_assert(test());
