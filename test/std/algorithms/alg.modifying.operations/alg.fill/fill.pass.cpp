// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_fill_fill).
// main -> test_algorithms_alg_modifying_operations_alg_fill_fill; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_fill_fill { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_fill_fill; // libcis


void test_algorithms_alg_modifying_operations_alg_fill_fill() {
  test();
#if TEST_STD_VER >= 20
  static_assert(test());
#endif
