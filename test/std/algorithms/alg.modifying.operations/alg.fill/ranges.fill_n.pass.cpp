// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_fill_ranges_fill_n_3af259a3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_fill_ranges_fill_n_3af259a3 { // libcis
template <class Iter>
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_fill_ranges_fill_n_3af259a3 (libcis)
