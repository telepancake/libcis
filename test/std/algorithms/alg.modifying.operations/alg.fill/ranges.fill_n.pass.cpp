// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_fill_ranges_fill_n).
// main -> test_algorithms_alg_modifying_operations_alg_fill_ranges_fill_n; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_fill_ranges_fill_n { // libcis: isolate file-scope helpers
template <class Iter>
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_fill_ranges_fill_n; // libcis


void test_algorithms_alg_modifying_operations_alg_fill_ranges_fill_n() {
  test();
  static_assert(test());
