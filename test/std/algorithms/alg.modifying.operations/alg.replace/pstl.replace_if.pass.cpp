// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_replace_pstl_replace_if_26ebf7cb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_replace_pstl_replace_if_26ebf7cb { // libcis
template <class Iter>
struct Test {
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_replace_pstl_replace_if_26ebf7cb (libcis)
