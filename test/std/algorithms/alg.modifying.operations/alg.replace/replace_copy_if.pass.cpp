// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_replace_replace_copy_if_25d73746).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_replace_replace_copy_if_25d73746 { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_replace_replace_copy_if_25d73746 (libcis)
