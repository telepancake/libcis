// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_replace_ranges_replace_if).
// main -> test_algorithms_alg_modifying_operations_alg_replace_ranges_replace_if; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_replace_ranges_replace_if { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_replace_ranges_replace_if; // libcis


void test_algorithms_alg_modifying_operations_alg_replace_ranges_replace_if() {
  test();
  static_assert(test());
