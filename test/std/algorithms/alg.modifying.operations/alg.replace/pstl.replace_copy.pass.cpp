// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_replace_pstl_replace_copy_9cb2adf1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_replace_pstl_replace_copy_9cb2adf1 { // libcis
template <class Iter>
struct Test {
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_replace_pstl_replace_copy_9cb2adf1 (libcis)
