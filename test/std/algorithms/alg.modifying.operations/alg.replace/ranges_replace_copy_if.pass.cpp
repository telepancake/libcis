// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_replace_ranges_replace_copy_if).
// main -> test_algorithms_alg_modifying_operations_alg_replace_ranges_replace_copy_if; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_replace_ranges_replace_copy_if { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_replace_ranges_replace_copy_if; // libcis


void test_algorithms_alg_modifying_operations_alg_replace_ranges_replace_copy_if() {
  test();
  static_assert(test());
