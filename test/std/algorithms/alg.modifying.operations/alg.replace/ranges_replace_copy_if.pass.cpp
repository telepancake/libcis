// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_replace_ranges_replace_copy_if_ad2a3bfd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_replace_ranges_replace_copy_if_ad2a3bfd { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_replace_ranges_replace_copy_if_ad2a3bfd (libcis)
