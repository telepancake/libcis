// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_swap_ranges_swap_ranges_1285de2f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_swap_ranges_swap_ranges_1285de2f { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_swap_ranges_swap_ranges_1285de2f (libcis)
