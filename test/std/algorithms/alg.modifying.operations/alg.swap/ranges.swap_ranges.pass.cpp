// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_swap_ranges_swap_ranges).
// main -> test_algorithms_alg_modifying_operations_alg_swap_ranges_swap_ranges; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_swap_ranges_swap_ranges { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_swap_ranges_swap_ranges; // libcis


void test_algorithms_alg_modifying_operations_alg_swap_ranges_swap_ranges() {
  test();
  static_assert(test());
