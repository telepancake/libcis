// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_swap_swap_ranges_e00f12d5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_swap_swap_ranges_e00f12d5 { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_swap_swap_ranges_e00f12d5 (libcis)
