// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_random_sample_sample).
// main -> test_algorithms_alg_modifying_operations_alg_random_sample_sample; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_random_sample_sample { // libcis: isolate file-scope helpers
struct ReservoirSampleExpectations {
  enum { os = 4 };
  static int oa1[os];
  static int oa2[os];
};
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_random_sample_sample; // libcis
...
void test_algorithms_alg_modifying_operations_alg_random_sample_sample() {
