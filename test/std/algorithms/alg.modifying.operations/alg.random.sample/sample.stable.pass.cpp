// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_random_sample_sample_stable_7065088d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_random_sample_sample_stable_7065088d { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_random_sample_sample_stable_7065088d (libcis)
