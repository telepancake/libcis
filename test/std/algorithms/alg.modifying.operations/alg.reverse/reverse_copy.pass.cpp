// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_reverse_reverse_copy_6212ea18).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_reverse_reverse_copy_6212ea18 { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_reverse_reverse_copy_6212ea18 (libcis)
