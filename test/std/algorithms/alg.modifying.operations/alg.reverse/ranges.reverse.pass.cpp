// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_reverse_ranges_reverse).
// main -> test_algorithms_alg_modifying_operations_alg_reverse_ranges_reverse; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_reverse_ranges_reverse { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_reverse_ranges_reverse; // libcis


void test_algorithms_alg_modifying_operations_alg_reverse_ranges_reverse() {
  test();
  static_assert(test());
