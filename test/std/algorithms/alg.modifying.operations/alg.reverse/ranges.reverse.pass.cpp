// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_reverse_ranges_reverse_6cf6fccc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_reverse_ranges_reverse_6cf6fccc { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_reverse_ranges_reverse_6cf6fccc (libcis)
