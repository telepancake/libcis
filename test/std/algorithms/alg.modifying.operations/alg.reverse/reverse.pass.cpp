// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_reverse_reverse_d90bd035).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_reverse_reverse_d90bd035 { // libcis
template <class Iter>
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_reverse_reverse_d90bd035 (libcis)
