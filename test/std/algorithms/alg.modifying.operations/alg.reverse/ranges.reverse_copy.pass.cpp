// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_reverse_ranges_reverse_copy_e8c8b4e2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_reverse_ranges_reverse_copy_e8c8b4e2 { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_reverse_ranges_reverse_copy_e8c8b4e2 (libcis)
