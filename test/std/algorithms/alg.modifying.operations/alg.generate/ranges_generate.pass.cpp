// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_generate_ranges_generate_36b503f7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_generate_ranges_generate_36b503f7 { // libcis
struct IntGen {
  int operator()() const;
};
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_generate_ranges_generate_36b503f7 (libcis)
