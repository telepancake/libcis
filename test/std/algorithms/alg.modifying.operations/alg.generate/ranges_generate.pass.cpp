// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_generate_ranges_generate).
// main -> test_algorithms_alg_modifying_operations_alg_generate_ranges_generate; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_generate_ranges_generate { // libcis: isolate file-scope helpers
struct IntGen {
  int operator()() const;
};
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_generate_ranges_generate; // libcis


void test_algorithms_alg_modifying_operations_alg_generate_ranges_generate() {
  test();
  static_assert(test());
