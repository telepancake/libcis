// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_generate_generate_n).
// main -> test_algorithms_alg_modifying_operations_alg_generate_generate_n; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_generate_generate_n { // libcis: isolate file-scope helpers
struct gen_test
{
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_generate_generate_n; // libcis


void test_algorithms_alg_modifying_operations_alg_generate_generate_n()
{
