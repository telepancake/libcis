// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_generate_pstl_generate_n_553a5b81).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_generate_pstl_generate_n_553a5b81 { // libcis
template <class Iter>
struct Test {
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_generate_pstl_generate_n_553a5b81 (libcis)
