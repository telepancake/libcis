// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_shift_shift_right).
// main -> test_algorithms_alg_modifying_operations_alg_shift_shift_right; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_shift_shift_right { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_shift_shift_right; // libcis


void test_algorithms_alg_modifying_operations_alg_shift_shift_right()
{
