// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_rotate_pstl_rotate_copy_7760f772).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_rotate_pstl_rotate_copy_7760f772 { // libcis
template <class Iter>
struct Test {
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_rotate_pstl_rotate_copy_7760f772 (libcis)
