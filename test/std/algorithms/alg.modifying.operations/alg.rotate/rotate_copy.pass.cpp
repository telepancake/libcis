// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_rotate_rotate_copy_b22a8515).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_rotate_rotate_copy_b22a8515 { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_rotate_rotate_copy_b22a8515 (libcis)
