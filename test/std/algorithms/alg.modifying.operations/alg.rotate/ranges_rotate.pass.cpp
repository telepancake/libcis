// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_rotate_ranges_rotate_345ba503).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_rotate_ranges_rotate_345ba503 { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_rotate_ranges_rotate_345ba503 (libcis)
