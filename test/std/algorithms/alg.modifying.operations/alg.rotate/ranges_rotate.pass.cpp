// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_rotate_ranges_rotate).
// main -> test_algorithms_alg_modifying_operations_alg_rotate_ranges_rotate; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_rotate_ranges_rotate { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_rotate_ranges_rotate; // libcis


void test_algorithms_alg_modifying_operations_alg_rotate_ranges_rotate() {
  test();
  static_assert(test());
