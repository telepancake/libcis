// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_rotate_rotate_a66ddb44).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_rotate_rotate_a66ddb44 { // libcis
template <class Iter>
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_rotate_rotate_a66ddb44 (libcis)
