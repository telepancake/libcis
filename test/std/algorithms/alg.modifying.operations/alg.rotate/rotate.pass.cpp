// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_rotate_rotate).
// main -> test_algorithms_alg_modifying_operations_alg_rotate_rotate; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_rotate_rotate { // libcis: isolate file-scope helpers
struct TestIter {
  template <class Iter>
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_rotate_rotate; // libcis


void test_algorithms_alg_modifying_operations_alg_rotate_rotate() {
  test();
#if TEST_STD_VER >= 20
  static_assert(test());
#endif
