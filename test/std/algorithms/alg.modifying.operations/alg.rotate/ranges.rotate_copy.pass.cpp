// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_rotate_ranges_rotate_copy).
// main -> test_algorithms_alg_modifying_operations_alg_rotate_ranges_rotate_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_rotate_ranges_rotate_copy { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_rotate_ranges_rotate_copy; // libcis


void test_algorithms_alg_modifying_operations_alg_rotate_ranges_rotate_copy() {
  test();
  static_assert(test());
