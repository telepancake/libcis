// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_remove_remove_if_d750b5be).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_remove_remove_if_d750b5be { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_remove_remove_if_d750b5be (libcis)
