// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_remove_ranges_remove).
// main -> test_algorithms_alg_modifying_operations_alg_remove_ranges_remove; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_remove_ranges_remove { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_remove_ranges_remove; // libcis


void test_algorithms_alg_modifying_operations_alg_remove_ranges_remove() {
  test();
  static_assert(test());
