// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_remove_remove_copy_if_dc6eda2f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_remove_remove_copy_if_dc6eda2f { // libcis
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_remove_remove_copy_if_dc6eda2f (libcis)
