// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_remove_ranges_remove_copy).
// main -> test_algorithms_alg_modifying_operations_alg_remove_ranges_remove_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_remove_ranges_remove_copy { // libcis: isolate file-scope helpers
struct ToPtr {
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_remove_ranges_remove_copy; // libcis


void test_algorithms_alg_modifying_operations_alg_remove_ranges_remove_copy() {
  test();
  static_assert(test());
