// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_remove_ranges_remove_copy_eb86f1dd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_remove_ranges_remove_copy_eb86f1dd { // libcis
struct ToPtr {
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_remove_ranges_remove_copy_eb86f1dd (libcis)
