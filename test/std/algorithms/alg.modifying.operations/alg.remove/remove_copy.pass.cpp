// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_remove_remove_copy).
// main -> test_algorithms_alg_modifying_operations_alg_remove_remove_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER > 17
namespace libcis_ns_algorithms_alg_modifying_operations_alg_remove_remove_copy { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_remove_remove_copy; // libcis


void test_algorithms_alg_modifying_operations_alg_remove_remove_copy()
{
