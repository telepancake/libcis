// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_remove_remove_copy_43c0ee24).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_remove_remove_copy_43c0ee24 { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_remove_remove_copy_43c0ee24 (libcis)
