// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_remove_ranges_remove_if).
// main -> test_algorithms_alg_modifying_operations_alg_remove_ranges_remove_if; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_remove_ranges_remove_if { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_modifying_operations_alg_remove_ranges_remove_if; // libcis

// clang-format on

void test_algorithms_alg_modifying_operations_alg_remove_ranges_remove_if() {
  test();
  static_assert(test());
