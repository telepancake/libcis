// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_modifying_operations_alg_remove_ranges_remove_copy_if_7a2b13ba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_modifying_operations_alg_remove_ranges_remove_copy_if_7a2b13ba { // libcis
struct AlwaysTrue {
...
} // libcis_ns_algorithms_alg_modifying_operations_alg_remove_ranges_remove_copy_if_7a2b13ba (libcis)
