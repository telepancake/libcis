// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_three_way_lexicographical_compare_three_way).
// main -> test_algorithms_alg_sorting_alg_three_way_lexicographical_compare_three_way; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_three_way_lexicographical_compare_three_way { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_three_way_lexicographical_compare_three_way; // libcis


void test_algorithms_alg_sorting_alg_three_way_lexicographical_compare_three_way() {
  test();
  static_assert(test());
