// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_three_way_lexicographical_compare_three_way_comp_03f363fe).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_three_way_lexicographical_compare_three_way_comp_03f363fe { // libcis
using std::array;
...
} // libcis_ns_algorithms_alg_sorting_alg_three_way_lexicographical_compare_three_way_comp_03f363fe (libcis)
