// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_binary_search_upper_bound_upper_bound_c14f8b49).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_binary_search_upper_bound_upper_bound_c14f8b49 { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_algorithms_alg_sorting_alg_binary_search_upper_bound_upper_bound_c14f8b49 (libcis)
