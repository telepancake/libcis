// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_binary_search_upper_bound_ranges_upper_bound).
// main -> test_algorithms_alg_sorting_alg_binary_search_upper_bound_ranges_upper_bound; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_binary_search_upper_bound_ranges_upper_bound { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_binary_search_upper_bound_ranges_upper_bound; // libcis


void test_algorithms_alg_sorting_alg_binary_search_upper_bound_ranges_upper_bound() {
  test();
  static_assert(test());
