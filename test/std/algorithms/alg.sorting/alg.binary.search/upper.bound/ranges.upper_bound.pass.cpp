// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_binary_search_upper_bound_ranges_upper_bound_d34bbd58).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_binary_search_upper_bound_ranges_upper_bound_d34bbd58 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_binary_search_upper_bound_ranges_upper_bound_d34bbd58 (libcis)
