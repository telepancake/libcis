// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_binary_search_lower_bound_ranges_lower_bound).
// main -> test_algorithms_alg_sorting_alg_binary_search_lower_bound_ranges_lower_bound; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_binary_search_lower_bound_ranges_lower_bound { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_binary_search_lower_bound_ranges_lower_bound; // libcis


void test_algorithms_alg_sorting_alg_binary_search_lower_bound_ranges_lower_bound() {
  test();
  static_assert(test());
