// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_binary_search_equal_range_equal_range_comp).
// main -> test_algorithms_alg_sorting_alg_binary_search_equal_range_equal_range_comp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER > 17
namespace libcis_ns_algorithms_alg_sorting_alg_binary_search_equal_range_equal_range_comp { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_binary_search_equal_range_equal_range_comp; // libcis


void test_algorithms_alg_sorting_alg_binary_search_equal_range_equal_range_comp()
{
    int d[] = {3, 2, 1, 0};
    for (int* e = d; e <= d+4; ++e)
        for (int x = -1; x <= 4; ++x)
