// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_binary_search_equal_range_equal_range_comp_c9d7397a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_binary_search_equal_range_equal_range_comp_c9d7397a { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_algorithms_alg_sorting_alg_binary_search_equal_range_equal_range_comp_c9d7397a (libcis)
