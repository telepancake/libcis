// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_binary_search_equal_range_ranges_equal_range_b1a5eaed).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_binary_search_equal_range_ranges_equal_range_b1a5eaed { // libcis
struct Foo {};
...
} // libcis_ns_algorithms_alg_sorting_alg_binary_search_equal_range_ranges_equal_range_b1a5eaed (libcis)
