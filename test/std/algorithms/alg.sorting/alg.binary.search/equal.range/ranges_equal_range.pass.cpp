// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_binary_search_equal_range_ranges_equal_range).
// main -> test_algorithms_alg_sorting_alg_binary_search_equal_range_ranges_equal_range; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_binary_search_equal_range_ranges_equal_range { // libcis: isolate file-scope helpers
struct Foo {};
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_binary_search_equal_range_ranges_equal_range; // libcis


void test_algorithms_alg_sorting_alg_binary_search_equal_range_ranges_equal_range() {
  test();
  static_assert(test());
