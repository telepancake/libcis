// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_binary_search_binary_search_ranges_binary_search_c79770d1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_binary_search_binary_search_ranges_binary_search_c79770d1 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_binary_search_binary_search_ranges_binary_search_c79770d1 (libcis)
