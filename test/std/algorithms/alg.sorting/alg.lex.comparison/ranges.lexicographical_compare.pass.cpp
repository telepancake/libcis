// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_lex_comparison_ranges_lexicographical_compare).
// main -> test_algorithms_alg_sorting_alg_lex_comparison_ranges_lexicographical_compare; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_lex_comparison_ranges_lexicographical_compare { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_lex_comparison_ranges_lexicographical_compare; // libcis


void test_algorithms_alg_sorting_alg_lex_comparison_ranges_lexicographical_compare() {
  test();
  static_assert(test());
