// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_lex_comparison_ranges_lexicographical_compare_09b6cf72).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_lex_comparison_ranges_lexicographical_compare_09b6cf72 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_lex_comparison_ranges_lexicographical_compare_09b6cf72 (libcis)
