// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_lex_comparison_lexicographical_compare_comp).
// main -> test_algorithms_alg_sorting_alg_lex_comparison_lexicographical_compare_comp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER > 17
namespace libcis_ns_algorithms_alg_sorting_alg_lex_comparison_lexicographical_compare_comp { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_lex_comparison_lexicographical_compare_comp; // libcis


void test_algorithms_alg_sorting_alg_lex_comparison_lexicographical_compare_comp()
{
