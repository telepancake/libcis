// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_lex_comparison_lexicographical_compare_comp_40935473).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_lex_comparison_lexicographical_compare_comp_40935473 { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_algorithms_alg_sorting_alg_lex_comparison_lexicographical_compare_comp_40935473 (libcis)
