// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_is_sorted_ranges_is_sorted_until).
// main -> test_algorithms_alg_sorting_alg_sort_is_sorted_ranges_is_sorted_until; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_is_sorted_ranges_is_sorted_until { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_sort_is_sorted_ranges_is_sorted_until; // libcis


void test_algorithms_alg_sorting_alg_sort_is_sorted_ranges_is_sorted_until() {
  test();
  static_assert(test());
