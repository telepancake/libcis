// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_is_sorted_is_sorted_comp_46bd343c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_is_sorted_is_sorted_comp_46bd343c { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_algorithms_alg_sorting_alg_sort_is_sorted_is_sorted_comp_46bd343c (libcis)
