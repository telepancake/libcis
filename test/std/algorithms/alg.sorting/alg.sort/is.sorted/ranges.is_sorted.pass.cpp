// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_is_sorted_ranges_is_sorted_5d54a5e9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_is_sorted_ranges_is_sorted_5d54a5e9 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_sort_is_sorted_ranges_is_sorted_5d54a5e9 (libcis)
