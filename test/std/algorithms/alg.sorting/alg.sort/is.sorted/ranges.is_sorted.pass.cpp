// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_is_sorted_ranges_is_sorted).
// main -> test_algorithms_alg_sorting_alg_sort_is_sorted_ranges_is_sorted; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_is_sorted_ranges_is_sorted { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_sort_is_sorted_ranges_is_sorted; // libcis


void test_algorithms_alg_sorting_alg_sort_is_sorted_ranges_is_sorted() {
  test();
  static_assert(test());
