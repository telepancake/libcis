// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_partial_sort_copy_partial_sort_copy).
// main -> test_algorithms_alg_sorting_alg_sort_partial_sort_copy_partial_sort_copy; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_partial_sort_copy_partial_sort_copy { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_sort_partial_sort_copy_partial_sort_copy; // libcis


void test_algorithms_alg_sorting_alg_sort_partial_sort_copy_partial_sort_copy()
{
    int i = 42;
    int j = 75;
