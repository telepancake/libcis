// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_stable_sort_stable_sort_comp).
// main -> test_algorithms_alg_sorting_alg_sort_stable_sort_stable_sort_comp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_stable_sort_stable_sort_comp { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_sort_stable_sort_stable_sort_comp; // libcis


void test_algorithms_alg_sorting_alg_sort_stable_sort_stable_sort_comp() {
  test();
#if TEST_STD_VER >= 26
  static_assert(test());
#endif
