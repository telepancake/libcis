// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_stable_sort_stable_sort_b266de08).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_stable_sort_stable_sort_b266de08 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_sort_stable_sort_stable_sort_b266de08 (libcis)
