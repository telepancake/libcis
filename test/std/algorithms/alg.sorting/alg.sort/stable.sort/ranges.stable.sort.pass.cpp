// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_stable_sort_ranges_stable_sort_c3644a51).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_stable_sort_ranges_stable_sort_c3644a51 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_sort_stable_sort_ranges_stable_sort_c3644a51 (libcis)
