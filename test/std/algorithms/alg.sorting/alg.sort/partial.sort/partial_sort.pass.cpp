// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_partial_sort_partial_sort).
// main -> test_algorithms_alg_sorting_alg_sort_partial_sort_partial_sort; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_partial_sort_partial_sort { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_sort_partial_sort_partial_sort; // libcis


void test_algorithms_alg_sorting_alg_sort_partial_sort_partial_sort()
{
    int i = 42;
