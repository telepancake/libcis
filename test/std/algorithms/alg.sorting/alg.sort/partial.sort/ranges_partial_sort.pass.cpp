// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_partial_sort_ranges_partial_sort_60dc45cf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_partial_sort_ranges_partial_sort_60dc45cf { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_sort_partial_sort_ranges_partial_sort_60dc45cf (libcis)
