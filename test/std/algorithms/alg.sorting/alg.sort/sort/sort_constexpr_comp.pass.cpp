// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_sort_sort_constexpr_comp_08ef23bd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_sort_sort_constexpr_comp_08ef23bd { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_sort_sort_sort_constexpr_comp_08ef23bd (libcis)
