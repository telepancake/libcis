// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_sort_sort).
// main -> test_algorithms_alg_sorting_alg_sort_sort_sort; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_sort_sort { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_sort_sort_sort; // libcis


void test_algorithms_alg_sorting_alg_sort_sort_sort()
{
