// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_sort_ranges_sort_642759a9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_sort_ranges_sort_642759a9 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_sort_sort_ranges_sort_642759a9 (libcis)
