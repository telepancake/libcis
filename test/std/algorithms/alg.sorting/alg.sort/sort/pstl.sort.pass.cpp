// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_sort_pstl_sort_f44a390d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_sort_pstl_sort_f44a390d { // libcis
template <class Iter>
struct Test {
...
} // libcis_ns_algorithms_alg_sorting_alg_sort_sort_pstl_sort_f44a390d (libcis)
