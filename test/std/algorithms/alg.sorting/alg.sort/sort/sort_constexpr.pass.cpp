// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_sort_sort_sort_constexpr_cc0fd1bd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_sort_sort_sort_constexpr_cc0fd1bd { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_sort_sort_sort_constexpr_cc0fd1bd (libcis)
