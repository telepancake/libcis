// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_min_max_min_comp_b0fffa75).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_min_max_min_comp_b0fffa75 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_min_max_min_comp_b0fffa75 (libcis)
