// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_min_max_max_init_list_comp_239bb24b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_min_max_max_init_list_comp_239bb24b { // libcis
int main(int, char**)
{
...
} // libcis_ns_algorithms_alg_sorting_alg_min_max_max_init_list_comp_239bb24b (libcis)
