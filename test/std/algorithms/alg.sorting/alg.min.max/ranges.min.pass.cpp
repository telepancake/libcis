// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_min_max_ranges_min_36ff3d87).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_min_max_ranges_min_36ff3d87 { // libcis
template <class T>
...
} // libcis_ns_algorithms_alg_sorting_alg_min_max_ranges_min_36ff3d87 (libcis)
