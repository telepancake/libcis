// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_min_max_max_element_comp_b67c5312).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_min_max_max_element_comp_b67c5312 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_min_max_max_element_comp_b67c5312 (libcis)
