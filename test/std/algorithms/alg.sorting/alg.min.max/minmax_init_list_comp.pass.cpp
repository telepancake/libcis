// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_min_max_minmax_init_list_comp).
// main -> test_algorithms_alg_sorting_alg_min_max_minmax_init_list_comp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_min_max_minmax_init_list_comp { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_min_max_minmax_init_list_comp; // libcis


void test_algorithms_alg_sorting_alg_min_max_minmax_init_list_comp()
{
