// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_min_max_minmax_element_comp_c5823aed).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_min_max_minmax_element_comp_c5823aed { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_min_max_minmax_element_comp_c5823aed (libcis)
