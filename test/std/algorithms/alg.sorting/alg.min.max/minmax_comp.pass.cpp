// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_min_max_minmax_comp_a1ef8f41).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_min_max_minmax_comp_a1ef8f41 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_min_max_minmax_comp_a1ef8f41 (libcis)
