// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_min_max_ranges_max_element).
// main -> test_algorithms_alg_sorting_alg_min_max_ranges_max_element; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_min_max_ranges_max_element { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_min_max_ranges_max_element; // libcis


void test_algorithms_alg_sorting_alg_min_max_ranges_max_element() {
  test();
  static_assert(test());
