// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_min_max_minmax_init_list).
// main -> test_algorithms_alg_sorting_alg_min_max_minmax_init_list; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_algorithms_alg_sorting_alg_min_max_minmax_init_list()
{
