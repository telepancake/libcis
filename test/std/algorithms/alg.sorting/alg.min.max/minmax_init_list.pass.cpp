// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_min_max_minmax_init_list_4eee9a4b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_min_max_minmax_init_list_4eee9a4b { // libcis
int main(int, char**)
{
...
} // libcis_ns_algorithms_alg_sorting_alg_min_max_minmax_init_list_4eee9a4b (libcis)
