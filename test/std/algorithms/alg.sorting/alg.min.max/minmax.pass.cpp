// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_min_max_minmax_97cc7f29).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_min_max_minmax_97cc7f29 { // libcis
template <class T>
void
...
} // libcis_ns_algorithms_alg_sorting_alg_min_max_minmax_97cc7f29 (libcis)
