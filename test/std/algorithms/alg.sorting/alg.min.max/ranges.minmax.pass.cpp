// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_min_max_ranges_minmax_6252a83f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_min_max_ranges_minmax_6252a83f { // libcis
template <class T>
...
} // libcis_ns_algorithms_alg_sorting_alg_min_max_ranges_minmax_6252a83f (libcis)
