// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_set_intersection_ranges_set_intersection_6adba3b1).
//===----------------------------------------------------------------------===//
//
...
// =====================================
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_set_intersection_ranges_set_intersection_6adba3b1 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_set_operations_set_intersection_ranges_set_intersection_6adba3b1 (libcis)
