// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_set_intersection_set_intersection_complexity_6da8565b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_set_intersection_set_intersection_complexity_6da8565b { // libcis
namespace {
...
} // libcis_ns_algorithms_alg_sorting_alg_set_operations_set_intersection_set_intersection_complexity_6da8565b (libcis)
