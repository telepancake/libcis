// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_set_intersection_set_intersection_complexity).
// main -> test_algorithms_alg_sorting_alg_set_operations_set_intersection_set_intersection_complexity; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_algorithms_alg_sorting_alg_set_operations_set_intersection_set_intersection_complexity() {
  testComplexityBasic();
  testComplexity();
