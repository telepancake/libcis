// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_set_intersection_set_intersection).
// main -> test_algorithms_alg_sorting_alg_set_operations_set_intersection_set_intersection; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_set_intersection_set_intersection { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_set_intersection_set_intersection; // libcis


void test_algorithms_alg_sorting_alg_set_operations_set_intersection_set_intersection()
{
    test();
#if TEST_STD_VER > 17
    static_assert(test());
