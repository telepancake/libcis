// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_includes_ranges_includes).
// main -> test_algorithms_alg_sorting_alg_set_operations_includes_ranges_includes; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_includes_ranges_includes { // libcis: isolate file-scope helpers
template <
    class Iter1 = int*,
    class Sent1 = int*,
    class Iter2 = int*,
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_includes_ranges_includes; // libcis


void test_algorithms_alg_sorting_alg_set_operations_includes_ranges_includes() {
  test();
  static_assert(test());
