// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_includes_ranges_includes_be424229).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_includes_ranges_includes_be424229 { // libcis
template <
    class Iter1 = int*,
    class Sent1 = int*,
    class Iter2 = int*,
...
} // libcis_ns_algorithms_alg_sorting_alg_set_operations_includes_ranges_includes_be424229 (libcis)
