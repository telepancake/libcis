// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_includes_includes_comp_f5acc7f8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_includes_includes_comp_f5acc7f8 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_set_operations_includes_includes_comp_f5acc7f8 (libcis)
