// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_includes_includes_6ffc119f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_includes_includes_6ffc119f { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_set_operations_includes_includes_6ffc119f (libcis)
