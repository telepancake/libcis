// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_includes_includes).
// main -> test_algorithms_alg_sorting_alg_set_operations_includes_includes; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_includes_includes { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_includes_includes; // libcis


void test_algorithms_alg_sorting_alg_set_operations_includes_includes()
{
    do_tests();
#if TEST_STD_VER > 17
