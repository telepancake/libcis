// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_set_difference_ranges_set_difference).
// main -> test_algorithms_alg_sorting_alg_set_operations_set_difference_ranges_set_difference; file-scope helpers isolated in anon namespace.
...
// =====================================
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_set_difference_ranges_set_difference { // libcis: isolate file-scope helpers
template <
    class InIter1,
    class InIter2,
    class OutIter,
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_set_difference_ranges_set_difference; // libcis
...
void test_algorithms_alg_sorting_alg_set_operations_set_difference_ranges_set_difference() {
  test();
  static_assert(test());
