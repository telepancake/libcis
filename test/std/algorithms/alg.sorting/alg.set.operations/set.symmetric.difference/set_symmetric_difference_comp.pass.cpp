// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_set_symmetric_difference_set_symmetric_difference_comp).
// main -> test_algorithms_alg_sorting_alg_set_operations_set_symmetric_difference_set_symmetric_difference_comp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_set_symmetric_difference_set_symmetric_difference_comp { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_set_symmetric_difference_set_symmetric_difference_comp; // libcis


void test_algorithms_alg_sorting_alg_set_operations_set_symmetric_difference_set_symmetric_difference_comp()
{
    test();
#if TEST_STD_VER > 17
    static_assert(test());
