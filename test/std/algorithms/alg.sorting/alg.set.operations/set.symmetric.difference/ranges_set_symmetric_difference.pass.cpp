// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_set_symmetric_difference_ranges_set_symmetric_difference_8633761c).
//===----------------------------------------------------------------------===//
//
...
// =====================================
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_set_symmetric_difference_ranges_set_symmetric_difference_8633761c { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_set_operations_set_symmetric_difference_ranges_set_symmetric_difference_8633761c (libcis)
