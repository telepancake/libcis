// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_set_union_set_union_move_38584b46).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_set_union_set_union_move_38584b46 { // libcis
int main(int, char**)
{
...
} // libcis_ns_algorithms_alg_sorting_alg_set_operations_set_union_set_union_move_38584b46 (libcis)
