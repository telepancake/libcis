// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_set_union_set_union_move).
// main -> test_algorithms_alg_sorting_alg_set_operations_set_union_set_union_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_algorithms_alg_sorting_alg_set_operations_set_union_set_union_move()
{
