// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_set_union_set_union).
// main -> test_algorithms_alg_sorting_alg_set_operations_set_union_set_union; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_set_union_set_union { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_set_union_set_union; // libcis


void test_algorithms_alg_sorting_alg_set_operations_set_union_set_union()
{
    test();
#if TEST_STD_VER > 17
    static_assert(test());
