// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_set_operations_set_union_set_union_62440574).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_set_operations_set_union_set_union_62440574 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_set_operations_set_union_set_union_62440574 (libcis)
