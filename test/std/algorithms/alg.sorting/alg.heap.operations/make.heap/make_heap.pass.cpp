// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_heap_operations_make_heap_make_heap_5fbad6dd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_make_heap_make_heap_5fbad6dd { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_heap_operations_make_heap_make_heap_5fbad6dd (libcis)
