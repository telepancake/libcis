// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_heap_operations_make_heap_ranges_make_heap_b104aa7b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_make_heap_ranges_make_heap_b104aa7b { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_heap_operations_make_heap_ranges_make_heap_b104aa7b (libcis)
