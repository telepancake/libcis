// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_heap_operations_push_heap_push_heap_comp_cc7fc911).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_push_heap_push_heap_comp_cc7fc911 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_heap_operations_push_heap_push_heap_comp_cc7fc911 (libcis)
