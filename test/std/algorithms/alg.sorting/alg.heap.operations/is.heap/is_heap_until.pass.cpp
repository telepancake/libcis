// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_heap_operations_is_heap_is_heap_until_cf0bcdd1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_is_heap_is_heap_until_cf0bcdd1 { // libcis
#if TEST_STD_VER > 17
...
} // libcis_ns_algorithms_alg_sorting_alg_heap_operations_is_heap_is_heap_until_cf0bcdd1 (libcis)
