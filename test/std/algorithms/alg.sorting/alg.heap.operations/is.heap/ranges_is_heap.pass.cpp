// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_heap_operations_is_heap_ranges_is_heap_87362318).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_is_heap_ranges_is_heap_87362318 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_heap_operations_is_heap_ranges_is_heap_87362318 (libcis)
