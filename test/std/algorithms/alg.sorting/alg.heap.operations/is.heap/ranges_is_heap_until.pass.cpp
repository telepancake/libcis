// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_heap_operations_is_heap_ranges_is_heap_until_3738df63).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_is_heap_ranges_is_heap_until_3738df63 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_heap_operations_is_heap_ranges_is_heap_until_3738df63 (libcis)
