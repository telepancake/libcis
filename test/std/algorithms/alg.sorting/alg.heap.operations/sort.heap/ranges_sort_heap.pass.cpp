// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_heap_operations_sort_heap_ranges_sort_heap).
// main -> test_algorithms_alg_sorting_alg_heap_operations_sort_heap_ranges_sort_heap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_sort_heap_ranges_sort_heap { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_sort_heap_ranges_sort_heap; // libcis


void test_algorithms_alg_sorting_alg_heap_operations_sort_heap_ranges_sort_heap() {
  test();
  static_assert(test());
  test_complexity();
  return;
