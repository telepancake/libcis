// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_heap_operations_sort_heap_complexity_27aeb746).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_sort_heap_complexity_27aeb746 { // libcis
struct Stats {
  int compared = 0;
  int copied   = 0;
  int moved    = 0;
...
} // libcis_ns_algorithms_alg_sorting_alg_heap_operations_sort_heap_complexity_27aeb746 (libcis)
