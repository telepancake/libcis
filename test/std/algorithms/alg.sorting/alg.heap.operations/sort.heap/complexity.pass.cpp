// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_heap_operations_sort_heap_complexity).
// main -> test_algorithms_alg_sorting_alg_heap_operations_sort_heap_complexity; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_sort_heap_complexity { // libcis: isolate file-scope helpers
struct Stats {
  int compared = 0;
  int copied   = 0;
  int moved    = 0;
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_sort_heap_complexity; // libcis


void test_algorithms_alg_sorting_alg_heap_operations_sort_heap_complexity() {
