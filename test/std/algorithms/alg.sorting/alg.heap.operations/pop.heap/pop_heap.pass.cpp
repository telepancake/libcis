// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_heap_operations_pop_heap_pop_heap_b255c33c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_pop_heap_pop_heap_b255c33c { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_heap_operations_pop_heap_pop_heap_b255c33c (libcis)
