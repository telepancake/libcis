// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_heap_operations_pop_heap_ranges_pop_heap).
// main -> test_algorithms_alg_sorting_alg_heap_operations_pop_heap_ranges_pop_heap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_pop_heap_ranges_pop_heap { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_pop_heap_ranges_pop_heap; // libcis


void test_algorithms_alg_sorting_alg_heap_operations_pop_heap_ranges_pop_heap() {
  test();
  static_assert(test());
