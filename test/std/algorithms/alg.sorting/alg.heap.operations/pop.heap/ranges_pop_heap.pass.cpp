// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_heap_operations_pop_heap_ranges_pop_heap_e48aa358).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_pop_heap_ranges_pop_heap_e48aa358 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_heap_operations_pop_heap_ranges_pop_heap_e48aa358 (libcis)
