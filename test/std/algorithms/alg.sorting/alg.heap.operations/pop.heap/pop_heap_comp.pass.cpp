// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_heap_operations_pop_heap_pop_heap_comp_8184097a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_heap_operations_pop_heap_pop_heap_comp_8184097a { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_heap_operations_pop_heap_pop_heap_comp_8184097a (libcis)
