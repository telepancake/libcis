// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_permutation_generators_ranges_prev_permutation_75a39b6f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_permutation_generators_ranges_prev_permutation_75a39b6f { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_permutation_generators_ranges_prev_permutation_75a39b6f (libcis)
