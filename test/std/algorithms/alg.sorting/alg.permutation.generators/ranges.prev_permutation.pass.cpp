// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_permutation_generators_ranges_prev_permutation).
// main -> test_algorithms_alg_sorting_alg_permutation_generators_ranges_prev_permutation; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_permutation_generators_ranges_prev_permutation { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_permutation_generators_ranges_prev_permutation; // libcis


void test_algorithms_alg_sorting_alg_permutation_generators_ranges_prev_permutation() {
  test();
  static_assert(test());
