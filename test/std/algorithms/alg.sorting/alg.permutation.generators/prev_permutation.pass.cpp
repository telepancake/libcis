// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_permutation_generators_prev_permutation_c6059dc1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_permutation_generators_prev_permutation_c6059dc1 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_permutation_generators_prev_permutation_c6059dc1 (libcis)
