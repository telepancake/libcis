// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_permutation_generators_prev_permutation_comp_38d6c748).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_permutation_generators_prev_permutation_comp_38d6c748 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_permutation_generators_prev_permutation_comp_38d6c748 (libcis)
