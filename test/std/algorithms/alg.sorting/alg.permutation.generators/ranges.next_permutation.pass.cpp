// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_permutation_generators_ranges_next_permutation_b3eb3111).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_permutation_generators_ranges_next_permutation_b3eb3111 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_permutation_generators_ranges_next_permutation_b3eb3111 (libcis)
