// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_clamp_clamp_5245ec69).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_clamp_clamp_5245ec69 { // libcis
struct Tag {
...
} // libcis_ns_algorithms_alg_sorting_alg_clamp_clamp_5245ec69 (libcis)
