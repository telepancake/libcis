// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_clamp_clamp_comp_038d30f1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_clamp_clamp_comp_038d30f1 { // libcis
struct Tag {
...
} // libcis_ns_algorithms_alg_sorting_alg_clamp_clamp_comp_038d30f1 (libcis)
