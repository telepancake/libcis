// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_clamp_clamp_comp).
// main -> test_algorithms_alg_sorting_alg_clamp_clamp_comp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_clamp_clamp_comp { // libcis: isolate file-scope helpers
struct Tag {
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_clamp_clamp_comp; // libcis


void test_algorithms_alg_sorting_alg_clamp_clamp_comp()
{
    {
    int x = 0;
    int y = 0;
