// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_clamp_ranges_clamp).
// main -> test_algorithms_alg_sorting_alg_clamp_ranges_clamp; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_clamp_ranges_clamp { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_clamp_ranges_clamp; // libcis


void test_algorithms_alg_sorting_alg_clamp_ranges_clamp() {
  test();
  static_assert(test());
