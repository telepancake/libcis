// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_clamp_ranges_clamp_2db095fc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_clamp_ranges_clamp_2db095fc { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_clamp_ranges_clamp_2db095fc (libcis)
