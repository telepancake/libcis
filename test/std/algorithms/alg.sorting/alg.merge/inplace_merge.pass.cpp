// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_merge_inplace_merge_c2dc4516).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_merge_inplace_merge_c2dc4516 { // libcis
#if TEST_STD_VER >= 11
struct S {
    S() : i_(0) {}
    S(int i) : i_(i) {}
...
} // libcis_ns_algorithms_alg_sorting_alg_merge_inplace_merge_c2dc4516 (libcis)
