// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_merge_ranges_inplace_merge_60168e35).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_merge_ranges_inplace_merge_60168e35 { // libcis
template < class Iter,
           class Middle = Iter,
...
} // libcis_ns_algorithms_alg_sorting_alg_merge_ranges_inplace_merge_60168e35 (libcis)
