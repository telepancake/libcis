// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_merge_merge).
// main -> test_algorithms_alg_sorting_alg_merge_merge; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_merge_merge { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_merge_merge; // libcis


void test_algorithms_alg_sorting_alg_merge_merge()
{
    test();
#if TEST_STD_VER > 17
    static_assert(test());
