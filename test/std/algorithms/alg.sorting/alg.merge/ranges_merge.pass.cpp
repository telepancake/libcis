// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_merge_ranges_merge).
// main -> test_algorithms_alg_sorting_alg_merge_ranges_merge; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
// =====================================
namespace libcis_ns_algorithms_alg_sorting_alg_merge_ranges_merge { // libcis: isolate file-scope helpers
template <
    class InIter1,
    class InIter2,
    class OutIter,
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_merge_ranges_merge; // libcis
...
void test_algorithms_alg_sorting_alg_merge_ranges_merge() {
  test();
  static_assert(test());
