// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_merge_ranges_merge_39a6b662).
//===----------------------------------------------------------------------===//
//
...
// =====================================
namespace libcis_ns_algorithms_alg_sorting_alg_merge_ranges_merge_39a6b662 { // libcis
template <
    class InIter1,
    class InIter2,
    class OutIter,
...
} // libcis_ns_algorithms_alg_sorting_alg_merge_ranges_merge_39a6b662 (libcis)
