// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_partitions_ranges_is_partitioned).
// main -> test_algorithms_alg_sorting_alg_partitions_ranges_is_partitioned; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_partitions_ranges_is_partitioned { // libcis: isolate file-scope helpers
struct Functor {
  bool operator()(auto&&);
};
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_partitions_ranges_is_partitioned; // libcis


void test_algorithms_alg_sorting_alg_partitions_ranges_is_partitioned() {
  test();
  static_assert(test());
