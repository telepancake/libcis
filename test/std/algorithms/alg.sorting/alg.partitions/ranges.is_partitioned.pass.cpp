// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_partitions_ranges_is_partitioned_83e2f7fd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_partitions_ranges_is_partitioned_83e2f7fd { // libcis
struct Functor {
  bool operator()(auto&&);
};
...
} // libcis_ns_algorithms_alg_sorting_alg_partitions_ranges_is_partitioned_83e2f7fd (libcis)
