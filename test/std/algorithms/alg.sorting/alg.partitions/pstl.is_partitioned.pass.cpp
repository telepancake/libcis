// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_partitions_pstl_is_partitioned_24c24618).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_partitions_pstl_is_partitioned_24c24618 { // libcis
template <class Iter>
struct Test {
...
} // libcis_ns_algorithms_alg_sorting_alg_partitions_pstl_is_partitioned_24c24618 (libcis)
