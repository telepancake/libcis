// transferred+adapted from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_nth_element_ranges_nth_element_31fbe324).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_nth_element_ranges_nth_element_31fbe324 { // libcis
...
} // libcis_ns_algorithms_alg_sorting_alg_nth_element_ranges_nth_element_31fbe324 (libcis)
