// AST-transferred from libc++ by tools/transfer.py (slug=algorithms_alg_sorting_alg_nth_element_ranges_nth_element).
// main -> test_algorithms_alg_sorting_alg_nth_element_ranges_nth_element; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_algorithms_alg_sorting_alg_nth_element_ranges_nth_element { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_algorithms_alg_sorting_alg_nth_element_ranges_nth_element; // libcis


void test_algorithms_alg_sorting_alg_nth_element_ranges_nth_element() {
  test();
  static_assert(test());
