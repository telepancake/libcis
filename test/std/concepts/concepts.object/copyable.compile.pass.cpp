// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_object_copyable_71825991).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_object_copyable_71825991 { // libcis
...
} // libcis_ns_concepts_concepts_object_copyable_71825991 (libcis)
