// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_object_semiregular_619c62ee).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_object_semiregular_619c62ee { // libcis
...
} // libcis_ns_concepts_concepts_object_semiregular_619c62ee (libcis)
