// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_object_semiregular).
...
namespace libcis_ns_concepts_concepts_object_semiregular { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_concepts_concepts_object_semiregular; // libcis
