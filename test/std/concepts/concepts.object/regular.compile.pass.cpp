// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_object_regular_e04c43ac).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_object_regular_e04c43ac { // libcis
...
} // libcis_ns_concepts_concepts_object_regular_e04c43ac (libcis)
