// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_object_regular).
...
namespace libcis_ns_concepts_concepts_object_regular { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_concepts_concepts_object_regular; // libcis
