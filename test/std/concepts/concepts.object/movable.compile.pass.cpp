// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_object_movable).
...
// Movable types
namespace libcis_ns_concepts_concepts_object_movable { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_concepts_concepts_object_movable; // libcis
