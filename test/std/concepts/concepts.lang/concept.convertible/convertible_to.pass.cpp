// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_convertible_convertible_to_7d4e970c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concept_convertible_convertible_to_7d4e970c { // libcis
namespace {
...
} // libcis_ns_concepts_concepts_lang_concept_convertible_convertible_to_7d4e970c (libcis)
