// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_convertible_convertible_to).
// main -> test_concepts_concepts_lang_concept_convertible_convertible_to; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concept_convertible_convertible_to { // libcis: isolate file-scope helpers
using Function = void();
...
} using namespace libcis_ns_concepts_concepts_lang_concept_convertible_convertible_to; // libcis


void test_concepts_concepts_lang_concept_convertible_convertible_to() {
  // void
