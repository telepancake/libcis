// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_swappable_swappable).
// main -> test_concepts_concepts_lang_concept_swappable_swappable; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concept_swappable_swappable { // libcis: isolate file-scope helpers
template <class T>
struct expected {
  T x;
  T y;
...
} using namespace libcis_ns_concepts_concepts_lang_concept_swappable_swappable; // libcis
...
void test_concepts_concepts_lang_concept_swappable_swappable() {
  {
