// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_swappable_swappable_03054c1a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concept_swappable_swappable_03054c1a { // libcis
template <class T>
struct expected {
  T x;
  T y;
...
} // libcis_ns_concepts_concepts_lang_concept_swappable_swappable_03054c1a (libcis)
