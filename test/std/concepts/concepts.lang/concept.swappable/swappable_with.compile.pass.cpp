// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_swappable_swappable_with_fb983dab).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concept_swappable_swappable_with_fb983dab { // libcis
template <class T, class U>
...
} // libcis_ns_concepts_concepts_lang_concept_swappable_swappable_with_fb983dab (libcis)
 // namespace LWG3175
