// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_swappable_swappable_with).
...
namespace libcis_ns_concepts_concepts_lang_concept_swappable_swappable_with { // libcis: isolate file-scope helpers
template <class T, class U>
...
} using namespace libcis_ns_concepts_concepts_lang_concept_swappable_swappable_with; // libcis
