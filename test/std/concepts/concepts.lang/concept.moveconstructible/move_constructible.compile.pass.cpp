// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_moveconstructible_move_constructible).
...
namespace libcis_ns_concepts_concepts_lang_concept_moveconstructible_move_constructible { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_concepts_concepts_lang_concept_moveconstructible_move_constructible; // libcis
