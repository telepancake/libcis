// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_derived_derived_from).
// main -> test_concepts_concepts_lang_concept_derived_derived_from; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concept_derived_derived_from { // libcis: isolate file-scope helpers
struct Base1 {};
...
} using namespace libcis_ns_concepts_concepts_lang_concept_derived_derived_from; // libcis


void test_concepts_concepts_lang_concept_derived_derived_from() {
