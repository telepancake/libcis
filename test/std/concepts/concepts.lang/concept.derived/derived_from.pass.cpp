// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_derived_derived_from_c1525478).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concept_derived_derived_from_c1525478 { // libcis
struct Base1 {};
...
} // libcis_ns_concepts_concepts_lang_concept_derived_derived_from_c1525478 (libcis)
