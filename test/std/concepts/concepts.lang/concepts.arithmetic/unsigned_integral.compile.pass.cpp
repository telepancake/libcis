// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concepts_arithmetic_unsigned_integral_ab6d05a8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concepts_arithmetic_unsigned_integral_ab6d05a8 { // libcis
template <typename T>
...
} // libcis_ns_concepts_concepts_lang_concepts_arithmetic_unsigned_integral_ab6d05a8 (libcis)
