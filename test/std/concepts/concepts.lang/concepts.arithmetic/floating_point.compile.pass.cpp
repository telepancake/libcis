// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concepts_arithmetic_floating_point).
...
namespace libcis_ns_concepts_concepts_lang_concepts_arithmetic_floating_point { // libcis: isolate file-scope helpers
template <typename T>
...
static_assert(!CheckFloatingPointQualifiers<int (EmptyStruct::*)()>());
} using namespace libcis_ns_concepts_concepts_lang_concepts_arithmetic_floating_point; // libcis
