// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concepts_arithmetic_floating_point_b6ce82df).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concepts_arithmetic_floating_point_b6ce82df { // libcis
template <typename T>
...
static_assert(!CheckFloatingPointQualifiers<int (EmptyStruct::*)()>());
} // libcis_ns_concepts_concepts_lang_concepts_arithmetic_floating_point_b6ce82df (libcis)
