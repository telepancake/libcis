// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concepts_arithmetic_signed_integral_006cf5ef).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concepts_arithmetic_signed_integral_006cf5ef { // libcis
template <typename T>
...
} // libcis_ns_concepts_concepts_lang_concepts_arithmetic_signed_integral_006cf5ef (libcis)
