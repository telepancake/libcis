// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concepts_arithmetic_signed_integral).
...
namespace libcis_ns_concepts_concepts_lang_concepts_arithmetic_signed_integral { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_concepts_concepts_lang_concepts_arithmetic_signed_integral; // libcis
