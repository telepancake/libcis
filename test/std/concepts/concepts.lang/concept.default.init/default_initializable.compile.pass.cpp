// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_default_init_default_initializable_4a554041).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concept_default_init_default_initializable_4a554041 { // libcis
struct Empty {};
...
} // libcis_ns_concepts_concepts_lang_concept_default_init_default_initializable_4a554041 (libcis)
