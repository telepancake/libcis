// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_default_init_default_initializable).
...
namespace libcis_ns_concepts_concepts_lang_concept_default_init_default_initializable { // libcis: isolate file-scope helpers
struct Empty {};
...
} using namespace libcis_ns_concepts_concepts_lang_concept_default_init_default_initializable; // libcis
