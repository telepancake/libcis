// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_common_common_with).
...
namespace libcis_ns_concepts_concepts_lang_concept_common_common_with { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_concepts_concepts_lang_concept_common_common_with; // libcis
