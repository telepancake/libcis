// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_same_same_as).
// main -> test_concepts_concepts_lang_concept_same_same_as; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concept_same_same_as { // libcis: isolate file-scope helpers
struct S1 {};
struct S2 {
  int i;
...
} using namespace libcis_ns_concepts_concepts_lang_concept_same_same_as; // libcis


void test_concepts_concepts_lang_concept_same_same_as() {
