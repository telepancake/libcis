// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_same_same_as_7c25a1fe).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concept_same_same_as_7c25a1fe { // libcis
struct S1 {};
struct S2 {
  int i;
...
} // libcis_ns_concepts_concepts_lang_concept_same_same_as_7c25a1fe (libcis)
