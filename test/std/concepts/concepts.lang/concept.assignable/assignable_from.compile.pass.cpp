// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_assignable_assignable_from_82ced9e8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concept_assignable_assignable_from_82ced9e8 { // libcis
struct NoCommonRef {
...
} // libcis_ns_concepts_concepts_lang_concept_assignable_assignable_from_82ced9e8 (libcis)
