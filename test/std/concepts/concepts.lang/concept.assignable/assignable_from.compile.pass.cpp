// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_assignable_assignable_from).
...
namespace libcis_ns_concepts_concepts_lang_concept_assignable_assignable_from { // libcis: isolate file-scope helpers
struct NoCommonRef {
...
} using namespace libcis_ns_concepts_concepts_lang_concept_assignable_assignable_from; // libcis
