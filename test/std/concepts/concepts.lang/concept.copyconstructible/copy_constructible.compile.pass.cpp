// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_copyconstructible_copy_constructible_0133b8e6).
//===----------------------------------------------------------------------===//
//
...
// too.
namespace libcis_ns_concepts_concepts_lang_concept_copyconstructible_copy_constructible_0133b8e6 { // libcis
...
} // libcis_ns_concepts_concepts_lang_concept_copyconstructible_copy_constructible_0133b8e6 (libcis)
 // namespace CopyConstructibleTests
