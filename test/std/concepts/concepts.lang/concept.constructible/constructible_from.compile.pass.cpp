// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_constructible_constructible_from_3a841843).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_lang_concept_constructible_constructible_from_3a841843 { // libcis
struct Empty {};
...
} // libcis_ns_concepts_concepts_lang_concept_constructible_constructible_from_3a841843 (libcis)
