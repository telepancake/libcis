// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_constructible_constructible_from).
...
namespace libcis_ns_concepts_concepts_lang_concept_constructible_constructible_from { // libcis: isolate file-scope helpers
struct Empty {};
...
} using namespace libcis_ns_concepts_concepts_lang_concept_constructible_constructible_from; // libcis
