// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_lang_concept_commonref_common_reference).
...
namespace libcis_ns_concepts_concepts_lang_concept_commonref_common_reference { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_concepts_concepts_lang_concept_commonref_common_reference; // libcis
