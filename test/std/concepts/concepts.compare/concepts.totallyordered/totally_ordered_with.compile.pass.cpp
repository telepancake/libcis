// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_compare_concepts_totallyordered_totally_ordered_with_d606273c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_compare_concepts_totallyordered_totally_ordered_with_d606273c { // libcis
...
} // libcis_ns_concepts_concepts_compare_concepts_totallyordered_totally_ordered_with_d606273c (libcis)
 // namespace types_fit_for_purpose
