// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_compare_concepts_totallyordered_totally_ordered).
...
namespace libcis_ns_concepts_concepts_compare_concepts_totallyordered_totally_ordered { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_concepts_concepts_compare_concepts_totallyordered_totally_ordered; // libcis
