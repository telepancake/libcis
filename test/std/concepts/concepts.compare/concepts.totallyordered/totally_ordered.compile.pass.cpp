// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_compare_concepts_totallyordered_totally_ordered_fa732592).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_compare_concepts_totallyordered_totally_ordered_fa732592 { // libcis
...
} // libcis_ns_concepts_concepts_compare_concepts_totallyordered_totally_ordered_fa732592 (libcis)
 // namespace types_fit_for_purpose
