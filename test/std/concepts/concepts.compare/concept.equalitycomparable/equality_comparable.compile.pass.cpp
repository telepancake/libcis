// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_compare_concept_equalitycomparable_equality_comparable_a504bc2c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_compare_concept_equalitycomparable_equality_comparable_a504bc2c { // libcis
...
} // libcis_ns_concepts_concepts_compare_concept_equalitycomparable_equality_comparable_a504bc2c (libcis)
 // namespace types_fit_for_purpose
