// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_compare_concept_equalitycomparable_equality_comparable_with_e08bbeb4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_compare_concept_equalitycomparable_equality_comparable_with_e08bbeb4 { // libcis
template <class T, class U>
...
} // libcis_ns_concepts_concepts_compare_concept_equalitycomparable_equality_comparable_with_e08bbeb4 (libcis)
 // namespace types_fit_for_purpose
