// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_callable_concept_relation_relation_subsumption_2d41247b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_callable_concept_relation_relation_subsumption_2d41247b { // libcis
struct S1 {};
struct S2 {};
...
} // libcis_ns_concepts_concepts_callable_concept_relation_relation_subsumption_2d41247b (libcis)
