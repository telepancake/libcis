// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_callable_concept_relation_relation_subsumption).
...
namespace libcis_ns_concepts_concepts_callable_concept_relation_relation_subsumption { // libcis: isolate file-scope helpers
struct S1 {};
struct S2 {};
...
} using namespace libcis_ns_concepts_concepts_callable_concept_relation_relation_subsumption; // libcis
