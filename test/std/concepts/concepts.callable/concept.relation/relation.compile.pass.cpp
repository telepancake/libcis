// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_callable_concept_relation_relation).
...
namespace libcis_ns_concepts_concepts_callable_concept_relation_relation { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_concepts_concepts_callable_concept_relation_relation; // libcis
