// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_callable_concept_relation_relation_87eefc46).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_callable_concept_relation_relation_87eefc46 { // libcis
...
} // libcis_ns_concepts_concepts_callable_concept_relation_relation_87eefc46 (libcis)
