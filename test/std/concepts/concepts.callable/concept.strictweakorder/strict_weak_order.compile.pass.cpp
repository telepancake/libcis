// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_callable_concept_strictweakorder_strict_weak_order_a20ede9e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_callable_concept_strictweakorder_strict_weak_order_a20ede9e { // libcis
...
} // libcis_ns_concepts_concepts_callable_concept_strictweakorder_strict_weak_order_a20ede9e (libcis)
