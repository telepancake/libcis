// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_callable_concept_strictweakorder_strict_weak_order).
...
namespace libcis_ns_concepts_concepts_callable_concept_strictweakorder_strict_weak_order { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_concepts_concepts_callable_concept_strictweakorder_strict_weak_order; // libcis
