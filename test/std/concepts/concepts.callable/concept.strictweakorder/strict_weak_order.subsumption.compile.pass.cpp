// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_callable_concept_strictweakorder_strict_weak_order_subsumption_6487b78d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_callable_concept_strictweakorder_strict_weak_order_subsumption_6487b78d { // libcis
struct S1 {};
struct S2 {};
...
} // libcis_ns_concepts_concepts_callable_concept_strictweakorder_strict_weak_order_subsumption_6487b78d (libcis)
