// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_callable_concept_predicate_predicate).
// no entry point (compile-only); all file-scope decls isolated in anon namespace.
namespace libcis_ns_concepts_concepts_callable_concept_predicate_predicate { // libcis: isolate file-scope helpers
//===----------------------------------------------------------------------===//
//
...
} using namespace libcis_ns_concepts_concepts_callable_concept_predicate_predicate; // libcis
