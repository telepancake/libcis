// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_callable_concept_invocable_invocable_3982477f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_callable_concept_invocable_invocable_3982477f { // libcis
...
} // libcis_ns_concepts_concepts_callable_concept_invocable_invocable_3982477f (libcis)
