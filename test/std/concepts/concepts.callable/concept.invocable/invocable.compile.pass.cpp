// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_callable_concept_invocable_invocable).
...
namespace libcis_ns_concepts_concepts_callable_concept_invocable_invocable { // libcis: isolate file-scope helpers
...
static_assert(!std::invocable<int&>);
static_assert(!std::invocable<int&&>);
} using namespace libcis_ns_concepts_concepts_callable_concept_invocable_invocable; // libcis
