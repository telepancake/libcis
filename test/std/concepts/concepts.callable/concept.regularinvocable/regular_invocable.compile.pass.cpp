// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_callable_concept_regularinvocable_regular_invocable).
...
namespace libcis_ns_concepts_concepts_callable_concept_regularinvocable_regular_invocable { // libcis: isolate file-scope helpers
...
static_assert(!std::regular_invocable<int&>);
static_assert(!std::regular_invocable<int&&>);
} using namespace libcis_ns_concepts_concepts_callable_concept_regularinvocable_regular_invocable; // libcis
