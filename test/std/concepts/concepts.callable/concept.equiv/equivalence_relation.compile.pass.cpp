// AST-transferred from libc++ by tools/transfer.py (slug=concepts_concepts_callable_concept_equiv_equivalence_relation).
...
namespace libcis_ns_concepts_concepts_callable_concept_equiv_equivalence_relation { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_concepts_concepts_callable_concept_equiv_equivalence_relation; // libcis
