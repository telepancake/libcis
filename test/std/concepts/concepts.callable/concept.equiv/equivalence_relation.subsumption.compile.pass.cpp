// transferred+adapted from libc++ by tools/transfer.py (slug=concepts_concepts_callable_concept_equiv_equivalence_relation_subsumption_f577df25).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_concepts_concepts_callable_concept_equiv_equivalence_relation_subsumption_f577df25 { // libcis
struct S1 {};
struct S2 {};
...
} // libcis_ns_concepts_concepts_callable_concept_equiv_equivalence_relation_subsumption_f577df25 (libcis)
