// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_minus_iter_93620251).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_minus_iter_93620251 { // libcis
template <class It>
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_minus_iter_93620251 (libcis)
