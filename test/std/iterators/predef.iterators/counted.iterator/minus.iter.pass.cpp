// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_minus_iter).
// main -> test_iterators_predef_iterators_counted_iterator_minus_iter; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_minus_iter { // libcis: isolate file-scope helpers
template <class It>
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_minus_iter; // libcis


void test_iterators_predef_iterators_counted_iterator_minus_iter() {
  test();
  static_assert(test());
