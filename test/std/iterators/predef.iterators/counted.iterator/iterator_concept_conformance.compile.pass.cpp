// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_iterator_concept_conformance_b1e7b586).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_iterator_concept_conformance_b1e7b586 { // libcis
void test() {
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_iterator_concept_conformance_b1e7b586 (libcis)
