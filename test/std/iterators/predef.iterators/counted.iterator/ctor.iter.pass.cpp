// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_ctor_iter_b9665b4b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_ctor_iter_b9665b4b { // libcis
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_ctor_iter_b9665b4b (libcis)
