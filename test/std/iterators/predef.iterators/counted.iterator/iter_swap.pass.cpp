// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_iter_swap_4510c41a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_iter_swap_4510c41a { // libcis
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_iter_swap_4510c41a (libcis)
