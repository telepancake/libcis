// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_iter_swap).
// main -> test_iterators_predef_iterators_counted_iterator_iter_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_iter_swap { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_iter_swap; // libcis


void test_iterators_predef_iterators_counted_iterator_iter_swap() {
  test();
  static_assert(test());
