// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_subscript_0c401a69).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_subscript_0c401a69 { // libcis
template<class Iter>
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_subscript_0c401a69 (libcis)
