// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_plus_e81b0232).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_plus_e81b0232 { // libcis
template<class Iter>
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_plus_e81b0232 (libcis)
