// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_plus).
// main -> test_iterators_predef_iterators_counted_iterator_plus; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_plus { // libcis: isolate file-scope helpers
template<class Iter>
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_plus; // libcis


void test_iterators_predef_iterators_counted_iterator_plus() {
  test();
  static_assert(test());
