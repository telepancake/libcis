// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_deref_358a817c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_deref_358a817c { // libcis
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_deref_358a817c (libcis)
