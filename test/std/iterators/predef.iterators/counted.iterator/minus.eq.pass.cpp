// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_minus_eq_800785e3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_minus_eq_800785e3 { // libcis
template<class Iter>
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_minus_eq_800785e3 (libcis)
