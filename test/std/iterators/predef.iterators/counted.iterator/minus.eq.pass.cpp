// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_minus_eq).
// main -> test_iterators_predef_iterators_counted_iterator_minus_eq; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_minus_eq { // libcis: isolate file-scope helpers
template<class Iter>
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_minus_eq; // libcis


void test_iterators_predef_iterators_counted_iterator_minus_eq() {
  test();
  static_assert(test());
