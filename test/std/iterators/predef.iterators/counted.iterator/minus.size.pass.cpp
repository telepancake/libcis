// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_minus_size_d6c91f08).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_minus_size_d6c91f08 { // libcis
template<class Iter>
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_minus_size_d6c91f08 (libcis)
