// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_minus_size).
// main -> test_iterators_predef_iterators_counted_iterator_minus_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_minus_size { // libcis: isolate file-scope helpers
template<class Iter>
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_minus_size; // libcis


void test_iterators_predef_iterators_counted_iterator_minus_size() {
  test();
  static_assert(test());
