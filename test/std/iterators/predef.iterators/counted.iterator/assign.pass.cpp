// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_assign_0634578a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_assign_0634578a { // libcis
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_assign_0634578a (libcis)
