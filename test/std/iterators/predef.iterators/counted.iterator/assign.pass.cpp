// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_assign).
// main -> test_iterators_predef_iterators_counted_iterator_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_assign { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_assign; // libcis


void test_iterators_predef_iterators_counted_iterator_assign() {
  test();
  static_assert(test());
