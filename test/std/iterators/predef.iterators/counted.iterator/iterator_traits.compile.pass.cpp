// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_iterator_traits_fd811f62).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_iterator_traits_fd811f62 { // libcis
void test() {
  {
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_iterator_traits_fd811f62 (libcis)
