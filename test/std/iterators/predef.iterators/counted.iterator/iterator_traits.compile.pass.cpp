// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_iterator_traits).
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_iterator_traits { // libcis: isolate file-scope helpers
void test() {
  {
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_iterator_traits; // libcis
