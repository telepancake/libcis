// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_minus_default_sentinel_f81d8b0d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_minus_default_sentinel_f81d8b0d { // libcis
constexpr bool test() {
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_minus_default_sentinel_f81d8b0d (libcis)
