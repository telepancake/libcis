// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_minus_default_sentinel).
// main -> test_iterators_predef_iterators_counted_iterator_minus_default_sentinel; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_minus_default_sentinel { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_minus_default_sentinel; // libcis


void test_iterators_predef_iterators_counted_iterator_minus_default_sentinel() {
  test();
  static_assert(test());
