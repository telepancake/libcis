// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_iter_move_616b6cc3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_iter_move_616b6cc3 { // libcis
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_iter_move_616b6cc3 (libcis)
