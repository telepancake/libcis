// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_three_way_compare).
// main -> test_iterators_predef_iterators_counted_iterator_three_way_compare; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_three_way_compare { // libcis: isolate file-scope helpers
template <class It>
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_three_way_compare; // libcis


void test_iterators_predef_iterators_counted_iterator_three_way_compare() {
  test();
  static_assert(test());
