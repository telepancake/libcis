// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_increment).
// main -> test_iterators_predef_iterators_counted_iterator_increment; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_increment { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_increment; // libcis


void test_iterators_predef_iterators_counted_iterator_increment() {
  test();
  static_assert(test());
