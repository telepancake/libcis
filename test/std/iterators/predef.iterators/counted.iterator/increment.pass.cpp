// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_increment_72cd450b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_increment_72cd450b { // libcis
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_increment_72cd450b (libcis)
