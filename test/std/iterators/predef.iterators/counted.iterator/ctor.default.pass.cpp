// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_ctor_default_547141b4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_ctor_default_547141b4 { // libcis
constexpr bool test() {
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_ctor_default_547141b4 (libcis)
