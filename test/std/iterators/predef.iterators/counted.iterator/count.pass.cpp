// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_count).
// main -> test_iterators_predef_iterators_counted_iterator_count; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_count { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_count; // libcis


void test_iterators_predef_iterators_counted_iterator_count() {
  test();
  static_assert(test());
