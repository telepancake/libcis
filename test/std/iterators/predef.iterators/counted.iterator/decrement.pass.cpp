// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_decrement).
// main -> test_iterators_predef_iterators_counted_iterator_decrement; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_decrement { // libcis: isolate file-scope helpers
template<class Iter>
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_decrement; // libcis


void test_iterators_predef_iterators_counted_iterator_decrement() {
  test();
  static_assert(test());
