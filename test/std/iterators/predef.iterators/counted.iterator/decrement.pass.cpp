// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_decrement_85a0095d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_decrement_85a0095d { // libcis
template<class Iter>
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_decrement_85a0095d (libcis)
