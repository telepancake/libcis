// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_ctor_conv_abfd3e45).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_ctor_conv_abfd3e45 { // libcis
template<class T>
class ConvertibleTo
{
    int *it_;
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_ctor_conv_abfd3e45 (libcis)
