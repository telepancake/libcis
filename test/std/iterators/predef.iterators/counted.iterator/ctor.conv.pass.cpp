// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_ctor_conv).
// main -> test_iterators_predef_iterators_counted_iterator_ctor_conv; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_ctor_conv { // libcis: isolate file-scope helpers
template<class T>
class ConvertibleTo
{
    int *it_;
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_ctor_conv; // libcis


void test_iterators_predef_iterators_counted_iterator_ctor_conv() {
  test();
  static_assert(test());
