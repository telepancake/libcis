// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_compare_86545780).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_counted_iterator_compare_86545780 { // libcis
template <class It>
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_compare_86545780 (libcis)
