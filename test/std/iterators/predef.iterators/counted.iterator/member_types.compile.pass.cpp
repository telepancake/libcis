// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_member_types).
...
// No value_type.
namespace libcis_ns_iterators_predef_iterators_counted_iterator_member_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_predef_iterators_counted_iterator_member_types; // libcis
