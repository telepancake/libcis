// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_counted_iterator_member_types_b6059569).
//===----------------------------------------------------------------------===//
//
...
// No value_type.
namespace libcis_ns_iterators_predef_iterators_counted_iterator_member_types_b6059569 { // libcis
...
} // libcis_ns_iterators_predef_iterators_counted_iterator_member_types_b6059569 (libcis)
