// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_insert_iterators_insert_iterator_cxx20_iter_member_91f110ce).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_insert_iterators_insert_iterator_cxx20_iter_member_91f110ce { // libcis
...
} // libcis_ns_iterators_predef_iterators_insert_iterators_insert_iterator_cxx20_iter_member_91f110ce (libcis)
