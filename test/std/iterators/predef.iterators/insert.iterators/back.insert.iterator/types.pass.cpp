// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_insert_iterators_back_insert_iterator_types).
// main -> test_iterators_predef_iterators_insert_iterators_back_insert_iterator_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_insert_iterators_back_insert_iterator_types { // libcis: isolate file-scope helpers
template <class C>
...
} using namespace libcis_ns_iterators_predef_iterators_insert_iterators_back_insert_iterator_types; // libcis


void test_iterators_predef_iterators_insert_iterators_back_insert_iterator_types()
{
    test<std::vector<int> >();
