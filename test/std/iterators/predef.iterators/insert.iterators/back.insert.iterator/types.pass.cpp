// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_insert_iterators_back_insert_iterator_types_1575fa59).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_insert_iterators_back_insert_iterator_types_1575fa59 { // libcis
template <class C>
...
} // libcis_ns_iterators_predef_iterators_insert_iterators_back_insert_iterator_types_1575fa59 (libcis)
