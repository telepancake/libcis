// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_insert_iterators_front_insert_iterator_types_52a02ff4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_insert_iterators_front_insert_iterator_types_52a02ff4 { // libcis
template <class C>
...
} // libcis_ns_iterators_predef_iterators_insert_iterators_front_insert_iterator_types_52a02ff4 (libcis)
