// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_insert_iterators_insert_iter_ops_insert_iter_op_rv_value).
// main -> test_iterators_predef_iterators_insert_iterators_insert_iter_ops_insert_iter_op_rv_value; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_insert_iterators_insert_iter_ops_insert_iter_op_rv_value { // libcis: isolate file-scope helpers
template <class C>
void
...
} using namespace libcis_ns_iterators_predef_iterators_insert_iterators_insert_iter_ops_insert_iter_op_rv_value; // libcis


void test_iterators_predef_iterators_insert_iterators_insert_iter_ops_insert_iter_op_rv_value()
{
    {
