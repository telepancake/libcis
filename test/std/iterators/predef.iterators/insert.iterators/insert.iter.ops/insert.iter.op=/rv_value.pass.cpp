// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_insert_iterators_insert_iter_ops_insert_iter_op_rv_value_8850cb3c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_insert_iterators_insert_iter_ops_insert_iter_op_rv_value_8850cb3c { // libcis
template <class C>
void
...
} // libcis_ns_iterators_predef_iterators_insert_iterators_insert_iter_ops_insert_iter_op_rv_value_8850cb3c (libcis)
