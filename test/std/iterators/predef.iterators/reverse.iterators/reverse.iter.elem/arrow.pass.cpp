// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow_ac000e51).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow_ac000e51 { // libcis
#if TEST_STD_VER >= 20
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow_ac000e51 (libcis)
