// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow).
// main -> test_iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow { // libcis: isolate file-scope helpers
template <class It>
...
TEST_CONSTEXPR  C gC;
} using namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow; // libcis


void test_iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow()
{
  A a;
  test(&a+1, A());
