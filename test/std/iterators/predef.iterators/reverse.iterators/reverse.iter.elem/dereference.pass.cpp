// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_elem_dereference_85b5b906).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_elem_dereference_85b5b906 { // libcis
class A
{
    int data_;
public:
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_elem_dereference_85b5b906 (libcis)
