// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow_sfinae_655a33d1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow_sfinae_655a33d1 { // libcis
template <class T>
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow_sfinae_655a33d1 (libcis)
