// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow_sfinae).
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow_sfinae { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_elem_arrow_sfinae; // libcis
