// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_iterator_concept_conformance_feb6526d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_iterator_concept_conformance_feb6526d { // libcis
template<class I1>
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_iterator_concept_conformance_feb6526d (libcis)
