// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_iterator_concept_conformance).
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_iterator_concept_conformance { // libcis: isolate file-scope helpers
template<class I1>
...
} using namespace libcis_ns_iterators_predef_iterators_reverse_iterators_iterator_concept_conformance; // libcis
