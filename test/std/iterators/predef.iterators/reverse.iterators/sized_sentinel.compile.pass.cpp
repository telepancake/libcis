// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_sized_sentinel_8b50a071).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_sized_sentinel_8b50a071 { // libcis
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_sized_sentinel_8b50a071 (libcis)
