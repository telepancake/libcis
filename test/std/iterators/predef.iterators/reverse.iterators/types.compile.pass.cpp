// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_types).
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_types { // libcis: isolate file-scope helpers
template <class It>
struct find_current
...
} using namespace libcis_ns_iterators_predef_iterators_reverse_iterators_types; // libcis
