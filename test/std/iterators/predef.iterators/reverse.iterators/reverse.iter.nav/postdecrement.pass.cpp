// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_nav_postdecrement_94e0e568).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_nav_postdecrement_94e0e568 { // libcis
template <class It>
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_nav_postdecrement_94e0e568 (libcis)
