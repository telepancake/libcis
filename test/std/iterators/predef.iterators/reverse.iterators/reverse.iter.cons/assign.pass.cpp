// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_cons_assign_d82c68a9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cons_assign_d82c68a9 { // libcis
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cons_assign_d82c68a9 (libcis)
