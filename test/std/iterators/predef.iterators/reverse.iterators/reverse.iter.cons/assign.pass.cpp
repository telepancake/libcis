// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_cons_assign).
// main -> test_iterators_predef_iterators_reverse_iterators_reverse_iter_cons_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cons_assign { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cons_assign; // libcis


void test_iterators_predef_iterators_reverse_iterators_reverse_iter_cons_assign() {
    tests();
#if TEST_STD_VER > 14
    static_assert(tests(), "");
#endif
