// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_nonmember_iter_swap_226ab510).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_nonmember_iter_swap_226ab510 { // libcis
constexpr bool test() {
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_nonmember_iter_swap_226ab510 (libcis)
