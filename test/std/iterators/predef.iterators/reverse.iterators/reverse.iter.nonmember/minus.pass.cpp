// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_nonmember_minus_b99716ba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_nonmember_minus_b99716ba { // libcis
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_nonmember_minus_b99716ba (libcis)
