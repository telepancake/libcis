// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_nonmember_iter_move).
// main -> test_iterators_predef_iterators_reverse_iterators_reverse_iter_nonmember_iter_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_nonmember_iter_move { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_nonmember_iter_move; // libcis


void test_iterators_predef_iterators_reverse_iterators_reverse_iter_nonmember_iter_move() {
  test();
  static_assert(test());
