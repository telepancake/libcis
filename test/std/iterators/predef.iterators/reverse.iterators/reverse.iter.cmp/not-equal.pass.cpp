// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_not_equal_bfda62fd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_not_equal_bfda62fd { // libcis
template <class It>
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_not_equal_bfda62fd (libcis)
