// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_three_way_7ebf41c8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_three_way_7ebf41c8 { // libcis
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_three_way_7ebf41c8 (libcis)
