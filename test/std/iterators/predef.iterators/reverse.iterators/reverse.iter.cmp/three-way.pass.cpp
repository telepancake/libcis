// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_three_way).
// main -> test_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_three_way; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_three_way { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_three_way; // libcis


void test_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_three_way() {
    tests();
    static_assert(tests());
    return;
}
