// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_greater_equal_fb9438e8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_greater_equal_fb9438e8 { // libcis
template <class It>
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_greater_equal_fb9438e8 (libcis)
