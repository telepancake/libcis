// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_less_7e7653f5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_less_7e7653f5 { // libcis
template <class It>
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_less_7e7653f5 (libcis)
