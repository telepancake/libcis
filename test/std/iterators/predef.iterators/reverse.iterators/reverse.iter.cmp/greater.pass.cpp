// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_greater_18201f88).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_greater_18201f88 { // libcis
template <class It>
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_greater_18201f88 (libcis)
