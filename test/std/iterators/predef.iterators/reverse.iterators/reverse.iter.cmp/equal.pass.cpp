// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_equal).
// main -> test_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_equal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_equal { // libcis: isolate file-scope helpers
template <class It>
...
} using namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_equal; // libcis


void test_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_equal() {
    tests();
#if TEST_STD_VER > 14
    static_assert(tests(), "");
#endif
