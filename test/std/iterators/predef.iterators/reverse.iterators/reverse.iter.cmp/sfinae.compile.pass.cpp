// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_sfinae).
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_sfinae { // libcis: isolate file-scope helpers
struct IterBase {
...
} using namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_sfinae; // libcis
