// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_sfinae_62c45263).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_sfinae_62c45263 { // libcis
struct IterBase {
...
} // libcis_ns_iterators_predef_iterators_reverse_iterators_reverse_iter_cmp_sfinae_62c45263 (libcis)
