// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_eq_ee057c6c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_eq_ee057c6c { // libcis
void test() {
...
} // libcis_ns_iterators_predef_iterators_iterators_common_eq_ee057c6c (libcis)
