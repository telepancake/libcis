// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_iter_move_faf3e0ef).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_iter_move_faf3e0ef { // libcis
struct IterMovingIt {
...
} // libcis_ns_iterators_predef_iterators_iterators_common_iter_move_faf3e0ef (libcis)
