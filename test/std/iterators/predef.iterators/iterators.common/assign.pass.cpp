// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_assign_efa1c6e9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_assign_efa1c6e9 { // libcis
void test() {
...
} // libcis_ns_iterators_predef_iterators_iterators_common_assign_efa1c6e9 (libcis)
