// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_assign).
// main -> test_iterators_predef_iterators_iterators_common_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_assign { // libcis: isolate file-scope helpers
void test() {
...
} using namespace libcis_ns_iterators_predef_iterators_iterators_common_assign; // libcis


void test_iterators_predef_iterators_iterators_common_assign() {
  test();
