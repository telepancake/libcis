// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_deref_60d5f7f7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_deref_60d5f7f7 { // libcis
void test() {
...
} // libcis_ns_iterators_predef_iterators_iterators_common_deref_60d5f7f7 (libcis)
