// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_deref).
// main -> test_iterators_predef_iterators_iterators_common_deref; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_deref { // libcis: isolate file-scope helpers
void test() {
...
} using namespace libcis_ns_iterators_predef_iterators_iterators_common_deref; // libcis


void test_iterators_predef_iterators_iterators_common_deref() {
  test();
