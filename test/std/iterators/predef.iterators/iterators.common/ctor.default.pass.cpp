// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_ctor_default_6045069b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_ctor_default_6045069b { // libcis
constexpr bool test()
{
  {
...
} // libcis_ns_iterators_predef_iterators_iterators_common_ctor_default_6045069b (libcis)
