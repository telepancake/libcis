// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_iterator_traits).
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_iterator_traits { // libcis: isolate file-scope helpers
template<class T>
...
} using namespace libcis_ns_iterators_predef_iterators_iterators_common_iterator_traits; // libcis
