// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_iterator_traits_b4375161).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_iterator_traits_b4375161 { // libcis
template<class T>
...
} // libcis_ns_iterators_predef_iterators_iterators_common_iterator_traits_b4375161 (libcis)
