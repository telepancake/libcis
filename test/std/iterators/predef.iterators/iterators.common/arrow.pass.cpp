// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_arrow).
// main -> test_iterators_predef_iterators_iterators_common_arrow; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_arrow { // libcis: isolate file-scope helpers
void test() {
...
} using namespace libcis_ns_iterators_predef_iterators_iterators_common_arrow; // libcis


void test_iterators_predef_iterators_iterators_common_arrow() {
  test();
