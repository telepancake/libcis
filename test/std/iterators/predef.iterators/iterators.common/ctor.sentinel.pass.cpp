// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_ctor_sentinel_013be2b5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_ctor_sentinel_013be2b5 { // libcis
template<class It>
constexpr bool test() {
...
} // libcis_ns_iterators_predef_iterators_iterators_common_ctor_sentinel_013be2b5 (libcis)
