// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_ctor_iter_1354624c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_ctor_iter_1354624c { // libcis
template<class It>
constexpr bool test() {
...
} // libcis_ns_iterators_predef_iterators_iterators_common_ctor_iter_1354624c (libcis)
