// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_ctor_converting_94f3e2ab).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_ctor_converting_94f3e2ab { // libcis
constexpr bool test()
{
  struct Base {};
  struct Derived : Base {};
...
} // libcis_ns_iterators_predef_iterators_iterators_common_ctor_converting_94f3e2ab (libcis)
