// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_minus_beb36f04).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_minus_beb36f04 { // libcis
void test() {
...
} // libcis_ns_iterators_predef_iterators_iterators_common_minus_beb36f04 (libcis)
