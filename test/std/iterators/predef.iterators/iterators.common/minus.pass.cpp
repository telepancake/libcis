// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_minus).
// main -> test_iterators_predef_iterators_iterators_common_minus; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_minus { // libcis: isolate file-scope helpers
void test() {
...
} using namespace libcis_ns_iterators_predef_iterators_iterators_common_minus; // libcis


void test_iterators_predef_iterators_iterators_common_minus() {
  test();
