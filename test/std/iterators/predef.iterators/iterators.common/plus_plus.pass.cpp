// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_plus_plus).
// main -> test_iterators_predef_iterators_iterators_common_plus_plus; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_plus_plus { // libcis: isolate file-scope helpers
struct Incomplete;
...
} using namespace libcis_ns_iterators_predef_iterators_iterators_common_plus_plus; // libcis


void test_iterators_predef_iterators_iterators_common_plus_plus() {
  test();
