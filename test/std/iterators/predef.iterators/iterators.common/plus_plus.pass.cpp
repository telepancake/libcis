// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_plus_plus_12975f5f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_plus_plus_12975f5f { // libcis
struct Incomplete;
...
} // libcis_ns_iterators_predef_iterators_iterators_common_plus_plus_12975f5f (libcis)
