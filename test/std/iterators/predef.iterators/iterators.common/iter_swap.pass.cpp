// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_iterators_common_iter_swap_c2770ed9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_iterators_common_iter_swap_c2770ed9 { // libcis
template<int K>
...
} // libcis_ns_iterators_predef_iterators_iterators_common_iter_swap_c2770ed9 (libcis)
