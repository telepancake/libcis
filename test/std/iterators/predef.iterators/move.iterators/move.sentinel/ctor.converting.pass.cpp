// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_sentinel_ctor_converting).
// main -> test_iterators_predef_iterators_move_iterators_move_sentinel_ctor_converting; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_ctor_converting { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_ctor_converting; // libcis


void test_iterators_predef_iterators_move_iterators_move_sentinel_ctor_converting()
{
  test();
  static_assert(test());
