// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_sentinel_concept_conformance).
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_concept_conformance { // libcis: isolate file-scope helpers
void test()
{
  // Pointer.
  {
...
} using namespace libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_concept_conformance; // libcis
