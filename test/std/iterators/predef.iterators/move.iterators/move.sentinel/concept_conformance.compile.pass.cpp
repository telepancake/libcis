// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_sentinel_concept_conformance_aaefb925).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_concept_conformance_aaefb925 { // libcis
void test()
{
  // Pointer.
  {
...
} // libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_concept_conformance_aaefb925 (libcis)
