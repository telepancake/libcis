// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_sentinel_ctor_sentinel_c3899161).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_ctor_sentinel_c3899161 { // libcis
constexpr bool test()
{
...
} // libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_ctor_sentinel_c3899161 (libcis)
