// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_sentinel_assign_converting_5fb88da1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_assign_converting_5fb88da1 { // libcis
...
} // libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_assign_converting_5fb88da1 (libcis)
