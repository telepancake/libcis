// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_sentinel_base).
// main -> test_iterators_predef_iterators_move_iterators_move_sentinel_base; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_base { // libcis: isolate file-scope helpers
constexpr bool test()
{
...
} using namespace libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_base; // libcis


void test_iterators_predef_iterators_move_iterators_move_sentinel_base()
{
  test();
  static_assert(test());
