// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_sentinel_base_90b10460).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_base_90b10460 { // libcis
constexpr bool test()
{
...
} // libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_base_90b10460 (libcis)
