// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_sentinel_op_eq_1490afb2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_op_eq_1490afb2 { // libcis
...
} // libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_op_eq_1490afb2 (libcis)
