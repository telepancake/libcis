// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_sentinel_op_eq).
// main -> test_iterators_predef_iterators_move_iterators_move_sentinel_op_eq; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_op_eq { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_predef_iterators_move_iterators_move_sentinel_op_eq; // libcis


void test_iterators_predef_iterators_move_iterators_move_sentinel_op_eq() {
  test();
  static_assert(test());
