// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_sentinel_b1618f91).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_sentinel_b1618f91 { // libcis
struct CustomIt {
...
} // libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_sentinel_b1618f91 (libcis)
