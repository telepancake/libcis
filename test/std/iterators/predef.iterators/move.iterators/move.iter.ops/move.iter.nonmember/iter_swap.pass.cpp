// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_nonmember_iter_swap_6afa7f60).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_nonmember_iter_swap_6afa7f60 { // libcis
...
} // libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_nonmember_iter_swap_6afa7f60 (libcis)
