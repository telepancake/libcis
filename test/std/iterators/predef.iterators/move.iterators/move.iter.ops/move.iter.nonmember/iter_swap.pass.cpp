// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_nonmember_iter_swap).
// main -> test_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_nonmember_iter_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_nonmember_iter_swap { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_nonmember_iter_swap; // libcis


void test_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_nonmember_iter_swap() {
  test();
  static_assert(test());
