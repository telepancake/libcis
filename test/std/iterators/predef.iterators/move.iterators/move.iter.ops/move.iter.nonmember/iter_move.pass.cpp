// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_nonmember_iter_move_0aacb4b8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_nonmember_iter_move_0aacb4b8 { // libcis
int global;
...
} // libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_nonmember_iter_move_0aacb4b8 (libcis)
