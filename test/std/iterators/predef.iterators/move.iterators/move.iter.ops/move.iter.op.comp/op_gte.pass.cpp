// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_comp_op_gte_d4e081f1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_comp_op_gte_d4e081f1 { // libcis
struct CustomIt {
...
} // libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_comp_op_gte_d4e081f1 (libcis)
