// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_incr_pre_cdb321a0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_incr_pre_cdb321a0 { // libcis
template <class It>
void
test(It i, It x)
{
...
} // libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_incr_pre_cdb321a0 (libcis)
