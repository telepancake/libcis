// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_incr_post).
// main -> test_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_incr_post; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER > 17
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_incr_post { // libcis: isolate file-scope helpers
template <class It>
...
} using namespace libcis_ns_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_incr_post; // libcis


void test_iterators_predef_iterators_move_iterators_move_iter_ops_move_iter_op_incr_post() {
  char s[] = "123";
#if TEST_STD_VER > 17
