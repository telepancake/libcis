// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_iterator_iterator_concept_conformance_510376fa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_iterator_iterator_concept_conformance_510376fa { // libcis
void test()
{
  {
...
} // libcis_ns_iterators_predef_iterators_move_iterators_move_iterator_iterator_concept_conformance_510376fa (libcis)
