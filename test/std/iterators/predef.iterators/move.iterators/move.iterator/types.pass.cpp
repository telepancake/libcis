// AST-transferred from libc++ by tools/transfer.py (slug=iterators_predef_iterators_move_iterators_move_iterator_types).
// main -> test_iterators_predef_iterators_move_iterators_move_iterator_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_predef_iterators_move_iterators_move_iterator_types { // libcis: isolate file-scope helpers
struct FooIter {
...
} using namespace libcis_ns_iterators_predef_iterators_move_iterators_move_iterator_types; // libcis
...
void test_iterators_predef_iterators_move_iterators_move_iterator_types() {
