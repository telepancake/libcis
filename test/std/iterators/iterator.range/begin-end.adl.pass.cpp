// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_range_begin_end_adl).
// main -> test_iterators_iterator_range_begin_end_adl; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_range_begin_end_adl { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_range_begin_end_adl; // libcis


void test_iterators_iterator_range_begin_end_adl() {
  test();
#if TEST_STD_VER >= 17
  static_assert(test());
#endif
