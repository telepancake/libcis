// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_range_begin_end_initializer_list).
// main -> test_iterators_iterator_range_begin_end_initializer_list; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_range_begin_end_initializer_list { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_range_begin_end_initializer_list; // libcis


void test_iterators_iterator_range_begin_end_initializer_list() {
  test();
#if TEST_STD_VER >= 17
  static_assert(test());
#endif
