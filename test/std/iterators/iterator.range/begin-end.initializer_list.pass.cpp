// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_range_begin_end_initializer_list_b49d69d1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_range_begin_end_initializer_list_b49d69d1 { // libcis
...
} // libcis_ns_iterators_iterator_range_begin_end_initializer_list_b49d69d1 (libcis)
