// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_range_begin_end_array).
// main -> test_iterators_iterator_range_begin_end_array; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_range_begin_end_array { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_range_begin_end_array; // libcis


void test_iterators_iterator_range_begin_end_array() {
  test();
  test_r();
#if TEST_STD_VER >= 14
  static_assert(test(), "");
