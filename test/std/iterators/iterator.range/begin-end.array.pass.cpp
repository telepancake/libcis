// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_range_begin_end_array_fafc0a09).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_range_begin_end_array_fafc0a09 { // libcis
...
} // libcis_ns_iterators_iterator_range_begin_end_array_fafc0a09 (libcis)
