// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_range_begin_end_container_6c98edbe).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_range_begin_end_container_6c98edbe { // libcis
template <typename C,
...
} // libcis_ns_iterators_iterator_range_begin_end_container_6c98edbe (libcis)
