// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_range_begin_end_container).
// main -> test_iterators_iterator_range_begin_end_container; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_range_begin_end_container { // libcis: isolate file-scope helpers
template <typename C,
...
} using namespace libcis_ns_iterators_iterator_range_begin_end_container; // libcis


void test_iterators_iterator_range_begin_end_container() {
