// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_alg_req_permutable_permutable_c01e16a7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_alg_req_permutable_permutable_c01e16a7 { // libcis
...
} // libcis_ns_iterators_iterator_requirements_alg_req_permutable_permutable_c01e16a7 (libcis)
