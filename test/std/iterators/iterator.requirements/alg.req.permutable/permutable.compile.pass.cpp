// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_alg_req_permutable_permutable).
...
namespace libcis_ns_iterators_iterator_requirements_alg_req_permutable_permutable { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_requirements_alg_req_permutable_permutable; // libcis
