// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_indirectcallable_indirectinvocable_indirect_strict_weak_order).
...
namespace libcis_ns_iterators_iterator_requirements_indirectcallable_indirectinvocable_indirect_strict_weak_order { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_requirements_indirectcallable_indirectinvocable_indirect_strict_weak_order; // libcis
