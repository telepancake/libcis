// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_indirectcallable_indirectinvocable_indirectly_unary_invocable_2ed19aea).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_indirectcallable_indirectinvocable_indirectly_unary_invocable_2ed19aea { // libcis
...
} // libcis_ns_iterators_iterator_requirements_indirectcallable_indirectinvocable_indirectly_unary_invocable_2ed19aea (libcis)
