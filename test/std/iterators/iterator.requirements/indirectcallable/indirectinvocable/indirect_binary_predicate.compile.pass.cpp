// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_indirectcallable_indirectinvocable_indirect_binary_predicate_7233cb26).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_indirectcallable_indirectinvocable_indirect_binary_predicate_7233cb26 { // libcis
...
} // libcis_ns_iterators_iterator_requirements_indirectcallable_indirectinvocable_indirect_binary_predicate_7233cb26 (libcis)
