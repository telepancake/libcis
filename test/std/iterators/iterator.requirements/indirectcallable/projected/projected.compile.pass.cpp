// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_indirectcallable_projected_projected).
...
namespace libcis_ns_iterators_iterator_requirements_indirectcallable_projected_projected { // libcis: isolate file-scope helpers
...
static_assert(!projectable<int*, void(int)>);
} using namespace libcis_ns_iterators_iterator_requirements_indirectcallable_projected_projected; // libcis
    // void(int) doesn't satisfy indirectly_regular_unary_invocable
