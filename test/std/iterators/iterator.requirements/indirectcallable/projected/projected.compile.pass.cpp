// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_indirectcallable_projected_projected_8a1c3326).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_indirectcallable_projected_projected_8a1c3326 { // libcis
...
} // libcis_ns_iterators_iterator_requirements_indirectcallable_projected_projected_8a1c3326 (libcis)
    // void(int) doesn't satisfy indirectly_regular_unary_invcable
