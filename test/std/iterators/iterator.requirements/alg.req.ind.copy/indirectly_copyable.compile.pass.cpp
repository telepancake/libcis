// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_alg_req_ind_copy_indirectly_copyable).
...
namespace libcis_ns_iterators_iterator_requirements_alg_req_ind_copy_indirectly_copyable { // libcis: isolate file-scope helpers
struct CopyOnly {
  CopyOnly() = default;
...
} using namespace libcis_ns_iterators_iterator_requirements_alg_req_ind_copy_indirectly_copyable; // libcis
