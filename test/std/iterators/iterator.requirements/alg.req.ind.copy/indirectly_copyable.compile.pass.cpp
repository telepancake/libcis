// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_alg_req_ind_copy_indirectly_copyable_c8d77f37).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_alg_req_ind_copy_indirectly_copyable_c8d77f37 { // libcis
struct CopyOnly {
  CopyOnly() = default;
...
} // libcis_ns_iterators_iterator_requirements_alg_req_ind_copy_indirectly_copyable_c8d77f37 (libcis)
