// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_alg_req_ind_swap_indirectly_swappable).
...
namespace libcis_ns_iterators_iterator_requirements_alg_req_ind_swap_indirectly_swappable { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_requirements_alg_req_ind_swap_indirectly_swappable; // libcis
