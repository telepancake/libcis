// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_alg_req_ind_swap_indirectly_swappable_c6e9a46f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_alg_req_ind_swap_indirectly_swappable_c6e9a46f { // libcis
...
} // libcis_ns_iterators_iterator_requirements_alg_req_ind_swap_indirectly_swappable_c6e9a46f (libcis)
