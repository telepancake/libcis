// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_alg_req_ind_move_indirectly_movable_storable).
...
namespace libcis_ns_iterators_iterator_requirements_alg_req_ind_move_indirectly_movable_storable { // libcis: isolate file-scope helpers
template <class T>
struct PointerTo {
  using value_type = T;
  T& operator*() const;
...
} using namespace libcis_ns_iterators_iterator_requirements_alg_req_ind_move_indirectly_movable_storable; // libcis
