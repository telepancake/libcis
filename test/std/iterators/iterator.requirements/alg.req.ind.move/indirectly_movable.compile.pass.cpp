// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_alg_req_ind_move_indirectly_movable).
...
namespace libcis_ns_iterators_iterator_requirements_alg_req_ind_move_indirectly_movable { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_requirements_alg_req_ind_move_indirectly_movable; // libcis
