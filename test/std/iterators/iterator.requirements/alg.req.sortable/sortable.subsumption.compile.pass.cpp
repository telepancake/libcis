// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_alg_req_sortable_sortable_subsumption_260645bd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_alg_req_sortable_sortable_subsumption_260645bd { // libcis
...
} // libcis_ns_iterators_iterator_requirements_alg_req_sortable_sortable_subsumption_260645bd (libcis)
