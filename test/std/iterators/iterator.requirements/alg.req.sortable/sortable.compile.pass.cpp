// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_alg_req_sortable_sortable_beea1dc9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_alg_req_sortable_sortable_beea1dc9 { // libcis
...
} // libcis_ns_iterators_iterator_requirements_alg_req_sortable_sortable_beea1dc9 (libcis)
