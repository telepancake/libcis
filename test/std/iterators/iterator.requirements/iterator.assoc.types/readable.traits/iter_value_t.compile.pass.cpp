// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_assoc_types_readable_traits_iter_value_t_abc81b4e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_iterator_assoc_types_readable_traits_iter_value_t_abc81b4e { // libcis
...
} // libcis_ns_iterators_iterator_requirements_iterator_assoc_types_readable_traits_iter_value_t_abc81b4e (libcis)
