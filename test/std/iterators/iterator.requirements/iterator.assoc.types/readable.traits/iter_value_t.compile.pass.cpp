// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_assoc_types_readable_traits_iter_value_t).
...
namespace libcis_ns_iterators_iterator_requirements_iterator_assoc_types_readable_traits_iter_value_t { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_requirements_iterator_assoc_types_readable_traits_iter_value_t; // libcis
