// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_assoc_types_readable_traits_indirectly_readable_traits).
...
namespace libcis_ns_iterators_iterator_requirements_iterator_assoc_types_readable_traits_indirectly_readable_traits { // libcis: isolate file-scope helpers
template <class T>
...
struct S2 {};
} using namespace libcis_ns_iterators_iterator_requirements_iterator_assoc_types_readable_traits_indirectly_readable_traits; // libcis
