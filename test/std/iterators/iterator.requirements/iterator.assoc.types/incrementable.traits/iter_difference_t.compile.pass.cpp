// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_assoc_types_incrementable_traits_iter_difference_t_40bf5aec).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_iterator_assoc_types_incrementable_traits_iter_difference_t_40bf5aec { // libcis
template <class T>
...
} // libcis_ns_iterators_iterator_requirements_iterator_assoc_types_incrementable_traits_iter_difference_t_40bf5aec (libcis)
