// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_assoc_types_incrementable_traits_iter_difference_t).
...
namespace libcis_ns_iterators_iterator_requirements_iterator_assoc_types_incrementable_traits_iter_difference_t { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_iterators_iterator_requirements_iterator_assoc_types_incrementable_traits_iter_difference_t; // libcis
