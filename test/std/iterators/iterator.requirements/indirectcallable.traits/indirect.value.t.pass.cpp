// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_indirectcallable_traits_indirect_value_t_b8d2dddb).
//===----------------------------------------------------------------------===//
//
...
TEST_CONSTEXPR_CXX23 namespace libcis_ns_iterators_iterator_requirements_indirectcallable_traits_indirect_value_t_b8d2dddb { // libcis
void test() {
...
} // libcis_ns_iterators_iterator_requirements_indirectcallable_traits_indirect_value_t_b8d2dddb (libcis)
