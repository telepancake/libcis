// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_indirectcallable_traits_indirect_value_t).
// main -> test_iterators_iterator_requirements_indirectcallable_traits_indirect_value_t; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_indirectcallable_traits_indirect_value_t { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_requirements_indirectcallable_traits_indirect_value_t; // libcis


void test_iterators_iterator_requirements_indirectcallable_traits_indirect_value_t() {
  test();
#if TEST_STD_VER >= 23
