// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_concepts_iterator_concept_readable_iter_common_reference_t).
...
namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_readable_iter_common_reference_t { // libcis: isolate file-scope helpers
struct X { };
...
} using namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_readable_iter_common_reference_t; // libcis
