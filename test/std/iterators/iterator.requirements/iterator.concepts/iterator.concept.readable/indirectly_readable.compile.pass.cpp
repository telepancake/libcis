// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_concepts_iterator_concept_readable_indirectly_readable).
...
namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_readable_indirectly_readable { // libcis: isolate file-scope helpers
template <class In>
...
} using namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_readable_indirectly_readable; // libcis
