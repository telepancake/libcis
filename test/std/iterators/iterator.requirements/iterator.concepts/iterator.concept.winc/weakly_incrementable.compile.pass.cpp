// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_concepts_iterator_concept_winc_weakly_incrementable_54d812eb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_winc_weakly_incrementable_54d812eb { // libcis
...
} // libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_winc_weakly_incrementable_54d812eb (libcis)
