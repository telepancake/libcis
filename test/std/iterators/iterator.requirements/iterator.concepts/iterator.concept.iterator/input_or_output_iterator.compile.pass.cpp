// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_concepts_iterator_concept_iterator_input_or_output_iterator).
...
namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_iterator_input_or_output_iterator { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_iterator_input_or_output_iterator; // libcis
