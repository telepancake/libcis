// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_concepts_iterator_concept_iterator_input_or_output_iterator_f3b47aaa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_iterator_input_or_output_iterator_f3b47aaa { // libcis
...
} // libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_iterator_input_or_output_iterator_f3b47aaa (libcis)
