// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_concepts_iterator_concept_output_output_iterator_7c4b3d86).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_output_output_iterator_7c4b3d86 { // libcis
struct T { };
...
} // libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_output_output_iterator_7c4b3d86 (libcis)
