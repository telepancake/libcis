// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_concepts_iterator_concept_inc_incrementable_2c0d9d57).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_inc_incrementable_2c0d9d57 { // libcis
...
} // libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_inc_incrementable_2c0d9d57 (libcis)
