// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_concepts_iterator_concept_random_access_random_access_iterator_cb635aab).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_random_access_random_access_iterator_cb635aab { // libcis
...
} // libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_random_access_random_access_iterator_cb635aab (libcis)
