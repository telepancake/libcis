// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_concepts_iterator_concept_sentinel_sized_sentinel_for).
...
namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_sentinel_sized_sentinel_for { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_sentinel_sized_sentinel_for; // libcis
