// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_concepts_iterator_concept_sentinel_sentinel_for_679e88d3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_sentinel_sentinel_for_679e88d3 { // libcis
...
} // libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_sentinel_sentinel_for_679e88d3 (libcis)
