// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_concepts_iterator_concept_writable_indirectly_writable_1da6e257).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_writable_indirectly_writable_1da6e257 { // libcis
...
static_assert(check_indirectly_writable<int**, int*>());
static_assert(!check_indirectly_writable<int**, int>());
} // libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_writable_indirectly_writable_1da6e257 (libcis)
