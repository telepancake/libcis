// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_concepts_iterator_concept_writable_indirectly_writable).
...
namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_writable_indirectly_writable { // libcis: isolate file-scope helpers
...
static_assert(check_indirectly_writable<int**, int*>());
static_assert(!check_indirectly_writable<int**, int>());
} using namespace libcis_ns_iterators_iterator_requirements_iterator_concepts_iterator_concept_writable_indirectly_writable; // libcis
