// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_alg_req_mergeable_mergeable_2fbddbe3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_alg_req_mergeable_mergeable_2fbddbe3 { // libcis
...
} // libcis_ns_iterators_iterator_requirements_alg_req_mergeable_mergeable_2fbddbe3 (libcis)
