// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_alg_req_mergeable_mergeable).
...
namespace libcis_ns_iterators_iterator_requirements_alg_req_mergeable_mergeable { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_requirements_alg_req_mergeable_mergeable; // libcis
