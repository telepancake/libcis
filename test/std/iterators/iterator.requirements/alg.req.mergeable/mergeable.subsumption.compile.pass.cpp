// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_alg_req_mergeable_mergeable_subsumption_f83da6b1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_alg_req_mergeable_mergeable_subsumption_f83da6b1 { // libcis
...
} // libcis_ns_iterators_iterator_requirements_alg_req_mergeable_mergeable_subsumption_f83da6b1 (libcis)
