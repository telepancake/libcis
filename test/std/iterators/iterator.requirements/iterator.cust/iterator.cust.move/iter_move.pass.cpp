// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_cust_iterator_cust_move_iter_move).
// main -> test_iterators_iterator_requirements_iterator_cust_iterator_cust_move_iter_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_iterator_cust_iterator_cust_move_iter_move { // libcis: isolate file-scope helpers
...
static_assert(std::is_invocable_v<IterMoveT, Holder<Incomplete>**&>);
} using namespace libcis_ns_iterators_iterator_requirements_iterator_cust_iterator_cust_move_iter_move; // libcis


void test_iterators_iterator_requirements_iterator_cust_iterator_cust_move_iter_move()
{
  test();
  static_assert(test());
