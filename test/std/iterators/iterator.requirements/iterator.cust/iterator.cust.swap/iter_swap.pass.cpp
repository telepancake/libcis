// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_cust_iterator_cust_swap_iter_swap).
// main -> test_iterators_iterator_requirements_iterator_cust_iterator_cust_swap_iter_swap; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_iterator_cust_iterator_cust_swap_iter_swap { // libcis: isolate file-scope helpers
...
static_assert(std::is_invocable_v<IterSwapT, Holder<Incomplete>**&, Holder<Incomplete>**>);
static_assert(std::is_invocable_v<IterSwapT, Holder<Incomplete>**&, Holder<Incomplete>**&>);
} using namespace libcis_ns_iterators_iterator_requirements_iterator_cust_iterator_cust_swap_iter_swap; // libcis


void test_iterators_iterator_requirements_iterator_cust_iterator_cust_swap_iter_swap()
{
  test();
  static_assert(test());
