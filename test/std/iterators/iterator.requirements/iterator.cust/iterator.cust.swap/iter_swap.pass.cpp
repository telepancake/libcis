// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_requirements_iterator_cust_iterator_cust_swap_iter_swap_028b82ba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_requirements_iterator_cust_iterator_cust_swap_iter_swap_028b82ba { // libcis
...
} // libcis_ns_iterators_iterator_requirements_iterator_cust_iterator_cust_swap_iter_swap_028b82ba (libcis)
