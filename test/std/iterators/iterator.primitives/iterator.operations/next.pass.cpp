// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_iterator_operations_next_f2a2973c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_iterator_operations_next_f2a2973c { // libcis
template <class It>
...
} // libcis_ns_iterators_iterator_primitives_iterator_operations_next_f2a2973c (libcis)
