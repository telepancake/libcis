// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_iterator_operations_advance).
// main -> test_iterators_iterator_primitives_iterator_operations_advance; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_iterator_operations_advance { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_primitives_iterator_operations_advance; // libcis


void test_iterators_iterator_primitives_iterator_operations_advance()
{
    tests();
#if TEST_STD_VER >= 17
    static_assert(tests(), "");
