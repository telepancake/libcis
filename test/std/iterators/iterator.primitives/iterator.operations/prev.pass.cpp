// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_iterator_operations_prev_a6a3a415).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_iterator_operations_prev_a6a3a415 { // libcis
template <class It>
...
} // libcis_ns_iterators_iterator_primitives_iterator_operations_prev_a6a3a415 (libcis)
