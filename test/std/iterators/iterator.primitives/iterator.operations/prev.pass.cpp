// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_iterator_operations_prev).
// main -> test_iterators_iterator_primitives_iterator_operations_prev; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_iterator_operations_prev { // libcis: isolate file-scope helpers
template <class It>
...
} using namespace libcis_ns_iterators_iterator_primitives_iterator_operations_prev; // libcis


void test_iterators_iterator_primitives_iterator_operations_prev()
{
    tests();
#if TEST_STD_VER >= 17
    static_assert(tests(), "");
