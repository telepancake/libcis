// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_iterator_operations_distance).
// main -> test_iterators_iterator_primitives_iterator_operations_distance; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_iterator_operations_distance { // libcis: isolate file-scope helpers
template <class It>
...
} using namespace libcis_ns_iterators_iterator_primitives_iterator_operations_distance; // libcis


void test_iterators_iterator_primitives_iterator_operations_distance() {
  tests();
#if TEST_STD_VER >= 17
  static_assert(tests(), "");
#endif
