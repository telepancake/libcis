// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_iterator_operations_distance_b7dc4f17).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_iterator_operations_distance_b7dc4f17 { // libcis
template <class It>
...
} // libcis_ns_iterators_iterator_primitives_iterator_operations_distance_b7dc4f17 (libcis)
