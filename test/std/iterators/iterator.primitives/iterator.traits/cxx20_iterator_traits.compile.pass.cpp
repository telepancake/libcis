// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_iterator_traits_cxx20_iterator_traits).
...
namespace libcis_ns_iterators_iterator_primitives_iterator_traits_cxx20_iterator_traits { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_primitives_iterator_traits_cxx20_iterator_traits; // libcis
