// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_iterator_traits_iterator_a1b2928d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_iterator_traits_iterator_a1b2928d { // libcis
struct A {};
...
} // libcis_ns_iterators_iterator_primitives_iterator_traits_iterator_a1b2928d (libcis)
