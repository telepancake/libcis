// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_iterator_traits_const_pointer_9fc6487a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_iterator_traits_const_pointer_9fc6487a { // libcis
struct A {};
...
} // libcis_ns_iterators_iterator_primitives_iterator_traits_const_pointer_9fc6487a (libcis)
