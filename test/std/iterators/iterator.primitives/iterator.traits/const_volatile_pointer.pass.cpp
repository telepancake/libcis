// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_iterator_traits_const_volatile_pointer_8c58582d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_iterator_traits_const_volatile_pointer_8c58582d { // libcis
struct A {};
...
} // libcis_ns_iterators_iterator_primitives_iterator_traits_const_volatile_pointer_8c58582d (libcis)
