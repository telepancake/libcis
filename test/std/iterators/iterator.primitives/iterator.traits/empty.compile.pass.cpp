// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_iterator_traits_empty_c8191f58).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_iterator_traits_empty_c8191f58 { // libcis
template <class...>
...
} // libcis_ns_iterators_iterator_primitives_iterator_traits_empty_c8191f58 (libcis)
