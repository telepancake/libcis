// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_iterator_basic_iterator_204ceae9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_iterator_basic_iterator_204ceae9 { // libcis
struct A {};
...
} // libcis_ns_iterators_iterator_primitives_iterator_basic_iterator_204ceae9 (libcis)
