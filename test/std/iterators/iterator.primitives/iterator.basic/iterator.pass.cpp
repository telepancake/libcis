// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_iterator_basic_iterator).
// main -> test_iterators_iterator_primitives_iterator_basic_iterator; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_iterator_basic_iterator { // libcis: isolate file-scope helpers
struct A {};
...
} using namespace libcis_ns_iterators_iterator_primitives_iterator_basic_iterator; // libcis


void test_iterators_iterator_primitives_iterator_basic_iterator()
{
    test2<A>();
    test3<A>();
    test4<A>();
