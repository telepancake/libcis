// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_range).
// main -> test_iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_range; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_range { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_range; // libcis


void test_iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_range() {
  test();
  static_assert(test());
