// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_iterator_sentinel_c3ee3eb3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_iterator_sentinel_c3ee3eb3 { // libcis
...
} // libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_iterator_sentinel_c3ee3eb3 (libcis)
