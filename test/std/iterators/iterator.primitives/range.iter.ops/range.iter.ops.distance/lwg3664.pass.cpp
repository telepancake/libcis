// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_lwg3664_c4259e1b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_lwg3664_c4259e1b { // libcis
template<class It>
struct EvilSentinel {
  It p_;
...
} // libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_lwg3664_c4259e1b (libcis)
