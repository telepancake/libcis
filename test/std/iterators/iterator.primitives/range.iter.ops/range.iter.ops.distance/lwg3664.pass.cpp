// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_lwg3664).
// main -> test_iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_lwg3664; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_lwg3664 { // libcis: isolate file-scope helpers
template<class It>
struct EvilSentinel {
  It p_;
...
} using namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_lwg3664; // libcis


void test_iterators_iterator_primitives_range_iter_ops_range_iter_ops_distance_lwg3664() {
  test();
  static_assert(test());
