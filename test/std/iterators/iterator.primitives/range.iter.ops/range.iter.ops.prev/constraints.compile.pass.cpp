// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_range_iter_ops_range_iter_ops_prev_constraints).
...
namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_prev_constraints { // libcis: isolate file-scope helpers
template <class ...Args>
...
} using namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_prev_constraints; // libcis
