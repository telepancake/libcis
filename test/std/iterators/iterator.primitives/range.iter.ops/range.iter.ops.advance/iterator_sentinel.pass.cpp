// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_range_iter_ops_range_iter_ops_advance_iterator_sentinel).
// main -> test_iterators_iterator_primitives_range_iter_ops_range_iter_ops_advance_iterator_sentinel; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_advance_iterator_sentinel { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_advance_iterator_sentinel; // libcis


void test_iterators_iterator_primitives_range_iter_ops_range_iter_ops_advance_iterator_sentinel() {
  assert(test());
  static_assert(test());
  return;
}
