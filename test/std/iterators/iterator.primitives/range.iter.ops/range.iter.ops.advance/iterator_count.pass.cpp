// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_range_iter_ops_range_iter_ops_advance_iterator_count).
// main -> test_iterators_iterator_primitives_range_iter_ops_range_iter_ops_advance_iterator_count; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_advance_iterator_count { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_advance_iterator_count; // libcis


void test_iterators_iterator_primitives_range_iter_ops_range_iter_ops_advance_iterator_count() {
  assert(test());
  static_assert(test());
  return;
}
