// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_primitives_range_iter_ops_range_iter_ops_advance_iterator_count_5e8d4681).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_advance_iterator_count_5e8d4681 { // libcis
...
} // libcis_ns_iterators_iterator_primitives_range_iter_ops_range_iter_ops_advance_iterator_count_5e8d4681 (libcis)
