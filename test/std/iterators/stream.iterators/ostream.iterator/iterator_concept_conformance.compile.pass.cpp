// AST-transferred from libc++ by tools/transfer.py (slug=iterators_stream_iterators_ostream_iterator_iterator_concept_conformance).
...
namespace libcis_ns_iterators_stream_iterators_ostream_iterator_iterator_concept_conformance { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_stream_iterators_ostream_iterator_iterator_concept_conformance; // libcis
