// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_stream_iterators_ostream_iterator_iterator_concept_conformance_e8235769).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_stream_iterators_ostream_iterator_iterator_concept_conformance_e8235769 { // libcis
...
} // libcis_ns_iterators_stream_iterators_ostream_iterator_iterator_concept_conformance_e8235769 (libcis)
