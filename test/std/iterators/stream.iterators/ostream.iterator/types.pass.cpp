// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_stream_iterators_ostream_iterator_types_8576ba8d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_stream_iterators_ostream_iterator_types_8576ba8d { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_iterators_stream_iterators_ostream_iterator_types_8576ba8d (libcis)
