// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_stream_iterators_istreambuf_iterator_istreambuf_iterator_op_not_equal_012e228d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_stream_iterators_istreambuf_iterator_istreambuf_iterator_op_not_equal_012e228d { // libcis
int main(int, char**) {
  {
...
} // libcis_ns_iterators_stream_iterators_istreambuf_iterator_istreambuf_iterator_op_not_equal_012e228d (libcis)
