// AST-transferred from libc++ by tools/transfer.py (slug=iterators_stream_iterators_istreambuf_iterator_types).
// main -> test_iterators_stream_iterators_istreambuf_iterator_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_iterators_stream_iterators_istreambuf_iterator_types()
{
    {
