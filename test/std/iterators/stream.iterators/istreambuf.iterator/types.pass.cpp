// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_stream_iterators_istreambuf_iterator_types_08947284).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_stream_iterators_istreambuf_iterator_types_08947284 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_iterators_stream_iterators_istreambuf_iterator_types_08947284 (libcis)
