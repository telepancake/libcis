// AST-transferred from libc++ by tools/transfer.py (slug=iterators_stream_iterators_istream_iterator_istream_iterator_ops_equal).
// main -> test_iterators_stream_iterators_istream_iterator_istream_iterator_ops_equal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_iterators_stream_iterators_istream_iterator_istream_iterator_ops_equal() {
  {
