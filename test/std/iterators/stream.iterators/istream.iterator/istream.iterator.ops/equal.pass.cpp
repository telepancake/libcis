// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_stream_iterators_istream_iterator_istream_iterator_ops_equal_976eb85d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_stream_iterators_istream_iterator_istream_iterator_ops_equal_976eb85d { // libcis
int main(int, char**) {
  {
...
} // libcis_ns_iterators_stream_iterators_istream_iterator_istream_iterator_ops_equal_976eb85d (libcis)
