// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_stream_iterators_istream_iterator_types_e9182394).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_stream_iterators_istream_iterator_types_e9182394 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_iterators_stream_iterators_istream_iterator_types_e9182394 (libcis)
