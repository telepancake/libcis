// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_container_data_df8a0722).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_container_data_df8a0722 { // libcis
template<typename C>
...
} // libcis_ns_iterators_iterator_container_data_df8a0722 (libcis)
