// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_container_ssize).
// main -> test_iterators_iterator_container_ssize; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_container_ssize { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_iterators_iterator_container_ssize; // libcis


void test_iterators_iterator_container_ssize()
{
