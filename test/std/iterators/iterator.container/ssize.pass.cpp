// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_container_ssize_118ff393).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_container_ssize_118ff393 { // libcis
...
} // libcis_ns_iterators_iterator_container_ssize_118ff393 (libcis)
