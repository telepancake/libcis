// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_container_size).
// main -> test_iterators_iterator_container_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_container_size { // libcis: isolate file-scope helpers
template<typename C>
...
} using namespace libcis_ns_iterators_iterator_container_size; // libcis


void test_iterators_iterator_container_size()
{
