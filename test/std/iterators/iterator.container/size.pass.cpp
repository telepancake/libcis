// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_container_size_6c6bdeea).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_container_size_6c6bdeea { // libcis
template<typename C>
...
} // libcis_ns_iterators_iterator_container_size_6c6bdeea (libcis)
