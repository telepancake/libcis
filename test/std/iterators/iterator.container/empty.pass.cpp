// AST-transferred from libc++ by tools/transfer.py (slug=iterators_iterator_container_empty).
// main -> test_iterators_iterator_container_empty; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_container_empty { // libcis: isolate file-scope helpers
template<typename C>
...
} using namespace libcis_ns_iterators_iterator_container_empty; // libcis


void test_iterators_iterator_container_empty()
{
