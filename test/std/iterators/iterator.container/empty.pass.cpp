// transferred+adapted from libc++ by tools/transfer.py (slug=iterators_iterator_container_empty_daa901b5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_iterators_iterator_container_empty_daa901b5 { // libcis
template<typename C>
...
} // libcis_ns_iterators_iterator_container_empty_daa901b5 (libcis)
