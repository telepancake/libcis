// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_results_types_8fcef764).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_types_8fcef764 { // libcis
...
} // libcis_ns_re_re_results_types_8fcef764 (libcis)
