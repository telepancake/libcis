// AST-transferred from libc++ by tools/transfer.py (slug=re_re_results_types).
// main -> test_re_re_results_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_re_re_results_types; // libcis


void test_re_re_results_types()
{
    test<char>();
    test<wchar_t>();
