// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_results_re_results_const_copy_ef9ed9a9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_re_results_const_copy_ef9ed9a9 { // libcis
...
} // libcis_ns_re_re_results_re_results_const_copy_ef9ed9a9 (libcis)
