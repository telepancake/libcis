// AST-transferred from libc++ by tools/transfer.py (slug=re_re_results_re_results_const_move).
// main -> test_re_re_results_re_results_const_move; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_re_results_const_move { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_re_re_results_re_results_const_move; // libcis


void test_re_re_results_re_results_const_move()
{
