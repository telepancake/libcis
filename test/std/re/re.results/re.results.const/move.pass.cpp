// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_results_re_results_const_move_5ff83fdf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_re_results_const_move_5ff83fdf { // libcis
...
} // libcis_ns_re_re_results_re_results_const_move_5ff83fdf (libcis)
