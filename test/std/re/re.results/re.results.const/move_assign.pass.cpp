// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_results_re_results_const_move_assign_b6d254bb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_re_results_const_move_assign_b6d254bb { // libcis
...
} // libcis_ns_re_re_results_re_results_const_move_assign_b6d254bb (libcis)
