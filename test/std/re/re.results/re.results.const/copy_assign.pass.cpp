// AST-transferred from libc++ by tools/transfer.py (slug=re_re_results_re_results_const_copy_assign).
// main -> test_re_re_results_re_results_const_copy_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_re_results_const_copy_assign { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_re_re_results_re_results_const_copy_assign; // libcis


void test_re_re_results_re_results_const_copy_assign()
{
