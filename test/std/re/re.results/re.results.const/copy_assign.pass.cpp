// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_results_re_results_const_copy_assign_10477046).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_re_results_const_copy_assign_10477046 { // libcis
...
} // libcis_ns_re_re_results_re_results_const_copy_assign_10477046 (libcis)
