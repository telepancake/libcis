// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_results_re_results_const_default_16cc4f18).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_re_results_const_default_16cc4f18 { // libcis
#if TEST_STD_VER >= 11
...
} // libcis_ns_re_re_results_re_results_const_default_16cc4f18 (libcis)
