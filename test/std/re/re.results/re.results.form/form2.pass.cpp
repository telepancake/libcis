// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_results_re_results_form_form2_0293db64).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_re_results_form_form2_0293db64 { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_results_re_results_form_form2_0293db64 (libcis)
