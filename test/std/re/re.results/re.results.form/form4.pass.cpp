// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_results_re_results_form_form4_1eea4ff2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_re_results_form_form4_1eea4ff2 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_re_re_results_re_results_form_form4_1eea4ff2 (libcis)
