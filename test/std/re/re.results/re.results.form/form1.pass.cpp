// AST-transferred from libc++ by tools/transfer.py (slug=re_re_results_re_results_form_form1).
// main -> test_re_re_results_re_results_form_form1; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_results_re_results_form_form1()
{
    {
