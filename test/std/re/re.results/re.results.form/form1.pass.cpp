// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_results_re_results_form_form1_3abf44aa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_re_results_form_form1_3abf44aa { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_re_re_results_re_results_form_form1_3abf44aa (libcis)
