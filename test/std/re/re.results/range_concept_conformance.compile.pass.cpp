// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_results_range_concept_conformance_12a668a8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_range_concept_conformance_12a668a8 { // libcis
...
} // libcis_ns_re_re_results_range_concept_conformance_12a668a8 (libcis)
