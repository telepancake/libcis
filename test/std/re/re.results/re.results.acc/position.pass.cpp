// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_results_re_results_acc_position_3437a538).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_re_results_acc_position_3437a538 { // libcis
void
test()
{
...
} // libcis_ns_re_re_results_re_results_acc_position_3437a538 (libcis)
