// AST-transferred from libc++ by tools/transfer.py (slug=re_re_results_re_results_acc_index).
// main -> test_re_re_results_re_results_acc_index; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_re_results_acc_index { // libcis: isolate file-scope helpers
void
...
} using namespace libcis_ns_re_re_results_re_results_acc_index; // libcis


void test_re_re_results_re_results_acc_index()
{
