// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_results_re_results_acc_index_42074609).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_results_re_results_acc_index_42074609 { // libcis
void
...
} // libcis_ns_re_re_results_re_results_acc_index_42074609 (libcis)
