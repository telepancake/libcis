// AST-transferred from libc++ by tools/transfer.py (slug=re_re_badexp_regex_error).
// main -> test_re_re_badexp_regex_error; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_badexp_regex_error()
{
    {
