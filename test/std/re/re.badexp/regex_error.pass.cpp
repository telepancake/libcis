// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_badexp_regex_error_3d7d0895).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_badexp_regex_error_3d7d0895 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_re_re_badexp_regex_error_3d7d0895 (libcis)
