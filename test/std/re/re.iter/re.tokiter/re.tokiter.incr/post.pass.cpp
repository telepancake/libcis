// AST-transferred from libc++ by tools/transfer.py (slug=re_re_iter_re_tokiter_re_tokiter_incr_post).
// main -> test_re_re_iter_re_tokiter_re_tokiter_incr_post; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_iter_re_tokiter_re_tokiter_incr_post()
{
    {
