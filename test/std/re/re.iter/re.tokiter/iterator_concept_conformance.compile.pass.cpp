// AST-transferred from libc++ by tools/transfer.py (slug=re_re_iter_re_tokiter_iterator_concept_conformance).
...
namespace libcis_ns_re_re_iter_re_tokiter_iterator_concept_conformance { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_re_re_iter_re_tokiter_iterator_concept_conformance; // libcis
