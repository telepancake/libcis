// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_iter_re_tokiter_types_da0af881).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_iter_re_tokiter_types_da0af881 { // libcis
...
} // libcis_ns_re_re_iter_re_tokiter_types_da0af881 (libcis)
