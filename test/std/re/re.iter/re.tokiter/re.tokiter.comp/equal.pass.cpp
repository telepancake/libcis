// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_iter_re_tokiter_re_tokiter_comp_equal_058bd23c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_iter_re_tokiter_re_tokiter_comp_equal_058bd23c { // libcis
int main(int, char**) {
...
} // libcis_ns_re_re_iter_re_tokiter_re_tokiter_comp_equal_058bd23c (libcis)
