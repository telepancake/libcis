// AST-transferred from libc++ by tools/transfer.py (slug=re_re_iter_re_tokiter_re_tokiter_comp_equal).
// main -> test_re_re_iter_re_tokiter_re_tokiter_comp_equal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_iter_re_tokiter_re_tokiter_comp_equal() {
#if TEST_STD_VER >= 20
