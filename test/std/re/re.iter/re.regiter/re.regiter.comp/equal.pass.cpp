// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_iter_re_regiter_re_regiter_comp_equal_564801bf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_iter_re_regiter_re_regiter_comp_equal_564801bf { // libcis
int main(int, char**) {
...
} // libcis_ns_re_re_iter_re_regiter_re_regiter_comp_equal_564801bf (libcis)
