// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_iter_re_regiter_re_regiter_deref_deref_494ca8ba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_iter_re_regiter_re_regiter_deref_deref_494ca8ba { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_re_re_iter_re_regiter_re_regiter_deref_deref_494ca8ba (libcis)
