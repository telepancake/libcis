// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_iter_re_regiter_re_regiter_incr_post_ee7481af).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_iter_re_regiter_re_regiter_incr_post_ee7481af { // libcis
...
} // libcis_ns_re_re_iter_re_regiter_re_regiter_incr_post_ee7481af (libcis)
