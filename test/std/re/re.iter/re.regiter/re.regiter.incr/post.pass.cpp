// AST-transferred from libc++ by tools/transfer.py (slug=re_re_iter_re_regiter_re_regiter_incr_post).
// main -> test_re_re_iter_re_regiter_re_regiter_incr_post; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_iter_re_regiter_re_regiter_incr_post { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_re_re_iter_re_regiter_re_regiter_incr_post; // libcis


void test_re_re_iter_re_regiter_re_regiter_incr_post() {
  {
