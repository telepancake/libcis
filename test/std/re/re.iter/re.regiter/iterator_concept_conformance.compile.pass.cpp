// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_iter_re_regiter_iterator_concept_conformance_999b52f9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_iter_re_regiter_iterator_concept_conformance_999b52f9 { // libcis
...
} // libcis_ns_re_re_iter_re_regiter_iterator_concept_conformance_999b52f9 (libcis)
