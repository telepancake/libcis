// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_iter_re_regiter_types_02356291).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_iter_re_regiter_types_02356291 { // libcis
...
} // libcis_ns_re_re_iter_re_regiter_types_02356291 (libcis)
