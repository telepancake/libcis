// AST-transferred from libc++ by tools/transfer.py (slug=re_re_iter_re_regiter_re_regiter_cnstr_cnstr).
// main -> test_re_re_iter_re_regiter_re_regiter_cnstr_cnstr; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_iter_re_regiter_re_regiter_cnstr_cnstr()
{
    {
