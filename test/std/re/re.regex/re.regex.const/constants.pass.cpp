// AST-transferred from libc++ by tools/transfer.py (slug=re_re_regex_re_regex_const_constants).
// main -> test_re_re_regex_re_regex_const_constants; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_regex_re_regex_const_constants { // libcis: isolate file-scope helpers
template <class T>
void where(const T &) {}
...
} using namespace libcis_ns_re_re_regex_re_regex_const_constants; // libcis


void test_re_re_regex_re_regex_const_constants()
{
    test<char>();
    test<wchar_t>();
