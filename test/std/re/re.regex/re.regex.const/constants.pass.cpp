// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_regex_re_regex_const_constants_9e1533e9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_regex_re_regex_const_constants_9e1533e9 { // libcis
template <class T>
void where(const T &) {}
...
} // libcis_ns_re_re_regex_re_regex_const_constants_9e1533e9 (libcis)
