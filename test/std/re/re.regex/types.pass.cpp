// AST-transferred from libc++ by tools/transfer.py (slug=re_re_regex_types).
// main -> test_re_re_regex_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
