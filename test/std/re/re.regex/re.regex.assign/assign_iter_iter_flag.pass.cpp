// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_regex_re_regex_assign_assign_iter_iter_flag_77b59c9c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_regex_re_regex_assign_assign_iter_iter_flag_77b59c9c { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_regex_re_regex_assign_assign_iter_iter_flag_77b59c9c (libcis)
