// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_regex_re_regex_construct_ptr_size_flg_c991d46a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_regex_re_regex_construct_ptr_size_flg_c991d46a { // libcis
...
} // libcis_ns_re_re_regex_re_regex_construct_ptr_size_flg_c991d46a (libcis)
