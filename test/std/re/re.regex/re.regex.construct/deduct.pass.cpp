// AST-transferred from libc++ by tools/transfer.py (slug=re_re_regex_re_regex_construct_deduct).
// main -> test_re_re_regex_re_regex_construct_deduct; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_regex_re_regex_construct_deduct { // libcis: isolate file-scope helpers
struct A {};
} using namespace libcis_ns_re_re_regex_re_regex_construct_deduct; // libcis


void test_re_re_regex_re_regex_construct_deduct()
{
