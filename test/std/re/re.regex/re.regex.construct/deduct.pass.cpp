// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_regex_re_regex_construct_deduct_dcb0cb36).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_regex_re_regex_construct_deduct_dcb0cb36 { // libcis
...
} // libcis_ns_re_re_regex_re_regex_construct_deduct_dcb0cb36 (libcis)
