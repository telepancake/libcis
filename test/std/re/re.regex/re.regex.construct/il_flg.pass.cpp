// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_regex_re_regex_construct_il_flg_6b1646f3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_regex_re_regex_construct_il_flg_6b1646f3 { // libcis
void
...
} // libcis_ns_re_re_regex_re_regex_construct_il_flg_6b1646f3 (libcis)
