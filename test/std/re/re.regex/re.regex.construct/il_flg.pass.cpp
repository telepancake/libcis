// AST-transferred from libc++ by tools/transfer.py (slug=re_re_regex_re_regex_construct_il_flg).
// main -> test_re_re_regex_re_regex_construct_il_flg; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_regex_re_regex_construct_il_flg { // libcis: isolate file-scope helpers
void
...
} using namespace libcis_ns_re_re_regex_re_regex_construct_il_flg; // libcis



void test_re_re_regex_re_regex_construct_il_flg()
{
    std::string s1("\\(a\\)");
    std::string s2("\\(a[bc]\\)");
    std::string s3("\\(a\\([bc]\\)\\)");
