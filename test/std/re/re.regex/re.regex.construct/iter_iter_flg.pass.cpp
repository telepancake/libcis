// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_regex_re_regex_construct_iter_iter_flg_c50c54d2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_regex_re_regex_construct_iter_iter_flg_c50c54d2 { // libcis
template <class Iter>
void
...
} // libcis_ns_re_re_regex_re_regex_construct_iter_iter_flg_c50c54d2 (libcis)
