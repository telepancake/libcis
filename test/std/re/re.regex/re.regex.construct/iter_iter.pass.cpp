// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_regex_re_regex_construct_iter_iter_916405a8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_regex_re_regex_construct_iter_iter_916405a8 { // libcis
template <class Iter>
void
...
} // libcis_ns_re_re_regex_re_regex_construct_iter_iter_916405a8 (libcis)
