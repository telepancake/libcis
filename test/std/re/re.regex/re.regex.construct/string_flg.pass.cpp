// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_regex_re_regex_construct_string_flg_e9aec883).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_regex_re_regex_construct_string_flg_e9aec883 { // libcis
...
} // libcis_ns_re_re_regex_re_regex_construct_string_flg_e9aec883 (libcis)
