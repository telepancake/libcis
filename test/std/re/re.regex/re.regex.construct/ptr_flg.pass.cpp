// AST-transferred from libc++ by tools/transfer.py (slug=re_re_regex_re_regex_construct_ptr_flg).
// main -> test_re_re_regex_re_regex_construct_ptr_flg; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_regex_re_regex_construct_ptr_flg { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_re_re_regex_re_regex_construct_ptr_flg; // libcis


void test_re_re_regex_re_regex_construct_ptr_flg()
{
