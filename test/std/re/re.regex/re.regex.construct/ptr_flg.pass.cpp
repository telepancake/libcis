// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_regex_re_regex_construct_ptr_flg_411ee573).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_regex_re_regex_construct_ptr_flg_411ee573 { // libcis
...
} // libcis_ns_re_re_regex_re_regex_construct_ptr_flg_411ee573 (libcis)
