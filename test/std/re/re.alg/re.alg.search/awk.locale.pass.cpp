// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_search_awk_locale_52dce043).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_search_awk_locale_52dce043 { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_alg_re_alg_search_awk_locale_52dce043 (libcis)
