// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_search_awk_0be53f40).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_search_awk_0be53f40 { // libcis
int main(int, char**)
{
    {
        std::cmatch m;
...
} // libcis_ns_re_re_alg_re_alg_search_awk_0be53f40 (libcis)
