// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_search_extended_locale_cd265603).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_search_extended_locale_cd265603 { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_alg_re_alg_search_extended_locale_cd265603 (libcis)
