// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_search_backup_22ccb0b9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_search_backup_22ccb0b9 { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_alg_re_alg_search_backup_22ccb0b9 (libcis)
