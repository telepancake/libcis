// AST-transferred from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_search_backup).
// main -> test_re_re_alg_re_alg_search_backup; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_alg_re_alg_search_backup()
{
