// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_search_ecma_d1adf875).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_search_ecma_d1adf875 { // libcis
int main(int, char**)
{
    {
        std::cmatch m;
...
} // libcis_ns_re_re_alg_re_alg_search_ecma_d1adf875 (libcis)
