// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_search_basic_8c1ff85c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_search_basic_8c1ff85c { // libcis
int main(int, char**)
{
    {
        std::cmatch m;
...
} // libcis_ns_re_re_alg_re_alg_search_basic_8c1ff85c (libcis)
