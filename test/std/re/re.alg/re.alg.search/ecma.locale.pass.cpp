// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_search_ecma_locale_eacffa1d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_search_ecma_locale_eacffa1d { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_alg_re_alg_search_ecma_locale_eacffa1d (libcis)
