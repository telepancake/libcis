// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_search_extended_19a1c4a9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_search_extended_19a1c4a9 { // libcis
int main(int, char**)
{
    {
        std::cmatch m;
...
} // libcis_ns_re_re_alg_re_alg_search_extended_19a1c4a9 (libcis)
