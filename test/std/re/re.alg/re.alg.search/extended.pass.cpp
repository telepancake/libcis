// AST-transferred from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_search_extended).
// main -> test_re_re_alg_re_alg_search_extended; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_alg_re_alg_search_extended()
{
    {
        std::cmatch m;
        const char s[] = "a";
