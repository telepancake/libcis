// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_search_basic_locale_d90b8a04).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_search_basic_locale_d90b8a04 { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_alg_re_alg_search_basic_locale_d90b8a04 (libcis)
