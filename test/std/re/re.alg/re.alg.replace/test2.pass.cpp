// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_replace_test2_551dd12c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_replace_test2_551dd12c { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_re_re_alg_re_alg_replace_test2_551dd12c (libcis)
