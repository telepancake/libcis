// AST-transferred from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_replace_zero_length_matches).
// main -> test_re_re_alg_re_alg_replace_zero_length_matches; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_alg_re_alg_replace_zero_length_matches() {
