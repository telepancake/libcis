// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_replace_zero_length_matches_fb369787).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_replace_zero_length_matches_fb369787 { // libcis
int main(int, char**) {
...
} // libcis_ns_re_re_alg_re_alg_replace_zero_length_matches_fb369787 (libcis)
