// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_replace_test4_50db98ba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_replace_test4_50db98ba { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_re_re_alg_re_alg_replace_test4_50db98ba (libcis)
