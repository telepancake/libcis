// AST-transferred from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_replace_test3).
// main -> test_re_re_alg_re_alg_replace_test3; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_alg_re_alg_replace_test3()
{
    {
