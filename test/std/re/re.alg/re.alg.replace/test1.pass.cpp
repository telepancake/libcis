// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_replace_test1_ab09fafa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_replace_test1_ab09fafa { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_re_re_alg_re_alg_replace_test1_ab09fafa (libcis)
