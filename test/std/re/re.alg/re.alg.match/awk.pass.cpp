// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_match_awk_3e408bff).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_match_awk_3e408bff { // libcis
int main(int, char**)
{
    {
        std::cmatch m;
...
} // libcis_ns_re_re_alg_re_alg_match_awk_3e408bff (libcis)
