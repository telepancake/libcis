// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_match_inverted_character_classes_69593f25).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_match_inverted_character_classes_69593f25 { // libcis
int main(int, char**) {
...
} // libcis_ns_re_re_alg_re_alg_match_inverted_character_classes_69593f25 (libcis)
