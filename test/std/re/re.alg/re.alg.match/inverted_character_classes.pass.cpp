// AST-transferred from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_match_inverted_character_classes).
// main -> test_re_re_alg_re_alg_match_inverted_character_classes; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_alg_re_alg_match_inverted_character_classes() {
