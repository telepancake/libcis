// AST-transferred from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_match_lookahead_capture).
// main -> test_re_re_alg_re_alg_match_lookahead_capture; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_alg_re_alg_match_lookahead_capture()
{
    {
        std::regex re("^(?=(.))a$");
