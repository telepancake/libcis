// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_match_lookahead_capture_6c3ebfef).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_match_lookahead_capture_6c3ebfef { // libcis
int main(int, char**)
{
    {
        std::regex re("^(?=(.))a$");
...
} // libcis_ns_re_re_alg_re_alg_match_lookahead_capture_6c3ebfef (libcis)
