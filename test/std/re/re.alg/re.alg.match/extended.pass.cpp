// AST-transferred from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_match_extended).
// main -> test_re_re_alg_re_alg_match_extended; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_alg_re_alg_match_extended()
{
    {
        std::cmatch m;
        const char s[] = "a";
