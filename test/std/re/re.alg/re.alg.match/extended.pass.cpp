// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_match_extended_3cafb792).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_match_extended_3cafb792 { // libcis
int main(int, char**)
{
    {
        std::cmatch m;
...
} // libcis_ns_re_re_alg_re_alg_match_extended_3cafb792 (libcis)
