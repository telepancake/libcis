// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_match_awk_locale_b0a59cd7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_match_awk_locale_b0a59cd7 { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_alg_re_alg_match_awk_locale_b0a59cd7 (libcis)
