// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_match_basic_locale_73e098a7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_match_basic_locale_73e098a7 { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_alg_re_alg_match_basic_locale_73e098a7 (libcis)
