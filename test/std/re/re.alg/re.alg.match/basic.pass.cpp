// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_alg_re_alg_match_basic_32805caa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_alg_re_alg_match_basic_32805caa { // libcis
int main(int, char**)
{
    {
        std::cmatch m;
...
} // libcis_ns_re_re_alg_re_alg_match_basic_32805caa (libcis)
