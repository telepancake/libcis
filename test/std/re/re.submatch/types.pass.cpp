// AST-transferred from libc++ by tools/transfer.py (slug=re_re_submatch_types).
// main -> test_re_re_submatch_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_submatch_types()
{
    {
