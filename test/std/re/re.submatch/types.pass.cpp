// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_submatch_types_18a8c0c4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_submatch_types_18a8c0c4 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_re_re_submatch_types_18a8c0c4 (libcis)
