// AST-transferred from libc++ by tools/transfer.py (slug=re_re_submatch_re_submatch_op_compare).
// main -> test_re_re_submatch_re_submatch_op_compare; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_submatch_re_submatch_op_compare { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_re_re_submatch_re_submatch_op_compare; // libcis

#endif //  TEST_STD_VER > 17

void test_re_re_submatch_re_submatch_op_compare()
{
