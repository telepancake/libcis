// AST-transferred from libc++ by tools/transfer.py (slug=re_re_const_re_synopt_syntax_option_type).
// main -> test_re_re_const_re_synopt_syntax_option_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_const_re_synopt_syntax_option_type()
{
