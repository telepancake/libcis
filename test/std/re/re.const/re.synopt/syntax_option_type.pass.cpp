// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_const_re_synopt_syntax_option_type_328aaf07).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_const_re_synopt_syntax_option_type_328aaf07 { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_const_re_synopt_syntax_option_type_328aaf07 (libcis)
