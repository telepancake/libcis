// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_const_re_err_error_type_71009fca).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_const_re_err_error_type_71009fca { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_const_re_err_error_type_71009fca (libcis)
