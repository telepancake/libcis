// AST-transferred from libc++ by tools/transfer.py (slug=re_re_const_re_matchflag_match_multiline).
// main -> test_re_re_const_re_matchflag_match_multiline; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_const_re_matchflag_match_multiline { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_re_re_const_re_matchflag_match_multiline; // libcis


void test_re_re_const_re_matchflag_match_multiline()
{
