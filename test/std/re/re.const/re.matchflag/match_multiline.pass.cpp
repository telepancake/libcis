// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_const_re_matchflag_match_multiline_b0de2a0f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_const_re_matchflag_match_multiline_b0de2a0f { // libcis
...
} // libcis_ns_re_re_const_re_matchflag_match_multiline_b0de2a0f (libcis)
