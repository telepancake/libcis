// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_const_re_matchflag_match_not_eol_be77a5c6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_const_re_matchflag_match_not_eol_be77a5c6 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_re_re_const_re_matchflag_match_not_eol_be77a5c6 (libcis)
