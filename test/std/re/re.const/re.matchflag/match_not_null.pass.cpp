// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_const_re_matchflag_match_not_null_d3bb7412).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_const_re_matchflag_match_not_null_d3bb7412 { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_const_re_matchflag_match_not_null_d3bb7412 (libcis)
