// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_const_re_matchflag_match_prev_avail_22c1a363).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_const_re_matchflag_match_prev_avail_22c1a363 { // libcis
int main(int, char**) {
  char str1[] = "\na";
...
} // libcis_ns_re_re_const_re_matchflag_match_prev_avail_22c1a363 (libcis)
