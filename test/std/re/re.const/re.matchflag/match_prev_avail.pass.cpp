// AST-transferred from libc++ by tools/transfer.py (slug=re_re_const_re_matchflag_match_prev_avail).
// main -> test_re_re_const_re_matchflag_match_prev_avail; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_const_re_matchflag_match_prev_avail() {
  char str1[] = "\na";
