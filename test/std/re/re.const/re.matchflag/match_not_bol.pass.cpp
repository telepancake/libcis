// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_const_re_matchflag_match_not_bol_8ec99e84).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_const_re_matchflag_match_not_bol_8ec99e84 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_re_re_const_re_matchflag_match_not_bol_8ec99e84 (libcis)
