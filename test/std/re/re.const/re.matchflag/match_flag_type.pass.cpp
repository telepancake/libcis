// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_const_re_matchflag_match_flag_type_4c7d90d9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_const_re_matchflag_match_flag_type_4c7d90d9 { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_const_re_matchflag_match_flag_type_4c7d90d9 (libcis)
