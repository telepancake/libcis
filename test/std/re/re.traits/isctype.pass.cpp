// AST-transferred from libc++ by tools/transfer.py (slug=re_re_traits_isctype).
// main -> test_re_re_traits_isctype; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_traits_isctype()
{
    {
