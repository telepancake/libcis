// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_traits_lookup_collatename_c984300c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_traits_lookup_collatename_c984300c { // libcis
...
} // libcis_ns_re_re_traits_lookup_collatename_c984300c (libcis)
