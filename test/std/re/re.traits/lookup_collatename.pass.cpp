// AST-transferred from libc++ by tools/transfer.py (slug=re_re_traits_lookup_collatename).
// main -> test_re_re_traits_lookup_collatename; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_traits_lookup_collatename { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_re_re_traits_lookup_collatename; // libcis


void test_re_re_traits_lookup_collatename()
{
