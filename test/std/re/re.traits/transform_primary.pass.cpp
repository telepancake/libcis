// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_traits_transform_primary_6ed7f2a0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_traits_transform_primary_6ed7f2a0 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_re_re_traits_transform_primary_6ed7f2a0 (libcis)
