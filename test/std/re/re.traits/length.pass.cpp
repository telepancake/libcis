// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_traits_length_a2540b73).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_traits_length_a2540b73 { // libcis
int main(int, char**)
{
...
} // libcis_ns_re_re_traits_length_a2540b73 (libcis)
