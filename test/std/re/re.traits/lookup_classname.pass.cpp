// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_traits_lookup_classname_1b1cddf8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_traits_lookup_classname_1b1cddf8 { // libcis
...
} // libcis_ns_re_re_traits_lookup_classname_1b1cddf8 (libcis)
