// AST-transferred from libc++ by tools/transfer.py (slug=re_re_traits_translate_nocase).
// main -> test_re_re_traits_translate_nocase; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_re_re_traits_translate_nocase()
{
    {
