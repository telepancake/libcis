// transferred+adapted from libc++ by tools/transfer.py (slug=re_re_traits_translate_nocase_85266a40).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_re_re_traits_translate_nocase_85266a40 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_re_re_traits_translate_nocase_85266a40 (libcis)
