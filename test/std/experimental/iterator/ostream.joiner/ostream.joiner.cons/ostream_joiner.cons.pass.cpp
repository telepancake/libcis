// AST-transferred from libc++ by tools/transfer.py (slug=experimental_iterator_ostream_joiner_ostream_joiner_cons_ostream_joiner_cons).
// main -> test_experimental_iterator_ostream_joiner_ostream_joiner_cons_ostream_joiner_cons; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_experimental_iterator_ostream_joiner_ostream_joiner_cons_ostream_joiner_cons() {
    const char eight = '8';
