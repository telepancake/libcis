// AST-transferred from libc++ by tools/transfer.py (slug=experimental_iterator_ostream_joiner_ostream_joiner_creation_make_ostream_joiner).
// main -> test_experimental_iterator_ostream_joiner_ostream_joiner_creation_make_ostream_joiner; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_iterator_ostream_joiner_ostream_joiner_creation_make_ostream_joiner { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_experimental_iterator_ostream_joiner_ostream_joiner_creation_make_ostream_joiner; // libcis


void test_experimental_iterator_ostream_joiner_ostream_joiner_creation_make_ostream_joiner() {
