// AST-transferred from libc++ by tools/transfer.py (slug=experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_assign).
// main -> test_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_assign { // libcis: isolate file-scope helpers
...
{ return os << d.get(); }
} using namespace libcis_ns_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_assign; // libcis
...
void test_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_assign() {
{
