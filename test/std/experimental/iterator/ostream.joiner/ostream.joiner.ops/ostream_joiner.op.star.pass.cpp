// AST-transferred from libc++ by tools/transfer.py (slug=experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_star).
// main -> test_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_star; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_star { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_star; // libcis


void test_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_star() {
