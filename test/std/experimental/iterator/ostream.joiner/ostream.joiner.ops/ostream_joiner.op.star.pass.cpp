// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_star_8e5eebd0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_star_8e5eebd0 { // libcis
...
} // libcis_ns_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_star_8e5eebd0 (libcis)
