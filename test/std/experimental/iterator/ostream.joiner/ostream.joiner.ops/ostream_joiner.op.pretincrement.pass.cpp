// AST-transferred from libc++ by tools/transfer.py (slug=experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_pretincrement).
// main -> test_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_pretincrement; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_pretincrement { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_pretincrement; // libcis


void test_experimental_iterator_ostream_joiner_ostream_joiner_ops_ostream_joiner_op_pretincrement() {
