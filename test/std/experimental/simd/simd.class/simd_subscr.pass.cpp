// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_class_simd_subscr_c66d8750).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_class_simd_subscr_c66d8750 { // libcis
...
} // libcis_ns_experimental_simd_simd_class_simd_subscr_c66d8750 (libcis)
