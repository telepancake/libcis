// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_class_simd_ctor_default_0a86a2e6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_class_simd_ctor_default_0a86a2e6 { // libcis
...
} // libcis_ns_experimental_simd_simd_class_simd_ctor_default_0a86a2e6 (libcis)
