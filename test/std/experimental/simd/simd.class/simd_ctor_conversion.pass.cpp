// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_class_simd_ctor_conversion_9fa1851a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_class_simd_ctor_conversion_9fa1851a { // libcis
...
} // libcis_ns_experimental_simd_simd_class_simd_ctor_conversion_9fa1851a (libcis)
