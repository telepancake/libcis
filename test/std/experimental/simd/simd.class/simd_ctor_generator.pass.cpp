// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_class_simd_ctor_generator_cfd26e84).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_class_simd_ctor_generator_cfd26e84 { // libcis
...
} // libcis_ns_experimental_simd_simd_class_simd_ctor_generator_cfd26e84 (libcis)
