// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_class_simd_copy_ecf8e3dc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_class_simd_copy_ecf8e3dc { // libcis
...
} // libcis_ns_experimental_simd_simd_class_simd_copy_ecf8e3dc (libcis)
