// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_class_simd_alias_f8300f56).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_class_simd_alias_f8300f56 { // libcis
...
} // libcis_ns_experimental_simd_simd_class_simd_alias_f8300f56 (libcis)
