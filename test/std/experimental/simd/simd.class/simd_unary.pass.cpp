// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_class_simd_unary_20045aaa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_class_simd_unary_20045aaa { // libcis
...
} // libcis_ns_experimental_simd_simd_class_simd_unary_20045aaa (libcis)
