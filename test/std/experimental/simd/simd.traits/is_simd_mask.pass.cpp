// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_traits_is_simd_mask_d48b06be).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_traits_is_simd_mask_d48b06be { // libcis
...
} // libcis_ns_experimental_simd_simd_traits_is_simd_mask_d48b06be (libcis)
