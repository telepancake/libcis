// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_traits_simd_size_2ca6751b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_traits_simd_size_2ca6751b { // libcis
...
} // libcis_ns_experimental_simd_simd_traits_simd_size_2ca6751b (libcis)
