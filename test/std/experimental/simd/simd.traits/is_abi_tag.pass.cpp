// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_traits_is_abi_tag_4ad7cce8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_traits_is_abi_tag_4ad7cce8 { // libcis
...
} // libcis_ns_experimental_simd_simd_traits_is_abi_tag_4ad7cce8 (libcis)
