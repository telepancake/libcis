// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_traits_is_simd_flag_type_a5c55be8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_traits_is_simd_flag_type_a5c55be8 { // libcis
...
} // libcis_ns_experimental_simd_simd_traits_is_simd_flag_type_a5c55be8 (libcis)
