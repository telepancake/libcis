// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_traits_memory_alignment_546f70ed).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_traits_memory_alignment_546f70ed { // libcis
...
} // libcis_ns_experimental_simd_simd_traits_memory_alignment_546f70ed (libcis)
