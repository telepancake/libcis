// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_reference_reference_bitwise_operators_4aedb6e5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_reference_reference_bitwise_operators_4aedb6e5 { // libcis
struct AndAssign {
...
} // libcis_ns_experimental_simd_simd_reference_reference_bitwise_operators_4aedb6e5 (libcis)
