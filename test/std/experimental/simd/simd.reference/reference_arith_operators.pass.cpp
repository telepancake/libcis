// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_reference_reference_arith_operators_a2e60ac9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_reference_reference_arith_operators_a2e60ac9 { // libcis
struct PlusAssign {
...
} // libcis_ns_experimental_simd_simd_reference_reference_arith_operators_a2e60ac9 (libcis)
