// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_reference_reference_unary_a2c9253f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_reference_reference_unary_a2c9253f { // libcis
...
} // libcis_ns_experimental_simd_simd_reference_reference_unary_a2c9253f (libcis)
