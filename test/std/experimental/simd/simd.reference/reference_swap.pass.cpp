// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_reference_reference_swap_90e7be93).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_reference_reference_swap_90e7be93 { // libcis
...
} // libcis_ns_experimental_simd_simd_reference_reference_swap_90e7be93 (libcis)
