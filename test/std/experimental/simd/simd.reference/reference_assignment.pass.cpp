// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_reference_reference_assignment_06ddf072).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_reference_reference_assignment_06ddf072 { // libcis
...
} // libcis_ns_experimental_simd_simd_reference_reference_assignment_06ddf072 (libcis)
