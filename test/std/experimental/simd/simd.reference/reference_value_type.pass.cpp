// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_reference_reference_value_type_baf48241).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_reference_reference_value_type_baf48241 { // libcis
...
} // libcis_ns_experimental_simd_simd_reference_reference_value_type_baf48241 (libcis)
