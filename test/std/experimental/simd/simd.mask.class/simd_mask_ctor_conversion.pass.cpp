// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_mask_class_simd_mask_ctor_conversion_81d14866).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_mask_class_simd_mask_ctor_conversion_81d14866 { // libcis
...
} // libcis_ns_experimental_simd_simd_mask_class_simd_mask_ctor_conversion_81d14866 (libcis)
