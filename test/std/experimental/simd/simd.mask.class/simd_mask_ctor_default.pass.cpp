// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_mask_class_simd_mask_ctor_default_ae25dad8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_mask_class_simd_mask_ctor_default_ae25dad8 { // libcis
...
} // libcis_ns_experimental_simd_simd_mask_class_simd_mask_ctor_default_ae25dad8 (libcis)
