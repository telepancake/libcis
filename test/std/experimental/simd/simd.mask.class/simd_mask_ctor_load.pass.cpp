// transferred+adapted from libc++ by tools/transfer.py (slug=experimental_simd_simd_mask_class_simd_mask_ctor_load_f8a1cdb4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_experimental_simd_simd_mask_class_simd_mask_ctor_load_f8a1cdb4 { // libcis
...
} // libcis_ns_experimental_simd_simd_mask_class_simd_mask_ctor_load_f8a1cdb4 (libcis)
