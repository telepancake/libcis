// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_traits_time_traits_specializations_duration_eacb2675).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_traits_time_traits_specializations_duration_eacb2675 { // libcis
...
} // libcis_ns_time_time_traits_time_traits_specializations_duration_eacb2675 (libcis)
