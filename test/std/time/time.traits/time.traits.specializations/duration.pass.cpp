// AST-transferred from libc++ by tools/transfer.py (slug=time_time_traits_time_traits_specializations_duration).
// main -> test_time_time_traits_time_traits_specializations_duration; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_traits_time_traits_specializations_duration { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_traits_time_traits_specializations_duration; // libcis


void test_time_time_traits_time_traits_specializations_duration()
{
