// AST-transferred from libc++ by tools/transfer.py (slug=time_time_traits_time_traits_specializations_time_point).
// main -> test_time_time_traits_time_traits_specializations_time_point; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_traits_time_traits_specializations_time_point { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_traits_time_traits_specializations_time_point; // libcis


void test_time_time_traits_time_traits_specializations_time_point()
{
