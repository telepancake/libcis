// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_traits_time_traits_specializations_time_point_53d6fcdc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_traits_time_traits_specializations_time_point_53d6fcdc { // libcis
...
} // libcis_ns_time_time_traits_time_traits_specializations_time_point_53d6fcdc (libcis)
