// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_traits_time_traits_duration_values_max_1034c016).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_traits_time_traits_duration_values_max_1034c016 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_traits_time_traits_duration_values_max_1034c016 (libcis)
