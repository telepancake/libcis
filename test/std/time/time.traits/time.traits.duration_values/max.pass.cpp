// AST-transferred from libc++ by tools/transfer.py (slug=time_time_traits_time_traits_duration_values_max).
// main -> test_time_time_traits_time_traits_duration_values_max; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_traits_time_traits_duration_values_max()
{
