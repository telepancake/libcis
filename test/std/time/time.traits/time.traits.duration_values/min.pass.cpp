// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_traits_time_traits_duration_values_min_ebfd3943).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_traits_time_traits_duration_values_min_ebfd3943 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_traits_time_traits_duration_values_min_ebfd3943 (libcis)
