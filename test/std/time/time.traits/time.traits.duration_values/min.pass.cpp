// AST-transferred from libc++ by tools/transfer.py (slug=time_time_traits_time_traits_duration_values_min).
// main -> test_time_time_traits_time_traits_duration_values_min; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_traits_time_traits_duration_values_min()
{
