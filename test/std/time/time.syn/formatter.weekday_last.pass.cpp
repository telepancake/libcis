// AST-transferred from libc++ by tools/transfer.py (slug=time_time_syn_formatter_weekday_last).
// main -> test_time_time_syn_formatter_weekday_last; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_weekday_last { // libcis: isolate file-scope helpers
...
void test_time_time_syn_formatter_weekday_last
} using namespace libcis_ns_time_time_syn_formatter_weekday_last; // libcis
()