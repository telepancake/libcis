// AST-transferred from libc++ by tools/transfer.py (slug=time_time_syn_formatter_duration).
// main -> test_time_time_syn_formatter_duration; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_duration { // libcis: isolate file-scope helpers
...
void test_time_time_syn_formatter_duration()
} using namespace libcis_ns_time_time_syn_formatter_duration; // libcis
