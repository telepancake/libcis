// AST-transferred from libc++ by tools/transfer.py (slug=time_time_syn_formatter_year_month).
// main -> test_time_time_syn_formatter_year_month; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_year_month { // libcis: isolate file-scope helpers
...
#if
} using namespace libcis_ns_time_time_syn_formatter_year_month; // libcis
ndvoid test_time_time_syn_formatter_year_month()HARACTERS
  test<wchar_t>();
#endif
