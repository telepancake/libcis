// AST-transferred from libc++ by tools/transfer.py (slug=time_time_syn_formatter_year).
// main -> test_time_time_syn_formatter_year; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_year { // libcis: isolate file-scope helpers
...
#ifndef TES
} using namespace libcis_ns_time_time_syn_formatter_year; // libcis
T_void test_time_time_syn_formatter_year()S
  test<wchar_t>();
#endif
