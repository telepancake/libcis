// AST-transferred from libc++ by tools/transfer.py (slug=time_time_syn_formatter_day).
// main -> test_time_time_syn_formatter_day; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_day { // libcis: isolate file-scope helpers
...
int main(int, char
} using namespace libcis_ns_time_time_syn_formatter_day; // libcis
**void test_time_time_syn_formatter_day()#ifndef TEST_HAS_NO_WIDE_CHARACTERS
  test<wchar_t>();
#endif
