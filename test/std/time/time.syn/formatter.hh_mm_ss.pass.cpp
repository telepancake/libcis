// AST-transferred from libc++ by tools/transfer.py (slug=time_time_syn_formatter_hh_mm_ss).
// main -> test_time_time_syn_formatter_hh_mm_ss; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_hh_mm_ss { // libcis: isolate file-scope helpers
...
void test_time_time_syn_formatter_hh_mm_ss()
} using namespace libcis_ns_time_time_syn_formatter_hh_mm_ss; // libcis
