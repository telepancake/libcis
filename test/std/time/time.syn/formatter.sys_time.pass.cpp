// AST-transferred from libc++ by tools/transfer.py (slug=time_time_syn_formatter_sys_time).
// main -> test_time_time_syn_formatter_sys_time; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_sys_time { // libcis: isolate file-scope helpers
...
void test_time_time_syn_formatter_sys_time()
} using namespace libcis_ns_time_time_syn_formatter_sys_time; // libcis
