// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_syn_formatter_sys_info_ef8332c8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_sys_info_ef8332c8 { // libcis
...
} // libcis_ns_time_time_syn_formatter_sys_info_ef8332c8 (libcis)
