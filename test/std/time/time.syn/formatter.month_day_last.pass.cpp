// AST-transferred from libc++ by tools/transfer.py (slug=time_time_syn_formatter_month_day_last).
// main -> test_time_time_syn_formatter_month_day_last; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_month_day_last { // libcis: isolate file-scope helpers
...
void test_time_time_syn_formatter_month_day_last()
} using namespace libcis_ns_time_time_syn_formatter_month_day_last; // libcis
