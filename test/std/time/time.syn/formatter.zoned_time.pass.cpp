// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_syn_formatter_zoned_time_4c1d7ced).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_zoned_time_4c1d7ced { // libcis
...
} // libcis_ns_time_time_syn_formatter_zoned_time_4c1d7ced (libcis)
