// AST-transferred from libc++ by tools/transfer.py (slug=time_time_syn_formatter_year_month_weekday_last).
// main -> test_time_time_syn_formatter_year_month_weekday_last; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_year_month_weekday_last { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_syn_formatter_year_month_weekday_last; // libcis


void test_time_time_syn_formatter_year_month_weekday_last() {
  test<char>();
