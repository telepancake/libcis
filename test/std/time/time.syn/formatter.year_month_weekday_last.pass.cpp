// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_syn_formatter_year_month_weekday_last_63c677e8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_year_month_weekday_last_63c677e8 { // libcis
...
} // libcis_ns_time_time_syn_formatter_year_month_weekday_last_63c677e8 (libcis)
