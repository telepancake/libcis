// AST-transferred from libc++ by tools/transfer.py (slug=time_time_syn_formatter_year_month_weekday).
// main -> test_time_time_syn_formatter_year_month_weekday; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_year_month_weekday { // libcis: isolate file-scope helpers
...
void test_time_time_syn_formatt
} using namespace libcis_ns_time_time_syn_formatter_year_month_weekday; // libcis
er_year_month_weekday()