// AST-transferred from libc++ by tools/transfer.py (slug=time_time_syn_formatter_weekday_index).
// main -> test_time_time_syn_formatter_weekday_index; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_syn_formatter_weekday_index { // libcis: isolate file-scope helpers
...
void test_time_time_syn_formatter_weekday_index()
} using namespace libcis_ns_time_time_syn_formatter_weekday_index; // libcis
