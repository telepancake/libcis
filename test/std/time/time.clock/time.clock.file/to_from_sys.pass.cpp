// AST-transferred from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_file_to_from_sys).
// main -> test_time_time_clock_time_clock_file_to_from_sys; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_clock_time_clock_file_to_from_sys() {
