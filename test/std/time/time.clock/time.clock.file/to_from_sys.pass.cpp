// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_file_to_from_sys_7214ce67).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_file_to_from_sys_7214ce67 { // libcis
int main(int, char**) {
...
} // libcis_ns_time_time_clock_time_clock_file_to_from_sys_7214ce67 (libcis)
