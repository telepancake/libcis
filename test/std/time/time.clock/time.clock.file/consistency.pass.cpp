// AST-transferred from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_file_consistency).
// main -> test_time_time_clock_time_clock_file_consistency; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_file_consistency { // libcis: isolate file-scope helpers
template <class T>
void test(const T &) {}
} using namespace libcis_ns_time_time_clock_time_clock_file_consistency; // libcis


void test_time_time_clock_time_clock_file_consistency()
{
