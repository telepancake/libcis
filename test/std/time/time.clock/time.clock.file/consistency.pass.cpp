// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_file_consistency_6c4610ea).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_file_consistency_6c4610ea { // libcis
template <class T>
void test(const T &) {}
...
} // libcis_ns_time_time_clock_time_clock_file_consistency_6c4610ea (libcis)
