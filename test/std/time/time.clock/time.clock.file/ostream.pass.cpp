// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_file_ostream_40858719).
//===----------------------------------------------------------------------===//
//
...
// tests easier.
namespace libcis_ns_time_time_clock_time_clock_file_ostream_40858719 { // libcis
...
} // libcis_ns_time_time_clock_time_clock_file_ostream_40858719 (libcis)
