// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_utc_time_clock_utc_members_to_sys_4a9a5696).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_utc_time_clock_utc_members_to_sys_4a9a5696 { // libcis
...
} // libcis_ns_time_time_clock_time_clock_utc_time_clock_utc_members_to_sys_4a9a5696 (libcis)
