// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_utc_time_clock_utc_members_from_sys_4adf78b1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_utc_time_clock_utc_members_from_sys_4adf78b1 { // libcis
template <class Duration>
...
} // libcis_ns_time_time_clock_time_clock_utc_time_clock_utc_members_from_sys_4adf78b1 (libcis)
