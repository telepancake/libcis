// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_utc_utc_time_ostream_6019b1d2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_utc_utc_time_ostream_6019b1d2 { // libcis
...
} // libcis_ns_time_time_clock_time_clock_utc_utc_time_ostream_6019b1d2 (libcis)
