// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_utc_get_leap_second_info_283019ec).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_utc_get_leap_second_info_283019ec { // libcis
template <class Duration>
...
} // libcis_ns_time_time_clock_time_clock_utc_get_leap_second_info_283019ec (libcis)
