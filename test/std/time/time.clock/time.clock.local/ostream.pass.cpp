// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_local_ostream_0b9aecae).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_local_ostream_0b9aecae { // libcis
...
} // libcis_ns_time_time_clock_time_clock_local_ostream_0b9aecae (libcis)
