// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_hires_consistency_1a56c269).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_hires_consistency_1a56c269 { // libcis
template <class T>
void test(const T &) {}
...
} // libcis_ns_time_time_clock_time_clock_hires_consistency_1a56c269 (libcis)
