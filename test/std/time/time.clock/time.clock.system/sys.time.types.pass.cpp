// AST-transferred from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_system_sys_time_types).
// main -> test_time_time_clock_time_clock_system_sys_time_types; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_clock_time_clock_system_sys_time_types()
{
