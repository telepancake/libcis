// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_system_sys_time_types_b60f9987).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_system_sys_time_types_b60f9987 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_clock_time_clock_system_sys_time_types_b60f9987 (libcis)
