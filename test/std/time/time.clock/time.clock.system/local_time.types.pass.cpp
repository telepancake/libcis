// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_system_local_time_types_1cb94331).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_system_local_time_types_1cb94331 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_clock_time_clock_system_local_time_types_1cb94331 (libcis)
