// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_system_consistency_57c72c58).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_system_consistency_57c72c58 { // libcis
template <class T>
void test(const T &) {}
...
} // libcis_ns_time_time_clock_time_clock_system_consistency_57c72c58 (libcis)
