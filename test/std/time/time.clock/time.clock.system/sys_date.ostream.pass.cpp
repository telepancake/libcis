// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_system_sys_date_ostream_8e7dccf9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_system_sys_date_ostream_8e7dccf9 { // libcis
...
} // libcis_ns_time_time_clock_time_clock_system_sys_date_ostream_8e7dccf9 (libcis)
