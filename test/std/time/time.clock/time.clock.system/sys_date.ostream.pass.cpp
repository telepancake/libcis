// AST-transferred from libc++ by tools/transfer.py (slug=time_time_clock_time_clock_system_sys_date_ostream).
// main -> test_time_time_clock_time_clock_system_sys_date_ostream; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_clock_time_clock_system_sys_date_ostream { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_clock_time_clock_system_sys_date_ostream; // libcis


void test_time_time_clock_time_clock_system_sys_date_ostream() {
  test<char>();
