// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_hms_time_12_is_pm_301a3afc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_hms_time_12_is_pm_301a3afc { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_hms_time_12_is_pm_301a3afc (libcis)
