// AST-transferred from libc++ by tools/transfer.py (slug=time_time_hms_time_12_is_pm).
// main -> test_time_time_hms_time_12_is_pm; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_hms_time_12_is_pm()
{
