// AST-transferred from libc++ by tools/transfer.py (slug=time_time_hms_time_12_make24).
// main -> test_time_time_hms_time_12_make24; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_hms_time_12_make24()
{
