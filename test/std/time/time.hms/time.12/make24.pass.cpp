// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_hms_time_12_make24_aae20f40).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_hms_time_12_make24_aae20f40 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_hms_time_12_make24_aae20f40 (libcis)
