// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_hms_time_hms_nonmembers_ostream_4d6c899d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_hms_time_hms_nonmembers_ostream_4d6c899d { // libcis
...
} // libcis_ns_time_time_hms_time_hms_nonmembers_ostream_4d6c899d (libcis)
