// AST-transferred from libc++ by tools/transfer.py (slug=time_time_hms_time_hms_members_to_duration).
// main -> test_time_time_hms_time_hms_members_to_duration; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_hms_time_hms_members_to_duration { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_hms_time_hms_members_to_duration; // libcis


void test_time_time_hms_time_hms_members_to_duration()
{
