// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_hms_time_hms_members_to_duration_0734a7b0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_hms_time_hms_members_to_duration_0734a7b0 { // libcis
...
} // libcis_ns_time_time_hms_time_hms_members_to_duration_0734a7b0 (libcis)
