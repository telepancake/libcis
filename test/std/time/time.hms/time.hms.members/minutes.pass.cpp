// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_hms_time_hms_members_minutes_d0b2a98a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_hms_time_hms_members_minutes_d0b2a98a { // libcis
...
} // libcis_ns_time_time_hms_time_hms_members_minutes_d0b2a98a (libcis)
