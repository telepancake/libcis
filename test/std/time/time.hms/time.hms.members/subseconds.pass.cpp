// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_hms_time_hms_members_subseconds_7201da9a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_hms_time_hms_members_subseconds_7201da9a { // libcis
...
} // libcis_ns_time_time_hms_time_hms_members_subseconds_7201da9a (libcis)
