// AST-transferred from libc++ by tools/transfer.py (slug=time_time_hms_time_hms_members_subseconds).
// main -> test_time_time_hms_time_hms_members_subseconds; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_hms_time_hms_members_subseconds { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_hms_time_hms_members_subseconds; // libcis


void test_time_time_hms_time_hms_members_subseconds()
{
