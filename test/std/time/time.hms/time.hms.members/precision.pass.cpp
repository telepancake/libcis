// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_hms_time_hms_members_precision_272c72f3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_hms_time_hms_members_precision_272c72f3 { // libcis
...
} // libcis_ns_time_time_hms_time_hms_members_precision_272c72f3 (libcis)
