// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_hms_time_hms_members_is_negative_1ebf2cc5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_hms_time_hms_members_is_negative_1ebf2cc5 { // libcis
...
} // libcis_ns_time_time_hms_time_hms_members_is_negative_1ebf2cc5 (libcis)
