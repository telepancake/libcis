// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_hms_time_hms_members_width_e1f8003a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_hms_time_hms_members_width_e1f8003a { // libcis
...
} // libcis_ns_time_time_hms_time_hms_members_width_e1f8003a (libcis)
