// AST-transferred from libc++ by tools/transfer.py (slug=time_time_hms_time_hms_members_hours).
// main -> test_time_time_hms_time_hms_members_hours; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_hms_time_hms_members_hours { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_hms_time_hms_members_hours; // libcis


void test_time_time_hms_time_hms_members_hours()
{
