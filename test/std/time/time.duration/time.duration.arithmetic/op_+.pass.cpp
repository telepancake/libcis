// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_arithmetic_op_26aa7be6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_arithmetic_op_26aa7be6 { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_time_time_duration_time_duration_arithmetic_op_26aa7be6 (libcis)
