// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_arithmetic_op_e8c9ba3e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_arithmetic_op_e8c9ba3e { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_time_time_duration_time_duration_arithmetic_op_e8c9ba3e (libcis)
