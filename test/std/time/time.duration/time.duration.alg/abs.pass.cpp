// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_alg_abs_3e672efd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_alg_abs_3e672efd { // libcis
...
} // libcis_ns_time_time_duration_time_duration_alg_abs_3e672efd (libcis)
