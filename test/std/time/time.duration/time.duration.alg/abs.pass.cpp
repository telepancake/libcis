// AST-transferred from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_alg_abs).
// main -> test_time_time_duration_time_duration_alg_abs; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_alg_abs { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_duration_time_duration_alg_abs; // libcis


void test_time_time_duration_time_duration_alg_abs()
{
