// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_special_max_ae20d228).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_special_max_ae20d228 { // libcis
template <class D>
void test()
{
...
} // libcis_ns_time_time_duration_time_duration_special_max_ae20d228 (libcis)
