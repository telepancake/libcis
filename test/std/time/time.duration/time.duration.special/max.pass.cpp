// AST-transferred from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_special_max).
// main -> test_time_time_duration_time_duration_special_max; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_special_max { // libcis: isolate file-scope helpers
template <class D>
void test()
{
...
} using namespace libcis_ns_time_time_duration_time_duration_special_max; // libcis


void test_time_time_duration_time_duration_special_max()
{
