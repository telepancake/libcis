// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_special_zero_a1fd4144).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_special_zero_a1fd4144 { // libcis
template <class D>
void test()
{
...
} // libcis_ns_time_time_duration_time_duration_special_zero_a1fd4144 (libcis)
