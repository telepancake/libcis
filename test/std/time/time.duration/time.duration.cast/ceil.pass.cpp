// AST-transferred from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_cast_ceil).
// main -> test_time_time_duration_time_duration_cast_ceil; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_cast_ceil { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_duration_time_duration_cast_ceil; // libcis


void test_time_time_duration_time_duration_cast_ceil()
{
