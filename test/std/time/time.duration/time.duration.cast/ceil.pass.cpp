// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_cast_ceil_88d2a550).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_cast_ceil_88d2a550 { // libcis
...
} // libcis_ns_time_time_duration_time_duration_cast_ceil_88d2a550 (libcis)
