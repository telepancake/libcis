// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_cast_duration_cast_51d884fd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_cast_duration_cast_51d884fd { // libcis
...
} // libcis_ns_time_time_duration_time_duration_cast_duration_cast_51d884fd (libcis)
