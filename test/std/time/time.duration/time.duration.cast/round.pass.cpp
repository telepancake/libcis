// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_cast_round_d7abfee9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_cast_round_d7abfee9 { // libcis
...
} // libcis_ns_time_time_duration_time_duration_cast_round_d7abfee9 (libcis)
