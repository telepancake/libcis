// AST-transferred from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_cast_floor).
// main -> test_time_time_duration_time_duration_cast_floor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_cast_floor { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_duration_time_duration_cast_floor; // libcis


void test_time_time_duration_time_duration_cast_floor()
{
