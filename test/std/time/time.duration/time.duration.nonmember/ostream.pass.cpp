// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_nonmember_ostream_73d2c51f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_nonmember_ostream_73d2c51f { // libcis
...
} // libcis_ns_time_time_duration_time_duration_nonmember_ostream_73d2c51f (libcis)
