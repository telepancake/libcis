// AST-transferred from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_nonmember_op_mod_duration).
// main -> test_time_time_duration_time_duration_nonmember_op_mod_duration; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_duration_time_duration_nonmember_op_mod_duration()
{
    {
