// AST-transferred from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_nonmember_op_times_rep).
// main -> test_time_time_duration_time_duration_nonmember_op_times_rep; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_duration_time_duration_nonmember_op_times_rep() {
  {
