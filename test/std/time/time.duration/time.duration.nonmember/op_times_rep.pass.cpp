// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_nonmember_op_times_rep_f053f738).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_nonmember_op_times_rep_f053f738 { // libcis
int main(int, char**) {
  {
...
} // libcis_ns_time_time_duration_time_duration_nonmember_op_times_rep_f053f738 (libcis)
