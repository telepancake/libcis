// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_nonmember_op_divide_duration_8647cf1c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_nonmember_op_divide_duration_8647cf1c { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_time_time_duration_time_duration_nonmember_op_divide_duration_8647cf1c (libcis)
