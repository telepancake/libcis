// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_cons_rep_1dece6eb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_cons_rep_1dece6eb { // libcis
#if TEST_STD_VER >= 11
...
} // libcis_ns_time_time_duration_time_duration_cons_rep_1dece6eb (libcis)
