// AST-transferred from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_cons_rep).
// main -> test_time_time_duration_time_duration_cons_rep; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#if TEST_STD_VER >= 11
namespace libcis_ns_time_time_duration_time_duration_cons_rep { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_duration_time_duration_cons_rep; // libcis


void test_time_time_duration_time_duration_cons_rep() {
    test();
#if TEST_STD_VER > 11
    static_assert(test(), "");
#endif
