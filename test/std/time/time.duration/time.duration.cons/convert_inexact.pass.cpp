// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_cons_convert_inexact_d422f0ff).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_cons_convert_inexact_d422f0ff { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_time_time_duration_time_duration_cons_convert_inexact_d422f0ff (libcis)
