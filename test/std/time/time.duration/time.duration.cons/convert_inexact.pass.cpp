// AST-transferred from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_cons_convert_inexact).
// main -> test_time_time_duration_time_duration_cons_convert_inexact; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_duration_time_duration_cons_convert_inexact()
{
    {
