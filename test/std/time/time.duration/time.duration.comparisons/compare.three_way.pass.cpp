// AST-transferred from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_comparisons_compare_three_way).
// main -> test_time_time_duration_time_duration_comparisons_compare_three_way; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_comparisons_compare_three_way { // libcis: isolate file-scope helpers
constexpr bool test() {
  {
...
} using namespace libcis_ns_time_time_duration_time_duration_comparisons_compare_three_way; // libcis


void test_time_time_duration_time_duration_comparisons_compare_three_way() {
  assert(test());
  static_assert(test());
  return;
}
