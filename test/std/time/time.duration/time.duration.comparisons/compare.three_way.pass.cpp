// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_comparisons_compare_three_way_5fdcb617).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_comparisons_compare_three_way_5fdcb617 { // libcis
constexpr bool test() {
  {
...
} // libcis_ns_time_time_duration_time_duration_comparisons_compare_three_way_5fdcb617 (libcis)
