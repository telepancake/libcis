// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_comparisons_op_equal_bbc4a1dc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_comparisons_op_equal_bbc4a1dc { // libcis
int main(int, char**)
{
    {
...
} // libcis_ns_time_time_duration_time_duration_comparisons_op_equal_bbc4a1dc (libcis)
