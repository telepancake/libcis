// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_literals_literals1_a0d31c1a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_literals_literals1_a0d31c1a { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_duration_time_duration_literals_literals1_a0d31c1a (libcis)
