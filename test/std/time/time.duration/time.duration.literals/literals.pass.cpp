// AST-transferred from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_literals_literals).
// main -> test_time_time_duration_time_duration_literals_literals; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_duration_time_duration_literals_literals()
{
