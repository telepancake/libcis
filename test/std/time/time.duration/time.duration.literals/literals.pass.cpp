// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_duration_time_duration_literals_literals_d26d0fea).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_duration_time_duration_literals_literals_d26d0fea { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_duration_time_duration_literals_literals_d26d0fea (libcis)
