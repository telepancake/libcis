// AST-transferred from libc++ by tools/transfer.py (slug=time_months).
// main -> test_time_months; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
