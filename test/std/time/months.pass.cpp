// transferred+adapted from libc++ by tools/transfer.py (slug=time_months_86fc447a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_months_86fc447a { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_months_86fc447a (libcis)
