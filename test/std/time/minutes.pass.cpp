// AST-transferred from libc++ by tools/transfer.py (slug=time_minutes).
// main -> test_time_minutes; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
