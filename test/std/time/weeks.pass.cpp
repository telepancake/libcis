// transferred+adapted from libc++ by tools/transfer.py (slug=time_weeks_987aca16).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_weeks_987aca16 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_weeks_987aca16 (libcis)
