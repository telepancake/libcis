// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_mwdlast_time_cal_mwdlast_members_weekday_last_3da33c6a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_mwdlast_time_cal_mwdlast_members_weekday_last_3da33c6a { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_mwdlast_time_cal_mwdlast_members_weekday_last_3da33c6a (libcis)
