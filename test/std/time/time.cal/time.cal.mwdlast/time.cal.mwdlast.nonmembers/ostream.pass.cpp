// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_mwdlast_time_cal_mwdlast_nonmembers_ostream).
// main -> test_time_time_cal_time_cal_mwdlast_time_cal_mwdlast_nonmembers_ostream; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_mwdlast_time_cal_mwdlast_nonmembers_ostream { // libcis: isolate file-scope helpers
...
int main(int, char**) {
  ...
  retur
} using namespace libcis_ns_time_time_cal_time_cal_mwdlast_time_cal_mwdlast_nonmembers_ostream; // libcis
n void test_time_time_cal_time_cal_mwdlast_time_cal_mwdlast_nonmembers_ostream()