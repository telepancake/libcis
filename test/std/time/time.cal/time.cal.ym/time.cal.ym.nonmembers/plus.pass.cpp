// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ym_time_cal_ym_nonmembers_plus).
// main -> test_time_time_cal_time_cal_ym_time_cal_ym_nonmembers_plus; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ym_time_cal_ym_nonmembers_plus { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_cal_time_cal_ym_time_cal_ym_nonmembers_plus; // libcis


void test_time_time_cal_time_cal_ym_time_cal_ym_nonmembers_plus() {
  test();
  static_assert(test());
