// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ym_time_cal_ym_nonmembers_minus_aa1ecfa5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ym_time_cal_ym_nonmembers_minus_aa1ecfa5 { // libcis
...
} // libcis_ns_time_time_cal_time_cal_ym_time_cal_ym_nonmembers_minus_aa1ecfa5 (libcis)
