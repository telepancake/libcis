// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ym_time_cal_ym_nonmembers_comparisons_a8080b86).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ym_time_cal_ym_nonmembers_comparisons_a8080b86 { // libcis
constexpr bool test() {
...
} // libcis_ns_time_time_cal_time_cal_ym_time_cal_ym_nonmembers_comparisons_a8080b86 (libcis)
