// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ym_time_cal_ym_members_plus_minus_equal_year_2f8b38d8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ym_time_cal_ym_members_plus_minus_equal_year_2f8b38d8 { // libcis
...
} // libcis_ns_time_time_cal_time_cal_ym_time_cal_ym_members_plus_minus_equal_year_2f8b38d8 (libcis)
