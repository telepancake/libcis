// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ym_time_cal_ym_members_ctor_b80fa3f6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ym_time_cal_ym_members_ctor_b80fa3f6 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_ym_time_cal_ym_members_ctor_b80fa3f6 (libcis)
