// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ym_time_cal_ym_members_ok).
// main -> test_time_time_cal_time_cal_ym_time_cal_ym_members_ok; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_cal_time_cal_ym_time_cal_ym_members_ok()
{
