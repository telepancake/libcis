// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ym_time_cal_ym_members_plus_minus_equal_month_57abf850).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ym_time_cal_ym_members_plus_minus_equal_month_57abf850 { // libcis
...
} // libcis_ns_time_time_cal_time_cal_ym_time_cal_ym_members_plus_minus_equal_month_57abf850 (libcis)
