// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_day_time_cal_day_nonmembers_plus_e5dfbbba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_day_time_cal_day_nonmembers_plus_e5dfbbba { // libcis
...
} // libcis_ns_time_time_cal_time_cal_day_time_cal_day_nonmembers_plus_e5dfbbba (libcis)
