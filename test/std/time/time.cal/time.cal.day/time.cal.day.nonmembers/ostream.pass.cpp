// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_day_time_cal_day_nonmembers_ostream).
// main -> test_time_time_cal_time_cal_day_time_cal_day_nonmembers_ostream; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_day_time_cal_day_nonmembers_ostream { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_cal_time_cal_day_time_cal_day_nonmembers_ostream; // libcis


void test_time_time_cal_time_cal_day_time_cal_day_nonmembers_ostream() {
  using namespace std::literals::chrono_literals;
