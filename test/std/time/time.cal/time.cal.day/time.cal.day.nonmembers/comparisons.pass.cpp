// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_day_time_cal_day_nonmembers_comparisons_19f3f758).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_day_time_cal_day_nonmembers_comparisons_19f3f758 { // libcis
constexpr bool test() {
...
} // libcis_ns_time_time_cal_time_cal_day_time_cal_day_nonmembers_comparisons_19f3f758 (libcis)
