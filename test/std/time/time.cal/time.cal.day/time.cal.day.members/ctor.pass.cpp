// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_day_time_cal_day_members_ctor_ea03fb6c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_day_time_cal_day_members_ctor_ea03fb6c { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_day_time_cal_day_members_ctor_ea03fb6c (libcis)
