// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_wdidx_time_cal_wdidx_nonmembers_ostream).
// main -> test_time_time_cal_time_cal_wdidx_time_cal_wdidx_nonmembers_ostream; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_wdidx_time_cal_wdidx_nonmembers_ostream { // libcis: isolate file-scope helpers
...
int main(int, 
} using namespace libcis_ns_time_time_cal_time_cal_wdidx_time_cal_wdidx_nonmembers_ostream; // libcis
chvoid test_time_time_cal_time_cal_wdidx_time_cal_wdidx_nonmembers_ostream());
