// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_wdidx_time_cal_wdidx_members_index).
// main -> test_time_time_cal_time_cal_wdidx_time_cal_wdidx_members_index; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_cal_time_cal_wdidx_time_cal_wdidx_members_index()
{
