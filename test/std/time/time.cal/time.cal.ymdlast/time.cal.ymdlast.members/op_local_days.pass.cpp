// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymdlast_time_cal_ymdlast_members_op_local_days_e859f561).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_members_op_local_days_e859f561 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_members_op_local_days_e859f561 (libcis)
