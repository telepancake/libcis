// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymdlast_time_cal_ymdlast_members_plus_minus_equal_month_aec139d6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_members_plus_minus_equal_month_aec139d6 { // libcis
...
} // libcis_ns_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_members_plus_minus_equal_month_aec139d6 (libcis)
