// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_ostream).
// main -> test_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_ostream; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_ostream { // libcis: isolate file-scope helpers
...
#i
} using namespace libcis_ns_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_ostream; // libcis
fnvoid test_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_ostream()CHARACTERS
  test<wchar_t>();
#endif
