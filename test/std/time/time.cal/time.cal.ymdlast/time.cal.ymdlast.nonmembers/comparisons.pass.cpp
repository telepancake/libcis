// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_comparisons_b0c790d6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_comparisons_b0c790d6 { // libcis
constexpr bool test() {
...
} // libcis_ns_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_comparisons_b0c790d6 (libcis)
