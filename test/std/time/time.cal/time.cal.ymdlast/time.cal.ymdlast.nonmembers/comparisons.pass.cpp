// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_comparisons).
// main -> test_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_comparisons; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_comparisons { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_comparisons; // libcis


void test_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_comparisons() {
  using year_month_day_last = std::chrono::year_month_day_last;
