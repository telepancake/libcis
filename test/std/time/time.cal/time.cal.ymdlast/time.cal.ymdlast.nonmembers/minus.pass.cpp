// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_minus_efacf5b3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_minus_efacf5b3 { // libcis
...
} // libcis_ns_time_time_cal_time_cal_ymdlast_time_cal_ymdlast_nonmembers_minus_efacf5b3 (libcis)
