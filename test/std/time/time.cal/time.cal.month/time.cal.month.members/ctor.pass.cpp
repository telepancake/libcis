// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_month_time_cal_month_members_ctor_ff6046b4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_month_time_cal_month_members_ctor_ff6046b4 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_month_time_cal_month_members_ctor_ff6046b4 (libcis)
