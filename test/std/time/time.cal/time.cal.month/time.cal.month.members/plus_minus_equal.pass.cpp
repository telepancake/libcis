// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_month_time_cal_month_members_plus_minus_equal_f51686fd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_month_time_cal_month_members_plus_minus_equal_f51686fd { // libcis
constexpr bool test() {
...
} // libcis_ns_time_time_cal_time_cal_month_time_cal_month_members_plus_minus_equal_f51686fd (libcis)
