// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_month_time_cal_month_nonmembers_literals).
// main -> test_time_time_cal_time_cal_month_time_cal_month_nonmembers_literals; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_cal_time_cal_month_time_cal_month_nonmembers_literals()
{
