// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_month_time_cal_month_nonmembers_literals_170fd6b0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_month_time_cal_month_nonmembers_literals_170fd6b0 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_month_time_cal_month_nonmembers_literals_170fd6b0 (libcis)
