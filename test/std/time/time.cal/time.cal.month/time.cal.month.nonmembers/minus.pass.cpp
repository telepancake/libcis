// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_month_time_cal_month_nonmembers_minus_56e3e7bb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_month_time_cal_month_nonmembers_minus_56e3e7bb { // libcis
...
} // libcis_ns_time_time_cal_time_cal_month_time_cal_month_nonmembers_minus_56e3e7bb (libcis)
