// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_operators_year_month_weekday_eda13847).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_operators_year_month_weekday_eda13847 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_operators_year_month_weekday_eda13847 (libcis)
