// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_operators_year_month_weekday_last_c6d6dab9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_operators_year_month_weekday_last_c6d6dab9 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_operators_year_month_weekday_last_c6d6dab9 (libcis)
