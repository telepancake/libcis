// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_operators_year_month_day_last_783bd26c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_operators_year_month_day_last_783bd26c { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_operators_year_month_day_last_783bd26c (libcis)
