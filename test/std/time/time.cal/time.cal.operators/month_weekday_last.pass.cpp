// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_operators_month_weekday_last).
// main -> test_time_time_cal_time_cal_operators_month_weekday_last; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_cal_time_cal_operators_month_weekday_last()
{
