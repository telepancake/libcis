// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_operators_month_weekday_last_c3bec657).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_operators_month_weekday_last_c3bec657 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_operators_month_weekday_last_c3bec657 (libcis)
