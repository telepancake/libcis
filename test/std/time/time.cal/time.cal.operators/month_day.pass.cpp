// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_operators_month_day_f047be71).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_operators_month_day_f047be71 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_operators_month_day_f047be71 (libcis)
