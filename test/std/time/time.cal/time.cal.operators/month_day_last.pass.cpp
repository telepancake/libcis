// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_operators_month_day_last_8ebf43a7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_operators_month_day_last_8ebf43a7 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_operators_month_day_last_8ebf43a7 (libcis)
