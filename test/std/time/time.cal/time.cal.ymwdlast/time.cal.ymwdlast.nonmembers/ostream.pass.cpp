// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymwdlast_time_cal_ymwdlast_nonmembers_ostream).
// main -> test_time_time_cal_time_cal_ymwdlast_time_cal_ymwdlast_nonmembers_ostream; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymwdlast_time_cal_ymwdlast_nonmembers_ostream { // libcis: isolate file-scope helpers
...
int main(int, char**) {
  test<char>();
} using namespace libcis_ns_time_time_cal_time_cal_ymwdlast_time_cal_ymwdlast_nonmembers_ostream; // libcis

void test_time_time_cal_time_cal_ymwdlast_time_cal_ymwdlast_nonmembers_ostream()WIDE_CHARACTERS
  test<wchar_t>();
#endif
