// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymwdlast_time_cal_ymwdlast_members_op_local_days_58d9650a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymwdlast_time_cal_ymwdlast_members_op_local_days_58d9650a { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_ymwdlast_time_cal_ymwdlast_members_op_local_days_58d9650a (libcis)
