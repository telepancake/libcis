// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymwdlast_time_cal_ymwdlast_members_year_59b6dcfe).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymwdlast_time_cal_ymwdlast_members_year_59b6dcfe { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_ymwdlast_time_cal_ymwdlast_members_year_59b6dcfe (libcis)
