// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymd_time_cal_ymd_members_plus_minus_equal_month_995a7bd5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymd_time_cal_ymd_members_plus_minus_equal_month_995a7bd5 { // libcis
...
} // libcis_ns_time_time_cal_time_cal_ymd_time_cal_ymd_members_plus_minus_equal_month_995a7bd5 (libcis)
