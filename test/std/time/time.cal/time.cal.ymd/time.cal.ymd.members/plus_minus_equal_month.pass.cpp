// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymd_time_cal_ymd_members_plus_minus_equal_month).
// main -> test_time_time_cal_time_cal_ymd_time_cal_ymd_members_plus_minus_equal_month; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymd_time_cal_ymd_members_plus_minus_equal_month { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_cal_time_cal_ymd_time_cal_ymd_members_plus_minus_equal_month; // libcis


void test_time_time_cal_time_cal_ymd_time_cal_ymd_members_plus_minus_equal_month() {
