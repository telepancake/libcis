// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymd_time_cal_ymd_members_op_sys_days_d124de82).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymd_time_cal_ymd_members_op_sys_days_d124de82 { // libcis
void RunTheExample()
{
...
} // libcis_ns_time_time_cal_time_cal_ymd_time_cal_ymd_members_op_sys_days_d124de82 (libcis)
