// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymd_time_cal_ymd_members_op_local_days_7837dc07).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymd_time_cal_ymd_members_op_local_days_7837dc07 { // libcis
void RunTheExample()
{
...
} // libcis_ns_time_time_cal_time_cal_ymd_time_cal_ymd_members_op_local_days_7837dc07 (libcis)
