// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymd_time_cal_ymd_members_op_local_days).
// main -> test_time_time_cal_time_cal_ymd_time_cal_ymd_members_op_local_days; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymd_time_cal_ymd_members_op_local_days { // libcis: isolate file-scope helpers
void RunTheExample()
{
...
} using namespace libcis_ns_time_time_cal_time_cal_ymd_time_cal_ymd_members_op_local_days; // libcis


void test_time_time_cal_time_cal_ymd_time_cal_ymd_members_op_local_days()
{
