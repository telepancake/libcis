// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymd_time_cal_ymd_members_ctor_local_days).
// main -> test_time_time_cal_time_cal_ymd_time_cal_ymd_members_ctor_local_days; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_cal_time_cal_ymd_time_cal_ymd_members_ctor_local_days()
{
