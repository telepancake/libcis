// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymd_time_cal_ymd_members_ctor_local_days_2f3eba8b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymd_time_cal_ymd_members_ctor_local_days_2f3eba8b { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_ymd_time_cal_ymd_members_ctor_local_days_2f3eba8b (libcis)
