// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_year_time_cal_year_nonmembers_minus_a21dc3c8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_year_time_cal_year_nonmembers_minus_a21dc3c8 { // libcis
...
} // libcis_ns_time_time_cal_time_cal_year_time_cal_year_nonmembers_minus_a21dc3c8 (libcis)
