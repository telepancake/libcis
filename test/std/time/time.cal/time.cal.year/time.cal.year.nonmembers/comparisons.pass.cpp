// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_year_time_cal_year_nonmembers_comparisons_a130ea5f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_year_time_cal_year_nonmembers_comparisons_a130ea5f { // libcis
constexpr bool test() {
...
} // libcis_ns_time_time_cal_time_cal_year_time_cal_year_nonmembers_comparisons_a130ea5f (libcis)
