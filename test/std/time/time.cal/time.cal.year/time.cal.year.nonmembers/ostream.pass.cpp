// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_year_time_cal_year_nonmembers_ostream_0eb8a27d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_year_time_cal_year_nonmembers_ostream_0eb8a27d { // libcis
...
} // libcis_ns_time_time_cal_time_cal_year_time_cal_year_nonmembers_ostream_0eb8a27d (libcis)
