// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_year_time_cal_year_nonmembers_plus_44e0ef4e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_year_time_cal_year_nonmembers_plus_44e0ef4e { // libcis
...
} // libcis_ns_time_time_cal_time_cal_year_time_cal_year_nonmembers_plus_44e0ef4e (libcis)
