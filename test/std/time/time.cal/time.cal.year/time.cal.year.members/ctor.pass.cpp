// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_year_time_cal_year_members_ctor_c8c1bfa9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_year_time_cal_year_members_ctor_c8c1bfa9 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_year_time_cal_year_members_ctor_c8c1bfa9 (libcis)
