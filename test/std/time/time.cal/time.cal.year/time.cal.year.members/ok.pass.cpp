// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_year_time_cal_year_members_ok_c3d032ad).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_year_time_cal_year_members_ok_c3d032ad { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_year_time_cal_year_members_ok_c3d032ad (libcis)
