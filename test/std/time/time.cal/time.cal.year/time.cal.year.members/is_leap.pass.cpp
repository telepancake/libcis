// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_year_time_cal_year_members_is_leap_e660ab41).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_year_time_cal_year_members_is_leap_e660ab41 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_year_time_cal_year_members_is_leap_e660ab41 (libcis)
