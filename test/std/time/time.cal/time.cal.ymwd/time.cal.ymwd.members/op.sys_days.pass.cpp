// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymwd_time_cal_ymwd_members_op_sys_days_585d26ba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_members_op_sys_days_585d26ba { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_members_op_sys_days_585d26ba (libcis)
