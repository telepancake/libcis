// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymwd_time_cal_ymwd_members_ctor).
// main -> test_time_time_cal_time_cal_ymwd_time_cal_ymwd_members_ctor; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_cal_time_cal_ymwd_time_cal_ymwd_members_ctor()
{
