// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymwd_time_cal_ymwd_members_ctor_dd2ee1ef).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_members_ctor_dd2ee1ef { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_members_ctor_dd2ee1ef (libcis)
