// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymwd_time_cal_ymwd_members_ctor_sys_days_5764f3f7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_members_ctor_sys_days_5764f3f7 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_members_ctor_sys_days_5764f3f7 (libcis)
