// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymwd_time_cal_ymwd_members_plus_minus_equal_year_35105ceb).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_members_plus_minus_equal_year_35105ceb { // libcis
...
} // libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_members_plus_minus_equal_year_35105ceb (libcis)
