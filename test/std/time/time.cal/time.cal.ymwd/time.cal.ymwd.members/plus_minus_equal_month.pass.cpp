// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymwd_time_cal_ymwd_members_plus_minus_equal_month_50bee26b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_members_plus_minus_equal_month_50bee26b { // libcis
...
} // libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_members_plus_minus_equal_month_50bee26b (libcis)
