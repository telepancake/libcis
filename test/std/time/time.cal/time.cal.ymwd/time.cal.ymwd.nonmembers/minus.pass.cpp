// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymwd_time_cal_ymwd_nonmembers_minus_3a5527ec).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_nonmembers_minus_3a5527ec { // libcis
...
} // libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_nonmembers_minus_3a5527ec (libcis)
