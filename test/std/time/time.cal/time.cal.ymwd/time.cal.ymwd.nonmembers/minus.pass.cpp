// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_ymwd_time_cal_ymwd_nonmembers_minus).
// main -> test_time_time_cal_time_cal_ymwd_time_cal_ymwd_nonmembers_minus; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_nonmembers_minus { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_cal_time_cal_ymwd_time_cal_ymwd_nonmembers_minus; // libcis


void test_time_time_cal_time_cal_ymwd_time_cal_ymwd_nonmembers_minus() {
  // year_month_weekday - years
