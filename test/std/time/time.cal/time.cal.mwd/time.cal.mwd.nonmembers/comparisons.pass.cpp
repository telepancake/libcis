// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_mwd_time_cal_mwd_nonmembers_comparisons_e4e4c23d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_mwd_time_cal_mwd_nonmembers_comparisons_e4e4c23d { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_mwd_time_cal_mwd_nonmembers_comparisons_e4e4c23d (libcis)
