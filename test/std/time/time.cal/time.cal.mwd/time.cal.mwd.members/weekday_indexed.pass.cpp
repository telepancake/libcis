// AST-transferred from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_mwd_time_cal_mwd_members_weekday_indexed).
// main -> test_time_time_cal_time_cal_mwd_time_cal_mwd_members_weekday_indexed; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_cal_time_cal_mwd_time_cal_mwd_members_weekday_indexed()
{
