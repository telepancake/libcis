// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_mwd_time_cal_mwd_members_ctor_81e4e7f1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_mwd_time_cal_mwd_members_ctor_81e4e7f1 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_mwd_time_cal_mwd_members_ctor_81e4e7f1 (libcis)
