// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_mwd_time_cal_mwd_members_ok_9c8c0e3d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_mwd_time_cal_mwd_members_ok_9c8c0e3d { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_mwd_time_cal_mwd_members_ok_9c8c0e3d (libcis)
