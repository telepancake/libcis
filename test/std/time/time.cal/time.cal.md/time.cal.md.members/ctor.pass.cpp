// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_md_time_cal_md_members_ctor_cd25457e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_md_time_cal_md_members_ctor_cd25457e { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_md_time_cal_md_members_ctor_cd25457e (libcis)
