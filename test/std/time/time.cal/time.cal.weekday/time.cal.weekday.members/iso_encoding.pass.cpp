// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_weekday_time_cal_weekday_members_iso_encoding_b58c3cbc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_weekday_time_cal_weekday_members_iso_encoding_b58c3cbc { // libcis
...
} // libcis_ns_time_time_cal_time_cal_weekday_time_cal_weekday_members_iso_encoding_b58c3cbc (libcis)
