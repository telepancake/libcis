// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_weekday_time_cal_weekday_members_ctor_local_days_42428306).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_weekday_time_cal_weekday_members_ctor_local_days_42428306 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_weekday_time_cal_weekday_members_ctor_local_days_42428306 (libcis)
