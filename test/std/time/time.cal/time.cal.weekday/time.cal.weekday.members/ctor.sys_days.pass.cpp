// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_weekday_time_cal_weekday_members_ctor_sys_days_89e6b7ba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_weekday_time_cal_weekday_members_ctor_sys_days_89e6b7ba { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_weekday_time_cal_weekday_members_ctor_sys_days_89e6b7ba (libcis)
