// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_weekday_time_cal_weekday_members_plus_minus_equal_42f8588c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_weekday_time_cal_weekday_members_plus_minus_equal_42f8588c { // libcis
...
} // libcis_ns_time_time_cal_time_cal_weekday_time_cal_weekday_members_plus_minus_equal_42f8588c (libcis)
