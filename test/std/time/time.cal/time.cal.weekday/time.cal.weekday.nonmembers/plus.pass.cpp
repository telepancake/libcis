// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_weekday_time_cal_weekday_nonmembers_plus_a622934a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_weekday_time_cal_weekday_nonmembers_plus_a622934a { // libcis
...
} // libcis_ns_time_time_cal_time_cal_weekday_time_cal_weekday_nonmembers_plus_a622934a (libcis)
