// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_mdlast_ctor_98bac901).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_mdlast_ctor_98bac901 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_mdlast_ctor_98bac901 (libcis)
