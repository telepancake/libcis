// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_cal_time_cal_mdlast_ok_ded3795c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_cal_time_cal_mdlast_ok_ded3795c { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_cal_time_cal_mdlast_ok_ded3795c (libcis)
