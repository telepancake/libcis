// transferred+adapted from libc++ by tools/transfer.py (slug=time_years_1b2cfcc1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_years_1b2cfcc1 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_years_1b2cfcc1 (libcis)
