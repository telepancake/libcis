// AST-transferred from libc++ by tools/transfer.py (slug=time_nanoseconds).
// main -> test_time_nanoseconds; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
