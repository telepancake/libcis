// transferred+adapted from libc++ by tools/transfer.py (slug=time_nanoseconds_b8d8bdb5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_nanoseconds_b8d8bdb5 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_nanoseconds_b8d8bdb5 (libcis)
