// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_point_time_point_cast_round_2bd368fd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_point_time_point_cast_round_2bd368fd { // libcis
...
} // libcis_ns_time_time_point_time_point_cast_round_2bd368fd (libcis)
