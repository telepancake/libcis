// AST-transferred from libc++ by tools/transfer.py (slug=time_time_point_time_point_cast_round).
// main -> test_time_time_point_time_point_cast_round; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_point_time_point_cast_round { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_point_time_point_cast_round; // libcis


void test_time_time_point_time_point_cast_round()
{
