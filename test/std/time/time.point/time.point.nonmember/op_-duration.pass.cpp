// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_point_time_point_nonmember_op_duration_2340d4e7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_point_time_point_nonmember_op_duration_2340d4e7 { // libcis
template <class D>
...
} // libcis_ns_time_time_point_time_point_nonmember_op_duration_2340d4e7 (libcis)
