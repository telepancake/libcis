// AST-transferred from libc++ by tools/transfer.py (slug=time_time_point_time_point_nonmember_op_duration).
// main -> test_time_time_point_time_point_nonmember_op_duration; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_point_time_point_nonmember_op_duration { // libcis: isolate file-scope helpers
template <class D>
...
} using namespace libcis_ns_time_time_point_time_point_nonmember_op_duration; // libcis


void test_time_time_point_time_point_nonmember_op_duration()
{
