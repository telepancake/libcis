// AST-transferred from libc++ by tools/transfer.py (slug=time_time_point_time_point_nonmember_op).
// main -> test_time_time_point_time_point_nonmember_op; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_point_time_point_nonmember_op()
{
