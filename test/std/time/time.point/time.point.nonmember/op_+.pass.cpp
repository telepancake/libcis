// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_point_time_point_nonmember_op_0e3cb117).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_point_time_point_nonmember_op_0e3cb117 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_point_time_point_nonmember_op_0e3cb117 (libcis)
