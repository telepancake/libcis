// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_point_time_point_cons_convert_758c3aed).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_point_time_point_cons_convert_758c3aed { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_point_time_point_cons_convert_758c3aed (libcis)
