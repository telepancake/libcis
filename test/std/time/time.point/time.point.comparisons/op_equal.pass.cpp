// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_point_time_point_comparisons_op_equal_23a05187).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_point_time_point_comparisons_op_equal_23a05187 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_point_time_point_comparisons_op_equal_23a05187 (libcis)
