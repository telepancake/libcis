// AST-transferred from libc++ by tools/transfer.py (slug=time_time_point_time_point_comparisons_op_equal).
// main -> test_time_time_point_time_point_comparisons_op_equal; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_time_time_point_time_point_comparisons_op_equal()
{
