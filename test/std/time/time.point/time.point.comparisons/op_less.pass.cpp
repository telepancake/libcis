// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_point_time_point_comparisons_op_less_465432ae).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_point_time_point_comparisons_op_less_465432ae { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_time_point_time_point_comparisons_op_less_465432ae (libcis)
