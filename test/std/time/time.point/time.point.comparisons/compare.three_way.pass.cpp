// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_point_time_point_comparisons_compare_three_way_0f1998af).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_point_time_point_comparisons_compare_three_way_0f1998af { // libcis
...
} // libcis_ns_time_time_point_time_point_comparisons_compare_three_way_0f1998af (libcis)
