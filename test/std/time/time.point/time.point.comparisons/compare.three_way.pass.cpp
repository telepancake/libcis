// AST-transferred from libc++ by tools/transfer.py (slug=time_time_point_time_point_comparisons_compare_three_way).
// main -> test_time_time_point_time_point_comparisons_compare_three_way; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_point_time_point_comparisons_compare_three_way { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_time_time_point_time_point_comparisons_compare_three_way; // libcis


void test_time_time_point_time_point_comparisons_compare_three_way() {
  assert(test());
  static_assert(test());
  return;
}
