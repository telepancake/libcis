// AST-transferred from libc++ by tools/transfer.py (slug=time_seconds).
// main -> test_time_seconds; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
