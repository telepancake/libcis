// transferred+adapted from libc++ by tools/transfer.py (slug=time_milliseconds_1528f07e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_milliseconds_1528f07e { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_milliseconds_1528f07e (libcis)
