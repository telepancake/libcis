// AST-transferred from libc++ by tools/transfer.py (slug=time_milliseconds).
// main -> test_time_milliseconds; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
