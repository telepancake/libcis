// transferred+adapted from libc++ by tools/transfer.py (slug=time_days_6cf568c4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_days_6cf568c4 { // libcis
int main(int, char**)
{
...
} // libcis_ns_time_days_6cf568c4 (libcis)
