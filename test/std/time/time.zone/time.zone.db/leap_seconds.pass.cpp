// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_db_leap_seconds_42d2b7ca).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_db_leap_seconds_42d2b7ca { // libcis
...
} // libcis_ns_time_time_zone_time_zone_db_leap_seconds_42d2b7ca (libcis)
