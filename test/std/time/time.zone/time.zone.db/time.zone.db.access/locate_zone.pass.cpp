// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_db_time_zone_db_access_locate_zone_a95d5a48).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_db_time_zone_db_access_locate_zone_a95d5a48 { // libcis
...
} // libcis_ns_time_time_zone_time_zone_db_time_zone_db_access_locate_zone_a95d5a48 (libcis)
