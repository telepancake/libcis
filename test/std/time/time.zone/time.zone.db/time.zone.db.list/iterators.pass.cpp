// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_db_time_zone_db_list_iterators_e91cd829).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_db_time_zone_db_list_iterators_e91cd829 { // libcis
int main(int, char**) {
...
} // libcis_ns_time_time_zone_time_zone_db_time_zone_db_list_iterators_e91cd829 (libcis)
