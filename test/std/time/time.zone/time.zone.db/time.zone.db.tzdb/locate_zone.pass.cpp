// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_db_time_zone_db_tzdb_locate_zone_4daf6dfd).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_db_time_zone_db_tzdb_locate_zone_4daf6dfd { // libcis
...
} // libcis_ns_time_time_zone_time_zone_db_time_zone_db_tzdb_locate_zone_4daf6dfd (libcis)
