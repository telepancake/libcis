// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_db_time_zone_db_tzdb_current_zone_642e2d4c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_db_time_zone_db_tzdb_current_zone_642e2d4c { // libcis
#ifdef _WIN32
...
} // libcis_ns_time_time_zone_time_zone_db_time_zone_db_tzdb_current_zone_642e2d4c (libcis)
