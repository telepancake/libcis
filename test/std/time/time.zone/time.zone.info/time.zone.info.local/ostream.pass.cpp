// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_info_time_zone_info_local_ostream_447bf4ae).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_info_time_zone_info_local_ostream_447bf4ae { // libcis
...
} // libcis_ns_time_time_zone_time_zone_info_time_zone_info_local_ostream_447bf4ae (libcis)
