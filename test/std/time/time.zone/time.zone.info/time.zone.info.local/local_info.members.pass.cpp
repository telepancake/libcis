// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_info_time_zone_info_local_local_info_members_719992e8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_info_time_zone_info_local_local_info_members_719992e8 { // libcis
...
} // libcis_ns_time_time_zone_time_zone_info_time_zone_info_local_local_info_members_719992e8 (libcis)
