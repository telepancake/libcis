// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_info_time_zone_info_sys_ostream_c8f6b7cc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_info_time_zone_info_sys_ostream_c8f6b7cc { // libcis
...
} // libcis_ns_time_time_zone_time_zone_info_time_zone_info_sys_ostream_c8f6b7cc (libcis)
