// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_exception_time_zone_exception_nonexist_types_ffe890b2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_exception_time_zone_exception_nonexist_types_ffe890b2 { // libcis
int main(int, char**) {
...
} // libcis_ns_time_time_zone_time_zone_exception_time_zone_exception_nonexist_types_ffe890b2 (libcis)
