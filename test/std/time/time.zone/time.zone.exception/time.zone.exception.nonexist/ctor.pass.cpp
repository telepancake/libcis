// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_exception_time_zone_exception_nonexist_ctor_8e26fab5).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_exception_time_zone_exception_nonexist_ctor_8e26fab5 { // libcis
template <class Duration>
static void
...
} // libcis_ns_time_time_zone_time_zone_exception_time_zone_exception_nonexist_ctor_8e26fab5 (libcis)
