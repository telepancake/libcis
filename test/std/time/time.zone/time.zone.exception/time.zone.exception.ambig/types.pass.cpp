// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_exception_time_zone_exception_ambig_types_98ac590a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_exception_time_zone_exception_ambig_types_98ac590a { // libcis
int main(int, char**) {
...
} // libcis_ns_time_time_zone_time_zone_exception_time_zone_exception_ambig_types_98ac590a (libcis)
