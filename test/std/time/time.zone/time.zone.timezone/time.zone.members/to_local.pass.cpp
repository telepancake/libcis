// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_timezone_time_zone_members_to_local_67dcce7b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_timezone_time_zone_members_to_local_67dcce7b { // libcis
int main(int, char**) {
...
} // libcis_ns_time_time_zone_time_zone_timezone_time_zone_members_to_local_67dcce7b (libcis)
