// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_timezone_time_zone_members_to_sys_choose_37805e9b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_timezone_time_zone_members_to_sys_choose_37805e9b { // libcis
...
} // libcis_ns_time_time_zone_time_zone_timezone_time_zone_members_to_sys_choose_37805e9b (libcis)
