// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_timezone_time_zone_members_to_sys_e2781e46).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_timezone_time_zone_members_to_sys_e2781e46 { // libcis
...
} // libcis_ns_time_time_zone_time_zone_timezone_time_zone_members_to_sys_e2781e46 (libcis)
