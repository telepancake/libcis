// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_leap_cons_copy_ba4d890d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_leap_cons_copy_ba4d890d { // libcis
constexpr bool test() {
...
} // libcis_ns_time_time_zone_time_zone_leap_cons_copy_ba4d890d (libcis)
