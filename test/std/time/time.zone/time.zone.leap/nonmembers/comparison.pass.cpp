// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_leap_nonmembers_comparison_dcf7da71).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_leap_nonmembers_comparison_dcf7da71 { // libcis
...
} // libcis_ns_time_time_zone_time_zone_leap_nonmembers_comparison_dcf7da71 (libcis)
