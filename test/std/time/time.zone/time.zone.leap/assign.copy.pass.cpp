// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_leap_assign_copy_b1be9cc4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_leap_assign_copy_b1be9cc4 { // libcis
constexpr bool test() {
...
} // libcis_ns_time_time_zone_time_zone_leap_assign_copy_b1be9cc4 (libcis)
