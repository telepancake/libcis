// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_link_time_zone_link_nonmembers_comparison_d5a06571).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_link_time_zone_link_nonmembers_comparison_d5a06571 { // libcis
...
} // libcis_ns_time_time_zone_time_zone_link_time_zone_link_nonmembers_comparison_d5a06571 (libcis)
