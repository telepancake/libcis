// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_zonedtime_copy_assign_20ded8e6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_zonedtime_copy_assign_20ded8e6 { // libcis
int main(int, char**) {
...
} // libcis_ns_time_time_zone_time_zone_zonedtime_copy_assign_20ded8e6 (libcis)
