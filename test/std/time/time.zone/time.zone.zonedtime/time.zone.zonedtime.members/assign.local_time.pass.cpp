// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_zonedtime_time_zone_zonedtime_members_assign_local_time_8a9ec758).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_zonedtime_time_zone_zonedtime_members_assign_local_time_8a9ec758 { // libcis
...
} // libcis_ns_time_time_zone_time_zone_zonedtime_time_zone_zonedtime_members_assign_local_time_8a9ec758 (libcis)
