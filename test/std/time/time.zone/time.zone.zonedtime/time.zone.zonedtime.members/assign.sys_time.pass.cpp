// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_zonedtime_time_zone_zonedtime_members_assign_sys_time_27fee620).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_zonedtime_time_zone_zonedtime_members_assign_sys_time_27fee620 { // libcis
...
} // libcis_ns_time_time_zone_time_zone_zonedtime_time_zone_zonedtime_members_assign_sys_time_27fee620 (libcis)
