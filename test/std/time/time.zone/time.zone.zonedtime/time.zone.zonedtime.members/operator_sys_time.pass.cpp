// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_zonedtime_time_zone_zonedtime_members_operator_sys_time_c9eb64fc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_zonedtime_time_zone_zonedtime_members_operator_sys_time_c9eb64fc { // libcis
...
} // libcis_ns_time_time_zone_time_zone_zonedtime_time_zone_zonedtime_members_operator_sys_time_c9eb64fc (libcis)
