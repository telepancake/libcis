// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_zonedtime_time_zone_zonedtime_ctor_string_view_local_time_choose_5009e0d6).
//===----------------------------------------------------------------------===/
//
...
namespace libcis_ns_time_time_zone_time_zone_zonedtime_time_zone_zonedtime_ctor_string_view_local_time_choose_5009e0d6 { // libcis
...
} // libcis_ns_time_time_zone_time_zone_zonedtime_time_zone_zonedtime_ctor_string_view_local_time_choose_5009e0d6 (libcis)
