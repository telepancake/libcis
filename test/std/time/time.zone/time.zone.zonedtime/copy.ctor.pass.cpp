// transferred+adapted from libc++ by tools/transfer.py (slug=time_time_zone_time_zone_zonedtime_copy_ctor_6d38f2fc).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_time_time_zone_time_zone_zonedtime_copy_ctor_6d38f2fc { // libcis
int main(int, char**) {
...
} // libcis_ns_time_time_zone_time_zone_zonedtime_copy_ctor_6d38f2fc (libcis)
