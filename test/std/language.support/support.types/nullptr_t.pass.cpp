// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_types_nullptr_t).
// main -> test_language_support_support_types_nullptr_t; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_types_nullptr_t { // libcis: isolate file-scope helpers
struct A
{
    A(std::nullptr_t) {}
};
...
} using namespace libcis_ns_language_support_support_types_nullptr_t; // libcis

TEST_DIAGNOSTIC_POP


void test_language_support_support_types_nullptr_t()
{
