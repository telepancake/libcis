// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_types_nullptr_t_313dc72f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_types_nullptr_t_313dc72f { // libcis
struct A
{
    A(std::nullptr_t) {}
};
...
} // libcis_ns_language_support_support_types_nullptr_t_313dc72f (libcis)
