// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_types_byteops_xor_9ed09913).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_types_byteops_xor_9ed09913 { // libcis
int main(int, char**) {
...
} // libcis_ns_language_support_support_types_byteops_xor_9ed09913 (libcis)
