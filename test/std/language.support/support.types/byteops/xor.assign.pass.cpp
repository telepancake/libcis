// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_types_byteops_xor_assign).
// main -> test_language_support_support_types_byteops_xor_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_types_byteops_xor_assign { // libcis: isolate file-scope helpers
constexpr std::byte test(std::byte b1, std::byte b2) {
    std::byte bret = b1;
    return bret ^= b2;
    }
} using namespace libcis_ns_language_support_support_types_byteops_xor_assign; // libcis



void test_language_support_support_types_byteops_xor_assign() {
