// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_types_byteops_lshift_16e98d56).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_types_byteops_lshift_16e98d56 { // libcis
int main(int, char**) {
...
} // libcis_ns_language_support_support_types_byteops_lshift_16e98d56 (libcis)
