// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_types_byteops_rshift_assign_fed64122).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_types_byteops_rshift_assign_fed64122 { // libcis
...
} // libcis_ns_language_support_support_types_byteops_rshift_assign_fed64122 (libcis)
