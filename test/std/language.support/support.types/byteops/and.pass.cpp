// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_types_byteops_and).
// main -> test_language_support_support_types_byteops_and; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_language_support_support_types_byteops_and() {
