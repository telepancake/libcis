// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_types_byteops_not_f6cdee4a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_types_byteops_not_f6cdee4a { // libcis
int main(int, char**) {
...
} // libcis_ns_language_support_support_types_byteops_not_f6cdee4a (libcis)
