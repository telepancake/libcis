// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_types_byteops_or_6183fe4a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_types_byteops_or_6183fe4a { // libcis
int main(int, char**) {
...
} // libcis_ns_language_support_support_types_byteops_or_6183fe4a (libcis)
