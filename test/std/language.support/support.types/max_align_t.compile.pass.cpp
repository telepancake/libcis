// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_types_max_align_t).
...
namespace libcis_ns_language_support_support_types_max_align_t { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_types_max_align_t; // libcis
