// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_types_max_align_t_bdc26d42).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_types_max_align_t_bdc26d42 { // libcis
...
} // libcis_ns_language_support_support_types_max_align_t_bdc26d42 (libcis)
