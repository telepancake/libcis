// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_types_cstddef).
...
namespace libcis_ns_language_support_support_types_cstddef { // libcis: isolate file-scope helpers
...
#if TEST_STD_VER >= 17
using Byte = std::byte;
} using namespace libcis_ns_language_support_support_types_cstddef; // libcis
