// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_dynamic_destroying_delete_t).
// main -> test_language_support_support_dynamic_destroying_delete_t; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_dynamic_destroying_delete_t { // libcis: isolate file-scope helpers
struct A {
  void *data;
  A();
  ~A();
...
} using namespace libcis_ns_language_support_support_dynamic_destroying_delete_t; // libcis
...
void test_language_support_support_dynamic_destroying_delete_t() {
