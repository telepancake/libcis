// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_dynamic_destroying_delete_t_declaration_dde73cba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_dynamic_destroying_delete_t_declaration_dde73cba { // libcis
...
} // libcis_ns_language_support_support_dynamic_destroying_delete_t_declaration_dde73cba (libcis)
