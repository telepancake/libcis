// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_dynamic_align_val_t).
// main -> test_language_support_support_dynamic_align_val_t; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_dynamic_align_val_t { // libcis: isolate file-scope helpers
constexpr bool test() {
...
} using namespace libcis_ns_language_support_support_dynamic_align_val_t; // libcis


void test_language_support_support_dynamic_align_val_t() {
  test();
  static_assert(test(), "");
