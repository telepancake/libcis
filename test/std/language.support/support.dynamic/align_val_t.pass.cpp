// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_dynamic_align_val_t_c215882d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_dynamic_align_val_t_c215882d { // libcis
constexpr bool test() {
...
} // libcis_ns_language_support_support_dynamic_align_val_t_c215882d (libcis)
