// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_dynamic_new_delete_new_delete_array_new_size_nothrow_8621e4d7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_dynamic_new_delete_new_delete_array_new_size_nothrow_8621e4d7 { // libcis
...
} // libcis_ns_language_support_support_dynamic_new_delete_new_delete_array_new_size_nothrow_8621e4d7 (libcis)
