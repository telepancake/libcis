// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_dynamic_new_delete_new_delete_array_new_size_nothrow_replace_indirect).
// main -> test_language_support_support_dynamic_new_delete_new_delete_array_new_size_nothrow_replace_indirect; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_dynamic_new_delete_new_delete_array_new_size_nothrow_replace_indirect { // libcis: isolate file-scope helpers
int new_called = 0;
int delete_called = 0;
...
} using namespace libcis_ns_language_support_support_dynamic_new_delete_new_delete_array_new_size_nothrow_replace_indirect; // libcis


void test_language_support_support_dynamic_new_delete_new_delete_array_new_size_nothrow_replace_indirect() {
