// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_dynamic_new_delete_new_delete_array_new_size).
// main -> test_language_support_support_dynamic_new_delete_new_delete_array_new_size; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_dynamic_new_delete_new_delete_array_new_size { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_dynamic_new_delete_new_delete_array_new_size; // libcis


void test_language_support_support_dynamic_new_delete_new_delete_array_new_size() {
