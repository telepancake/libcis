// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_dynamic_new_delete_new_delete_array_new_size_align_nothrow).
// main -> test_language_support_support_dynamic_new_delete_new_delete_array_new_size_align_nothrow; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_dynamic_new_delete_new_delete_array_new_size_align_nothrow { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_dynamic_new_delete_new_delete_array_new_size_align_nothrow; // libcis


void test_language_support_support_dynamic_new_delete_new_delete_array_new_size_align_nothrow() {
