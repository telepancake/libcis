// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_dynamic_new_delete_new_delete_array_sized_delete_array).
// main -> test_language_support_support_dynamic_new_delete_new_delete_array_sized_delete_array; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_dynamic_new_delete_new_delete_array_sized_delete_array { // libcis: isolate file-scope helpers
...
//   selected.
struct A { ~A() {} };
} using namespace libcis_ns_language_support_support_dynamic_new_delete_new_delete_array_sized_delete_array; // libcis


void test_language_support_support_dynamic_new_delete_new_delete_array_sized_delete_array()
{
    A* x = new A[3];
