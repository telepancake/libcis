// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_dynamic_new_delete_new_delete_single_sized_delete).
// main -> test_language_support_support_dynamic_new_delete_new_delete_single_sized_delete; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_dynamic_new_delete_new_delete_single_sized_delete { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_dynamic_new_delete_new_delete_single_sized_delete; // libcis


void test_language_support_support_dynamic_new_delete_new_delete_single_sized_delete()
{
    int *x = new int(42);
    DoNotOptimize(x);
