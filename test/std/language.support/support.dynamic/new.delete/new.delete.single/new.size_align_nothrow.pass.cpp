// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_dynamic_new_delete_new_delete_single_new_size_align_nothrow_e77054ba).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_dynamic_new_delete_new_delete_single_new_size_align_nothrow_e77054ba { // libcis
...
} // libcis_ns_language_support_support_dynamic_new_delete_new_delete_single_new_size_align_nothrow_e77054ba (libcis)
