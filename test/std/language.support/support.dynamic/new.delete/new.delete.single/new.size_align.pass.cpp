// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_dynamic_new_delete_new_delete_single_new_size_align_982eaf1b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_dynamic_new_delete_new_delete_single_new_size_align_982eaf1b { // libcis
...
} // libcis_ns_language_support_support_dynamic_new_delete_new_delete_single_new_size_align_982eaf1b (libcis)
