// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_initlist_types_032e99b3).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_initlist_types_032e99b3 { // libcis
struct A {};
...
} // libcis_ns_language_support_support_initlist_types_032e99b3 (libcis)
