// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_initlist_support_initlist_range_begin_end_b6b62080).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_initlist_support_initlist_range_begin_end_b6b62080 { // libcis
...
} // libcis_ns_language_support_support_initlist_support_initlist_range_begin_end_b6b62080 (libcis)
