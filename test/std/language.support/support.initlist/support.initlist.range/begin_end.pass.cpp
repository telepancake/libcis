// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_initlist_support_initlist_range_begin_end).
// main -> test_language_support_support_initlist_support_initlist_range_begin_end; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_initlist_support_initlist_range_begin_end { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_initlist_support_initlist_range_begin_end; // libcis


void test_language_support_support_initlist_support_initlist_range_begin_end() {
  test();
#if TEST_STD_VER >= 14
  static_assert(test(), "");
#endif
