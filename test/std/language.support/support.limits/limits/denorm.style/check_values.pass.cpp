// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_denorm_style_check_values_6f181db1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_denorm_style_check_values_6f181db1 { // libcis
typedef char one;
struct two {one _[2];};
...
} // libcis_ns_language_support_support_limits_limits_denorm_style_check_values_6f181db1 (libcis)
