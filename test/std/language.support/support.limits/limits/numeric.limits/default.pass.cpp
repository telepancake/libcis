// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_default).
// main -> test_language_support_support_limits_limits_numeric_limits_default; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_default { // libcis: isolate file-scope helpers
struct A
{
    A(int i = 0) : data_(i) {}
    int data_;
...
} using namespace libcis_ns_language_support_support_limits_limits_numeric_limits_default; // libcis


void test_language_support_support_limits_limits_numeric_limits_default()
{
