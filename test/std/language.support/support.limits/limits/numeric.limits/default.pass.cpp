// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_default_5c1c7c04).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_default_5c1c7c04 { // libcis
struct A
{
    A(int i = 0) : data_(i) {}
    int data_;
...
} // libcis_ns_language_support_support_limits_limits_numeric_limits_default_5c1c7c04 (libcis)
