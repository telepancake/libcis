// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_is_specialized_08358f2d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_is_specialized_08358f2d { // libcis
struct Test {
  template <class T>
  void operator()() {
...
} // libcis_ns_language_support_support_limits_limits_is_specialized_08358f2d (libcis)
