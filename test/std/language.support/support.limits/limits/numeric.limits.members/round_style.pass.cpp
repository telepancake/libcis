// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_round_style).
// main -> test_language_support_support_limits_limits_numeric_limits_members_round_style; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_round_style { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_round_style; // libcis


void test_language_support_support_limits_limits_numeric_limits_members_round_style()
{
