// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_max_4e89059f).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_max_4e89059f { // libcis
template <class T>
void
test(T expected)
{
...
} // libcis_ns_language_support_support_limits_limits_numeric_limits_members_max_4e89059f (libcis)
