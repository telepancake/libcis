// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_max).
// main -> test_language_support_support_limits_limits_numeric_limits_members_max; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_max { // libcis: isolate file-scope helpers
template <class T>
void
test(T expected)
{
...
} using namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_max; // libcis


void test_language_support_support_limits_limits_numeric_limits_members_max()
{
    test<bool>(true);
    test<char>(CHAR_MAX);
