// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_min).
// main -> test_language_support_support_limits_limits_numeric_limits_members_min; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_min { // libcis: isolate file-scope helpers
template <class T>
void
test(T expected)
{
...
} using namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_min; // libcis


void test_language_support_support_limits_limits_numeric_limits_members_min()
{
    test<bool>(false);
    test<char>(CHAR_MIN);
