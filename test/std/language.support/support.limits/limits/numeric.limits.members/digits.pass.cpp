// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_digits).
// main -> test_language_support_support_limits_limits_numeric_limits_members_digits; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_digits { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_digits; // libcis


void test_language_support_support_limits_limits_numeric_limits_members_digits()
{
    test<bool, 1>();
