// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_const_data_members_1ad66d1c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_const_data_members_1ad66d1c { // libcis
template <class T>
void test(const T &) {}
...
} // libcis_ns_language_support_support_limits_limits_numeric_limits_members_const_data_members_1ad66d1c (libcis)
