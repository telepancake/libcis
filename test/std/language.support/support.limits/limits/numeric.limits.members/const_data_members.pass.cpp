// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_const_data_members).
// main -> test_language_support_support_limits_limits_numeric_limits_members_const_data_members; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_const_data_members { // libcis: isolate file-scope helpers
template <class T>
void test(const T &) {}
...
struct other {};
} using namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_const_data_members; // libcis


void test_language_support_support_limits_limits_numeric_limits_members_const_data_members()
{
    // bool
