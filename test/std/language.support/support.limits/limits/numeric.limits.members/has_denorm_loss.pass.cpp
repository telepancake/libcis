// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_has_denorm_loss_af16a09e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_has_denorm_loss_af16a09e { // libcis
...
} // libcis_ns_language_support_support_limits_limits_numeric_limits_members_has_denorm_loss_af16a09e (libcis)
