// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_has_denorm).
// main -> test_language_support_support_limits_limits_numeric_limits_members_has_denorm; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_has_denorm { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_has_denorm; // libcis


void test_language_support_support_limits_limits_numeric_limits_members_has_denorm()
{
