// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_lowest_17b0f9e8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_lowest_17b0f9e8 { // libcis
template <class T>
void
test(T expected)
{
...
} // libcis_ns_language_support_support_limits_limits_numeric_limits_members_lowest_17b0f9e8 (libcis)
