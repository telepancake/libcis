// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_quiet_NaN_a396cfc8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_quiet_NaN_a396cfc8 { // libcis
template <class T>
void
...
} // libcis_ns_language_support_support_limits_limits_numeric_limits_members_quiet_NaN_a396cfc8 (libcis)
