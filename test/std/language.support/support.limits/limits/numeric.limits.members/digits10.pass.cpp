// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_digits10).
// main -> test_language_support_support_limits_limits_numeric_limits_members_digits10; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_digits10 { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_digits10; // libcis


void test_language_support_support_limits_limits_numeric_limits_members_digits10()
{
    test<bool, 0>();
    test<char, 2>();
    test<signed char, 2>();
