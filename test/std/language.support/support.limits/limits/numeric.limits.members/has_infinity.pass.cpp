// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_has_infinity_6e0b1a6e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_has_infinity_6e0b1a6e { // libcis
...
} // libcis_ns_language_support_support_limits_limits_numeric_limits_members_has_infinity_6e0b1a6e (libcis)
