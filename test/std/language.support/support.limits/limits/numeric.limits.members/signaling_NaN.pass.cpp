// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_limits_limits_numeric_limits_members_signaling_NaN_bfa9650a).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_limits_numeric_limits_members_signaling_NaN_bfa9650a { // libcis
template <class T>
void
...
} // libcis_ns_language_support_support_limits_limits_numeric_limits_members_signaling_NaN_bfa9650a (libcis)
