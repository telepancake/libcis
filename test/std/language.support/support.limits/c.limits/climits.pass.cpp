// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_limits_c_limits_climits_b11602a4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_c_limits_climits_b11602a4 { // libcis
int main(int, char**)
{
...
} // libcis_ns_language_support_support_limits_c_limits_climits_b11602a4 (libcis)
