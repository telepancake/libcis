// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_limits_c_limits_climits).
// main -> test_language_support_support_limits_c_limits_climits; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_language_support_support_limits_c_limits_climits()
{
