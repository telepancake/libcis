// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_limits_c_limits_cfloat).
// main -> test_language_support_support_limits_c_limits_cfloat; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_language_support_support_limits_c_limits_cfloat()
{
