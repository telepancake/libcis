// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_limits_c_limits_cfloat_9c17db16).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_limits_c_limits_cfloat_9c17db16 { // libcis
int main(int, char**)
{
...
} // libcis_ns_language_support_support_limits_c_limits_cfloat_9c17db16 (libcis)
