// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_srcloc_general_aa66bef2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_srcloc_general_aa66bef2 { // libcis
...
} // libcis_ns_language_support_support_srcloc_general_aa66bef2 (libcis)
