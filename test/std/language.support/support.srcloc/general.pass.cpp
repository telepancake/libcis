// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_srcloc_general).
// main -> test_language_support_support_srcloc_general; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_srcloc_general { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_srcloc_general; // libcis


// and inside a function.
void test_language_support_support_srcloc_general() {
  auto local =
#line 2000
      std::source_location::current();
