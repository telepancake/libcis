// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_runtime_cstdlib_aligned_alloc).
...
namespace libcis_ns_language_support_support_runtime_cstdlib_aligned_alloc { // libcis: isolate file-scope helpers
static_assert(std::is_same<decltype(std::aligned_alloc(1, 0)), void*>::value, "");
} using namespace libcis_ns_language_support_support_runtime_cstdlib_aligned_alloc; // libcis
