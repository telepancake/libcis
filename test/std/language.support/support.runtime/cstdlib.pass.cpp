// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_runtime_cstdlib_e63efe28).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_runtime_cstdlib_e63efe28 { // libcis
...
} // libcis_ns_language_support_support_runtime_cstdlib_e63efe28 (libcis)
