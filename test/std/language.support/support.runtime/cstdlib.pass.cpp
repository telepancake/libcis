// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_runtime_cstdlib).
// main -> test_language_support_support_runtime_cstdlib; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_runtime_cstdlib { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_runtime_cstdlib; // libcis


void test_language_support_support_runtime_cstdlib()
{
    std::size_t s = 0;
    ((void)s);
