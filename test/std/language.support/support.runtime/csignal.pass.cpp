// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_runtime_csignal_0ed7f710).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_runtime_csignal_0ed7f710 { // libcis
int main(int, char**)
{
...
} // libcis_ns_language_support_support_runtime_csignal_0ed7f710 (libcis)
