// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_runtime_ctime_timespec_c781b154).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_runtime_ctime_timespec_c781b154 { // libcis
std::timespec tmspec = {};
static_assert(std::is_same<decltype(std::timespec_get(&tmspec, 0)), int>::value, "");
} // libcis_ns_language_support_support_runtime_ctime_timespec_c781b154 (libcis)
