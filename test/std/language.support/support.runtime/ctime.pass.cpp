// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_runtime_ctime_dbf5aafa).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_runtime_ctime_dbf5aafa { // libcis
int main(int, char**)
{
    std::clock_t c = 0;
    std::size_t s = 0;
...
} // libcis_ns_language_support_support_runtime_ctime_dbf5aafa (libcis)
