// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_runtime_ctime).
// main -> test_language_support_support_runtime_ctime; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_language_support_support_runtime_ctime()
{
    std::clock_t c = 0;
    std::size_t s = 0;
    std::time_t t = 0;
