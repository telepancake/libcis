// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_runtime_csetjmp_4866c985).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_runtime_csetjmp_4866c985 { // libcis
int main(int, char**) {
  std::jmp_buf jb;
...
} // libcis_ns_language_support_support_runtime_csetjmp_4866c985 (libcis)
