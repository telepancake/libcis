// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_coroutines_coroutine_trivial_awaitables_suspend_never).
// main -> test_language_support_support_coroutines_coroutine_trivial_awaitables_suspend_never; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_coroutine_trivial_awaitables_suspend_never { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_coroutines_coroutine_trivial_awaitables_suspend_never; // libcis


void test_language_support_support_coroutines_coroutine_trivial_awaitables_suspend_never()
{
