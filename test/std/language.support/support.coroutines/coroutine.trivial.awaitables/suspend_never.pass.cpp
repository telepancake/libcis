// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_coroutines_coroutine_trivial_awaitables_suspend_never_cb9592d1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_coroutine_trivial_awaitables_suspend_never_cb9592d1 { // libcis
...
} // libcis_ns_language_support_support_coroutines_coroutine_trivial_awaitables_suspend_never_cb9592d1 (libcis)
