// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_coroutines_coroutine_trivial_awaitables_suspend_always_3ed947b0).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_coroutine_trivial_awaitables_suspend_always_3ed947b0 { // libcis
...
} // libcis_ns_language_support_support_coroutines_coroutine_trivial_awaitables_suspend_always_3ed947b0 (libcis)
