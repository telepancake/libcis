// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_coroutines_coroutine_trivial_awaitables_suspend_always).
// main -> test_language_support_support_coroutines_coroutine_trivial_awaitables_suspend_always; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_coroutine_trivial_awaitables_suspend_always { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_coroutines_coroutine_trivial_awaitables_suspend_always; // libcis


void test_language_support_support_coroutines_coroutine_trivial_awaitables_suspend_always()
{
