// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_coroutines_end_to_end_bool_await_suspend_5cc854f8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_end_to_end_bool_await_suspend_5cc854f8 { // libcis
struct coro_t {
  struct promise_type {
...
} // libcis_ns_language_support_support_coroutines_end_to_end_bool_await_suspend_5cc854f8 (libcis)
