// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_coroutines_end_to_end_multishot_func).
// main -> test_language_support_support_coroutines_end_to_end_multishot_func; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_end_to_end_multishot_func { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_coroutines_end_to_end_multishot_func; // libcis


void test_language_support_support_coroutines_end_to_end_multishot_func() {
