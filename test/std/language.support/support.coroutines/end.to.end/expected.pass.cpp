// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_coroutines_end_to_end_expected).
// main -> test_language_support_support_coroutines_end_to_end_expected; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_end_to_end_expected { // libcis: isolate file-scope helpers
struct error_tag { };
...
} using namespace libcis_ns_language_support_support_coroutines_end_to_end_expected; // libcis
...
void test_language_support_support_coroutines_end_to_end_expected() {
  auto c1 = f1();
