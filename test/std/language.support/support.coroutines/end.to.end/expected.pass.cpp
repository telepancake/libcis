// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_coroutines_end_to_end_expected_415648bf).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_end_to_end_expected_415648bf { // libcis
struct error_tag { };
...
} // libcis_ns_language_support_support_coroutines_end_to_end_expected_415648bf (libcis)
