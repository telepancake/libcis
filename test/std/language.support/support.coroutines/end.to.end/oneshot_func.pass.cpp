// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_coroutines_end_to_end_oneshot_func_5aeb0442).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_end_to_end_oneshot_func_5aeb0442 { // libcis
...
} // libcis_ns_language_support_support_coroutines_end_to_end_oneshot_func_5aeb0442 (libcis)
