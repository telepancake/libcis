// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_coroutines_end_to_end_generator_c5be8e8b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_end_to_end_generator_c5be8e8b { // libcis
...
} // libcis_ns_language_support_support_coroutines_end_to_end_generator_c5be8e8b (libcis)
