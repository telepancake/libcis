// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_coroutines_end_to_end_generator).
// main -> test_language_support_support_coroutines_end_to_end_generator; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_end_to_end_generator { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_support_coroutines_end_to_end_generator; // libcis


void test_language_support_support_coroutines_end_to_end_generator() {
  test_count();
  test_range();
  test_mini_generator();
