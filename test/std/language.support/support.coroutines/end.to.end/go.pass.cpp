// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_coroutines_end_to_end_go).
// main -> test_language_support_support_coroutines_end_to_end_go; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_end_to_end_go { // libcis: isolate file-scope helpers
bool cancel = false;
...
} using namespace libcis_ns_language_support_support_coroutines_end_to_end_go; // libcis
...
void test_language_support_support_coroutines_end_to_end_go() {
  for (int i = 0; i < N; ++i)
    pusher(c[i], c[i + 1]);
