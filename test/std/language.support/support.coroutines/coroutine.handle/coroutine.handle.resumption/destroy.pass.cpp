// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_coroutines_coroutine_handle_coroutine_handle_resumption_destroy_b78d6b62).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_coroutine_handle_coroutine_handle_resumption_destroy_b78d6b62 { // libcis
template <class H>
...
} // libcis_ns_language_support_support_coroutines_coroutine_handle_coroutine_handle_resumption_destroy_b78d6b62 (libcis)
