// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_coroutines_coroutine_handle_coroutine_handle_resumption_resume_cf3cde90).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_coroutine_handle_coroutine_handle_resumption_resume_cf3cde90 { // libcis
template <class H>
...
} // libcis_ns_language_support_support_coroutines_coroutine_handle_coroutine_handle_resumption_resume_cf3cde90 (libcis)
