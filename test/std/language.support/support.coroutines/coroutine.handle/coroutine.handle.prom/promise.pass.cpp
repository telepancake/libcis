// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_coroutines_coroutine_handle_coroutine_handle_prom_promise_3a3eaf70).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_coroutine_handle_coroutine_handle_prom_promise_3a3eaf70 { // libcis
struct MyCoro {
  struct promise_type {
...
} // libcis_ns_language_support_support_coroutines_coroutine_handle_coroutine_handle_prom_promise_3a3eaf70 (libcis)
