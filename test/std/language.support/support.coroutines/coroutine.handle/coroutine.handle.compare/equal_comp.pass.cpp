// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_support_coroutines_coroutine_handle_coroutine_handle_compare_equal_comp_662b1d6b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_coroutine_handle_coroutine_handle_compare_equal_comp_662b1d6b { // libcis
template <class C>
...
} // libcis_ns_language_support_support_coroutines_coroutine_handle_coroutine_handle_compare_equal_comp_662b1d6b (libcis)
