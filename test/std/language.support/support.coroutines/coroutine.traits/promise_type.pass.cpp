// AST-transferred from libc++ by tools/transfer.py (slug=language_support_support_coroutines_coroutine_traits_promise_type).
// main -> test_language_support_support_coroutines_coroutine_traits_promise_type; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_support_coroutines_coroutine_traits_promise_type { // libcis: isolate file-scope helpers
...
struct E {};
} using namespace libcis_ns_language_support_support_coroutines_coroutine_traits_promise_type; // libcis
...
void test_language_support_support_coroutines_coroutine_traits_promise_type()
{
  {
    check_type<A*, A>();
