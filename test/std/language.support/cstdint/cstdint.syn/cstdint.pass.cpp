// AST-transferred from libc++ by tools/transfer.py (slug=language_support_cstdint_cstdint_syn_cstdint).
// main -> test_language_support_cstdint_cstdint_syn_cstdint; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_language_support_cstdint_cstdint_syn_cstdint()
{
    // typedef std::int8_t
