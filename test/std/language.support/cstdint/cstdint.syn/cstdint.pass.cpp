// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cstdint_cstdint_syn_cstdint_64df078d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cstdint_cstdint_syn_cstdint_64df078d { // libcis
int main(int, char**)
{
    // typedef std::int8_t
...
} // libcis_ns_language_support_cstdint_cstdint_syn_cstdint_64df078d (libcis)
