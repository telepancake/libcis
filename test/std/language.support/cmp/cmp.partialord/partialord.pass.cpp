// AST-transferred from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_partialord_partialord).
// main -> test_language_support_cmp_cmp_partialord_partialord; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_partialord_partialord { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_cmp_cmp_partialord_partialord; // libcis


void test_language_support_cmp_cmp_partialord_partialord() {
  test_static_members();
  test_signatures();
  test_equality();
