// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_partialord_partialord_c185e76d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_partialord_partialord_c185e76d { // libcis
...
} // libcis_ns_language_support_cmp_cmp_partialord_partialord_c185e76d (libcis)
