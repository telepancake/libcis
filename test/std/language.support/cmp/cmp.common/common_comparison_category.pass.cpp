// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_common_common_comparison_category_53b6b80b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_common_common_comparison_category_53b6b80b { // libcis
...
} // libcis_ns_language_support_cmp_cmp_common_common_comparison_category_53b6b80b (libcis)
