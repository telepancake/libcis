// AST-transferred from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_common_common_comparison_category).
// main -> test_language_support_cmp_cmp_common_common_comparison_category; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_common_common_comparison_category { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_cmp_cmp_common_common_comparison_category; // libcis



// [class.spaceship]p4: The 'common comparison type' U of a possibly-empty list
//   of 'n' types T0, T1, ..., TN, is defined as follows:
void test_language_support_cmp_cmp_common_common_comparison_category() {
