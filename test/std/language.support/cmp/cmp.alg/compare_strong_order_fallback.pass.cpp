// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_alg_compare_strong_order_fallback_d99ffd0c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_alg_compare_strong_order_fallback_d99ffd0c { // libcis
...
} // libcis_ns_language_support_cmp_cmp_alg_compare_strong_order_fallback_d99ffd0c (libcis)
