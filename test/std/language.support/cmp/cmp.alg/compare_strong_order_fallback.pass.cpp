// AST-transferred from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_alg_compare_strong_order_fallback).
// main -> test_language_support_cmp_cmp_alg_compare_strong_order_fallback; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_alg_compare_strong_order_fallback { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_cmp_cmp_alg_compare_strong_order_fallback; // libcis
...
void test_language_support_cmp_cmp_alg_compare_strong_order_fallback()
{
    test_1_1();
    test_1_2();
    test_1_3<float>();
