// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_alg_compare_weak_order_fallback_739bb0ec).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_alg_compare_weak_order_fallback_739bb0ec { // libcis
...
} // libcis_ns_language_support_cmp_cmp_alg_compare_weak_order_fallback_739bb0ec (libcis)
