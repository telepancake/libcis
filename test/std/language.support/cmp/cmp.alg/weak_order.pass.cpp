// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_alg_weak_order_05f0ee8b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_alg_weak_order_05f0ee8b { // libcis
...
} // libcis_ns_language_support_cmp_cmp_alg_weak_order_05f0ee8b (libcis)
