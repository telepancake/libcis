// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_alg_strong_order_87b9cad4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_alg_strong_order_87b9cad4 { // libcis
...
} // libcis_ns_language_support_cmp_cmp_alg_strong_order_87b9cad4 (libcis)
