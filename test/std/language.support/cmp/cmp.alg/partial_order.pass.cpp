// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_alg_partial_order_34916a4c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_alg_partial_order_34916a4c { // libcis
...
} // libcis_ns_language_support_cmp_cmp_alg_partial_order_34916a4c (libcis)
