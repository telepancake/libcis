// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_alg_compare_partial_order_fallback_7d33197c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_alg_compare_partial_order_fallback_7d33197c { // libcis
...
} // libcis_ns_language_support_cmp_cmp_alg_compare_partial_order_fallback_7d33197c (libcis)
