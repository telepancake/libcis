// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_strongord_strongord_cc0ae7c9).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_strongord_strongord_cc0ae7c9 { // libcis
...
} // libcis_ns_language_support_cmp_cmp_strongord_strongord_cc0ae7c9 (libcis)
