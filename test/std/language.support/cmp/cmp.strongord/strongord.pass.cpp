// AST-transferred from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_strongord_strongord).
// main -> test_language_support_cmp_cmp_strongord_strongord; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_strongord_strongord { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_cmp_cmp_strongord_strongord; // libcis


void test_language_support_cmp_cmp_strongord_strongord() {
  test_static_members();
  test_signatures();
  test_equality();
