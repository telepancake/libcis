// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_concept_three_way_comparable_8705f7a8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_concept_three_way_comparable_8705f7a8 { // libcis
...
} // libcis_ns_language_support_cmp_cmp_concept_three_way_comparable_8705f7a8 (libcis)
 // namespace user_defined
