// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_concept_three_way_comparable_with_d64555d6).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_concept_three_way_comparable_with_d64555d6 { // libcis
...
} // libcis_ns_language_support_cmp_cmp_concept_three_way_comparable_with_d64555d6 (libcis)
 // namespace user_defined
