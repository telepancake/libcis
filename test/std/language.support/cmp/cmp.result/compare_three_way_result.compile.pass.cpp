// AST-transferred from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_result_compare_three_way_result).
...
namespace libcis_ns_language_support_cmp_cmp_result_compare_three_way_result { // libcis: isolate file-scope helpers
template<class T>
...
ASSERT_SAME_TYPE(std::compare_three_way_result_t<const D&&, const D&&>, std::weak_ordering);
} using namespace libcis_ns_language_support_cmp_cmp_result_compare_three_way_result; // libcis
