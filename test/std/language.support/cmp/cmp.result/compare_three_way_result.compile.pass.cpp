// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_result_compare_three_way_result_62915e5b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_result_compare_three_way_result_62915e5b { // libcis
template<class T>
...
ASSERT_SAME_TYPE(std::compare_three_way_result_t<const D&&, const D&&>, std::weak_ordering);
} // libcis_ns_language_support_cmp_cmp_result_compare_three_way_result_62915e5b (libcis)
