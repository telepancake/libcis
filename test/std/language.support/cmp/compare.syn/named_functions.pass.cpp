// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_compare_syn_named_functions_9944a1c4).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_compare_syn_named_functions_9944a1c4 { // libcis
constexpr bool test()
{
...
} // libcis_ns_language_support_cmp_compare_syn_named_functions_9944a1c4 (libcis)
