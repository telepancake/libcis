// AST-transferred from libc++ by tools/transfer.py (slug=language_support_cmp_compare_syn_named_functions).
// main -> test_language_support_cmp_compare_syn_named_functions; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_compare_syn_named_functions { // libcis: isolate file-scope helpers
constexpr bool test()
{
...
} using namespace libcis_ns_language_support_cmp_compare_syn_named_functions; // libcis


void test_language_support_cmp_compare_syn_named_functions() {
    test();
    static_assert(test());
