// transferred+adapted from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_weakord_weakord_0566ead2).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_weakord_weakord_0566ead2 { // libcis
...
} // libcis_ns_language_support_cmp_cmp_weakord_weakord_0566ead2 (libcis)
