// AST-transferred from libc++ by tools/transfer.py (slug=language_support_cmp_cmp_weakord_weakord).
// main -> test_language_support_cmp_cmp_weakord_weakord; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_language_support_cmp_cmp_weakord_weakord { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_language_support_cmp_cmp_weakord_weakord; // libcis


void test_language_support_cmp_cmp_weakord_weakord() {
  test_static_members();
  test_signatures();
  test_equality();
