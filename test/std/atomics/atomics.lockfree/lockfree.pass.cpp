// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_lockfree_lockfree_be9b9594).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_lockfree_lockfree_be9b9594 { // libcis
int main(int, char**)
{
...
} // libcis_ns_atomics_atomics_lockfree_lockfree_be9b9594 (libcis)
