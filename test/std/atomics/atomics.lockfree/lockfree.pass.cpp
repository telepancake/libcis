// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_lockfree_lockfree).
// main -> test_atomics_atomics_lockfree_lockfree; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_atomics_atomics_lockfree_lockfree()
{
