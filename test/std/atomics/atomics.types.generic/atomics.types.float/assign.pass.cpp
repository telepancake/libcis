// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_atomics_types_float_assign_cde40e96).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_assign_cde40e96 { // libcis
template <class T>
...
} // libcis_ns_atomics_atomics_types_generic_atomics_types_float_assign_cde40e96 (libcis)
