// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_atomics_types_float_operator_minus_equals).
// main -> test_atomics_atomics_types_generic_atomics_types_float_operator_minus_equals; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_operator_minus_equals { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_operator_minus_equals; // libcis


void test_atomics_atomics_types_generic_atomics_types_float_operator_minus_equals() {
  test<float>();
  test<double>();
