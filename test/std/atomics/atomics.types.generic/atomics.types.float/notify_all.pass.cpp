// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_atomics_types_float_notify_all).
// main -> test_atomics_atomics_types_generic_atomics_types_float_notify_all; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_notify_all { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_notify_all; // libcis


void test_atomics_atomics_types_generic_atomics_types_float_notify_all() {
  test<float>();
  test<double>();
