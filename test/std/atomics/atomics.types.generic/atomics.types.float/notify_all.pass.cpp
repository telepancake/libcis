// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_atomics_types_float_notify_all_7a3479c7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_notify_all_7a3479c7 { // libcis
template <class T>
...
} // libcis_ns_atomics_atomics_types_generic_atomics_types_float_notify_all_7a3479c7 (libcis)
