// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_atomics_types_float_fetch_sub).
// main -> test_atomics_atomics_types_generic_atomics_types_float_fetch_sub; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_fetch_sub { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_fetch_sub; // libcis


void test_atomics_atomics_types_generic_atomics_types_float_fetch_sub() {
  test<float>();
  test<double>();
