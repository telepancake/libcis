// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_atomics_types_float_fetch_add_3f2ab2ce).
//===----------------------------------------------------------------------===//
//
...
#  include <thread>
#endif
namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_fetch_add_3f2ab2ce { // libcis
template <class T>
...
} // libcis_ns_atomics_atomics_types_generic_atomics_types_float_fetch_add_3f2ab2ce (libcis)
