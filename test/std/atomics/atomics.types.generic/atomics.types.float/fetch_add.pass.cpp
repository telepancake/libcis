// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_atomics_types_float_fetch_add).
// main -> test_atomics_atomics_types_generic_atomics_types_float_fetch_add; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
#  include <thread>
#endif
namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_fetch_add { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_fetch_add; // libcis


void test_atomics_atomics_types_generic_atomics_types_float_fetch_add() {
  test<float>();
  test<double>();
