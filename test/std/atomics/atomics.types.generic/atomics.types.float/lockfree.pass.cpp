// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_atomics_types_float_lockfree_5f6a3e67).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_lockfree_5f6a3e67 { // libcis
template <class T>
...
} // libcis_ns_atomics_atomics_types_generic_atomics_types_float_lockfree_5f6a3e67 (libcis)
