// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_atomics_types_float_load).
// main -> test_atomics_atomics_types_generic_atomics_types_float_load; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_load { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_load; // libcis


void test_atomics_atomics_types_generic_atomics_types_float_load() {
  test<float>();
  test<double>();
