// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_atomics_types_float_compare_exchange_strong_e1eea4b7).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_compare_exchange_strong_e1eea4b7 { // libcis
...
} // libcis_ns_atomics_atomics_types_generic_atomics_types_float_compare_exchange_strong_e1eea4b7 (libcis)
