// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_atomics_types_float_store_70390bf1).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_store_70390bf1 { // libcis
template <class T>
...
} // libcis_ns_atomics_atomics_types_generic_atomics_types_float_store_70390bf1 (libcis)
