// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_atomics_types_float_compare_exchange_weak).
// main -> test_atomics_atomics_types_generic_atomics_types_float_compare_exchange_weak; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_compare_exchange_weak { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_compare_exchange_weak; // libcis


void test_atomics_atomics_types_generic_atomics_types_float_compare_exchange_weak() {
  test<float>();
  test<double>();
