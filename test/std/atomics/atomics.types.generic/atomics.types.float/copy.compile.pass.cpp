// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_atomics_types_float_copy).
...
namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_copy { // libcis: isolate file-scope helpers
template <class T>
void test() {
...
} using namespace libcis_ns_atomics_atomics_types_generic_atomics_types_float_copy; // libcis
