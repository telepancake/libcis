// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_integral_typedefs).
// main -> test_atomics_atomics_types_generic_integral_typedefs; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_atomics_atomics_types_generic_integral_typedefs()
{
