// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_integral_typedefs_b21df669).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_integral_typedefs_b21df669 { // libcis
int main(int, char**)
{
...
} // libcis_ns_atomics_atomics_types_generic_integral_typedefs_b21df669 (libcis)
