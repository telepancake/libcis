// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_cas_non_power_of_2).
// main -> test_atomics_atomics_types_generic_cas_non_power_of_2; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_cas_non_power_of_2 { // libcis: isolate file-scope helpers
template <int Size>
struct S {
  char data[Size];
...
} using namespace libcis_ns_atomics_atomics_types_generic_cas_non_power_of_2; // libcis


void test_atomics_atomics_types_generic_cas_non_power_of_2() {
  test<1>();
  test<2>();
  test<3>();
  test<4>();
