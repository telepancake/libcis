// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_pointer).
...
namespace libcis_ns_atomics_atomics_types_generic_pointer { // libcis: isolate file-scope helpers
template <class T>
void test() {
  T a;
...
} using namespace libcis_ns_atomics_atomics_types_generic_pointer; // libcis
