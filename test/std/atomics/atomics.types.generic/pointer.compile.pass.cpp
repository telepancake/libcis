// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_pointer_82fcb76b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_pointer_82fcb76b { // libcis
template <class T>
void test() {
  T a;
...
} // libcis_ns_atomics_atomics_types_generic_pointer_82fcb76b (libcis)
