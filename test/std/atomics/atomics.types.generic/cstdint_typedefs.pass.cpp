// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_cstdint_typedefs_6b617cda).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_cstdint_typedefs_6b617cda { // libcis
int main(int, char**)
{
...
} // libcis_ns_atomics_atomics_types_generic_cstdint_typedefs_6b617cda (libcis)
