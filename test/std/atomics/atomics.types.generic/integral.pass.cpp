// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_integral_a1fc4b13).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_integral_a1fc4b13 { // libcis
...
} // libcis_ns_atomics_atomics_types_generic_integral_a1fc4b13 (libcis)
