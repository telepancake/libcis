// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_integral).
// main -> test_atomics_atomics_types_generic_integral; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_integral { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_atomics_atomics_types_generic_integral; // libcis



void test_atomics_atomics_types_generic_integral()
{
