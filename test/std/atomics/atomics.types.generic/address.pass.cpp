// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_address).
// main -> test_atomics_atomics_types_generic_address; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_address { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_atomics_atomics_types_generic_address; // libcis


void test_atomics_atomics_types_generic_address()
{
