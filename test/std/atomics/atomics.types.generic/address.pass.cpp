// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_address_3572b5ac).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_address_3572b5ac { // libcis
...
} // libcis_ns_atomics_atomics_types_generic_address_3572b5ac (libcis)
