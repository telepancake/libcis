// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_general_d43adbef).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_generic_general_d43adbef { // libcis
template <class T>
void test() {
  T a;
...
} // libcis_ns_atomics_atomics_types_generic_general_d43adbef (libcis)
