// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_generic_general).
...
namespace libcis_ns_atomics_atomics_types_generic_general { // libcis: isolate file-scope helpers
template <class T>
void test() {
  T a;
...
} using namespace libcis_ns_atomics_atomics_types_generic_general; // libcis
