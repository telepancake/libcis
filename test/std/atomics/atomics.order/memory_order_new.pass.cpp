// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_order_memory_order_new_9d14332b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_order_memory_order_new_9d14332b { // libcis
int main(int, char**)
{
...
} // libcis_ns_atomics_atomics_order_memory_order_new_9d14332b (libcis)
