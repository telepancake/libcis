// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_order_memory_order_1dcb3192).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_order_memory_order_1dcb3192 { // libcis
int main(int, char**)
{
...
} // libcis_ns_atomics_atomics_order_memory_order_1dcb3192 (libcis)
