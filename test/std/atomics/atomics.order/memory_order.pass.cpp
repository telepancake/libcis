// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_order_memory_order).
// main -> test_atomics_atomics_order_memory_order; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_atomics_atomics_order_memory_order()
{
