// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_ref_compare_exchange_strong_d9ffd5d2).
//
...
namespace libcis_ns_atomics_atomics_ref_compare_exchange_strong_d9ffd5d2 { // libcis
template <typename T>
...
} // libcis_ns_atomics_atomics_ref_compare_exchange_strong_d9ffd5d2 (libcis)
