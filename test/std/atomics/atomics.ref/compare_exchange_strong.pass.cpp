// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_ref_compare_exchange_strong).
// main -> test_atomics_atomics_ref_compare_exchange_strong; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_ref_compare_exchange_strong { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_atomics_atomics_ref_compare_exchange_strong; // libcis


void test_atomics_atomics_ref_compare_exchange_strong() {
