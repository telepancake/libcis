// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_ref_store_e039043a).
//
...
namespace libcis_ns_atomics_atomics_ref_store_e039043a { // libcis
template <typename T>
struct TestStore {
  void operator()() const {
    T x(T(1));
...
} // libcis_ns_atomics_atomics_ref_store_e039043a (libcis)
