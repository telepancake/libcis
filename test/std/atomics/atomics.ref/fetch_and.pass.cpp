// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_ref_fetch_and).
// main -> test_atomics_atomics_ref_fetch_and; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_ref_fetch_and { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_atomics_atomics_ref_fetch_and; // libcis


void test_atomics_atomics_ref_fetch_and() {
