// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_ref_convert_f249a560).
//
...
namespace libcis_ns_atomics_atomics_ref_convert_f249a560 { // libcis
template <typename T>
struct TestConvert {
  void operator()() const {
    T x(T(1));
...
} // libcis_ns_atomics_atomics_ref_convert_f249a560 (libcis)
