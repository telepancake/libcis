// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_ref_fetch_xor_007ed263).
//
...
namespace libcis_ns_atomics_atomics_ref_fetch_xor_007ed263 { // libcis
template <typename T>
...
} // libcis_ns_atomics_atomics_ref_fetch_xor_007ed263 (libcis)
