// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_ref_fetch_add).
// main -> test_atomics_atomics_ref_fetch_add; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_ref_fetch_add { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_atomics_atomics_ref_fetch_add; // libcis


void test_atomics_atomics_ref_fetch_add() {
