// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_ref_member_types).
...
namespace libcis_ns_atomics_atomics_ref_member_types { // libcis: isolate file-scope helpers
template <class T>
...
} using namespace libcis_ns_atomics_atomics_ref_member_types; // libcis
