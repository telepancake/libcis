// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_ref_bitwise_and_assign).
// main -> test_atomics_atomics_ref_bitwise_and_assign; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_ref_bitwise_and_assign { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_atomics_atomics_ref_bitwise_and_assign; // libcis


void test_atomics_atomics_ref_bitwise_and_assign() {
