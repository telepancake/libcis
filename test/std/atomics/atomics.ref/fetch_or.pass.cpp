// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_ref_fetch_or_f384ec98).
//
...
namespace libcis_ns_atomics_atomics_ref_fetch_or_f384ec98 { // libcis
template <typename T>
...
} // libcis_ns_atomics_atomics_ref_fetch_or_f384ec98 (libcis)
