// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_ref_fetch_or).
// main -> test_atomics_atomics_ref_fetch_or; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_ref_fetch_or { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_atomics_atomics_ref_fetch_or; // libcis


void test_atomics_atomics_ref_fetch_or() {
