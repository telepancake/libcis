// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_ref_increment_decrement_5f3e0a24).
//
...
namespace libcis_ns_atomics_atomics_ref_increment_decrement_5f3e0a24 { // libcis
template <typename T>
...
} // libcis_ns_atomics_atomics_ref_increment_decrement_5f3e0a24 (libcis)
