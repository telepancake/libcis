// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_ref_increment_decrement).
// main -> test_atomics_atomics_ref_increment_decrement; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_ref_increment_decrement { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_atomics_atomics_ref_increment_decrement; // libcis


void test_atomics_atomics_ref_increment_decrement() {
