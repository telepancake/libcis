// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_ref_wait_b6a1a400).
//
...
namespace libcis_ns_atomics_atomics_ref_wait_b6a1a400 { // libcis
template <typename T>
struct TestWait {
  void operator()() const {
    {
...
} // libcis_ns_atomics_atomics_ref_wait_b6a1a400 (libcis)
