// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_ref_is_always_lock_free_0f6a39e8).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_ref_is_always_lock_free_0f6a39e8 { // libcis
template <typename T>
...
} // libcis_ns_atomics_atomics_ref_is_always_lock_free_0f6a39e8 (libcis)
