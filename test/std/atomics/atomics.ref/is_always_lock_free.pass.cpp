// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_ref_is_always_lock_free).
// main -> test_atomics_atomics_ref_is_always_lock_free; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_ref_is_always_lock_free { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_atomics_atomics_ref_is_always_lock_free; // libcis


void test_atomics_atomics_ref_is_always_lock_free() {
  test();
  return;
}
