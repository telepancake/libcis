// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_ref_operator_plus_equals).
// main -> test_atomics_atomics_ref_operator_plus_equals; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_ref_operator_plus_equals { // libcis: isolate file-scope helpers
template <typename T>
...
} using namespace libcis_ns_atomics_atomics_ref_operator_plus_equals; // libcis


void test_atomics_atomics_ref_operator_plus_equals() {
