// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_ref_operator_minus_equals_0343eee4).
//
...
namespace libcis_ns_atomics_atomics_ref_operator_minus_equals_0343eee4 { // libcis
template <typename T>
...
} // libcis_ns_atomics_atomics_ref_operator_minus_equals_0343eee4 (libcis)
