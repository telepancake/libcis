// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_types_3a917c9c).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_types_3a917c9c { // libcis
...
} // libcis_ns_atomics_types_3a917c9c (libcis)
