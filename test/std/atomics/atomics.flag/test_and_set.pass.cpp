// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_flag_test_and_set).
// main -> test_atomics_atomics_flag_test_and_set; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_atomics_atomics_flag_test_and_set()
{
    {
        std::atomic_flag f;
        f.clear();
