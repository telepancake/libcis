// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_flag_atomic_flag_test_and_set_explicit).
// main -> test_atomics_atomics_flag_atomic_flag_test_and_set_explicit; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_atomics_atomics_flag_atomic_flag_test_and_set_explicit()
{
    {
        std::atomic_flag f;
        f.clear();
