// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_flag_atomic_flag_test_explicit_03e61c61).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_flag_atomic_flag_test_explicit_03e61c61 { // libcis
int main(int, char**)
{
    {
        std::atomic_flag f;
...
} // libcis_ns_atomics_atomics_flag_atomic_flag_test_explicit_03e61c61 (libcis)
