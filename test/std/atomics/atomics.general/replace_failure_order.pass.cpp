// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_general_replace_failure_order).
// main -> test_atomics_atomics_general_replace_failure_order; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
void test_atomics_atomics_general_replace_failure_order() {
    std::atomic<int> i;
