// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_general_replace_failure_order_feb1f56d).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_general_replace_failure_order_feb1f56d { // libcis
int main(int, char**) {
    std::atomic<int> i;
...
} // libcis_ns_atomics_atomics_general_replace_failure_order_feb1f56d (libcis)
