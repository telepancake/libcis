// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_operations_atomics_types_operations_req_atomic_fetch_sub_explicit_516a6b7e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_operations_atomics_types_operations_req_atomic_fetch_sub_explicit_516a6b7e { // libcis
template <class T>
struct TestFn {
  void operator()() const {
    {
...
} // libcis_ns_atomics_atomics_types_operations_atomics_types_operations_req_atomic_fetch_sub_explicit_516a6b7e (libcis)
