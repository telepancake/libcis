// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_operations_atomics_types_operations_req_atomic_load_explicit_99f9ea7e).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_operations_atomics_types_operations_req_atomic_load_explicit_99f9ea7e { // libcis
template <class T>
struct TestFn {
  void operator()() const {
...
} // libcis_ns_atomics_atomics_types_operations_atomics_types_operations_req_atomic_load_explicit_99f9ea7e (libcis)
