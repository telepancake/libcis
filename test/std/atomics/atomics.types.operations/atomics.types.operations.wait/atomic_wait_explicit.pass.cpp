// AST-transferred from libc++ by tools/transfer.py (slug=atomics_atomics_types_operations_atomics_types_operations_wait_atomic_wait_explicit).
// main -> test_atomics_atomics_types_operations_atomics_types_operations_wait_atomic_wait_explicit; file-scope helpers isolated in anon namespace.
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_operations_atomics_types_operations_wait_atomic_wait_explicit { // libcis: isolate file-scope helpers
template <class T>
struct TestFn {
  void operator()() const {
...
} using namespace libcis_ns_atomics_atomics_types_operations_atomics_types_operations_wait_atomic_wait_explicit; // libcis


void test_atomics_atomics_types_operations_atomics_types_operations_wait_atomic_wait_explicit() {
