// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_operations_atomics_types_operations_wait_atomic_wait_explicit_f8fa2895).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_operations_atomics_types_operations_wait_atomic_wait_explicit_f8fa2895 { // libcis
template <class T>
struct TestFn {
  void operator()() const {
...
} // libcis_ns_atomics_atomics_types_operations_atomics_types_operations_wait_atomic_wait_explicit_f8fa2895 (libcis)
