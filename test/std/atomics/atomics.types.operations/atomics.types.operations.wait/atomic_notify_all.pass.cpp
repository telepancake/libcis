// transferred+adapted from libc++ by tools/transfer.py (slug=atomics_atomics_types_operations_atomics_types_operations_wait_atomic_notify_all_e8327e1b).
//===----------------------------------------------------------------------===//
//
...
namespace libcis_ns_atomics_atomics_types_operations_atomics_types_operations_wait_atomic_notify_all_e8327e1b { // libcis
template <class T>
struct TestFn {
  void operator()() const {
...
} // libcis_ns_atomics_atomics_types_operations_atomics_types_operations_wait_atomic_notify_all_e8327e1b (libcis)
