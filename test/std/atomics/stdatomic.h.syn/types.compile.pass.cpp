// AST-transferred from libc++ by tools/transfer.py (slug=atomics_stdatomic_h_syn_types).
...
namespace libcis_ns_atomics_stdatomic_h_syn_types { // libcis: isolate file-scope helpers
...
} using namespace libcis_ns_atomics_stdatomic_h_syn_types; // libcis
